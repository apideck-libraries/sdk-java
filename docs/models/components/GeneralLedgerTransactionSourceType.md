...
```java
import com.apideck.unify.models.components.GeneralLedgerTransactionSourceType;

GeneralLedgerTransactionSourceType value = GeneralLedgerTransactionSourceType.OTHER;

// Open enum: use .of() to create instances from custom string values
GeneralLedgerTransactionSourceType custom = GeneralLedgerTransactionSourceType.of("custom_value");
```
