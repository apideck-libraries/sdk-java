...
<!-- UsageSnippet language="java" operationID="hris.companiesAll2" method="get" path="/hris/companies" -->
```java
package hello.world;
...
public class Application {
    ...
    public static void main(String[] args) throws BadRequestResponse, UnauthorizedResponse, PaymentRequiredResponse, NotFoundResponse, UnprocessableResponse, Exception {
        ...
        HrisCompaniesAll2Request req = HrisCompaniesAll2Request.builder()
        ...
        sdk.hris().companies().all()
                .callAsStream()
                .forEach((HrisCompaniesAll2Response item) -> {
                   // handle page
                });
...
| ------------------------------------------------------------------------------- | ------------------------------------------------------------------------------- | ------------------------------------------------------------------------------- | ------------------------------------------------------------------------------- |
| `request`                                                                       | [HrisCompaniesAll2Request](../../models/operations/HrisCompaniesAll2Request.md) | :heavy_check_mark:                                                              | The request object to use for the request.                                      |

### Response

**[HrisCompaniesAll2Response](../../models/operations/HrisCompaniesAll2Response.md)**
