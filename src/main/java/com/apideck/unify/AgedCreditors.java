...
public class AgedCreditors implements
            MethodCallAccountingAgedCreditorsOne {
    ...
    public AccountingAgedCreditorsOneRequestBuilder get() {
        return new AccountingAgedCreditorsOneRequestBuilder(this);
    }
    ...
    public AccountingAgedCreditorsOneResponse get(
            AccountingAgedCreditorsOneRequest request) throws Exception {
    ...
    public AccountingAgedCreditorsOneResponse get(
        ...
        AccountingAgedCreditorsOneResponse.Builder _resBuilder = 
        ...
        AccountingAgedCreditorsOneResponse _res = _resBuilder.build();
        
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "200")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                GetAgedCreditorsResponse _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<GetAgedCreditorsResponse>() {});
                _res.withGetAgedCreditorsResponse(Optional.ofNullable(_out));
                return _res;
            } else {
