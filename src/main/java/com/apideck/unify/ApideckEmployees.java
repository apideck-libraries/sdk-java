...
public class ApideckEmployees {
    private static final Headers _headers = Headers.EMPTY;
    private final SDKConfiguration sdkConfiguration;
    private final AsyncApideckEmployees asyncSDK;

    ApideckEmployees(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
        this.asyncSDK = new AsyncApideckEmployees(this, sdkConfiguration);
    }
     ...
     */
    public AsyncApideckEmployees async() {
        return asyncSDK;
    }
