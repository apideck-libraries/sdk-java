...
import com.apideck.unify.models.operations.HrisCompaniesAll2RequestBuilder;
...
public class ApideckHrisCompanies {
    private static final Headers _headers = Headers.EMPTY;
    private final SDKConfiguration sdkConfiguration;
    private final AsyncApideckHrisCompanies asyncSDK;

    ApideckHrisCompanies(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
        this.asyncSDK = new AsyncApideckHrisCompanies(this, sdkConfiguration);
    }
     ...
     */
    public AsyncApideckHrisCompanies async() {
        return asyncSDK;
    }
     ...
     */
    public HrisCompaniesAll2Response all(HrisCompaniesAll2Request request) {
     ...
     * @throws RuntimeException subclass if the API call fails
     */
    public HrisCompaniesAll2Response all(HrisCompaniesAll2Request request, Optional<Options> options) {
