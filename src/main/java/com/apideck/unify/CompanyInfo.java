...
public class CompanyInfo implements
            MethodCallAccountingCompanyInfoOne {
    ...
    public AccountingCompanyInfoOneRequestBuilder get() {
        return new AccountingCompanyInfoOneRequestBuilder(this);
    }
    ...
    public AccountingCompanyInfoOneResponse get(
            AccountingCompanyInfoOneRequest request) throws Exception {
    ...
    public AccountingCompanyInfoOneResponse get(
        ...
        AccountingCompanyInfoOneResponse.Builder _resBuilder = 
        ...
        AccountingCompanyInfoOneResponse _res = _resBuilder.build();
        
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "200")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                GetCompanyInfoResponse _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<GetCompanyInfoResponse>() {});
                _res.withGetCompanyInfoResponse(Optional.ofNullable(_out));
                return _res;
            } else {
