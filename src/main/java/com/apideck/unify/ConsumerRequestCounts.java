...
public class ConsumerRequestCounts implements
            MethodCallVaultConsumerRequestCountsAll {
    ...
    public VaultConsumerRequestCountsAllRequestBuilder list() {
        return new VaultConsumerRequestCountsAllRequestBuilder(this);
    }
    ...
    public VaultConsumerRequestCountsAllResponse list(
        ...
        VaultConsumerRequestCountsAllResponse.Builder _resBuilder = 
        ...
        VaultConsumerRequestCountsAllResponse _res = _resBuilder.build();
        
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "200")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                ConsumerRequestCountsInDateRangeResponse _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<ConsumerRequestCountsInDateRangeResponse>() {});
                _res.withConsumerRequestCountsInDateRangeResponse(Optional.ofNullable(_out));
                return _res;
            } else {
