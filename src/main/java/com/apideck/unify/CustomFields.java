...
public class CustomFields {
     ...
     */
    public VaultCustomFieldsAllResponse list(VaultCustomFieldsAllRequest request) {
     ...
     * @throws RuntimeException subclass if the API call fails
     */
    public VaultCustomFieldsAllResponse list(VaultCustomFieldsAllRequest request, Optional<Options> options) {
