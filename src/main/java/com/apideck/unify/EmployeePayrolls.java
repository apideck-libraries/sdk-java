...
public class EmployeePayrolls implements
            MethodCallHrisEmployeePayrollsAll,
            MethodCallHrisEmployeePayrollsOne {
    ...
    public HrisEmployeePayrollsAllRequestBuilder list() {
        return new HrisEmployeePayrollsAllRequestBuilder(this);
    }
    ...
    public HrisEmployeePayrollsAllResponse list(
            HrisEmployeePayrollsAllRequest request) throws Exception {
    ...
    public HrisEmployeePayrollsAllResponse list(
        ...
        String _url = Utils.generateURL(
                HrisEmployeePayrollsAllRequest.class,
                _baseUrl,
        ...
        HrisEmployeePayrollsAllResponse.Builder _resBuilder = 
        ...
        HrisEmployeePayrollsAllResponse _res = _resBuilder.build();
        
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "200")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                GetEmployeePayrollsResponse _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<GetEmployeePayrollsResponse>() {});
                _res.withGetEmployeePayrollsResponse(Optional.ofNullable(_out));
                return _res;
            } else {
    ...
    public HrisEmployeePayrollsOneRequestBuilder get() {
        return new HrisEmployeePayrollsOneRequestBuilder(this);
    }
    ...
    public HrisEmployeePayrollsOneResponse get(
            HrisEmployeePayrollsOneRequest request) throws Exception {
    ...
    public HrisEmployeePayrollsOneResponse get(
        ...
        String _baseUrl = this.sdkConfiguration.serverUrl;
        String _url = Utils.generateURL(
                HrisEmployeePayrollsOneRequest.class,
                _baseUrl,
        ...
        String _contentType = _httpRes
            ...
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        HrisEmployeePayrollsOneResponse.Builder _resBuilder = 
        ...
        HrisEmployeePayrollsOneResponse _res = _resBuilder.build();
        
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "200")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                GetEmployeePayrollResponse _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<GetEmployeePayrollResponse>() {});
                _res.withGetEmployeePayrollResponse(Optional.ofNullable(_out));
                return _res;
            } else {
                throw new APIException(
                    _httpRes, 
