...
public class EmployeeSchedules implements
            MethodCallHrisEmployeeSchedulesAll {
    ...
    public HrisEmployeeSchedulesAllRequestBuilder list() {
        return new HrisEmployeeSchedulesAllRequestBuilder(this);
    }
    ...
    public HrisEmployeeSchedulesAllResponse list(
            HrisEmployeeSchedulesAllRequest request) throws Exception {
    ...
    public HrisEmployeeSchedulesAllResponse list(
        ...
        HrisEmployeeSchedulesAllResponse.Builder _resBuilder = 
        ...
        HrisEmployeeSchedulesAllResponse _res = _resBuilder.build();
        
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "200")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                GetEmployeeSchedulesResponse _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<GetEmployeeSchedulesResponse>() {});
                _res.withGetEmployeeSchedulesResponse(Optional.ofNullable(_out));
                return _res;
            } else {
