...
public class ProfitAndLoss implements
            MethodCallAccountingProfitAndLossOne {
    ...
    public AccountingProfitAndLossOneRequestBuilder get() {
        return new AccountingProfitAndLossOneRequestBuilder(this);
    }
    ...
    public AccountingProfitAndLossOneResponse get(
            AccountingProfitAndLossOneRequest request) throws Exception {
    ...
    public AccountingProfitAndLossOneResponse get(
        ...
        AccountingProfitAndLossOneResponse.Builder _resBuilder = 
        ...
        AccountingProfitAndLossOneResponse _res = _resBuilder.build();
        
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "200")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                GetProfitAndLossResponse _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<GetProfitAndLossResponse>() {});
                _res.withGetProfitAndLossResponse(Optional.ofNullable(_out));
                return _res;
            } else {
