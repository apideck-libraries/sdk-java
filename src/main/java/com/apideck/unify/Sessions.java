...
public class Sessions implements
    ...
    public VaultSessionsCreateRequestBuilder create() {
        return new VaultSessionsCreateRequestBuilder(this);
    }
    ...
    public VaultSessionsCreateResponse create(
        ...
        VaultSessionsCreateResponse.Builder _resBuilder = 
        ...
        VaultSessionsCreateResponse _res = _resBuilder.build();
        
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "200")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                CreateSessionResponse _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<CreateSessionResponse>() {});
                _res.withCreateSessionResponse(Optional.ofNullable(_out));
                return _res;
            } else {
