...
public class Stores implements
            MethodCallEcommerceStoresOne {
    ...
    public EcommerceStoresOneRequestBuilder get() {
        return new EcommerceStoresOneRequestBuilder(this);
    }
    ...
    public EcommerceStoresOneResponse get(
            EcommerceStoresOneRequest request) throws Exception {
    ...
    public EcommerceStoresOneResponse get(
        ...
        EcommerceStoresOneResponse.Builder _resBuilder = 
        ...
        EcommerceStoresOneResponse _res = _resBuilder.build();
        
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "200")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                GetStoreResponse _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<GetStoreResponse>() {});
                _res.withGetStoreResponse(Optional.ofNullable(_out));
                return _res;
            } else {
