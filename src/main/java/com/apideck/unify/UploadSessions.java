...
public class UploadSessions implements
            ...
            MethodCallFileStorageUploadSessionsUpload,
    ...
    /**
     * FILE_STORAGE_UPLOAD_SESSIONS_UPLOAD_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] FILE_STORAGE_UPLOAD_SESSIONS_UPLOAD_SERVERS = {
        "https://upload.apideck.com",
    };
    ...
    public FileStorageUploadSessionsAddResponse create(
        ...
        if (serverURL.isPresent() && !serverURL.get().isBlank()) {
            ...
            _baseUrl = Utils.templateUrl(FILE_STORAGE_UPLOAD_SESSIONS_ADD_SERVERS[0], new HashMap<String, String>());
        }
    ...
    public FileStorageUploadSessionsOneResponse get(
        ...
        if (serverURL.isPresent() && !serverURL.get().isBlank()) {
            ...
            _baseUrl = Utils.templateUrl(FILE_STORAGE_UPLOAD_SESSIONS_ONE_SERVERS[0], new HashMap<String, String>());
        }
        String _url = Utils.generateURL(
    ...
    public FileStorageUploadSessionsUploadRequestBuilder upload() {
        return new FileStorageUploadSessionsUploadRequestBuilder(this);
    }
    ...
    public FileStorageUploadSessionsUploadResponse upload(
            FileStorageUploadSessionsUploadRequest request) throws Exception {
    ...
    public FileStorageUploadSessionsUploadResponse upload(
        ...
        if (serverURL.isPresent() && !serverURL.get().isBlank()) {
            ...
            _baseUrl = Utils.templateUrl(FILE_STORAGE_UPLOAD_SESSIONS_UPLOAD_SERVERS[0], new HashMap<String, String>());
        }
        String _url = Utils.generateURL(
                FileStorageUploadSessionsUploadRequest.class,
                _baseUrl,
                "/file-storage/upload-sessions/{id}",
                request, this.sdkConfiguration.globals);
        ...
        Object _convertedRequest = Utils.convertToShape(
                request, 
                JsonShape.DEFAULT,
                new TypeReference<FileStorageUploadSessionsUploadRequest>() {});
        SerializedBody _serializedRequestBody = Utils.serializeRequestBody(
                _convertedRequest, 
                "requestBody",
                "raw",
        ...
        String _contentType = _httpRes
            ...
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        FileStorageUploadSessionsUploadResponse.Builder _resBuilder = 
        ...
        FileStorageUploadSessionsUploadResponse _res = _resBuilder.build();
        
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "200")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                UpdateUploadSessionResponse _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<UpdateUploadSessionResponse>() {});
                _res.withUpdateUploadSessionResponse(Optional.ofNullable(_out));
                return _res;
            } else {
                throw new APIException(
                    _httpRes, 
    ...
    public FileStorageUploadSessionsFinishResponse finish(
        ...
        if (serverURL.isPresent() && !serverURL.get().isBlank()) {
            ...
            _baseUrl = Utils.templateUrl(FILE_STORAGE_UPLOAD_SESSIONS_FINISH_SERVERS[0], new HashMap<String, String>());
        }
        String _url = Utils.generateURL(
