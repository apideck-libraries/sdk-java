...
public final class SDKHooks {
    ...
    public static void initialize(com.apideck.unify.utils.Hooks hooks) {
    ...
    public static void initialize(com.apideck.unify.utils.AsyncHooks asyncHooks) {
        ...
        // asyncHooks.registerAfterError(com.apideck.unify.utils.HookAdapters.adapt(mySyncHook));
