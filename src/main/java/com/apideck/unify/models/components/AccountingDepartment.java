...
public class AccountingDepartment {
     ...
     * A unique identifier for an object.
     */
    public AccountingDepartment withId(@Nullable String id) {
        this.id = id;
        return this;
    }
     ...
     * A unique identifier for an object.
     */
    public AccountingDepartment withParentId(@Nullable String parentId) {
     ...
     * The name of the department.
     */
    public AccountingDepartment withName(@Nullable String name) {
     ...
     * Based on the status some functionality is enabled or disabled.
     */
    public AccountingDepartment withStatus(@Nullable DepartmentStatus status) {
        this.status = status;
        return this;
    }


    public AccountingDepartment withSubsidiaries(@Nullable List<SubsidiaryReference> subsidiaries) {
        this.subsidiaries = subsidiaries;
        return this;
    }
     ...
     * The code of the department.
     */
    public AccountingDepartment withCode(@Nullable String code) {
        this.code = code;
        return this;
    }
     ...
     * When custom mappings are configured on the resource, the result is included here.
     */
    public AccountingDepartment withCustomMappings(@Nullable Map<String, Object> customMappings) {
     ...
     * A binary value used to detect updates to a object and prevent data conflicts. It is incremented each time an update is made to the object.
     */
    public AccountingDepartment withRowVersion(@Nullable String rowVersion) {
     ...
     * The user who last updated the object.
     */
    public AccountingDepartment withUpdatedBy(@Nullable String updatedBy) {
     ...
     * The user who created the object.
     */
    public AccountingDepartment withCreatedBy(@Nullable String createdBy) {
     ...
     * The date and time when the object was last updated.
     */
    public AccountingDepartment withUpdatedAt(@Nullable OffsetDateTime updatedAt) {
     ...
     * The date and time when the object was created.
     */
    public AccountingDepartment withCreatedAt(@Nullable OffsetDateTime createdAt) {
     ...
     * The pass_through property allows passing service-specific, custom data or structured modifications in request body when creating or updating resources.
     */
    public AccountingDepartment withPassThrough(@Nullable List<PassThroughBody> passThrough) {
        this.passThrough = passThrough;
        return this;
    }
