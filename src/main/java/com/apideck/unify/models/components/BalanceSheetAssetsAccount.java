 ...
 * 
 * <p>A balance sheet assets account represents the financial position of a company at a specific point in
 * time.
 */
public class BalanceSheetAssetsAccount {
     ...
     * The unique identifier for the account.
     */
    public BalanceSheetAssetsAccount withAccountId(String accountId) {
        Utils.checkNotNull(accountId, "accountId");
     ...
     * The unique identifier for the account.
     */
    public BalanceSheetAssetsAccount withAccountId(Optional<String> accountId) {
        Utils.checkNotNull(accountId, "accountId");
        this.accountId = accountId;
        return this;
    }
     ...
     * The account code of the account
     */
    public BalanceSheetAssetsAccount withCode(String code) {
        Utils.checkNotNull(code, "code");
     ...
     * The account code of the account
     */
    public BalanceSheetAssetsAccount withCode(Optional<String> code) {
        Utils.checkNotNull(code, "code");
        this.code = code;
        return this;
    }
     ...
     * The name of the account.
     */
    public BalanceSheetAssetsAccount withName(String name) {
        Utils.checkNotNull(name, "name");
     ...
     * The name of the account.
     */
    public BalanceSheetAssetsAccount withName(Optional<String> name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }
     ...
     * The amount or value of the item
     */
    public BalanceSheetAssetsAccount withValue(double value) {
        Utils.checkNotNull(value, "value");
     ...
     * The amount or value of the item
     */
    public BalanceSheetAssetsAccount withValue(Optional<Double> value) {
        Utils.checkNotNull(value, "value");
        this.value = value;
        return this;
    }
     ...
     * A list of balance sheet accounts
     */
    public BalanceSheetAssetsAccount withItems(Object items) {
        Utils.checkNotNull(items, "items");
     ...
     * A list of balance sheet accounts
     */
    public BalanceSheetAssetsAccount withItems(Optional<? extends Object> items) {
        Utils.checkNotNull(items, "items");
        this.items = items;
        return this;
    }
    ...
    @JsonAnySetter
    public BalanceSheetAssetsAccount withAdditionalProperty(String key, Object value) {
        // note that value can be null because of the way JsonAnySetter works
        Utils.checkNotNull(key, "key");
        additionalProperties.put(key, value); 
        return this;
    }
    public BalanceSheetAssetsAccount withAdditionalProperties(Map<String, Object> additionalProperties) {
