...
public class BankAccount2 {
    ...
    private JsonNullable<? extends BankAccount2AccountType> accountType;
    ...
    public BankAccount2(
            ...
            @JsonProperty("account_type") JsonNullable<? extends BankAccount2AccountType> accountType,
    ...
    @JsonIgnore
    public JsonNullable<BankAccount2AccountType> accountType() {
        return (JsonNullable<BankAccount2AccountType>) accountType;
    }
     ...
     * The name of the bank or financial institution
     */
    public BankAccount2 withBankName(String bankName) {
        Utils.checkNotNull(bankName, "bankName");
     ...
     * The name of the bank or financial institution
     */
    public BankAccount2 withBankName(JsonNullable<String> bankName) {
        Utils.checkNotNull(bankName, "bankName");
        this.bankName = bankName;
        return this;
    }
     ...
     * The bank account number
     */
    public BankAccount2 withAccountNumber(String accountNumber) {
        Utils.checkNotNull(accountNumber, "accountNumber");
     ...
     * The bank account number
     */
    public BankAccount2 withAccountNumber(JsonNullable<String> accountNumber) {
        Utils.checkNotNull(accountNumber, "accountNumber");
        this.accountNumber = accountNumber;
        return this;
    }
     ...
     * The name of the bank account
     */
    public BankAccount2 withAccountName(String accountName) {
        Utils.checkNotNull(accountName, "accountName");
     ...
     * The name of the bank account
     */
    public BankAccount2 withAccountName(JsonNullable<String> accountName) {
        Utils.checkNotNull(accountName, "accountName");
        this.accountName = accountName;
        return this;
    }
     ...
     * The type of bank account.
     */
    public BankAccount2 withAccountType(BankAccount2AccountType accountType) {
        Utils.checkNotNull(accountType, "accountType");
     ...
     * The type of bank account.
     */
    public BankAccount2 withAccountType(JsonNullable<? extends BankAccount2AccountType> accountType) {
        Utils.checkNotNull(accountType, "accountType");
        this.accountType = accountType;
        return this;
    }
     ...
     * International Bank Account Number
     */
    public BankAccount2 withIban(String iban) {
        Utils.checkNotNull(iban, "iban");
     ...
     * International Bank Account Number
     */
    public BankAccount2 withIban(JsonNullable<String> iban) {
        Utils.checkNotNull(iban, "iban");
        this.iban = iban;
        return this;
    }
     ...
     * Bank Identifier Code / SWIFT Code
     */
    public BankAccount2 withBic(String bic) {
        Utils.checkNotNull(bic, "bic");
     ...
     * Bank Identifier Code / SWIFT Code
     */
    public BankAccount2 withBic(JsonNullable<String> bic) {
        Utils.checkNotNull(bic, "bic");
        this.bic = bic;
        return this;
    }
     ...
     * Bank routing number (US)
     */
    public BankAccount2 withRoutingNumber(String routingNumber) {
        Utils.checkNotNull(routingNumber, "routingNumber");
     ...
     * Bank routing number (US)
     */
    public BankAccount2 withRoutingNumber(JsonNullable<String> routingNumber) {
        Utils.checkNotNull(routingNumber, "routingNumber");
        this.routingNumber = routingNumber;
        return this;
    }
     ...
     * Bank State Branch number (Australia/New Zealand)
     */
    public BankAccount2 withBsbNumber(String bsbNumber) {
        Utils.checkNotNull(bsbNumber, "bsbNumber");
     ...
     * Bank State Branch number (Australia/New Zealand)
     */
    public BankAccount2 withBsbNumber(JsonNullable<String> bsbNumber) {
        Utils.checkNotNull(bsbNumber, "bsbNumber");
        this.bsbNumber = bsbNumber;
        return this;
    }
     ...
     * Bank branch identifier
     */
    public BankAccount2 withBranchIdentifier(String branchIdentifier) {
        Utils.checkNotNull(branchIdentifier, "branchIdentifier");
     ...
     * Bank branch identifier
     */
    public BankAccount2 withBranchIdentifier(JsonNullable<String> branchIdentifier) {
        Utils.checkNotNull(branchIdentifier, "branchIdentifier");
        this.branchIdentifier = branchIdentifier;
        return this;
    }
     ...
     * Bank code assigned by central bank
     */
    public BankAccount2 withBankCode(String bankCode) {
        Utils.checkNotNull(bankCode, "bankCode");
     ...
     * Bank code assigned by central bank
     */
    public BankAccount2 withBankCode(JsonNullable<String> bankCode) {
        Utils.checkNotNull(bankCode, "bankCode");
        this.bankCode = bankCode;
        return this;
    }
     ...
     * 4217](https://en.wikipedia.org/wiki/ISO_4217).
     */
    public BankAccount2 withCurrency(Currency currency) {
        Utils.checkNotNull(currency, "currency");
     ...
     * 4217](https://en.wikipedia.org/wiki/ISO_4217).
     */
    public BankAccount2 withCurrency(JsonNullable<? extends Currency> currency) {
        Utils.checkNotNull(currency, "currency");
        this.currency = currency;
        return this;
    }
     ...
     * Country code according to ISO 3166-1 alpha-2.
     */
    public BankAccount2 withCountry(String country) {
        Utils.checkNotNull(country, "country");
     ...
     * Country code according to ISO 3166-1 alpha-2.
     */
    public BankAccount2 withCountry(JsonNullable<String> country) {
        Utils.checkNotNull(country, "country");
        this.country = country;
        return this;
    }
    ...
    @JsonAnySetter
    public BankAccount2 withAdditionalProperty(String key, Object value) {
        // note that value can be null because of the way JsonAnySetter works
        Utils.checkNotNull(key, "key");
        additionalProperties.put(key, value); 
        return this;
    }
    public BankAccount2 withAdditionalProperties(Map<String, Object> additionalProperties) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        BankAccount2 other = (BankAccount2) o;
        return 
    ...
    public String toString() {
        return Utils.toString(BankAccount2.class,
                "bankName", bankName,
    ...
    public final static class Builder {
        ...
        private JsonNullable<? extends BankAccount2AccountType> accountType = JsonNullable.undefined();
         ...
         * The type of bank account.
         */
        public Builder accountType(BankAccount2AccountType accountType) {
            Utils.checkNotNull(accountType, "accountType");
            this.accountType = JsonNullable.of(accountType);
            return this;
        }
         ...
         * The type of bank account.
         */
        public Builder accountType(JsonNullable<? extends BankAccount2AccountType> accountType) {
            Utils.checkNotNull(accountType, "accountType");
            this.accountType = accountType;
            return this;
        }
