...
public class BillCreditNoteLineItemInput {
    ...
    @JsonCreator
    public BillCreditNoteLineItemInput(
     ...
     * The unique row identifier of the line item, when the connector exposes one.
     */
    public BillCreditNoteLineItemInput withRowId(String rowId) {
        Utils.checkNotNull(rowId, "rowId");
     ...
     * The unique row identifier of the line item, when the connector exposes one.
     */
    public BillCreditNoteLineItemInput withRowId(JsonNullable<String> rowId) {
        Utils.checkNotNull(rowId, "rowId");
        this.rowId = rowId;
        return this;
    }
     ...
     * User defined item code.
     */
    public BillCreditNoteLineItemInput withCode(String code) {
        Utils.checkNotNull(code, "code");
     ...
     * User defined item code.
     */
    public BillCreditNoteLineItemInput withCode(JsonNullable<String> code) {
        Utils.checkNotNull(code, "code");
        this.code = code;
        return this;
    }
     ...
     * Line number of the resource
     */
    public BillCreditNoteLineItemInput withLineNumber(long lineNumber) {
        Utils.checkNotNull(lineNumber, "lineNumber");
     ...
     * Line number of the resource
     */
    public BillCreditNoteLineItemInput withLineNumber(JsonNullable<Long> lineNumber) {
        Utils.checkNotNull(lineNumber, "lineNumber");
        this.lineNumber = lineNumber;
        return this;
    }
     ...
     * User defined description for the line item.
     */
    public BillCreditNoteLineItemInput withDescription(String description) {
        Utils.checkNotNull(description, "description");
     ...
     * User defined description for the line item.
     */
    public BillCreditNoteLineItemInput withDescription(JsonNullable<String> description) {
        Utils.checkNotNull(description, "description");
        this.description = description;
        return this;
    }
     ...
     * Line Item type
     */
    public BillCreditNoteLineItemInput withType(LineItemType type) {
        Utils.checkNotNull(type, "type");
     ...
     * Line Item type
     */
    public BillCreditNoteLineItemInput withType(JsonNullable<? extends LineItemType> type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
     ...
     * Tax amount
     */
    public BillCreditNoteLineItemInput withTaxAmount(double taxAmount) {
        Utils.checkNotNull(taxAmount, "taxAmount");
     ...
     * Tax amount
     */
    public BillCreditNoteLineItemInput withTaxAmount(JsonNullable<Double> taxAmount) {
        Utils.checkNotNull(taxAmount, "taxAmount");
        this.taxAmount = taxAmount;
        return this;
    }
     ...
     * Total amount of the line item.
     */
    public BillCreditNoteLineItemInput withTotalAmount(double totalAmount) {
        Utils.checkNotNull(totalAmount, "totalAmount");
     ...
     * Total amount of the line item.
     */
    public BillCreditNoteLineItemInput withTotalAmount(JsonNullable<Double> totalAmount) {
        Utils.checkNotNull(totalAmount, "totalAmount");
        this.totalAmount = totalAmount;
        return this;
    }

    public BillCreditNoteLineItemInput withQuantity(double quantity) {
        Utils.checkNotNull(quantity, "quantity");
        this.quantity = JsonNullable.of(quantity);
        return this;
    }

    public BillCreditNoteLineItemInput withQuantity(JsonNullable<Double> quantity) {
        Utils.checkNotNull(quantity, "quantity");
        this.quantity = quantity;
        return this;
    }

    public BillCreditNoteLineItemInput withUnitPrice(double unitPrice) {
        Utils.checkNotNull(unitPrice, "unitPrice");
        this.unitPrice = JsonNullable.of(unitPrice);
        return this;
    }

    public BillCreditNoteLineItemInput withUnitPrice(JsonNullable<Double> unitPrice) {
        Utils.checkNotNull(unitPrice, "unitPrice");
        this.unitPrice = unitPrice;
        return this;
    }
     ...
     * Description of the unit type the item is sold as, ie: kg, hour.
     */
    public BillCreditNoteLineItemInput withUnitOfMeasure(String unitOfMeasure) {
        Utils.checkNotNull(unitOfMeasure, "unitOfMeasure");
     ...
     * Description of the unit type the item is sold as, ie: kg, hour.
     */
    public BillCreditNoteLineItemInput withUnitOfMeasure(JsonNullable<String> unitOfMeasure) {
        Utils.checkNotNull(unitOfMeasure, "unitOfMeasure");
        this.unitOfMeasure = unitOfMeasure;
        return this;
    }
     ...
     * Discount percentage applied to the line item when supported downstream.
     */
    public BillCreditNoteLineItemInput withDiscountPercentage(double discountPercentage) {
        Utils.checkNotNull(discountPercentage, "discountPercentage");
     ...
     * Discount percentage applied to the line item when supported downstream.
     */
    public BillCreditNoteLineItemInput withDiscountPercentage(JsonNullable<Double> discountPercentage) {
        Utils.checkNotNull(discountPercentage, "discountPercentage");
        this.discountPercentage = discountPercentage;
        return this;
    }
     ...
     * Discount amount applied to the line item when supported downstream.
     */
    public BillCreditNoteLineItemInput withDiscountAmount(double discountAmount) {
        Utils.checkNotNull(discountAmount, "discountAmount");
     ...
     * Discount amount applied to the line item when supported downstream.
     */
    public BillCreditNoteLineItemInput withDiscountAmount(JsonNullable<Double> discountAmount) {
        Utils.checkNotNull(discountAmount, "discountAmount");
        this.discountAmount = discountAmount;
        return this;
    }
     ...
     * Date on which the service was provided or performed - YYYY-MM-DD.
     */
    public BillCreditNoteLineItemInput withServiceDate(LocalDate serviceDate) {
        Utils.checkNotNull(serviceDate, "serviceDate");
     ...
     * Date on which the service was provided or performed - YYYY-MM-DD.
     */
    public BillCreditNoteLineItemInput withServiceDate(JsonNullable<LocalDate> serviceDate) {
        Utils.checkNotNull(serviceDate, "serviceDate");
        this.serviceDate = serviceDate;
        return this;
    }

    public BillCreditNoteLineItemInput withLocation(LinkedLocationInput location) {
        Utils.checkNotNull(location, "location");
        this.location = JsonNullable.of(location);
        return this;
    }

    public BillCreditNoteLineItemInput withLocation(JsonNullable<? extends LinkedLocationInput> location) {
        Utils.checkNotNull(location, "location");
        this.location = location;
        return this;
    }

    public BillCreditNoteLineItemInput withDepartment(LinkedDepartmentInput department) {
        Utils.checkNotNull(department, "department");
        this.department = JsonNullable.of(department);
        return this;
    }

    public BillCreditNoteLineItemInput withDepartment(JsonNullable<? extends LinkedDepartmentInput> department) {
        Utils.checkNotNull(department, "department");
        this.department = department;
        return this;
    }

    public BillCreditNoteLineItemInput withItem(LinkedInvoiceItem item) {
        Utils.checkNotNull(item, "item");
    ...
    public BillCreditNoteLineItemInput withItem(Optional<? extends LinkedInvoiceItem> item) {
        Utils.checkNotNull(item, "item");
        this.item = item;
        return this;
    }

    public BillCreditNoteLineItemInput withTaxRate(LinkedTaxRateInput taxRate) {
        Utils.checkNotNull(taxRate, "taxRate");
    ...
    public BillCreditNoteLineItemInput withTaxRate(Optional<? extends LinkedTaxRateInput> taxRate) {
        Utils.checkNotNull(taxRate, "taxRate");
        this.taxRate = taxRate;
        return this;
    }

    public BillCreditNoteLineItemInput withLedgerAccount(LinkedLedgerAccount ledgerAccount) {
        Utils.checkNotNull(ledgerAccount, "ledgerAccount");
        this.ledgerAccount = JsonNullable.of(ledgerAccount);
        return this;
    }

    public BillCreditNoteLineItemInput withLedgerAccount(JsonNullable<? extends LinkedLedgerAccount> ledgerAccount) {
        Utils.checkNotNull(ledgerAccount, "ledgerAccount");
        this.ledgerAccount = ledgerAccount;
        return this;
    }
     ...
     * A list of linked tracking categories.
     */
    public BillCreditNoteLineItemInput withTrackingCategories(List<LinkedTrackingCategory> trackingCategories) {
        Utils.checkNotNull(trackingCategories, "trackingCategories");
     ...
     * A list of linked tracking categories.
     */
    public BillCreditNoteLineItemInput withTrackingCategories(JsonNullable<? extends List<LinkedTrackingCategory>> trackingCategories) {
        Utils.checkNotNull(trackingCategories, "trackingCategories");
        this.trackingCategories = trackingCategories;
        return this;
    }
     ...
     * time an update is made to the object.
     */
    public BillCreditNoteLineItemInput withRowVersion(String rowVersion) {
        Utils.checkNotNull(rowVersion, "rowVersion");
     ...
     * time an update is made to the object.
     */
    public BillCreditNoteLineItemInput withRowVersion(JsonNullable<String> rowVersion) {
        Utils.checkNotNull(rowVersion, "rowVersion");
        this.rowVersion = rowVersion;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        BillCreditNoteLineItemInput other = (BillCreditNoteLineItemInput) o;
        return 
    ...
    public int hashCode() {
        return Utils.enhancedHash(
            ...
            serviceDate, location, department,
            item, taxRate, ledgerAccount,
            trackingCategories, rowVersion);
    }
    
    @Override
    public String toString() {
        return Utils.toString(BillCreditNoteLineItemInput.class,
                "rowId", rowId,
                "code", code,
    ...
    public final static class Builder {
        ...
        public BillCreditNoteLineItemInput build() {

            return new BillCreditNoteLineItemInput(
                rowId, code, lineNumber,
                description, type, taxAmount,
                totalAmount, quantity, unitPrice,
                unitOfMeasure, discountPercentage, discountAmount,
