...
public class CollectionsSort {
    ...
    private Optional<? extends CollectionsSortBy> by;
    ...
    public CollectionsSort(
            Optional<? extends CollectionsSortBy> by,
    ...
    @JsonIgnore
    public Optional<CollectionsSortBy> by() {
        return (Optional<CollectionsSortBy>) by;
    }
     ...
     * The field on which to sort the Collections
     */
    public CollectionsSort withBy(CollectionsSortBy by) {
        Utils.checkNotNull(by, "by");
     ...
     * The field on which to sort the Collections
     */
    public CollectionsSort withBy(Optional<? extends CollectionsSortBy> by) {
        Utils.checkNotNull(by, "by");
        this.by = by;
        return this;
    }
     ...
     * The direction in which to sort the results
     */
    public CollectionsSort withDirection(SortDirection direction) {
        Utils.checkNotNull(direction, "direction");
     ...
     * The direction in which to sort the results
     */
    public CollectionsSort withDirection(Optional<? extends SortDirection> direction) {
        Utils.checkNotNull(direction, "direction");
        this.direction = direction;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CollectionsSort other = (CollectionsSort) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CollectionsSort.class,
                "by", by,
                "direction", direction);
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends CollectionsSortBy> by = Optional.empty();
         ...
         * The field on which to sort the Collections
         */
        public Builder by(CollectionsSortBy by) {
            Utils.checkNotNull(by, "by");
            this.by = Optional.ofNullable(by);
            return this;
        }
         ...
         * The field on which to sort the Collections
         */
        public Builder by(Optional<? extends CollectionsSortBy> by) {
            Utils.checkNotNull(by, "by");
            this.by = by;
            return this;
        }
