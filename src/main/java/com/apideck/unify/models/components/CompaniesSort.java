...
public class CompaniesSort {
    ...
    private Optional<? extends CompaniesSortBy> by;
    ...
    public CompaniesSort(
            Optional<? extends CompaniesSortBy> by,
    ...
    @JsonIgnore
    public Optional<CompaniesSortBy> by() {
        return (Optional<CompaniesSortBy>) by;
    }
     ...
     * The field on which to sort the Companies
     */
    public CompaniesSort withBy(CompaniesSortBy by) {
        Utils.checkNotNull(by, "by");
     ...
     * The field on which to sort the Companies
     */
    public CompaniesSort withBy(Optional<? extends CompaniesSortBy> by) {
        Utils.checkNotNull(by, "by");
        this.by = by;
        return this;
    }
     ...
     * The direction in which to sort the results
     */
    public CompaniesSort withDirection(SortDirection direction) {
        Utils.checkNotNull(direction, "direction");
     ...
     * The direction in which to sort the results
     */
    public CompaniesSort withDirection(Optional<? extends SortDirection> direction) {
        Utils.checkNotNull(direction, "direction");
        this.direction = direction;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CompaniesSort other = (CompaniesSort) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CompaniesSort.class,
                "by", by,
                "direction", direction);
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends CompaniesSortBy> by = Optional.empty();
         ...
         * The field on which to sort the Companies
         */
        public Builder by(CompaniesSortBy by) {
            Utils.checkNotNull(by, "by");
            this.by = Optional.ofNullable(by);
            return this;
        }
         ...
         * The field on which to sort the Companies
         */
        public Builder by(Optional<? extends CompaniesSortBy> by) {
            Utils.checkNotNull(by, "by");
            this.by = by;
            return this;
        }
        ...
        public CompaniesSort build() {
            if (direction == null) {
                direction = _SINGLETON_VALUE_Direction.value();
            }
            return new CompaniesSort(
                by,
                direction);
        }
