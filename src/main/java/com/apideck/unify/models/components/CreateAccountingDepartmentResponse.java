...
public class CreateAccountingDepartmentResponse {
     ...
     * HTTP Response Status
     */
    public CreateAccountingDepartmentResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public CreateAccountingDepartmentResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public CreateAccountingDepartmentResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public CreateAccountingDepartmentResponse withOperation(@Nonnull String operation) {
     ...
     * A object containing a unique identifier for the resource that was created, updated, or deleted.
     */
    public CreateAccountingDepartmentResponse withData(@Nonnull UnifiedId data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public CreateAccountingDepartmentResponse withRaw(@Nullable Map<String, Object> raw) {
