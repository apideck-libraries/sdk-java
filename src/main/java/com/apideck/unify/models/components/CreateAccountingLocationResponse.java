...
public class CreateAccountingLocationResponse {
     ...
     * HTTP Response Status
     */
    public CreateAccountingLocationResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public CreateAccountingLocationResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public CreateAccountingLocationResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public CreateAccountingLocationResponse withOperation(@Nonnull String operation) {
     ...
     * A object containing a unique identifier for the resource that was created, updated, or deleted.
     */
    public CreateAccountingLocationResponse withData(@Nonnull UnifiedId data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public CreateAccountingLocationResponse withRaw(@Nullable Map<String, Object> raw) {
