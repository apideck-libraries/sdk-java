...
public class CreateActivityResponse {
     ...
     * HTTP Response Status
     */
    public CreateActivityResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public CreateActivityResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public CreateActivityResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public CreateActivityResponse withOperation(@Nonnull String operation) {
     ...
     * A object containing a unique identifier for the resource that was created, updated, or deleted.
     */
    public CreateActivityResponse withData(@Nonnull UnifiedId data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public CreateActivityResponse withRaw(@Nullable Map<String, Object> raw) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CreateActivityResponse other = (CreateActivityResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CreateActivityResponse.class,
