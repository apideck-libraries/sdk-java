...
public class CreateApplicationResponse {
     ...
     * HTTP Response Status
     */
    public CreateApplicationResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public CreateApplicationResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public CreateApplicationResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public CreateApplicationResponse withOperation(@Nonnull String operation) {
     ...
     * A object containing a unique identifier for the resource that was created, updated, or deleted.
     */
    public CreateApplicationResponse withData(@Nonnull UnifiedId data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public CreateApplicationResponse withRaw(@Nullable Map<String, Object> raw) {
    ...
    public String toString() {
        return Utils.toString(CreateApplicationResponse.class,
