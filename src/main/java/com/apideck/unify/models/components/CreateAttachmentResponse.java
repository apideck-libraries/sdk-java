...
public class CreateAttachmentResponse {
     ...
     * HTTP Response Status
     */
    public CreateAttachmentResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public CreateAttachmentResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public CreateAttachmentResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public CreateAttachmentResponse withOperation(@Nonnull String operation) {
     ...
     * A object containing a unique identifier for the resource that was created, updated, or deleted.
     */
    public CreateAttachmentResponse withData(@Nonnull UnifiedId data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public CreateAttachmentResponse withRaw(@Nullable Map<String, Object> raw) {
