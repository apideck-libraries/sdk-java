...
public class CreateBankFeedAccountResponse {
     ...
     * HTTP Response Status
     */
    public CreateBankFeedAccountResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public CreateBankFeedAccountResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public CreateBankFeedAccountResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public CreateBankFeedAccountResponse withOperation(@Nonnull String operation) {
     ...
     * A object containing a unique identifier for the resource that was created, updated, or deleted.
     */
    public CreateBankFeedAccountResponse withData(@Nonnull UnifiedId data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public CreateBankFeedAccountResponse withRaw(@Nullable Map<String, Object> raw) {
