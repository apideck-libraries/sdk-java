...
public class CreateBankFeedStatementResponse {
     ...
     * HTTP Response Status
     */
    public CreateBankFeedStatementResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public CreateBankFeedStatementResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public CreateBankFeedStatementResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public CreateBankFeedStatementResponse withOperation(@Nonnull String operation) {
     ...
     * A object containing a unique identifier for the resource that was created, updated, or deleted.
     */
    public CreateBankFeedStatementResponse withData(@Nonnull UnifiedId data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public CreateBankFeedStatementResponse withRaw(@Nullable Map<String, Object> raw) {
