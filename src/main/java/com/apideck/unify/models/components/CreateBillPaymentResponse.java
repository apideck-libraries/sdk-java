...
public class CreateBillPaymentResponse {
     ...
     * HTTP Response Status
     */
    public CreateBillPaymentResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public CreateBillPaymentResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public CreateBillPaymentResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public CreateBillPaymentResponse withOperation(@Nonnull String operation) {
     ...
     * A object containing a unique identifier for the resource that was created, updated, or deleted.
     */
    public CreateBillPaymentResponse withData(@Nonnull UnifiedId data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public CreateBillPaymentResponse withRaw(@Nullable Map<String, Object> raw) {
