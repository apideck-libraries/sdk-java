...
public class CreateBillResponse {
     ...
     * HTTP Response Status
     */
    public CreateBillResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public CreateBillResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public CreateBillResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public CreateBillResponse withOperation(@Nonnull String operation) {
     ...
     * A object containing a unique identifier for the resource that was created, updated, or deleted.
     */
    public CreateBillResponse withData(@Nonnull UnifiedId data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public CreateBillResponse withRaw(@Nullable Map<String, Object> raw) {
