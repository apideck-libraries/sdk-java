...
public class CreateCommentResponse {
     ...
     * HTTP Response Status
     */
    public CreateCommentResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public CreateCommentResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public CreateCommentResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public CreateCommentResponse withOperation(@Nonnull String operation) {
     ...
     * A object containing a unique identifier for the resource that was created, updated, or deleted.
     */
    public CreateCommentResponse withData(@Nonnull UnifiedId data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public CreateCommentResponse withRaw(@Nullable Map<String, Object> raw) {
