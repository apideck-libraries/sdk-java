...
public class CreateCompanyResponse {
     ...
     * HTTP Response Status
     */
    public CreateCompanyResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public CreateCompanyResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public CreateCompanyResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public CreateCompanyResponse withOperation(@Nonnull String operation) {
     ...
     * A object containing a unique identifier for the resource that was created, updated, or deleted.
     */
    public CreateCompanyResponse withData(@Nonnull UnifiedId data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public CreateCompanyResponse withRaw(@Nullable Map<String, Object> raw) {
