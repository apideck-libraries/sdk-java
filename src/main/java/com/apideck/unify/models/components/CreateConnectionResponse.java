...
public class CreateConnectionResponse {
     ...
     * HTTP Response Status
     */
    public CreateConnectionResponse withStatus(@Nonnull String status) {
        this.status = Utils.checkNotNull(status, "status");
        return this;
    }


    public CreateConnectionResponse withData(@Nonnull Connection data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public CreateConnectionResponse withRaw(@Nullable Map<String, Object> raw) {
