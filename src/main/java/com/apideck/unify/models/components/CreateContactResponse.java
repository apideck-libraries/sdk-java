...
public class CreateContactResponse {
     ...
     * HTTP Response Status
     */
    public CreateContactResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public CreateContactResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public CreateContactResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public CreateContactResponse withOperation(@Nonnull String operation) {
     ...
     * A object containing a unique identifier for the resource that was created, updated, or deleted.
     */
    public CreateContactResponse withData(@Nonnull UnifiedId data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public CreateContactResponse withRaw(@Nullable Map<String, Object> raw) {
    ...
    public String toString() {
        return Utils.toString(CreateContactResponse.class,
