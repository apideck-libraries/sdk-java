...
public class CreateCreditNoteResponse {
     ...
     * HTTP Response Status
     */
    public CreateCreditNoteResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public CreateCreditNoteResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public CreateCreditNoteResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public CreateCreditNoteResponse withOperation(@Nonnull String operation) {
     ...
     * A object containing a unique identifier for the resource that was created, updated, or deleted.
     */
    public CreateCreditNoteResponse withData(@Nonnull UnifiedId data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public CreateCreditNoteResponse withRaw(@Nullable Map<String, Object> raw) {
