...
public class CreateCustomerResponse {
     ...
     * HTTP Response Status
     */
    public CreateCustomerResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public CreateCustomerResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public CreateCustomerResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public CreateCustomerResponse withOperation(@Nonnull String operation) {
     ...
     * A object containing a unique identifier for the resource that was created, updated, or deleted.
     */
    public CreateCustomerResponse withData(@Nonnull UnifiedId data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public CreateCustomerResponse withRaw(@Nullable Map<String, Object> raw) {
