...
public class CreateExpenseResponse {
     ...
     * HTTP Response Status
     */
    public CreateExpenseResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public CreateExpenseResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public CreateExpenseResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public CreateExpenseResponse withOperation(@Nonnull String operation) {
     ...
     * A object containing a unique identifier for the resource that was created, updated, or deleted.
     */
    public CreateExpenseResponse withData(@Nonnull UnifiedId data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public CreateExpenseResponse withRaw(@Nullable Map<String, Object> raw) {
