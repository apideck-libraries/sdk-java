...
public class CreateHrisCompanyResponse {
     ...
     * HTTP Response Status
     */
    public CreateHrisCompanyResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public CreateHrisCompanyResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public CreateHrisCompanyResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public CreateHrisCompanyResponse withOperation(@Nonnull String operation) {
     ...
     * A object containing a unique identifier for the resource that was created, updated, or deleted.
     */
    public CreateHrisCompanyResponse withData(@Nonnull UnifiedId data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public CreateHrisCompanyResponse withRaw(@Nullable Map<String, Object> raw) {
