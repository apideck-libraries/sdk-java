...
public class CreateInvoiceItemResponse {
     ...
     * HTTP Response Status
     */
    public CreateInvoiceItemResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public CreateInvoiceItemResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public CreateInvoiceItemResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public CreateInvoiceItemResponse withOperation(@Nonnull String operation) {
     ...
     * A object containing a unique identifier for the resource that was created, updated, or deleted.
     */
    public CreateInvoiceItemResponse withData(@Nonnull UnifiedId data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public CreateInvoiceItemResponse withRaw(@Nullable Map<String, Object> raw) {
