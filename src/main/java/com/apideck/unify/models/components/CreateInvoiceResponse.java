...
public class CreateInvoiceResponse {
     ...
     * HTTP Response Status
     */
    public CreateInvoiceResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public CreateInvoiceResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public CreateInvoiceResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public CreateInvoiceResponse withOperation(@Nonnull String operation) {
        this.operation = Utils.checkNotNull(operation, "operation");
        return this;
    }


    public CreateInvoiceResponse withData(@Nonnull InvoiceResponse data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public CreateInvoiceResponse withRaw(@Nullable Map<String, Object> raw) {
