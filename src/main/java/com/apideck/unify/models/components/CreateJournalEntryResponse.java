...
public class CreateJournalEntryResponse {
     ...
     * HTTP Response Status
     */
    public CreateJournalEntryResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public CreateJournalEntryResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public CreateJournalEntryResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public CreateJournalEntryResponse withOperation(@Nonnull String operation) {
     ...
     * A object containing a unique identifier for the resource that was created, updated, or deleted.
     */
    public CreateJournalEntryResponse withData(@Nonnull UnifiedId data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public CreateJournalEntryResponse withRaw(@Nullable Map<String, Object> raw) {
