...
public class CreatePurchaseOrderResponse {
     ...
     * HTTP Response Status
     */
    public CreatePurchaseOrderResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public CreatePurchaseOrderResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public CreatePurchaseOrderResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public CreatePurchaseOrderResponse withOperation(@Nonnull String operation) {
     ...
     * A object containing a unique identifier for the resource that was created, updated, or deleted.
     */
    public CreatePurchaseOrderResponse withData(@Nonnull UnifiedId data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public CreatePurchaseOrderResponse withRaw(@Nullable Map<String, Object> raw) {
