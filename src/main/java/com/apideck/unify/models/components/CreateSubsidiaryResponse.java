...
public class CreateSubsidiaryResponse {
     ...
     * HTTP Response Status
     */
    public CreateSubsidiaryResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public CreateSubsidiaryResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public CreateSubsidiaryResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public CreateSubsidiaryResponse withOperation(@Nonnull String operation) {
     ...
     * A object containing a unique identifier for the resource that was created, updated, or deleted.
     */
    public CreateSubsidiaryResponse withData(@Nonnull UnifiedId data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public CreateSubsidiaryResponse withRaw(@Nullable Map<String, Object> raw) {
