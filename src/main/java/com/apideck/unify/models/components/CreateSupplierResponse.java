...
public class CreateSupplierResponse {
     ...
     * HTTP Response Status
     */
    public CreateSupplierResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public CreateSupplierResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public CreateSupplierResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public CreateSupplierResponse withOperation(@Nonnull String operation) {
     ...
     * A object containing a unique identifier for the resource that was created, updated, or deleted.
     */
    public CreateSupplierResponse withData(@Nonnull UnifiedId data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public CreateSupplierResponse withRaw(@Nullable Map<String, Object> raw) {
