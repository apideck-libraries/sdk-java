...
public class CreateTimeOffRequestResponse {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public CreateTimeOffRequestResponse withRaw(Map<String, Object> raw) {
        Utils.checkNotNull(raw, "raw");
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public CreateTimeOffRequestResponse withRaw(JsonNullable<? extends Map<String, Object>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
