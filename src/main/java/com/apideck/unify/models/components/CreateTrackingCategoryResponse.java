...
public class CreateTrackingCategoryResponse {
     ...
     * HTTP Response Status
     */
    public CreateTrackingCategoryResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public CreateTrackingCategoryResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public CreateTrackingCategoryResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public CreateTrackingCategoryResponse withOperation(@Nonnull String operation) {
     ...
     * A object containing a unique identifier for the resource that was created, updated, or deleted.
     */
    public CreateTrackingCategoryResponse withData(@Nonnull UnifiedId data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public CreateTrackingCategoryResponse withRaw(@Nullable Map<String, Object> raw) {
