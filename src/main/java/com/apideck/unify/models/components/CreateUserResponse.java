...
public class CreateUserResponse {
     ...
     * HTTP Response Status
     */
    public CreateUserResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public CreateUserResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public CreateUserResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public CreateUserResponse withOperation(@Nonnull String operation) {
     ...
     * A object containing a unique identifier for the resource that was created, updated, or deleted.
     */
    public CreateUserResponse withData(@Nonnull UnifiedId data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public CreateUserResponse withRaw(@Nullable Map<String, Object> raw) {
