...
public class CreateWebhookResponse {
     ...
     * HTTP Response Status
     */
    public CreateWebhookResponse withStatus(@Nonnull String status) {
        this.status = Utils.checkNotNull(status, "status");
        return this;
    }


    public CreateWebhookResponse withData(@Nonnull Webhook data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public CreateWebhookResponse withRaw(@Nullable Map<String, Object> raw) {
