...
public class CustomObjectSchema {
    ...
    @JsonAnySetter
    public CustomObjectSchema withAdditionalProperty(String key, Object value) {
        // note that value can be null because of the way JsonAnySetter works
        Utils.checkNotNull(key, "key");
        additionalProperties.put(key, value); 
        return this;
    }
    public CustomObjectSchema withAdditionalProperties(Map<String, Object> additionalProperties) {
