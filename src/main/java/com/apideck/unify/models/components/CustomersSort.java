...
public class CustomersSort {
     ...
     * The field on which to sort the Customers
     */
    public CustomersSort withBy(@Nullable CustomersSortBy by) {
        this.by = by;
        return this;
    }
     ...
     * The direction in which to sort the results
     */
    public CustomersSort withDirection(@Nullable SortDirection direction) {
    ...
    public final static class Builder {
         ...
         * The field on which to sort the Customers
         */
        public Builder by(@Nullable CustomersSortBy by) {
            this.by = by;
            return this;
        }
