...
public class DataScopes {
     ...
     * Whether Data Scopes is enabled for this application
     */
    public DataScopes withEnabled(boolean enabled) {
        Utils.checkNotNull(enabled, "enabled");
     ...
     * Whether Data Scopes is enabled for this application
     */
    public DataScopes withEnabled(Optional<Boolean> enabled) {
        Utils.checkNotNull(enabled, "enabled");
        this.enabled = enabled;
        return this;
    }
     ...
     * ISO timestamp of when the Data Scopes configuration was last modified
     */
    public DataScopes withUpdatedAt(String updatedAt) {
        Utils.checkNotNull(updatedAt, "updatedAt");
     ...
     * ISO timestamp of when the Data Scopes configuration was last modified
     */
    public DataScopes withUpdatedAt(Optional<String> updatedAt) {
        Utils.checkNotNull(updatedAt, "updatedAt");
        this.updatedAt = updatedAt;
        return this;
    }
     ...
     * Data scopes resource configuration that can be either detailed field permissions or a wildcard
     */
    public DataScopes withResources(DataScopesResources resources) {
        Utils.checkNotNull(resources, "resources");
     ...
     * Data scopes resource configuration that can be either detailed field permissions or a wildcard
     */
    public DataScopes withResources(Optional<? extends DataScopesResources> resources) {
        Utils.checkNotNull(resources, "resources");
        this.resources = resources;
        return this;
    }
    ...
    public int hashCode() {
        return Utils.enhancedHash(
            enabled, updatedAt, resources);
    }
    
    @Override
    public String toString() {
        return Utils.toString(DataScopes.class,
                "enabled", enabled,
                "updatedAt", updatedAt,
                "resources", resources);
    }
    ...
    public final static class Builder {
        ...
        public DataScopes build() {

            return new DataScopes(
                enabled, updatedAt, resources);
        }
