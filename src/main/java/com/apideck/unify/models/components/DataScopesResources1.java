...
public class DataScopesResources1 {
     ...
     * Whether the field can be read
     */
    public DataScopesResources1 withRead(boolean read) {
        Utils.checkNotNull(read, "read");
     ...
     * Whether the field can be read
     */
    public DataScopesResources1 withRead(Optional<Boolean> read) {
        Utils.checkNotNull(read, "read");
        this.read = read;
        return this;
    }
     ...
     * Whether the field can be written to
     */
    public DataScopesResources1 withWrite(boolean write) {
        Utils.checkNotNull(write, "write");
     ...
     * Whether the field can be written to
     */
    public DataScopesResources1 withWrite(Optional<Boolean> write) {
        Utils.checkNotNull(write, "write");
        this.write = write;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        DataScopesResources1 other = (DataScopesResources1) o;
        return 
    ...
    public String toString() {
        return Utils.toString(DataScopesResources1.class,
                "read", read,
                "write", write);
    }
    ...
    public final static class Builder {
        ...
        public DataScopesResources1 build() {

            return new DataScopesResources1(
                read, write);
        }
