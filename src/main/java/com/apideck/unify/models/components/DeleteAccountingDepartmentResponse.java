...
public class DeleteAccountingDepartmentResponse {
     ...
     * HTTP Response Status
     */
    public DeleteAccountingDepartmentResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public DeleteAccountingDepartmentResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public DeleteAccountingDepartmentResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public DeleteAccountingDepartmentResponse withOperation(@Nonnull String operation) {
     ...
     * A object containing a unique identifier for the resource that was created, updated, or deleted.
     */
    public DeleteAccountingDepartmentResponse withData(@Nonnull UnifiedId data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public DeleteAccountingDepartmentResponse withRaw(@Nullable Map<String, Object> raw) {
