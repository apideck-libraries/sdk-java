...
public class DeleteAccountingLocationResponse {
     ...
     * HTTP Response Status
     */
    public DeleteAccountingLocationResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public DeleteAccountingLocationResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public DeleteAccountingLocationResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public DeleteAccountingLocationResponse withOperation(@Nonnull String operation) {
     ...
     * A object containing a unique identifier for the resource that was created, updated, or deleted.
     */
    public DeleteAccountingLocationResponse withData(@Nonnull UnifiedId data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public DeleteAccountingLocationResponse withRaw(@Nullable Map<String, Object> raw) {
