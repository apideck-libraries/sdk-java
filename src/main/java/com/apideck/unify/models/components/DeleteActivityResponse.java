...
public class DeleteActivityResponse {
     ...
     * HTTP Response Status
     */
    public DeleteActivityResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public DeleteActivityResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public DeleteActivityResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public DeleteActivityResponse withOperation(@Nonnull String operation) {
     ...
     * A object containing a unique identifier for the resource that was created, updated, or deleted.
     */
    public DeleteActivityResponse withData(@Nonnull UnifiedId data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public DeleteActivityResponse withRaw(@Nullable Map<String, Object> raw) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        DeleteActivityResponse other = (DeleteActivityResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(DeleteActivityResponse.class,
