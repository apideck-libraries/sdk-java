...
public class DeleteApplicantResponse {
     ...
     * HTTP Response Status
     */
    public DeleteApplicantResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public DeleteApplicantResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public DeleteApplicantResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public DeleteApplicantResponse withOperation(@Nonnull String operation) {
     ...
     * A object containing a unique identifier for the resource that was created, updated, or deleted.
     */
    public DeleteApplicantResponse withData(@Nonnull UnifiedId data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public DeleteApplicantResponse withRaw(@Nullable Map<String, Object> raw) {
