...
public class DeleteApplicationResponse {
     ...
     * HTTP Response Status
     */
    public DeleteApplicationResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public DeleteApplicationResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public DeleteApplicationResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public DeleteApplicationResponse withOperation(@Nonnull String operation) {
     ...
     * A object containing a unique identifier for the resource that was created, updated, or deleted.
     */
    public DeleteApplicationResponse withData(@Nonnull UnifiedId data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public DeleteApplicationResponse withRaw(@Nullable Map<String, Object> raw) {
    ...
    public String toString() {
        return Utils.toString(DeleteApplicationResponse.class,
