...
public class DeleteBankFeedAccountResponse {
     ...
     * HTTP Response Status
     */
    public DeleteBankFeedAccountResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public DeleteBankFeedAccountResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public DeleteBankFeedAccountResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public DeleteBankFeedAccountResponse withOperation(@Nonnull String operation) {
     ...
     * A object containing a unique identifier for the resource that was created, updated, or deleted.
     */
    public DeleteBankFeedAccountResponse withData(@Nonnull UnifiedId data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public DeleteBankFeedAccountResponse withRaw(@Nullable Map<String, Object> raw) {
