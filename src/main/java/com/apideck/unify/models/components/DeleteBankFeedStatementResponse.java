...
public class DeleteBankFeedStatementResponse {
     ...
     * HTTP Response Status
     */
    public DeleteBankFeedStatementResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public DeleteBankFeedStatementResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public DeleteBankFeedStatementResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public DeleteBankFeedStatementResponse withOperation(@Nonnull String operation) {
     ...
     * A object containing a unique identifier for the resource that was created, updated, or deleted.
     */
    public DeleteBankFeedStatementResponse withData(@Nonnull UnifiedId data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public DeleteBankFeedStatementResponse withRaw(@Nullable Map<String, Object> raw) {
