...
public class DeleteBillPaymentResponse {
     ...
     * HTTP Response Status
     */
    public DeleteBillPaymentResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public DeleteBillPaymentResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public DeleteBillPaymentResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public DeleteBillPaymentResponse withOperation(@Nonnull String operation) {
     ...
     * A object containing a unique identifier for the resource that was created, updated, or deleted.
     */
    public DeleteBillPaymentResponse withData(@Nonnull UnifiedId data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public DeleteBillPaymentResponse withRaw(@Nullable Map<String, Object> raw) {
