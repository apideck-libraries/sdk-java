...
public class DeleteCompanyResponse {
     ...
     * HTTP Response Status
     */
    public DeleteCompanyResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public DeleteCompanyResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public DeleteCompanyResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public DeleteCompanyResponse withOperation(@Nonnull String operation) {
     ...
     * A object containing a unique identifier for the resource that was created, updated, or deleted.
     */
    public DeleteCompanyResponse withData(@Nonnull UnifiedId data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public DeleteCompanyResponse withRaw(@Nullable Map<String, Object> raw) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        DeleteCompanyResponse other = (DeleteCompanyResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(DeleteCompanyResponse.class,
