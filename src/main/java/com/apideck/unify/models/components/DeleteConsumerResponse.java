...
public class DeleteConsumerResponse {
    ...
    public DeleteConsumerResponse(
            ...
            @JsonProperty("data") @Nonnull DeleteConsumerResponseData data,
    ...
    public DeleteConsumerResponse(
            ...
            @Nonnull DeleteConsumerResponseData data) {
     ...
     * HTTP Response Status
     */
    public DeleteConsumerResponse withStatus(@Nonnull String status) {
        this.status = Utils.checkNotNull(status, "status");
        return this;
    }


    public DeleteConsumerResponse withData(@Nonnull DeleteConsumerResponseData data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public DeleteConsumerResponse withRaw(@Nullable Map<String, Object> raw) {
    ...
    public final static class Builder {
        ...
        public Builder data(@Nonnull DeleteConsumerResponseData data) {
            this.data = Utils.checkNotNull(data, "data");
            return this;
        }
