...
public class DeleteCreditNoteResponse {
     ...
     * HTTP Response Status
     */
    public DeleteCreditNoteResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public DeleteCreditNoteResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public DeleteCreditNoteResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public DeleteCreditNoteResponse withOperation(@Nonnull String operation) {
     ...
     * A object containing a unique identifier for the resource that was created, updated, or deleted.
     */
    public DeleteCreditNoteResponse withData(@Nonnull UnifiedId data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public DeleteCreditNoteResponse withRaw(@Nullable Map<String, Object> raw) {
