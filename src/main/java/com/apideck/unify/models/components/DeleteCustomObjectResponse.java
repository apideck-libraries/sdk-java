...
public class DeleteCustomObjectResponse {
     ...
     * HTTP Response Status
     */
    public DeleteCustomObjectResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public DeleteCustomObjectResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public DeleteCustomObjectResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public DeleteCustomObjectResponse withOperation(@Nonnull String operation) {
     ...
     * A object containing a unique identifier for the resource that was created, updated, or deleted.
     */
    public DeleteCustomObjectResponse withData(@Nonnull UnifiedId data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public DeleteCustomObjectResponse withRaw(@Nullable Map<String, Object> raw) {
