...
public class DeleteCustomObjectSchemaResponse {
     ...
     * HTTP Response Status
     */
    public DeleteCustomObjectSchemaResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public DeleteCustomObjectSchemaResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public DeleteCustomObjectSchemaResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public DeleteCustomObjectSchemaResponse withOperation(@Nonnull String operation) {
     ...
     * A object containing a unique identifier for the resource that was created, updated, or deleted.
     */
    public DeleteCustomObjectSchemaResponse withData(@Nonnull UnifiedId data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public DeleteCustomObjectSchemaResponse withRaw(@Nullable Map<String, Object> raw) {
