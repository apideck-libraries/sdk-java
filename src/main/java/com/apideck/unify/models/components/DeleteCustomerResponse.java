...
public class DeleteCustomerResponse {
     ...
     * HTTP Response Status
     */
    public DeleteCustomerResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public DeleteCustomerResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public DeleteCustomerResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public DeleteCustomerResponse withOperation(@Nonnull String operation) {
     ...
     * A object containing a unique identifier for the resource that was created, updated, or deleted.
     */
    public DeleteCustomerResponse withData(@Nonnull UnifiedId data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public DeleteCustomerResponse withRaw(@Nullable Map<String, Object> raw) {
