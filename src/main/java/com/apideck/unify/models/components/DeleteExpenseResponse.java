...
public class DeleteExpenseResponse {
     ...
     * HTTP Response Status
     */
    public DeleteExpenseResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public DeleteExpenseResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public DeleteExpenseResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public DeleteExpenseResponse withOperation(@Nonnull String operation) {
     ...
     * A object containing a unique identifier for the resource that was created, updated, or deleted.
     */
    public DeleteExpenseResponse withData(@Nonnull UnifiedId data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public DeleteExpenseResponse withRaw(@Nullable Map<String, Object> raw) {
