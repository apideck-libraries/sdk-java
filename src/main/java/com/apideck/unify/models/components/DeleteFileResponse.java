...
public class DeleteFileResponse {
     ...
     * HTTP Response Status
     */
    public DeleteFileResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public DeleteFileResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public DeleteFileResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public DeleteFileResponse withOperation(@Nonnull String operation) {
     ...
     * A object containing a unique identifier for the resource that was created, updated, or deleted.
     */
    public DeleteFileResponse withData(@Nonnull UnifiedId data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public DeleteFileResponse withRaw(@Nullable Map<String, Object> raw) {
