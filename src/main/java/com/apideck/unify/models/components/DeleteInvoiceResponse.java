...
public class DeleteInvoiceResponse {
    ...
    public DeleteInvoiceResponse(
            ...
            @JsonProperty("data") @Nonnull InvoiceResponse data,
     ...
     * HTTP Response Status
     */
    public DeleteInvoiceResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public DeleteInvoiceResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public DeleteInvoiceResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public DeleteInvoiceResponse withOperation(@Nonnull String operation) {
        this.operation = Utils.checkNotNull(operation, "operation");
        return this;
    }


    public DeleteInvoiceResponse withData(@Nonnull InvoiceResponse data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public DeleteInvoiceResponse withRaw(@Nullable Map<String, Object> raw) {
    ...
    public final static class Builder {
        ...
        public Builder data(@Nonnull InvoiceResponse data) {
            this.data = Utils.checkNotNull(data, "data");
            return this;
        }
