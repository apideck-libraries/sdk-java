...
public class DeleteJournalEntryResponse {
     ...
     * HTTP Response Status
     */
    public DeleteJournalEntryResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public DeleteJournalEntryResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public DeleteJournalEntryResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public DeleteJournalEntryResponse withOperation(@Nonnull String operation) {
     ...
     * A object containing a unique identifier for the resource that was created, updated, or deleted.
     */
    public DeleteJournalEntryResponse withData(@Nonnull UnifiedId data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public DeleteJournalEntryResponse withRaw(@Nullable Map<String, Object> raw) {
