...
public class DeleteMessageResponse {
     ...
     * HTTP Response Status
     */
    public DeleteMessageResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public DeleteMessageResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public DeleteMessageResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public DeleteMessageResponse withOperation(@Nonnull String operation) {
     ...
     * A object containing a unique identifier for the resource that was created, updated, or deleted.
     */
    public DeleteMessageResponse withData(@Nonnull UnifiedId data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public DeleteMessageResponse withRaw(@Nullable Map<String, Object> raw) {
    ...
    public String toString() {
        return Utils.toString(DeleteMessageResponse.class,
