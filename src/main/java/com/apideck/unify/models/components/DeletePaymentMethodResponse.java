...
public class DeletePaymentMethodResponse {
     ...
     * HTTP Response Status Code
     */
    public DeletePaymentMethodResponse withStatusCode(long statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * HTTP Response Status
     */
    public DeletePaymentMethodResponse withStatus(String status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * Apideck ID of service provider
     */
    public DeletePaymentMethodResponse withService(String service) {
        Utils.checkNotNull(service, "service");
        this.service = service;
        return this;
    }
     ...
     * Unified API resource name
     */
    public DeletePaymentMethodResponse withResource(String resource) {
        Utils.checkNotNull(resource, "resource");
        this.resource = resource;
        return this;
    }
     ...
     * Operation performed
     */
    public DeletePaymentMethodResponse withOperation(String operation) {
        Utils.checkNotNull(operation, "operation");
        this.operation = operation;
        return this;
    }
     ...
     * A object containing a unique identifier for the resource that was created, updated, or deleted.
     */
    public DeletePaymentMethodResponse withData(UnifiedId data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public DeletePaymentMethodResponse withRaw(Map<String, Object> raw) {
        Utils.checkNotNull(raw, "raw");
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public DeletePaymentMethodResponse withRaw(JsonNullable<? extends Map<String, Object>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        DeletePaymentMethodResponse other = (DeletePaymentMethodResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(DeletePaymentMethodResponse.class,
    ...
    public final static class Builder {
        ...
        public DeletePaymentMethodResponse build() {
