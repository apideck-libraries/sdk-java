...
public class DeletePaymentResponse {
     ...
     * HTTP Response Status
     */
    public DeletePaymentResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public DeletePaymentResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public DeletePaymentResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public DeletePaymentResponse withOperation(@Nonnull String operation) {
     ...
     * A object containing a unique identifier for the resource that was created, updated, or deleted.
     */
    public DeletePaymentResponse withData(@Nonnull UnifiedId data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public DeletePaymentResponse withRaw(@Nullable Map<String, Object> raw) {
