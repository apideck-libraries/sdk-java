...
public class DeletePipelineResponse {
     ...
     * HTTP Response Status
     */
    public DeletePipelineResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public DeletePipelineResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public DeletePipelineResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public DeletePipelineResponse withOperation(@Nonnull String operation) {
     ...
     * A object containing a unique identifier for the resource that was created, updated, or deleted.
     */
    public DeletePipelineResponse withData(@Nonnull UnifiedId data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public DeletePipelineResponse withRaw(@Nullable Map<String, Object> raw) {
    ...
    public String toString() {
        return Utils.toString(DeletePipelineResponse.class,
