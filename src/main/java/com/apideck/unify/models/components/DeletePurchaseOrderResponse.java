...
public class DeletePurchaseOrderResponse {
     ...
     * HTTP Response Status
     */
    public DeletePurchaseOrderResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public DeletePurchaseOrderResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public DeletePurchaseOrderResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public DeletePurchaseOrderResponse withOperation(@Nonnull String operation) {
     ...
     * A object containing a unique identifier for the resource that was created, updated, or deleted.
     */
    public DeletePurchaseOrderResponse withData(@Nonnull UnifiedId data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public DeletePurchaseOrderResponse withRaw(@Nullable Map<String, Object> raw) {
