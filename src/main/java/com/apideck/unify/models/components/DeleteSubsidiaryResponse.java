...
public class DeleteSubsidiaryResponse {
     ...
     * HTTP Response Status
     */
    public DeleteSubsidiaryResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public DeleteSubsidiaryResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public DeleteSubsidiaryResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public DeleteSubsidiaryResponse withOperation(@Nonnull String operation) {
     ...
     * A object containing a unique identifier for the resource that was created, updated, or deleted.
     */
    public DeleteSubsidiaryResponse withData(@Nonnull UnifiedId data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public DeleteSubsidiaryResponse withRaw(@Nullable Map<String, Object> raw) {
