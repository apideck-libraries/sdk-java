...
public class DeleteTimeOffRequestResponse {
    ...
    @JsonCreator
    public DeleteTimeOffRequestResponse(
     ...
     * HTTP Response Status
     */
    public DeleteTimeOffRequestResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public DeleteTimeOffRequestResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public DeleteTimeOffRequestResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public DeleteTimeOffRequestResponse withOperation(@Nonnull String operation) {
     ...
     * A object containing a unique identifier for the resource that was created, updated, or deleted.
     */
    public DeleteTimeOffRequestResponse withData(@Nonnull UnifiedId data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public DeleteTimeOffRequestResponse withRaw(@Nullable Map<String, Object> raw) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        DeleteTimeOffRequestResponse other = (DeleteTimeOffRequestResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(DeleteTimeOffRequestResponse.class,
    ...
    public final static class Builder {
        ...
        public DeleteTimeOffRequestResponse build() {
            return new DeleteTimeOffRequestResponse(
                statusCode, status, service,
                resource, operation, data,
                raw);
        }
