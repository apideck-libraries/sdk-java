...
public class DeleteTrackingCategoryResponse {
     ...
     * HTTP Response Status
     */
    public DeleteTrackingCategoryResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public DeleteTrackingCategoryResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public DeleteTrackingCategoryResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public DeleteTrackingCategoryResponse withOperation(@Nonnull String operation) {
     ...
     * A object containing a unique identifier for the resource that was created, updated, or deleted.
     */
    public DeleteTrackingCategoryResponse withData(@Nonnull UnifiedId data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public DeleteTrackingCategoryResponse withRaw(@Nullable Map<String, Object> raw) {
