...
public class DeleteUserResponse {
     ...
     * HTTP Response Status
     */
    public DeleteUserResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public DeleteUserResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public DeleteUserResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public DeleteUserResponse withOperation(@Nonnull String operation) {
     ...
     * A object containing a unique identifier for the resource that was created, updated, or deleted.
     */
    public DeleteUserResponse withData(@Nonnull UnifiedId data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public DeleteUserResponse withRaw(@Nullable Map<String, Object> raw) {
