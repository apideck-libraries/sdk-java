...
public class DeleteWebhookResponse {
     ...
     * HTTP Response Status
     */
    public DeleteWebhookResponse withStatus(@Nonnull String status) {
        this.status = Utils.checkNotNull(status, "status");
        return this;
    }


    public DeleteWebhookResponse withData(@Nonnull Webhook data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public DeleteWebhookResponse withRaw(@Nullable Map<String, Object> raw) {
