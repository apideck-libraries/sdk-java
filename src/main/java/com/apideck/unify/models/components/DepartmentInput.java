...
public class DepartmentInput {
    ...
    @JsonAnySetter
    public DepartmentInput withAdditionalProperty(String key, Object value) {
        // note that value can be null because of the way JsonAnySetter works
        Utils.checkNotNull(key, "key");
        additionalProperties.put(key, value); 
        return this;
    }
    public DepartmentInput withAdditionalProperties(Map<String, Object> additionalProperties) {
