...
public class EcommerceStore {
     ...
     * A unique identifier for an object.
     */
    public EcommerceStore withId(Optional<String> id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
    ...
    @JsonAnySetter
    public EcommerceStore withAdditionalProperty(String key, Object value) {
        // note that value can be null because of the way JsonAnySetter works
        Utils.checkNotNull(key, "key");
        additionalProperties.put(key, value); 
        return this;
    }
    public EcommerceStore withAdditionalProperties(Map<String, Object> additionalProperties) {
