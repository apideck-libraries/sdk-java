...
public class EmployeeJob {
     ...
     * A unique identifier for an object.
     */
    public EmployeeJob withId(@Nullable String id) {
     ...
     * A unique identifier for an object.
     */
    public EmployeeJob withEmployeeId(@Nullable String employeeId) {
     ...
     * The job title of the person.
     */
    public EmployeeJob withTitle(@Nullable String title) {
     ...
     * The position and responsibilities of the person within the organization.
     */
    public EmployeeJob withRole(@Nullable String role) {
     ...
     * The date on which the employee starts working in their current job role.
     */
    public EmployeeJob withStartDate(@Nullable LocalDate startDate) {
     ...
     * The date on which the employee leaves or is expected to leave their current job role.
     */
    public EmployeeJob withEndDate(@Nullable LocalDate endDate) {
     ...
     * The rate of pay for the employee in their current job role.
     */
    public EmployeeJob withCompensationRate(@Nullable Double compensationRate) {
     ...
     * Indicates the associated currency for an amount of money. Values correspond to [ISO 4217](https://en.wikipedia.org/wiki/ISO_4217).
     */
    public EmployeeJob withCurrency(@Nullable Currency currency) {
     ...
     * Unit of measurement for employee compensation.
     */
    public EmployeeJob withPaymentUnit(@Nullable PaymentUnit paymentUnit) {
     ...
     * The date on which the employee was hired by the organization
     */
    public EmployeeJob withHiredAt(@Nullable LocalDate hiredAt) {
     ...
     * Indicates whether this the employee's primary job.
     */
    public EmployeeJob withIsPrimary(@Nullable Boolean isPrimary) {
     ...
     * Indicates whether this the employee has a manager role.
     */
    public EmployeeJob withIsManager(@Nullable Boolean isManager) {
     ...
     * Indicates the status of the job.
     */
    public EmployeeJob withStatus(@Nullable EmployeeJobStatus status) {
        this.status = JsonNullable.of(status);
        return this;
    }


    public EmployeeJob withLocation(@Nullable Address location) {
        this.location = location;
        return this;
    }
