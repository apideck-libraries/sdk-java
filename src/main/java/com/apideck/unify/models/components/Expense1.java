...
public class Expense1 {
    ...
    public Expense1(
        ...
        this(Optional.empty(), JsonNullable.undefined(), Optional.empty(),
            accountId, JsonNullable.undefined(), JsonNullable.undefined(),
     ...
     * A unique identifier for an object.
     */
    public Expense1 withId(String id) {
        Utils.checkNotNull(id, "id");
     ...
     * A unique identifier for an object.
     */
    public Expense1 withId(Optional<String> id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * Number.
     */
    public Expense1 withNumber(String number) {
        Utils.checkNotNull(number, "number");
     ...
     * Number.
     */
    public Expense1 withNumber(JsonNullable<String> number) {
        Utils.checkNotNull(number, "number");
        this.number = number;
        return this;
    }
     ...
     * The date of the transaction - YYYY:MM::DDThh:mm:ss.sTZD
     */
    public Expense1 withTransactionDate(OffsetDateTime transactionDate) {
        Utils.checkNotNull(transactionDate, "transactionDate");
     ...
     * The date of the transaction - YYYY:MM::DDThh:mm:ss.sTZD
     */
    public Expense1 withTransactionDate(Optional<OffsetDateTime> transactionDate) {
        Utils.checkNotNull(transactionDate, "transactionDate");
        this.transactionDate = transactionDate;
        return this;
    }
     ...
     */
    @Deprecated
    public Expense1 withAccountId(String accountId) {
        Utils.checkNotNull(accountId, "accountId");
        this.accountId = accountId;
        return this;
    }

    public Expense1 withAccount(LinkedLedgerAccount account) {
        Utils.checkNotNull(account, "account");
        this.account = JsonNullable.of(account);
        return this;
    }

    public Expense1 withAccount(JsonNullable<? extends LinkedLedgerAccount> account) {
        Utils.checkNotNull(account, "account");
        this.account = account;
        return this;
    }

    public Expense1 withBankAccount(LinkedBankAccount bankAccount) {
        Utils.checkNotNull(bankAccount, "bankAccount");
        this.bankAccount = JsonNullable.of(bankAccount);
        return this;
    }

    public Expense1 withBankAccount(JsonNullable<? extends LinkedBankAccount> bankAccount) {
        Utils.checkNotNull(bankAccount, "bankAccount");
        this.bankAccount = bankAccount;
        return this;
    }
     ...
     * to customers.
     */
    public Expense1 withCustomerId(String customerId) {
        Utils.checkNotNull(customerId, "customerId");
     ...
     * to customers.
     */
    public Expense1 withCustomerId(Optional<String> customerId) {
        Utils.checkNotNull(customerId, "customerId");
        this.customerId = customerId;
        return this;
    }
     ...
     * The ID of the supplier this entity is linked to.
     */
    public Expense1 withSupplierId(String supplierId) {
        Utils.checkNotNull(supplierId, "supplierId");
     ...
     * The ID of the supplier this entity is linked to.
     */
    public Expense1 withSupplierId(Optional<String> supplierId) {
        Utils.checkNotNull(supplierId, "supplierId");
        this.supplierId = supplierId;
        return this;
    }
     ...
     * The company ID the transaction belongs to
     */
    public Expense1 withCompanyId(String companyId) {
        Utils.checkNotNull(companyId, "companyId");
     ...
     * The company ID the transaction belongs to
     */
    public Expense1 withCompanyId(JsonNullable<String> companyId) {
        Utils.checkNotNull(companyId, "companyId");
        this.companyId = companyId;
        return this;
    }
     ...
     * The ID of the department
     */
    public Expense1 withDepartmentId(String departmentId) {
        Utils.checkNotNull(departmentId, "departmentId");
     ...
     * The ID of the department
     */
    public Expense1 withDepartmentId(JsonNullable<String> departmentId) {
        Utils.checkNotNull(departmentId, "departmentId");
        this.departmentId = departmentId;
        return this;
    }
     ...
     * The type of payment for the expense.
     */
    public Expense1 withPaymentType(ExpensePaymentType paymentType) {
        Utils.checkNotNull(paymentType, "paymentType");
     ...
     * The type of payment for the expense.
     */
    public Expense1 withPaymentType(JsonNullable<? extends ExpensePaymentType> paymentType) {
        Utils.checkNotNull(paymentType, "paymentType");
        this.paymentType = paymentType;
        return this;
    }
     ...
     * 4217](https://en.wikipedia.org/wiki/ISO_4217).
     */
    public Expense1 withCurrency(Currency currency) {
        Utils.checkNotNull(currency, "currency");
     ...
     * 4217](https://en.wikipedia.org/wiki/ISO_4217).
     */
    public Expense1 withCurrency(JsonNullable<? extends Currency> currency) {
        Utils.checkNotNull(currency, "currency");
        this.currency = currency;
        return this;
    }
     ...
     * Currency Exchange Rate at the time entity was recorded/generated.
     */
    public Expense1 withCurrencyRate(double currencyRate) {
        Utils.checkNotNull(currencyRate, "currencyRate");
     ...
     * Currency Exchange Rate at the time entity was recorded/generated.
     */
    public Expense1 withCurrencyRate(JsonNullable<Double> currencyRate) {
        Utils.checkNotNull(currencyRate, "currencyRate");
        this.currencyRate = currencyRate;
        return this;
    }
     ...
     * The type of expense.
     */
    public Expense1 withType(ExpenseType type) {
        Utils.checkNotNull(type, "type");
     ...
     * The type of expense.
     */
    public Expense1 withType(JsonNullable<? extends ExpenseType> type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
     ...
     * The memo of the expense.
     */
    public Expense1 withMemo(String memo) {
        Utils.checkNotNull(memo, "memo");
     ...
     * The memo of the expense.
     */
    public Expense1 withMemo(JsonNullable<String> memo) {
        Utils.checkNotNull(memo, "memo");
        this.memo = memo;
        return this;
    }

    public Expense1 withTaxRate(LinkedTaxRate taxRate) {
        Utils.checkNotNull(taxRate, "taxRate");
    ...
    public Expense1 withTaxRate(Optional<? extends LinkedTaxRate> taxRate) {
        Utils.checkNotNull(taxRate, "taxRate");
        this.taxRate = taxRate;
        return this;
    }
     ...
     * The total amount of the expense line item.
     */
    public Expense1 withTotalAmount(double totalAmount) {
        Utils.checkNotNull(totalAmount, "totalAmount");
     ...
     * The total amount of the expense line item.
     */
    public Expense1 withTotalAmount(JsonNullable<Double> totalAmount) {
        Utils.checkNotNull(totalAmount, "totalAmount");
        this.totalAmount = totalAmount;
        return this;
    }
     ...
     * Expense line items linked to this expense.
     */
    public Expense1 withLineItems(List<ExpenseLineItem> lineItems) {
        Utils.checkNotNull(lineItems, "lineItems");
        this.lineItems = lineItems;
        return this;
    }
     ...
     * Optional reference identifier for the transaction.
     */
    public Expense1 withReference(String reference) {
        Utils.checkNotNull(reference, "reference");
     ...
     * Optional reference identifier for the transaction.
     */
    public Expense1 withReference(JsonNullable<String> reference) {
        Utils.checkNotNull(reference, "reference");
        this.reference = reference;
        return this;
    }
     ...
     * supported for Xero.
     */
    public Expense1 withSourceDocumentUrl(String sourceDocumentUrl) {
        Utils.checkNotNull(sourceDocumentUrl, "sourceDocumentUrl");
     ...
     * supported for Xero.
     */
    public Expense1 withSourceDocumentUrl(JsonNullable<String> sourceDocumentUrl) {
        Utils.checkNotNull(sourceDocumentUrl, "sourceDocumentUrl");
        this.sourceDocumentUrl = sourceDocumentUrl;
        return this;
    }

    public Expense1 withCustomFields(List<CustomField> customFields) {
        Utils.checkNotNull(customFields, "customFields");
    ...
    public Expense1 withCustomFields(Optional<? extends List<CustomField>> customFields) {
        Utils.checkNotNull(customFields, "customFields");
        this.customFields = customFields;
        return this;
    }
     ...
     * When custom mappings are configured on the resource, the result is included here.
     */
    public Expense1 withCustomMappings(Map<String, Object> customMappings) {
        Utils.checkNotNull(customMappings, "customMappings");
     ...
     * When custom mappings are configured on the resource, the result is included here.
     */
    public Expense1 withCustomMappings(JsonNullable<? extends Map<String, Object>> customMappings) {
        Utils.checkNotNull(customMappings, "customMappings");
        this.customMappings = customMappings;
        return this;
    }
     ...
     * Expense status
     */
    public Expense1 withStatus(ExpenseStatus status) {
        Utils.checkNotNull(status, "status");
     ...
     * Expense status
     */
    public Expense1 withStatus(JsonNullable<? extends ExpenseStatus> status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * The date and time when the object was last updated.
     */
    public Expense1 withUpdatedAt(OffsetDateTime updatedAt) {
        Utils.checkNotNull(updatedAt, "updatedAt");
     ...
     * The date and time when the object was last updated.
     */
    public Expense1 withUpdatedAt(JsonNullable<OffsetDateTime> updatedAt) {
        Utils.checkNotNull(updatedAt, "updatedAt");
        this.updatedAt = updatedAt;
        return this;
    }
     ...
     * The date and time when the object was created.
     */
    public Expense1 withCreatedAt(OffsetDateTime createdAt) {
        Utils.checkNotNull(createdAt, "createdAt");
     ...
     * The date and time when the object was created.
     */
    public Expense1 withCreatedAt(JsonNullable<OffsetDateTime> createdAt) {
        Utils.checkNotNull(createdAt, "createdAt");
        this.createdAt = createdAt;
        return this;
    }
     ...
     * time an update is made to the object.
     */
    public Expense1 withRowVersion(String rowVersion) {
        Utils.checkNotNull(rowVersion, "rowVersion");
     ...
     * time an update is made to the object.
     */
    public Expense1 withRowVersion(JsonNullable<String> rowVersion) {
        Utils.checkNotNull(rowVersion, "rowVersion");
        this.rowVersion = rowVersion;
        return this;
    }
     ...
     * The user who last updated the object.
     */
    public Expense1 withUpdatedBy(String updatedBy) {
        Utils.checkNotNull(updatedBy, "updatedBy");
     ...
     * The user who last updated the object.
     */
    public Expense1 withUpdatedBy(JsonNullable<String> updatedBy) {
        Utils.checkNotNull(updatedBy, "updatedBy");
        this.updatedBy = updatedBy;
        return this;
    }
     ...
     * The user who created the object.
     */
    public Expense1 withCreatedBy(String createdBy) {
        Utils.checkNotNull(createdBy, "createdBy");
     ...
     * The user who created the object.
     */
    public Expense1 withCreatedBy(JsonNullable<String> createdBy) {
        Utils.checkNotNull(createdBy, "createdBy");
        this.createdBy = createdBy;
        return this;
    }
     ...
     * in request body when creating or updating resources.
     */
    public Expense1 withPassThrough(List<PassThroughBody> passThrough) {
        Utils.checkNotNull(passThrough, "passThrough");
     ...
     * in request body when creating or updating resources.
     */
    public Expense1 withPassThrough(Optional<? extends List<PassThroughBody>> passThrough) {
        Utils.checkNotNull(passThrough, "passThrough");
        this.passThrough = passThrough;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(Expense1.class,
                "id", id,
                "number", number,
