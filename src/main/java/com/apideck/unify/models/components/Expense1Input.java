...
public class Expense1Input {
     ...
     * Number.
     */
    public Expense1Input withNumber(String number) {
        Utils.checkNotNull(number, "number");
     ...
     * Number.
     */
    public Expense1Input withNumber(JsonNullable<String> number) {
        Utils.checkNotNull(number, "number");
        this.number = number;
        return this;
    }
     ...
     * The date of the transaction - YYYY:MM::DDThh:mm:ss.sTZD
     */
    public Expense1Input withTransactionDate(OffsetDateTime transactionDate) {
        Utils.checkNotNull(transactionDate, "transactionDate");
     ...
     * The date of the transaction - YYYY:MM::DDThh:mm:ss.sTZD
     */
    public Expense1Input withTransactionDate(Optional<OffsetDateTime> transactionDate) {
        Utils.checkNotNull(transactionDate, "transactionDate");
        this.transactionDate = transactionDate;
        return this;
    }
     ...
     */
    @Deprecated
    public Expense1Input withAccountId(String accountId) {
        Utils.checkNotNull(accountId, "accountId");
        this.accountId = accountId;
        return this;
    }

    public Expense1Input withAccount(LinkedLedgerAccountInput account) {
        Utils.checkNotNull(account, "account");
        this.account = JsonNullable.of(account);
        return this;
    }

    public Expense1Input withAccount(JsonNullable<? extends LinkedLedgerAccountInput> account) {
        Utils.checkNotNull(account, "account");
        this.account = account;
        return this;
    }

    public Expense1Input withBankAccount(LinkedBankAccount bankAccount) {
        Utils.checkNotNull(bankAccount, "bankAccount");
        this.bankAccount = JsonNullable.of(bankAccount);
        return this;
    }

    public Expense1Input withBankAccount(JsonNullable<? extends LinkedBankAccount> bankAccount) {
        Utils.checkNotNull(bankAccount, "bankAccount");
        this.bankAccount = bankAccount;
        return this;
    }
     ...
     * to customers.
     */
    public Expense1Input withCustomerId(String customerId) {
        Utils.checkNotNull(customerId, "customerId");
     ...
     * to customers.
     */
    public Expense1Input withCustomerId(Optional<String> customerId) {
        Utils.checkNotNull(customerId, "customerId");
        this.customerId = customerId;
        return this;
    }
     ...
     * The ID of the supplier this entity is linked to.
     */
    public Expense1Input withSupplierId(String supplierId) {
        Utils.checkNotNull(supplierId, "supplierId");
     ...
     * The ID of the supplier this entity is linked to.
     */
    public Expense1Input withSupplierId(Optional<String> supplierId) {
        Utils.checkNotNull(supplierId, "supplierId");
        this.supplierId = supplierId;
        return this;
    }
     ...
     * The company ID the transaction belongs to
     */
    public Expense1Input withCompanyId(String companyId) {
        Utils.checkNotNull(companyId, "companyId");
     ...
     * The company ID the transaction belongs to
     */
    public Expense1Input withCompanyId(JsonNullable<String> companyId) {
        Utils.checkNotNull(companyId, "companyId");
        this.companyId = companyId;
        return this;
    }
     ...
     * The ID of the department
     */
    public Expense1Input withDepartmentId(String departmentId) {
        Utils.checkNotNull(departmentId, "departmentId");
     ...
     * The ID of the department
     */
    public Expense1Input withDepartmentId(JsonNullable<String> departmentId) {
        Utils.checkNotNull(departmentId, "departmentId");
        this.departmentId = departmentId;
        return this;
    }
     ...
     * The type of payment for the expense.
     */
    public Expense1Input withPaymentType(ExpensePaymentType paymentType) {
        Utils.checkNotNull(paymentType, "paymentType");
     ...
     * The type of payment for the expense.
     */
    public Expense1Input withPaymentType(JsonNullable<? extends ExpensePaymentType> paymentType) {
        Utils.checkNotNull(paymentType, "paymentType");
        this.paymentType = paymentType;
        return this;
    }
     ...
     * 4217](https://en.wikipedia.org/wiki/ISO_4217).
     */
    public Expense1Input withCurrency(Currency currency) {
        Utils.checkNotNull(currency, "currency");
     ...
     * 4217](https://en.wikipedia.org/wiki/ISO_4217).
     */
    public Expense1Input withCurrency(JsonNullable<? extends Currency> currency) {
        Utils.checkNotNull(currency, "currency");
        this.currency = currency;
        return this;
    }
     ...
     * Currency Exchange Rate at the time entity was recorded/generated.
     */
    public Expense1Input withCurrencyRate(double currencyRate) {
        Utils.checkNotNull(currencyRate, "currencyRate");
     ...
     * Currency Exchange Rate at the time entity was recorded/generated.
     */
    public Expense1Input withCurrencyRate(JsonNullable<Double> currencyRate) {
        Utils.checkNotNull(currencyRate, "currencyRate");
        this.currencyRate = currencyRate;
        return this;
    }
     ...
     * The type of expense.
     */
    public Expense1Input withType(ExpenseType type) {
        Utils.checkNotNull(type, "type");
     ...
     * The type of expense.
     */
    public Expense1Input withType(JsonNullable<? extends ExpenseType> type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
     ...
     * The memo of the expense.
     */
    public Expense1Input withMemo(String memo) {
        Utils.checkNotNull(memo, "memo");
     ...
     * The memo of the expense.
     */
    public Expense1Input withMemo(JsonNullable<String> memo) {
        Utils.checkNotNull(memo, "memo");
        this.memo = memo;
        return this;
    }

    public Expense1Input withTaxRate(LinkedTaxRateInput taxRate) {
        Utils.checkNotNull(taxRate, "taxRate");
    ...
    public Expense1Input withTaxRate(Optional<? extends LinkedTaxRateInput> taxRate) {
        Utils.checkNotNull(taxRate, "taxRate");
        this.taxRate = taxRate;
        return this;
    }
     ...
     * The total amount of the expense line item.
     */
    public Expense1Input withTotalAmount(double totalAmount) {
        Utils.checkNotNull(totalAmount, "totalAmount");
     ...
     * The total amount of the expense line item.
     */
    public Expense1Input withTotalAmount(JsonNullable<Double> totalAmount) {
        Utils.checkNotNull(totalAmount, "totalAmount");
        this.totalAmount = totalAmount;
        return this;
    }
     ...
     * Expense line items linked to this expense.
     */
    public Expense1Input withLineItems(List<ExpenseLineItemInput> lineItems) {
        Utils.checkNotNull(lineItems, "lineItems");
        this.lineItems = lineItems;
        return this;
    }
     ...
     * Optional reference identifier for the transaction.
     */
    public Expense1Input withReference(String reference) {
        Utils.checkNotNull(reference, "reference");
     ...
     * Optional reference identifier for the transaction.
     */
    public Expense1Input withReference(JsonNullable<String> reference) {
        Utils.checkNotNull(reference, "reference");
        this.reference = reference;
        return this;
    }
     ...
     * supported for Xero.
     */
    public Expense1Input withSourceDocumentUrl(String sourceDocumentUrl) {
        Utils.checkNotNull(sourceDocumentUrl, "sourceDocumentUrl");
     ...
     * supported for Xero.
     */
    public Expense1Input withSourceDocumentUrl(JsonNullable<String> sourceDocumentUrl) {
        Utils.checkNotNull(sourceDocumentUrl, "sourceDocumentUrl");
        this.sourceDocumentUrl = sourceDocumentUrl;
        return this;
    }

    public Expense1Input withCustomFields(List<CustomField> customFields) {
        Utils.checkNotNull(customFields, "customFields");
    ...
    public Expense1Input withCustomFields(Optional<? extends List<CustomField>> customFields) {
        Utils.checkNotNull(customFields, "customFields");
        this.customFields = customFields;
        return this;
    }
     ...
     * Expense status
     */
    public Expense1Input withStatus(ExpenseStatus status) {
        Utils.checkNotNull(status, "status");
     ...
     * Expense status
     */
    public Expense1Input withStatus(JsonNullable<? extends ExpenseStatus> status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * time an update is made to the object.
     */
    public Expense1Input withRowVersion(String rowVersion) {
        Utils.checkNotNull(rowVersion, "rowVersion");
     ...
     * time an update is made to the object.
     */
    public Expense1Input withRowVersion(JsonNullable<String> rowVersion) {
        Utils.checkNotNull(rowVersion, "rowVersion");
        this.rowVersion = rowVersion;
        return this;
    }
     ...
     * in request body when creating or updating resources.
     */
    public Expense1Input withPassThrough(List<PassThroughBody> passThrough) {
        Utils.checkNotNull(passThrough, "passThrough");
     ...
     * in request body when creating or updating resources.
     */
    public Expense1Input withPassThrough(Optional<? extends List<PassThroughBody>> passThrough) {
        Utils.checkNotNull(passThrough, "passThrough");
        this.passThrough = passThrough;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        Expense1Input other = (Expense1Input) o;
        return 
    ...
    public String toString() {
        return Utils.toString(Expense1Input.class,
                "number", number,
    ...
    public final static class Builder {
        ...
        public Expense1Input build() {

            return new Expense1Input(
                number, transactionDate, accountId,
                account, bankAccount, customerId,
                supplierId, companyId, departmentId,
                paymentType, currency, currencyRate,
