...
public class Expense2Input {
    ...
    private Optional<? extends LinkedLedgerAccountInput> account;
    ...
    public Expense2Input(
            ...
            @JsonProperty("account") Optional<? extends LinkedLedgerAccountInput> account,
    ...
    @JsonIgnore
    public Optional<LinkedLedgerAccountInput> account() {
        return (Optional<LinkedLedgerAccountInput>) account;
    }
     ...
     * Number.
     */
    public Expense2Input withNumber(String number) {
        Utils.checkNotNull(number, "number");
     ...
     * Number.
     */
    public Expense2Input withNumber(JsonNullable<String> number) {
        Utils.checkNotNull(number, "number");
        this.number = number;
        return this;
    }
     ...
     * The date of the transaction - YYYY:MM::DDThh:mm:ss.sTZD
     */
    public Expense2Input withTransactionDate(OffsetDateTime transactionDate) {
        Utils.checkNotNull(transactionDate, "transactionDate");
     ...
     * The date of the transaction - YYYY:MM::DDThh:mm:ss.sTZD
     */
    public Expense2Input withTransactionDate(Optional<OffsetDateTime> transactionDate) {
        Utils.checkNotNull(transactionDate, "transactionDate");
        this.transactionDate = transactionDate;
        return this;
    }
     ...
     */
    @Deprecated
    public Expense2Input withAccountId(String accountId) {
        Utils.checkNotNull(accountId, "accountId");
     ...
     */
    @Deprecated
    public Expense2Input withAccountId(Optional<String> accountId) {
        Utils.checkNotNull(accountId, "accountId");
        this.accountId = accountId;
        return this;
    }

    public Expense2Input withAccount(LinkedLedgerAccountInput account) {
        Utils.checkNotNull(account, "account");
    ...
    public Expense2Input withAccount(Optional<? extends LinkedLedgerAccountInput> account) {
        Utils.checkNotNull(account, "account");
        this.account = account;
        return this;
    }

    public Expense2Input withBankAccount(LinkedBankAccount bankAccount) {
        Utils.checkNotNull(bankAccount, "bankAccount");
        this.bankAccount = JsonNullable.of(bankAccount);
        return this;
    }

    public Expense2Input withBankAccount(JsonNullable<? extends LinkedBankAccount> bankAccount) {
        Utils.checkNotNull(bankAccount, "bankAccount");
        this.bankAccount = bankAccount;
        return this;
    }
     ...
     * to customers.
     */
    public Expense2Input withCustomerId(String customerId) {
        Utils.checkNotNull(customerId, "customerId");
     ...
     * to customers.
     */
    public Expense2Input withCustomerId(Optional<String> customerId) {
        Utils.checkNotNull(customerId, "customerId");
        this.customerId = customerId;
        return this;
    }
     ...
     * The ID of the supplier this entity is linked to.
     */
    public Expense2Input withSupplierId(String supplierId) {
        Utils.checkNotNull(supplierId, "supplierId");
     ...
     * The ID of the supplier this entity is linked to.
     */
    public Expense2Input withSupplierId(Optional<String> supplierId) {
        Utils.checkNotNull(supplierId, "supplierId");
        this.supplierId = supplierId;
        return this;
    }
     ...
     * The company ID the transaction belongs to
     */
    public Expense2Input withCompanyId(String companyId) {
        Utils.checkNotNull(companyId, "companyId");
     ...
     * The company ID the transaction belongs to
     */
    public Expense2Input withCompanyId(JsonNullable<String> companyId) {
        Utils.checkNotNull(companyId, "companyId");
        this.companyId = companyId;
        return this;
    }
     ...
     * The ID of the department
     */
    public Expense2Input withDepartmentId(String departmentId) {
        Utils.checkNotNull(departmentId, "departmentId");
     ...
     * The ID of the department
     */
    public Expense2Input withDepartmentId(JsonNullable<String> departmentId) {
        Utils.checkNotNull(departmentId, "departmentId");
        this.departmentId = departmentId;
        return this;
    }
     ...
     * The type of payment for the expense.
     */
    public Expense2Input withPaymentType(Expense2PaymentType paymentType) {
        Utils.checkNotNull(paymentType, "paymentType");
     ...
     * The type of payment for the expense.
     */
    public Expense2Input withPaymentType(JsonNullable<? extends Expense2PaymentType> paymentType) {
        Utils.checkNotNull(paymentType, "paymentType");
        this.paymentType = paymentType;
        return this;
    }
     ...
     * 4217](https://en.wikipedia.org/wiki/ISO_4217).
     */
    public Expense2Input withCurrency(Currency currency) {
        Utils.checkNotNull(currency, "currency");
     ...
     * 4217](https://en.wikipedia.org/wiki/ISO_4217).
     */
    public Expense2Input withCurrency(JsonNullable<? extends Currency> currency) {
        Utils.checkNotNull(currency, "currency");
        this.currency = currency;
        return this;
    }
     ...
     * Currency Exchange Rate at the time entity was recorded/generated.
     */
    public Expense2Input withCurrencyRate(double currencyRate) {
        Utils.checkNotNull(currencyRate, "currencyRate");
     ...
     * Currency Exchange Rate at the time entity was recorded/generated.
     */
    public Expense2Input withCurrencyRate(JsonNullable<Double> currencyRate) {
        Utils.checkNotNull(currencyRate, "currencyRate");
        this.currencyRate = currencyRate;
        return this;
    }
     ...
     * The type of expense.
     */
    public Expense2Input withType(ExpenseExpenseType type) {
        Utils.checkNotNull(type, "type");
     ...
     * The type of expense.
     */
    public Expense2Input withType(JsonNullable<? extends ExpenseExpenseType> type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
     ...
     * The memo of the expense.
     */
    public Expense2Input withMemo(String memo) {
        Utils.checkNotNull(memo, "memo");
     ...
     * The memo of the expense.
     */
    public Expense2Input withMemo(JsonNullable<String> memo) {
        Utils.checkNotNull(memo, "memo");
        this.memo = memo;
        return this;
    }

    public Expense2Input withTaxRate(LinkedTaxRateInput taxRate) {
        Utils.checkNotNull(taxRate, "taxRate");
    ...
    public Expense2Input withTaxRate(Optional<? extends LinkedTaxRateInput> taxRate) {
        Utils.checkNotNull(taxRate, "taxRate");
        this.taxRate = taxRate;
        return this;
    }
     ...
     * The total amount of the expense line item.
     */
    public Expense2Input withTotalAmount(double totalAmount) {
        Utils.checkNotNull(totalAmount, "totalAmount");
     ...
     * The total amount of the expense line item.
     */
    public Expense2Input withTotalAmount(JsonNullable<Double> totalAmount) {
        Utils.checkNotNull(totalAmount, "totalAmount");
        this.totalAmount = totalAmount;
        return this;
    }
     ...
     * Expense line items linked to this expense.
     */
    public Expense2Input withLineItems(List<ExpenseLineItemInput> lineItems) {
        Utils.checkNotNull(lineItems, "lineItems");
        this.lineItems = lineItems;
        return this;
    }
     ...
     * Optional reference identifier for the transaction.
     */
    public Expense2Input withReference(String reference) {
        Utils.checkNotNull(reference, "reference");
     ...
     * Optional reference identifier for the transaction.
     */
    public Expense2Input withReference(JsonNullable<String> reference) {
        Utils.checkNotNull(reference, "reference");
        this.reference = reference;
        return this;
    }
     ...
     * supported for Xero.
     */
    public Expense2Input withSourceDocumentUrl(String sourceDocumentUrl) {
        Utils.checkNotNull(sourceDocumentUrl, "sourceDocumentUrl");
     ...
     * supported for Xero.
     */
    public Expense2Input withSourceDocumentUrl(JsonNullable<String> sourceDocumentUrl) {
        Utils.checkNotNull(sourceDocumentUrl, "sourceDocumentUrl");
        this.sourceDocumentUrl = sourceDocumentUrl;
        return this;
    }

    public Expense2Input withCustomFields(List<CustomField> customFields) {
        Utils.checkNotNull(customFields, "customFields");
    ...
    public Expense2Input withCustomFields(Optional<? extends List<CustomField>> customFields) {
        Utils.checkNotNull(customFields, "customFields");
        this.customFields = customFields;
        return this;
    }
     ...
     * Expense status
     */
    public Expense2Input withStatus(Expense2Status status) {
        Utils.checkNotNull(status, "status");
     ...
     * Expense status
     */
    public Expense2Input withStatus(JsonNullable<? extends Expense2Status> status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * time an update is made to the object.
     */
    public Expense2Input withRowVersion(String rowVersion) {
        Utils.checkNotNull(rowVersion, "rowVersion");
     ...
     * time an update is made to the object.
     */
    public Expense2Input withRowVersion(JsonNullable<String> rowVersion) {
        Utils.checkNotNull(rowVersion, "rowVersion");
        this.rowVersion = rowVersion;
        return this;
    }
     ...
     * in request body when creating or updating resources.
     */
    public Expense2Input withPassThrough(List<PassThroughBody> passThrough) {
        Utils.checkNotNull(passThrough, "passThrough");
     ...
     * in request body when creating or updating resources.
     */
    public Expense2Input withPassThrough(Optional<? extends List<PassThroughBody>> passThrough) {
        Utils.checkNotNull(passThrough, "passThrough");
        this.passThrough = passThrough;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        Expense2Input other = (Expense2Input) o;
        return 
    ...
    public int hashCode() {
        return Utils.enhancedHash(
            ...
            supplierId, companyId, departmentId,
    ...
    public String toString() {
        return Utils.toString(Expense2Input.class,
                "number", number,
    ...
    public final static class Builder {
        ...
        private Optional<? extends LinkedLedgerAccountInput> account = Optional.empty();
        ...
        public Builder account(Optional<? extends LinkedLedgerAccountInput> account) {
            Utils.checkNotNull(account, "account");
            this.account = account;
            return this;
        }
        ...
        public Expense2Input build() {

            return new Expense2Input(
                number, transactionDate, accountId,
                account, bankAccount, customerId,
                supplierId, companyId, departmentId,
                paymentType, currency, currencyRate,
