...
public class Expense3 {
     ...
     * Number.
     */
    public Expense3 withNumber(String number) {
        Utils.checkNotNull(number, "number");
     ...
     * Number.
     */
    public Expense3 withNumber(JsonNullable<String> number) {
        Utils.checkNotNull(number, "number");
        this.number = number;
        return this;
    }
     ...
     * The date of the transaction - YYYY:MM::DDThh:mm:ss.sTZD
     */
    public Expense3 withTransactionDate(OffsetDateTime transactionDate) {
        Utils.checkNotNull(transactionDate, "transactionDate");
     ...
     * The date of the transaction - YYYY:MM::DDThh:mm:ss.sTZD
     */
    public Expense3 withTransactionDate(Optional<OffsetDateTime> transactionDate) {
        Utils.checkNotNull(transactionDate, "transactionDate");
        this.transactionDate = transactionDate;
        return this;
    }
     ...
     */
    @Deprecated
    public Expense3 withAccountId(String accountId) {
        Utils.checkNotNull(accountId, "accountId");
     ...
     */
    @Deprecated
    public Expense3 withAccountId(Optional<String> accountId) {
        Utils.checkNotNull(accountId, "accountId");
        this.accountId = accountId;
        return this;
    }

    public Expense3 withAccount(LinkedLedgerAccountInput account) {
        Utils.checkNotNull(account, "account");
        this.account = JsonNullable.of(account);
        return this;
    }

    public Expense3 withAccount(JsonNullable<? extends LinkedLedgerAccountInput> account) {
        Utils.checkNotNull(account, "account");
        this.account = account;
        return this;
    }

    public Expense3 withBankAccount(LinkedBankAccount bankAccount) {
        Utils.checkNotNull(bankAccount, "bankAccount");
    ...
    public Expense3 withBankAccount(Optional<? extends LinkedBankAccount> bankAccount) {
        Utils.checkNotNull(bankAccount, "bankAccount");
        this.bankAccount = bankAccount;
        return this;
    }
     ...
     * to customers.
     */
    public Expense3 withCustomerId(String customerId) {
        Utils.checkNotNull(customerId, "customerId");
     ...
     * to customers.
     */
    public Expense3 withCustomerId(Optional<String> customerId) {
        Utils.checkNotNull(customerId, "customerId");
        this.customerId = customerId;
        return this;
    }
     ...
     * The ID of the supplier this entity is linked to.
     */
    public Expense3 withSupplierId(String supplierId) {
        Utils.checkNotNull(supplierId, "supplierId");
     ...
     * The ID of the supplier this entity is linked to.
     */
    public Expense3 withSupplierId(Optional<String> supplierId) {
        Utils.checkNotNull(supplierId, "supplierId");
        this.supplierId = supplierId;
        return this;
    }
     ...
     * The company ID the transaction belongs to
     */
    public Expense3 withCompanyId(String companyId) {
        Utils.checkNotNull(companyId, "companyId");
     ...
     * The company ID the transaction belongs to
     */
    public Expense3 withCompanyId(JsonNullable<String> companyId) {
        Utils.checkNotNull(companyId, "companyId");
        this.companyId = companyId;
        return this;
    }
     ...
     * The ID of the department
     */
    public Expense3 withDepartmentId(String departmentId) {
        Utils.checkNotNull(departmentId, "departmentId");
     ...
     * The ID of the department
     */
    public Expense3 withDepartmentId(JsonNullable<String> departmentId) {
        Utils.checkNotNull(departmentId, "departmentId");
        this.departmentId = departmentId;
        return this;
    }
     ...
     * The type of payment for the expense.
     */
    public Expense3 withPaymentType(Expense3PaymentType paymentType) {
        Utils.checkNotNull(paymentType, "paymentType");
     ...
     * The type of payment for the expense.
     */
    public Expense3 withPaymentType(JsonNullable<? extends Expense3PaymentType> paymentType) {
        Utils.checkNotNull(paymentType, "paymentType");
        this.paymentType = paymentType;
        return this;
    }
     ...
     * 4217](https://en.wikipedia.org/wiki/ISO_4217).
     */
    public Expense3 withCurrency(Currency currency) {
        Utils.checkNotNull(currency, "currency");
     ...
     * 4217](https://en.wikipedia.org/wiki/ISO_4217).
     */
    public Expense3 withCurrency(JsonNullable<? extends Currency> currency) {
        Utils.checkNotNull(currency, "currency");
        this.currency = currency;
        return this;
    }
     ...
     * Currency Exchange Rate at the time entity was recorded/generated.
     */
    public Expense3 withCurrencyRate(double currencyRate) {
        Utils.checkNotNull(currencyRate, "currencyRate");
     ...
     * Currency Exchange Rate at the time entity was recorded/generated.
     */
    public Expense3 withCurrencyRate(JsonNullable<Double> currencyRate) {
        Utils.checkNotNull(currencyRate, "currencyRate");
        this.currencyRate = currencyRate;
        return this;
    }
     ...
     * The type of expense.
     */
    public Expense3 withType(Expense3ExpenseType type) {
        Utils.checkNotNull(type, "type");
     ...
     * The type of expense.
     */
    public Expense3 withType(JsonNullable<? extends Expense3ExpenseType> type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
     ...
     * The memo of the expense.
     */
    public Expense3 withMemo(String memo) {
        Utils.checkNotNull(memo, "memo");
     ...
     * The memo of the expense.
     */
    public Expense3 withMemo(JsonNullable<String> memo) {
        Utils.checkNotNull(memo, "memo");
        this.memo = memo;
        return this;
    }

    public Expense3 withTaxRate(LinkedTaxRateInput taxRate) {
        Utils.checkNotNull(taxRate, "taxRate");
    ...
    public Expense3 withTaxRate(Optional<? extends LinkedTaxRateInput> taxRate) {
        Utils.checkNotNull(taxRate, "taxRate");
        this.taxRate = taxRate;
        return this;
    }
     ...
     * The total amount of the expense line item.
     */
    public Expense3 withTotalAmount(double totalAmount) {
        Utils.checkNotNull(totalAmount, "totalAmount");
     ...
     * The total amount of the expense line item.
     */
    public Expense3 withTotalAmount(JsonNullable<Double> totalAmount) {
        Utils.checkNotNull(totalAmount, "totalAmount");
        this.totalAmount = totalAmount;
        return this;
    }
     ...
     * Expense line items linked to this expense.
     */
    public Expense3 withLineItems(List<ExpenseLineItemInput> lineItems) {
        Utils.checkNotNull(lineItems, "lineItems");
        this.lineItems = lineItems;
        return this;
    }
     ...
     * Optional reference identifier for the transaction.
     */
    public Expense3 withReference(String reference) {
        Utils.checkNotNull(reference, "reference");
     ...
     * Optional reference identifier for the transaction.
     */
    public Expense3 withReference(JsonNullable<String> reference) {
        Utils.checkNotNull(reference, "reference");
        this.reference = reference;
        return this;
    }
     ...
     * supported for Xero.
     */
    public Expense3 withSourceDocumentUrl(String sourceDocumentUrl) {
        Utils.checkNotNull(sourceDocumentUrl, "sourceDocumentUrl");
     ...
     * supported for Xero.
     */
    public Expense3 withSourceDocumentUrl(JsonNullable<String> sourceDocumentUrl) {
        Utils.checkNotNull(sourceDocumentUrl, "sourceDocumentUrl");
        this.sourceDocumentUrl = sourceDocumentUrl;
        return this;
    }

    public Expense3 withCustomFields(List<CustomField> customFields) {
        Utils.checkNotNull(customFields, "customFields");
    ...
    public Expense3 withCustomFields(Optional<? extends List<CustomField>> customFields) {
        Utils.checkNotNull(customFields, "customFields");
        this.customFields = customFields;
        return this;
    }
     ...
     * Expense status
     */
    public Expense3 withStatus(Expense3Status status) {
        Utils.checkNotNull(status, "status");
     ...
     * Expense status
     */
    public Expense3 withStatus(JsonNullable<? extends Expense3Status> status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * time an update is made to the object.
     */
    public Expense3 withRowVersion(String rowVersion) {
        Utils.checkNotNull(rowVersion, "rowVersion");
     ...
     * time an update is made to the object.
     */
    public Expense3 withRowVersion(JsonNullable<String> rowVersion) {
        Utils.checkNotNull(rowVersion, "rowVersion");
        this.rowVersion = rowVersion;
        return this;
    }
     ...
     * in request body when creating or updating resources.
     */
    public Expense3 withPassThrough(List<PassThroughBody> passThrough) {
        Utils.checkNotNull(passThrough, "passThrough");
     ...
     * in request body when creating or updating resources.
     */
    public Expense3 withPassThrough(Optional<? extends List<PassThroughBody>> passThrough) {
        Utils.checkNotNull(passThrough, "passThrough");
        this.passThrough = passThrough;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(Expense3.class,
                "number", number,
