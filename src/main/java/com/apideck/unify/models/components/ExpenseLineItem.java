...
public class ExpenseLineItem {
     ...
     * A unique identifier for an object.
     */
    public ExpenseLineItem withId(@Nullable String id) {
        this.id = id;
        return this;
    }
     ...
     * A list of linked tracking categories.
     */
    public ExpenseLineItem withTrackingCategories(@Nullable List<LinkedTrackingCategory> trackingCategories) {
     ...
     * The unique identifier for the ledger account.
     */
    public ExpenseLineItem withAccountId(@Nullable String accountId) {
        this.accountId = accountId;
        return this;
    }
     ...
     * The ID of the customer this expense item is linked to.
     */
    public ExpenseLineItem withCustomerId(@Nullable String customerId) {
        this.customerId = customerId;
        return this;
    }
     ...
     * The ID of the department
     */
    public ExpenseLineItem withDepartmentId(@Nullable String departmentId) {
     ...
     * The ID of the location
     */
    public ExpenseLineItem withLocationId(@Nullable String locationId) {
     ...
     * The ID of the subsidiary
     */
    public ExpenseLineItem withSubsidiaryId(@Nullable String subsidiaryId) {
        this.subsidiaryId = JsonNullable.of(subsidiaryId);
        return this;
    }


    public ExpenseLineItem withTaxRate(@Nullable LinkedTaxRate taxRate) {
        this.taxRate = taxRate;
        return this;
    }
     ...
     * The expense line item description
     */
    public ExpenseLineItem withDescription(@Nullable String description) {
     ...
     * The total amount of the expense line item.
     */
    public ExpenseLineItem withTotalAmount(@Nullable Double totalAmount) {
        this.totalAmount = JsonNullable.of(totalAmount);
        return this;
    }
     ...
     * Boolean that indicates if the line item is billable or not.
     */
    public ExpenseLineItem withBillable(@Nullable Boolean billable) {
        this.billable = billable;
        return this;
    }
     ...
     * Line number of the resource
     */
    public ExpenseLineItem withLineNumber(@Nullable Long lineNumber) {
