...
public class Fulfillments {
    ...
    private Optional<? extends PickupDetails> pickupDetails;
    ...
    public Fulfillments(
            ...
            @JsonProperty("pickup_details") Optional<? extends PickupDetails> pickupDetails,
    ...
    public Optional<PickupDetails> pickupDetails() {
        return (Optional<PickupDetails>) pickupDetails;
    }
    ...
    public Fulfillments withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = Optional.ofNullable(id);
        return this;
    }

    public Fulfillments withId(Optional<String> id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * The state of the fulfillment.
     */
    public Fulfillments withStatus(OrderFulfillmentStatus status) {
        Utils.checkNotNull(status, "status");
     ...
     * The state of the fulfillment.
     */
    public Fulfillments withStatus(Optional<? extends OrderFulfillmentStatus> status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }

    public Fulfillments withType(OrderFulfillmentsType type) {
        Utils.checkNotNull(type, "type");
        this.type = Optional.ofNullable(type);
        return this;
    }

    public Fulfillments withType(Optional<? extends OrderFulfillmentsType> type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }

    public Fulfillments withPickupDetails(PickupDetails pickupDetails) {
        Utils.checkNotNull(pickupDetails, "pickupDetails");
        this.pickupDetails = Optional.ofNullable(pickupDetails);
        return this;
    }

    public Fulfillments withPickupDetails(Optional<? extends PickupDetails> pickupDetails) {
        Utils.checkNotNull(pickupDetails, "pickupDetails");
        this.pickupDetails = pickupDetails;
        return this;
    }

    public Fulfillments withShipmentDetails(ShipmentDetails shipmentDetails) {
        Utils.checkNotNull(shipmentDetails, "shipmentDetails");
        this.shipmentDetails = Optional.ofNullable(shipmentDetails);
        return this;
    }

    public Fulfillments withShipmentDetails(Optional<? extends ShipmentDetails> shipmentDetails) {
        Utils.checkNotNull(shipmentDetails, "shipmentDetails");
        this.shipmentDetails = shipmentDetails;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        Fulfillments other = (Fulfillments) o;
        return 
    ...
    public String toString() {
        return Utils.toString(Fulfillments.class,
                "id", id,
                "status", status,
                "type", type,
    ...
    public final static class Builder {
        ...
        private Optional<? extends PickupDetails> pickupDetails = Optional.empty();
        ...
        public Builder pickupDetails(Optional<? extends PickupDetails> pickupDetails) {
            Utils.checkNotNull(pickupDetails, "pickupDetails");
            this.pickupDetails = pickupDetails;
            return this;
        }
