...
public class GetAccountingDepartmentsResponse {
    ...
    @JsonProperty("data")
    private List<AccountingDepartment> data;
    ...
    public GetAccountingDepartmentsResponse(
            ...
            @JsonProperty("data") @Nonnull List<AccountingDepartment> data,
    ...
    public GetAccountingDepartmentsResponse(
            ...
            @Nonnull List<AccountingDepartment> data) {
    ...
    public List<AccountingDepartment> data() {
        return this.data;
    }
     ...
     * HTTP Response Status Code
     */
    public GetAccountingDepartmentsResponse withStatusCode(long statusCode) {
        this.statusCode = statusCode;
        return this;
    }
     ...
     * HTTP Response Status
     */
    public GetAccountingDepartmentsResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public GetAccountingDepartmentsResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public GetAccountingDepartmentsResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public GetAccountingDepartmentsResponse withOperation(@Nonnull String operation) {
        this.operation = Utils.checkNotNull(operation, "operation");
        return this;
    }


    public GetAccountingDepartmentsResponse withData(@Nonnull List<AccountingDepartment> data) {
     ...
     * Response metadata
     */
    public GetAccountingDepartmentsResponse withMeta(@Nullable Meta meta) {
        this.meta = meta;
        return this;
    }
     ...
     * Links to navigate to previous or next pages through the API
     */
    public GetAccountingDepartmentsResponse withLinks(@Nullable Links links) {
        this.links = links;
        return this;
    }
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetAccountingDepartmentsResponse withRaw(@Nullable Map<String, Object> raw) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetAccountingDepartmentsResponse other = (GetAccountingDepartmentsResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetAccountingDepartmentsResponse.class,
    ...
    public final static class Builder {
        ...
        public Builder data(@Nonnull List<AccountingDepartment> data) {
            this.data = Utils.checkNotNull(data, "data");
            return this;
        }
