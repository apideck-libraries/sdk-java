...
public class GetAgedCreditorsResponse {
    ...
    public GetAgedCreditorsResponse(
            ...
            @JsonProperty("data") @Nonnull AgedCreditors data,
     ...
     * HTTP Response Status
     */
    public GetAgedCreditorsResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public GetAgedCreditorsResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public GetAgedCreditorsResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public GetAgedCreditorsResponse withOperation(@Nonnull String operation) {
        this.operation = Utils.checkNotNull(operation, "operation");
        return this;
    }


    public GetAgedCreditorsResponse withData(@Nonnull AgedCreditors data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetAgedCreditorsResponse withRaw(@Nullable Map<String, Object> raw) {
    ...
    public final static class Builder {
        ...
        public Builder data(@Nonnull AgedCreditors data) {
            this.data = Utils.checkNotNull(data, "data");
            return this;
        }
