...
public class GetAgedDebtorsResponse {
    ...
    public GetAgedDebtorsResponse(
            ...
            @JsonProperty("data") @Nonnull AgedDebtors data,
     ...
     * HTTP Response Status
     */
    public GetAgedDebtorsResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public GetAgedDebtorsResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public GetAgedDebtorsResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public GetAgedDebtorsResponse withOperation(@Nonnull String operation) {
        this.operation = Utils.checkNotNull(operation, "operation");
        return this;
    }


    public GetAgedDebtorsResponse withData(@Nonnull AgedDebtors data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetAgedDebtorsResponse withRaw(@Nullable Map<String, Object> raw) {
    ...
    public final static class Builder {
        ...
        public Builder data(@Nonnull AgedDebtors data) {
            this.data = Utils.checkNotNull(data, "data");
            return this;
        }
