...
public class GetApiResourceCoverageResponse {
    ...
    public GetApiResourceCoverageResponse(
            ...
            @JsonProperty("data") @Nonnull ApiResourceCoverage data,
    ...
    public GetApiResourceCoverageResponse(
            ...
            @Nonnull ApiResourceCoverage data) {
     ...
     * HTTP Response Status
     */
    public GetApiResourceCoverageResponse withStatus(@Nonnull String status) {
        this.status = Utils.checkNotNull(status, "status");
        return this;
    }


    public GetApiResourceCoverageResponse withData(@Nonnull ApiResourceCoverage data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetApiResourceCoverageResponse withRaw(@Nullable Map<String, Object> raw) {
     ...
     * Response metadata
     */
    public GetApiResourceCoverageResponse withMeta(@Nullable Meta meta) {
        this.meta = meta;
        return this;
    }
     ...
     * Links to navigate to previous or next pages through the API
     */
    public GetApiResourceCoverageResponse withLinks(@Nullable Links links) {
        this.links = links;
        return this;
    }
    ...
    public final static class Builder {
        ...
        public Builder data(@Nonnull ApiResourceCoverage data) {
            this.data = Utils.checkNotNull(data, "data");
            return this;
        }
