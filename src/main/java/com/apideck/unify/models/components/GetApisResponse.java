...
public class GetApisResponse {
    ...
    public GetApisResponse(
            ...
            @JsonProperty("data") @Nonnull List<Api> data,
     ...
     * HTTP Response Status
     */
    public GetApisResponse withStatus(@Nonnull String status) {
        this.status = Utils.checkNotNull(status, "status");
        return this;
    }


    public GetApisResponse withData(@Nonnull List<Api> data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetApisResponse withRaw(@Nullable Map<String, Object> raw) {
     ...
     * Response metadata
     */
    public GetApisResponse withMeta(@Nullable Meta meta) {
        this.meta = meta;
        return this;
    }
     ...
     * Links to navigate to previous or next pages through the API
     */
    public GetApisResponse withLinks(@Nullable Links links) {
        this.links = links;
        return this;
    }
    ...
    public final static class Builder {
        ...
        public Builder data(@Nonnull List<Api> data) {
            this.data = Utils.checkNotNull(data, "data");
            return this;
        }
