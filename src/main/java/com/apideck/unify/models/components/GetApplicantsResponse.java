...
public class GetApplicantsResponse {
    ...
    public GetApplicantsResponse(
            ...
            @JsonProperty("data") List<Applicant> data,
    ...
    public GetApplicantsResponse withData(List<Applicant> data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetApplicantsResponse withRaw(Map<String, Object> raw) {
        Utils.checkNotNull(raw, "raw");
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetApplicantsResponse withRaw(JsonNullable<? extends Map<String, Object>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
