...
public class GetApplicantsResponse {
    ...
    public GetApplicantsResponse(
            ...
            @JsonProperty("data") @Nonnull List<Applicant> data,
     ...
     * HTTP Response Status
     */
    public GetApplicantsResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public GetApplicantsResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public GetApplicantsResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public GetApplicantsResponse withOperation(@Nonnull String operation) {
        this.operation = Utils.checkNotNull(operation, "operation");
        return this;
    }


    public GetApplicantsResponse withData(@Nonnull List<Applicant> data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetApplicantsResponse withRaw(@Nullable Map<String, Object> raw) {
     ...
     * Response metadata
     */
    public GetApplicantsResponse withMeta(@Nullable Meta meta) {
        this.meta = meta;
        return this;
    }
     ...
     * Links to navigate to previous or next pages through the API
     */
    public GetApplicantsResponse withLinks(@Nullable Links links) {
        this.links = links;
        return this;
    }
    ...
    public final static class Builder {
        ...
        public Builder data(@Nonnull List<Applicant> data) {
            this.data = Utils.checkNotNull(data, "data");
            return this;
        }
