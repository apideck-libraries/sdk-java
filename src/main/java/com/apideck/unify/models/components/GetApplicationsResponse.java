...
public class GetApplicationsResponse {
    ...
    public GetApplicationsResponse(
            ...
            @JsonProperty("data") @Nonnull List<Application> data,
     ...
     * HTTP Response Status
     */
    public GetApplicationsResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public GetApplicationsResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public GetApplicationsResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public GetApplicationsResponse withOperation(@Nonnull String operation) {
        this.operation = Utils.checkNotNull(operation, "operation");
        return this;
    }


    public GetApplicationsResponse withData(@Nonnull List<Application> data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetApplicationsResponse withRaw(@Nullable Map<String, Object> raw) {
     ...
     * Response metadata
     */
    public GetApplicationsResponse withMeta(@Nullable Meta meta) {
        this.meta = meta;
        return this;
    }
     ...
     * Links to navigate to previous or next pages through the API
     */
    public GetApplicationsResponse withLinks(@Nullable Links links) {
        this.links = links;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetApplicationsResponse other = (GetApplicationsResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetApplicationsResponse.class,
    ...
    public final static class Builder {
        ...
        public Builder data(@Nonnull List<Application> data) {
            this.data = Utils.checkNotNull(data, "data");
            return this;
        }
        ...
        public GetApplicationsResponse build() {
