...
public class GetAttachmentResponse {
    ...
    public GetAttachmentResponse(
            ...
            @JsonProperty("data") Attachment data,
     ...
     * HTTP Response Status
     */
    public GetAttachmentResponse withStatus(String status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * Apideck ID of service provider
     */
    public GetAttachmentResponse withService(String service) {
        Utils.checkNotNull(service, "service");
        this.service = service;
        return this;
    }
     ...
     * Unified API resource name
     */
    public GetAttachmentResponse withResource(String resource) {
        Utils.checkNotNull(resource, "resource");
        this.resource = resource;
        return this;
    }
     ...
     * Operation performed
     */
    public GetAttachmentResponse withOperation(String operation) {
        Utils.checkNotNull(operation, "operation");
        this.operation = operation;
        return this;
    }

    public GetAttachmentResponse withData(Attachment data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }
     ...
     * Response metadata
     */
    public GetAttachmentResponse withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
     ...
     * Response metadata
     */
    public GetAttachmentResponse withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetAttachmentResponse withRaw(Map<String, Object> raw) {
        Utils.checkNotNull(raw, "raw");
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetAttachmentResponse withRaw(JsonNullable<? extends Map<String, Object>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetAttachmentResponse other = (GetAttachmentResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetAttachmentResponse.class,
    ...
    public final static class Builder {
        ...
        public Builder data(Attachment data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
