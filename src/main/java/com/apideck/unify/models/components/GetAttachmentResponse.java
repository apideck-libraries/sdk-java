...
public class GetAttachmentResponse {
    ...
    public GetAttachmentResponse(
            ...
            @JsonProperty("data") @Nonnull Attachment data,
     ...
     * HTTP Response Status
     */
    public GetAttachmentResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public GetAttachmentResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public GetAttachmentResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public GetAttachmentResponse withOperation(@Nonnull String operation) {
        this.operation = Utils.checkNotNull(operation, "operation");
        return this;
    }


    public GetAttachmentResponse withData(@Nonnull Attachment data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetAttachmentResponse withRaw(@Nullable Map<String, Object> raw) {
    ...
    public final static class Builder {
        ...
        public Builder data(@Nonnull Attachment data) {
            this.data = Utils.checkNotNull(data, "data");
            return this;
        }
