...
public class GetBalanceSheetResponse {
    ...
    public GetBalanceSheetResponse(
            ...
            @JsonProperty("data") @Nonnull BalanceSheet data,
     ...
     * HTTP Response Status
     */
    public GetBalanceSheetResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public GetBalanceSheetResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public GetBalanceSheetResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public GetBalanceSheetResponse withOperation(@Nonnull String operation) {
        this.operation = Utils.checkNotNull(operation, "operation");
        return this;
    }


    public GetBalanceSheetResponse withData(@Nonnull BalanceSheet data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetBalanceSheetResponse withRaw(@Nullable Map<String, Object> raw) {
    ...
    public final static class Builder {
        ...
        public Builder data(@Nonnull BalanceSheet data) {
            this.data = Utils.checkNotNull(data, "data");
            return this;
        }
