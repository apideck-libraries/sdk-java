...
public class GetBankFeedAccountResponse {
    ...
    public GetBankFeedAccountResponse(
            ...
            @JsonProperty("data") @Nonnull BankFeedAccount data,
     ...
     * HTTP Response Status
     */
    public GetBankFeedAccountResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public GetBankFeedAccountResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public GetBankFeedAccountResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public GetBankFeedAccountResponse withOperation(@Nonnull String operation) {
        this.operation = Utils.checkNotNull(operation, "operation");
        return this;
    }


    public GetBankFeedAccountResponse withData(@Nonnull BankFeedAccount data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetBankFeedAccountResponse withRaw(@Nullable Map<String, Object> raw) {
    ...
    public final static class Builder {
        ...
        public Builder data(@Nonnull BankFeedAccount data) {
            this.data = Utils.checkNotNull(data, "data");
            return this;
        }
