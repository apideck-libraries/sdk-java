...
public class GetBankFeedStatementResponse {
    ...
    public GetBankFeedStatementResponse(
            ...
            @JsonProperty("data") @Nonnull BankFeedStatement data,
    ...
    public GetBankFeedStatementResponse(
            ...
            @Nonnull BankFeedStatement data) {
     ...
     * HTTP Response Status
     */
    public GetBankFeedStatementResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public GetBankFeedStatementResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public GetBankFeedStatementResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public GetBankFeedStatementResponse withOperation(@Nonnull String operation) {
        this.operation = Utils.checkNotNull(operation, "operation");
        return this;
    }


    public GetBankFeedStatementResponse withData(@Nonnull BankFeedStatement data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetBankFeedStatementResponse withRaw(@Nullable Map<String, Object> raw) {
    ...
    public final static class Builder {
        ...
        public Builder data(@Nonnull BankFeedStatement data) {
            this.data = Utils.checkNotNull(data, "data");
            return this;
        }
