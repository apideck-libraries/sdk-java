...
public class GetBankFeedStatementsResponse {
    ...
    public GetBankFeedStatementsResponse(
            ...
            @JsonProperty("data") @Nonnull List<BankFeedStatement> data,
    ...
    public GetBankFeedStatementsResponse(
            ...
            @Nonnull List<BankFeedStatement> data) {
     ...
     * HTTP Response Status
     */
    public GetBankFeedStatementsResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public GetBankFeedStatementsResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public GetBankFeedStatementsResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public GetBankFeedStatementsResponse withOperation(@Nonnull String operation) {
        this.operation = Utils.checkNotNull(operation, "operation");
        return this;
    }


    public GetBankFeedStatementsResponse withData(@Nonnull List<BankFeedStatement> data) {
     ...
     * Response metadata
     */
    public GetBankFeedStatementsResponse withMeta(@Nullable Meta meta) {
        this.meta = meta;
        return this;
    }
     ...
     * Links to navigate to previous or next pages through the API
     */
    public GetBankFeedStatementsResponse withLinks(@Nullable Links links) {
        this.links = links;
        return this;
    }
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetBankFeedStatementsResponse withRaw(@Nullable Map<String, Object> raw) {
    ...
    public final static class Builder {
        ...
        public Builder data(@Nonnull List<BankFeedStatement> data) {
            this.data = Utils.checkNotNull(data, "data");
            return this;
        }
