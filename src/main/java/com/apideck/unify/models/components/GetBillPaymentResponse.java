...
public class GetBillPaymentResponse {
    ...
    public GetBillPaymentResponse(
            ...
            @JsonProperty("data") @Nonnull BillPayment data,
     ...
     * HTTP Response Status
     */
    public GetBillPaymentResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public GetBillPaymentResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public GetBillPaymentResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public GetBillPaymentResponse withOperation(@Nonnull String operation) {
        this.operation = Utils.checkNotNull(operation, "operation");
        return this;
    }


    public GetBillPaymentResponse withData(@Nonnull BillPayment data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetBillPaymentResponse withRaw(@Nullable Map<String, Object> raw) {
    ...
    public final static class Builder {
        ...
        public Builder data(@Nonnull BillPayment data) {
            this.data = Utils.checkNotNull(data, "data");
            return this;
        }
