...
public class GetBillPaymentsResponse {
    ...
    public GetBillPaymentsResponse(
            ...
            @JsonProperty("data") @Nonnull List<BillPayment> data,
     ...
     * HTTP Response Status
     */
    public GetBillPaymentsResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public GetBillPaymentsResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public GetBillPaymentsResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public GetBillPaymentsResponse withOperation(@Nonnull String operation) {
        this.operation = Utils.checkNotNull(operation, "operation");
        return this;
    }


    public GetBillPaymentsResponse withData(@Nonnull List<BillPayment> data) {
     ...
     * Response metadata
     */
    public GetBillPaymentsResponse withMeta(@Nullable Meta meta) {
        this.meta = meta;
        return this;
    }
     ...
     * Links to navigate to previous or next pages through the API
     */
    public GetBillPaymentsResponse withLinks(@Nullable Links links) {
        this.links = links;
        return this;
    }
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetBillPaymentsResponse withRaw(@Nullable Map<String, Object> raw) {
    ...
    public final static class Builder {
        ...
        public Builder data(@Nonnull List<BillPayment> data) {
            this.data = Utils.checkNotNull(data, "data");
            return this;
        }
