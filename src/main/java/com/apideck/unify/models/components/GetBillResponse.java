...
public class GetBillResponse {
    ...
    public GetBillResponse(
            ...
            @JsonProperty("data") @Nonnull Bill data,
     ...
     * HTTP Response Status
     */
    public GetBillResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public GetBillResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public GetBillResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public GetBillResponse withOperation(@Nonnull String operation) {
        this.operation = Utils.checkNotNull(operation, "operation");
        return this;
    }


    public GetBillResponse withData(@Nonnull Bill data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetBillResponse withRaw(@Nullable Map<String, Object> raw) {
    ...
    public final static class Builder {
        ...
        public Builder data(@Nonnull Bill data) {
            this.data = Utils.checkNotNull(data, "data");
            return this;
        }
