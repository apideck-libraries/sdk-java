...
public class GetCollectionTagsResponse {
    ...
    public GetCollectionTagsResponse(
            ...
            @JsonProperty("data") @Nonnull List<CollectionTag> data,
    ...
    public GetCollectionTagsResponse(
            ...
            @Nonnull List<CollectionTag> data) {
    ...
    public List<CollectionTag> data() {
        return this.data;
    }
     ...
     * HTTP Response Status
     */
    public GetCollectionTagsResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public GetCollectionTagsResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public GetCollectionTagsResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public GetCollectionTagsResponse withOperation(@Nonnull String operation) {
        this.operation = Utils.checkNotNull(operation, "operation");
        return this;
    }


    public GetCollectionTagsResponse withData(@Nonnull List<CollectionTag> data) {
     ...
     * Response metadata
     */
    public GetCollectionTagsResponse withMeta(@Nullable Meta meta) {
        this.meta = meta;
        return this;
    }
     ...
     * Links to navigate to previous or next pages through the API
     */
    public GetCollectionTagsResponse withLinks(@Nullable Links links) {
        this.links = links;
        return this;
    }
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetCollectionTagsResponse withRaw(@Nullable Map<String, Object> raw) {
    ...
    public String toString() {
        return Utils.toString(GetCollectionTagsResponse.class,
    ...
    public final static class Builder {
        ...
        public Builder data(@Nonnull List<CollectionTag> data) {
            this.data = Utils.checkNotNull(data, "data");
            return this;
        }
