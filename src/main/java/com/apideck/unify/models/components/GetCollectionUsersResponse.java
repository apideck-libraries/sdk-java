...
public class GetCollectionUsersResponse {
    ...
    @JsonProperty("data")
    private List<CollectionUser> data;
    ...
    public GetCollectionUsersResponse(
            ...
            @JsonProperty("data") @Nonnull List<CollectionUser> data,
    ...
    public GetCollectionUsersResponse(
            ...
            @Nonnull List<CollectionUser> data) {
    ...
    public List<CollectionUser> data() {
        return this.data;
    }
     ...
     * HTTP Response Status
     */
    public GetCollectionUsersResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public GetCollectionUsersResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public GetCollectionUsersResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public GetCollectionUsersResponse withOperation(@Nonnull String operation) {
        this.operation = Utils.checkNotNull(operation, "operation");
        return this;
    }


    public GetCollectionUsersResponse withData(@Nonnull List<CollectionUser> data) {
     ...
     * Response metadata
     */
    public GetCollectionUsersResponse withMeta(@Nullable Meta meta) {
        this.meta = meta;
        return this;
    }
     ...
     * Links to navigate to previous or next pages through the API
     */
    public GetCollectionUsersResponse withLinks(@Nullable Links links) {
        this.links = links;
        return this;
    }
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetCollectionUsersResponse withRaw(@Nullable Map<String, Object> raw) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetCollectionUsersResponse other = (GetCollectionUsersResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetCollectionUsersResponse.class,
    ...
    public final static class Builder {
        ...
        public Builder data(@Nonnull List<CollectionUser> data) {
            this.data = Utils.checkNotNull(data, "data");
            return this;
        }
        ...
        public GetCollectionUsersResponse build() {
            return new GetCollectionUsersResponse(
                statusCode, status, service,
                resource, operation, data,
                meta, links, raw);
        }
