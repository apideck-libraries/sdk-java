...
public class GetCollectionsResponse {
    ...
    public GetCollectionsResponse(
            ...
            @JsonProperty("data") @Nonnull List<Collection> data,
     ...
     * HTTP Response Status
     */
    public GetCollectionsResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public GetCollectionsResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public GetCollectionsResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public GetCollectionsResponse withOperation(@Nonnull String operation) {
        this.operation = Utils.checkNotNull(operation, "operation");
        return this;
    }


    public GetCollectionsResponse withData(@Nonnull List<Collection> data) {
     ...
     * Response metadata
     */
    public GetCollectionsResponse withMeta(@Nullable Meta meta) {
        this.meta = meta;
        return this;
    }
     ...
     * Links to navigate to previous or next pages through the API
     */
    public GetCollectionsResponse withLinks(@Nullable Links links) {
        this.links = links;
        return this;
    }
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetCollectionsResponse withRaw(@Nullable Map<String, Object> raw) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetCollectionsResponse other = (GetCollectionsResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetCollectionsResponse.class,
    ...
    public final static class Builder {
        ...
        public Builder data(@Nonnull List<Collection> data) {
            this.data = Utils.checkNotNull(data, "data");
            return this;
        }
