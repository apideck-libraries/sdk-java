...
public class GetCompanyInfoResponse {
    ...
    public GetCompanyInfoResponse(
            ...
            @JsonProperty("data") @Nonnull CompanyInfo data,
     ...
     * HTTP Response Status
     */
    public GetCompanyInfoResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public GetCompanyInfoResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public GetCompanyInfoResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public GetCompanyInfoResponse withOperation(@Nonnull String operation) {
        this.operation = Utils.checkNotNull(operation, "operation");
        return this;
    }


    public GetCompanyInfoResponse withData(@Nonnull CompanyInfo data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetCompanyInfoResponse withRaw(@Nullable Map<String, Object> raw) {
    ...
    public final static class Builder {
        ...
        public Builder data(@Nonnull CompanyInfo data) {
            this.data = Utils.checkNotNull(data, "data");
            return this;
        }
