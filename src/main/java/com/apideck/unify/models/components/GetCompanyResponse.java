...
public class GetCompanyResponse {
    ...
    public GetCompanyResponse(
            ...
            @JsonProperty("data") @Nonnull Company1 data,
     ...
     * HTTP Response Status
     */
    public GetCompanyResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public GetCompanyResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public GetCompanyResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public GetCompanyResponse withOperation(@Nonnull String operation) {
        this.operation = Utils.checkNotNull(operation, "operation");
        return this;
    }


    public GetCompanyResponse withData(@Nonnull Company1 data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetCompanyResponse withRaw(@Nullable Map<String, Object> raw) {
    ...
    public final static class Builder {
        ...
        public Builder data(@Nonnull Company1 data) {
            this.data = Utils.checkNotNull(data, "data");
            return this;
        }
