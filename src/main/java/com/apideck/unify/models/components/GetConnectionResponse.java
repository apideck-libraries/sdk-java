...
public class GetConnectionResponse {
     ...
     * HTTP Response Status
     */
    public GetConnectionResponse withStatus(@Nonnull String status) {
        this.status = Utils.checkNotNull(status, "status");
        return this;
    }


    public GetConnectionResponse withData(@Nonnull Connection data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetConnectionResponse withRaw(@Nullable Map<String, Object> raw) {
