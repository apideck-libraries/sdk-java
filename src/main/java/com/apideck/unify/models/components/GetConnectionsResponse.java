...
public class GetConnectionsResponse {
    ...
    public GetConnectionsResponse(
            ...
            @JsonProperty("data") @Nonnull List<Connection> data,
     ...
     * HTTP Response Status
     */
    public GetConnectionsResponse withStatus(@Nonnull String status) {
        this.status = Utils.checkNotNull(status, "status");
        return this;
    }


    public GetConnectionsResponse withData(@Nonnull List<Connection> data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetConnectionsResponse withRaw(@Nullable Map<String, Object> raw) {
    ...
    public final static class Builder {
        ...
        public Builder data(@Nonnull List<Connection> data) {
            this.data = Utils.checkNotNull(data, "data");
            return this;
        }
