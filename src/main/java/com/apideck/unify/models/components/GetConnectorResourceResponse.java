...
public class GetConnectorResourceResponse {
    ...
    public GetConnectorResourceResponse(
            ...
            @JsonProperty("data") @Nonnull ConnectorResource data,
    ...
    public GetConnectorResourceResponse(
            ...
            @Nonnull ConnectorResource data) {
     ...
     * HTTP Response Status
     */
    public GetConnectorResourceResponse withStatus(@Nonnull String status) {
        this.status = Utils.checkNotNull(status, "status");
        return this;
    }


    public GetConnectorResourceResponse withData(@Nonnull ConnectorResource data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetConnectorResourceResponse withRaw(@Nullable Map<String, Object> raw) {
     ...
     * Response metadata
     */
    public GetConnectorResourceResponse withMeta(@Nullable Meta meta) {
        this.meta = meta;
        return this;
    }
     ...
     * Links to navigate to previous or next pages through the API
     */
    public GetConnectorResourceResponse withLinks(@Nullable Links links) {
        this.links = links;
        return this;
    }
    ...
    public final static class Builder {
        ...
        public Builder data(@Nonnull ConnectorResource data) {
            this.data = Utils.checkNotNull(data, "data");
            return this;
        }
