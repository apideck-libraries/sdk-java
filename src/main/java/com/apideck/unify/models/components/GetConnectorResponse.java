...
public class GetConnectorResponse {
    ...
    public GetConnectorResponse(
            ...
            @JsonProperty("data") @Nonnull Connector data,
     ...
     * HTTP Response Status
     */
    public GetConnectorResponse withStatus(@Nonnull String status) {
        this.status = Utils.checkNotNull(status, "status");
        return this;
    }


    public GetConnectorResponse withData(@Nonnull Connector data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetConnectorResponse withRaw(@Nullable Map<String, Object> raw) {
     ...
     * Response metadata
     */
    public GetConnectorResponse withMeta(@Nullable Meta meta) {
        this.meta = meta;
        return this;
    }
     ...
     * Links to navigate to previous or next pages through the API
     */
    public GetConnectorResponse withLinks(@Nullable Links links) {
        this.links = links;
        return this;
    }
    ...
    public final static class Builder {
        ...
        public Builder data(@Nonnull Connector data) {
            this.data = Utils.checkNotNull(data, "data");
            return this;
        }
