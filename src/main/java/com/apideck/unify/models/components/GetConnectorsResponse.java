...
public class GetConnectorsResponse {
    ...
    public GetConnectorsResponse(
            ...
            @JsonProperty("data") @Nonnull List<Connector> data,
     ...
     * HTTP Response Status
     */
    public GetConnectorsResponse withStatus(@Nonnull String status) {
        this.status = Utils.checkNotNull(status, "status");
        return this;
    }


    public GetConnectorsResponse withData(@Nonnull List<Connector> data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetConnectorsResponse withRaw(@Nullable Map<String, Object> raw) {
     ...
     * Response metadata
     */
    public GetConnectorsResponse withMeta(@Nullable Meta meta) {
        this.meta = meta;
        return this;
    }
     ...
     * Links to navigate to previous or next pages through the API
     */
    public GetConnectorsResponse withLinks(@Nullable Links links) {
        this.links = links;
        return this;
    }
    ...
    public final static class Builder {
        ...
        public Builder data(@Nonnull List<Connector> data) {
            this.data = Utils.checkNotNull(data, "data");
            return this;
        }
