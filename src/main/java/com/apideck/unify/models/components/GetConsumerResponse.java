...
public class GetConsumerResponse {
     ...
     * HTTP Response Status
     */
    public GetConsumerResponse withStatus(@Nonnull String status) {
        this.status = Utils.checkNotNull(status, "status");
        return this;
    }


    public GetConsumerResponse withData(@Nonnull Consumer data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetConsumerResponse withRaw(@Nullable Map<String, Object> raw) {
