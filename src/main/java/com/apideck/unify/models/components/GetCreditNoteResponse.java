...
public class GetCreditNoteResponse {
    ...
    public GetCreditNoteResponse(
            ...
            @JsonProperty("data") @Nonnull CreditNote data,
     ...
     * HTTP Response Status
     */
    public GetCreditNoteResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public GetCreditNoteResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public GetCreditNoteResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public GetCreditNoteResponse withOperation(@Nonnull String operation) {
        this.operation = Utils.checkNotNull(operation, "operation");
        return this;
    }


    public GetCreditNoteResponse withData(@Nonnull CreditNote data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetCreditNoteResponse withRaw(@Nullable Map<String, Object> raw) {
    ...
    public final static class Builder {
        ...
        public Builder data(@Nonnull CreditNote data) {
            this.data = Utils.checkNotNull(data, "data");
            return this;
        }
