...
public class GetCustomFieldsResponse {
    ...
    public GetCustomFieldsResponse(
            ...
            @JsonProperty("data") @Nonnull List<CustomFieldFinder> data,
    ...
    public GetCustomFieldsResponse(
            ...
            @Nonnull List<CustomFieldFinder> data) {
     ...
     * HTTP Response Status
     */
    public GetCustomFieldsResponse withStatus(@Nonnull String status) {
        this.status = Utils.checkNotNull(status, "status");
        return this;
    }


    public GetCustomFieldsResponse withData(@Nonnull List<CustomFieldFinder> data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetCustomFieldsResponse withRaw(@Nullable Map<String, Object> raw) {
    ...
    public final static class Builder {
        ...
        public Builder data(@Nonnull List<CustomFieldFinder> data) {
            this.data = Utils.checkNotNull(data, "data");
            return this;
        }
