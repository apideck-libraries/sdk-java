...
public class GetCustomObjectResponse {
    ...
    public GetCustomObjectResponse(
            ...
            @JsonProperty("data") @Nonnull CustomObject data,
     ...
     * HTTP Response Status
     */
    public GetCustomObjectResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public GetCustomObjectResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public GetCustomObjectResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public GetCustomObjectResponse withOperation(@Nonnull String operation) {
        this.operation = Utils.checkNotNull(operation, "operation");
        return this;
    }


    public GetCustomObjectResponse withData(@Nonnull CustomObject data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetCustomObjectResponse withRaw(@Nullable Map<String, Object> raw) {
    ...
    public final static class Builder {
        ...
        public Builder data(@Nonnull CustomObject data) {
            this.data = Utils.checkNotNull(data, "data");
            return this;
        }
