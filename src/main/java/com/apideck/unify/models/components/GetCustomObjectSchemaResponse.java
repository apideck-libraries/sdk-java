...
public class GetCustomObjectSchemaResponse {
     ...
     * HTTP Response Status
     */
    public GetCustomObjectSchemaResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public GetCustomObjectSchemaResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public GetCustomObjectSchemaResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public GetCustomObjectSchemaResponse withOperation(@Nonnull String operation) {
        this.operation = Utils.checkNotNull(operation, "operation");
        return this;
    }


    public GetCustomObjectSchemaResponse withData(@Nonnull CustomObjectSchema data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetCustomObjectSchemaResponse withRaw(@Nullable Map<String, Object> raw) {
