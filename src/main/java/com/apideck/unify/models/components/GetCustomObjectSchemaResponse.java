...
public class GetCustomObjectSchemaResponse {
    ...
    @JsonCreator
    public GetCustomObjectSchemaResponse(
     ...
     * HTTP Response Status Code
     */
    public GetCustomObjectSchemaResponse withStatusCode(long statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * HTTP Response Status
     */
    public GetCustomObjectSchemaResponse withStatus(String status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * Apideck ID of service provider
     */
    public GetCustomObjectSchemaResponse withService(String service) {
        Utils.checkNotNull(service, "service");
        this.service = service;
        return this;
    }
     ...
     * Unified API resource name
     */
    public GetCustomObjectSchemaResponse withResource(String resource) {
        Utils.checkNotNull(resource, "resource");
        this.resource = resource;
        return this;
    }
     ...
     * Operation performed
     */
    public GetCustomObjectSchemaResponse withOperation(String operation) {
        Utils.checkNotNull(operation, "operation");
        this.operation = operation;
        return this;
    }

    public GetCustomObjectSchemaResponse withData(CustomObjectSchema data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }
     ...
     * Response metadata
     */
    public GetCustomObjectSchemaResponse withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
     ...
     * Response metadata
     */
    public GetCustomObjectSchemaResponse withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetCustomObjectSchemaResponse withRaw(Map<String, Object> raw) {
        Utils.checkNotNull(raw, "raw");
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetCustomObjectSchemaResponse withRaw(JsonNullable<? extends Map<String, Object>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetCustomObjectSchemaResponse other = (GetCustomObjectSchemaResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetCustomObjectSchemaResponse.class,
    ...
    public final static class Builder {
        ...
        public GetCustomObjectSchemaResponse build() {

            return new GetCustomObjectSchemaResponse(
                statusCode, status, service,
                resource, operation, data,
                meta, raw);
        }
