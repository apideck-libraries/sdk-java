...
public class GetCustomerResponse {
    ...
    public GetCustomerResponse(
            ...
            @JsonProperty("data") @Nonnull Customer data,
     ...
     * HTTP Response Status
     */
    public GetCustomerResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public GetCustomerResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public GetCustomerResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public GetCustomerResponse withOperation(@Nonnull String operation) {
        this.operation = Utils.checkNotNull(operation, "operation");
        return this;
    }


    public GetCustomerResponse withData(@Nonnull Customer data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetCustomerResponse withRaw(@Nullable Map<String, Object> raw) {
    ...
    public final static class Builder {
        ...
        public Builder data(@Nonnull Customer data) {
            this.data = Utils.checkNotNull(data, "data");
            return this;
        }
