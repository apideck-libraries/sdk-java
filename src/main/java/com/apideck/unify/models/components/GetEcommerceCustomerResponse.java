...
public class GetEcommerceCustomerResponse {
    ...
    public GetEcommerceCustomerResponse(
            ...
            @JsonProperty("data") @Nonnull EcommerceCustomer data,
    ...
    public GetEcommerceCustomerResponse(
            ...
            @Nonnull EcommerceCustomer data) {
     ...
     * HTTP Response Status
     */
    public GetEcommerceCustomerResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public GetEcommerceCustomerResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public GetEcommerceCustomerResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public GetEcommerceCustomerResponse withOperation(@Nonnull String operation) {
        this.operation = Utils.checkNotNull(operation, "operation");
        return this;
    }


    public GetEcommerceCustomerResponse withData(@Nonnull EcommerceCustomer data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetEcommerceCustomerResponse withRaw(@Nullable Map<String, Object> raw) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetEcommerceCustomerResponse other = (GetEcommerceCustomerResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetEcommerceCustomerResponse.class,
    ...
    public final static class Builder {
        ...
        public Builder data(@Nonnull EcommerceCustomer data) {
            this.data = Utils.checkNotNull(data, "data");
            return this;
        }
        ...
        public GetEcommerceCustomerResponse build() {
            return new GetEcommerceCustomerResponse(
                statusCode, status, service,
                resource, operation, data,
                raw);
        }
