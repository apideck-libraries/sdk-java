...
public class GetEcommerceCustomersResponse {
    ...
    @JsonProperty("data")
    private List<EcommerceCustomer> data;
    ...
    @JsonCreator
    public GetEcommerceCustomersResponse(
            ...
            @JsonProperty("data") @Nonnull List<EcommerceCustomer> data,
    ...
    public GetEcommerceCustomersResponse(
            ...
            @Nonnull List<EcommerceCustomer> data) {
    ...
    public List<EcommerceCustomer> data() {
        return this.data;
    }
     ...
     * HTTP Response Status
     */
    public GetEcommerceCustomersResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public GetEcommerceCustomersResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public GetEcommerceCustomersResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public GetEcommerceCustomersResponse withOperation(@Nonnull String operation) {
        this.operation = Utils.checkNotNull(operation, "operation");
        return this;
    }


    public GetEcommerceCustomersResponse withData(@Nonnull List<EcommerceCustomer> data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetEcommerceCustomersResponse withRaw(@Nullable Map<String, Object> raw) {
     ...
     * Response metadata
     */
    public GetEcommerceCustomersResponse withMeta(@Nullable Meta meta) {
        this.meta = meta;
        return this;
    }
     ...
     * Links to navigate to previous or next pages through the API
     */
    public GetEcommerceCustomersResponse withLinks(@Nullable Links links) {
        this.links = links;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetEcommerceCustomersResponse other = (GetEcommerceCustomersResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetEcommerceCustomersResponse.class,
    ...
    public final static class Builder {
        ...
        public Builder data(@Nonnull List<EcommerceCustomer> data) {
            this.data = Utils.checkNotNull(data, "data");
            return this;
        }
        ...
        public GetEcommerceCustomersResponse build() {
            return new GetEcommerceCustomersResponse(
                statusCode, status, service,
                resource, operation, data,
                raw, meta, links);
        }
