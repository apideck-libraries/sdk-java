...
public class GetEcommerceOrdersResponse {
    ...
    public GetEcommerceOrdersResponse(
            ...
            @JsonProperty("data") @Nonnull List<EcommerceOrder> data,
    ...
    public GetEcommerceOrdersResponse(
            ...
            @Nonnull List<EcommerceOrder> data) {
     ...
     * HTTP Response Status
     */
    public GetEcommerceOrdersResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public GetEcommerceOrdersResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public GetEcommerceOrdersResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public GetEcommerceOrdersResponse withOperation(@Nonnull String operation) {
        this.operation = Utils.checkNotNull(operation, "operation");
        return this;
    }


    public GetEcommerceOrdersResponse withData(@Nonnull List<EcommerceOrder> data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetEcommerceOrdersResponse withRaw(@Nullable Map<String, Object> raw) {
     ...
     * Response metadata
     */
    public GetEcommerceOrdersResponse withMeta(@Nullable Meta meta) {
        this.meta = meta;
        return this;
    }
     ...
     * Links to navigate to previous or next pages through the API
     */
    public GetEcommerceOrdersResponse withLinks(@Nullable Links links) {
        this.links = links;
        return this;
    }
    ...
    public final static class Builder {
        ...
        public Builder data(@Nonnull List<EcommerceOrder> data) {
            this.data = Utils.checkNotNull(data, "data");
            return this;
        }
