...
public class GetEmployeePayrollResponse {
    ...
    @JsonCreator
    public GetEmployeePayrollResponse(
            ...
            @JsonProperty("data") @Nonnull EmployeePayroll data,
     ...
     * HTTP Response Status
     */
    public GetEmployeePayrollResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public GetEmployeePayrollResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public GetEmployeePayrollResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public GetEmployeePayrollResponse withOperation(@Nonnull String operation) {
        this.operation = Utils.checkNotNull(operation, "operation");
        return this;
    }


    public GetEmployeePayrollResponse withData(@Nonnull EmployeePayroll data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetEmployeePayrollResponse withRaw(@Nullable Map<String, Object> raw) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetEmployeePayrollResponse other = (GetEmployeePayrollResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetEmployeePayrollResponse.class,
    ...
    public final static class Builder {
        ...
        public Builder data(@Nonnull EmployeePayroll data) {
            this.data = Utils.checkNotNull(data, "data");
            return this;
        }
        ...
        public GetEmployeePayrollResponse build() {
