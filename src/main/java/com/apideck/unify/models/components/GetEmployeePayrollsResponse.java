...
public class GetEmployeePayrollsResponse {
    ...
    @JsonProperty("data")
    private List<EmployeePayroll> data;
    ...
    public GetEmployeePayrollsResponse(
            ...
            @JsonProperty("data") @Nonnull List<EmployeePayroll> data,
    ...
    public GetEmployeePayrollsResponse(
            ...
            @Nonnull List<EmployeePayroll> data) {
    ...
    public List<EmployeePayroll> data() {
        return this.data;
    }
     ...
     * HTTP Response Status
     */
    public GetEmployeePayrollsResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public GetEmployeePayrollsResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public GetEmployeePayrollsResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public GetEmployeePayrollsResponse withOperation(@Nonnull String operation) {
        this.operation = Utils.checkNotNull(operation, "operation");
        return this;
    }


    public GetEmployeePayrollsResponse withData(@Nonnull List<EmployeePayroll> data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetEmployeePayrollsResponse withRaw(@Nullable Map<String, Object> raw) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetEmployeePayrollsResponse other = (GetEmployeePayrollsResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetEmployeePayrollsResponse.class,
    ...
    public final static class Builder {
        ...
        public Builder data(@Nonnull List<EmployeePayroll> data) {
            this.data = Utils.checkNotNull(data, "data");
            return this;
        }
        ...
        public GetEmployeePayrollsResponse build() {
            return new GetEmployeePayrollsResponse(
                statusCode, status, service,
                resource, operation, data,
                raw);
        }
