...
public class GetExpenseCategoriesResponse {
    ...
    public GetExpenseCategoriesResponse(
            ...
            @JsonProperty("data") List<ExpenseCategory> data,
    ...
    @JsonIgnore
    public List<ExpenseCategory> data() {
        return data;
    }
     ...
     * HTTP Response Status Code
     */
    public GetExpenseCategoriesResponse withStatusCode(long statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * HTTP Response Status
     */
    public GetExpenseCategoriesResponse withStatus(String status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * Apideck ID of service provider
     */
    public GetExpenseCategoriesResponse withService(String service) {
        Utils.checkNotNull(service, "service");
        this.service = service;
        return this;
    }
     ...
     * Unified API resource name
     */
    public GetExpenseCategoriesResponse withResource(String resource) {
        Utils.checkNotNull(resource, "resource");
        this.resource = resource;
        return this;
    }
     ...
     * Operation performed
     */
    public GetExpenseCategoriesResponse withOperation(String operation) {
        Utils.checkNotNull(operation, "operation");
        this.operation = operation;
        return this;
    }

    public GetExpenseCategoriesResponse withData(List<ExpenseCategory> data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }
     ...
     * Response metadata
     */
    public GetExpenseCategoriesResponse withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
     ...
     * Response metadata
     */
    public GetExpenseCategoriesResponse withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
     ...
     * Links to navigate to previous or next pages through the API
     */
    public GetExpenseCategoriesResponse withLinks(Links links) {
        Utils.checkNotNull(links, "links");
     ...
     * Links to navigate to previous or next pages through the API
     */
    public GetExpenseCategoriesResponse withLinks(Optional<? extends Links> links) {
        Utils.checkNotNull(links, "links");
        this.links = links;
        return this;
    }
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetExpenseCategoriesResponse withRaw(Map<String, Object> raw) {
        Utils.checkNotNull(raw, "raw");
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetExpenseCategoriesResponse withRaw(JsonNullable<? extends Map<String, Object>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetExpenseCategoriesResponse other = (GetExpenseCategoriesResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetExpenseCategoriesResponse.class,
    ...
    public final static class Builder {
        ...
        public Builder data(List<ExpenseCategory> data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
        ...
        public GetExpenseCategoriesResponse build() {
