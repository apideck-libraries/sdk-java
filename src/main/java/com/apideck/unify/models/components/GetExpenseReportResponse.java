...
public class GetExpenseReportResponse {
    ...
    @JsonCreator
    public GetExpenseReportResponse(
     ...
     * HTTP Response Status Code
     */
    public GetExpenseReportResponse withStatusCode(long statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * HTTP Response Status
     */
    public GetExpenseReportResponse withStatus(String status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * Apideck ID of service provider
     */
    public GetExpenseReportResponse withService(String service) {
        Utils.checkNotNull(service, "service");
        this.service = service;
        return this;
    }
     ...
     * Unified API resource name
     */
    public GetExpenseReportResponse withResource(String resource) {
        Utils.checkNotNull(resource, "resource");
        this.resource = resource;
        return this;
    }
     ...
     * Operation performed
     */
    public GetExpenseReportResponse withOperation(String operation) {
        Utils.checkNotNull(operation, "operation");
        this.operation = operation;
        return this;
    }

    public GetExpenseReportResponse withData(ExpenseReport data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetExpenseReportResponse withRaw(JsonNullable<? extends Map<String, Object>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetExpenseReportResponse other = (GetExpenseReportResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetExpenseReportResponse.class,
    ...
    public final static class Builder {
        ...
        public Builder data(ExpenseReport data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
        ...
        public GetExpenseReportResponse build() {
