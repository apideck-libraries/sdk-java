...
public class GetExpenseReportsResponse {
    ...
    @JsonProperty("data")
    private List<ExpenseReport> data;
    ...
    @JsonCreator
    public GetExpenseReportsResponse(
            @JsonProperty("status_code") long statusCode,
            @JsonProperty("status") String status,
            @JsonProperty("service") String service,
            @JsonProperty("resource") String resource,
            @JsonProperty("operation") String operation,
            @JsonProperty("data") List<ExpenseReport> data,
    ...
    @JsonIgnore
    public List<ExpenseReport> data() {
        return data;
    }
     ...
     * HTTP Response Status Code
     */
    public GetExpenseReportsResponse withStatusCode(long statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * HTTP Response Status
     */
    public GetExpenseReportsResponse withStatus(String status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * Apideck ID of service provider
     */
    public GetExpenseReportsResponse withService(String service) {
        Utils.checkNotNull(service, "service");
        this.service = service;
        return this;
    }
     ...
     * Unified API resource name
     */
    public GetExpenseReportsResponse withResource(String resource) {
        Utils.checkNotNull(resource, "resource");
        this.resource = resource;
        return this;
    }
     ...
     * Operation performed
     */
    public GetExpenseReportsResponse withOperation(String operation) {
        Utils.checkNotNull(operation, "operation");
        this.operation = operation;
        return this;
    }

    public GetExpenseReportsResponse withData(List<ExpenseReport> data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }
     ...
     * Response metadata
     */
    public GetExpenseReportsResponse withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
     ...
     * Response metadata
     */
    public GetExpenseReportsResponse withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
     ...
     * Links to navigate to previous or next pages through the API
     */
    public GetExpenseReportsResponse withLinks(Links links) {
        Utils.checkNotNull(links, "links");
     ...
     * Links to navigate to previous or next pages through the API
     */
    public GetExpenseReportsResponse withLinks(Optional<? extends Links> links) {
        Utils.checkNotNull(links, "links");
        this.links = links;
        return this;
    }
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetExpenseReportsResponse withRaw(Map<String, Object> raw) {
        Utils.checkNotNull(raw, "raw");
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetExpenseReportsResponse withRaw(JsonNullable<? extends Map<String, Object>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetExpenseReportsResponse other = (GetExpenseReportsResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetExpenseReportsResponse.class,
    ...
    public final static class Builder {
        ...
        public Builder data(List<ExpenseReport> data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
        ...
        public GetExpenseReportsResponse build() {

            return new GetExpenseReportsResponse(
                statusCode, status, service,
                resource, operation, data,
                meta, links, raw);
        }
