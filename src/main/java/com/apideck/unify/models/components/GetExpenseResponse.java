...
public class GetExpenseResponse {
    ...
    public GetExpenseResponse(
            ...
            @JsonProperty("data") @Nonnull Expense data,
     ...
     * HTTP Response Status
     */
    public GetExpenseResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public GetExpenseResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public GetExpenseResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public GetExpenseResponse withOperation(@Nonnull String operation) {
        this.operation = Utils.checkNotNull(operation, "operation");
        return this;
    }


    public GetExpenseResponse withData(@Nonnull Expense data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetExpenseResponse withRaw(@Nullable Map<String, Object> raw) {
    ...
    public final static class Builder {
        ...
        public Builder data(@Nonnull Expense data) {
            this.data = Utils.checkNotNull(data, "data");
            return this;
        }
