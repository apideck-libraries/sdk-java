...
public class GetExpensesResponse {
    ...
    public GetExpensesResponse(
            ...
            @JsonProperty("data") @Nonnull List<Expense> data,
     ...
     * HTTP Response Status
     */
    public GetExpensesResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public GetExpensesResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public GetExpensesResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public GetExpensesResponse withOperation(@Nonnull String operation) {
        this.operation = Utils.checkNotNull(operation, "operation");
        return this;
    }


    public GetExpensesResponse withData(@Nonnull List<Expense> data) {
     ...
     * Response metadata
     */
    public GetExpensesResponse withMeta(@Nullable Meta meta) {
        this.meta = meta;
        return this;
    }
     ...
     * Links to navigate to previous or next pages through the API
     */
    public GetExpensesResponse withLinks(@Nullable Links links) {
        this.links = links;
        return this;
    }
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetExpensesResponse withRaw(@Nullable Map<String, Object> raw) {
    ...
    public final static class Builder {
        ...
        public Builder data(@Nonnull List<Expense> data) {
            this.data = Utils.checkNotNull(data, "data");
            return this;
        }
