...
public class GetGoodsReceiptResponse {
    ...
    @JsonCreator
    public GetGoodsReceiptResponse(
            @JsonProperty("status_code") long statusCode,
            @JsonProperty("status") String status,
            @JsonProperty("service") String service,
            @JsonProperty("resource") String resource,
            @JsonProperty("operation") String operation,
            @JsonProperty("data") GoodsReceipt data,
     ...
     * HTTP Response Status Code
     */
    public GetGoodsReceiptResponse withStatusCode(long statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * HTTP Response Status
     */
    public GetGoodsReceiptResponse withStatus(String status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * Apideck ID of service provider
     */
    public GetGoodsReceiptResponse withService(String service) {
        Utils.checkNotNull(service, "service");
        this.service = service;
        return this;
    }
     ...
     * Unified API resource name
     */
    public GetGoodsReceiptResponse withResource(String resource) {
        Utils.checkNotNull(resource, "resource");
        this.resource = resource;
        return this;
    }
     ...
     * Operation performed
     */
    public GetGoodsReceiptResponse withOperation(String operation) {
        Utils.checkNotNull(operation, "operation");
        this.operation = operation;
        return this;
    }

    public GetGoodsReceiptResponse withData(GoodsReceipt data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }
     ...
     * Response metadata
     */
    public GetGoodsReceiptResponse withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
     ...
     * Response metadata
     */
    public GetGoodsReceiptResponse withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetGoodsReceiptResponse withRaw(Map<String, Object> raw) {
        Utils.checkNotNull(raw, "raw");
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetGoodsReceiptResponse withRaw(JsonNullable<? extends Map<String, Object>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetGoodsReceiptResponse other = (GetGoodsReceiptResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetGoodsReceiptResponse.class,
    ...
    public final static class Builder {
        ...
        public Builder data(GoodsReceipt data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
        ...
        public GetGoodsReceiptResponse build() {
