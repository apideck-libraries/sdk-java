...
public class GetHrisCompanyResponse {
    ...
    public GetHrisCompanyResponse(
            ...
            @JsonProperty("data") @Nonnull HrisCompany data,
     ...
     * HTTP Response Status
     */
    public GetHrisCompanyResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public GetHrisCompanyResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public GetHrisCompanyResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public GetHrisCompanyResponse withOperation(@Nonnull String operation) {
        this.operation = Utils.checkNotNull(operation, "operation");
        return this;
    }


    public GetHrisCompanyResponse withData(@Nonnull HrisCompany data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetHrisCompanyResponse withRaw(@Nullable Map<String, Object> raw) {
    ...
    public final static class Builder {
        ...
        public Builder data(@Nonnull HrisCompany data) {
            this.data = Utils.checkNotNull(data, "data");
            return this;
        }
