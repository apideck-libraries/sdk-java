...
public class GetInvoiceResponse {
    ...
    public GetInvoiceResponse(
            ...
            @JsonProperty("data") @Nonnull Invoice data,
     ...
     * HTTP Response Status
     */
    public GetInvoiceResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public GetInvoiceResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public GetInvoiceResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public GetInvoiceResponse withOperation(@Nonnull String operation) {
        this.operation = Utils.checkNotNull(operation, "operation");
        return this;
    }


    public GetInvoiceResponse withData(@Nonnull Invoice data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetInvoiceResponse withRaw(@Nullable Map<String, Object> raw) {
    ...
    public final static class Builder {
        ...
        public Builder data(@Nonnull Invoice data) {
            this.data = Utils.checkNotNull(data, "data");
            return this;
        }
