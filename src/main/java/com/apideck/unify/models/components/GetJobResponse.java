...
public class GetJobResponse {
    ...
    public GetJobResponse(
            ...
            @JsonProperty("data") @Nonnull Job data,
     ...
     * HTTP Response Status
     */
    public GetJobResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public GetJobResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public GetJobResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public GetJobResponse withOperation(@Nonnull String operation) {
        this.operation = Utils.checkNotNull(operation, "operation");
        return this;
    }


    public GetJobResponse withData(@Nonnull Job data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetJobResponse withRaw(@Nullable Map<String, Object> raw) {
    ...
    public final static class Builder {
        ...
        public Builder data(@Nonnull Job data) {
            this.data = Utils.checkNotNull(data, "data");
            return this;
        }
