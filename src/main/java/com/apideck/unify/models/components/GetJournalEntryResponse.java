...
public class GetJournalEntryResponse {
    ...
    public GetJournalEntryResponse(
            ...
            @JsonProperty("data") @Nonnull JournalEntry data,
     ...
     * HTTP Response Status
     */
    public GetJournalEntryResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public GetJournalEntryResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public GetJournalEntryResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public GetJournalEntryResponse withOperation(@Nonnull String operation) {
        this.operation = Utils.checkNotNull(operation, "operation");
        return this;
    }


    public GetJournalEntryResponse withData(@Nonnull JournalEntry data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetJournalEntryResponse withRaw(@Nullable Map<String, Object> raw) {
    ...
    public final static class Builder {
        ...
        public Builder data(@Nonnull JournalEntry data) {
            this.data = Utils.checkNotNull(data, "data");
            return this;
        }
