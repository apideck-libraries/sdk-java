...
public class GetLeadResponse {
    ...
    public GetLeadResponse(
            ...
            @JsonProperty("data") @Nonnull Lead data,
     ...
     * HTTP Response Status
     */
    public GetLeadResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public GetLeadResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public GetLeadResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public GetLeadResponse withOperation(@Nonnull String operation) {
        this.operation = Utils.checkNotNull(operation, "operation");
        return this;
    }


    public GetLeadResponse withData(@Nonnull Lead data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetLeadResponse withRaw(@Nullable Map<String, Object> raw) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetLeadResponse other = (GetLeadResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetLeadResponse.class,
    ...
    public final static class Builder {
        ...
        public Builder data(@Nonnull Lead data) {
            this.data = Utils.checkNotNull(data, "data");
            return this;
        }
