...
public class GetLeadsResponse {
    ...
    public GetLeadsResponse(
            ...
            @JsonProperty("data") @Nonnull List<Lead> data,
     ...
     * HTTP Response Status
     */
    public GetLeadsResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public GetLeadsResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public GetLeadsResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public GetLeadsResponse withOperation(@Nonnull String operation) {
        this.operation = Utils.checkNotNull(operation, "operation");
        return this;
    }


    public GetLeadsResponse withData(@Nonnull List<Lead> data) {
     ...
     * Response metadata
     */
    public GetLeadsResponse withMeta(@Nullable Meta meta) {
        this.meta = meta;
        return this;
    }
     ...
     * Links to navigate to previous or next pages through the API
     */
    public GetLeadsResponse withLinks(@Nullable Links links) {
        this.links = links;
        return this;
    }
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetLeadsResponse withRaw(@Nullable Map<String, Object> raw) {
    ...
    public final static class Builder {
        ...
        public Builder data(@Nonnull List<Lead> data) {
            this.data = Utils.checkNotNull(data, "data");
            return this;
        }
