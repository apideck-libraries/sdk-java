...
public class GetListMembersResponse {
    ...
    public GetListMembersResponse(
            ...
            @JsonProperty("data") List<ListMember> data,
     ...
     * HTTP Response Status Code
     */
    public GetListMembersResponse withStatusCode(long statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * HTTP Response Status
     */
    public GetListMembersResponse withStatus(String status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * Apideck ID of service provider
     */
    public GetListMembersResponse withService(String service) {
        Utils.checkNotNull(service, "service");
        this.service = service;
        return this;
    }
     ...
     * Unified API resource name
     */
    public GetListMembersResponse withResource(String resource) {
        Utils.checkNotNull(resource, "resource");
        this.resource = resource;
        return this;
    }
     ...
     * Operation performed
     */
    public GetListMembersResponse withOperation(String operation) {
        Utils.checkNotNull(operation, "operation");
        this.operation = operation;
        return this;
    }

    public GetListMembersResponse withData(List<ListMember> data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetListMembersResponse withRaw(Map<String, Object> raw) {
        Utils.checkNotNull(raw, "raw");
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetListMembersResponse withRaw(JsonNullable<? extends Map<String, Object>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
     ...
     * Response metadata
     */
    public GetListMembersResponse withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
     ...
     * Response metadata
     */
    public GetListMembersResponse withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
     ...
     * Links to navigate to previous or next pages through the API
     */
    public GetListMembersResponse withLinks(Links links) {
        Utils.checkNotNull(links, "links");
     ...
     * Links to navigate to previous or next pages through the API
     */
    public GetListMembersResponse withLinks(Optional<? extends Links> links) {
        Utils.checkNotNull(links, "links");
        this.links = links;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetListMembersResponse other = (GetListMembersResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetListMembersResponse.class,
    ...
    public final static class Builder {
        ...
        public Builder data(List<ListMember> data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
        ...
        public GetListMembersResponse build() {
