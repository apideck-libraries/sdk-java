...
public class GetListsResponse {
    ...
    @JsonProperty("data")
    private List<com.apideck.unify.models.components.List> data;
    ...
    public GetListsResponse(
            ...
            @JsonProperty("data") List<com.apideck.unify.models.components.List> data,
    ...
    public GetListsResponse(
            ...
            String resource,
            String operation,
            List<com.apideck.unify.models.components.List> data) {
    ...
    @JsonIgnore
    public List<com.apideck.unify.models.components.List> data() {
        return data;
    }
     ...
     * HTTP Response Status Code
     */
    public GetListsResponse withStatusCode(long statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * HTTP Response Status
     */
    public GetListsResponse withStatus(String status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * Apideck ID of service provider
     */
    public GetListsResponse withService(String service) {
        Utils.checkNotNull(service, "service");
        this.service = service;
        return this;
    }
     ...
     * Unified API resource name
     */
    public GetListsResponse withResource(String resource) {
        Utils.checkNotNull(resource, "resource");
        this.resource = resource;
        return this;
    }
     ...
     * Operation performed
     */
    public GetListsResponse withOperation(String operation) {
        Utils.checkNotNull(operation, "operation");
        this.operation = operation;
        return this;
    }

    public GetListsResponse withData(List<com.apideck.unify.models.components.List> data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetListsResponse withRaw(Map<String, Object> raw) {
        Utils.checkNotNull(raw, "raw");
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetListsResponse withRaw(JsonNullable<? extends Map<String, Object>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
     ...
     * Response metadata
     */
    public GetListsResponse withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
     ...
     * Response metadata
     */
    public GetListsResponse withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
     ...
     * Links to navigate to previous or next pages through the API
     */
    public GetListsResponse withLinks(Links links) {
        Utils.checkNotNull(links, "links");
     ...
     * Links to navigate to previous or next pages through the API
     */
    public GetListsResponse withLinks(Optional<? extends Links> links) {
        Utils.checkNotNull(links, "links");
        this.links = links;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetListsResponse other = (GetListsResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetListsResponse.class,
    ...
    public final static class Builder {
        ...
        public Builder data(List<com.apideck.unify.models.components.List> data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
