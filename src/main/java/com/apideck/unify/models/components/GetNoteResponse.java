...
public class GetNoteResponse {
    ...
    public GetNoteResponse(
            ...
            @JsonProperty("data") @Nonnull Note data,
     ...
     * HTTP Response Status
     */
    public GetNoteResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public GetNoteResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public GetNoteResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public GetNoteResponse withOperation(@Nonnull String operation) {
        this.operation = Utils.checkNotNull(operation, "operation");
        return this;
    }


    public GetNoteResponse withData(@Nonnull Note data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetNoteResponse withRaw(@Nullable Map<String, Object> raw) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetNoteResponse other = (GetNoteResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetNoteResponse.class,
    ...
    public final static class Builder {
        ...
        public Builder data(@Nonnull Note data) {
            this.data = Utils.checkNotNull(data, "data");
            return this;
        }
