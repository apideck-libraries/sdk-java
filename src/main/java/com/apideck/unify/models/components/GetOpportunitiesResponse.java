...
public class GetOpportunitiesResponse {
    ...
    public GetOpportunitiesResponse(
            ...
            @JsonProperty("data") @Nonnull List<Opportunity> data,
     ...
     * HTTP Response Status
     */
    public GetOpportunitiesResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public GetOpportunitiesResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public GetOpportunitiesResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public GetOpportunitiesResponse withOperation(@Nonnull String operation) {
        this.operation = Utils.checkNotNull(operation, "operation");
        return this;
    }


    public GetOpportunitiesResponse withData(@Nonnull List<Opportunity> data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetOpportunitiesResponse withRaw(@Nullable Map<String, Object> raw) {
     ...
     * Response metadata
     */
    public GetOpportunitiesResponse withMeta(@Nullable Meta meta) {
        this.meta = meta;
        return this;
    }
     ...
     * Links to navigate to previous or next pages through the API
     */
    public GetOpportunitiesResponse withLinks(@Nullable Links links) {
        this.links = links;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetOpportunitiesResponse other = (GetOpportunitiesResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetOpportunitiesResponse.class,
    ...
    public final static class Builder {
        ...
        public Builder data(@Nonnull List<Opportunity> data) {
            this.data = Utils.checkNotNull(data, "data");
            return this;
        }
        ...
        public GetOpportunitiesResponse build() {
