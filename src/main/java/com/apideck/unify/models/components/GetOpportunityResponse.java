...
public class GetOpportunityResponse {
    ...
    public GetOpportunityResponse(
            ...
            @JsonProperty("data") @Nonnull Opportunity data,
     ...
     * HTTP Response Status
     */
    public GetOpportunityResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public GetOpportunityResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public GetOpportunityResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public GetOpportunityResponse withOperation(@Nonnull String operation) {
        this.operation = Utils.checkNotNull(operation, "operation");
        return this;
    }


    public GetOpportunityResponse withData(@Nonnull Opportunity data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetOpportunityResponse withRaw(@Nullable Map<String, Object> raw) {
    ...
    public String toString() {
        return Utils.toString(GetOpportunityResponse.class,
    ...
    public final static class Builder {
        ...
        public Builder data(@Nonnull Opportunity data) {
            this.data = Utils.checkNotNull(data, "data");
            return this;
        }
