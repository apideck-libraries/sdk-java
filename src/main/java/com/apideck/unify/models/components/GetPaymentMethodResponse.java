...
public class GetPaymentMethodResponse {
    ...
    @JsonProperty("data")
    private AccountingPaymentMethod data;
    ...
    public GetPaymentMethodResponse(
            ...
            @JsonProperty("data") AccountingPaymentMethod data,
    ...
    @JsonIgnore
    public AccountingPaymentMethod data() {
        return data;
    }
     ...
     * HTTP Response Status
     */
    public GetPaymentMethodResponse withStatus(String status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * Apideck ID of service provider
     */
    public GetPaymentMethodResponse withService(String service) {
        Utils.checkNotNull(service, "service");
        this.service = service;
        return this;
    }
     ...
     * Unified API resource name
     */
    public GetPaymentMethodResponse withResource(String resource) {
        Utils.checkNotNull(resource, "resource");
        this.resource = resource;
        return this;
    }
     ...
     * Operation performed
     */
    public GetPaymentMethodResponse withOperation(String operation) {
        Utils.checkNotNull(operation, "operation");
        this.operation = operation;
        return this;
    }

    public GetPaymentMethodResponse withData(AccountingPaymentMethod data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }
     ...
     * Response metadata
     */
    public GetPaymentMethodResponse withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
     ...
     * Response metadata
     */
    public GetPaymentMethodResponse withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetPaymentMethodResponse withRaw(Map<String, Object> raw) {
        Utils.checkNotNull(raw, "raw");
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetPaymentMethodResponse withRaw(JsonNullable<? extends Map<String, Object>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public final static class Builder {
        ...
        public Builder data(AccountingPaymentMethod data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
