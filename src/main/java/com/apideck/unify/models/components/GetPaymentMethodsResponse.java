...
public class GetPaymentMethodsResponse {
    ...
    @JsonProperty("data")
    private List<AccountingPaymentMethod> data;
    ...
    public GetPaymentMethodsResponse(
            ...
            @JsonProperty("data") List<AccountingPaymentMethod> data,
    ...
    public GetPaymentMethodsResponse(
            ...
            String resource,
            String operation,
            List<AccountingPaymentMethod> data) {
    ...
    @JsonIgnore
    public List<AccountingPaymentMethod> data() {
        return data;
    }
     ...
     * HTTP Response Status Code
     */
    public GetPaymentMethodsResponse withStatusCode(long statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * HTTP Response Status
     */
    public GetPaymentMethodsResponse withStatus(String status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * Apideck ID of service provider
     */
    public GetPaymentMethodsResponse withService(String service) {
        Utils.checkNotNull(service, "service");
        this.service = service;
        return this;
    }
     ...
     * Unified API resource name
     */
    public GetPaymentMethodsResponse withResource(String resource) {
        Utils.checkNotNull(resource, "resource");
        this.resource = resource;
        return this;
    }
     ...
     * Operation performed
     */
    public GetPaymentMethodsResponse withOperation(String operation) {
        Utils.checkNotNull(operation, "operation");
        this.operation = operation;
        return this;
    }

    public GetPaymentMethodsResponse withData(List<AccountingPaymentMethod> data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }
     ...
     * Response metadata
     */
    public GetPaymentMethodsResponse withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
     ...
     * Response metadata
     */
    public GetPaymentMethodsResponse withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
     ...
     * Links to navigate to previous or next pages through the API
     */
    public GetPaymentMethodsResponse withLinks(Links links) {
        Utils.checkNotNull(links, "links");
     ...
     * Links to navigate to previous or next pages through the API
     */
    public GetPaymentMethodsResponse withLinks(Optional<? extends Links> links) {
        Utils.checkNotNull(links, "links");
        this.links = links;
        return this;
    }
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetPaymentMethodsResponse withRaw(Map<String, Object> raw) {
        Utils.checkNotNull(raw, "raw");
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetPaymentMethodsResponse withRaw(JsonNullable<? extends Map<String, Object>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetPaymentMethodsResponse other = (GetPaymentMethodsResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetPaymentMethodsResponse.class,
    ...
    public final static class Builder {
        ...
        public Builder data(List<AccountingPaymentMethod> data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
