...
public class GetPaymentResponse {
    ...
    public GetPaymentResponse(
            ...
            @JsonProperty("data") @Nonnull Payment data,
     ...
     * HTTP Response Status
     */
    public GetPaymentResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public GetPaymentResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public GetPaymentResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public GetPaymentResponse withOperation(@Nonnull String operation) {
        this.operation = Utils.checkNotNull(operation, "operation");
        return this;
    }


    public GetPaymentResponse withData(@Nonnull Payment data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetPaymentResponse withRaw(@Nullable Map<String, Object> raw) {
    ...
    public final static class Builder {
        ...
        public Builder data(@Nonnull Payment data) {
            this.data = Utils.checkNotNull(data, "data");
            return this;
        }
