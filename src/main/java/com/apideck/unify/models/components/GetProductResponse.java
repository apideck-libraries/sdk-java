...
public class GetProductResponse {
    ...
    public GetProductResponse(
            ...
            @JsonProperty("data") @Nonnull EcommerceProduct data,
     ...
     * HTTP Response Status
     */
    public GetProductResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public GetProductResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public GetProductResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public GetProductResponse withOperation(@Nonnull String operation) {
        this.operation = Utils.checkNotNull(operation, "operation");
        return this;
    }


    public GetProductResponse withData(@Nonnull EcommerceProduct data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetProductResponse withRaw(@Nullable Map<String, Object> raw) {
    ...
    public final static class Builder {
        ...
        public Builder data(@Nonnull EcommerceProduct data) {
            this.data = Utils.checkNotNull(data, "data");
            return this;
        }
