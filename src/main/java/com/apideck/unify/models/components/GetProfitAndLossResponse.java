...
public class GetProfitAndLossResponse {
    ...
    public GetProfitAndLossResponse(
            ...
            @JsonProperty("data") @Nonnull ProfitAndLoss data,
     ...
     * HTTP Response Status
     */
    public GetProfitAndLossResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public GetProfitAndLossResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public GetProfitAndLossResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public GetProfitAndLossResponse withOperation(@Nonnull String operation) {
        this.operation = Utils.checkNotNull(operation, "operation");
        return this;
    }


    public GetProfitAndLossResponse withData(@Nonnull ProfitAndLoss data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetProfitAndLossResponse withRaw(@Nullable Map<String, Object> raw) {
    ...
    public final static class Builder {
        ...
        public Builder data(@Nonnull ProfitAndLoss data) {
            this.data = Utils.checkNotNull(data, "data");
            return this;
        }
