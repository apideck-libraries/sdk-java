...
public class GetPurchaseOrderResponse {
    ...
    public GetPurchaseOrderResponse(
            ...
            @JsonProperty("data") @Nonnull PurchaseOrder data,
     ...
     * HTTP Response Status
     */
    public GetPurchaseOrderResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public GetPurchaseOrderResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public GetPurchaseOrderResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public GetPurchaseOrderResponse withOperation(@Nonnull String operation) {
        this.operation = Utils.checkNotNull(operation, "operation");
        return this;
    }


    public GetPurchaseOrderResponse withData(@Nonnull PurchaseOrder data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetPurchaseOrderResponse withRaw(@Nullable Map<String, Object> raw) {
    ...
    public final static class Builder {
        ...
        public Builder data(@Nonnull PurchaseOrder data) {
            this.data = Utils.checkNotNull(data, "data");
            return this;
        }
