...
public class GetSharedLinkResponse {
    ...
    public GetSharedLinkResponse(
            ...
            @JsonProperty("data") @Nonnull SharedLink data,
     ...
     * HTTP Response Status
     */
    public GetSharedLinkResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public GetSharedLinkResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public GetSharedLinkResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public GetSharedLinkResponse withOperation(@Nonnull String operation) {
        this.operation = Utils.checkNotNull(operation, "operation");
        return this;
    }


    public GetSharedLinkResponse withData(@Nonnull SharedLink data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetSharedLinkResponse withRaw(@Nullable Map<String, Object> raw) {
    ...
    public final static class Builder {
        ...
        public Builder data(@Nonnull SharedLink data) {
            this.data = Utils.checkNotNull(data, "data");
            return this;
        }
