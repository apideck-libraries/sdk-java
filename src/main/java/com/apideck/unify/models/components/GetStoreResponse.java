...
public class GetStoreResponse {
    ...
    public GetStoreResponse(
            ...
            @JsonProperty("data") @Nonnull EcommerceStore data,
     ...
     * HTTP Response Status
     */
    public GetStoreResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public GetStoreResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public GetStoreResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public GetStoreResponse withOperation(@Nonnull String operation) {
        this.operation = Utils.checkNotNull(operation, "operation");
        return this;
    }


    public GetStoreResponse withData(@Nonnull EcommerceStore data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetStoreResponse withRaw(@Nullable Map<String, Object> raw) {
    ...
    public String toString() {
        return Utils.toString(GetStoreResponse.class,
    ...
    public final static class Builder {
        ...
        public Builder data(@Nonnull EcommerceStore data) {
            this.data = Utils.checkNotNull(data, "data");
            return this;
        }
