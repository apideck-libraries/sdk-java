...
public class GetSubsidiariesResponse {
    ...
    public GetSubsidiariesResponse(
            ...
            @JsonProperty("data") @Nonnull List<Subsidiary> data,
     ...
     * HTTP Response Status
     */
    public GetSubsidiariesResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public GetSubsidiariesResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public GetSubsidiariesResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public GetSubsidiariesResponse withOperation(@Nonnull String operation) {
        this.operation = Utils.checkNotNull(operation, "operation");
        return this;
    }


    public GetSubsidiariesResponse withData(@Nonnull List<Subsidiary> data) {
     ...
     * Response metadata
     */
    public GetSubsidiariesResponse withMeta(@Nullable Meta meta) {
        this.meta = meta;
        return this;
    }
     ...
     * Links to navigate to previous or next pages through the API
     */
    public GetSubsidiariesResponse withLinks(@Nullable Links links) {
        this.links = links;
        return this;
    }
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetSubsidiariesResponse withRaw(@Nullable Map<String, Object> raw) {
    ...
    public final static class Builder {
        ...
        public Builder data(@Nonnull List<Subsidiary> data) {
            this.data = Utils.checkNotNull(data, "data");
            return this;
        }
