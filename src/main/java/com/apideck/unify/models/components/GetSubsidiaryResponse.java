...
public class GetSubsidiaryResponse {
    ...
    public GetSubsidiaryResponse(
            ...
            @JsonProperty("data") @Nonnull Subsidiary data,
     ...
     * HTTP Response Status
     */
    public GetSubsidiaryResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public GetSubsidiaryResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public GetSubsidiaryResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public GetSubsidiaryResponse withOperation(@Nonnull String operation) {
        this.operation = Utils.checkNotNull(operation, "operation");
        return this;
    }


    public GetSubsidiaryResponse withData(@Nonnull Subsidiary data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetSubsidiaryResponse withRaw(@Nullable Map<String, Object> raw) {
    ...
    public final static class Builder {
        ...
        public Builder data(@Nonnull Subsidiary data) {
            this.data = Utils.checkNotNull(data, "data");
            return this;
        }
