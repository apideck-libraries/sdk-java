...
public class GetSupplierResponse {
    ...
    public GetSupplierResponse(
            ...
            @JsonProperty("data") @Nonnull Supplier data,
     ...
     * HTTP Response Status
     */
    public GetSupplierResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public GetSupplierResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public GetSupplierResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public GetSupplierResponse withOperation(@Nonnull String operation) {
        this.operation = Utils.checkNotNull(operation, "operation");
        return this;
    }


    public GetSupplierResponse withData(@Nonnull Supplier data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetSupplierResponse withRaw(@Nullable Map<String, Object> raw) {
    ...
    public final static class Builder {
        ...
        public Builder data(@Nonnull Supplier data) {
            this.data = Utils.checkNotNull(data, "data");
            return this;
        }
