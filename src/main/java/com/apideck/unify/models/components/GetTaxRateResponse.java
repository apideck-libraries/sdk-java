...
public class GetTaxRateResponse {
    ...
    public GetTaxRateResponse(
            ...
            @JsonProperty("data") @Nonnull TaxRate data,
     ...
     * HTTP Response Status
     */
    public GetTaxRateResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public GetTaxRateResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public GetTaxRateResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public GetTaxRateResponse withOperation(@Nonnull String operation) {
        this.operation = Utils.checkNotNull(operation, "operation");
        return this;
    }


    public GetTaxRateResponse withData(@Nonnull TaxRate data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetTaxRateResponse withRaw(@Nullable Map<String, Object> raw) {
    ...
    public final static class Builder {
        ...
        public Builder data(@Nonnull TaxRate data) {
            this.data = Utils.checkNotNull(data, "data");
            return this;
        }
