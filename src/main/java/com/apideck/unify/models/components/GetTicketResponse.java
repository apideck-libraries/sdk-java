...
public class GetTicketResponse {
    ...
    public GetTicketResponse(
            ...
            @JsonProperty("data") @Nonnull Ticket data,
     ...
     * HTTP Response Status
     */
    public GetTicketResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public GetTicketResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public GetTicketResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public GetTicketResponse withOperation(@Nonnull String operation) {
        this.operation = Utils.checkNotNull(operation, "operation");
        return this;
    }


    public GetTicketResponse withData(@Nonnull Ticket data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetTicketResponse withRaw(@Nullable Map<String, Object> raw) {
    ...
    public final static class Builder {
        ...
        public Builder data(@Nonnull Ticket data) {
            this.data = Utils.checkNotNull(data, "data");
            return this;
        }
