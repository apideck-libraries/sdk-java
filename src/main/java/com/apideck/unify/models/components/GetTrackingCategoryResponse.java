...
public class GetTrackingCategoryResponse {
    ...
    public GetTrackingCategoryResponse(
            ...
            @JsonProperty("data") @Nonnull TrackingCategory data,
     ...
     * HTTP Response Status
     */
    public GetTrackingCategoryResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public GetTrackingCategoryResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public GetTrackingCategoryResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public GetTrackingCategoryResponse withOperation(@Nonnull String operation) {
        this.operation = Utils.checkNotNull(operation, "operation");
        return this;
    }


    public GetTrackingCategoryResponse withData(@Nonnull TrackingCategory data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetTrackingCategoryResponse withRaw(@Nullable Map<String, Object> raw) {
    ...
    public final static class Builder {
        ...
        public Builder data(@Nonnull TrackingCategory data) {
            this.data = Utils.checkNotNull(data, "data");
            return this;
        }
