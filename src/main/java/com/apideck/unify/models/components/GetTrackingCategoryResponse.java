...
public class GetTrackingCategoryResponse {
    ...
    public GetTrackingCategoryResponse(
            ...
            @JsonProperty("data") TrackingCategory data,
     ...
     * HTTP Response Status Code
     */
    public GetTrackingCategoryResponse withStatusCode(long statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * HTTP Response Status
     */
    public GetTrackingCategoryResponse withStatus(String status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * Apideck ID of service provider
     */
    public GetTrackingCategoryResponse withService(String service) {
        Utils.checkNotNull(service, "service");
        this.service = service;
        return this;
    }
     ...
     * Unified API resource name
     */
    public GetTrackingCategoryResponse withResource(String resource) {
        Utils.checkNotNull(resource, "resource");
        this.resource = resource;
        return this;
    }
     ...
     * Operation performed
     */
    public GetTrackingCategoryResponse withOperation(String operation) {
        Utils.checkNotNull(operation, "operation");
        this.operation = operation;
        return this;
    }

    public GetTrackingCategoryResponse withData(TrackingCategory data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }
     ...
     * Response metadata
     */
    public GetTrackingCategoryResponse withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
     ...
     * Response metadata
     */
    public GetTrackingCategoryResponse withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetTrackingCategoryResponse withRaw(Map<String, Object> raw) {
        Utils.checkNotNull(raw, "raw");
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetTrackingCategoryResponse withRaw(JsonNullable<? extends Map<String, Object>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public final static class Builder {
        ...
        public Builder data(TrackingCategory data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
