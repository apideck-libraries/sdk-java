...
public class GetUserResponse {
    ...
    public GetUserResponse(
            ...
            @JsonProperty("data") @Nonnull User data,
     ...
     * HTTP Response Status
     */
    public GetUserResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public GetUserResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public GetUserResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public GetUserResponse withOperation(@Nonnull String operation) {
        this.operation = Utils.checkNotNull(operation, "operation");
        return this;
    }


    public GetUserResponse withData(@Nonnull User data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetUserResponse withRaw(@Nullable Map<String, Object> raw) {
    ...
    public final static class Builder {
        ...
        public Builder data(@Nonnull User data) {
            this.data = Utils.checkNotNull(data, "data");
            return this;
        }
