...
public class GetWebhookResponse {
     ...
     * HTTP Response Status
     */
    public GetWebhookResponse withStatus(@Nonnull String status) {
        this.status = Utils.checkNotNull(status, "status");
        return this;
    }


    public GetWebhookResponse withData(@Nonnull Webhook data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public GetWebhookResponse withRaw(@Nullable Map<String, Object> raw) {
