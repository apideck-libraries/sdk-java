...
public class Income {
     ...
     * A unique identifier for an object.
     */
    public Income withId(@Nullable String id) {
        this.id = id;
        return this;
    }
     ...
     * The account code of the account
     */
    public Income withCode(@Nullable String code) {
        this.code = code;
        return this;
    }
     ...
     * The name of the account.
     */
    public Income withTitle(@Nullable String title) {
        this.title = title;
        return this;
    }
     ...
     * The type of profit and loss
     */
    public Income withType(@Nullable ProfitAndLossType type) {
     ...
     * The aggregated total of all accounts within this category.
     */
    public Income withTotal(@Nullable Double total) {
        this.total = JsonNullable.of(total);
        return this;
    }


    public Income withRecords(@Nonnull Object records) {
