...
public class InvoiceItemPurchaseDetails {
    ...
    @JsonCreator
    public InvoiceItemPurchaseDetails(
    ...
    public InvoiceItemPurchaseDetails withUnitPrice(double unitPrice) {
        Utils.checkNotNull(unitPrice, "unitPrice");
        this.unitPrice = JsonNullable.of(unitPrice);
        return this;
    }

    public InvoiceItemPurchaseDetails withUnitPrice(JsonNullable<Double> unitPrice) {
        Utils.checkNotNull(unitPrice, "unitPrice");
        this.unitPrice = unitPrice;
        return this;
    }
     ...
     * Description of the unit type the item is sold as, ie: kg, hour.
     */
    public InvoiceItemPurchaseDetails withUnitOfMeasure(String unitOfMeasure) {
        Utils.checkNotNull(unitOfMeasure, "unitOfMeasure");
     ...
     * Description of the unit type the item is sold as, ie: kg, hour.
     */
    public InvoiceItemPurchaseDetails withUnitOfMeasure(JsonNullable<String> unitOfMeasure) {
        Utils.checkNotNull(unitOfMeasure, "unitOfMeasure");
        this.unitOfMeasure = unitOfMeasure;
        return this;
    }
     ...
     * Amounts are including tax
     */
    public InvoiceItemPurchaseDetails withTaxInclusive(boolean taxInclusive) {
        Utils.checkNotNull(taxInclusive, "taxInclusive");
     ...
     * Amounts are including tax
     */
    public InvoiceItemPurchaseDetails withTaxInclusive(JsonNullable<Boolean> taxInclusive) {
        Utils.checkNotNull(taxInclusive, "taxInclusive");
        this.taxInclusive = taxInclusive;
        return this;
    }

    public InvoiceItemPurchaseDetails withTaxRate(LinkedTaxRateInput taxRate) {
        Utils.checkNotNull(taxRate, "taxRate");
        this.taxRate = Optional.ofNullable(taxRate);
        return this;
    }

    public InvoiceItemPurchaseDetails withTaxRate(Optional<? extends LinkedTaxRateInput> taxRate) {
        Utils.checkNotNull(taxRate, "taxRate");
        this.taxRate = taxRate;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        InvoiceItemPurchaseDetails other = (InvoiceItemPurchaseDetails) o;
        return 
    ...
    public String toString() {
        return Utils.toString(InvoiceItemPurchaseDetails.class,
                "unitPrice", unitPrice,
    ...
    public final static class Builder {
        ...
        public InvoiceItemPurchaseDetails build() {
            return new InvoiceItemPurchaseDetails(
                unitPrice,
                unitOfMeasure,
                taxInclusive,
                taxRate);
