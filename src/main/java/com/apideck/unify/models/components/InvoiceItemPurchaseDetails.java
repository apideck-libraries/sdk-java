...
public class InvoiceItemPurchaseDetails {
    ...
    public InvoiceItemPurchaseDetails withUnitPrice(@Nullable Double unitPrice) {
     ...
     * Description of the unit type the item is sold as, ie: kg, hour.
     */
    public InvoiceItemPurchaseDetails withUnitOfMeasure(@Nullable String unitOfMeasure) {
     ...
     * Amounts are including tax
     */
    public InvoiceItemPurchaseDetails withTaxInclusive(@Nullable Boolean taxInclusive) {
        this.taxInclusive = JsonNullable.of(taxInclusive);
        return this;
    }


    public InvoiceItemPurchaseDetails withTaxRate(@Nullable LinkedTaxRateInput taxRate) {
        this.taxRate = taxRate;
        return this;
    }
