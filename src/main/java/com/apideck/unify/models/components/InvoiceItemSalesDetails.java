...
public class InvoiceItemSalesDetails {
    ...
    public InvoiceItemSalesDetails withUnitPrice(@Nullable Double unitPrice) {
     ...
     * Description of the unit type the item is sold as, ie: kg, hour.
     */
    public InvoiceItemSalesDetails withUnitOfMeasure(@Nullable String unitOfMeasure) {
     ...
     * Amounts are including tax
     */
    public InvoiceItemSalesDetails withTaxInclusive(@Nullable Boolean taxInclusive) {
        this.taxInclusive = JsonNullable.of(taxInclusive);
        return this;
    }


    public InvoiceItemSalesDetails withTaxRate(@Nullable LinkedTaxRateInput taxRate) {
        this.taxRate = taxRate;
        return this;
    }
