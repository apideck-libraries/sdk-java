...
public class JobInput {
    ...
    private Optional<? extends DepartmentInput> department;
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("branch")
    private Optional<? extends JobBranch> branch;
    ...
    public JobInput(
            ...
            @JsonProperty("department") Optional<? extends DepartmentInput> department,
            @JsonProperty("branch") Optional<? extends JobBranch> branch,
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<DepartmentInput> department() {
        return (Optional<DepartmentInput>) department;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<JobBranch> branch() {
        return (Optional<JobBranch>) branch;
    }
    ...
    public JobInput withSlug(String slug) {
        Utils.checkNotNull(slug, "slug");
        this.slug = JsonNullable.of(slug);
        return this;
    }

    public JobInput withSlug(JsonNullable<String> slug) {
        Utils.checkNotNull(slug, "slug");
        this.slug = slug;
        return this;
    }
     ...
     * The job title of the person.
     */
    public JobInput withTitle(JsonNullable<String> title) {
        Utils.checkNotNull(title, "title");
        this.title = title;
        return this;
    }
     ...
     * Sequence in relation to other jobs.
     */
    public JobInput withSequence(long sequence) {
        Utils.checkNotNull(sequence, "sequence");
     ...
     * Sequence in relation to other jobs.
     */
    public JobInput withSequence(Optional<Long> sequence) {
        Utils.checkNotNull(sequence, "sequence");
        this.sequence = sequence;
        return this;
    }
     ...
     * The visibility of the job
     */
    public JobInput withVisibility(Visibility visibility) {
        Utils.checkNotNull(visibility, "visibility");
     ...
     * The visibility of the job
     */
    public JobInput withVisibility(Optional<? extends Visibility> visibility) {
        Utils.checkNotNull(visibility, "visibility");
        this.visibility = visibility;
        return this;
    }
     ...
     * The status of the job.
     */
    public JobInput withStatus(Optional<? extends JobStatus> status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * The code of the job.
     */
    public JobInput withCode(String code) {
        Utils.checkNotNull(code, "code");
     ...
     * The code of the job.
     */
    public JobInput withCode(Optional<String> code) {
        Utils.checkNotNull(code, "code");
        this.code = code;
        return this;
    }
     ...
     * language code according to ISO 639-1. For the United States - EN
     */
    public JobInput withLanguage(String language) {
        Utils.checkNotNull(language, "language");
     ...
     * language code according to ISO 639-1. For the United States - EN
     */
    public JobInput withLanguage(JsonNullable<String> language) {
        Utils.checkNotNull(language, "language");
        this.language = language;
        return this;
    }

    public JobInput withEmploymentTerms(EmploymentTerms employmentTerms) {
        Utils.checkNotNull(employmentTerms, "employmentTerms");
        this.employmentTerms = JsonNullable.of(employmentTerms);
        return this;
    }

    public JobInput withEmploymentTerms(JsonNullable<? extends EmploymentTerms> employmentTerms) {
        Utils.checkNotNull(employmentTerms, "employmentTerms");
        this.employmentTerms = employmentTerms;
        return this;
    }
     ...
     * Level of experience required for the job role.
     */
    public JobInput withExperience(String experience) {
        Utils.checkNotNull(experience, "experience");
     ...
     * Level of experience required for the job role.
     */
    public JobInput withExperience(Optional<String> experience) {
        Utils.checkNotNull(experience, "experience");
        this.experience = experience;
        return this;
    }
     ...
     * Specifies the location for the job posting.
     */
    public JobInput withLocation(JsonNullable<String> location) {
        Utils.checkNotNull(location, "location");
        this.location = location;
        return this;
    }
     ...
     * Specifies whether the posting is for a remote job.
     */
    public JobInput withRemote(boolean remote) {
        Utils.checkNotNull(remote, "remote");
     ...
     * Specifies whether the posting is for a remote job.
     */
    public JobInput withRemote(JsonNullable<Boolean> remote) {
        Utils.checkNotNull(remote, "remote");
        this.remote = remote;
        return this;
    }
     ...
     * alphanumeric naming conventions unique to your company's internal processes.
     */
    public JobInput withRequisitionId(Optional<String> requisitionId) {
        Utils.checkNotNull(requisitionId, "requisitionId");
        this.requisitionId = requisitionId;
        return this;
    }

    public JobInput withDepartment(DepartmentInput department) {
        Utils.checkNotNull(department, "department");
    ...
    public JobInput withDepartment(Optional<? extends DepartmentInput> department) {
        Utils.checkNotNull(department, "department");
        this.department = department;
        return this;
    }
     ...
     * Details of the branch for which the job is created.
     */
    public JobInput withBranch(JobBranch branch) {
        Utils.checkNotNull(branch, "branch");
     ...
     * Details of the branch for which the job is created.
     */
    public JobInput withBranch(Optional<? extends JobBranch> branch) {
        Utils.checkNotNull(branch, "branch");
        this.branch = branch;
        return this;
    }
     ...
     * qualified applicant
     */
    public JobInput withRecruiters(List<String> recruiters) {
        Utils.checkNotNull(recruiters, "recruiters");
     ...
     * qualified applicant
     */
    public JobInput withRecruiters(JsonNullable<? extends List<String>> recruiters) {
        Utils.checkNotNull(recruiters, "recruiters");
        this.recruiters = recruiters;
        return this;
    }

    public JobInput withHiringManagers(List<String> hiringManagers) {
        Utils.checkNotNull(hiringManagers, "hiringManagers");
    ...
    public JobInput withHiringManagers(Optional<? extends List<String>> hiringManagers) {
        Utils.checkNotNull(hiringManagers, "hiringManagers");
        this.hiringManagers = hiringManagers;
        return this;
    }

    public JobInput withFollowers(List<String> followers) {
        Utils.checkNotNull(followers, "followers");
        this.followers = JsonNullable.of(followers);
        return this;
    }

    public JobInput withFollowers(JsonNullable<? extends List<String>> followers) {
        Utils.checkNotNull(followers, "followers");
        this.followers = followers;
        return this;
    }
     ...
     * A description of the object.
     */
    public JobInput withDescription(JsonNullable<String> description) {
        Utils.checkNotNull(description, "description");
        this.description = description;
        return this;
    }
     ...
     * The job description in HTML format
     */
    public JobInput withDescriptionHtml(String descriptionHtml) {
        Utils.checkNotNull(descriptionHtml, "descriptionHtml");
     ...
     * The job description in HTML format
     */
    public JobInput withDescriptionHtml(JsonNullable<String> descriptionHtml) {
        Utils.checkNotNull(descriptionHtml, "descriptionHtml");
        this.descriptionHtml = descriptionHtml;
        return this;
    }

    public JobInput withBlocks(List<Blocks> blocks) {
        Utils.checkNotNull(blocks, "blocks");
    ...
    public JobInput withBlocks(Optional<? extends List<Blocks>> blocks) {
        Utils.checkNotNull(blocks, "blocks");
        this.blocks = blocks;
        return this;
    }

    public JobInput withClosing(String closing) {
        Utils.checkNotNull(closing, "closing");
        this.closing = JsonNullable.of(closing);
        return this;
    }

    public JobInput withClosing(JsonNullable<String> closing) {
        Utils.checkNotNull(closing, "closing");
        this.closing = closing;
        return this;
    }
     ...
     * The closing section of the job description in HTML format
     */
    public JobInput withClosingHtml(String closingHtml) {
        Utils.checkNotNull(closingHtml, "closingHtml");
     ...
     * The closing section of the job description in HTML format
     */
    public JobInput withClosingHtml(JsonNullable<String> closingHtml) {
        Utils.checkNotNull(closingHtml, "closingHtml");
        this.closingHtml = closingHtml;
        return this;
    }

    public JobInput withClosingDate(LocalDate closingDate) {
        Utils.checkNotNull(closingDate, "closingDate");
        this.closingDate = JsonNullable.of(closingDate);
        return this;
    }

    public JobInput withClosingDate(JsonNullable<LocalDate> closingDate) {
        Utils.checkNotNull(closingDate, "closingDate");
        this.closingDate = closingDate;
        return this;
    }

    public JobInput withSalary(Salary salary) {
        Utils.checkNotNull(salary, "salary");
    ...
    public JobInput withSalary(Optional<? extends Salary> salary) {
        Utils.checkNotNull(salary, "salary");
        this.salary = salary;
        return this;
    }
     ...
     */
    @Deprecated
    public JobInput withUrl(String url) {
        Utils.checkNotNull(url, "url");
     ...
     */
    @Deprecated
    public JobInput withUrl(JsonNullable<String> url) {
        Utils.checkNotNull(url, "url");
        this.url = url;
        return this;
    }
     ...
     */
    @Deprecated
    public JobInput withJobPortalUrl(String jobPortalUrl) {
        Utils.checkNotNull(jobPortalUrl, "jobPortalUrl");
     ...
     */
    @Deprecated
    public JobInput withJobPortalUrl(JsonNullable<String> jobPortalUrl) {
        Utils.checkNotNull(jobPortalUrl, "jobPortalUrl");
        this.jobPortalUrl = jobPortalUrl;
        return this;
    }
     ...
     */
    @Deprecated
    public JobInput withRecordUrl(String recordUrl) {
        Utils.checkNotNull(recordUrl, "recordUrl");
     ...
     */
    @Deprecated
    public JobInput withRecordUrl(JsonNullable<String> recordUrl) {
        Utils.checkNotNull(recordUrl, "recordUrl");
        this.recordUrl = recordUrl;
        return this;
    }

    public JobInput withLinks(List<JobLinks> links) {
        Utils.checkNotNull(links, "links");
    ...
    public JobInput withLinks(Optional<? extends List<JobLinks>> links) {
        Utils.checkNotNull(links, "links");
        this.links = links;
        return this;
    }

    public JobInput withConfidential(boolean confidential) {
        Utils.checkNotNull(confidential, "confidential");
    ...
    public JobInput withConfidential(Optional<Boolean> confidential) {
        Utils.checkNotNull(confidential, "confidential");
        this.confidential = confidential;
        return this;
    }
     ...
     * Specifies whether an employee of the organization can apply for the job.
     */
    public JobInput withAvailableToEmployees(boolean availableToEmployees) {
        Utils.checkNotNull(availableToEmployees, "availableToEmployees");
     ...
     * Specifies whether an employee of the organization can apply for the job.
     */
    public JobInput withAvailableToEmployees(Optional<Boolean> availableToEmployees) {
        Utils.checkNotNull(availableToEmployees, "availableToEmployees");
        this.availableToEmployees = availableToEmployees;
        return this;
    }

    public JobInput withTags(List<String> tags) {
        Utils.checkNotNull(tags, "tags");
        this.tags = JsonNullable.of(tags);
        return this;
    }

    public JobInput withTags(JsonNullable<? extends List<String>> tags) {
        Utils.checkNotNull(tags, "tags");
        this.tags = tags;
        return this;
    }

    public JobInput withAddresses(List<Address> addresses) {
        Utils.checkNotNull(addresses, "addresses");
    ...
    public JobInput withAddresses(Optional<? extends List<Address>> addresses) {
        Utils.checkNotNull(addresses, "addresses");
        this.addresses = addresses;
        return this;
    }

    public JobInput withCustomFields(List<CustomField> customFields) {
        Utils.checkNotNull(customFields, "customFields");
    ...
    public JobInput withCustomFields(Optional<? extends List<CustomField>> customFields) {
        Utils.checkNotNull(customFields, "customFields");
        this.customFields = customFields;
        return this;
    }
     ...
     * Flag to indicate if the object is deleted.
     */
    public JobInput withDeleted(boolean deleted) {
        Utils.checkNotNull(deleted, "deleted");
     ...
     * Flag to indicate if the object is deleted.
     */
    public JobInput withDeleted(JsonNullable<Boolean> deleted) {
        Utils.checkNotNull(deleted, "deleted");
        this.deleted = deleted;
        return this;
    }

    public JobInput withOwnerId(String ownerId) {
        Utils.checkNotNull(ownerId, "ownerId");
        this.ownerId = JsonNullable.of(ownerId);
        return this;
    }

    public JobInput withOwnerId(JsonNullable<String> ownerId) {
        Utils.checkNotNull(ownerId, "ownerId");
        this.ownerId = ownerId;
        return this;
    }
    ...
    public int hashCode() {
        return Utils.enhancedHash(
            slug, title, sequence,
            visibility, status, code,
            language, employmentTerms, experience,
            location, remote, requisitionId,
            department, branch, recruiters,
            hiringManagers, followers, description,
            descriptionHtml, blocks, closing,
            closingHtml, closingDate, salary,
            url, jobPortalUrl, recordUrl,
            links, confidential, availableToEmployees,
            tags, addresses, customFields,
            deleted, ownerId);
    }
    
    @Override
    public String toString() {
        return Utils.toString(JobInput.class,
                "slug", slug,
                "title", title,
                "sequence", sequence,
    ...
    public final static class Builder {
        ...
        private Optional<? extends DepartmentInput> department = Optional.empty();

        private Optional<? extends JobBranch> branch = Optional.empty();
        ...
        public Builder department(DepartmentInput department) {
            Utils.checkNotNull(department, "department");
            this.department = Optional.ofNullable(department);
            return this;
        }

        public Builder department(Optional<? extends DepartmentInput> department) {
            Utils.checkNotNull(department, "department");
            this.department = department;
            return this;
        }
         ...
         * Details of the branch for which the job is created.
         */
        public Builder branch(JobBranch branch) {
            Utils.checkNotNull(branch, "branch");
            this.branch = Optional.ofNullable(branch);
            return this;
        }
         ...
         * Details of the branch for which the job is created.
         */
        public Builder branch(Optional<? extends JobBranch> branch) {
            Utils.checkNotNull(branch, "branch");
            this.branch = branch;
            return this;
        }
