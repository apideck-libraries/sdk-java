...
public class JournalEntryInput {
    ...
    private List<JournalEntryLineItemInput> lineItems;
    ...
    public JournalEntryInput(
            ...
            @JsonProperty("line_items") @Nullable List<JournalEntryLineItemInput> lineItems,
     ...
     * Journal entry title
     */
    public JournalEntryInput withTitle(@Nullable String title) {
     ...
     * Currency Exchange Rate at the time entity was recorded/generated.
     */
    public JournalEntryInput withCurrencyRate(@Nullable Double currencyRate) {
     ...
     * Indicates the associated currency for an amount of money. Values correspond to [ISO 4217](https://en.wikipedia.org/wiki/ISO_4217).
     */
    public JournalEntryInput withCurrency(@Nullable Currency currency) {
     ...
     * The company or subsidiary id the transaction belongs to
     */
    public JournalEntryInput withCompanyId(@Nullable String companyId) {
     ...
     * Requires a minimum of 2 line items that sum to 0
     */
    public JournalEntryInput withLineItems(@Nullable List<JournalEntryLineItemInput> lineItems) {
        this.lineItems = lineItems;
        return this;
    }
     ...
     * Journal entry status
     */
    public JournalEntryInput withStatus(@Nullable JournalEntryStatus status) {
     ...
     * Reference for the journal entry.
     */
    public JournalEntryInput withMemo(@Nullable String memo) {
     ...
     * This is the date on which the journal entry was added. This can be different from the creation date and can also be backdated.
     */
    public JournalEntryInput withPostedAt(@Nullable OffsetDateTime postedAt) {
        this.postedAt = postedAt;
        return this;
    }
     ...
     * Journal symbol of the entry. For example IND for indirect costs
     */
    public JournalEntryInput withJournalSymbol(@Nullable String journalSymbol) {
     ...
     * The specific category of tax associated with a transaction like sales or purchase
     */
    public JournalEntryInput withTaxType(@Nullable String taxType) {
     ...
     * Applicable tax id/code override if tax is not supplied on a line item basis.
     */
    public JournalEntryInput withTaxCode(@Nullable String taxCode) {
     ...
     * Journal entry number.
     */
    public JournalEntryInput withNumber(@Nullable String number) {
     ...
     * A list of linked tracking categories.
     */
    public JournalEntryInput withTrackingCategories(@Nullable List<LinkedTrackingCategory> trackingCategories) {
     ...
     * Accounting period
     */
    public JournalEntryInput withAccountingPeriod(@Nullable String accountingPeriod) {
     ...
     * A binary value used to detect updates to a object and prevent data conflicts. It is incremented each time an update is made to the object.
     */
    public JournalEntryInput withRowVersion(@Nullable String rowVersion) {
        this.rowVersion = JsonNullable.of(rowVersion);
        return this;
    }


    public JournalEntryInput withCustomFields(@Nullable List<CustomField> customFields) {
        this.customFields = customFields;
        return this;
    }
     ...
     * The pass_through property allows passing service-specific, custom data or structured modifications in request body when creating or updating resources.
     */
    public JournalEntryInput withPassThrough(@Nullable List<PassThroughBody> passThrough) {
        this.passThrough = passThrough;
        return this;
    }
    ...
    public final static class Builder {
         ...
         * Requires a minimum of 2 line items that sum to 0
         */
        public Builder lineItems(@Nullable List<JournalEntryLineItemInput> lineItems) {
            this.lineItems = lineItems;
            return this;
        }
