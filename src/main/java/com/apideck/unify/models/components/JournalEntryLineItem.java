...
public class JournalEntryLineItem {
     ...
     * legitimately absent rather than wrong.
     */
    public JournalEntryLineItem withDate(LocalDate date) {
        Utils.checkNotNull(date, "date");
     ...
     * legitimately absent rather than wrong.
     */
    public JournalEntryLineItem withDate(JsonNullable<LocalDate> date) {
        Utils.checkNotNull(date, "date");
        this.date = date;
        return this;
    }
     ...
     * single journal entry aggregates lines originating from more than one source.
     */
    public JournalEntryLineItem withSourceId(String sourceId) {
        Utils.checkNotNull(sourceId, "sourceId");
     ...
     * single journal entry aggregates lines originating from more than one source.
     */
    public JournalEntryLineItem withSourceId(JsonNullable<String> sourceId) {
        Utils.checkNotNull(sourceId, "sourceId");
        this.sourceId = sourceId;
        return this;
    }
