...
public class LinkedLocation {
     ...
     * The unique identifier for the location.
     */
    public LinkedLocation withId(String id) {
        Utils.checkNotNull(id, "id");
     ...
     * The unique identifier for the location.
     */
    public LinkedLocation withId(Optional<String> id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * Id to be displayed.
     */
    public LinkedLocation withDisplayId(String displayId) {
        Utils.checkNotNull(displayId, "displayId");
     ...
     * Id to be displayed.
     */
    public LinkedLocation withDisplayId(JsonNullable<String> displayId) {
        Utils.checkNotNull(displayId, "displayId");
        this.displayId = displayId;
        return this;
    }
     ...
     * The name of the location.
     */
    public LinkedLocation withName(String name) {
        Utils.checkNotNull(name, "name");
     ...
     * The name of the location.
     */
    public LinkedLocation withName(JsonNullable<String> name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }
     ...
     * The third-party API ID of original entity
     */
    public LinkedLocation withDownstreamId(String downstreamId) {
        Utils.checkNotNull(downstreamId, "downstreamId");
     ...
     * The third-party API ID of original entity
     */
    public LinkedLocation withDownstreamId(JsonNullable<String> downstreamId) {
        Utils.checkNotNull(downstreamId, "downstreamId");
        this.downstreamId = downstreamId;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        LinkedLocation other = (LinkedLocation) o;
        return 
    ...
    public String toString() {
        return Utils.toString(LinkedLocation.class,
                "id", id,
                "displayId", displayId,
                "name", name,
