 ...
 * Mode
 * 
 * <p>Mode of the webhook support.
 */
public class Mode {

    public static final Mode NATIVE = new Mode("native");
    public static final Mode VIRTUAL = new Mode("virtual");
    ...
    private static final Map<String, ModeEnum> createEnumsMap() {
        ...
        map.put("native", ModeEnum.NATIVE);
        map.put("virtual", ModeEnum.VIRTUAL);
        map.put("none", ModeEnum.NONE);
        return map;
    }
