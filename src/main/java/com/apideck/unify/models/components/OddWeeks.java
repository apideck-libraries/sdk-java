...
public class OddWeeks {
    ...
    public OddWeeks withHoursMonday(@Nullable Double hoursMonday) {
        this.hoursMonday = hoursMonday;
        return this;
    }


    public OddWeeks withHoursTuesday(@Nullable Double hoursTuesday) {
        this.hoursTuesday = hoursTuesday;
        return this;
    }


    public OddWeeks withHoursWednesday(@Nullable Double hoursWednesday) {
        this.hoursWednesday = hoursWednesday;
        return this;
    }


    public OddWeeks withHoursThursday(@Nullable Double hoursThursday) {
        this.hoursThursday = hoursThursday;
        return this;
    }


    public OddWeeks withHoursFriday(@Nullable Double hoursFriday) {
        this.hoursFriday = hoursFriday;
        return this;
    }


    public OddWeeks withHoursSaturday(@Nullable Double hoursSaturday) {
        this.hoursSaturday = hoursSaturday;
        return this;
    }


    public OddWeeks withHoursSunday(@Nullable Double hoursSunday) {
        this.hoursSunday = hoursSunday;
        return this;
    }
