...
public class OrderPickupDetails {
    ...
    public OrderPickupDetails() {
        this(JsonNullable.undefined(), JsonNullable.undefined(), Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty());
    }
     ...
     * The duration of time after which an open and accepted pickup fulfillment is automatically moved to the COMPLETED state. The duration must be in RFC 3339 format (for example, 'P1W3D').
     */
    public OrderPickupDetails withAutoCompleteDuration(String autoCompleteDuration) {
        Utils.checkNotNull(autoCompleteDuration, "autoCompleteDuration");
     ...
     * The duration of time after which an open and accepted pickup fulfillment is automatically moved to the COMPLETED state. The duration must be in RFC 3339 format (for example, 'P1W3D').
     */
    public OrderPickupDetails withAutoCompleteDuration(JsonNullable<String> autoCompleteDuration) {
        Utils.checkNotNull(autoCompleteDuration, "autoCompleteDuration");
        this.autoCompleteDuration = autoCompleteDuration;
        return this;
    }
     ...
     * A description of why the pickup was canceled.
     */
    public OrderPickupDetails withCancelReason(String cancelReason) {
        Utils.checkNotNull(cancelReason, "cancelReason");
     ...
     * A description of why the pickup was canceled.
     */
    public OrderPickupDetails withCancelReason(JsonNullable<String> cancelReason) {
        Utils.checkNotNull(cancelReason, "cancelReason");
        this.cancelReason = cancelReason;
        return this;
    }
     ...
     * placed.
     */
    public OrderPickupDetails withExpiresAt(OffsetDateTime expiresAt) {
        Utils.checkNotNull(expiresAt, "expiresAt");
     ...
     * placed.
     */
    public OrderPickupDetails withExpiresAt(Optional<OffsetDateTime> expiresAt) {
        Utils.checkNotNull(expiresAt, "expiresAt");
        this.expiresAt = expiresAt;
        return this;
    }
     ...
     * The schedule type of the pickup fulfillment.
     */
    public OrderPickupDetails withScheduleType(ScheduleType scheduleType) {
        Utils.checkNotNull(scheduleType, "scheduleType");
     ...
     * The schedule type of the pickup fulfillment.
     */
    public OrderPickupDetails withScheduleType(Optional<? extends ScheduleType> scheduleType) {
        Utils.checkNotNull(scheduleType, "scheduleType");
        this.scheduleType = scheduleType;
        return this;
    }
     ...
     * to the current time plus the expected duration to prepare the fulfillment.
     */
    public OrderPickupDetails withPickupAt(OffsetDateTime pickupAt) {
        Utils.checkNotNull(pickupAt, "pickupAt");
     ...
     * to the current time plus the expected duration to prepare the fulfillment.
     */
    public OrderPickupDetails withPickupAt(Optional<OffsetDateTime> pickupAt) {
        Utils.checkNotNull(pickupAt, "pickupAt");
        this.pickupAt = pickupAt;
        return this;
    }
     ...
     * informational guideline for merchants.
     */
    public OrderPickupDetails withPickupWindowDuration(String pickupWindowDuration) {
        Utils.checkNotNull(pickupWindowDuration, "pickupWindowDuration");
     ...
     * informational guideline for merchants.
     */
    public OrderPickupDetails withPickupWindowDuration(Optional<String> pickupWindowDuration) {
        Utils.checkNotNull(pickupWindowDuration, "pickupWindowDuration");
        this.pickupWindowDuration = pickupWindowDuration;
        return this;
    }
     ...
     * The duration must be in RFC 3339 format (for example, "P1W3D").
     */
    public OrderPickupDetails withPrepTimeDuration(String prepTimeDuration) {
        Utils.checkNotNull(prepTimeDuration, "prepTimeDuration");
     ...
     * The duration must be in RFC 3339 format (for example, "P1W3D").
     */
    public OrderPickupDetails withPrepTimeDuration(Optional<String> prepTimeDuration) {
        Utils.checkNotNull(prepTimeDuration, "prepTimeDuration");
        this.prepTimeDuration = prepTimeDuration;
        return this;
    }
     ...
     * fulfillment displayed in the Square Point of Sale application and set by the API.
     */
    public OrderPickupDetails withNote(String note) {
        Utils.checkNotNull(note, "note");
     ...
     * fulfillment displayed in the Square Point of Sale application and set by the API.
     */
    public OrderPickupDetails withNote(Optional<String> note) {
        Utils.checkNotNull(note, "note");
        this.note = note;
        return this;
    }
     ...
     * (for example, "2016-09-04T23:59:33.123Z").
     */
    public OrderPickupDetails withPlacedAt(OffsetDateTime placedAt) {
        Utils.checkNotNull(placedAt, "placedAt");
     ...
     * (for example, "2016-09-04T23:59:33.123Z").
     */
    public OrderPickupDetails withPlacedAt(Optional<OffsetDateTime> placedAt) {
        Utils.checkNotNull(placedAt, "placedAt");
        this.placedAt = placedAt;
        return this;
    }
     ...
     * (for example, "2016-09-04T23:59:33.123Z").
     */
    public OrderPickupDetails withRejectedAt(OffsetDateTime rejectedAt) {
        Utils.checkNotNull(rejectedAt, "rejectedAt");
     ...
     * (for example, "2016-09-04T23:59:33.123Z").
     */
    public OrderPickupDetails withRejectedAt(Optional<OffsetDateTime> rejectedAt) {
        Utils.checkNotNull(rejectedAt, "rejectedAt");
        this.rejectedAt = rejectedAt;
        return this;
    }
     ...
     * (for example, "2016-09-04T23:59:33.123Z").
     */
    public OrderPickupDetails withReadyAt(OffsetDateTime readyAt) {
        Utils.checkNotNull(readyAt, "readyAt");
     ...
     * (for example, "2016-09-04T23:59:33.123Z").
     */
    public OrderPickupDetails withReadyAt(Optional<OffsetDateTime> readyAt) {
        Utils.checkNotNull(readyAt, "readyAt");
        this.readyAt = readyAt;
        return this;
    }
     ...
     * (for example, "2016-09-04T23:59:33.123Z").
     */
    public OrderPickupDetails withExpiredAt(OffsetDateTime expiredAt) {
        Utils.checkNotNull(expiredAt, "expiredAt");
     ...
     * (for example, "2016-09-04T23:59:33.123Z").
     */
    public OrderPickupDetails withExpiredAt(Optional<OffsetDateTime> expiredAt) {
        Utils.checkNotNull(expiredAt, "expiredAt");
        this.expiredAt = expiredAt;
        return this;
    }
     ...
     * (for example, "2016-09-04T23:59:33.123Z").
     */
    public OrderPickupDetails withPickedUpAt(OffsetDateTime pickedUpAt) {
        Utils.checkNotNull(pickedUpAt, "pickedUpAt");
     ...
     * (for example, "2016-09-04T23:59:33.123Z").
     */
    public OrderPickupDetails withPickedUpAt(Optional<OffsetDateTime> pickedUpAt) {
        Utils.checkNotNull(pickedUpAt, "pickedUpAt");
        this.pickedUpAt = pickedUpAt;
        return this;
    }
     ...
     * (for example, "2016-09-04T23:59:33.123Z").
     */
    public OrderPickupDetails withCanceledAt(OffsetDateTime canceledAt) {
        Utils.checkNotNull(canceledAt, "canceledAt");
     ...
     * (for example, "2016-09-04T23:59:33.123Z").
     */
    public OrderPickupDetails withCanceledAt(Optional<OffsetDateTime> canceledAt) {
        Utils.checkNotNull(canceledAt, "canceledAt");
        this.canceledAt = canceledAt;
        return this;
    }
     ...
     * If set to `true`, indicates that this pickup order is for curbside pickup, not in-store pickup.
     */
    public OrderPickupDetails withIsCurbsidePickup(boolean isCurbsidePickup) {
        Utils.checkNotNull(isCurbsidePickup, "isCurbsidePickup");
     ...
     * If set to `true`, indicates that this pickup order is for curbside pickup, not in-store pickup.
     */
    public OrderPickupDetails withIsCurbsidePickup(Optional<Boolean> isCurbsidePickup) {
        Utils.checkNotNull(isCurbsidePickup, "isCurbsidePickup");
        this.isCurbsidePickup = isCurbsidePickup;
        return this;
    }
     ...
     * Specific details for curbside pickup.
     */
    public OrderPickupDetails withCurbsidePickupDetails(CurbsidePickupDetails curbsidePickupDetails) {
        Utils.checkNotNull(curbsidePickupDetails, "curbsidePickupDetails");
     ...
     * Specific details for curbside pickup.
     */
    public OrderPickupDetails withCurbsidePickupDetails(Optional<? extends CurbsidePickupDetails> curbsidePickupDetails) {
        Utils.checkNotNull(curbsidePickupDetails, "curbsidePickupDetails");
        this.curbsidePickupDetails = curbsidePickupDetails;
        return this;
    }

    public OrderPickupDetails withRecipient(Recipient recipient) {
        Utils.checkNotNull(recipient, "recipient");
        this.recipient = Optional.ofNullable(recipient);
        return this;
    }

    public OrderPickupDetails withRecipient(Optional<? extends Recipient> recipient) {
        Utils.checkNotNull(recipient, "recipient");
        this.recipient = recipient;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        OrderPickupDetails other = (OrderPickupDetails) o;
        return 
    ...
    public String toString() {
        return Utils.toString(OrderPickupDetails.class,
