...
public class OtherExpenses {
     ...
     * A unique identifier for an object.
     */
    public OtherExpenses withId(@Nullable String id) {
        this.id = id;
        return this;
    }
     ...
     * The account code of the account
     */
    public OtherExpenses withCode(@Nullable String code) {
        this.code = code;
        return this;
    }
     ...
     * The name of the account.
     */
    public OtherExpenses withTitle(@Nullable String title) {
        this.title = title;
        return this;
    }
     ...
     * The type of profit and loss
     */
    public OtherExpenses withType(@Nullable ProfitAndLossType type) {
     ...
     * The aggregated total of all accounts within this category.
     */
    public OtherExpenses withTotal(@Nullable Double total) {
        this.total = JsonNullable.of(total);
        return this;
    }


    public OtherExpenses withRecords(@Nonnull Object records) {
