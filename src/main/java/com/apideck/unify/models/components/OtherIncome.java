...
public class OtherIncome {
     ...
     * A unique identifier for an object.
     */
    public OtherIncome withId(@Nullable String id) {
        this.id = id;
        return this;
    }
     ...
     * The account code of the account
     */
    public OtherIncome withCode(@Nullable String code) {
        this.code = code;
        return this;
    }
     ...
     * The name of the account.
     */
    public OtherIncome withTitle(@Nullable String title) {
        this.title = title;
        return this;
    }
     ...
     * The type of profit and loss
     */
    public OtherIncome withType(@Nullable ProfitAndLossType type) {
     ...
     * The aggregated total of all accounts within this category.
     */
    public OtherIncome withTotal(@Nullable Double total) {
        this.total = JsonNullable.of(total);
        return this;
    }


    public OtherIncome withRecords(@Nonnull Object records) {
