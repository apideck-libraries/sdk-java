...
public class PaymentsSort {
    ...
    private Optional<? extends PaymentsSortBy> by;
    ...
    @JsonCreator
    public PaymentsSort(
            Optional<? extends PaymentsSortBy> by,
    ...
    public Optional<PaymentsSortBy> by() {
        return (Optional<PaymentsSortBy>) by;
    }
     ...
     * The field on which to sort the Payments
     */
    public PaymentsSort withBy(PaymentsSortBy by) {
        Utils.checkNotNull(by, "by");
     ...
     * The field on which to sort the Payments
     */
    public PaymentsSort withBy(Optional<? extends PaymentsSortBy> by) {
        Utils.checkNotNull(by, "by");
        this.by = by;
        return this;
    }
     ...
     * The direction in which to sort the results
     */
    public PaymentsSort withDirection(SortDirection direction) {
        Utils.checkNotNull(direction, "direction");
     ...
     * The direction in which to sort the results
     */
    public PaymentsSort withDirection(Optional<? extends SortDirection> direction) {
        Utils.checkNotNull(direction, "direction");
        this.direction = direction;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends PaymentsSortBy> by = Optional.empty();
         ...
         * The field on which to sort the Payments
         */
        public Builder by(PaymentsSortBy by) {
            Utils.checkNotNull(by, "by");
            this.by = Optional.ofNullable(by);
            return this;
        }
         ...
         * The field on which to sort the Payments
         */
        public Builder by(Optional<? extends PaymentsSortBy> by) {
            Utils.checkNotNull(by, "by");
            this.by = by;
            return this;
        }
