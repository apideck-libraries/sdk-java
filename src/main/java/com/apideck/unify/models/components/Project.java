...
public class Project {
    ...
    private JsonNullable<Double> actualAmount;
    ...
    private JsonNullable<Double> actualHours;
    ...
    public Project(
            ...
            @JsonProperty("actual_amount") JsonNullable<Double> actualAmount,
            @JsonProperty("budget_hours") JsonNullable<Double> budgetHours,
            @JsonProperty("actual_hours") JsonNullable<Double> actualHours,
        ...
        Utils.checkNotNull(actualAmount, "actualAmount");
        Utils.checkNotNull(budgetHours, "budgetHours");
        Utils.checkNotNull(actualHours, "actualHours");
     ...
     */
    @JsonIgnore
    public JsonNullable<Double> actualAmount() {
        return actualAmount;
    }
     ...
     */
    @JsonIgnore
    public JsonNullable<Double> actualHours() {
        return actualHours;
    }
     ...
     * A unique identifier for an object.
     */
    public Project withId(Optional<String> id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * The third-party API ID of original entity
     */
    public Project withDownstreamId(String downstreamId) {
        Utils.checkNotNull(downstreamId, "downstreamId");
     ...
     * The third-party API ID of original entity
     */
    public Project withDownstreamId(JsonNullable<String> downstreamId) {
        Utils.checkNotNull(downstreamId, "downstreamId");
        this.downstreamId = downstreamId;
        return this;
    }
     ...
     * User-friendly project identifier
     */
    public Project withDisplayId(String displayId) {
        Utils.checkNotNull(displayId, "displayId");
     ...
     * User-friendly project identifier
     */
    public Project withDisplayId(JsonNullable<String> displayId) {
        Utils.checkNotNull(displayId, "displayId");
        this.displayId = displayId;
        return this;
    }
     ...
     * External reference identifier for the project
     */
    public Project withReferenceId(String referenceId) {
        Utils.checkNotNull(referenceId, "referenceId");
     ...
     * External reference identifier for the project
     */
    public Project withReferenceId(JsonNullable<String> referenceId) {
        Utils.checkNotNull(referenceId, "referenceId");
        this.referenceId = referenceId;
        return this;
    }
     ...
     * Detailed description of the project
     */
    public Project withDescription(JsonNullable<String> description) {
        Utils.checkNotNull(description, "description");
        this.description = description;
        return this;
    }
     ...
     * Current status of the project
     */
    public Project withStatus(ProjectProjectStatus status) {
        Utils.checkNotNull(status, "status");
     ...
     * Type or category of the project
     */
    public Project withProjectType(ProjectType projectType) {
        Utils.checkNotNull(projectType, "projectType");
     ...
     * Type or category of the project
     */
    public Project withProjectType(JsonNullable<? extends ProjectType> projectType) {
        Utils.checkNotNull(projectType, "projectType");
        this.projectType = projectType;
        return this;
    }
     ...
     * Priority level of the project
     */
    public Project withPriority(Priority priority) {
        Utils.checkNotNull(priority, "priority");
     ...
     * Priority level of the project
     */
    public Project withPriority(JsonNullable<? extends Priority> priority) {
        Utils.checkNotNull(priority, "priority");
        this.priority = priority;
        return this;
    }
     ...
     * Percentage of project completion (0-100)
     */
    public Project withCompletionPercentage(double completionPercentage) {
        Utils.checkNotNull(completionPercentage, "completionPercentage");
     ...
     * Percentage of project completion (0-100)
     */
    public Project withCompletionPercentage(JsonNullable<Double> completionPercentage) {
        Utils.checkNotNull(completionPercentage, "completionPercentage");
        this.completionPercentage = completionPercentage;
        return this;
    }
     ...
     * Start date of the project
     */
    public Project withStartDate(JsonNullable<LocalDate> startDate) {
        Utils.checkNotNull(startDate, "startDate");
        this.startDate = startDate;
        return this;
    }
     ...
     * Expected or planned end date of the project
     */
    public Project withEndDate(JsonNullable<LocalDate> endDate) {
        Utils.checkNotNull(endDate, "endDate");
        this.endDate = endDate;
        return this;
    }
     ...
     * Actual end date of the project
     */
    public Project withCompletionDate(LocalDate completionDate) {
        Utils.checkNotNull(completionDate, "completionDate");
     ...
     * Actual end date of the project
     */
    public Project withCompletionDate(JsonNullable<LocalDate> completionDate) {
        Utils.checkNotNull(completionDate, "completionDate");
        this.completionDate = completionDate;
        return this;
    }
     ...
     * The customer this entity is linked to.
     */
    public Project withCustomer(LinkedCustomer customer) {
        Utils.checkNotNull(customer, "customer");
     ...
     * The customer this entity is linked to.
     */
    public Project withCustomer(JsonNullable<? extends LinkedCustomer> customer) {
        Utils.checkNotNull(customer, "customer");
        this.customer = customer;
        return this;
    }
     ...
     * Department or organizational unit associated with the project
     */
    public Project withDepartment(ProjectDepartment department) {
        Utils.checkNotNull(department, "department");
     ...
     * Department or organizational unit associated with the project
     */
    public Project withDepartment(JsonNullable<? extends ProjectDepartment> department) {
        Utils.checkNotNull(department, "department");
        this.department = department;
        return this;
    }
     ...
     * The company ID the transaction belongs to
     */
    public Project withCompanyId(String companyId) {
        Utils.checkNotNull(companyId, "companyId");
     ...
     * The company ID the transaction belongs to
     */
    public Project withCompanyId(JsonNullable<String> companyId) {
        Utils.checkNotNull(companyId, "companyId");
        this.companyId = companyId;
        return this;
    }
     ...
     * ID of the user who owns/manages this project
     */
    public Project withOwnerId(String ownerId) {
        Utils.checkNotNull(ownerId, "ownerId");
     ...
     * ID of the user who owns/manages this project
     */
    public Project withOwnerId(JsonNullable<String> ownerId) {
        Utils.checkNotNull(ownerId, "ownerId");
        this.ownerId = ownerId;
        return this;
    }
     ...
     * Parent project if this is a subproject
     */
    public Project withParentProject(ParentProject parentProject) {
        Utils.checkNotNull(parentProject, "parentProject");
     ...
     * Parent project if this is a subproject
     */
    public Project withParentProject(JsonNullable<? extends ParentProject> parentProject) {
        Utils.checkNotNull(parentProject, "parentProject");
        this.parentProject = parentProject;
        return this;
    }
     ...
     * 4217](https://en.wikipedia.org/wiki/ISO_4217).
     */
    public Project withCurrency(Currency currency) {
        Utils.checkNotNull(currency, "currency");
     ...
     * 4217](https://en.wikipedia.org/wiki/ISO_4217).
     */
    public Project withCurrency(JsonNullable<? extends Currency> currency) {
        Utils.checkNotNull(currency, "currency");
        this.currency = currency;
        return this;
    }
     ...
     * Total budgeted amount for the project
     */
    public Project withBudgetAmount(double budgetAmount) {
        Utils.checkNotNull(budgetAmount, "budgetAmount");
     ...
     * Total budgeted amount for the project
     */
    public Project withBudgetAmount(JsonNullable<Double> budgetAmount) {
        Utils.checkNotNull(budgetAmount, "budgetAmount");
        this.budgetAmount = budgetAmount;
        return this;
    }
     ...
     * Approved budget amount for the project
     */
    public Project withApprovedAmount(double approvedAmount) {
        Utils.checkNotNull(approvedAmount, "approvedAmount");
     ...
     * Approved budget amount for the project
     */
    public Project withApprovedAmount(JsonNullable<Double> approvedAmount) {
        Utils.checkNotNull(approvedAmount, "approvedAmount");
        this.approvedAmount = approvedAmount;
        return this;
    }
     ...
     * Total actual amount spent on the project
     */
    public Project withActualAmount(double actualAmount) {
        Utils.checkNotNull(actualAmount, "actualAmount");
        this.actualAmount = JsonNullable.of(actualAmount);
        return this;
    }
     ...
     * Total actual amount spent on the project
     */
    public Project withActualAmount(JsonNullable<Double> actualAmount) {
        Utils.checkNotNull(actualAmount, "actualAmount");
        this.actualAmount = actualAmount;
        return this;
    }
     ...
     * Total budgeted hours for the project
     */
    public Project withBudgetHours(double budgetHours) {
        Utils.checkNotNull(budgetHours, "budgetHours");
     ...
     * Total budgeted hours for the project
     */
    public Project withBudgetHours(JsonNullable<Double> budgetHours) {
        Utils.checkNotNull(budgetHours, "budgetHours");
        this.budgetHours = budgetHours;
        return this;
    }
     ...
     * Total actual hours worked on the project
     */
    public Project withActualHours(double actualHours) {
        Utils.checkNotNull(actualHours, "actualHours");
        this.actualHours = JsonNullable.of(actualHours);
        return this;
    }
     ...
     * Total actual hours worked on the project
     */
    public Project withActualHours(JsonNullable<Double> actualHours) {
        Utils.checkNotNull(actualHours, "actualHours");
        this.actualHours = actualHours;
        return this;
    }
     ...
     * Default hourly rate for project work
     */
    public Project withHourlyRate(double hourlyRate) {
        Utils.checkNotNull(hourlyRate, "hourlyRate");
     ...
     * Default hourly rate for project work
     */
    public Project withHourlyRate(JsonNullable<Double> hourlyRate) {
        Utils.checkNotNull(hourlyRate, "hourlyRate");
        this.hourlyRate = hourlyRate;
        return this;
    }
     ...
     * Method used for billing this project
     */
    public Project withBillingMethod(BillingMethod billingMethod) {
        Utils.checkNotNull(billingMethod, "billingMethod");
     ...
     * Method used for billing this project
     */
    public Project withBillingMethod(JsonNullable<? extends BillingMethod> billingMethod) {
        Utils.checkNotNull(billingMethod, "billingMethod");
        this.billingMethod = billingMethod;
        return this;
    }
     ...
     * Indicates if the project is billable to the customer
     */
    public Project withIsBillable(boolean isBillable) {
        Utils.checkNotNull(isBillable, "isBillable");
     ...
     * Indicates if the project is billable to the customer
     */
    public Project withIsBillable(JsonNullable<Boolean> isBillable) {
        Utils.checkNotNull(isBillable, "isBillable");
        this.isBillable = isBillable;
        return this;
    }
     ...
     * Current phase of the project lifecycle
     */
    public Project withPhase(ProjectPhase phase) {
        Utils.checkNotNull(phase, "phase");
     ...
     * Current phase of the project lifecycle
     */
    public Project withPhase(JsonNullable<? extends ProjectPhase> phase) {
        Utils.checkNotNull(phase, "phase");
        this.phase = phase;
        return this;
    }

    public Project withTaxRate(LinkedTaxRate taxRate) {
        Utils.checkNotNull(taxRate, "taxRate");
    ...
    public Project withTaxRate(Optional<? extends LinkedTaxRate> taxRate) {
        Utils.checkNotNull(taxRate, "taxRate");
        this.taxRate = taxRate;
        return this;
    }
     ...
     * A list of linked tracking categories.
     */
    public Project withTrackingCategories(List<LinkedTrackingCategory> trackingCategories) {
        Utils.checkNotNull(trackingCategories, "trackingCategories");
     ...
     * A list of linked tracking categories.
     */
    public Project withTrackingCategories(JsonNullable<? extends List<LinkedTrackingCategory>> trackingCategories) {
        Utils.checkNotNull(trackingCategories, "trackingCategories");
        this.trackingCategories = trackingCategories;
        return this;
    }
     ...
     * Tags associated with the project
     */
    public Project withTags(List<String> tags) {
        Utils.checkNotNull(tags, "tags");
     ...
     * Tags associated with the project
     */
    public Project withTags(Optional<? extends List<String>> tags) {
        Utils.checkNotNull(tags, "tags");
        this.tags = tags;
        return this;
    }
     ...
     * Additional notes about the project
     */
    public Project withNotes(JsonNullable<String> notes) {
        Utils.checkNotNull(notes, "notes");
        this.notes = notes;
        return this;
    }
     ...
     * Contract or agreement number associated with the project
     */
    public Project withContractNumber(String contractNumber) {
        Utils.checkNotNull(contractNumber, "contractNumber");
     ...
     * Contract or agreement number associated with the project
     */
    public Project withContractNumber(JsonNullable<String> contractNumber) {
        Utils.checkNotNull(contractNumber, "contractNumber");
        this.contractNumber = contractNumber;
        return this;
    }
     ...
     * Expected profit margin percentage for the project
     */
    public Project withProfitMargin(double profitMargin) {
        Utils.checkNotNull(profitMargin, "profitMargin");
     ...
     * Expected profit margin percentage for the project
     */
    public Project withProfitMargin(JsonNullable<Double> profitMargin) {
        Utils.checkNotNull(profitMargin, "profitMargin");
        this.profitMargin = profitMargin;
        return this;
    }
     ...
     * Current status of project schedule compared to plan
     */
    public Project withScheduleStatus(ScheduleStatus scheduleStatus) {
        Utils.checkNotNull(scheduleStatus, "scheduleStatus");
     ...
     * Current status of project schedule compared to plan
     */
    public Project withScheduleStatus(JsonNullable<? extends ScheduleStatus> scheduleStatus) {
        Utils.checkNotNull(scheduleStatus, "scheduleStatus");
        this.scheduleStatus = scheduleStatus;
        return this;
    }
     ...
     * An array of addresses associated with the project (billing, job site, etc.)
     */
    public Project withAddresses(List<Address> addresses) {
        Utils.checkNotNull(addresses, "addresses");
     ...
     * An array of addresses associated with the project (billing, job site, etc.)
     */
    public Project withAddresses(Optional<? extends List<Address>> addresses) {
        Utils.checkNotNull(addresses, "addresses");
        this.addresses = addresses;
        return this;
    }
     ...
     * Number of team members assigned to the project
     */
    public Project withTeamSize(long teamSize) {
        Utils.checkNotNull(teamSize, "teamSize");
     ...
     * Number of team members assigned to the project
     */
    public Project withTeamSize(JsonNullable<Long> teamSize) {
        Utils.checkNotNull(teamSize, "teamSize");
        this.teamSize = teamSize;
        return this;
    }

    public Project withCustomFields(List<CustomField> customFields) {
        Utils.checkNotNull(customFields, "customFields");
    ...
    public Project withCustomFields(Optional<? extends List<CustomField>> customFields) {
        Utils.checkNotNull(customFields, "customFields");
        this.customFields = customFields;
        return this;
    }
     ...
     * time an update is made to the object.
     */
    public Project withRowVersion(String rowVersion) {
        Utils.checkNotNull(rowVersion, "rowVersion");
     ...
     * time an update is made to the object.
     */
    public Project withRowVersion(JsonNullable<String> rowVersion) {
        Utils.checkNotNull(rowVersion, "rowVersion");
        this.rowVersion = rowVersion;
        return this;
    }
     ...
     * The user who last updated the object.
     */
    public Project withUpdatedBy(String updatedBy) {
        Utils.checkNotNull(updatedBy, "updatedBy");
     ...
     * The user who last updated the object.
     */
    public Project withUpdatedBy(JsonNullable<String> updatedBy) {
        Utils.checkNotNull(updatedBy, "updatedBy");
        this.updatedBy = updatedBy;
        return this;
    }
     ...
     * The user who created the object.
     */
    public Project withCreatedBy(JsonNullable<String> createdBy) {
        Utils.checkNotNull(createdBy, "createdBy");
        this.createdBy = createdBy;
        return this;
    }
     ...
     * The date and time when the object was created.
     */
    public Project withCreatedAt(JsonNullable<OffsetDateTime> createdAt) {
        Utils.checkNotNull(createdAt, "createdAt");
        this.createdAt = createdAt;
        return this;
    }
     ...
     * The date and time when the object was last updated.
     */
    public Project withUpdatedAt(JsonNullable<OffsetDateTime> updatedAt) {
        Utils.checkNotNull(updatedAt, "updatedAt");
        this.updatedAt = updatedAt;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return 
            ...
            Utils.enhancedDeepEquals(this.actualAmount, other.actualAmount) &&
            Utils.enhancedDeepEquals(this.budgetHours, other.budgetHours) &&
            Utils.enhancedDeepEquals(this.actualHours, other.actualHours) &&
    ...
    public int hashCode() {
        return Utils.enhancedHash(
            ...
            endDate, completionDate, customer,
            department, companyId, ownerId,
            parentProject, currency, budgetAmount,
            approvedAmount, actualAmount, budgetHours,
            actualHours, hourlyRate, billingMethod,
    ...
    public String toString() {
        return Utils.toString(Project.class,
                "id", id,
    ...
    public final static class Builder {
        ...
        private JsonNullable<Double> actualAmount = JsonNullable.undefined();

        private JsonNullable<Double> budgetHours = JsonNullable.undefined();

        private JsonNullable<Double> actualHours = JsonNullable.undefined();
         ...
         * Total actual amount spent on the project
         */
        public Builder actualAmount(JsonNullable<Double> actualAmount) {
            Utils.checkNotNull(actualAmount, "actualAmount");
            this.actualAmount = actualAmount;
            return this;
        }
         ...
         * Total actual hours worked on the project
         */
        public Builder actualHours(JsonNullable<Double> actualHours) {
            Utils.checkNotNull(actualHours, "actualHours");
            this.actualHours = actualHours;
            return this;
        }
