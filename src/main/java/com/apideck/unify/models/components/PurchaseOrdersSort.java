...
public class PurchaseOrdersSort {
    ...
    private Optional<? extends PurchaseOrdersSortBy> by;
    ...
    public PurchaseOrdersSort(
            Optional<? extends PurchaseOrdersSortBy> by,
    ...
    public Optional<PurchaseOrdersSortBy> by() {
        return (Optional<PurchaseOrdersSortBy>) by;
    }
     ...
     * The field on which to sort the Purchase Orders
     */
    public PurchaseOrdersSort withBy(PurchaseOrdersSortBy by) {
        Utils.checkNotNull(by, "by");
     ...
     * The field on which to sort the Purchase Orders
     */
    public PurchaseOrdersSort withBy(Optional<? extends PurchaseOrdersSortBy> by) {
        Utils.checkNotNull(by, "by");
        this.by = by;
        return this;
    }
     ...
     * The direction in which to sort the results
     */
    public PurchaseOrdersSort withDirection(SortDirection direction) {
        Utils.checkNotNull(direction, "direction");
     ...
     * The direction in which to sort the results
     */
    public PurchaseOrdersSort withDirection(Optional<? extends SortDirection> direction) {
        Utils.checkNotNull(direction, "direction");
        this.direction = direction;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends PurchaseOrdersSortBy> by = Optional.empty();
         ...
         * The field on which to sort the Purchase Orders
         */
        public Builder by(PurchaseOrdersSortBy by) {
            Utils.checkNotNull(by, "by");
            this.by = Optional.ofNullable(by);
            return this;
        }
         ...
         * The field on which to sort the Purchase Orders
         */
        public Builder by(Optional<? extends PurchaseOrdersSortBy> by) {
            Utils.checkNotNull(by, "by");
            this.by = by;
            return this;
        }
