...
public class QuoteLineItem {
     ...
     * Date on which the service was provided or performed - YYYY-MM-DD.
     */
    public QuoteLineItem withServiceDate(JsonNullable<LocalDate> serviceDate) {
        Utils.checkNotNull(serviceDate, "serviceDate");
        this.serviceDate = serviceDate;
        return this;
    }
    ...
    @JsonAnySetter
    public QuoteLineItem withAdditionalProperty(String key, Object value) {
        // note that value can be null because of the way JsonAnySetter works
        Utils.checkNotNull(key, "key");
        additionalProperties.put(key, value); 
        return this;
    }
    public QuoteLineItem withAdditionalProperties(Map<String, Object> additionalProperties) {
