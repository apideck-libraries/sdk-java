...
public class RefundInput {
     ...
     * The total amount of the transaction or record
     */
    public RefundInput withTotalAmount(JsonNullable<Double> totalAmount) {
        Utils.checkNotNull(totalAmount, "totalAmount");
        this.totalAmount = totalAmount;
        return this;
    }
    ...
    @JsonAnySetter
    public RefundInput withAdditionalProperty(String key, Object value) {
        // note that value can be null because of the way JsonAnySetter works
        Utils.checkNotNull(key, "key");
        additionalProperties.put(key, value); 
        return this;
    }
    public RefundInput withAdditionalProperties(Map<String, Object> additionalProperties) {
