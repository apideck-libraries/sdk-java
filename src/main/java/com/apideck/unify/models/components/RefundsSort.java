...
public class RefundsSort {
    ...
    private Optional<? extends RefundsSortBy> by;
    ...
    @JsonCreator
    public RefundsSort(
            Optional<? extends RefundsSortBy> by,
    ...
    @JsonIgnore
    public Optional<RefundsSortBy> by() {
        return (Optional<RefundsSortBy>) by;
    }
     ...
     * The field on which to sort the Refunds
     */
    public RefundsSort withBy(RefundsSortBy by) {
        Utils.checkNotNull(by, "by");
     ...
     * The field on which to sort the Refunds
     */
    public RefundsSort withBy(Optional<? extends RefundsSortBy> by) {
        Utils.checkNotNull(by, "by");
        this.by = by;
        return this;
    }
     ...
     * The direction in which to sort the results
     */
    public RefundsSort withDirection(SortDirection direction) {
        Utils.checkNotNull(direction, "direction");
     ...
     * The direction in which to sort the results
     */
    public RefundsSort withDirection(Optional<? extends SortDirection> direction) {
        Utils.checkNotNull(direction, "direction");
        this.direction = direction;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        RefundsSort other = (RefundsSort) o;
        return 
    ...
    public String toString() {
        return Utils.toString(RefundsSort.class,
                "by", by,
                "direction", direction);
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends RefundsSortBy> by = Optional.empty();
         ...
         * The field on which to sort the Refunds
         */
        public Builder by(RefundsSortBy by) {
            Utils.checkNotNull(by, "by");
            this.by = Optional.ofNullable(by);
            return this;
        }
         ...
         * The field on which to sort the Refunds
         */
        public Builder by(Optional<? extends RefundsSortBy> by) {
            Utils.checkNotNull(by, "by");
            this.by = by;
            return this;
        }
        ...
        public RefundsSort build() {
            if (direction == null) {
                direction = _SINGLETON_VALUE_Direction.value();
            }

            return new RefundsSort(
                by, direction);
        }
