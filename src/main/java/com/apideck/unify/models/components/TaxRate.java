...
public class TaxRate {
     ...
     * Country code according to ISO 3166-1 alpha-2.
     */
    public TaxRate withCountry(String country) {
        Utils.checkNotNull(country, "country");
     ...
     * Country code according to ISO 3166-1 alpha-2.
     */
    public TaxRate withCountry(JsonNullable<String> country) {
        Utils.checkNotNull(country, "country");
        this.country = country;
        return this;
    }
    ...
    @JsonAnySetter
    public TaxRate withAdditionalProperty(String key, Object value) {
        // note that value can be null because of the way JsonAnySetter works
        Utils.checkNotNull(key, "key");
        additionalProperties.put(key, value); 
        return this;
    }
    public TaxRate withAdditionalProperties(Map<String, Object> additionalProperties) {
