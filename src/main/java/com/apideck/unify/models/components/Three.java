...
public class Three {
    ...
    private Optional<? extends LinkedBankAccount> bankAccount;
    ...
    private JsonNullable<? extends Expense3PaymentType> paymentType;
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("type")
    private JsonNullable<? extends Expense3ExpenseType> type;
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("status")
    private JsonNullable<? extends Expense3Status> status;
    ...
    public Three(
            ...
            @JsonProperty("bank_account") Optional<? extends LinkedBankAccount> bankAccount,
            ...
            @JsonProperty("payment_type") JsonNullable<? extends Expense3PaymentType> paymentType,
            @JsonProperty("currency") JsonNullable<? extends Currency> currency,
            @JsonProperty("currency_rate") JsonNullable<Double> currencyRate,
            @JsonProperty("type") JsonNullable<? extends Expense3ExpenseType> type,
            ...
            @JsonProperty("status") JsonNullable<? extends Expense3Status> status,
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<LinkedBankAccount> bankAccount() {
        return (Optional<LinkedBankAccount>) bankAccount;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public JsonNullable<Expense3PaymentType> paymentType() {
        return (JsonNullable<Expense3PaymentType>) paymentType;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public JsonNullable<Expense3ExpenseType> type() {
        return (JsonNullable<Expense3ExpenseType>) type;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public JsonNullable<Expense3Status> status() {
        return (JsonNullable<Expense3Status>) status;
    }
     ...
     * A unique identifier for an object.
     */
    public Three withId(Optional<String> id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * Number.
     */
    public Three withNumber(String number) {
        Utils.checkNotNull(number, "number");
     ...
     * Number.
     */
    public Three withNumber(JsonNullable<String> number) {
        Utils.checkNotNull(number, "number");
        this.number = number;
        return this;
    }
     ...
     * The date of the transaction - YYYY:MM::DDThh:mm:ss.sTZD
     */
    public Three withTransactionDate(OffsetDateTime transactionDate) {
        Utils.checkNotNull(transactionDate, "transactionDate");
     ...
     * The date of the transaction - YYYY:MM::DDThh:mm:ss.sTZD
     */
    public Three withTransactionDate(Optional<OffsetDateTime> transactionDate) {
        Utils.checkNotNull(transactionDate, "transactionDate");
        this.transactionDate = transactionDate;
        return this;
    }
     ...
     */
    @Deprecated
    public Three withAccountId(String accountId) {
        Utils.checkNotNull(accountId, "accountId");
     ...
     */
    @Deprecated
    public Three withAccountId(Optional<String> accountId) {
        Utils.checkNotNull(accountId, "accountId");
        this.accountId = accountId;
        return this;
    }

    public Three withAccount(LinkedLedgerAccount account) {
        Utils.checkNotNull(account, "account");
        this.account = JsonNullable.of(account);
        return this;
    }

    public Three withAccount(JsonNullable<? extends LinkedLedgerAccount> account) {
        Utils.checkNotNull(account, "account");
        this.account = account;
        return this;
    }

    public Three withBankAccount(LinkedBankAccount bankAccount) {
        Utils.checkNotNull(bankAccount, "bankAccount");
    ...
    public Three withBankAccount(Optional<? extends LinkedBankAccount> bankAccount) {
        Utils.checkNotNull(bankAccount, "bankAccount");
        this.bankAccount = bankAccount;
        return this;
    }
     ...
     * to customers.
     */
    public Three withCustomerId(String customerId) {
        Utils.checkNotNull(customerId, "customerId");
     ...
     * to customers.
     */
    public Three withCustomerId(Optional<String> customerId) {
        Utils.checkNotNull(customerId, "customerId");
        this.customerId = customerId;
        return this;
    }
     ...
     * The ID of the supplier this entity is linked to.
     */
    public Three withSupplierId(String supplierId) {
        Utils.checkNotNull(supplierId, "supplierId");
     ...
     * The ID of the supplier this entity is linked to.
     */
    public Three withSupplierId(Optional<String> supplierId) {
        Utils.checkNotNull(supplierId, "supplierId");
        this.supplierId = supplierId;
        return this;
    }
     ...
     * The company ID the transaction belongs to
     */
    public Three withCompanyId(String companyId) {
        Utils.checkNotNull(companyId, "companyId");
     ...
     * The company ID the transaction belongs to
     */
    public Three withCompanyId(JsonNullable<String> companyId) {
        Utils.checkNotNull(companyId, "companyId");
        this.companyId = companyId;
        return this;
    }
     ...
     * The ID of the department
     */
    public Three withDepartmentId(String departmentId) {
        Utils.checkNotNull(departmentId, "departmentId");
     ...
     * The ID of the department
     */
    public Three withDepartmentId(JsonNullable<String> departmentId) {
        Utils.checkNotNull(departmentId, "departmentId");
        this.departmentId = departmentId;
        return this;
    }
     ...
     * The type of payment for the expense.
     */
    public Three withPaymentType(Expense3PaymentType paymentType) {
        Utils.checkNotNull(paymentType, "paymentType");
     ...
     * The type of payment for the expense.
     */
    public Three withPaymentType(JsonNullable<? extends Expense3PaymentType> paymentType) {
        Utils.checkNotNull(paymentType, "paymentType");
        this.paymentType = paymentType;
        return this;
    }
     ...
     * 4217](https://en.wikipedia.org/wiki/ISO_4217).
     */
    public Three withCurrency(Currency currency) {
        Utils.checkNotNull(currency, "currency");
     ...
     * 4217](https://en.wikipedia.org/wiki/ISO_4217).
     */
    public Three withCurrency(JsonNullable<? extends Currency> currency) {
        Utils.checkNotNull(currency, "currency");
        this.currency = currency;
        return this;
    }
     ...
     * Currency Exchange Rate at the time entity was recorded/generated.
     */
    public Three withCurrencyRate(double currencyRate) {
        Utils.checkNotNull(currencyRate, "currencyRate");
     ...
     * Currency Exchange Rate at the time entity was recorded/generated.
     */
    public Three withCurrencyRate(JsonNullable<Double> currencyRate) {
        Utils.checkNotNull(currencyRate, "currencyRate");
        this.currencyRate = currencyRate;
        return this;
    }
     ...
     * The type of expense.
     */
    public Three withType(Expense3ExpenseType type) {
        Utils.checkNotNull(type, "type");
     ...
     * The type of expense.
     */
    public Three withType(JsonNullable<? extends Expense3ExpenseType> type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
     ...
     * The memo of the expense.
     */
    public Three withMemo(String memo) {
        Utils.checkNotNull(memo, "memo");
     ...
     * The memo of the expense.
     */
    public Three withMemo(JsonNullable<String> memo) {
        Utils.checkNotNull(memo, "memo");
        this.memo = memo;
        return this;
    }

    public Three withTaxRate(LinkedTaxRate taxRate) {
        Utils.checkNotNull(taxRate, "taxRate");
    ...
    public Three withTaxRate(Optional<? extends LinkedTaxRate> taxRate) {
        Utils.checkNotNull(taxRate, "taxRate");
        this.taxRate = taxRate;
        return this;
    }
     ...
     * The total amount of the expense line item.
     */
    public Three withTotalAmount(double totalAmount) {
        Utils.checkNotNull(totalAmount, "totalAmount");
     ...
     * The total amount of the expense line item.
     */
    public Three withTotalAmount(JsonNullable<Double> totalAmount) {
        Utils.checkNotNull(totalAmount, "totalAmount");
        this.totalAmount = totalAmount;
        return this;
    }
     ...
     * Expense line items linked to this expense.
     */
    public Three withLineItems(List<ExpenseLineItem> lineItems) {
        Utils.checkNotNull(lineItems, "lineItems");
        this.lineItems = lineItems;
        return this;
    }
     ...
     * Optional reference identifier for the transaction.
     */
    public Three withReference(String reference) {
        Utils.checkNotNull(reference, "reference");
     ...
     * Optional reference identifier for the transaction.
     */
    public Three withReference(JsonNullable<String> reference) {
        Utils.checkNotNull(reference, "reference");
        this.reference = reference;
        return this;
    }
     ...
     * supported for Xero.
     */
    public Three withSourceDocumentUrl(String sourceDocumentUrl) {
        Utils.checkNotNull(sourceDocumentUrl, "sourceDocumentUrl");
     ...
     * supported for Xero.
     */
    public Three withSourceDocumentUrl(JsonNullable<String> sourceDocumentUrl) {
        Utils.checkNotNull(sourceDocumentUrl, "sourceDocumentUrl");
        this.sourceDocumentUrl = sourceDocumentUrl;
        return this;
    }

    public Three withCustomFields(List<CustomField> customFields) {
        Utils.checkNotNull(customFields, "customFields");
    ...
    public Three withCustomFields(Optional<? extends List<CustomField>> customFields) {
        Utils.checkNotNull(customFields, "customFields");
        this.customFields = customFields;
        return this;
    }
     ...
     * When custom mappings are configured on the resource, the result is included here.
     */
    public Three withCustomMappings(Map<String, Object> customMappings) {
        Utils.checkNotNull(customMappings, "customMappings");
     ...
     * When custom mappings are configured on the resource, the result is included here.
     */
    public Three withCustomMappings(JsonNullable<? extends Map<String, Object>> customMappings) {
        Utils.checkNotNull(customMappings, "customMappings");
        this.customMappings = customMappings;
        return this;
    }
     ...
     * Expense status
     */
    public Three withStatus(Expense3Status status) {
        Utils.checkNotNull(status, "status");
     ...
     * Expense status
     */
    public Three withStatus(JsonNullable<? extends Expense3Status> status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * The date and time when the object was last updated.
     */
    public Three withUpdatedAt(OffsetDateTime updatedAt) {
        Utils.checkNotNull(updatedAt, "updatedAt");
     ...
     * The date and time when the object was last updated.
     */
    public Three withUpdatedAt(JsonNullable<OffsetDateTime> updatedAt) {
        Utils.checkNotNull(updatedAt, "updatedAt");
        this.updatedAt = updatedAt;
        return this;
    }
     ...
     * The date and time when the object was created.
     */
    public Three withCreatedAt(OffsetDateTime createdAt) {
        Utils.checkNotNull(createdAt, "createdAt");
     ...
     * The date and time when the object was created.
     */
    public Three withCreatedAt(JsonNullable<OffsetDateTime> createdAt) {
        Utils.checkNotNull(createdAt, "createdAt");
        this.createdAt = createdAt;
        return this;
    }
     ...
     * time an update is made to the object.
     */
    public Three withRowVersion(String rowVersion) {
        Utils.checkNotNull(rowVersion, "rowVersion");
     ...
     * time an update is made to the object.
     */
    public Three withRowVersion(JsonNullable<String> rowVersion) {
        Utils.checkNotNull(rowVersion, "rowVersion");
        this.rowVersion = rowVersion;
        return this;
    }
     ...
     * The user who last updated the object.
     */
    public Three withUpdatedBy(String updatedBy) {
        Utils.checkNotNull(updatedBy, "updatedBy");
     ...
     * The user who last updated the object.
     */
    public Three withUpdatedBy(JsonNullable<String> updatedBy) {
        Utils.checkNotNull(updatedBy, "updatedBy");
        this.updatedBy = updatedBy;
        return this;
    }
     ...
     * The user who created the object.
     */
    public Three withCreatedBy(String createdBy) {
        Utils.checkNotNull(createdBy, "createdBy");
     ...
     * The user who created the object.
     */
    public Three withCreatedBy(JsonNullable<String> createdBy) {
        Utils.checkNotNull(createdBy, "createdBy");
        this.createdBy = createdBy;
        return this;
    }
     ...
     * in request body when creating or updating resources.
     */
    public Three withPassThrough(List<PassThroughBody> passThrough) {
        Utils.checkNotNull(passThrough, "passThrough");
     ...
     * in request body when creating or updating resources.
     */
    public Three withPassThrough(Optional<? extends List<PassThroughBody>> passThrough) {
        Utils.checkNotNull(passThrough, "passThrough");
        this.passThrough = passThrough;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends LinkedBankAccount> bankAccount = Optional.empty();
        ...
        private JsonNullable<? extends Expense3PaymentType> paymentType = JsonNullable.undefined();

        private JsonNullable<? extends Currency> currency = JsonNullable.undefined();

        private JsonNullable<Double> currencyRate = JsonNullable.undefined();

        private JsonNullable<? extends Expense3ExpenseType> type = JsonNullable.undefined();
        ...
        private JsonNullable<? extends Expense3Status> status = JsonNullable.undefined();
        ...
        public Builder bankAccount(Optional<? extends LinkedBankAccount> bankAccount) {
            Utils.checkNotNull(bankAccount, "bankAccount");
            this.bankAccount = bankAccount;
            return this;
        }
         ...
         * The type of payment for the expense.
         */
        public Builder paymentType(Expense3PaymentType paymentType) {
            Utils.checkNotNull(paymentType, "paymentType");
            this.paymentType = JsonNullable.of(paymentType);
            return this;
        }
         ...
         * The type of payment for the expense.
         */
        public Builder paymentType(JsonNullable<? extends Expense3PaymentType> paymentType) {
            Utils.checkNotNull(paymentType, "paymentType");
            this.paymentType = paymentType;
            return this;
        }
         ...
         * The type of expense.
         */
        public Builder type(Expense3ExpenseType type) {
            Utils.checkNotNull(type, "type");
            this.type = JsonNullable.of(type);
            return this;
        }
         ...
         * The type of expense.
         */
        public Builder type(JsonNullable<? extends Expense3ExpenseType> type) {
            Utils.checkNotNull(type, "type");
            this.type = type;
            return this;
        }
         ...
         * Expense status
         */
        public Builder status(Expense3Status status) {
            Utils.checkNotNull(status, "status");
            this.status = JsonNullable.of(status);
            return this;
        }
         ...
         * Expense status
         */
        public Builder status(JsonNullable<? extends Expense3Status> status) {
            Utils.checkNotNull(status, "status");
            this.status = status;
            return this;
        }
