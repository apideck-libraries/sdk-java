...
public class UnexpectedErrorResponse {
     ...
     * HTTP status code
     */
    public UnexpectedErrorResponse withStatusCode(@Nullable Double statusCode) {
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Contains an explanation of the status_code as defined in HTTP/1.1 standard (RFC 7231)
     */
    public UnexpectedErrorResponse withError(@Nullable String error) {
        this.error = error;
        return this;
    }
     ...
     * The type of error returned
     */
    public UnexpectedErrorResponse withTypeName(@Nullable String typeName) {
        this.typeName = typeName;
        return this;
    }
     ...
     * A human-readable message providing more details about the error.
     */
    public UnexpectedErrorResponse withMessage(@Nullable String message) {
        this.message = message;
        return this;
    }
     ...
     * Contains parameter or domain specific information related to the error and why it occurred.
     */
    public UnexpectedErrorResponse withDetail(@Nullable Detail detail) {
        this.detail = detail;
        return this;
    }
     ...
     * Link to documentation of error type
     */
    public UnexpectedErrorResponse withRef(@Nullable String ref) {
        this.ref = ref;
        return this;
    }
