...
public class UpdateAccountingDepartmentResponse {
     ...
     * HTTP Response Status
     */
    public UpdateAccountingDepartmentResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public UpdateAccountingDepartmentResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public UpdateAccountingDepartmentResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public UpdateAccountingDepartmentResponse withOperation(@Nonnull String operation) {
     ...
     * A object containing a unique identifier for the resource that was created, updated, or deleted.
     */
    public UpdateAccountingDepartmentResponse withData(@Nonnull UnifiedId data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public UpdateAccountingDepartmentResponse withRaw(@Nullable Map<String, Object> raw) {
