...
public class UpdateAccountingLocationResponse {
     ...
     * HTTP Response Status
     */
    public UpdateAccountingLocationResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public UpdateAccountingLocationResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public UpdateAccountingLocationResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public UpdateAccountingLocationResponse withOperation(@Nonnull String operation) {
     ...
     * A object containing a unique identifier for the resource that was created, updated, or deleted.
     */
    public UpdateAccountingLocationResponse withData(@Nonnull UnifiedId data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public UpdateAccountingLocationResponse withRaw(@Nullable Map<String, Object> raw) {
