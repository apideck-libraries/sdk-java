...
public class UpdateApplicantResponse {
     ...
     * HTTP Response Status
     */
    public UpdateApplicantResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public UpdateApplicantResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public UpdateApplicantResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public UpdateApplicantResponse withOperation(@Nonnull String operation) {
     ...
     * A object containing a unique identifier for the resource that was created, updated, or deleted.
     */
    public UpdateApplicantResponse withData(@Nonnull UnifiedId data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public UpdateApplicantResponse withRaw(@Nullable Map<String, Object> raw) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        UpdateApplicantResponse other = (UpdateApplicantResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(UpdateApplicantResponse.class,
