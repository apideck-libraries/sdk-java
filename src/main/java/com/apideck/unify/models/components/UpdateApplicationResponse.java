...
public class UpdateApplicationResponse {
     ...
     * HTTP Response Status
     */
    public UpdateApplicationResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public UpdateApplicationResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public UpdateApplicationResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public UpdateApplicationResponse withOperation(@Nonnull String operation) {
     ...
     * A object containing a unique identifier for the resource that was created, updated, or deleted.
     */
    public UpdateApplicationResponse withData(@Nonnull UnifiedId data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public UpdateApplicationResponse withRaw(@Nullable Map<String, Object> raw) {
    ...
    public String toString() {
        return Utils.toString(UpdateApplicationResponse.class,
