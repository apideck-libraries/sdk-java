...
public class UpdateBankAccountResponse {
     ...
     * HTTP Response Status
     */
    public UpdateBankAccountResponse withStatus(String status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * Apideck ID of service provider
     */
    public UpdateBankAccountResponse withService(String service) {
        Utils.checkNotNull(service, "service");
     ...
     * Apideck ID of service provider
     */
    public UpdateBankAccountResponse withService(Optional<String> service) {
        Utils.checkNotNull(service, "service");
        this.service = service;
        return this;
    }
     ...
     * Unified API resource name
     */
    public UpdateBankAccountResponse withResource(String resource) {
        Utils.checkNotNull(resource, "resource");
     ...
     * Unified API resource name
     */
    public UpdateBankAccountResponse withResource(Optional<String> resource) {
        Utils.checkNotNull(resource, "resource");
        this.resource = resource;
        return this;
    }
     ...
     * Operation performed
     */
    public UpdateBankAccountResponse withOperation(String operation) {
        Utils.checkNotNull(operation, "operation");
     ...
     * Operation performed
     */
    public UpdateBankAccountResponse withOperation(Optional<String> operation) {
        Utils.checkNotNull(operation, "operation");
        this.operation = operation;
        return this;
    }
     ...
     * A object containing a unique identifier for the resource that was created, updated, or deleted.
     */
    public UpdateBankAccountResponse withData(UnifiedId data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }
