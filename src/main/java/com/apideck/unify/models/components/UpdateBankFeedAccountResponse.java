...
public class UpdateBankFeedAccountResponse {
     ...
     * HTTP Response Status
     */
    public UpdateBankFeedAccountResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public UpdateBankFeedAccountResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public UpdateBankFeedAccountResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public UpdateBankFeedAccountResponse withOperation(@Nonnull String operation) {
     ...
     * A object containing a unique identifier for the resource that was created, updated, or deleted.
     */
    public UpdateBankFeedAccountResponse withData(@Nonnull UnifiedId data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public UpdateBankFeedAccountResponse withRaw(@Nullable Map<String, Object> raw) {
