...
public class UpdateBillResponse {
     ...
     * HTTP Response Status
     */
    public UpdateBillResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public UpdateBillResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public UpdateBillResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public UpdateBillResponse withOperation(@Nonnull String operation) {
     ...
     * A object containing a unique identifier for the resource that was created, updated, or deleted.
     */
    public UpdateBillResponse withData(@Nonnull UnifiedId data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public UpdateBillResponse withRaw(@Nullable Map<String, Object> raw) {
