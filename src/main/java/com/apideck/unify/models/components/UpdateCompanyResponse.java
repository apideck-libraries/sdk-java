...
public class UpdateCompanyResponse {
     ...
     * HTTP Response Status
     */
    public UpdateCompanyResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public UpdateCompanyResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public UpdateCompanyResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public UpdateCompanyResponse withOperation(@Nonnull String operation) {
     ...
     * A object containing a unique identifier for the resource that was created, updated, or deleted.
     */
    public UpdateCompanyResponse withData(@Nonnull UnifiedId data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public UpdateCompanyResponse withRaw(@Nullable Map<String, Object> raw) {
