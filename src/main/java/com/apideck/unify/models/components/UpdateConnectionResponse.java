...
public class UpdateConnectionResponse {
    ...
    public UpdateConnectionResponse(
            ...
            @JsonProperty("data") @Nonnull Connection data,
     ...
     * HTTP Response Status
     */
    public UpdateConnectionResponse withStatus(@Nonnull String status) {
        this.status = Utils.checkNotNull(status, "status");
        return this;
    }


    public UpdateConnectionResponse withData(@Nonnull Connection data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public UpdateConnectionResponse withRaw(@Nullable Map<String, Object> raw) {
    ...
    public final static class Builder {
        ...
        public Builder data(@Nonnull Connection data) {
            this.data = Utils.checkNotNull(data, "data");
            return this;
        }
