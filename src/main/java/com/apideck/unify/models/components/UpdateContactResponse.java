...
public class UpdateContactResponse {
     ...
     * HTTP Response Status
     */
    public UpdateContactResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public UpdateContactResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public UpdateContactResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public UpdateContactResponse withOperation(@Nonnull String operation) {
     ...
     * A object containing a unique identifier for the resource that was created, updated, or deleted.
     */
    public UpdateContactResponse withData(@Nonnull UnifiedId data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public UpdateContactResponse withRaw(@Nullable Map<String, Object> raw) {
