...
public class UpdateCreditNoteResponse {
     ...
     * HTTP Response Status
     */
    public UpdateCreditNoteResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public UpdateCreditNoteResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public UpdateCreditNoteResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public UpdateCreditNoteResponse withOperation(@Nonnull String operation) {
     ...
     * A object containing a unique identifier for the resource that was created, updated, or deleted.
     */
    public UpdateCreditNoteResponse withData(@Nonnull UnifiedId data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public UpdateCreditNoteResponse withRaw(@Nullable Map<String, Object> raw) {
