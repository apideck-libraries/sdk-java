...
public class UpdateCustomObjectResponse {
     ...
     * HTTP Response Status
     */
    public UpdateCustomObjectResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public UpdateCustomObjectResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public UpdateCustomObjectResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public UpdateCustomObjectResponse withOperation(@Nonnull String operation) {
     ...
     * A object containing a unique identifier for the resource that was created, updated, or deleted.
     */
    public UpdateCustomObjectResponse withData(@Nonnull UnifiedId data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public UpdateCustomObjectResponse withRaw(@Nullable Map<String, Object> raw) {
