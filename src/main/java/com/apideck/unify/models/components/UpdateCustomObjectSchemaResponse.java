...
public class UpdateCustomObjectSchemaResponse {
     ...
     * HTTP Response Status
     */
    public UpdateCustomObjectSchemaResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public UpdateCustomObjectSchemaResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public UpdateCustomObjectSchemaResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public UpdateCustomObjectSchemaResponse withOperation(@Nonnull String operation) {
     ...
     * A object containing a unique identifier for the resource that was created, updated, or deleted.
     */
    public UpdateCustomObjectSchemaResponse withData(@Nonnull UnifiedId data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public UpdateCustomObjectSchemaResponse withRaw(@Nullable Map<String, Object> raw) {
