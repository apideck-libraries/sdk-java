...
public class UpdateCustomerResponse {
     ...
     * HTTP Response Status
     */
    public UpdateCustomerResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public UpdateCustomerResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public UpdateCustomerResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public UpdateCustomerResponse withOperation(@Nonnull String operation) {
     ...
     * A object containing a unique identifier for the resource that was created, updated, or deleted.
     */
    public UpdateCustomerResponse withData(@Nonnull UnifiedId data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public UpdateCustomerResponse withRaw(@Nullable Map<String, Object> raw) {
