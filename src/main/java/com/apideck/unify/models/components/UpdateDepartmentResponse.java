...
public class UpdateDepartmentResponse {
     ...
     * HTTP Response Status
     */
    public UpdateDepartmentResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public UpdateDepartmentResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public UpdateDepartmentResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public UpdateDepartmentResponse withOperation(@Nonnull String operation) {
     ...
     * A object containing a unique identifier for the resource that was created, updated, or deleted.
     */
    public UpdateDepartmentResponse withData(@Nonnull UnifiedId data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public UpdateDepartmentResponse withRaw(@Nullable Map<String, Object> raw) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        UpdateDepartmentResponse other = (UpdateDepartmentResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(UpdateDepartmentResponse.class,
