...
public class UpdateDriveResponse {
     ...
     * HTTP Response Status
     */
    public UpdateDriveResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public UpdateDriveResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public UpdateDriveResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public UpdateDriveResponse withOperation(@Nonnull String operation) {
     ...
     * A object containing a unique identifier for the resource that was created, updated, or deleted.
     */
    public UpdateDriveResponse withData(@Nonnull UnifiedId data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public UpdateDriveResponse withRaw(@Nullable Map<String, Object> raw) {
    ...
    public String toString() {
        return Utils.toString(UpdateDriveResponse.class,
