...
public class UpdateExpenseResponse {
     ...
     * HTTP Response Status
     */
    public UpdateExpenseResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public UpdateExpenseResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public UpdateExpenseResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public UpdateExpenseResponse withOperation(@Nonnull String operation) {
     ...
     * A object containing a unique identifier for the resource that was created, updated, or deleted.
     */
    public UpdateExpenseResponse withData(@Nonnull UnifiedId data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public UpdateExpenseResponse withRaw(@Nullable Map<String, Object> raw) {
