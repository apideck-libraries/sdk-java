...
public class UpdateFileResponse {
     ...
     * HTTP Response Status
     */
    public UpdateFileResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public UpdateFileResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public UpdateFileResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public UpdateFileResponse withOperation(@Nonnull String operation) {
     ...
     * A object containing a unique identifier for the resource that was created, updated, or deleted.
     */
    public UpdateFileResponse withData(@Nonnull UnifiedId data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public UpdateFileResponse withRaw(@Nullable Map<String, Object> raw) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        UpdateFileResponse other = (UpdateFileResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(UpdateFileResponse.class,
