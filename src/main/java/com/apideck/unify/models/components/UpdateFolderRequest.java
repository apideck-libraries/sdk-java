...
public class UpdateFolderRequest {
    ...
    @JsonAnySetter
    public UpdateFolderRequest withAdditionalProperty(String key, Object value) {
        // note that value can be null because of the way JsonAnySetter works
        Utils.checkNotNull(key, "key");
        additionalProperties.put(key, value); 
        return this;
    }
    public UpdateFolderRequest withAdditionalProperties(Map<String, Object> additionalProperties) {
