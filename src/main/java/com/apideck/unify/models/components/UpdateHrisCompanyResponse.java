...
public class UpdateHrisCompanyResponse {
     ...
     * HTTP Response Status
     */
    public UpdateHrisCompanyResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public UpdateHrisCompanyResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public UpdateHrisCompanyResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public UpdateHrisCompanyResponse withOperation(@Nonnull String operation) {
     ...
     * A object containing a unique identifier for the resource that was created, updated, or deleted.
     */
    public UpdateHrisCompanyResponse withData(@Nonnull UnifiedId data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public UpdateHrisCompanyResponse withRaw(@Nullable Map<String, Object> raw) {
