...
public class UpdateInvoiceResponse {
     ...
     * HTTP Response Status
     */
    public UpdateInvoiceResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public UpdateInvoiceResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public UpdateInvoiceResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public UpdateInvoiceResponse withOperation(@Nonnull String operation) {
        this.operation = Utils.checkNotNull(operation, "operation");
        return this;
    }


    public UpdateInvoiceResponse withData(@Nonnull InvoiceResponse data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public UpdateInvoiceResponse withRaw(@Nullable Map<String, Object> raw) {
