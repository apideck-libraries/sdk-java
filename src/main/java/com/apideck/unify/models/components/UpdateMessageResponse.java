...
public class UpdateMessageResponse {
     ...
     * HTTP Response Status
     */
    public UpdateMessageResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public UpdateMessageResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public UpdateMessageResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public UpdateMessageResponse withOperation(@Nonnull String operation) {
     ...
     * A object containing a unique identifier for the resource that was created, updated, or deleted.
     */
    public UpdateMessageResponse withData(@Nonnull UnifiedId data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public UpdateMessageResponse withRaw(@Nullable Map<String, Object> raw) {
