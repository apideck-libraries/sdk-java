...
public class UpdatePaymentResponse {
     ...
     * HTTP Response Status
     */
    public UpdatePaymentResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public UpdatePaymentResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public UpdatePaymentResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public UpdatePaymentResponse withOperation(@Nonnull String operation) {
     ...
     * A object containing a unique identifier for the resource that was created, updated, or deleted.
     */
    public UpdatePaymentResponse withData(@Nonnull UnifiedId data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public UpdatePaymentResponse withRaw(@Nullable Map<String, Object> raw) {
