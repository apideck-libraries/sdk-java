...
public class UpdatePipelineResponse {
     ...
     * HTTP Response Status
     */
    public UpdatePipelineResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public UpdatePipelineResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public UpdatePipelineResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public UpdatePipelineResponse withOperation(@Nonnull String operation) {
     ...
     * A object containing a unique identifier for the resource that was created, updated, or deleted.
     */
    public UpdatePipelineResponse withData(@Nonnull UnifiedId data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public UpdatePipelineResponse withRaw(@Nullable Map<String, Object> raw) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        UpdatePipelineResponse other = (UpdatePipelineResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(UpdatePipelineResponse.class,
