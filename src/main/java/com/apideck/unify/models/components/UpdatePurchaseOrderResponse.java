...
public class UpdatePurchaseOrderResponse {
     ...
     * HTTP Response Status
     */
    public UpdatePurchaseOrderResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public UpdatePurchaseOrderResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public UpdatePurchaseOrderResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public UpdatePurchaseOrderResponse withOperation(@Nonnull String operation) {
     ...
     * A object containing a unique identifier for the resource that was created, updated, or deleted.
     */
    public UpdatePurchaseOrderResponse withData(@Nonnull UnifiedId data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public UpdatePurchaseOrderResponse withRaw(@Nullable Map<String, Object> raw) {
