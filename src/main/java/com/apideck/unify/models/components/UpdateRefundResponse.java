...
public class UpdateRefundResponse {
     ...
     * HTTP Response Status Code
     */
    public UpdateRefundResponse withStatusCode(long statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * HTTP Response Status
     */
    public UpdateRefundResponse withStatus(String status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * Apideck ID of service provider
     */
    public UpdateRefundResponse withService(String service) {
        Utils.checkNotNull(service, "service");
        this.service = service;
        return this;
    }
     ...
     * Unified API resource name
     */
    public UpdateRefundResponse withResource(String resource) {
        Utils.checkNotNull(resource, "resource");
        this.resource = resource;
        return this;
    }
     ...
     * Operation performed
     */
    public UpdateRefundResponse withOperation(String operation) {
        Utils.checkNotNull(operation, "operation");
        this.operation = operation;
        return this;
    }
     ...
     * A object containing a unique identifier for the resource that was created, updated, or deleted.
     */
    public UpdateRefundResponse withData(UnifiedId data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public UpdateRefundResponse withRaw(Map<String, Object> raw) {
        Utils.checkNotNull(raw, "raw");
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public UpdateRefundResponse withRaw(JsonNullable<? extends Map<String, Object>> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        UpdateRefundResponse other = (UpdateRefundResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(UpdateRefundResponse.class,
    ...
    public final static class Builder {
        ...
        public UpdateRefundResponse build() {
