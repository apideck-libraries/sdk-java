...
public class UpdateSubsidiaryResponse {
     ...
     * HTTP Response Status
     */
    public UpdateSubsidiaryResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public UpdateSubsidiaryResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public UpdateSubsidiaryResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public UpdateSubsidiaryResponse withOperation(@Nonnull String operation) {
     ...
     * A object containing a unique identifier for the resource that was created, updated, or deleted.
     */
    public UpdateSubsidiaryResponse withData(@Nonnull UnifiedId data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public UpdateSubsidiaryResponse withRaw(@Nullable Map<String, Object> raw) {
