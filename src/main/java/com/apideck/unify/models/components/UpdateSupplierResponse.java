...
public class UpdateSupplierResponse {
     ...
     * HTTP Response Status
     */
    public UpdateSupplierResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public UpdateSupplierResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public UpdateSupplierResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public UpdateSupplierResponse withOperation(@Nonnull String operation) {
     ...
     * A object containing a unique identifier for the resource that was created, updated, or deleted.
     */
    public UpdateSupplierResponse withData(@Nonnull UnifiedId data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public UpdateSupplierResponse withRaw(@Nullable Map<String, Object> raw) {
