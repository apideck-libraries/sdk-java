...
public class UpdateTicketResponse {
     ...
     * HTTP Response Status
     */
    public UpdateTicketResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public UpdateTicketResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public UpdateTicketResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public UpdateTicketResponse withOperation(@Nonnull String operation) {
     ...
     * A object containing a unique identifier for the resource that was created, updated, or deleted.
     */
    public UpdateTicketResponse withData(@Nonnull UnifiedId data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public UpdateTicketResponse withRaw(@Nullable Map<String, Object> raw) {
