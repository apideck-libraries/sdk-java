...
public class UpdateUserResponse {
     ...
     * HTTP Response Status
     */
    public UpdateUserResponse withStatus(@Nonnull String status) {
     ...
     * Apideck ID of service provider
     */
    public UpdateUserResponse withService(@Nonnull String service) {
     ...
     * Unified API resource name
     */
    public UpdateUserResponse withResource(@Nonnull String resource) {
     ...
     * Operation performed
     */
    public UpdateUserResponse withOperation(@Nonnull String operation) {
     ...
     * A object containing a unique identifier for the resource that was created, updated, or deleted.
     */
    public UpdateUserResponse withData(@Nonnull UnifiedId data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public UpdateUserResponse withRaw(@Nullable Map<String, Object> raw) {
