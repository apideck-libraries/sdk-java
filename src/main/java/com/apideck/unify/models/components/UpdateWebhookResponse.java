...
public class UpdateWebhookResponse {
    ...
    public UpdateWebhookResponse(
            ...
            @JsonProperty("data") @Nonnull Webhook data,
     ...
     * HTTP Response Status
     */
    public UpdateWebhookResponse withStatus(@Nonnull String status) {
        this.status = Utils.checkNotNull(status, "status");
        return this;
    }


    public UpdateWebhookResponse withData(@Nonnull Webhook data) {
     ...
     * Raw response from the integration when raw=true query param is provided
     */
    public UpdateWebhookResponse withRaw(@Nullable Map<String, Object> raw) {
    ...
    public final static class Builder {
        ...
        public Builder data(@Nonnull Webhook data) {
            this.data = Utils.checkNotNull(data, "data");
            return this;
        }
