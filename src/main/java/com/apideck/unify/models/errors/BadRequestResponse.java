...
public class BadRequestResponse extends ApideckError {
    ...
    */
    public static BadRequestResponse from(HttpResponse<InputStream> response) {
        ...
        try {
            ...
            return new BadRequestResponse(response.statusCode(), bytes, response, null, e);
        }
    }
    ...
    */
    ...
    public static class Data {
         ...
         * Contains parameter or domain specific information related to the error and why it occurred.
         */
        public Data withDetail(Detail detail) {
            Utils.checkNotNull(detail, "detail");
         ...
         * Contains parameter or domain specific information related to the error and why it occurred.
         */
        public Data withDetail(Optional<? extends Detail> detail) {
            Utils.checkNotNull(detail, "detail");
            this.detail = detail;
            return this;
        }
