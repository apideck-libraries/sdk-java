...
public class NotFoundResponse extends RuntimeException {
    ...
    public NotFoundResponse(
            ...
            @JsonProperty("detail") @Nullable NotFoundResponseDetail detail,
     ...
     * HTTP status code
     */
    public NotFoundResponse withStatusCode(@Nullable Double statusCode) {
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Contains an explanation of the status_code as defined in HTTP/1.1 standard (RFC 7231)
     */
    public NotFoundResponse withError(@Nullable String error) {
        this.error = error;
        return this;
    }
     ...
     * The type of error returned
     */
    public NotFoundResponse withTypeName(@Nullable String typeName) {
        this.typeName = typeName;
        return this;
    }
     ...
     * A human-readable message providing more details about the error.
     */
    public NotFoundResponse withMessage(@Nullable String message) {
        this.message = message;
        return this;
    }
     ...
     * Contains parameter or domain specific information related to the error and why it occurred.
     */
    public NotFoundResponse withDetail(@Nullable NotFoundResponseDetail detail) {
        this.detail = detail;
        return this;
    }
     ...
     * Link to documentation of error type
     */
    public NotFoundResponse withRef(@Nullable String ref) {
        this.ref = ref;
        return this;
    }
    ...
    public final static class Builder {
         ...
         * Contains parameter or domain specific information related to the error and why it occurred.
         */
        public Builder detail(@Nullable NotFoundResponseDetail detail) {
            this.detail = detail;
            return this;
        }
