...
public class PaymentRequiredResponse extends ApideckError {
    ...
    /**
    * Parse a response into an instance of PaymentRequiredResponse. If deserialization of the response body fails,
    * the resulting PaymentRequiredResponse instance will have a null data() value and a non-null deserializationException().
    */
    public static PaymentRequiredResponse from(HttpResponse<InputStream> response) {
        byte[] bytes;
        try {
            bytes = Utils.extractByteArrayFromBody(response);
        } catch (Exception e) {
            return new PaymentRequiredResponse(response.statusCode(), null, response, null, e);
        }
        try {
            Data data = Utils.mapper().readValue(bytes, Data.class);
            return new PaymentRequiredResponse(response.statusCode(), bytes, response, data, null);
        } catch (Exception e) {
            return new PaymentRequiredResponse(response.statusCode(), bytes, response, null, e);
        }
    }

    /**
    * Parse a response into an instance of PaymentRequiredResponse asynchronously. If deserialization of the response body fails,
    * the resulting PaymentRequiredResponse instance will have a null data() value and a non-null deserializationException().
    */
    public static CompletableFuture<PaymentRequiredResponse> fromAsync(HttpResponse<Blob> response) {
