...
public class UnprocessableResponse extends ApideckError {
    ...
    /**
    * Parse a response into an instance of UnprocessableResponse. If deserialization of the response body fails,
    * the resulting UnprocessableResponse instance will have a null data() value and a non-null deserializationException().
    */
    public static UnprocessableResponse from(HttpResponse<InputStream> response) {
        byte[] bytes;
        try {
            bytes = Utils.extractByteArrayFromBody(response);
        } catch (Exception e) {
            return new UnprocessableResponse(response.statusCode(), null, response, null, e);
        }
        try {
            Data data = Utils.mapper().readValue(bytes, Data.class);
            return new UnprocessableResponse(response.statusCode(), bytes, response, data, null);
        } catch (Exception e) {
            return new UnprocessableResponse(response.statusCode(), bytes, response, null, e);
        }
    }

    /**
    * Parse a response into an instance of UnprocessableResponse asynchronously. If deserialization of the response body fails,
    * the resulting UnprocessableResponse instance will have a null data() value and a non-null deserializationException().
    */
    public static CompletableFuture<UnprocessableResponse> fromAsync(HttpResponse<Blob> response) {
    ...
    public static class Data {
         ...
         * Contains parameter or domain specific information related to the error and why it occurred.
         */
        public Data withDetail(UnprocessableResponseDetail detail) {
            Utils.checkNotNull(detail, "detail");
         ...
         * Contains parameter or domain specific information related to the error and why it occurred.
         */
        public Data withDetail(Optional<? extends UnprocessableResponseDetail> detail) {
            Utils.checkNotNull(detail, "detail");
            this.detail = detail;
            return this;
        }
