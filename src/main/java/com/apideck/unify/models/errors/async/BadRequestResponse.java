...
import com.apideck.unify.models.errors.Detail;
...
public class BadRequestResponse extends RuntimeException {
     ...
     * HTTP status code
     */
    public BadRequestResponse withStatusCode(Optional<Double> statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Contains an explanation of the status_code as defined in HTTP/1.1 standard (RFC 7231)
     */
    public BadRequestResponse withError(Optional<String> error) {
        Utils.checkNotNull(error, "error");
        this.error = error;
        return this;
    }
     ...
     * The type of error returned
     */
    public BadRequestResponse withTypeName(Optional<String> typeName) {
        Utils.checkNotNull(typeName, "typeName");
        this.typeName = typeName;
        return this;
    }
     ...
     * A human-readable message providing more details about the error.
     */
    public BadRequestResponse withMessage(Optional<String> message) {
        Utils.checkNotNull(message, "message");
        this.message = message;
        return this;
    }
     ...
     * Link to documentation of error type
     */
    public BadRequestResponse withRef(Optional<String> ref) {
        Utils.checkNotNull(ref, "ref");
        this.ref = ref;
        return this;
    }
