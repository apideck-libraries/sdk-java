...
import com.apideck.unify.models.errors.NotFoundResponseDetail;
...
public class NotFoundResponse extends RuntimeException {
     ...
     * HTTP status code
     */
    public NotFoundResponse withStatusCode(Optional<Double> statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Contains an explanation of the status_code as defined in HTTP/1.1 standard (RFC 7231)
     */
    public NotFoundResponse withError(Optional<String> error) {
        Utils.checkNotNull(error, "error");
        this.error = error;
        return this;
    }
     ...
     * The type of error returned
     */
    public NotFoundResponse withTypeName(Optional<String> typeName) {
        Utils.checkNotNull(typeName, "typeName");
        this.typeName = typeName;
        return this;
    }
     ...
     * A human-readable message providing more details about the error.
     */
    public NotFoundResponse withMessage(Optional<String> message) {
        Utils.checkNotNull(message, "message");
        this.message = message;
        return this;
    }
     ...
     * Contains parameter or domain specific information related to the error and why it occurred.
     */
    public NotFoundResponse withDetail(NotFoundResponseDetail detail) {
        Utils.checkNotNull(detail, "detail");
     ...
     * Contains parameter or domain specific information related to the error and why it occurred.
     */
    public NotFoundResponse withDetail(Optional<? extends NotFoundResponseDetail> detail) {
        Utils.checkNotNull(detail, "detail");
        this.detail = detail;
        return this;
    }
     ...
     * Link to documentation of error type
     */
    public NotFoundResponse withRef(Optional<String> ref) {
        Utils.checkNotNull(ref, "ref");
        this.ref = ref;
        return this;
    }
