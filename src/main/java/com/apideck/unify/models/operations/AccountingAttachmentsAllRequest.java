...
public class AccountingAttachmentsAllRequest {
     ...
     * The reference type of the document.
     */
    public AccountingAttachmentsAllRequest withReferenceType(AttachmentReferenceType referenceType) {
        Utils.checkNotNull(referenceType, "referenceType");
        this.referenceType = referenceType;
        return this;
    }
     ...
     * The reference id of the object to retrieve.
     */
    public AccountingAttachmentsAllRequest withReferenceId(String referenceId) {
        Utils.checkNotNull(referenceId, "referenceId");
        this.referenceId = referenceId;
        return this;
    }
     ...
     * Include raw response. Mostly used for debugging purposes
     */
    public AccountingAttachmentsAllRequest withRaw(boolean raw) {
        Utils.checkNotNull(raw, "raw");
     ...
     * Include raw response. Mostly used for debugging purposes
     */
    public AccountingAttachmentsAllRequest withRaw(Optional<Boolean> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
     ...
     * ID of the consumer which you want to get or push data from
     */
    public AccountingAttachmentsAllRequest withConsumerId(String consumerId) {
        Utils.checkNotNull(consumerId, "consumerId");
     ...
     * ID of the consumer which you want to get or push data from
     */
    public AccountingAttachmentsAllRequest withConsumerId(Optional<String> consumerId) {
        Utils.checkNotNull(consumerId, "consumerId");
        this.consumerId = consumerId;
        return this;
    }
     ...
     * The ID of your Unify application
     */
    public AccountingAttachmentsAllRequest withAppId(String appId) {
        Utils.checkNotNull(appId, "appId");
     ...
     * The ID of your Unify application
     */
    public AccountingAttachmentsAllRequest withAppId(Optional<String> appId) {
        Utils.checkNotNull(appId, "appId");
        this.appId = appId;
        return this;
    }
     ...
     * multiple integrations for a Unified API.
     */
    public AccountingAttachmentsAllRequest withServiceId(String serviceId) {
        Utils.checkNotNull(serviceId, "serviceId");
     ...
     * multiple integrations for a Unified API.
     */
    public AccountingAttachmentsAllRequest withServiceId(Optional<String> serviceId) {
        Utils.checkNotNull(serviceId, "serviceId");
        this.serviceId = serviceId;
        return this;
    }
     ...
     * overrides the default company configured in connection settings.
     */
    public AccountingAttachmentsAllRequest withCompanyId(String companyId) {
        Utils.checkNotNull(companyId, "companyId");
     ...
     * overrides the default company configured in connection settings.
     */
    public AccountingAttachmentsAllRequest withCompanyId(Optional<String> companyId) {
        Utils.checkNotNull(companyId, "companyId");
        this.companyId = companyId;
        return this;
    }
     ...
     * the response.
     */
    public AccountingAttachmentsAllRequest withCursor(String cursor) {
        Utils.checkNotNull(cursor, "cursor");
     ...
     * the response.
     */
    public AccountingAttachmentsAllRequest withCursor(JsonNullable<String> cursor) {
        Utils.checkNotNull(cursor, "cursor");
        this.cursor = cursor;
        return this;
    }
     ...
     * Number of results to return. Minimum 1, Maximum 200, Default 20
     */
    public AccountingAttachmentsAllRequest withLimit(long limit) {
        Utils.checkNotNull(limit, "limit");
     ...
     * Number of results to return. Minimum 1, Maximum 200, Default 20
     */
    public AccountingAttachmentsAllRequest withLimit(Optional<Long> limit) {
        Utils.checkNotNull(limit, "limit");
        this.limit = limit;
        return this;
    }
     ...
     * excluded.
     */
    public AccountingAttachmentsAllRequest withFields(String fields) {
        Utils.checkNotNull(fields, "fields");
     ...
     * excluded.
     */
    public AccountingAttachmentsAllRequest withFields(JsonNullable<String> fields) {
        Utils.checkNotNull(fields, "fields");
        this.fields = fields;
        return this;
    }
     ...
     * ?pass_through[search]=leads becomes ?search=leads
     */
    public AccountingAttachmentsAllRequest withPassThrough(Map<String, Object> passThrough) {
        Utils.checkNotNull(passThrough, "passThrough");
     ...
     * ?pass_through[search]=leads becomes ?search=leads
     */
    public AccountingAttachmentsAllRequest withPassThrough(Optional<? extends Map<String, Object>> passThrough) {
        Utils.checkNotNull(passThrough, "passThrough");
        this.passThrough = passThrough;
        return this;
    }
