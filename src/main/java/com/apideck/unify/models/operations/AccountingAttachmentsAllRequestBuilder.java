...
public class AccountingAttachmentsAllRequestBuilder {
    ...
    public AccountingAttachmentsAllRequestBuilder request(@Nonnull AccountingAttachmentsAllRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private AccountingAttachmentsAllRequest _buildRequest() {
        return this.request;
    }
    /**
    ...
    * <pre><code>
    * for (AccountingAttachmentsAllResponse page : builder.callAsIterable()) {
    *     // Process each page
    * }
    * </code></pre>
    * 
    ...
    */
    public Iterable<AccountingAttachmentsAllResponse> callAsIterable() {
    ...
    * are returned.
    **/  
    public Stream<AccountingAttachmentsAllResponse> callAsStream() {
