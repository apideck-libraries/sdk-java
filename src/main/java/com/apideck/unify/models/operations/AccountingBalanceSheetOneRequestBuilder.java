...
public class AccountingBalanceSheetOneRequestBuilder {
    ...
    public AccountingBalanceSheetOneRequestBuilder request(@Nonnull AccountingBalanceSheetOneRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private AccountingBalanceSheetOneRequest _buildRequest() {
        return this.request;
    }
    /**
