...
public class AccountingBankAccountsAllRequestBuilder {
    ...
    public AccountingBankAccountsAllResponse call() throws Exception {
    ...
    * <pre><code>
    * for (AccountingBankAccountsAllResponse page : builder.callAsIterable()) {
    *     // Process each page
    * }
    * </code></pre>
    * 
    ...
    */
    public Iterable<AccountingBankAccountsAllResponse> callAsIterable() {
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
     ...
     * are returned.
     **/  
    public Stream<AccountingBankAccountsAllResponse> callAsStream() {
