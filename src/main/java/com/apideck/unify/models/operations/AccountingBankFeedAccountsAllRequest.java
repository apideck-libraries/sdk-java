...
public class AccountingBankFeedAccountsAllRequest {
     ...
     * Include raw response. Mostly used for debugging purposes
     */
    public AccountingBankFeedAccountsAllRequest withRaw(boolean raw) {
        Utils.checkNotNull(raw, "raw");
     ...
     * Include raw response. Mostly used for debugging purposes
     */
    public AccountingBankFeedAccountsAllRequest withRaw(Optional<Boolean> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
     ...
     * ID of the consumer which you want to get or push data from
     */
    public AccountingBankFeedAccountsAllRequest withConsumerId(String consumerId) {
        Utils.checkNotNull(consumerId, "consumerId");
     ...
     * ID of the consumer which you want to get or push data from
     */
    public AccountingBankFeedAccountsAllRequest withConsumerId(Optional<String> consumerId) {
        Utils.checkNotNull(consumerId, "consumerId");
        this.consumerId = consumerId;
        return this;
    }
     ...
     * The ID of your Unify application
     */
    public AccountingBankFeedAccountsAllRequest withAppId(String appId) {
        Utils.checkNotNull(appId, "appId");
     ...
     * The ID of your Unify application
     */
    public AccountingBankFeedAccountsAllRequest withAppId(Optional<String> appId) {
        Utils.checkNotNull(appId, "appId");
        this.appId = appId;
        return this;
    }
     ...
     * multiple integrations for a Unified API.
     */
    public AccountingBankFeedAccountsAllRequest withServiceId(String serviceId) {
        Utils.checkNotNull(serviceId, "serviceId");
     ...
     * multiple integrations for a Unified API.
     */
    public AccountingBankFeedAccountsAllRequest withServiceId(Optional<String> serviceId) {
        Utils.checkNotNull(serviceId, "serviceId");
        this.serviceId = serviceId;
        return this;
    }
     ...
     * overrides the default company configured in connection settings.
     */
    public AccountingBankFeedAccountsAllRequest withCompanyId(String companyId) {
        Utils.checkNotNull(companyId, "companyId");
     ...
     * overrides the default company configured in connection settings.
     */
    public AccountingBankFeedAccountsAllRequest withCompanyId(Optional<String> companyId) {
        Utils.checkNotNull(companyId, "companyId");
        this.companyId = companyId;
        return this;
    }
     ...
     * the response.
     */
    public AccountingBankFeedAccountsAllRequest withCursor(String cursor) {
        Utils.checkNotNull(cursor, "cursor");
     ...
     * the response.
     */
    public AccountingBankFeedAccountsAllRequest withCursor(JsonNullable<String> cursor) {
        Utils.checkNotNull(cursor, "cursor");
        this.cursor = cursor;
        return this;
    }
     ...
     * Number of results to return. Minimum 1, Maximum 200, Default 20
     */
    public AccountingBankFeedAccountsAllRequest withLimit(long limit) {
        Utils.checkNotNull(limit, "limit");
     ...
     * Number of results to return. Minimum 1, Maximum 200, Default 20
     */
    public AccountingBankFeedAccountsAllRequest withLimit(Optional<Long> limit) {
        Utils.checkNotNull(limit, "limit");
        this.limit = limit;
        return this;
    }
     ...
     * ?pass_through[search]=leads becomes ?search=leads
     */
    public AccountingBankFeedAccountsAllRequest withPassThrough(Map<String, Object> passThrough) {
        Utils.checkNotNull(passThrough, "passThrough");
     ...
     * ?pass_through[search]=leads becomes ?search=leads
     */
    public AccountingBankFeedAccountsAllRequest withPassThrough(Optional<? extends Map<String, Object>> passThrough) {
        Utils.checkNotNull(passThrough, "passThrough");
        this.passThrough = passThrough;
        return this;
    }
     ...
     * excluded.
     */
    public AccountingBankFeedAccountsAllRequest withFields(String fields) {
        Utils.checkNotNull(fields, "fields");
     ...
     * excluded.
     */
    public AccountingBankFeedAccountsAllRequest withFields(JsonNullable<String> fields) {
        Utils.checkNotNull(fields, "fields");
        this.fields = fields;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AccountingBankFeedAccountsAllRequest other = (AccountingBankFeedAccountsAllRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AccountingBankFeedAccountsAllRequest.class,
                "raw", raw,
    ...
    public final static class Builder {
        ...
        public AccountingBankFeedAccountsAllRequest build() {
            if (raw == null) {
            ...
            return new AccountingBankFeedAccountsAllRequest(
                raw, consumerId, appId,
                serviceId, companyId, cursor,
                limit, passThrough, fields);
        }
