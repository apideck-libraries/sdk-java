...
public class AccountingBankFeedAccountsAllRequestBuilder {
    ...
    private final SDKMethodInterfaces.MethodCallAccountingBankFeedAccountsAll sdk;

    public AccountingBankFeedAccountsAllRequestBuilder(SDKMethodInterfaces.MethodCallAccountingBankFeedAccountsAll sdk) {
        this.sdk = sdk;
    }
