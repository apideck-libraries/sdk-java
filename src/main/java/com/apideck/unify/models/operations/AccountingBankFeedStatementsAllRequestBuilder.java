...
public class AccountingBankFeedStatementsAllRequestBuilder {
    ...
    public AccountingBankFeedStatementsAllRequestBuilder request(@Nonnull AccountingBankFeedStatementsAllRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private AccountingBankFeedStatementsAllRequest _buildRequest() {
        return this.request;
    }
    /**
