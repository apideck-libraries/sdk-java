...
public class AccountingBillPaymentsAllRequestBuilder {
    ...
    public AccountingBillPaymentsAllRequestBuilder request(@Nonnull AccountingBillPaymentsAllRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private AccountingBillPaymentsAllRequest _buildRequest() {
        return this.request;
    }
    /**
