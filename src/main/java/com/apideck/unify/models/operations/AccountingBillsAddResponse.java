...
public class AccountingBillsAddResponse implements Response {
     ...
     * Bill created
     */
    private CreateBillResponse createBillResponse;
    ...
    public AccountingBillsAddResponse(
            ...
            @Nullable CreateBillResponse createBillResponse,
    ...
    public Optional<CreateBillResponse> createBillResponse() {
        return Optional.ofNullable(this.createBillResponse);
    }
     ...
     * HTTP response content type for this operation
     */
    public AccountingBillsAddResponse withContentType(@Nonnull String contentType) {
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public AccountingBillsAddResponse withRawResponse(@Nonnull HttpResponse<InputStream> rawResponse) {
     ...
     * Bill created
     */
    public AccountingBillsAddResponse withCreateBillResponse(@Nullable CreateBillResponse createBillResponse) {
        this.createBillResponse = createBillResponse;
        return this;
    }
     ...
     * Unexpected error
     */
    public AccountingBillsAddResponse withUnexpectedErrorResponse(@Nullable UnexpectedErrorResponse unexpectedErrorResponse) {
        this.unexpectedErrorResponse = unexpectedErrorResponse;
        return this;
    }
    ...
    public final static class Builder {
         ...
         * Bill created
         */
        public Builder createBillResponse(@Nullable CreateBillResponse createBillResponse) {
            this.createBillResponse = createBillResponse;
            return this;
        }
