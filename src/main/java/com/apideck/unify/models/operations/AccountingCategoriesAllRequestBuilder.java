...
public class AccountingCategoriesAllRequestBuilder {
    ...
    public AccountingCategoriesAllRequestBuilder request(@Nonnull AccountingCategoriesAllRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private AccountingCategoriesAllRequest _buildRequest() {
        return this.request;
    }
    /**
    ...
    */
    public AccountingCategoriesAllResponse call() throws Exception {
    ...
    * <pre><code>
    * for (AccountingCategoriesAllResponse page : builder.callAsIterable()) {
    *     // Process each page
    * }
    * </code></pre>
    * 
    ...
    */
    public Iterable<AccountingCategoriesAllResponse> callAsIterable() {
    ...
    * are returned.
    **/  
    public Stream<AccountingCategoriesAllResponse> callAsStream() {
