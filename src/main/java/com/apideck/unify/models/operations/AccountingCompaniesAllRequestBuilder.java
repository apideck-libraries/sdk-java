...
public class AccountingCompaniesAllRequestBuilder {
    ...
    public AccountingCompaniesAllResponse call() {
    ...
    * <pre><code>
    * for (AccountingCompaniesAllResponse page : builder.callAsIterable()) {
    *     // Process each page
    * }
    * </code></pre>
    * 
    ...
    */
    public Iterable<AccountingCompaniesAllResponse> callAsIterable() {
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
     ...
     * are returned.
     **/  
    public Stream<AccountingCompaniesAllResponse> callAsStream() {
