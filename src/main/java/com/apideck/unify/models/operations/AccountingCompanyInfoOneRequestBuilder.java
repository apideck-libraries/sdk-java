...
public class AccountingCompanyInfoOneRequestBuilder {
    ...
    public AccountingCompanyInfoOneRequestBuilder(SDKConfiguration sdkConfiguration) {
    ...
    public AccountingCompanyInfoOneRequestBuilder request(@Nonnull AccountingCompanyInfoOneRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private AccountingCompanyInfoOneRequest _buildRequest() {
        return this.request;
    }
    /**
