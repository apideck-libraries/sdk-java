...
public class AccountingCreditNotesDeleteRequestBuilder {
    ...
    public AccountingCreditNotesDeleteRequestBuilder request(@Nonnull AccountingCreditNotesDeleteRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private AccountingCreditNotesDeleteRequest _buildRequest() {
        return this.request;
    }
    /**
