...
public class AccountingCustomersAllRequestBuilder {
    ...
    public AccountingCustomersAllRequestBuilder request(@Nonnull AccountingCustomersAllRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private AccountingCustomersAllRequest _buildRequest() {
        return this.request;
    }
    /**
    ...
    */
    public AccountingCustomersAllResponse call() throws Exception {
    ...
    * <pre><code>
    * for (AccountingCustomersAllResponse page : builder.callAsIterable()) {
    *     // Process each page
    * }
    * </code></pre>
    * 
    ...
    */
    public Iterable<AccountingCustomersAllResponse> callAsIterable() {
    ...
    * are returned.
    **/  
    public Stream<AccountingCustomersAllResponse> callAsStream() {
