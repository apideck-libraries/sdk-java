...
public class AccountingDepartmentsAllRequest {
     ...
     * Include raw response. Mostly used for debugging purposes
     */
    public AccountingDepartmentsAllRequest withRaw(boolean raw) {
        Utils.checkNotNull(raw, "raw");
     ...
     * Include raw response. Mostly used for debugging purposes
     */
    public AccountingDepartmentsAllRequest withRaw(Optional<Boolean> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
     ...
     * ID of the consumer which you want to get or push data from
     */
    public AccountingDepartmentsAllRequest withConsumerId(String consumerId) {
        Utils.checkNotNull(consumerId, "consumerId");
     ...
     * ID of the consumer which you want to get or push data from
     */
    public AccountingDepartmentsAllRequest withConsumerId(Optional<String> consumerId) {
        Utils.checkNotNull(consumerId, "consumerId");
        this.consumerId = consumerId;
        return this;
    }
     ...
     * The ID of your Unify application
     */
    public AccountingDepartmentsAllRequest withAppId(String appId) {
        Utils.checkNotNull(appId, "appId");
     ...
     * The ID of your Unify application
     */
    public AccountingDepartmentsAllRequest withAppId(Optional<String> appId) {
        Utils.checkNotNull(appId, "appId");
        this.appId = appId;
        return this;
    }
     ...
     * multiple integrations for a Unified API.
     */
    public AccountingDepartmentsAllRequest withServiceId(String serviceId) {
        Utils.checkNotNull(serviceId, "serviceId");
     ...
     * multiple integrations for a Unified API.
     */
    public AccountingDepartmentsAllRequest withServiceId(Optional<String> serviceId) {
        Utils.checkNotNull(serviceId, "serviceId");
        this.serviceId = serviceId;
        return this;
    }
     ...
     * overrides the default company configured in connection settings.
     */
    public AccountingDepartmentsAllRequest withCompanyId(String companyId) {
        Utils.checkNotNull(companyId, "companyId");
     ...
     * overrides the default company configured in connection settings.
     */
    public AccountingDepartmentsAllRequest withCompanyId(Optional<String> companyId) {
        Utils.checkNotNull(companyId, "companyId");
        this.companyId = companyId;
        return this;
    }
     ...
     * the response.
     */
    public AccountingDepartmentsAllRequest withCursor(String cursor) {
        Utils.checkNotNull(cursor, "cursor");
     ...
     * the response.
     */
    public AccountingDepartmentsAllRequest withCursor(JsonNullable<String> cursor) {
        Utils.checkNotNull(cursor, "cursor");
        this.cursor = cursor;
        return this;
    }
     ...
     * Number of results to return. Minimum 1, Maximum 200, Default 20
     */
    public AccountingDepartmentsAllRequest withLimit(long limit) {
        Utils.checkNotNull(limit, "limit");
     ...
     * Number of results to return. Minimum 1, Maximum 200, Default 20
     */
    public AccountingDepartmentsAllRequest withLimit(Optional<Long> limit) {
        Utils.checkNotNull(limit, "limit");
        this.limit = limit;
        return this;
    }
     ...
     * excluded.
     */
    public AccountingDepartmentsAllRequest withFields(String fields) {
        Utils.checkNotNull(fields, "fields");
     ...
     * excluded.
     */
    public AccountingDepartmentsAllRequest withFields(JsonNullable<String> fields) {
        Utils.checkNotNull(fields, "fields");
        this.fields = fields;
        return this;
    }
     ...
     * Apply filters
     */
    public AccountingDepartmentsAllRequest withFilter(AccountingDepartmentsFilter filter) {
        Utils.checkNotNull(filter, "filter");
     ...
     * Apply filters
     */
    public AccountingDepartmentsAllRequest withFilter(Optional<? extends AccountingDepartmentsFilter> filter) {
        Utils.checkNotNull(filter, "filter");
        this.filter = filter;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(AccountingDepartmentsAllRequest.class,
                "raw", raw,
    ...
    public final static class Builder {
         ...
         * Apply filters
         */
        public Builder filter(AccountingDepartmentsFilter filter) {
            Utils.checkNotNull(filter, "filter");
            this.filter = Optional.ofNullable(filter);
            return this;
        }
         ...
         * Apply filters
         */
        public Builder filter(Optional<? extends AccountingDepartmentsFilter> filter) {
            Utils.checkNotNull(filter, "filter");
            this.filter = filter;
            return this;
        }
