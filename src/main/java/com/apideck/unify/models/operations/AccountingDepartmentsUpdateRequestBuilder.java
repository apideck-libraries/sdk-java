...
public class AccountingDepartmentsUpdateRequestBuilder {
    ...
    private final SDKMethodInterfaces.MethodCallAccountingDepartmentsUpdate sdk;

    public AccountingDepartmentsUpdateRequestBuilder(SDKMethodInterfaces.MethodCallAccountingDepartmentsUpdate sdk) {
        this.sdk = sdk;
    }
