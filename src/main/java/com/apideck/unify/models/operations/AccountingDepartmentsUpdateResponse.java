...
public class AccountingDepartmentsUpdateResponse implements Response {
     ...
     * Department
     */
    private UpdateAccountingDepartmentResponse updateAccountingDepartmentResponse;
    ...
    public AccountingDepartmentsUpdateResponse(
            ...
            @Nullable UpdateAccountingDepartmentResponse updateAccountingDepartmentResponse,
    ...
    public Optional<UpdateAccountingDepartmentResponse> updateAccountingDepartmentResponse() {
        return Optional.ofNullable(this.updateAccountingDepartmentResponse);
    }
     ...
     * HTTP response content type for this operation
     */
    public AccountingDepartmentsUpdateResponse withContentType(@Nonnull String contentType) {
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public AccountingDepartmentsUpdateResponse withRawResponse(@Nonnull HttpResponse<InputStream> rawResponse) {
     ...
     * Department
     */
    public AccountingDepartmentsUpdateResponse withUpdateAccountingDepartmentResponse(@Nullable UpdateAccountingDepartmentResponse updateAccountingDepartmentResponse) {
        this.updateAccountingDepartmentResponse = updateAccountingDepartmentResponse;
        return this;
    }
     ...
     * Unexpected error
     */
    public AccountingDepartmentsUpdateResponse withUnexpectedErrorResponse(@Nullable UnexpectedErrorResponse unexpectedErrorResponse) {
        this.unexpectedErrorResponse = unexpectedErrorResponse;
        return this;
    }
    ...
    public final static class Builder {
         ...
         * Department
         */
        public Builder updateAccountingDepartmentResponse(@Nullable UpdateAccountingDepartmentResponse updateAccountingDepartmentResponse) {
            this.updateAccountingDepartmentResponse = updateAccountingDepartmentResponse;
            return this;
        }
