...
public class AccountingEmployeesAllRequestBuilder {
    ...
    public AccountingEmployeesAllResponse call() {
    ...
    */
    public Iterable<AccountingEmployeesAllResponse> callAsIterable() {
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
     ...
     * are returned.
     **/  
    public Stream<AccountingEmployeesAllResponse> callAsStream() {
