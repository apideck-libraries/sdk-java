...
public class AccountingExpenseCategoriesAllRequest {
     ...
     * Include raw response. Mostly used for debugging purposes
     */
    public AccountingExpenseCategoriesAllRequest withRaw(boolean raw) {
        Utils.checkNotNull(raw, "raw");
     ...
     * Include raw response. Mostly used for debugging purposes
     */
    public AccountingExpenseCategoriesAllRequest withRaw(Optional<Boolean> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
     ...
     * ID of the consumer which you want to get or push data from
     */
    public AccountingExpenseCategoriesAllRequest withConsumerId(String consumerId) {
        Utils.checkNotNull(consumerId, "consumerId");
     ...
     * ID of the consumer which you want to get or push data from
     */
    public AccountingExpenseCategoriesAllRequest withConsumerId(Optional<String> consumerId) {
        Utils.checkNotNull(consumerId, "consumerId");
        this.consumerId = consumerId;
        return this;
    }
     ...
     * The ID of your Unify application
     */
    public AccountingExpenseCategoriesAllRequest withAppId(String appId) {
        Utils.checkNotNull(appId, "appId");
     ...
     * The ID of your Unify application
     */
    public AccountingExpenseCategoriesAllRequest withAppId(Optional<String> appId) {
        Utils.checkNotNull(appId, "appId");
        this.appId = appId;
        return this;
    }
     ...
     * multiple integrations for a Unified API.
     */
    public AccountingExpenseCategoriesAllRequest withServiceId(String serviceId) {
        Utils.checkNotNull(serviceId, "serviceId");
     ...
     * multiple integrations for a Unified API.
     */
    public AccountingExpenseCategoriesAllRequest withServiceId(Optional<String> serviceId) {
        Utils.checkNotNull(serviceId, "serviceId");
        this.serviceId = serviceId;
        return this;
    }
     ...
     * the response.
     */
    public AccountingExpenseCategoriesAllRequest withCursor(String cursor) {
        Utils.checkNotNull(cursor, "cursor");
     ...
     * the response.
     */
    public AccountingExpenseCategoriesAllRequest withCursor(JsonNullable<String> cursor) {
        Utils.checkNotNull(cursor, "cursor");
        this.cursor = cursor;
        return this;
    }
     ...
     * Number of results to return. Minimum 1, Maximum 200, Default 20
     */
    public AccountingExpenseCategoriesAllRequest withLimit(long limit) {
        Utils.checkNotNull(limit, "limit");
     ...
     * Number of results to return. Minimum 1, Maximum 200, Default 20
     */
    public AccountingExpenseCategoriesAllRequest withLimit(Optional<Long> limit) {
        Utils.checkNotNull(limit, "limit");
        this.limit = limit;
        return this;
    }
     ...
     * excluded.
     */
    public AccountingExpenseCategoriesAllRequest withFields(String fields) {
        Utils.checkNotNull(fields, "fields");
     ...
     * excluded.
     */
    public AccountingExpenseCategoriesAllRequest withFields(JsonNullable<String> fields) {
        Utils.checkNotNull(fields, "fields");
        this.fields = fields;
        return this;
    }
     ...
     * ?pass_through[search]=leads becomes ?search=leads
     */
    public AccountingExpenseCategoriesAllRequest withPassThrough(Map<String, Object> passThrough) {
        Utils.checkNotNull(passThrough, "passThrough");
     ...
     * ?pass_through[search]=leads becomes ?search=leads
     */
    public AccountingExpenseCategoriesAllRequest withPassThrough(Optional<? extends Map<String, Object>> passThrough) {
        Utils.checkNotNull(passThrough, "passThrough");
        this.passThrough = passThrough;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AccountingExpenseCategoriesAllRequest other = (AccountingExpenseCategoriesAllRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AccountingExpenseCategoriesAllRequest.class,
                "raw", raw,
    ...
    public final static class Builder {
        ...
        public AccountingExpenseCategoriesAllRequest build() {
            if (raw == null) {
            ...
            return new AccountingExpenseCategoriesAllRequest(
                raw, consumerId, appId,
                serviceId, cursor, limit,
                fields, filter, passThrough);
        }
