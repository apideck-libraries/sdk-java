...
public class AccountingExpensesAllResponse implements Response {
    ...
    private Callable<Optional<AccountingExpensesAllResponse>> next = () -> Optional.empty();
    ...
    public Optional<AccountingExpensesAllResponse> next() throws Exception {
        return this.next.call();
    }
    
    // internal use only
    private AccountingExpensesAllResponse withNext(Callable<Optional<AccountingExpensesAllResponse>> next) {
        this.next = next;
        return this;
    }
    ...
    public final static class Builder {
        private Callable<Optional<AccountingExpensesAllResponse>> next;
         ...
         */
        @Deprecated
        public Builder next(Callable<Optional<AccountingExpensesAllResponse>> next) {
