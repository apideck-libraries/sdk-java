...
public class AccountingExpensesDeleteRequestBuilder {
    ...
    public AccountingExpensesDeleteRequestBuilder request(@Nonnull AccountingExpensesDeleteRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private AccountingExpensesDeleteRequest _buildRequest() {
        return this.request;
    }
    /**
