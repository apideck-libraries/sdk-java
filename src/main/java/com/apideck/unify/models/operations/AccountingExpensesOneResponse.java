...
public class AccountingExpensesOneResponse implements Response {
     ...
     * Expenses
     */
    private GetExpenseResponse getExpenseResponse;
    ...
    public AccountingExpensesOneResponse(
            ...
            @Nullable GetExpenseResponse getExpenseResponse,
    ...
    public Optional<GetExpenseResponse> getExpenseResponse() {
        return Optional.ofNullable(this.getExpenseResponse);
    }
     ...
     * HTTP response content type for this operation
     */
    public AccountingExpensesOneResponse withContentType(@Nonnull String contentType) {
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public AccountingExpensesOneResponse withRawResponse(@Nonnull HttpResponse<InputStream> rawResponse) {
     ...
     * Expenses
     */
    public AccountingExpensesOneResponse withGetExpenseResponse(@Nullable GetExpenseResponse getExpenseResponse) {
        this.getExpenseResponse = getExpenseResponse;
        return this;
    }
     ...
     * Unexpected error
     */
    public AccountingExpensesOneResponse withUnexpectedErrorResponse(@Nullable UnexpectedErrorResponse unexpectedErrorResponse) {
        this.unexpectedErrorResponse = unexpectedErrorResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return 
            ...
            Utils.enhancedDeepEquals(this.getExpenseResponse, other.getExpenseResponse) &&
    ...
    public int hashCode() {
        return Utils.enhancedHash(
            ...
            getExpenseResponse, unexpectedErrorResponse);
    }
    ...
    public final static class Builder {
         ...
         * Expenses
         */
        public Builder getExpenseResponse(@Nullable GetExpenseResponse getExpenseResponse) {
            this.getExpenseResponse = getExpenseResponse;
            return this;
        }
