...
public class AccountingInvoiceItemsOneRequestBuilder {
    ...
    public AccountingInvoiceItemsOneRequestBuilder(SDKConfiguration sdkConfiguration) {
    ...
    public AccountingInvoiceItemsOneRequestBuilder request(@Nonnull AccountingInvoiceItemsOneRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private AccountingInvoiceItemsOneRequest _buildRequest() {
        return this.request;
    }
    /**
