...
public class AccountingInvoicesAllRequest {
     ...
     * overrides the default company configured in connection settings.
     */
    public AccountingInvoicesAllRequest withCompanyId(String companyId) {
        Utils.checkNotNull(companyId, "companyId");
     ...
     * overrides the default company configured in connection settings.
     */
    public AccountingInvoicesAllRequest withCompanyId(Optional<String> companyId) {
        Utils.checkNotNull(companyId, "companyId");
        this.companyId = companyId;
        return this;
    }
     ...
     * Apply filters
     */
    public AccountingInvoicesAllRequest withFilter(Map<String, Object> filter) {
        Utils.checkNotNull(filter, "filter");
     ...
     * Apply filters
     */
    public AccountingInvoicesAllRequest withFilter(Optional<? extends Map<String, Object>> filter) {
        Utils.checkNotNull(filter, "filter");
        this.filter = filter;
        return this;
    }
     ...
     * Apply sorting
     */
    public AccountingInvoicesAllRequest withSort(Map<String, Object> sort) {
        Utils.checkNotNull(sort, "sort");
     ...
     * Apply sorting
     */
    public AccountingInvoicesAllRequest withSort(Optional<? extends Map<String, Object>> sort) {
        Utils.checkNotNull(sort, "sort");
        this.sort = sort;
        return this;
    }
