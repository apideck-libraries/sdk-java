...
public class AccountingInvoicesAllRequestBuilder {
    ...
    public AccountingInvoicesAllRequestBuilder request(@Nonnull AccountingInvoicesAllRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private AccountingInvoicesAllRequest _buildRequest() {
        return this.request;
    }
    /**
    ...
    * <pre><code>
    * for (AccountingInvoicesAllResponse page : builder.callAsIterable()) {
    *     // Process each page
    * }
    * </code></pre>
    * 
    ...
    */
    public Iterable<AccountingInvoicesAllResponse> callAsIterable() {
    ...
    * are returned.
    **/  
    public Stream<AccountingInvoicesAllResponse> callAsStream() {
