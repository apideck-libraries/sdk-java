...
public class AccountingJournalEntriesAllRequest {
     ...
     * overrides the default company configured in connection settings.
     */
    public AccountingJournalEntriesAllRequest withCompanyId(String companyId) {
        Utils.checkNotNull(companyId, "companyId");
     ...
     * overrides the default company configured in connection settings.
     */
    public AccountingJournalEntriesAllRequest withCompanyId(Optional<String> companyId) {
        Utils.checkNotNull(companyId, "companyId");
        this.companyId = companyId;
        return this;
    }
     ...
     * Apply filters
     */
    public AccountingJournalEntriesAllRequest withFilter(Map<String, Object> filter) {
        Utils.checkNotNull(filter, "filter");
     ...
     * Apply filters
     */
    public AccountingJournalEntriesAllRequest withFilter(Optional<? extends Map<String, Object>> filter) {
        Utils.checkNotNull(filter, "filter");
        this.filter = filter;
        return this;
    }
     ...
     * Apply sorting
     */
    public AccountingJournalEntriesAllRequest withSort(Map<String, Object> sort) {
        Utils.checkNotNull(sort, "sort");
     ...
     * Apply sorting
     */
    public AccountingJournalEntriesAllRequest withSort(Optional<? extends Map<String, Object>> sort) {
        Utils.checkNotNull(sort, "sort");
        this.sort = sort;
        return this;
    }
