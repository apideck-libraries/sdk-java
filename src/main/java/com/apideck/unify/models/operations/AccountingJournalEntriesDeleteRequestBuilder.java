...
public class AccountingJournalEntriesDeleteRequestBuilder {
    ...
    public AccountingJournalEntriesDeleteRequestBuilder request(@Nonnull AccountingJournalEntriesDeleteRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private AccountingJournalEntriesDeleteRequest _buildRequest() {
        return this.request;
    }
    /**
