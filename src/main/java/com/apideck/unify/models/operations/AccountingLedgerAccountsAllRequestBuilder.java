...
public class AccountingLedgerAccountsAllRequestBuilder {
    ...
    public AccountingLedgerAccountsAllRequestBuilder request(@Nonnull AccountingLedgerAccountsAllRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private AccountingLedgerAccountsAllRequest _buildRequest() {
        return this.request;
    }
    /**
    ...
    * <pre><code>
    * for (AccountingLedgerAccountsAllResponse page : builder.callAsIterable()) {
    *     // Process each page
    * }
    * </code></pre>
    * 
    ...
    */
    public Iterable<AccountingLedgerAccountsAllResponse> callAsIterable() {
    ...
    * are returned.
    **/  
    public Stream<AccountingLedgerAccountsAllResponse> callAsStream() {
