...
public class AccountingLedgerAccountsUpdateResponse implements Response {
     ...
     */
    private UpdateLedgerAccountResponse updateLedgerAccountResponse;
    ...
    public AccountingLedgerAccountsUpdateResponse(
            ...
            @Nullable UpdateLedgerAccountResponse updateLedgerAccountResponse,
    ...
    public Optional<UpdateLedgerAccountResponse> updateLedgerAccountResponse() {
        return Optional.ofNullable(this.updateLedgerAccountResponse);
    }
     ...
     * HTTP response content type for this operation
     */
    public AccountingLedgerAccountsUpdateResponse withContentType(@Nonnull String contentType) {
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public AccountingLedgerAccountsUpdateResponse withRawResponse(@Nonnull HttpResponse<InputStream> rawResponse) {
     ...
     * LedgerAccount updated
     */
    public AccountingLedgerAccountsUpdateResponse withUpdateLedgerAccountResponse(@Nullable UpdateLedgerAccountResponse updateLedgerAccountResponse) {
        this.updateLedgerAccountResponse = updateLedgerAccountResponse;
        return this;
    }
     ...
     * Unexpected error
     */
    public AccountingLedgerAccountsUpdateResponse withUnexpectedErrorResponse(@Nullable UnexpectedErrorResponse unexpectedErrorResponse) {
        this.unexpectedErrorResponse = unexpectedErrorResponse;
        return this;
    }
    ...
    public final static class Builder {
         ...
         * LedgerAccount updated
         */
        public Builder updateLedgerAccountResponse(@Nullable UpdateLedgerAccountResponse updateLedgerAccountResponse) {
            this.updateLedgerAccountResponse = updateLedgerAccountResponse;
            return this;
        }
