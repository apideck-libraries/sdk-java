...
public class AccountingLocationsAllRequest {
     ...
     * Apply filters
     */
    public AccountingLocationsAllRequest withFilter(Map<String, Object> filter) {
        Utils.checkNotNull(filter, "filter");
     ...
     * Apply filters
     */
    public AccountingLocationsAllRequest withFilter(Optional<? extends Map<String, Object>> filter) {
        Utils.checkNotNull(filter, "filter");
        this.filter = filter;
        return this;
    }
