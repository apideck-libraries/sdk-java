...
public class AccountingProfitAndLossOneRequest {
     ...
     * Apply filters
     */
    public AccountingProfitAndLossOneRequest withFilter(Map<String, Object> filter) {
        Utils.checkNotNull(filter, "filter");
     ...
     * Apply filters
     */
    public AccountingProfitAndLossOneRequest withFilter(Optional<? extends Map<String, Object>> filter) {
        Utils.checkNotNull(filter, "filter");
        this.filter = filter;
        return this;
    }
