...
public class AccountingProfitAndLossOneRequestBuilder {
    ...
    public AccountingProfitAndLossOneRequestBuilder request(@Nonnull AccountingProfitAndLossOneRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private AccountingProfitAndLossOneRequest _buildRequest() {
        return this.request;
    }
    /**
