...
public class AccountingProjectsAllRequestBuilder {
    ...
    public AccountingProjectsAllResponse call() throws Exception {
    ...
    * <pre><code>
    * for (AccountingProjectsAllResponse page : builder.callAsIterable()) {
    *     // Process each page
    * }
    * </code></pre>
    * 
    ...
    */
    public Iterable<AccountingProjectsAllResponse> callAsIterable() {
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
     ...
     * are returned.
     **/  
    public Stream<AccountingProjectsAllResponse> callAsStream() {
