...
public class AccountingPurchaseOrdersAllRequestBuilder {
    ...
    public AccountingPurchaseOrdersAllRequestBuilder request(@Nonnull AccountingPurchaseOrdersAllRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private AccountingPurchaseOrdersAllRequest _buildRequest() {
        return this.request;
    }
    /**
    ...
    */
    public AccountingPurchaseOrdersAllResponse call() throws Exception {
    ...
    * <pre><code>
    * for (AccountingPurchaseOrdersAllResponse page : builder.callAsIterable()) {
    *     // Process each page
    * }
    * </code></pre>
    * 
    ...
    */
    public Iterable<AccountingPurchaseOrdersAllResponse> callAsIterable() {
    ...
    * are returned.
    **/  
    public Stream<AccountingPurchaseOrdersAllResponse> callAsStream() {
