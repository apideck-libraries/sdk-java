...
public class AccountingPurchaseOrdersUpdateResponse implements Response {
     ...
     * PurchaseOrders
     */
    private UpdatePurchaseOrderResponse updatePurchaseOrderResponse;
    ...
    public AccountingPurchaseOrdersUpdateResponse(
            ...
            @Nullable UpdatePurchaseOrderResponse updatePurchaseOrderResponse,
    ...
    public Optional<UpdatePurchaseOrderResponse> updatePurchaseOrderResponse() {
        return Optional.ofNullable(this.updatePurchaseOrderResponse);
    }
     ...
     * HTTP response content type for this operation
     */
    public AccountingPurchaseOrdersUpdateResponse withContentType(@Nonnull String contentType) {
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public AccountingPurchaseOrdersUpdateResponse withRawResponse(@Nonnull HttpResponse<InputStream> rawResponse) {
     ...
     * PurchaseOrders
     */
    public AccountingPurchaseOrdersUpdateResponse withUpdatePurchaseOrderResponse(@Nullable UpdatePurchaseOrderResponse updatePurchaseOrderResponse) {
        this.updatePurchaseOrderResponse = updatePurchaseOrderResponse;
        return this;
    }
     ...
     * Unexpected error
     */
    public AccountingPurchaseOrdersUpdateResponse withUnexpectedErrorResponse(@Nullable UnexpectedErrorResponse unexpectedErrorResponse) {
        this.unexpectedErrorResponse = unexpectedErrorResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return 
            ...
            Utils.enhancedDeepEquals(this.updatePurchaseOrderResponse, other.updatePurchaseOrderResponse) &&
    ...
    public int hashCode() {
        return Utils.enhancedHash(
            ...
            updatePurchaseOrderResponse, unexpectedErrorResponse);
    }
    ...
    public final static class Builder {
         ...
         * PurchaseOrders
         */
        public Builder updatePurchaseOrderResponse(@Nullable UpdatePurchaseOrderResponse updatePurchaseOrderResponse) {
            this.updatePurchaseOrderResponse = updatePurchaseOrderResponse;
            return this;
        }
