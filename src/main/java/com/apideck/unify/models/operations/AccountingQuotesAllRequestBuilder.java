...
import com.apideck.unify.operations.AccountingQuotesAllOperation;
...
public class AccountingQuotesAllRequestBuilder {
    ...
    public AccountingQuotesAllResponse call() throws Exception {
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());

        RequestOperation<AccountingQuotesAllRequest, AccountingQuotesAllResponse> operation
              = new AccountingQuotesAllOperation(sdkConfiguration, options);
    ...
    * <pre><code>
    * for (AccountingQuotesAllResponse page : builder.callAsIterable()) {
    *     // Process each page
    * }
    * </code></pre>
    * 
    ...
    */
    public Iterable<AccountingQuotesAllResponse> callAsIterable() {
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
     ...
     * are returned.
     **/  
    public Stream<AccountingQuotesAllResponse> callAsStream() {
