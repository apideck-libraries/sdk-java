...
public class AccountingSuppliersUpdateRequestBuilder {
    ...
    public AccountingSuppliersUpdateRequestBuilder request(@Nonnull AccountingSuppliersUpdateRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private AccountingSuppliersUpdateRequest _buildRequest() {
        return this.request;
    }
    /**
