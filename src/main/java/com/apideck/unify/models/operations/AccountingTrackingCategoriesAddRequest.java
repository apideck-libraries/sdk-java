...
public class AccountingTrackingCategoriesAddRequest {
     ...
     * Include raw response. Mostly used for debugging purposes
     */
    public AccountingTrackingCategoriesAddRequest withRaw(boolean raw) {
        Utils.checkNotNull(raw, "raw");
     ...
     * Include raw response. Mostly used for debugging purposes
     */
    public AccountingTrackingCategoriesAddRequest withRaw(Optional<Boolean> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
     ...
     * ID of the consumer which you want to get or push data from
     */
    public AccountingTrackingCategoriesAddRequest withConsumerId(String consumerId) {
        Utils.checkNotNull(consumerId, "consumerId");
     ...
     * ID of the consumer which you want to get or push data from
     */
    public AccountingTrackingCategoriesAddRequest withConsumerId(Optional<String> consumerId) {
        Utils.checkNotNull(consumerId, "consumerId");
        this.consumerId = consumerId;
        return this;
    }
     ...
     * The ID of your Unify application
     */
    public AccountingTrackingCategoriesAddRequest withAppId(String appId) {
        Utils.checkNotNull(appId, "appId");
     ...
     * The ID of your Unify application
     */
    public AccountingTrackingCategoriesAddRequest withAppId(Optional<String> appId) {
        Utils.checkNotNull(appId, "appId");
        this.appId = appId;
        return this;
    }
     ...
     * Provide the service id you want to call (e.g., pipedrive). Only needed when a consumer has activated multiple integrations for a Unified API.
     */
    public AccountingTrackingCategoriesAddRequest withServiceId(String serviceId) {
        Utils.checkNotNull(serviceId, "serviceId");
     ...
     * Provide the service id you want to call (e.g., pipedrive). Only needed when a consumer has activated multiple integrations for a Unified API.
     */
    public AccountingTrackingCategoriesAddRequest withServiceId(Optional<String> serviceId) {
        Utils.checkNotNull(serviceId, "serviceId");
        this.serviceId = serviceId;
        return this;
    }
