...
public class AccountingTrackingCategoriesAllRequest {
     ...
     * ID of the consumer which you want to get or push data from
     */
    public AccountingTrackingCategoriesAllRequest withCustomerId(String customerId) {
        Utils.checkNotNull(customerId, "customerId");
     ...
     * ID of the consumer which you want to get or push data from
     */
    public AccountingTrackingCategoriesAllRequest withCustomerId(Optional<String> customerId) {
        Utils.checkNotNull(customerId, "customerId");
        this.customerId = customerId;
        return this;
    }
