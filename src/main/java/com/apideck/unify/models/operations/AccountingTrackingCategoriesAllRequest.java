...
public class AccountingTrackingCategoriesAllRequest {
     ...
     * overrides the default company configured in connection settings.
     */
    public AccountingTrackingCategoriesAllRequest withCompanyId(String companyId) {
        Utils.checkNotNull(companyId, "companyId");
     ...
     * overrides the default company configured in connection settings.
     */
    public AccountingTrackingCategoriesAllRequest withCompanyId(Optional<String> companyId) {
        Utils.checkNotNull(companyId, "companyId");
        this.companyId = companyId;
        return this;
    }
