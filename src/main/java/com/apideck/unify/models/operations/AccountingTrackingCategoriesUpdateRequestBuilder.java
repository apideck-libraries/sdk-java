...
public class AccountingTrackingCategoriesUpdateRequestBuilder {
    ...
    public AccountingTrackingCategoriesUpdateRequestBuilder request(@Nonnull AccountingTrackingCategoriesUpdateRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private AccountingTrackingCategoriesUpdateRequest _buildRequest() {
        return this.request;
    }
    /**
