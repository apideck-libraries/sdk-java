...
public class AtsApplicantsAllRequest {
    ...
    private Optional<? extends ApplicantsFilter> filter;
    ...
    @JsonCreator
    public AtsApplicantsAllRequest(
            ...
            Optional<Long> limit,
            Optional<? extends ApplicantsFilter> filter,
    ...
    @JsonIgnore
    public Optional<ApplicantsFilter> filter() {
        return (Optional<ApplicantsFilter>) filter;
    }
     ...
     * Include raw response. Mostly used for debugging purposes
     */
    public AtsApplicantsAllRequest withRaw(boolean raw) {
        Utils.checkNotNull(raw, "raw");
     ...
     * Include raw response. Mostly used for debugging purposes
     */
    public AtsApplicantsAllRequest withRaw(Optional<Boolean> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
     ...
     * ID of the consumer which you want to get or push data from
     */
    public AtsApplicantsAllRequest withConsumerId(String consumerId) {
        Utils.checkNotNull(consumerId, "consumerId");
     ...
     * ID of the consumer which you want to get or push data from
     */
    public AtsApplicantsAllRequest withConsumerId(Optional<String> consumerId) {
        Utils.checkNotNull(consumerId, "consumerId");
        this.consumerId = consumerId;
        return this;
    }
     ...
     * The ID of your Unify application
     */
    public AtsApplicantsAllRequest withAppId(String appId) {
        Utils.checkNotNull(appId, "appId");
     ...
     * The ID of your Unify application
     */
    public AtsApplicantsAllRequest withAppId(Optional<String> appId) {
        Utils.checkNotNull(appId, "appId");
        this.appId = appId;
        return this;
    }
     ...
     * multiple integrations for a Unified API.
     */
    public AtsApplicantsAllRequest withServiceId(String serviceId) {
        Utils.checkNotNull(serviceId, "serviceId");
     ...
     * multiple integrations for a Unified API.
     */
    public AtsApplicantsAllRequest withServiceId(Optional<String> serviceId) {
        Utils.checkNotNull(serviceId, "serviceId");
        this.serviceId = serviceId;
        return this;
    }
     ...
     * the response.
     */
    public AtsApplicantsAllRequest withCursor(String cursor) {
        Utils.checkNotNull(cursor, "cursor");
     ...
     * the response.
     */
    public AtsApplicantsAllRequest withCursor(JsonNullable<String> cursor) {
        Utils.checkNotNull(cursor, "cursor");
        this.cursor = cursor;
        return this;
    }
     ...
     * Number of results to return. Minimum 1, Maximum 200, Default 20
     */
    public AtsApplicantsAllRequest withLimit(long limit) {
        Utils.checkNotNull(limit, "limit");
     ...
     * Number of results to return. Minimum 1, Maximum 200, Default 20
     */
    public AtsApplicantsAllRequest withLimit(Optional<Long> limit) {
        Utils.checkNotNull(limit, "limit");
        this.limit = limit;
        return this;
    }
     ...
     * Apply filters
     */
    public AtsApplicantsAllRequest withFilter(ApplicantsFilter filter) {
        Utils.checkNotNull(filter, "filter");
     ...
     * Apply filters
     */
    public AtsApplicantsAllRequest withFilter(Optional<? extends ApplicantsFilter> filter) {
        Utils.checkNotNull(filter, "filter");
        this.filter = filter;
        return this;
    }
     ...
     * ?pass_through[search]=leads becomes ?search=leads
     */
    public AtsApplicantsAllRequest withPassThrough(Map<String, Object> passThrough) {
        Utils.checkNotNull(passThrough, "passThrough");
     ...
     * ?pass_through[search]=leads becomes ?search=leads
     */
    public AtsApplicantsAllRequest withPassThrough(Optional<? extends Map<String, Object>> passThrough) {
        Utils.checkNotNull(passThrough, "passThrough");
        this.passThrough = passThrough;
        return this;
    }
     ...
     * excluded.
     */
    public AtsApplicantsAllRequest withFields(String fields) {
        Utils.checkNotNull(fields, "fields");
     ...
     * excluded.
     */
    public AtsApplicantsAllRequest withFields(JsonNullable<String> fields) {
        Utils.checkNotNull(fields, "fields");
        this.fields = fields;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AtsApplicantsAllRequest other = (AtsApplicantsAllRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AtsApplicantsAllRequest.class,
                "raw", raw,
    ...
    public final static class Builder {
        ...
        private Optional<? extends ApplicantsFilter> filter = Optional.empty();
         ...
         * Apply filters
         */
        public Builder filter(ApplicantsFilter filter) {
            Utils.checkNotNull(filter, "filter");
            this.filter = Optional.ofNullable(filter);
            return this;
        }
         ...
         * Apply filters
         */
        public Builder filter(Optional<? extends ApplicantsFilter> filter) {
            Utils.checkNotNull(filter, "filter");
            this.filter = filter;
            return this;
        }
        ...
        public AtsApplicantsAllRequest build() {
            if (raw == null) {
            ...
            return new AtsApplicantsAllRequest(
                raw, consumerId, appId,
                serviceId, cursor, limit,
                filter, passThrough, fields);
        }
