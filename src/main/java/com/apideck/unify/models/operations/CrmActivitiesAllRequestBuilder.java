...
public class CrmActivitiesAllRequestBuilder {
    ...
    public CrmActivitiesAllResponse call() throws Exception {
    ...
    * <pre><code>
    * for (CrmActivitiesAllResponse page : builder.callAsIterable()) {
    *     // Process each page
    * }
    * </code></pre>
    * 
    ...
    */
    public Iterable<CrmActivitiesAllResponse> callAsIterable() {
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
     ...
     * are returned.
     **/  
    public Stream<CrmActivitiesAllResponse> callAsStream() {
