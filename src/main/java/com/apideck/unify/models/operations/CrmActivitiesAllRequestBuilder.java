...
public class CrmActivitiesAllRequestBuilder {
    ...
    private final SDKMethodInterfaces.MethodCallCrmActivitiesAll sdk;

    public CrmActivitiesAllRequestBuilder(SDKMethodInterfaces.MethodCallCrmActivitiesAll sdk) {
        this.sdk = sdk;
    }
