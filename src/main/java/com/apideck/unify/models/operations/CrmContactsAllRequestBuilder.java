...
public class CrmContactsAllRequestBuilder {
    ...
    public CrmContactsAllRequestBuilder request(@Nonnull CrmContactsAllRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private CrmContactsAllRequest _buildRequest() {
        return this.request;
    }
    /**
    ...
    * <pre><code>
    * for (CrmContactsAllResponse page : builder.callAsIterable()) {
    *     // Process each page
    * }
    * </code></pre>
    * 
    ...
    */
    public Iterable<CrmContactsAllResponse> callAsIterable() {
    ...
    * are returned.
    **/  
    public Stream<CrmContactsAllResponse> callAsStream() {
