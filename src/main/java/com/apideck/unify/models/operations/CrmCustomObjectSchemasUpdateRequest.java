...
public class CrmCustomObjectSchemasUpdateRequest {
     ...
     * ID of the record you are acting upon.
     */
    public CrmCustomObjectSchemasUpdateRequest withId(@Nonnull String id) {
     ...
     * ID of the consumer which you want to get or push data from
     */
    public CrmCustomObjectSchemasUpdateRequest withConsumerId(@Nullable String consumerId) {
        this.consumerId = consumerId;
        return this;
    }
     ...
     * The ID of your Unify application
     */
    public CrmCustomObjectSchemasUpdateRequest withAppId(@Nullable String appId) {
        this.appId = appId;
        return this;
    }
     ...
     * Provide the service id you want to call (e.g., pipedrive). Only needed when a consumer has activated multiple integrations for a Unified API.
     */
    public CrmCustomObjectSchemasUpdateRequest withServiceId(@Nullable String serviceId) {
        this.serviceId = serviceId;
        return this;
    }
     ...
     * Include raw response. Mostly used for debugging purposes
     */
    public CrmCustomObjectSchemasUpdateRequest withRaw(@Nullable Boolean raw) {
        this.raw = raw;
        return this;
    }


    public CrmCustomObjectSchemasUpdateRequest withCustomObjectSchema(@Nonnull CustomObjectSchemaInput customObjectSchema) {
