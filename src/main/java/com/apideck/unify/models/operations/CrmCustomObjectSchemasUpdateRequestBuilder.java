...
public class CrmCustomObjectSchemasUpdateRequestBuilder {
    ...
    public CrmCustomObjectSchemasUpdateRequestBuilder request(@Nonnull CrmCustomObjectSchemasUpdateRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private CrmCustomObjectSchemasUpdateRequest _buildRequest() {
        return this.request;
    }
    /**
