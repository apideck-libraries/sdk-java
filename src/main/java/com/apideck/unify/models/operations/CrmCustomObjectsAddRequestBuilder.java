...
public class CrmCustomObjectsAddRequestBuilder {
    ...
    private final SDKMethodInterfaces.MethodCallCrmCustomObjectsAdd sdk;

    public CrmCustomObjectsAddRequestBuilder(SDKMethodInterfaces.MethodCallCrmCustomObjectsAdd sdk) {
        this.sdk = sdk;
    }
