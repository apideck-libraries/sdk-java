...
public class CrmCustomObjectsAllRequestBuilder {
    ...
    private final SDKMethodInterfaces.MethodCallCrmCustomObjectsAll sdk;

    public CrmCustomObjectsAllRequestBuilder(SDKMethodInterfaces.MethodCallCrmCustomObjectsAll sdk) {
        this.sdk = sdk;
    }
