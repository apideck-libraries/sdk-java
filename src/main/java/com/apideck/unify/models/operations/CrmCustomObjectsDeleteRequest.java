...
public class CrmCustomObjectsDeleteRequest {
     ...
     * ID of the record you are acting upon.
     */
    public CrmCustomObjectsDeleteRequest withId(@Nonnull String id) {
     ...
     * ID of the consumer which you want to get or push data from
     */
    public CrmCustomObjectsDeleteRequest withConsumerId(@Nullable String consumerId) {
        this.consumerId = consumerId;
        return this;
    }
     ...
     * The ID of your Unify application
     */
    public CrmCustomObjectsDeleteRequest withAppId(@Nullable String appId) {
        this.appId = appId;
        return this;
    }
     ...
     * Provide the service id you want to call (e.g., pipedrive). Only needed when a consumer has activated multiple integrations for a Unified API.
     */
    public CrmCustomObjectsDeleteRequest withServiceId(@Nullable String serviceId) {
        this.serviceId = serviceId;
        return this;
    }
     ...
     * Include raw response. Mostly used for debugging purposes
     */
    public CrmCustomObjectsDeleteRequest withRaw(@Nullable Boolean raw) {
        this.raw = raw;
        return this;
    }
     ...
     * The id of the custom object to query
     */
    public CrmCustomObjectsDeleteRequest withObjectId(@Nonnull String objectId) {
