...
public class CrmListsAllRequestBuilder {
    ...
    public CrmListsAllResponse call() {
    ...
    * <pre><code>
    * for (CrmListsAllResponse page : builder.callAsIterable()) {
    *     // Process each page
    * }
    * </code></pre>
    * 
    ...
    */
    public Iterable<CrmListsAllResponse> callAsIterable() {
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
     ...
     * are returned.
     **/  
    public Stream<CrmListsAllResponse> callAsStream() {
