...
public class CrmOpportunitiesAllRequestBuilder {
    ...
    public CrmOpportunitiesAllResponse call() throws Exception {
        ...
        RequestOperation<CrmOpportunitiesAllRequest, CrmOpportunitiesAllResponse> operation
              = new CrmOpportunitiesAllOperation(sdkConfiguration, options);
    ...
    * <pre><code>
    * for (CrmOpportunitiesAllResponse page : builder.callAsIterable()) {
    *     // Process each page
    * }
    * </code></pre>
    * 
    ...
    */
    public Iterable<CrmOpportunitiesAllResponse> callAsIterable() {
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
     ...
     * are returned.
     **/  
    public Stream<CrmOpportunitiesAllResponse> callAsStream() {
