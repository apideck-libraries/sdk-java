...
public class CrmPipelinesAllResponse implements Response {
     ...
     * Pipelines
     */
    private GetPipelinesResponse getPipelinesResponse;
    ...
    public CrmPipelinesAllResponse(
            ...
            @Nullable GetPipelinesResponse getPipelinesResponse,
    ...
    public Optional<GetPipelinesResponse> getPipelinesResponse() {
        return Optional.ofNullable(this.getPipelinesResponse);
    }
     ...
     * HTTP response content type for this operation
     */
    public CrmPipelinesAllResponse withContentType(@Nonnull String contentType) {
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public CrmPipelinesAllResponse withRawResponse(@Nonnull HttpResponse<InputStream> rawResponse) {
     ...
     * Pipelines
     */
    public CrmPipelinesAllResponse withGetPipelinesResponse(@Nullable GetPipelinesResponse getPipelinesResponse) {
        this.getPipelinesResponse = getPipelinesResponse;
        return this;
    }
     ...
     * Unexpected error
     */
    public CrmPipelinesAllResponse withUnexpectedErrorResponse(@Nullable UnexpectedErrorResponse unexpectedErrorResponse) {
        this.unexpectedErrorResponse = unexpectedErrorResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return 
            ...
            Utils.enhancedDeepEquals(this.getPipelinesResponse, other.getPipelinesResponse) &&
    ...
    public int hashCode() {
        return Utils.enhancedHash(
            ...
            getPipelinesResponse, unexpectedErrorResponse);
    }
    ...
    public final static class Builder {
         ...
         * Pipelines
         */
        public Builder getPipelinesResponse(@Nullable GetPipelinesResponse getPipelinesResponse) {
            this.getPipelinesResponse = getPipelinesResponse;
            return this;
        }
