...
public class CrmUsersAllRequest {
    ...
    private Optional<? extends UsersFilter> filter;
    ...
    public CrmUsersAllRequest(
            ...
            Optional<Long> limit,
            Optional<? extends UsersFilter> filter,
    ...
    @JsonIgnore
    public Optional<UsersFilter> filter() {
        return (Optional<UsersFilter>) filter;
    }
     ...
     * Include raw response. Mostly used for debugging purposes
     */
    public CrmUsersAllRequest withRaw(boolean raw) {
        Utils.checkNotNull(raw, "raw");
     ...
     * Include raw response. Mostly used for debugging purposes
     */
    public CrmUsersAllRequest withRaw(Optional<Boolean> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
     ...
     * ID of the consumer which you want to get or push data from
     */
    public CrmUsersAllRequest withConsumerId(String consumerId) {
        Utils.checkNotNull(consumerId, "consumerId");
     ...
     * ID of the consumer which you want to get or push data from
     */
    public CrmUsersAllRequest withConsumerId(Optional<String> consumerId) {
        Utils.checkNotNull(consumerId, "consumerId");
        this.consumerId = consumerId;
        return this;
    }
     ...
     * The ID of your Unify application
     */
    public CrmUsersAllRequest withAppId(String appId) {
        Utils.checkNotNull(appId, "appId");
     ...
     * The ID of your Unify application
     */
    public CrmUsersAllRequest withAppId(Optional<String> appId) {
        Utils.checkNotNull(appId, "appId");
        this.appId = appId;
        return this;
    }
     ...
     * multiple integrations for a Unified API.
     */
    public CrmUsersAllRequest withServiceId(String serviceId) {
        Utils.checkNotNull(serviceId, "serviceId");
     ...
     * multiple integrations for a Unified API.
     */
    public CrmUsersAllRequest withServiceId(Optional<String> serviceId) {
        Utils.checkNotNull(serviceId, "serviceId");
        this.serviceId = serviceId;
        return this;
    }
     ...
     * the response.
     */
    public CrmUsersAllRequest withCursor(String cursor) {
        Utils.checkNotNull(cursor, "cursor");
     ...
     * the response.
     */
    public CrmUsersAllRequest withCursor(JsonNullable<String> cursor) {
        Utils.checkNotNull(cursor, "cursor");
        this.cursor = cursor;
        return this;
    }
     ...
     * Number of results to return. Minimum 1, Maximum 200, Default 20
     */
    public CrmUsersAllRequest withLimit(long limit) {
        Utils.checkNotNull(limit, "limit");
     ...
     * Number of results to return. Minimum 1, Maximum 200, Default 20
     */
    public CrmUsersAllRequest withLimit(Optional<Long> limit) {
        Utils.checkNotNull(limit, "limit");
        this.limit = limit;
        return this;
    }
     ...
     * Apply filters
     */
    public CrmUsersAllRequest withFilter(UsersFilter filter) {
        Utils.checkNotNull(filter, "filter");
     ...
     * Apply filters
     */
    public CrmUsersAllRequest withFilter(Optional<? extends UsersFilter> filter) {
        Utils.checkNotNull(filter, "filter");
        this.filter = filter;
        return this;
    }
     ...
     * ?pass_through[search]=leads becomes ?search=leads
     */
    public CrmUsersAllRequest withPassThrough(Map<String, Object> passThrough) {
        Utils.checkNotNull(passThrough, "passThrough");
     ...
     * ?pass_through[search]=leads becomes ?search=leads
     */
    public CrmUsersAllRequest withPassThrough(Optional<? extends Map<String, Object>> passThrough) {
        Utils.checkNotNull(passThrough, "passThrough");
        this.passThrough = passThrough;
        return this;
    }
     ...
     * excluded.
     */
    public CrmUsersAllRequest withFields(String fields) {
        Utils.checkNotNull(fields, "fields");
     ...
     * excluded.
     */
    public CrmUsersAllRequest withFields(JsonNullable<String> fields) {
        Utils.checkNotNull(fields, "fields");
        this.fields = fields;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CrmUsersAllRequest other = (CrmUsersAllRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CrmUsersAllRequest.class,
                "raw", raw,
    ...
    public final static class Builder {
        ...
        private Optional<? extends UsersFilter> filter = Optional.empty();
         ...
         * Apply filters
         */
        public Builder filter(UsersFilter filter) {
            Utils.checkNotNull(filter, "filter");
            this.filter = Optional.ofNullable(filter);
            return this;
        }
         ...
         * Apply filters
         */
        public Builder filter(Optional<? extends UsersFilter> filter) {
            Utils.checkNotNull(filter, "filter");
            this.filter = filter;
            return this;
        }
        ...
        public CrmUsersAllRequest build() {
            if (raw == null) {
