...
public class EcommerceCustomersAllResponse implements Response {
    ...
    private Callable<Optional<EcommerceCustomersAllResponse>> next = () -> Optional.empty();
    ...
    public Optional<EcommerceCustomersAllResponse> next() throws Exception {
        return this.next.call();
    }
    
    // internal use only
    private EcommerceCustomersAllResponse withNext(Callable<Optional<EcommerceCustomersAllResponse>> next) {
        this.next = next;
        return this;
    }
    ...
    public final static class Builder {
        private Callable<Optional<EcommerceCustomersAllResponse>> next;
         ...
         */
        @Deprecated
        public Builder next(Callable<Optional<EcommerceCustomersAllResponse>> next) {
