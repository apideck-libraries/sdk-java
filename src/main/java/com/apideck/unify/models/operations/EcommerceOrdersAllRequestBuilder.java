...
public class EcommerceOrdersAllRequestBuilder {
    ...
    public EcommerceOrdersAllRequestBuilder request(@Nonnull EcommerceOrdersAllRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private EcommerceOrdersAllRequest _buildRequest() {
        return this.request;
    }
    /**
    ...
    * <pre><code>
    * for (EcommerceOrdersAllResponse page : builder.callAsIterable()) {
    *     // Process each page
    * }
    * </code></pre>
    * 
    ...
    */
    public Iterable<EcommerceOrdersAllResponse> callAsIterable() {
