...
public class EcommerceProductsAllRequestBuilder {
    ...
    private final SDKMethodInterfaces.MethodCallEcommerceProductsAll sdk;

    public EcommerceProductsAllRequestBuilder(SDKMethodInterfaces.MethodCallEcommerceProductsAll sdk) {
        this.sdk = sdk;
    }
