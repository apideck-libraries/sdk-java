...
public class FileStorageDriveGroupsAddResponse implements Response {
     ...
     * DriveGroups
     */
    private CreateDriveGroupResponse createDriveGroupResponse;
    ...
    public FileStorageDriveGroupsAddResponse(
            ...
            @Nullable CreateDriveGroupResponse createDriveGroupResponse,
    ...
    public Optional<CreateDriveGroupResponse> createDriveGroupResponse() {
        return Optional.ofNullable(this.createDriveGroupResponse);
    }
     ...
     * HTTP response content type for this operation
     */
    public FileStorageDriveGroupsAddResponse withContentType(@Nonnull String contentType) {
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public FileStorageDriveGroupsAddResponse withRawResponse(@Nonnull HttpResponse<InputStream> rawResponse) {
     ...
     * DriveGroups
     */
    public FileStorageDriveGroupsAddResponse withCreateDriveGroupResponse(@Nullable CreateDriveGroupResponse createDriveGroupResponse) {
        this.createDriveGroupResponse = createDriveGroupResponse;
        return this;
    }
     ...
     * Unexpected error
     */
    public FileStorageDriveGroupsAddResponse withUnexpectedErrorResponse(@Nullable UnexpectedErrorResponse unexpectedErrorResponse) {
        this.unexpectedErrorResponse = unexpectedErrorResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return 
            ...
            Utils.enhancedDeepEquals(this.createDriveGroupResponse, other.createDriveGroupResponse) &&
    ...
    public final static class Builder {
         ...
         * DriveGroups
         */
        public Builder createDriveGroupResponse(@Nullable CreateDriveGroupResponse createDriveGroupResponse) {
            this.createDriveGroupResponse = createDriveGroupResponse;
            return this;
        }
