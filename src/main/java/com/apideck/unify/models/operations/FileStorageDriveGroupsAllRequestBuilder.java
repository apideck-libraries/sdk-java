...
public class FileStorageDriveGroupsAllRequestBuilder {
    ...
    public FileStorageDriveGroupsAllRequestBuilder request(@Nonnull FileStorageDriveGroupsAllRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private FileStorageDriveGroupsAllRequest _buildRequest() {
        return this.request;
    }
    /**
    ...
    * <pre><code>
    * for (FileStorageDriveGroupsAllResponse page : builder.callAsIterable()) {
    *     // Process each page
    * }
    * </code></pre>
    * 
    ...
    */
    public Iterable<FileStorageDriveGroupsAllResponse> callAsIterable() {
