...
public class FileStorageDrivesAllRequestBuilder {
    ...
    public FileStorageDrivesAllRequestBuilder request(@Nonnull FileStorageDrivesAllRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private FileStorageDrivesAllRequest _buildRequest() {
        return this.request;
    }
    /**
    ...
    * <pre><code>
    * for (FileStorageDrivesAllResponse page : builder.callAsIterable()) {
    *     // Process each page
    * }
    * </code></pre>
    * 
    ...
    */
    public Iterable<FileStorageDrivesAllResponse> callAsIterable() {
    ...
    * are returned.
    **/  
    public Stream<FileStorageDrivesAllResponse> callAsStream() {
