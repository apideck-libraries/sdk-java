...
public class FileStorageSharedLinksAddRequest {
     ...
     * Include raw response. Mostly used for debugging purposes
     */
    public FileStorageSharedLinksAddRequest withRaw(@Nullable Boolean raw) {
        this.raw = raw;
        return this;
    }
     ...
     * ID of the consumer which you want to get or push data from
     */
    public FileStorageSharedLinksAddRequest withConsumerId(@Nullable String consumerId) {
        this.consumerId = consumerId;
        return this;
    }
     ...
     * The ID of your Unify application
     */
    public FileStorageSharedLinksAddRequest withAppId(@Nullable String appId) {
        this.appId = appId;
        return this;
    }
     ...
     * Provide the service id you want to call (e.g., pipedrive). Only needed when a consumer has activated multiple integrations for a Unified API.
     */
    public FileStorageSharedLinksAddRequest withServiceId(@Nullable String serviceId) {
        this.serviceId = serviceId;
        return this;
    }


    public FileStorageSharedLinksAddRequest withSharedLink(@Nonnull SharedLinkInput sharedLink) {
