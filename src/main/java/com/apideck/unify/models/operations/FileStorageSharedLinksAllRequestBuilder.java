...
public class FileStorageSharedLinksAllRequestBuilder {
    ...
    public FileStorageSharedLinksAllRequestBuilder request(@Nonnull FileStorageSharedLinksAllRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private FileStorageSharedLinksAllRequest _buildRequest() {
        return this.request;
    }
    /**
    ...
    * <pre><code>
    * for (FileStorageSharedLinksAllResponse page : builder.callAsIterable()) {
    *     // Process each page
    * }
    * </code></pre>
    * 
    ...
    */
    public Iterable<FileStorageSharedLinksAllResponse> callAsIterable() {
    ...
    * are returned.
    **/  
    public Stream<FileStorageSharedLinksAllResponse> callAsStream() {
