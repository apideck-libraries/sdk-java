...
public class FileStorageSharedLinksAllResponse implements Response {
     ...
     * Shared Links
     */
    private GetSharedLinksResponse getSharedLinksResponse;
    ...
    public FileStorageSharedLinksAllResponse(
            ...
            @Nullable GetSharedLinksResponse getSharedLinksResponse,
    ...
    public Optional<GetSharedLinksResponse> getSharedLinksResponse() {
        return Optional.ofNullable(this.getSharedLinksResponse);
    }
     ...
     * HTTP response content type for this operation
     */
    public FileStorageSharedLinksAllResponse withContentType(@Nonnull String contentType) {
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public FileStorageSharedLinksAllResponse withRawResponse(@Nonnull HttpResponse<InputStream> rawResponse) {
     ...
     * Shared Links
     */
    public FileStorageSharedLinksAllResponse withGetSharedLinksResponse(@Nullable GetSharedLinksResponse getSharedLinksResponse) {
        this.getSharedLinksResponse = getSharedLinksResponse;
        return this;
    }
     ...
     * Unexpected error
     */
    public FileStorageSharedLinksAllResponse withUnexpectedErrorResponse(@Nullable UnexpectedErrorResponse unexpectedErrorResponse) {
        this.unexpectedErrorResponse = unexpectedErrorResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return 
            ...
            Utils.enhancedDeepEquals(this.getSharedLinksResponse, other.getSharedLinksResponse) &&
    ...
    public int hashCode() {
        return Utils.enhancedHash(
            ...
            getSharedLinksResponse, unexpectedErrorResponse);
    }
    ...
    public final static class Builder {
         ...
         * Shared Links
         */
        public Builder getSharedLinksResponse(@Nullable GetSharedLinksResponse getSharedLinksResponse) {
            this.getSharedLinksResponse = getSharedLinksResponse;
            return this;
        }
