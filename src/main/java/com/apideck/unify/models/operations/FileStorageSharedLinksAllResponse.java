...
public class FileStorageSharedLinksAllResponse implements Response {
    ...
    private Callable<Optional<FileStorageSharedLinksAllResponse>> next = () -> Optional.empty();
    ...
    public Optional<FileStorageSharedLinksAllResponse> next() throws Exception {
        return this.next.call();
    }
    
    // internal use only
    private FileStorageSharedLinksAllResponse withNext(Callable<Optional<FileStorageSharedLinksAllResponse>> next) {
        this.next = next;
        return this;
    }
    ...
    public final static class Builder {
        private Callable<Optional<FileStorageSharedLinksAllResponse>> next;
         ...
         */
        @Deprecated
        public Builder next(Callable<Optional<FileStorageSharedLinksAllResponse>> next) {
