...
public class FileStorageSharedLinksOneRequestBuilder {
    ...
    public FileStorageSharedLinksOneRequestBuilder request(@Nonnull FileStorageSharedLinksOneRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private FileStorageSharedLinksOneRequest _buildRequest() {
        return this.request;
    }
    /**
