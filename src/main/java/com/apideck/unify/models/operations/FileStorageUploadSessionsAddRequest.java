...
public class FileStorageUploadSessionsAddRequest {
    ...
    public FileStorageUploadSessionsAddRequest(
            ...
            @Nonnull CreateUploadSessionRequest createUploadSessionRequest) {
        this.raw = Optional.ofNullable(raw)
            .orElse(Builder._SINGLETON_VALUE_Raw.value());
        this.consumerId = consumerId;
        this.appId = appId;
        this.serviceId = serviceId;
        this.createUploadSessionRequest = Optional.ofNullable(createUploadSessionRequest)
            .orElseThrow(() -> new IllegalArgumentException("createUploadSessionRequest cannot be null"));
    }
    
    public FileStorageUploadSessionsAddRequest(
            @Nonnull CreateUploadSessionRequest createUploadSessionRequest) {
        this(null, null, null,
            null, createUploadSessionRequest);
    }
    ...
    public CreateUploadSessionRequest createUploadSessionRequest() {
        return this.createUploadSessionRequest;
    }
     ...
     * Include raw response. Mostly used for debugging purposes
     */
    public FileStorageUploadSessionsAddRequest withRaw(@Nullable Boolean raw) {
        this.raw = raw;
        return this;
    }
     ...
     * ID of the consumer which you want to get or push data from
     */
    public FileStorageUploadSessionsAddRequest withConsumerId(@Nullable String consumerId) {
        this.consumerId = consumerId;
        return this;
    }
     ...
     * The ID of your Unify application
     */
    public FileStorageUploadSessionsAddRequest withAppId(@Nullable String appId) {
        this.appId = appId;
        return this;
    }
     ...
     * Provide the service id you want to call (e.g., pipedrive). Only needed when a consumer has activated multiple integrations for a Unified API.
     */
    public FileStorageUploadSessionsAddRequest withServiceId(@Nullable String serviceId) {
        this.serviceId = serviceId;
        return this;
    }


    public FileStorageUploadSessionsAddRequest withCreateUploadSessionRequest(@Nonnull CreateUploadSessionRequest createUploadSessionRequest) {
        this.createUploadSessionRequest = Utils.checkNotNull(createUploadSessionRequest, "createUploadSessionRequest");
        return this;
    }
    ...
    public final static class Builder {
        ...
        public Builder createUploadSessionRequest(@Nonnull CreateUploadSessionRequest createUploadSessionRequest) {
            this.createUploadSessionRequest = Utils.checkNotNull(createUploadSessionRequest, "createUploadSessionRequest");
            return this;
        }
