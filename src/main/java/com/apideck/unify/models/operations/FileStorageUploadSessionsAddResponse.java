...
public class FileStorageUploadSessionsAddResponse implements Response {
     ...
     * UploadSessions
     */
    private CreateUploadSessionResponse createUploadSessionResponse;
    ...
    public FileStorageUploadSessionsAddResponse(
            ...
            @Nullable CreateUploadSessionResponse createUploadSessionResponse,
    ...
    public Optional<CreateUploadSessionResponse> createUploadSessionResponse() {
        return Optional.ofNullable(this.createUploadSessionResponse);
    }
     ...
     * HTTP response content type for this operation
     */
    public FileStorageUploadSessionsAddResponse withContentType(@Nonnull String contentType) {
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public FileStorageUploadSessionsAddResponse withRawResponse(@Nonnull HttpResponse<InputStream> rawResponse) {
     ...
     * UploadSessions
     */
    public FileStorageUploadSessionsAddResponse withCreateUploadSessionResponse(@Nullable CreateUploadSessionResponse createUploadSessionResponse) {
        this.createUploadSessionResponse = createUploadSessionResponse;
        return this;
    }
     ...
     * Unexpected error
     */
    public FileStorageUploadSessionsAddResponse withUnexpectedErrorResponse(@Nullable UnexpectedErrorResponse unexpectedErrorResponse) {
        this.unexpectedErrorResponse = unexpectedErrorResponse;
        return this;
    }
    ...
    public final static class Builder {
         ...
         * UploadSessions
         */
        public Builder createUploadSessionResponse(@Nullable CreateUploadSessionResponse createUploadSessionResponse) {
            this.createUploadSessionResponse = createUploadSessionResponse;
            return this;
        }
