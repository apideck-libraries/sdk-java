...
public class HrisCompaniesAll2Response implements Response {
    /**
    ...
    @JsonCreator
    public HrisCompaniesAll2Response(
            String contentType,
            int statusCode,
     ...
     * HTTP response content type for this operation
     */
    public HrisCompaniesAll2Response withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public HrisCompaniesAll2Response withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public HrisCompaniesAll2Response withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * Companies
     */
    public HrisCompaniesAll2Response withGetHrisCompaniesResponse(GetHrisCompaniesResponse getHrisCompaniesResponse) {
        Utils.checkNotNull(getHrisCompaniesResponse, "getHrisCompaniesResponse");
     ...
     * Companies
     */
    public HrisCompaniesAll2Response withGetHrisCompaniesResponse(Optional<? extends GetHrisCompaniesResponse> getHrisCompaniesResponse) {
        Utils.checkNotNull(getHrisCompaniesResponse, "getHrisCompaniesResponse");
        this.getHrisCompaniesResponse = getHrisCompaniesResponse;
        return this;
    }
     ...
     * Unexpected error
     */
    public HrisCompaniesAll2Response withUnexpectedErrorResponse(UnexpectedErrorResponse unexpectedErrorResponse) {
        Utils.checkNotNull(unexpectedErrorResponse, "unexpectedErrorResponse");
     ...
     * Unexpected error
     */
    public HrisCompaniesAll2Response withUnexpectedErrorResponse(Optional<? extends UnexpectedErrorResponse> unexpectedErrorResponse) {
        Utils.checkNotNull(unexpectedErrorResponse, "unexpectedErrorResponse");
        this.unexpectedErrorResponse = unexpectedErrorResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        HrisCompaniesAll2Response other = (HrisCompaniesAll2Response) o;
        return 
    ...
    public String toString() {
        return Utils.toString(HrisCompaniesAll2Response.class,
    ...
    public final static class Builder {
        ...
        public HrisCompaniesAll2Response build() {

            return new HrisCompaniesAll2Response(
                contentType, statusCode, rawResponse,
                getHrisCompaniesResponse, unexpectedErrorResponse);
        }
