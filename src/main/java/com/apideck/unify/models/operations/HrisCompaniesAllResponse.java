...
public class HrisCompaniesAllResponse implements Response {
     ...
     * Companies
     */
    private GetHrisCompaniesResponse getHrisCompaniesResponse;
    ...
    public HrisCompaniesAllResponse(
            ...
            @Nullable GetHrisCompaniesResponse getHrisCompaniesResponse,
    ...
    public Optional<GetHrisCompaniesResponse> getHrisCompaniesResponse() {
        return Optional.ofNullable(this.getHrisCompaniesResponse);
    }
     ...
     * HTTP response content type for this operation
     */
    public HrisCompaniesAllResponse withContentType(@Nonnull String contentType) {
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public HrisCompaniesAllResponse withRawResponse(@Nonnull HttpResponse<InputStream> rawResponse) {
     ...
     * Companies
     */
    public HrisCompaniesAllResponse withGetHrisCompaniesResponse(@Nullable GetHrisCompaniesResponse getHrisCompaniesResponse) {
        this.getHrisCompaniesResponse = getHrisCompaniesResponse;
        return this;
    }
     ...
     * Unexpected error
     */
    public HrisCompaniesAllResponse withUnexpectedErrorResponse(@Nullable UnexpectedErrorResponse unexpectedErrorResponse) {
        this.unexpectedErrorResponse = unexpectedErrorResponse;
        return this;
    }
    ...
    public final static class Builder {
         ...
         * Companies
         */
        public Builder getHrisCompaniesResponse(@Nullable GetHrisCompaniesResponse getHrisCompaniesResponse) {
            this.getHrisCompaniesResponse = getHrisCompaniesResponse;
            return this;
        }
