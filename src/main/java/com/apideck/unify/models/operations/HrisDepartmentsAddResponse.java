...
public class HrisDepartmentsAddResponse implements Response {
     ...
     * Departments
     */
    private CreateDepartmentResponse createDepartmentResponse;
    ...
    public HrisDepartmentsAddResponse(
            ...
            @Nullable CreateDepartmentResponse createDepartmentResponse,
    ...
    public Optional<CreateDepartmentResponse> createDepartmentResponse() {
        return Optional.ofNullable(this.createDepartmentResponse);
    }
     ...
     * HTTP response content type for this operation
     */
    public HrisDepartmentsAddResponse withContentType(@Nonnull String contentType) {
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public HrisDepartmentsAddResponse withRawResponse(@Nonnull HttpResponse<InputStream> rawResponse) {
     ...
     * Departments
     */
    public HrisDepartmentsAddResponse withCreateDepartmentResponse(@Nullable CreateDepartmentResponse createDepartmentResponse) {
        this.createDepartmentResponse = createDepartmentResponse;
        return this;
    }
     ...
     * Unexpected error
     */
    public HrisDepartmentsAddResponse withUnexpectedErrorResponse(@Nullable UnexpectedErrorResponse unexpectedErrorResponse) {
        this.unexpectedErrorResponse = unexpectedErrorResponse;
        return this;
    }
    ...
    public final static class Builder {
         ...
         * Departments
         */
        public Builder createDepartmentResponse(@Nullable CreateDepartmentResponse createDepartmentResponse) {
            this.createDepartmentResponse = createDepartmentResponse;
            return this;
        }
