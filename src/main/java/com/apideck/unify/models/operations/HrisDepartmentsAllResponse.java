...
public class HrisDepartmentsAllResponse implements Response {
     ...
     * Departments
     */
    private GetDepartmentsResponse getDepartmentsResponse;
    ...
    public HrisDepartmentsAllResponse(
            ...
            @Nullable GetDepartmentsResponse getDepartmentsResponse,
    ...
    public Optional<GetDepartmentsResponse> getDepartmentsResponse() {
        return Optional.ofNullable(this.getDepartmentsResponse);
    }
     ...
     * HTTP response content type for this operation
     */
    public HrisDepartmentsAllResponse withContentType(@Nonnull String contentType) {
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public HrisDepartmentsAllResponse withRawResponse(@Nonnull HttpResponse<InputStream> rawResponse) {
     ...
     * Departments
     */
    public HrisDepartmentsAllResponse withGetDepartmentsResponse(@Nullable GetDepartmentsResponse getDepartmentsResponse) {
        this.getDepartmentsResponse = getDepartmentsResponse;
        return this;
    }
     ...
     * Unexpected error
     */
    public HrisDepartmentsAllResponse withUnexpectedErrorResponse(@Nullable UnexpectedErrorResponse unexpectedErrorResponse) {
        this.unexpectedErrorResponse = unexpectedErrorResponse;
        return this;
    }
    ...
    public final static class Builder {
         ...
         * Departments
         */
        public Builder getDepartmentsResponse(@Nullable GetDepartmentsResponse getDepartmentsResponse) {
            this.getDepartmentsResponse = getDepartmentsResponse;
            return this;
        }
