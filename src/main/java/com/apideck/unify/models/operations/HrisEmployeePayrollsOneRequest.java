...
public class HrisEmployeePayrollsOneRequest {
    ...
    public HrisEmployeePayrollsOneRequest(
            String payrollId,
            String employeeId) {
        this(payrollId, employeeId, Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), JsonNullable.undefined());
    }
     ...
     * ID of the consumer which you want to get or push data from
     */
    public HrisEmployeePayrollsOneRequest withCustomerId(String customerId) {
        Utils.checkNotNull(customerId, "customerId");
     ...
     * ID of the consumer which you want to get or push data from
     */
    public HrisEmployeePayrollsOneRequest withCustomerId(Optional<String> customerId) {
        Utils.checkNotNull(customerId, "customerId");
        this.customerId = customerId;
        return this;
    }
