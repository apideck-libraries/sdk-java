...
public class HrisEmployeesAllRequestBuilder {
    ...
    public HrisEmployeesAllRequestBuilder request(@Nonnull HrisEmployeesAllRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private HrisEmployeesAllRequest _buildRequest() {
        return this.request;
    }
    /**
    ...
    * <pre><code>
    * for (HrisEmployeesAllResponse page : builder.callAsIterable()) {
    *     // Process each page
    * }
    * </code></pre>
    * 
    ...
    */
    public Iterable<HrisEmployeesAllResponse> callAsIterable() {
