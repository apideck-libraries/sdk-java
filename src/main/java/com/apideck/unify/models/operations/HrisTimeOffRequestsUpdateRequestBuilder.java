...
public class HrisTimeOffRequestsUpdateRequestBuilder {
    ...
    public HrisTimeOffRequestsUpdateRequestBuilder request(@Nonnull HrisTimeOffRequestsUpdateRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private HrisTimeOffRequestsUpdateRequest _buildRequest() {
        return this.request;
    }
    /**
