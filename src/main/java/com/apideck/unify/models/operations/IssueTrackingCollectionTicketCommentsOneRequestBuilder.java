...
public class IssueTrackingCollectionTicketCommentsOneRequestBuilder {
    ...
    private final SDKMethodInterfaces.MethodCallIssueTrackingCollectionTicketCommentsOne sdk;

    public IssueTrackingCollectionTicketCommentsOneRequestBuilder(SDKMethodInterfaces.MethodCallIssueTrackingCollectionTicketCommentsOne sdk) {
        this.sdk = sdk;
    }
