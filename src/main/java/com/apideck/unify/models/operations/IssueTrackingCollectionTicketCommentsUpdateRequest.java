...
public class IssueTrackingCollectionTicketCommentsUpdateRequest {
    ...
    public IssueTrackingCollectionTicketCommentsUpdateRequest(
            ...
            String ticketId,
            CollectionTicketCommentInput collectionTicketComment) {
        this(id, Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), collectionId, ticketId, collectionTicketComment);
    }
     ...
     * ID of the record you are acting upon.
     */
    public IssueTrackingCollectionTicketCommentsUpdateRequest withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * The ID of your Unify application
     */
    public IssueTrackingCollectionTicketCommentsUpdateRequest withAppId(String appId) {
        Utils.checkNotNull(appId, "appId");
     ...
     * The ID of your Unify application
     */
    public IssueTrackingCollectionTicketCommentsUpdateRequest withAppId(Optional<String> appId) {
        Utils.checkNotNull(appId, "appId");
        this.appId = appId;
        return this;
    }
     ...
     * Provide the service id you want to call (e.g., pipedrive). Only needed when a consumer has activated multiple integrations for a Unified API.
     */
    public IssueTrackingCollectionTicketCommentsUpdateRequest withServiceId(String serviceId) {
        Utils.checkNotNull(serviceId, "serviceId");
     ...
     * Provide the service id you want to call (e.g., pipedrive). Only needed when a consumer has activated multiple integrations for a Unified API.
     */
    public IssueTrackingCollectionTicketCommentsUpdateRequest withServiceId(Optional<String> serviceId) {
        Utils.checkNotNull(serviceId, "serviceId");
        this.serviceId = serviceId;
        return this;
    }
     ...
     * Include raw response. Mostly used for debugging purposes
     */
    public IssueTrackingCollectionTicketCommentsUpdateRequest withRaw(boolean raw) {
        Utils.checkNotNull(raw, "raw");
     ...
     * Include raw response. Mostly used for debugging purposes
     */
    public IssueTrackingCollectionTicketCommentsUpdateRequest withRaw(Optional<Boolean> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
     ...
     * The collection ID
     */
    public IssueTrackingCollectionTicketCommentsUpdateRequest withCollectionId(String collectionId) {
        Utils.checkNotNull(collectionId, "collectionId");
        this.collectionId = collectionId;
        return this;
    }
     ...
     * ID of the ticket you are acting upon.
     */
    public IssueTrackingCollectionTicketCommentsUpdateRequest withTicketId(String ticketId) {
        Utils.checkNotNull(ticketId, "ticketId");
        this.ticketId = ticketId;
        return this;
    }

    public IssueTrackingCollectionTicketCommentsUpdateRequest withCollectionTicketComment(CollectionTicketCommentInput collectionTicketComment) {
        Utils.checkNotNull(collectionTicketComment, "collectionTicketComment");
        this.collectionTicketComment = collectionTicketComment;
        return this;
    }
