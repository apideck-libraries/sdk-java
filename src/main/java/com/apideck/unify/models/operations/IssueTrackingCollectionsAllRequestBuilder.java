...
public class IssueTrackingCollectionsAllRequestBuilder {
    ...
    private final SDKMethodInterfaces.MethodCallIssueTrackingCollectionsAll sdk;

    public IssueTrackingCollectionsAllRequestBuilder(SDKMethodInterfaces.MethodCallIssueTrackingCollectionsAll sdk) {
        this.sdk = sdk;
    }
