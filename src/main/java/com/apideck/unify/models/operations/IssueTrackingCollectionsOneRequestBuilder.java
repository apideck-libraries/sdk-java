...
public class IssueTrackingCollectionsOneRequestBuilder {
    ...
    public IssueTrackingCollectionsOneRequestBuilder request(@Nonnull IssueTrackingCollectionsOneRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private IssueTrackingCollectionsOneRequest _buildRequest() {
        return this.request;
    }
    /**
