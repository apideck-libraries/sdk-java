...
public class LeadLeadsAllResponse implements Response {
     ...
     * HTTP response content type for this operation
     */
    public LeadLeadsAllResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public LeadLeadsAllResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public LeadLeadsAllResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * Leads
     */
    public LeadLeadsAllResponse withGetLeadsResponse(GetLeadsResponse getLeadsResponse) {
        Utils.checkNotNull(getLeadsResponse, "getLeadsResponse");
     ...
     * Leads
     */
    public LeadLeadsAllResponse withGetLeadsResponse(Optional<? extends GetLeadsResponse> getLeadsResponse) {
        Utils.checkNotNull(getLeadsResponse, "getLeadsResponse");
        this.getLeadsResponse = getLeadsResponse;
        return this;
    }
     ...
     * Unexpected error
     */
    public LeadLeadsAllResponse withUnexpectedErrorResponse(UnexpectedErrorResponse unexpectedErrorResponse) {
        Utils.checkNotNull(unexpectedErrorResponse, "unexpectedErrorResponse");
     ...
     * Unexpected error
     */
    public LeadLeadsAllResponse withUnexpectedErrorResponse(Optional<? extends UnexpectedErrorResponse> unexpectedErrorResponse) {
        Utils.checkNotNull(unexpectedErrorResponse, "unexpectedErrorResponse");
        this.unexpectedErrorResponse = unexpectedErrorResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        LeadLeadsAllResponse other = (LeadLeadsAllResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(LeadLeadsAllResponse.class,
    ...
    public final static class Builder {
        ...
        public LeadLeadsAllResponse build() {
