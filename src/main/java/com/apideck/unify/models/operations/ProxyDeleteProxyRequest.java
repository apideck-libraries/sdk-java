...
public class ProxyDeleteProxyRequest {
     ...
     * ID of the consumer which you want to get or push data from
     */
    public ProxyDeleteProxyRequest withConsumerId(String consumerId) {
        Utils.checkNotNull(consumerId, "consumerId");
     ...
     * ID of the consumer which you want to get or push data from
     */
    public ProxyDeleteProxyRequest withConsumerId(Optional<String> consumerId) {
        Utils.checkNotNull(consumerId, "consumerId");
        this.consumerId = consumerId;
        return this;
    }
     ...
     * The ID of your Unify application
     */
    public ProxyDeleteProxyRequest withAppId(String appId) {
        Utils.checkNotNull(appId, "appId");
     ...
     * The ID of your Unify application
     */
    public ProxyDeleteProxyRequest withAppId(Optional<String> appId) {
        Utils.checkNotNull(appId, "appId");
        this.appId = appId;
        return this;
    }
     ...
     * multiple integrations for a Unified API.
     */
    public ProxyDeleteProxyRequest withServiceId(String serviceId) {
        Utils.checkNotNull(serviceId, "serviceId");
        this.serviceId = serviceId;
        return this;
    }
     ...
     * Workday) to ensure the correct credentials are used.
     */
    public ProxyDeleteProxyRequest withUnifiedApi(String unifiedApi) {
        Utils.checkNotNull(unifiedApi, "unifiedApi");
     ...
     * Workday) to ensure the correct credentials are used.
     */
    public ProxyDeleteProxyRequest withUnifiedApi(Optional<String> unifiedApi) {
        Utils.checkNotNull(unifiedApi, "unifiedApi");
        this.unifiedApi = unifiedApi;
        return this;
    }
     ...
     * Downstream URL
     */
    public ProxyDeleteProxyRequest withDownstreamUrl(String downstreamUrl) {
        Utils.checkNotNull(downstreamUrl, "downstreamUrl");
        this.downstreamUrl = downstreamUrl;
        return this;
    }
     ...
     * Downstream authorization header. This will skip the Vault token injection.
     */
    public ProxyDeleteProxyRequest withDownstreamAuthorization(String downstreamAuthorization) {
        Utils.checkNotNull(downstreamAuthorization, "downstreamAuthorization");
     ...
     * Downstream authorization header. This will skip the Vault token injection.
     */
    public ProxyDeleteProxyRequest withDownstreamAuthorization(Optional<String> downstreamAuthorization) {
        Utils.checkNotNull(downstreamAuthorization, "downstreamAuthorization");
        this.downstreamAuthorization = downstreamAuthorization;
        return this;
    }
     ...
     * Override the default downstream request timeout in milliseconds. The default is 28000 (28 seconds).
     */
    public ProxyDeleteProxyRequest withTimeout(long timeout) {
        Utils.checkNotNull(timeout, "timeout");
     ...
     * Override the default downstream request timeout in milliseconds. The default is 28000 (28 seconds).
     */
    public ProxyDeleteProxyRequest withTimeout(Optional<Long> timeout) {
        Utils.checkNotNull(timeout, "timeout");
        this.timeout = timeout;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ProxyDeleteProxyRequest other = (ProxyDeleteProxyRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ProxyDeleteProxyRequest.class,
