...
public class ProxyGetProxyRequest {
     ...
     * <p>Any value other than `false` (or omitting the header) preserves the default redirect behavior.
     */
    public ProxyGetProxyRequest withFollowRedirects(boolean followRedirects) {
        Utils.checkNotNull(followRedirects, "followRedirects");
     ...
     * <p>Any value other than `false` (or omitting the header) preserves the default redirect behavior.
     */
    public ProxyGetProxyRequest withFollowRedirects(Optional<Boolean> followRedirects) {
        Utils.checkNotNull(followRedirects, "followRedirects");
        this.followRedirects = followRedirects;
        return this;
    }
