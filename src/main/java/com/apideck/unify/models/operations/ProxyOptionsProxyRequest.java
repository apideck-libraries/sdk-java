...
public class ProxyOptionsProxyRequest {
    ...
    @JsonCreator
    public ProxyOptionsProxyRequest(
     ...
     * ID of the consumer which you want to get or push data from
     */
    public ProxyOptionsProxyRequest withConsumerId(String consumerId) {
        Utils.checkNotNull(consumerId, "consumerId");
     ...
     * ID of the consumer which you want to get or push data from
     */
    public ProxyOptionsProxyRequest withConsumerId(Optional<String> consumerId) {
        Utils.checkNotNull(consumerId, "consumerId");
        this.consumerId = consumerId;
        return this;
    }
     ...
     * The ID of your Unify application
     */
    public ProxyOptionsProxyRequest withAppId(String appId) {
        Utils.checkNotNull(appId, "appId");
     ...
     * The ID of your Unify application
     */
    public ProxyOptionsProxyRequest withAppId(Optional<String> appId) {
        Utils.checkNotNull(appId, "appId");
        this.appId = appId;
        return this;
    }
     ...
     * multiple integrations for a Unified API.
     */
    public ProxyOptionsProxyRequest withServiceId(String serviceId) {
        Utils.checkNotNull(serviceId, "serviceId");
        this.serviceId = serviceId;
        return this;
    }
     ...
     * Workday) to ensure the correct credentials are used.
     */
    public ProxyOptionsProxyRequest withUnifiedApi(String unifiedApi) {
        Utils.checkNotNull(unifiedApi, "unifiedApi");
     ...
     * Workday) to ensure the correct credentials are used.
     */
    public ProxyOptionsProxyRequest withUnifiedApi(Optional<String> unifiedApi) {
        Utils.checkNotNull(unifiedApi, "unifiedApi");
        this.unifiedApi = unifiedApi;
        return this;
    }
     ...
     * Downstream URL
     */
    public ProxyOptionsProxyRequest withDownstreamUrl(String downstreamUrl) {
        Utils.checkNotNull(downstreamUrl, "downstreamUrl");
        this.downstreamUrl = downstreamUrl;
        return this;
    }
     ...
     * Downstream authorization header. This will skip the Vault token injection.
     */
    public ProxyOptionsProxyRequest withDownstreamAuthorization(String downstreamAuthorization) {
        Utils.checkNotNull(downstreamAuthorization, "downstreamAuthorization");
     ...
     * Downstream authorization header. This will skip the Vault token injection.
     */
    public ProxyOptionsProxyRequest withDownstreamAuthorization(Optional<String> downstreamAuthorization) {
        Utils.checkNotNull(downstreamAuthorization, "downstreamAuthorization");
        this.downstreamAuthorization = downstreamAuthorization;
        return this;
    }
     ...
     * Override the default downstream request timeout in milliseconds. The default is 28000 (28 seconds).
     */
    public ProxyOptionsProxyRequest withTimeout(long timeout) {
        Utils.checkNotNull(timeout, "timeout");
     ...
     * Override the default downstream request timeout in milliseconds. The default is 28000 (28 seconds).
     */
    public ProxyOptionsProxyRequest withTimeout(Optional<Long> timeout) {
        Utils.checkNotNull(timeout, "timeout");
        this.timeout = timeout;
        return this;
    }
     ...
     * <p>Any value other than `false` (or omitting the header) preserves the default redirect behavior.
     */
    public ProxyOptionsProxyRequest withFollowRedirects(boolean followRedirects) {
        Utils.checkNotNull(followRedirects, "followRedirects");
     ...
     * <p>Any value other than `false` (or omitting the header) preserves the default redirect behavior.
     */
    public ProxyOptionsProxyRequest withFollowRedirects(Optional<Boolean> followRedirects) {
        Utils.checkNotNull(followRedirects, "followRedirects");
        this.followRedirects = followRedirects;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ProxyOptionsProxyRequest other = (ProxyOptionsProxyRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ProxyOptionsProxyRequest.class,
    ...
    public final static class Builder {
        ...
        public ProxyOptionsProxyRequest build() {
            if (timeout == null) {
            ...
            return new ProxyOptionsProxyRequest(
                consumerId, appId, serviceId,
                unifiedApi, downstreamUrl, downstreamAuthorization,
                timeout, followRedirects);
        }
