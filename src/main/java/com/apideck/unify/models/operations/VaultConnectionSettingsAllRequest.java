...
public class VaultConnectionSettingsAllRequest {
     ...
     * ID of the consumer which you want to get or push data from
     */
    public VaultConnectionSettingsAllRequest withCustomerId(String customerId) {
        Utils.checkNotNull(customerId, "customerId");
     ...
     * ID of the consumer which you want to get or push data from
     */
    public VaultConnectionSettingsAllRequest withCustomerId(Optional<String> customerId) {
        Utils.checkNotNull(customerId, "customerId");
        this.customerId = customerId;
        return this;
    }
