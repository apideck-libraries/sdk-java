...
public class VaultConnectionSettingsUpdateRequestBuilder {
    ...
    public VaultConnectionSettingsUpdateRequestBuilder(SDKConfiguration sdkConfiguration) {
    ...
    public VaultConnectionSettingsUpdateRequestBuilder request(@Nonnull VaultConnectionSettingsUpdateRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private VaultConnectionSettingsUpdateRequest _buildRequest() {
        return this.request;
    }
    /**
