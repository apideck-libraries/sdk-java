...
public class VaultConnectionsAllResponse implements Response {
     ...
     * Connections
     */
    private GetConnectionsResponse getConnectionsResponse;
    ...
    public VaultConnectionsAllResponse(
            ...
            @Nullable GetConnectionsResponse getConnectionsResponse,
    ...
    public Optional<GetConnectionsResponse> getConnectionsResponse() {
        return Optional.ofNullable(this.getConnectionsResponse);
    }
     ...
     * HTTP response content type for this operation
     */
    public VaultConnectionsAllResponse withContentType(@Nonnull String contentType) {
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public VaultConnectionsAllResponse withRawResponse(@Nonnull HttpResponse<InputStream> rawResponse) {
     ...
     * Connections
     */
    public VaultConnectionsAllResponse withGetConnectionsResponse(@Nullable GetConnectionsResponse getConnectionsResponse) {
        this.getConnectionsResponse = getConnectionsResponse;
        return this;
    }
     ...
     * Unexpected error
     */
    public VaultConnectionsAllResponse withUnexpectedErrorResponse(@Nullable UnexpectedErrorResponse unexpectedErrorResponse) {
        this.unexpectedErrorResponse = unexpectedErrorResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return 
            ...
            Utils.enhancedDeepEquals(this.getConnectionsResponse, other.getConnectionsResponse) &&
    ...
    public int hashCode() {
        return Utils.enhancedHash(
            ...
            getConnectionsResponse, unexpectedErrorResponse);
    }
    ...
    public final static class Builder {
         ...
         * Connections
         */
        public Builder getConnectionsResponse(@Nullable GetConnectionsResponse getConnectionsResponse) {
            this.getConnectionsResponse = getConnectionsResponse;
            return this;
        }
