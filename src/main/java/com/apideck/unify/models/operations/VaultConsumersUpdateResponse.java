...
public class VaultConsumersUpdateResponse implements Response {
     ...
     * Consumer updated
     */
    private UpdateConsumerResponse updateConsumerResponse;
    ...
    public VaultConsumersUpdateResponse(
            ...
            @Nullable UpdateConsumerResponse updateConsumerResponse,
    ...
    public Optional<UpdateConsumerResponse> updateConsumerResponse() {
        return Optional.ofNullable(this.updateConsumerResponse);
    }
     ...
     * HTTP response content type for this operation
     */
    public VaultConsumersUpdateResponse withContentType(@Nonnull String contentType) {
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public VaultConsumersUpdateResponse withRawResponse(@Nonnull HttpResponse<InputStream> rawResponse) {
     ...
     * Consumer updated
     */
    public VaultConsumersUpdateResponse withUpdateConsumerResponse(@Nullable UpdateConsumerResponse updateConsumerResponse) {
        this.updateConsumerResponse = updateConsumerResponse;
        return this;
    }
     ...
     * Unexpected error
     */
    public VaultConsumersUpdateResponse withUnexpectedErrorResponse(@Nullable UnexpectedErrorResponse unexpectedErrorResponse) {
        this.unexpectedErrorResponse = unexpectedErrorResponse;
        return this;
    }
    ...
    public final static class Builder {
         ...
         * Consumer updated
         */
        public Builder updateConsumerResponse(@Nullable UpdateConsumerResponse updateConsumerResponse) {
            this.updateConsumerResponse = updateConsumerResponse;
            return this;
        }
