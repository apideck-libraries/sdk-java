...
public class VaultCreateCallbackStateRequestBuilder {
    ...
    public VaultCreateCallbackStateRequestBuilder request(@Nonnull VaultCreateCallbackStateRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private VaultCreateCallbackStateRequest _buildRequest() {
        return this.request;
    }
    /**
