...
public class VaultCustomMappingsAllResponse implements Response {
     ...
     * HTTP response content type for this operation
     */
    public VaultCustomMappingsAllResponse withContentType(@Nonnull String contentType) {
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public VaultCustomMappingsAllResponse withRawResponse(@Nonnull HttpResponse<InputStream> rawResponse) {
     ...
     * Custom mapping
     */
    public VaultCustomMappingsAllResponse withGetCustomMappingsResponse(@Nullable GetCustomMappingsResponse getCustomMappingsResponse) {
        this.getCustomMappingsResponse = getCustomMappingsResponse;
        return this;
    }
     ...
     * Unexpected error
     */
    public VaultCustomMappingsAllResponse withUnexpectedErrorResponse(@Nullable UnexpectedErrorResponse unexpectedErrorResponse) {
        this.unexpectedErrorResponse = unexpectedErrorResponse;
        return this;
    }
