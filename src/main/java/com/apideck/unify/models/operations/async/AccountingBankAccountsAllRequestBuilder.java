...
public class AccountingBankAccountsAllRequestBuilder {

    private AccountingBankAccountsAllRequest request;
    private Optional<RetryConfig> retryConfig = Optional.empty();
    private final SDKConfiguration sdkConfiguration;
    private final Headers _headers = new Headers(); 

    public AccountingBankAccountsAllRequestBuilder(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
    }

    public AccountingBankAccountsAllRequestBuilder request(AccountingBankAccountsAllRequest request) {
        Utils.checkNotNull(request, "request");
        this.request = request;
        return this;
    }
                
    public AccountingBankAccountsAllRequestBuilder retryConfig(RetryConfig retryConfig) {
        Utils.checkNotNull(retryConfig, "retryConfig");
        this.retryConfig = Optional.of(retryConfig);
        return this;
    }

    public AccountingBankAccountsAllRequestBuilder retryConfig(Optional<RetryConfig> retryConfig) {
        Utils.checkNotNull(retryConfig, "retryConfig");
     ...
     * <pre><code>
     * Publisher&lt;AccountingBankAccountsAllResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;AccountingBankAccountsAllResponse&gt;() {
     ...
     */
    public Publisher<AccountingBankAccountsAllResponse> callAsPublisher() {
        AccountingBankAccountsAllRequest request = this.request;
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
        ...
        Flow.Publisher<HttpResponse<Blob>> asyncPaginator = new AsyncPaginator<>(
            ...
            new CursorTracker<>("$.meta.cursors.next", String.class),
                    AccountingBankAccountsAllRequest::withCursor,
            operation::doRequest);

        Flow.Publisher<AccountingBankAccountsAllResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
