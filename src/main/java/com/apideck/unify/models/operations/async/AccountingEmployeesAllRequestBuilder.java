...
public class AccountingEmployeesAllRequestBuilder {

    private AccountingEmployeesAllRequest request;
    private Optional<RetryConfig> retryConfig = Optional.empty();
    private final SDKConfiguration sdkConfiguration;
    private final Headers _headers = new Headers(); 

    public AccountingEmployeesAllRequestBuilder(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
    }

    public AccountingEmployeesAllRequestBuilder request(AccountingEmployeesAllRequest request) {
        Utils.checkNotNull(request, "request");
        this.request = request;
        return this;
    }
                
    public AccountingEmployeesAllRequestBuilder retryConfig(RetryConfig retryConfig) {
        Utils.checkNotNull(retryConfig, "retryConfig");
        this.retryConfig = Optional.of(retryConfig);
        return this;
    }

    public AccountingEmployeesAllRequestBuilder retryConfig(Optional<RetryConfig> retryConfig) {
        Utils.checkNotNull(retryConfig, "retryConfig");
        this.retryConfig = retryConfig;
        return this;
    }

    public CompletableFuture<AccountingEmployeesAllResponse> call() {
     ...
     */
    public Publisher<AccountingEmployeesAllResponse> callAsPublisher() {
        AccountingEmployeesAllRequest request = this.request;
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
        ...
        Flow.Publisher<HttpResponse<Blob>> asyncPaginator = new AsyncPaginator<>(
            ...
            new CursorTracker<>("$.meta.cursors.next", String.class),
                    AccountingEmployeesAllRequest::withCursor,
            operation::doRequest);

        Flow.Publisher<AccountingEmployeesAllResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
