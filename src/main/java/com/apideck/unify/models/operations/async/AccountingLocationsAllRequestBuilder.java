...
public class AccountingLocationsAllRequestBuilder {
    ...
    public CompletableFuture<AccountingLocationsAllResponse> call() throws Exception {
     ...
     * <pre><code>
     * Publisher&lt;AccountingLocationsAllResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;AccountingLocationsAllResponse&gt;() {
     ...
     */
    public Publisher<AccountingLocationsAllResponse> callAsPublisher() {
        AccountingLocationsAllRequest request = this.request;
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
        ...
        Flow.Publisher<AccountingLocationsAllResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
