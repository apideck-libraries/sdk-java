...
public class AccountingQuotesAllRequestBuilder {
    ...
    public AccountingQuotesAllRequestBuilder request(AccountingQuotesAllRequest request) {
        Utils.checkNotNull(request, "request");
        this.request = request;
        return this;
    }
                
    public AccountingQuotesAllRequestBuilder retryConfig(RetryConfig retryConfig) {
        Utils.checkNotNull(retryConfig, "retryConfig");
        this.retryConfig = Optional.of(retryConfig);
        return this;
    }

    public AccountingQuotesAllRequestBuilder retryConfig(Optional<RetryConfig> retryConfig) {
        Utils.checkNotNull(retryConfig, "retryConfig");
        this.retryConfig = retryConfig;
        return this;
    }

    public CompletableFuture<AccountingQuotesAllResponse> call() throws Exception {
     ...
     * <pre><code>
     * Publisher&lt;AccountingQuotesAllResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;AccountingQuotesAllResponse&gt;() {
     ...
     */
    public Publisher<AccountingQuotesAllResponse> callAsPublisher() {
        AccountingQuotesAllRequest request = this.request;
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
        ...
        Flow.Publisher<HttpResponse<Blob>> asyncPaginator = new AsyncPaginator<>(
            ...
            new CursorTracker<>("$.meta.cursors.next", String.class),
                    AccountingQuotesAllRequest::withCursor,
            operation::doRequest);

        Flow.Publisher<AccountingQuotesAllResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
