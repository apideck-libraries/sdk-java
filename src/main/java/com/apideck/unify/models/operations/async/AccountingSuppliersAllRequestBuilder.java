...
public class AccountingSuppliersAllRequestBuilder {
    ...
    public CompletableFuture<AccountingSuppliersAllResponse> call() throws Exception {
     ...
     * <pre><code>
     * Publisher&lt;AccountingSuppliersAllResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;AccountingSuppliersAllResponse&gt;() {
     ...
     */
    public Publisher<AccountingSuppliersAllResponse> callAsPublisher() {
        AccountingSuppliersAllRequest request = this.request;
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
        ...
        Flow.Publisher<AccountingSuppliersAllResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
