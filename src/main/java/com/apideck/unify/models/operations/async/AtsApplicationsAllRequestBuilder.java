...
public class AtsApplicationsAllRequestBuilder {
    ...
    public CompletableFuture<AtsApplicationsAllResponse> call() throws Exception {
     ...
     * <pre><code>
     * Publisher&lt;AtsApplicationsAllResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;AtsApplicationsAllResponse&gt;() {
     ...
     */
    public Publisher<AtsApplicationsAllResponse> callAsPublisher() {
        AtsApplicationsAllRequest request = this.request;
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
        ...
        Flow.Publisher<AtsApplicationsAllResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
