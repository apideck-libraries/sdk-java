...
public class AtsJobsAllRequestBuilder {
    ...
    public CompletableFuture<AtsJobsAllResponse> call() throws Exception {
     ...
     * <pre><code>
     * Publisher&lt;AtsJobsAllResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;AtsJobsAllResponse&gt;() {
     ...
     */
    public Publisher<AtsJobsAllResponse> callAsPublisher() {
        ...
        Flow.Publisher<AtsJobsAllResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
