...
public class CrmCompaniesAllRequestBuilder {
    ...
    public CompletableFuture<CrmCompaniesAllResponse> call() throws Exception {
     ...
     * <pre><code>
     * Publisher&lt;CrmCompaniesAllResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;CrmCompaniesAllResponse&gt;() {
     ...
     */
    public Publisher<CrmCompaniesAllResponse> callAsPublisher() {
        CrmCompaniesAllRequest request = this.request;
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
        ...
        Flow.Publisher<CrmCompaniesAllResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
