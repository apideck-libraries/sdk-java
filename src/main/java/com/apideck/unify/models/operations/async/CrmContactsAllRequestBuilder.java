...
public class CrmContactsAllRequestBuilder {
    ...
    public CrmContactsAllRequestBuilder(SDKConfiguration sdkConfiguration) {
    ...
    public CompletableFuture<CrmContactsAllResponse> call() throws Exception {
     ...
     * <pre><code>
     * Publisher&lt;CrmContactsAllResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;CrmContactsAllResponse&gt;() {
     ...
     */
    public Publisher<CrmContactsAllResponse> callAsPublisher() {
        CrmContactsAllRequest request = this.request;
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
        ...
        Flow.Publisher<HttpResponse<Blob>> asyncPaginator = new AsyncPaginator<>(
            ...
            new CursorTracker<>("$.meta.cursors.next", String.class),
                    CrmContactsAllRequest::withCursor,
            operation::doRequest);

        Flow.Publisher<CrmContactsAllResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
