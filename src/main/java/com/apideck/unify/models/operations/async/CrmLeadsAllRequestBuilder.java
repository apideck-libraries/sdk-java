...
public class CrmLeadsAllRequestBuilder {
    ...
    public CompletableFuture<CrmLeadsAllResponse> call() throws Exception {
     ...
     * <pre><code>
     * Publisher&lt;CrmLeadsAllResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;CrmLeadsAllResponse&gt;() {
     ...
     */
    public Publisher<CrmLeadsAllResponse> callAsPublisher() {
        CrmLeadsAllRequest request = this.request;
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
        ...
        Flow.Publisher<CrmLeadsAllResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
