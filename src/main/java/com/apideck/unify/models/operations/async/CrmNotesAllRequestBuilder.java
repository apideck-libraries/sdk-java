...
public class CrmNotesAllRequestBuilder {
    ...
    public CompletableFuture<CrmNotesAllResponse> call() throws Exception {
     ...
     * <pre><code>
     * Publisher&lt;CrmNotesAllResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;CrmNotesAllResponse&gt;() {
     ...
     */
    public Publisher<CrmNotesAllResponse> callAsPublisher() {
        ...
        Flow.Publisher<CrmNotesAllResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
