...
public class CrmPipelinesAllRequestBuilder {
    ...
    public CompletableFuture<CrmPipelinesAllResponse> call() throws Exception {
     ...
     * <pre><code>
     * Publisher&lt;CrmPipelinesAllResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;CrmPipelinesAllResponse&gt;() {
     ...
     */
    public Publisher<CrmPipelinesAllResponse> callAsPublisher() {
        ...
        Flow.Publisher<CrmPipelinesAllResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
