...
public class EcommerceOrdersAllRequestBuilder {
    ...
    public EcommerceOrdersAllRequestBuilder(SDKConfiguration sdkConfiguration) {
    ...
    public CompletableFuture<EcommerceOrdersAllResponse> call() throws Exception {
     ...
     * <pre><code>
     * Publisher&lt;EcommerceOrdersAllResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;EcommerceOrdersAllResponse&gt;() {
     ...
     */
    public Publisher<EcommerceOrdersAllResponse> callAsPublisher() {
        EcommerceOrdersAllRequest request = this.request;
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
        ...
        Flow.Publisher<HttpResponse<Blob>> asyncPaginator = new AsyncPaginator<>(
            ...
            new CursorTracker<>("$.meta.cursors.next", String.class),
                    EcommerceOrdersAllRequest::withCursor,
            operation::doRequest);

        Flow.Publisher<EcommerceOrdersAllResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
