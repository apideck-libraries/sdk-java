...
public class HrisCompaniesAll2RequestBuilder {
    ...
    public CompletableFuture<HrisCompaniesAll2Response> call() {
     ...
     * <pre><code>
     * Publisher&lt;HrisCompaniesAll2Response&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;HrisCompaniesAll2Response&gt;() {
     ...
     */
    public Publisher<HrisCompaniesAll2Response> callAsPublisher() {
        HrisCompaniesAll2Request request = this.request;
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
        ...
        Flow.Publisher<HrisCompaniesAll2Response> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
