...
public class HrisDepartmentsAllRequestBuilder {
    ...
    public CompletableFuture<HrisDepartmentsAllResponse> call() throws Exception {
     ...
     * <pre><code>
     * Publisher&lt;HrisDepartmentsAllResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;HrisDepartmentsAllResponse&gt;() {
     ...
     */
    public Publisher<HrisDepartmentsAllResponse> callAsPublisher() {
        HrisDepartmentsAllRequest request = this.request;
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
        ...
        Flow.Publisher<HrisDepartmentsAllResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
