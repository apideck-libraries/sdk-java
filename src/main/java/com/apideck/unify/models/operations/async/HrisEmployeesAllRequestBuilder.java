...
public class HrisEmployeesAllRequestBuilder {
    ...
    public HrisEmployeesAllRequestBuilder(SDKConfiguration sdkConfiguration) {
    ...
    public CompletableFuture<HrisEmployeesAllResponse> call() throws Exception {
     ...
     * <pre><code>
     * Publisher&lt;HrisEmployeesAllResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;HrisEmployeesAllResponse&gt;() {
     ...
     */
    public Publisher<HrisEmployeesAllResponse> callAsPublisher() {
        HrisEmployeesAllRequest request = this.request;
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
        ...
        Flow.Publisher<HttpResponse<Blob>> asyncPaginator = new AsyncPaginator<>(
            ...
            new CursorTracker<>("$.meta.cursors.next", String.class),
                    HrisEmployeesAllRequest::withCursor,
            operation::doRequest);

        Flow.Publisher<HrisEmployeesAllResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
