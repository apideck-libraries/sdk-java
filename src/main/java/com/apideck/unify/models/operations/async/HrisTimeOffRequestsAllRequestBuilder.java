...
public class HrisTimeOffRequestsAllRequestBuilder {
    ...
    public CompletableFuture<HrisTimeOffRequestsAllResponse> call() throws Exception {
     ...
     * <pre><code>
     * Publisher&lt;HrisTimeOffRequestsAllResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;HrisTimeOffRequestsAllResponse&gt;() {
     ...
     */
    public Publisher<HrisTimeOffRequestsAllResponse> callAsPublisher() {
