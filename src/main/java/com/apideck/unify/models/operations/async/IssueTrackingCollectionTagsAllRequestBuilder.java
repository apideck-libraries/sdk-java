...
public class IssueTrackingCollectionTagsAllRequestBuilder {
    ...
    public CompletableFuture<IssueTrackingCollectionTagsAllResponse> call() throws Exception {
        ...
        AsyncRequestOperation<IssueTrackingCollectionTagsAllRequest, IssueTrackingCollectionTagsAllResponse> operation
              = new IssueTrackingCollectionTagsAll.Async(
     ...
     * <pre><code>
     * Publisher&lt;IssueTrackingCollectionTagsAllResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;IssueTrackingCollectionTagsAllResponse&gt;() {
     ...
     */
    public Publisher<IssueTrackingCollectionTagsAllResponse> callAsPublisher() {
        ...
        Flow.Publisher<IssueTrackingCollectionTagsAllResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
