...
public class IssueTrackingCollectionTicketCommentsOneRequestBuilder {
    ...
    public CompletableFuture<IssueTrackingCollectionTicketCommentsOneResponse> call() throws Exception {
     ...
     * <pre><code>
     * Publisher&lt;IssueTrackingCollectionTicketCommentsOneResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;IssueTrackingCollectionTicketCommentsOneResponse&gt;() {
     ...
     */
    public Publisher<IssueTrackingCollectionTicketCommentsOneResponse> callAsPublisher() {
        ...
        Flow.Publisher<IssueTrackingCollectionTicketCommentsOneResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
