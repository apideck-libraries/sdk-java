...
public class IssueTrackingCollectionTicketsOneRequestBuilder {
    ...
    public IssueTrackingCollectionTicketsOneRequestBuilder retryConfig(Optional<RetryConfig> retryConfig) {
        Utils.checkNotNull(retryConfig, "retryConfig");
        this.retryConfig = retryConfig;
        return this;
    }

    public CompletableFuture<IssueTrackingCollectionTicketsOneResponse> call() throws Exception {
