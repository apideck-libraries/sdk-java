...
public class SmsMessagesAllRequestBuilder {
    ...
    public CompletableFuture<SmsMessagesAllResponse> call() throws Exception {
     ...
     * <pre><code>
     * Publisher&lt;SmsMessagesAllResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;SmsMessagesAllResponse&gt;() {
     ...
     */
    public Publisher<SmsMessagesAllResponse> callAsPublisher() {
        SmsMessagesAllRequest request = this.request;
        Optional<Options> options = Optional.of(Options.builder()
            .retryConfig(retryConfig)
            .build());
        ...
        Flow.Publisher<SmsMessagesAllResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
