...
public class VaultLogsAllRequestBuilder {
    ...
    public CompletableFuture<VaultLogsAllResponse> call() throws Exception {
     ...
     * <pre><code>
     * Publisher&lt;VaultLogsAllResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;VaultLogsAllResponse&gt;() {
     ...
     */
    public Publisher<VaultLogsAllResponse> callAsPublisher() {
