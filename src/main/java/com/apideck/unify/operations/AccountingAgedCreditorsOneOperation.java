...
public class AccountingAgedCreditorsOneOperation implements RequestOperation<AccountingAgedCreditorsOneRequest, AccountingAgedCreditorsOneResponse> {
    ...
    public AccountingAgedCreditorsOneOperation(
    ...
    public HttpRequest buildRequest(AccountingAgedCreditorsOneRequest request) throws Exception {
        ...
        req.addQueryParams(Utils.getQueryParams(
                AccountingAgedCreditorsOneRequest.class,
                request, 
    ...
    @Override
    public HttpResponse<InputStream> doRequest(AccountingAgedCreditorsOneRequest request) throws Exception {
    ...
    @Override
    public AccountingAgedCreditorsOneResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        ...
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                GetAgedCreditorsResponse out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withGetAgedCreditorsResponse(out);
                return res;
            } else {
