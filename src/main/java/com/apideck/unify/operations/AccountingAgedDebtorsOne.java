...
public class AccountingAgedDebtorsOne {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingAgedDebtorsOneRequest, AccountingAgedDebtorsOneResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingAgedDebtorsOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingAgedDebtorsOneRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingAgedDebtorsOneRequest request) {
        ...
        @Override
        public AccountingAgedDebtorsOneResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingAgedDebtorsOneResponse.Builder resBuilder =
            ...
            AccountingAgedDebtorsOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetAgedDebtorsResponse(Utils.unmarshal(response, new TypeReference<GetAgedDebtorsResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingAgedDebtorsOneRequest, com.apideck.unify.models.operations.async.AccountingAgedDebtorsOneResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingAgedDebtorsOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingAgedDebtorsOneRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingAgedDebtorsOneRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingAgedDebtorsOneResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingAgedDebtorsOneResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingAgedDebtorsOneResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingAgedDebtorsOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetAgedDebtorsResponse>() {})
                            .thenApply(res::withGetAgedDebtorsResponse);
                } else {
