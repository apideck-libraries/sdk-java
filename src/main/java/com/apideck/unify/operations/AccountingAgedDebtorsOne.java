...
public class AccountingAgedDebtorsOne {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingAgedDebtorsOneRequest request) throws Exception {
        ...
        @Override
        public AccountingAgedDebtorsOneResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GetAgedDebtorsResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGetAgedDebtorsResponse(out);
                    return res;
                } else {
