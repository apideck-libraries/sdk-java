...
public class AccountingAgedDebtorsOneOperation implements RequestOperation<AccountingAgedDebtorsOneRequest, AccountingAgedDebtorsOneResponse> {
    ...
    public AccountingAgedDebtorsOneOperation(
    ...
    public HttpRequest buildRequest(AccountingAgedDebtorsOneRequest request) throws Exception {
