...
public class AccountingAttachmentsAll {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingAttachmentsAllRequest, AccountingAttachmentsAllResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingAttachmentsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingAttachmentsAllRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingAttachmentsAllRequest request) {
        ...
        @Override
        public AccountingAttachmentsAllResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingAttachmentsAllResponse.Builder resBuilder =
            ...
            AccountingAttachmentsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetAttachmentsResponse(Utils.unmarshal(response, new TypeReference<GetAttachmentsResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingAttachmentsAllRequest, com.apideck.unify.models.operations.async.AccountingAttachmentsAllResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingAttachmentsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingAttachmentsAllRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingAttachmentsAllRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingAttachmentsAllResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingAttachmentsAllResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingAttachmentsAllResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingAttachmentsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetAttachmentsResponse>() {})
                            .thenApply(res::withGetAttachmentsResponse);
                } else {
