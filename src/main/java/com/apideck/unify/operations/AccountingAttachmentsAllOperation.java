...
public class AccountingAttachmentsAllOperation implements RequestOperation<AccountingAttachmentsAllRequest, AccountingAttachmentsAllResponse> {
    ...
    public AccountingAttachmentsAllOperation(
    ...
    public HttpRequest buildRequest(AccountingAttachmentsAllRequest request) throws Exception {
