...
public class AccountingAttachmentsDelete {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingAttachmentsDeleteRequest, AccountingAttachmentsDeleteResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingAttachmentsDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingAttachmentsDeleteRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingAttachmentsDeleteRequest request) {
        ...
        @Override
        public AccountingAttachmentsDeleteResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDeleteAttachmentResponse(Utils.unmarshal(response, new TypeReference<DeleteAttachmentResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingAttachmentsDeleteRequest, com.apideck.unify.models.operations.async.AccountingAttachmentsDeleteResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingAttachmentsDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingAttachmentsDeleteRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingAttachmentsDeleteRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingAttachmentsDeleteResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingAttachmentsDeleteResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingAttachmentsDeleteResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingAttachmentsDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DeleteAttachmentResponse>() {})
                            .thenApply(res::withDeleteAttachmentResponse);
                } else {
