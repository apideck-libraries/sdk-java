...
public class AccountingAttachmentsDownload {
    ...
    static abstract class Base {
        ...
        <T>HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            ...
            req.addHeader("Accept", "application/json;q=1, */*;q=0")
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingAttachmentsDownloadRequest, AccountingAttachmentsDownloadResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingAttachmentsDownloadRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingAttachmentsDownloadRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingAttachmentsDownloadRequest request) {
        ...
        @Override
        public AccountingAttachmentsDownloadResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingAttachmentsDownloadResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200") && Utils.contentTypeMatches(contentType, "*/*")) {
                resBuilder.getAttachmentDownloadResponse(response.body());
            }

            AccountingAttachmentsDownloadResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingAttachmentsDownloadRequest, com.apideck.unify.models.operations.async.AccountingAttachmentsDownloadResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingAttachmentsDownloadRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingAttachmentsDownloadRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingAttachmentsDownloadRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingAttachmentsDownloadResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingAttachmentsDownloadResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingAttachmentsDownloadResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
            ...
            com.apideck.unify.models.operations.async.AccountingAttachmentsDownloadResponse res = resBuilder.build();
