...
public class AccountingAttachmentsDownloadOperation implements RequestOperation<AccountingAttachmentsDownloadRequest, AccountingAttachmentsDownloadResponse> {
    ...
    public AccountingAttachmentsDownloadOperation(
    ...
    public HttpRequest buildRequest(AccountingAttachmentsDownloadRequest request) throws Exception {
