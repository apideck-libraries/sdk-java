...
public class AccountingAttachmentsOne {
    ...
    public static class Sync extends Base
        ...
        @Override
        public AccountingAttachmentsOneResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GetAttachmentResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGetAttachmentResponse(out);
                    return res;
                } else {
