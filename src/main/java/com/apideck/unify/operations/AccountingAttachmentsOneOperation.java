...
public class AccountingAttachmentsOneOperation implements RequestOperation<AccountingAttachmentsOneRequest, AccountingAttachmentsOneResponse> {
    ...
    public AccountingAttachmentsOneOperation(
    ...
    public HttpRequest buildRequest(AccountingAttachmentsOneRequest request) throws Exception {
