...
public class AccountingAttachmentsUploadOperation implements RequestOperation<AccountingAttachmentsUploadRequest, AccountingAttachmentsUploadResponse> {
    ...
    public HttpRequest buildRequest(AccountingAttachmentsUploadRequest request) throws Exception {
