...
public class AccountingBalanceSheetOne {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingBalanceSheetOneRequest request) throws Exception {
        ...
        @Override
        public AccountingBalanceSheetOneResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GetBalanceSheetResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGetBalanceSheetResponse(out);
                    return res;
                } else {
