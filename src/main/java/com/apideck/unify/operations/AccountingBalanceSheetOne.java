...
public class AccountingBalanceSheetOne {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingBalanceSheetOneRequest, AccountingBalanceSheetOneResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingBalanceSheetOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingBalanceSheetOneRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingBalanceSheetOneRequest request) {
        ...
        @Override
        public AccountingBalanceSheetOneResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingBalanceSheetOneResponse.Builder resBuilder =
            ...
            AccountingBalanceSheetOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetBalanceSheetResponse(Utils.unmarshal(response, new TypeReference<GetBalanceSheetResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingBalanceSheetOneRequest, com.apideck.unify.models.operations.async.AccountingBalanceSheetOneResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingBalanceSheetOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingBalanceSheetOneRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingBalanceSheetOneRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingBalanceSheetOneResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingBalanceSheetOneResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingBalanceSheetOneResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingBalanceSheetOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetBalanceSheetResponse>() {})
                            .thenApply(res::withGetBalanceSheetResponse);
                } else {
