...
public class AccountingBalanceSheetOneOperation implements RequestOperation<AccountingBalanceSheetOneRequest, AccountingBalanceSheetOneResponse> {
    ...
    public AccountingBalanceSheetOneOperation(
    ...
    public HttpRequest buildRequest(AccountingBalanceSheetOneRequest request) throws Exception {
