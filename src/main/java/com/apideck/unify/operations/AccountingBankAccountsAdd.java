...
public class AccountingBankAccountsAdd {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingBankAccountsAddRequest, AccountingBankAccountsAddResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingBankAccountsAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingBankAccountsAddRequest.class, new TypeReference<AccountingBankAccountsAddRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingBankAccountsAddRequest request) {
        ...
        @Override
        public AccountingBankAccountsAddResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingBankAccountsAddResponse.Builder resBuilder =
            ...
            AccountingBankAccountsAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCreateBankAccountResponse(Utils.unmarshal(response, new TypeReference<CreateBankAccountResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingBankAccountsAddRequest, com.apideck.unify.models.operations.async.AccountingBankAccountsAddResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingBankAccountsAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingBankAccountsAddRequest.class, new TypeReference<AccountingBankAccountsAddRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingBankAccountsAddRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingBankAccountsAddResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingBankAccountsAddResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingBankAccountsAddResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingBankAccountsAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CreateBankAccountResponse>() {})
                            .thenApply(res::withCreateBankAccountResponse);
                } else {
