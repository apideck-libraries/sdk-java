...
public class AccountingBankAccountsAll {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingBankAccountsAllRequest, AccountingBankAccountsAllResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingBankAccountsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingBankAccountsAllRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingBankAccountsAllRequest request) {
        ...
        @Override
        public AccountingBankAccountsAllResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingBankAccountsAllResponse.Builder resBuilder =
            ...
            AccountingBankAccountsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetBankAccountsResponse(Utils.unmarshal(response, new TypeReference<GetBankAccountsResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingBankAccountsAllRequest, com.apideck.unify.models.operations.async.AccountingBankAccountsAllResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingBankAccountsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingBankAccountsAllRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingBankAccountsAllRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingBankAccountsAllResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingBankAccountsAllResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingBankAccountsAllResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingBankAccountsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetBankAccountsResponse>() {})
                            .thenApply(res::withGetBankAccountsResponse);
                } else {
