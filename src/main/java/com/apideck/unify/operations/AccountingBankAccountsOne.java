...
public class AccountingBankAccountsOne {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingBankAccountsOneRequest, AccountingBankAccountsOneResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingBankAccountsOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingBankAccountsOneRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingBankAccountsOneRequest request) {
        ...
        @Override
        public AccountingBankAccountsOneResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingBankAccountsOneResponse.Builder resBuilder =
            ...
            AccountingBankAccountsOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetBankAccountResponse(Utils.unmarshal(response, new TypeReference<GetBankAccountResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingBankAccountsOneRequest, com.apideck.unify.models.operations.async.AccountingBankAccountsOneResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingBankAccountsOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingBankAccountsOneRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingBankAccountsOneRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingBankAccountsOneResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingBankAccountsOneResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingBankAccountsOneResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingBankAccountsOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetBankAccountResponse>() {})
                            .thenApply(res::withGetBankAccountResponse);
                } else {
