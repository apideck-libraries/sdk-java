...
public class AccountingBankAccountsUpdate {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingBankAccountsUpdateRequest, AccountingBankAccountsUpdateResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingBankAccountsUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingBankAccountsUpdateRequest.class, new TypeReference<AccountingBankAccountsUpdateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingBankAccountsUpdateRequest request) {
        ...
        @Override
        public AccountingBankAccountsUpdateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingBankAccountsUpdateResponse.Builder resBuilder =
            ...
            AccountingBankAccountsUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withUpdateBankAccountResponse(Utils.unmarshal(response, new TypeReference<UpdateBankAccountResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingBankAccountsUpdateRequest, com.apideck.unify.models.operations.async.AccountingBankAccountsUpdateResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingBankAccountsUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingBankAccountsUpdateRequest.class, new TypeReference<AccountingBankAccountsUpdateRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingBankAccountsUpdateRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingBankAccountsUpdateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingBankAccountsUpdateResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingBankAccountsUpdateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingBankAccountsUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<UpdateBankAccountResponse>() {})
                            .thenApply(res::withUpdateBankAccountResponse);
                } else {
