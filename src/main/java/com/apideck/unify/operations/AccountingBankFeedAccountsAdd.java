...
public class AccountingBankFeedAccountsAdd {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingBankFeedAccountsAddRequest request) throws Exception {
        ...
        @Override
        public AccountingBankFeedAccountsAddResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    CreateBankFeedAccountResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCreateBankFeedAccountResponse(out);
                    return res;
                } else {
