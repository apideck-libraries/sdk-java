...
public class AccountingBankFeedAccountsAddOperation implements RequestOperation<AccountingBankFeedAccountsAddRequest, AccountingBankFeedAccountsAddResponse> {
    ...
    public AccountingBankFeedAccountsAddOperation(
    ...
    public HttpRequest buildRequest(AccountingBankFeedAccountsAddRequest request) throws Exception {
