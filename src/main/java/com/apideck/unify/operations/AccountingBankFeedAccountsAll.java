...
public class AccountingBankFeedAccountsAll {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingBankFeedAccountsAllRequest, AccountingBankFeedAccountsAllResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingBankFeedAccountsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingBankFeedAccountsAllRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingBankFeedAccountsAllRequest request) {
        ...
        @Override
        public AccountingBankFeedAccountsAllResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingBankFeedAccountsAllResponse.Builder resBuilder =
            ...
            AccountingBankFeedAccountsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetBankFeedAccountsResponse(Utils.unmarshal(response, new TypeReference<GetBankFeedAccountsResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingBankFeedAccountsAllRequest, com.apideck.unify.models.operations.async.AccountingBankFeedAccountsAllResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingBankFeedAccountsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingBankFeedAccountsAllRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingBankFeedAccountsAllRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingBankFeedAccountsAllResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingBankFeedAccountsAllResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingBankFeedAccountsAllResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingBankFeedAccountsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetBankFeedAccountsResponse>() {})
                            .thenApply(res::withGetBankFeedAccountsResponse);
                } else {
