...
public class AccountingBankFeedAccountsAllOperation implements RequestOperation<AccountingBankFeedAccountsAllRequest, AccountingBankFeedAccountsAllResponse> {
    ...
    public AccountingBankFeedAccountsAllOperation(
    ...
    public HttpRequest buildRequest(AccountingBankFeedAccountsAllRequest request) throws Exception {
