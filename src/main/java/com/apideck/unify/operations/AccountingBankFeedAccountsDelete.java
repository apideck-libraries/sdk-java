...
public class AccountingBankFeedAccountsDelete {
    ...
    public static class Sync extends Base
        ...
        @Override
        public AccountingBankFeedAccountsDeleteResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    DeleteBankFeedAccountResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withDeleteBankFeedAccountResponse(out);
                    return res;
                } else {
