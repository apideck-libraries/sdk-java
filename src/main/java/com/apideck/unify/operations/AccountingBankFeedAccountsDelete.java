...
public class AccountingBankFeedAccountsDelete {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingBankFeedAccountsDeleteRequest, AccountingBankFeedAccountsDeleteResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingBankFeedAccountsDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingBankFeedAccountsDeleteRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingBankFeedAccountsDeleteRequest request) {
        ...
        @Override
        public AccountingBankFeedAccountsDeleteResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingBankFeedAccountsDeleteResponse.Builder resBuilder =
            ...
            AccountingBankFeedAccountsDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDeleteBankFeedAccountResponse(Utils.unmarshal(response, new TypeReference<DeleteBankFeedAccountResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingBankFeedAccountsDeleteRequest, com.apideck.unify.models.operations.async.AccountingBankFeedAccountsDeleteResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingBankFeedAccountsDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingBankFeedAccountsDeleteRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingBankFeedAccountsDeleteRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingBankFeedAccountsDeleteResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingBankFeedAccountsDeleteResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingBankFeedAccountsDeleteResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingBankFeedAccountsDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DeleteBankFeedAccountResponse>() {})
                            .thenApply(res::withDeleteBankFeedAccountResponse);
                } else {
