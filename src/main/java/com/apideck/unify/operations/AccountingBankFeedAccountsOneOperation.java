...
public class AccountingBankFeedAccountsOneOperation implements RequestOperation<AccountingBankFeedAccountsOneRequest, AccountingBankFeedAccountsOneResponse> {
    ...
    public AccountingBankFeedAccountsOneOperation(
    ...
    public HttpRequest buildRequest(AccountingBankFeedAccountsOneRequest request) throws Exception {
