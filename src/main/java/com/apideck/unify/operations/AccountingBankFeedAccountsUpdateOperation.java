...
public class AccountingBankFeedAccountsUpdateOperation implements RequestOperation<AccountingBankFeedAccountsUpdateRequest, AccountingBankFeedAccountsUpdateResponse> {
    ...
    public AccountingBankFeedAccountsUpdateOperation(
    ...
    public HttpRequest buildRequest(AccountingBankFeedAccountsUpdateRequest request) throws Exception {
