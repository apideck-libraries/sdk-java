...
public class AccountingBankFeedStatementsAdd {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingBankFeedStatementsAddRequest request) throws Exception {
        ...
        @Override
        public AccountingBankFeedStatementsAddResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    CreateBankFeedStatementResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCreateBankFeedStatementResponse(out);
                    return res;
                } else {
