...
public class AccountingBankFeedStatementsAdd {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingBankFeedStatementsAddRequest, AccountingBankFeedStatementsAddResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingBankFeedStatementsAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingBankFeedStatementsAddRequest.class, new TypeReference<AccountingBankFeedStatementsAddRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingBankFeedStatementsAddRequest request) {
        ...
        @Override
        public AccountingBankFeedStatementsAddResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingBankFeedStatementsAddResponse.Builder resBuilder =
            ...
            AccountingBankFeedStatementsAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCreateBankFeedStatementResponse(Utils.unmarshal(response, new TypeReference<CreateBankFeedStatementResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingBankFeedStatementsAddRequest, com.apideck.unify.models.operations.async.AccountingBankFeedStatementsAddResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingBankFeedStatementsAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingBankFeedStatementsAddRequest.class, new TypeReference<AccountingBankFeedStatementsAddRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingBankFeedStatementsAddRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingBankFeedStatementsAddResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingBankFeedStatementsAddResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingBankFeedStatementsAddResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingBankFeedStatementsAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CreateBankFeedStatementResponse>() {})
                            .thenApply(res::withCreateBankFeedStatementResponse);
                } else {
