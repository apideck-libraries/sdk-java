...
public class AccountingBankFeedStatementsAddOperation implements RequestOperation<AccountingBankFeedStatementsAddRequest, AccountingBankFeedStatementsAddResponse> {
    ...
    public AccountingBankFeedStatementsAddOperation(
    ...
    public HttpRequest buildRequest(AccountingBankFeedStatementsAddRequest request) throws Exception {
