...
public class AccountingBankFeedStatementsAll {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingBankFeedStatementsAllRequest request) throws Exception {
        ...
        @Override
        public AccountingBankFeedStatementsAllResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GetBankFeedStatementsResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGetBankFeedStatementsResponse(out);
                    return res;
                } else {
