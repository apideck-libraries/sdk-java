...
public class AccountingBankFeedStatementsDelete {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingBankFeedStatementsDeleteRequest, AccountingBankFeedStatementsDeleteResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingBankFeedStatementsDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingBankFeedStatementsDeleteRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingBankFeedStatementsDeleteRequest request) {
        ...
        @Override
        public AccountingBankFeedStatementsDeleteResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingBankFeedStatementsDeleteResponse.Builder resBuilder =
            ...
            AccountingBankFeedStatementsDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDeleteBankFeedStatementResponse(Utils.unmarshal(response, new TypeReference<DeleteBankFeedStatementResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingBankFeedStatementsDeleteRequest, com.apideck.unify.models.operations.async.AccountingBankFeedStatementsDeleteResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingBankFeedStatementsDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingBankFeedStatementsDeleteRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingBankFeedStatementsDeleteRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingBankFeedStatementsDeleteResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingBankFeedStatementsDeleteResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingBankFeedStatementsDeleteResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingBankFeedStatementsDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DeleteBankFeedStatementResponse>() {})
                            .thenApply(res::withDeleteBankFeedStatementResponse);
                } else {
