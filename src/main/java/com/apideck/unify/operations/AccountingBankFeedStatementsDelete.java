...
public class AccountingBankFeedStatementsDelete {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingBankFeedStatementsDeleteRequest request) throws Exception {
        ...
        @Override
        public AccountingBankFeedStatementsDeleteResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    DeleteBankFeedStatementResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withDeleteBankFeedStatementResponse(out);
                    return res;
                } else {
