...
public class AccountingBankFeedStatementsOne {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingBankFeedStatementsOneRequest request) throws Exception {
        ...
        @Override
        public AccountingBankFeedStatementsOneResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GetBankFeedStatementResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGetBankFeedStatementResponse(out);
                    return res;
                } else {
