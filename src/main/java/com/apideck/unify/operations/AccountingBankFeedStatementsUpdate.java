...
public class AccountingBankFeedStatementsUpdate {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingBankFeedStatementsUpdateRequest, AccountingBankFeedStatementsUpdateResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingBankFeedStatementsUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingBankFeedStatementsUpdateRequest.class, new TypeReference<AccountingBankFeedStatementsUpdateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingBankFeedStatementsUpdateRequest request) {
        ...
        @Override
        public AccountingBankFeedStatementsUpdateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingBankFeedStatementsUpdateResponse.Builder resBuilder =
            ...
            AccountingBankFeedStatementsUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withUpdateBankFeedStatementResponse(Utils.unmarshal(response, new TypeReference<UpdateBankFeedStatementResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingBankFeedStatementsUpdateRequest, com.apideck.unify.models.operations.async.AccountingBankFeedStatementsUpdateResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingBankFeedStatementsUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingBankFeedStatementsUpdateRequest.class, new TypeReference<AccountingBankFeedStatementsUpdateRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingBankFeedStatementsUpdateRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingBankFeedStatementsUpdateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingBankFeedStatementsUpdateResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingBankFeedStatementsUpdateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingBankFeedStatementsUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<UpdateBankFeedStatementResponse>() {})
                            .thenApply(res::withUpdateBankFeedStatementResponse);
                } else {
