...
public class AccountingBankFeedStatementsUpdate {
    ...
    public static class Sync extends Base
        ...
        @Override
        public AccountingBankFeedStatementsUpdateResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    UpdateBankFeedStatementResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withUpdateBankFeedStatementResponse(out);
                    return res;
                } else {
