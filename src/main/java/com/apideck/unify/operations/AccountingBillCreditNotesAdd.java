...
public class AccountingBillCreditNotesAdd {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingBillCreditNotesAddRequest, AccountingBillCreditNotesAddResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingBillCreditNotesAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingBillCreditNotesAddRequest.class, new TypeReference<AccountingBillCreditNotesAddRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingBillCreditNotesAddRequest request) {
        ...
        @Override
        public AccountingBillCreditNotesAddResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingBillCreditNotesAddResponse.Builder resBuilder =
            ...
            AccountingBillCreditNotesAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCreateBillCreditNoteResponse(Utils.unmarshal(response, new TypeReference<CreateBillCreditNoteResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingBillCreditNotesAddRequest, com.apideck.unify.models.operations.async.AccountingBillCreditNotesAddResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingBillCreditNotesAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingBillCreditNotesAddRequest.class, new TypeReference<AccountingBillCreditNotesAddRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingBillCreditNotesAddRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingBillCreditNotesAddResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingBillCreditNotesAddResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingBillCreditNotesAddResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingBillCreditNotesAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CreateBillCreditNoteResponse>() {})
                            .thenApply(res::withCreateBillCreditNoteResponse);
                } else {
