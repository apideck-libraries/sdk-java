...
public class AccountingBillCreditNotesAll {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingBillCreditNotesAllRequest, AccountingBillCreditNotesAllResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingBillCreditNotesAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingBillCreditNotesAllRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingBillCreditNotesAllRequest request) {
        ...
        @Override
        public AccountingBillCreditNotesAllResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingBillCreditNotesAllResponse.Builder resBuilder =
            ...
            AccountingBillCreditNotesAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetBillCreditNotesResponse(Utils.unmarshal(response, new TypeReference<GetBillCreditNotesResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingBillCreditNotesAllRequest, com.apideck.unify.models.operations.async.AccountingBillCreditNotesAllResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingBillCreditNotesAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingBillCreditNotesAllRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingBillCreditNotesAllRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingBillCreditNotesAllResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingBillCreditNotesAllResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingBillCreditNotesAllResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingBillCreditNotesAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetBillCreditNotesResponse>() {})
                            .thenApply(res::withGetBillCreditNotesResponse);
                } else {
