...
public class AccountingBillCreditNotesDelete {
    ...
    static abstract class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "accounting.billCreditNotesDelete",
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingBillCreditNotesDeleteRequest, AccountingBillCreditNotesDeleteResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingBillCreditNotesDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingBillCreditNotesDeleteRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingBillCreditNotesDeleteRequest request) {
        ...
        @Override
        public AccountingBillCreditNotesDeleteResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingBillCreditNotesDeleteResponse.Builder resBuilder =
            ...
            AccountingBillCreditNotesDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDeleteBillCreditNoteResponse(Utils.unmarshal(response, new TypeReference<DeleteBillCreditNoteResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingBillCreditNotesDeleteRequest, com.apideck.unify.models.operations.async.AccountingBillCreditNotesDeleteResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingBillCreditNotesDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingBillCreditNotesDeleteRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingBillCreditNotesDeleteRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingBillCreditNotesDeleteResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingBillCreditNotesDeleteResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingBillCreditNotesDeleteResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingBillCreditNotesDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DeleteBillCreditNoteResponse>() {})
                            .thenApply(res::withDeleteBillCreditNoteResponse);
                } else {
