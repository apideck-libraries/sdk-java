...
public class AccountingBillCreditNotesUpdate {
    ...
    static abstract class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "accounting.billCreditNotesUpdate",
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingBillCreditNotesUpdateRequest, AccountingBillCreditNotesUpdateResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingBillCreditNotesUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingBillCreditNotesUpdateRequest.class, new TypeReference<AccountingBillCreditNotesUpdateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingBillCreditNotesUpdateRequest request) {
        ...
        @Override
        public AccountingBillCreditNotesUpdateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingBillCreditNotesUpdateResponse.Builder resBuilder =
            ...
            AccountingBillCreditNotesUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withUpdateBillCreditNoteResponse(Utils.unmarshal(response, new TypeReference<UpdateBillCreditNoteResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingBillCreditNotesUpdateRequest, com.apideck.unify.models.operations.async.AccountingBillCreditNotesUpdateResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingBillCreditNotesUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingBillCreditNotesUpdateRequest.class, new TypeReference<AccountingBillCreditNotesUpdateRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingBillCreditNotesUpdateRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingBillCreditNotesUpdateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingBillCreditNotesUpdateResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingBillCreditNotesUpdateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingBillCreditNotesUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<UpdateBillCreditNoteResponse>() {})
                            .thenApply(res::withUpdateBillCreditNoteResponse);
                } else {
