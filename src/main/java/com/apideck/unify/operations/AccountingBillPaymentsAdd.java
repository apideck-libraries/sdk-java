...
public class AccountingBillPaymentsAdd {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingBillPaymentsAddRequest, AccountingBillPaymentsAddResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingBillPaymentsAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingBillPaymentsAddRequest.class, new TypeReference<AccountingBillPaymentsAddRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingBillPaymentsAddRequest request) {
        ...
        @Override
        public AccountingBillPaymentsAddResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingBillPaymentsAddResponse.Builder resBuilder =
            ...
            AccountingBillPaymentsAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCreateBillPaymentResponse(Utils.unmarshal(response, new TypeReference<CreateBillPaymentResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingBillPaymentsAddRequest, com.apideck.unify.models.operations.async.AccountingBillPaymentsAddResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingBillPaymentsAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingBillPaymentsAddRequest.class, new TypeReference<AccountingBillPaymentsAddRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingBillPaymentsAddRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingBillPaymentsAddResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingBillPaymentsAddResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingBillPaymentsAddResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingBillPaymentsAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CreateBillPaymentResponse>() {})
                            .thenApply(res::withCreateBillPaymentResponse);
                } else {
