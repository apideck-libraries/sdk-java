...
public class AccountingBillPaymentsAddOperation implements RequestOperation<AccountingBillPaymentsAddRequest, AccountingBillPaymentsAddResponse> {
    ...
    public AccountingBillPaymentsAddOperation(
    ...
    public HttpRequest buildRequest(AccountingBillPaymentsAddRequest request) throws Exception {
