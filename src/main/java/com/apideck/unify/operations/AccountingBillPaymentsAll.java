...
public class AccountingBillPaymentsAll {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingBillPaymentsAllRequest, AccountingBillPaymentsAllResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingBillPaymentsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingBillPaymentsAllRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingBillPaymentsAllRequest request) {
        ...
        @Override
        public AccountingBillPaymentsAllResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingBillPaymentsAllResponse.Builder resBuilder =
            ...
            AccountingBillPaymentsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetBillPaymentsResponse(Utils.unmarshal(response, new TypeReference<GetBillPaymentsResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingBillPaymentsAllRequest, com.apideck.unify.models.operations.async.AccountingBillPaymentsAllResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingBillPaymentsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingBillPaymentsAllRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingBillPaymentsAllRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingBillPaymentsAllResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingBillPaymentsAllResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingBillPaymentsAllResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingBillPaymentsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetBillPaymentsResponse>() {})
                            .thenApply(res::withGetBillPaymentsResponse);
                } else {
