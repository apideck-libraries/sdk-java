...
public class AccountingBillPaymentsAll {
    ...
    public static class Sync extends Base
        ...
        @Override
        public AccountingBillPaymentsAllResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GetBillPaymentsResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGetBillPaymentsResponse(out);
                    return res;
                } else {
