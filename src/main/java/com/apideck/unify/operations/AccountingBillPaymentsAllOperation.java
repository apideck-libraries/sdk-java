...
public class AccountingBillPaymentsAllOperation implements RequestOperation<AccountingBillPaymentsAllRequest, AccountingBillPaymentsAllResponse> {
    ...
    public AccountingBillPaymentsAllOperation(
    ...
    public HttpRequest buildRequest(AccountingBillPaymentsAllRequest request) throws Exception {
