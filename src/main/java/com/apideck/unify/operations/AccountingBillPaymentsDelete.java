...
public class AccountingBillPaymentsDelete {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingBillPaymentsDeleteRequest, AccountingBillPaymentsDeleteResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingBillPaymentsDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingBillPaymentsDeleteRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingBillPaymentsDeleteRequest request) {
        ...
        @Override
        public AccountingBillPaymentsDeleteResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingBillPaymentsDeleteResponse.Builder resBuilder =
            ...
            AccountingBillPaymentsDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDeleteBillPaymentResponse(Utils.unmarshal(response, new TypeReference<DeleteBillPaymentResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingBillPaymentsDeleteRequest, com.apideck.unify.models.operations.async.AccountingBillPaymentsDeleteResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingBillPaymentsDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingBillPaymentsDeleteRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingBillPaymentsDeleteRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingBillPaymentsDeleteResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingBillPaymentsDeleteResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingBillPaymentsDeleteResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingBillPaymentsDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DeleteBillPaymentResponse>() {})
                            .thenApply(res::withDeleteBillPaymentResponse);
                } else {
