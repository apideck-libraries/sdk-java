...
public class AccountingBillPaymentsDeleteOperation implements RequestOperation<AccountingBillPaymentsDeleteRequest, AccountingBillPaymentsDeleteResponse> {
    ...
    public AccountingBillPaymentsDeleteOperation(
    ...
    public HttpRequest buildRequest(AccountingBillPaymentsDeleteRequest request) throws Exception {
