...
public class AccountingBillPaymentsOne {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingBillPaymentsOneRequest, AccountingBillPaymentsOneResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingBillPaymentsOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingBillPaymentsOneRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingBillPaymentsOneRequest request) {
        ...
        @Override
        public AccountingBillPaymentsOneResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingBillPaymentsOneResponse.Builder resBuilder =
            ...
            AccountingBillPaymentsOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetBillPaymentResponse(Utils.unmarshal(response, new TypeReference<GetBillPaymentResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingBillPaymentsOneRequest, com.apideck.unify.models.operations.async.AccountingBillPaymentsOneResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingBillPaymentsOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingBillPaymentsOneRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingBillPaymentsOneRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingBillPaymentsOneResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingBillPaymentsOneResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingBillPaymentsOneResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingBillPaymentsOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetBillPaymentResponse>() {})
                            .thenApply(res::withGetBillPaymentResponse);
                } else {
