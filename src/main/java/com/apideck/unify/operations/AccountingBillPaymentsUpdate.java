...
public class AccountingBillPaymentsUpdate {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingBillPaymentsUpdateRequest, AccountingBillPaymentsUpdateResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingBillPaymentsUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingBillPaymentsUpdateRequest.class, new TypeReference<AccountingBillPaymentsUpdateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingBillPaymentsUpdateRequest request) {
        ...
        @Override
        public AccountingBillPaymentsUpdateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingBillPaymentsUpdateResponse.Builder resBuilder =
            ...
            AccountingBillPaymentsUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withUpdateBillPaymentResponse(Utils.unmarshal(response, new TypeReference<UpdateBillPaymentResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingBillPaymentsUpdateRequest, com.apideck.unify.models.operations.async.AccountingBillPaymentsUpdateResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingBillPaymentsUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingBillPaymentsUpdateRequest.class, new TypeReference<AccountingBillPaymentsUpdateRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingBillPaymentsUpdateRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingBillPaymentsUpdateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingBillPaymentsUpdateResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingBillPaymentsUpdateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingBillPaymentsUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<UpdateBillPaymentResponse>() {})
                            .thenApply(res::withUpdateBillPaymentResponse);
                } else {
