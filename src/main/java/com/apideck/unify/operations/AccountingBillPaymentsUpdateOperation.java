...
public class AccountingBillPaymentsUpdateOperation implements RequestOperation<AccountingBillPaymentsUpdateRequest, AccountingBillPaymentsUpdateResponse> {
    ...
    public AccountingBillPaymentsUpdateOperation(
    ...
    public HttpRequest buildRequest(AccountingBillPaymentsUpdateRequest request) throws Exception {
