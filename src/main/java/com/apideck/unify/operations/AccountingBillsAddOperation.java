...
public class AccountingBillsAddOperation implements RequestOperation<AccountingBillsAddRequest, AccountingBillsAddResponse> {
    ...
    public AccountingBillsAddOperation(
    ...
    public HttpRequest buildRequest(AccountingBillsAddRequest request) throws Exception {
