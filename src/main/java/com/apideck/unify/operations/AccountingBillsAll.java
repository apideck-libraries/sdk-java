...
public class AccountingBillsAll {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingBillsAllRequest, AccountingBillsAllResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingBillsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingBillsAllRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingBillsAllRequest request) {
        ...
        @Override
        public AccountingBillsAllResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingBillsAllResponse.Builder resBuilder =
            ...
            AccountingBillsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetBillsResponse(Utils.unmarshal(response, new TypeReference<GetBillsResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingBillsAllRequest, com.apideck.unify.models.operations.async.AccountingBillsAllResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingBillsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingBillsAllRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingBillsAllRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingBillsAllResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingBillsAllResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingBillsAllResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingBillsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetBillsResponse>() {})
                            .thenApply(res::withGetBillsResponse);
                } else {
