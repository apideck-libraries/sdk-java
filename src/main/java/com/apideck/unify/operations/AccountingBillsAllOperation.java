...
public class AccountingBillsAllOperation implements RequestOperation<AccountingBillsAllRequest, AccountingBillsAllResponse> {
    ...
    public AccountingBillsAllOperation(
    ...
    public HttpRequest buildRequest(AccountingBillsAllRequest request) throws Exception {
