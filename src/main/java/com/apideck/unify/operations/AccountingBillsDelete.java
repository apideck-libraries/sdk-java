...
public class AccountingBillsDelete {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingBillsDeleteRequest, AccountingBillsDeleteResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingBillsDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingBillsDeleteRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingBillsDeleteRequest request) {
        ...
        @Override
        public AccountingBillsDeleteResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingBillsDeleteResponse.Builder resBuilder =
            ...
            AccountingBillsDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDeleteBillResponse(Utils.unmarshal(response, new TypeReference<DeleteBillResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingBillsDeleteRequest, com.apideck.unify.models.operations.async.AccountingBillsDeleteResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingBillsDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingBillsDeleteRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingBillsDeleteRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingBillsDeleteResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingBillsDeleteResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingBillsDeleteResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingBillsDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DeleteBillResponse>() {})
                            .thenApply(res::withDeleteBillResponse);
                } else {
