...
public class AccountingBillsDeleteOperation implements RequestOperation<AccountingBillsDeleteRequest, AccountingBillsDeleteResponse> {
    ...
    public AccountingBillsDeleteOperation(
    ...
    public HttpRequest buildRequest(AccountingBillsDeleteRequest request) throws Exception {
