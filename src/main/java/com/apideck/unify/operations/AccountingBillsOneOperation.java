...
public class AccountingBillsOneOperation implements RequestOperation<AccountingBillsOneRequest, AccountingBillsOneResponse> {
    ...
    public AccountingBillsOneOperation(
    ...
    public HttpRequest buildRequest(AccountingBillsOneRequest request) throws Exception {
