...
public class AccountingBillsUpdateOperation implements RequestOperation<AccountingBillsUpdateRequest, AccountingBillsUpdateResponse> {
    ...
    public AccountingBillsUpdateOperation(
    ...
    public HttpRequest buildRequest(AccountingBillsUpdateRequest request) throws Exception {
