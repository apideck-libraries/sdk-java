...
public class AccountingCategoriesAll {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingCategoriesAllRequest, AccountingCategoriesAllResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingCategoriesAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingCategoriesAllRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingCategoriesAllRequest request) {
        ...
        @Override
        public AccountingCategoriesAllResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingCategoriesAllResponse.Builder resBuilder =
            ...
            AccountingCategoriesAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetCategoriesResponse(Utils.unmarshal(response, new TypeReference<GetCategoriesResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingCategoriesAllRequest, com.apideck.unify.models.operations.async.AccountingCategoriesAllResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingCategoriesAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingCategoriesAllRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingCategoriesAllRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingCategoriesAllResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingCategoriesAllResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingCategoriesAllResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingCategoriesAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetCategoriesResponse>() {})
                            .thenApply(res::withGetCategoriesResponse);
                } else {
