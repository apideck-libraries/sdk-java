...
public class AccountingCategoriesAllOperation implements RequestOperation<AccountingCategoriesAllRequest, AccountingCategoriesAllResponse> {
    ...
    public AccountingCategoriesAllOperation(
    ...
    public HttpRequest buildRequest(AccountingCategoriesAllRequest request) throws Exception {
