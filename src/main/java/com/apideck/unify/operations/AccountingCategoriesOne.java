...
public class AccountingCategoriesOne {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingCategoriesOneRequest, AccountingCategoriesOneResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingCategoriesOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingCategoriesOneRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingCategoriesOneRequest request) {
        ...
        @Override
        public AccountingCategoriesOneResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingCategoriesOneResponse.Builder resBuilder =
            ...
            AccountingCategoriesOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetCategoryResponse(Utils.unmarshal(response, new TypeReference<GetCategoryResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingCategoriesOneRequest, com.apideck.unify.models.operations.async.AccountingCategoriesOneResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingCategoriesOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingCategoriesOneRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingCategoriesOneRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingCategoriesOneResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingCategoriesOneResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingCategoriesOneResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingCategoriesOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetCategoryResponse>() {})
                            .thenApply(res::withGetCategoryResponse);
                } else {
