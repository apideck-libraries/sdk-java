...
public class AccountingCategoriesOneOperation implements RequestOperation<AccountingCategoriesOneRequest, AccountingCategoriesOneResponse> {
    ...
    public AccountingCategoriesOneOperation(
    ...
    public HttpRequest buildRequest(AccountingCategoriesOneRequest request) throws Exception {
