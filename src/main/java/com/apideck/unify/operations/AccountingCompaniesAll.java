...
public class AccountingCompaniesAll {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingCompaniesAllRequest, AccountingCompaniesAllResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingCompaniesAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingCompaniesAllRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingCompaniesAllRequest request) {
        ...
        @Override
        public AccountingCompaniesAllResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingCompaniesAllResponse.Builder resBuilder =
            ...
            AccountingCompaniesAllResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingCompaniesAllRequest, com.apideck.unify.models.operations.async.AccountingCompaniesAllResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingCompaniesAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingCompaniesAllRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingCompaniesAllRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingCompaniesAllResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingCompaniesAllResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingCompaniesAllResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingCompaniesAllResponse res = resBuilder.build();
