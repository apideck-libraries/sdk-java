...
public class AccountingCompanyInfoOne {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingCompanyInfoOneRequest request) throws Exception {
        ...
        @Override
        public AccountingCompanyInfoOneResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GetCompanyInfoResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGetCompanyInfoResponse(out);
                    return res;
                } else {
