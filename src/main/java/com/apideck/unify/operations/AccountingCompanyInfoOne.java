...
public class AccountingCompanyInfoOne {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingCompanyInfoOneRequest, AccountingCompanyInfoOneResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingCompanyInfoOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingCompanyInfoOneRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingCompanyInfoOneRequest request) {
        ...
        @Override
        public AccountingCompanyInfoOneResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingCompanyInfoOneResponse.Builder resBuilder =
            ...
            AccountingCompanyInfoOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetCompanyInfoResponse(Utils.unmarshal(response, new TypeReference<GetCompanyInfoResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingCompanyInfoOneRequest, com.apideck.unify.models.operations.async.AccountingCompanyInfoOneResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingCompanyInfoOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingCompanyInfoOneRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingCompanyInfoOneRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingCompanyInfoOneResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingCompanyInfoOneResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingCompanyInfoOneResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingCompanyInfoOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetCompanyInfoResponse>() {})
                            .thenApply(res::withGetCompanyInfoResponse);
                } else {
