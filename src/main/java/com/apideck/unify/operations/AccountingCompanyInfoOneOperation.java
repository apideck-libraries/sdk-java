...
public class AccountingCompanyInfoOneOperation implements RequestOperation<AccountingCompanyInfoOneRequest, AccountingCompanyInfoOneResponse> {
    ...
    public AccountingCompanyInfoOneOperation(
    ...
    public HttpRequest buildRequest(AccountingCompanyInfoOneRequest request) throws Exception {
