...
public class AccountingCreditNotesAdd {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingCreditNotesAddRequest, AccountingCreditNotesAddResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingCreditNotesAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingCreditNotesAddRequest.class, new TypeReference<AccountingCreditNotesAddRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingCreditNotesAddRequest request) {
        ...
        @Override
        public AccountingCreditNotesAddResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingCreditNotesAddResponse.Builder resBuilder =
            ...
            AccountingCreditNotesAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCreateCreditNoteResponse(Utils.unmarshal(response, new TypeReference<CreateCreditNoteResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingCreditNotesAddRequest, com.apideck.unify.models.operations.async.AccountingCreditNotesAddResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingCreditNotesAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingCreditNotesAddRequest.class, new TypeReference<AccountingCreditNotesAddRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingCreditNotesAddRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingCreditNotesAddResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingCreditNotesAddResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingCreditNotesAddResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingCreditNotesAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CreateCreditNoteResponse>() {})
                            .thenApply(res::withCreateCreditNoteResponse);
                } else {
