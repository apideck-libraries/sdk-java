...
public class AccountingCreditNotesAddOperation implements RequestOperation<AccountingCreditNotesAddRequest, AccountingCreditNotesAddResponse> {
    ...
    public AccountingCreditNotesAddOperation(
    ...
    public HttpRequest buildRequest(AccountingCreditNotesAddRequest request) throws Exception {
