...
public class AccountingCreditNotesAll {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingCreditNotesAllRequest, AccountingCreditNotesAllResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingCreditNotesAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingCreditNotesAllRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingCreditNotesAllRequest request) {
        ...
        @Override
        public AccountingCreditNotesAllResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingCreditNotesAllResponse.Builder resBuilder =
            ...
            AccountingCreditNotesAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetCreditNotesResponse(Utils.unmarshal(response, new TypeReference<GetCreditNotesResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingCreditNotesAllRequest, com.apideck.unify.models.operations.async.AccountingCreditNotesAllResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingCreditNotesAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingCreditNotesAllRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingCreditNotesAllRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingCreditNotesAllResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingCreditNotesAllResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingCreditNotesAllResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingCreditNotesAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetCreditNotesResponse>() {})
                            .thenApply(res::withGetCreditNotesResponse);
                } else {
