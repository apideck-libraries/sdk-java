...
public class AccountingCreditNotesAllOperation implements RequestOperation<AccountingCreditNotesAllRequest, AccountingCreditNotesAllResponse> {
    ...
    public AccountingCreditNotesAllOperation(
    ...
    public HttpRequest buildRequest(AccountingCreditNotesAllRequest request) throws Exception {
