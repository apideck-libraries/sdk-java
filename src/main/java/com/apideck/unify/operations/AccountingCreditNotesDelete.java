...
public class AccountingCreditNotesDelete {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingCreditNotesDeleteRequest, AccountingCreditNotesDeleteResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingCreditNotesDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingCreditNotesDeleteRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingCreditNotesDeleteRequest request) {
        ...
        @Override
        public AccountingCreditNotesDeleteResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingCreditNotesDeleteResponse.Builder resBuilder =
            ...
            AccountingCreditNotesDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDeleteCreditNoteResponse(Utils.unmarshal(response, new TypeReference<DeleteCreditNoteResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingCreditNotesDeleteRequest, com.apideck.unify.models.operations.async.AccountingCreditNotesDeleteResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingCreditNotesDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingCreditNotesDeleteRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingCreditNotesDeleteRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingCreditNotesDeleteResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingCreditNotesDeleteResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingCreditNotesDeleteResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingCreditNotesDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DeleteCreditNoteResponse>() {})
                            .thenApply(res::withDeleteCreditNoteResponse);
                } else {
