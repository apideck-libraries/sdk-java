...
public class AccountingCreditNotesDeleteOperation implements RequestOperation<AccountingCreditNotesDeleteRequest, AccountingCreditNotesDeleteResponse> {
    ...
    public AccountingCreditNotesDeleteOperation(
    ...
    public HttpRequest buildRequest(AccountingCreditNotesDeleteRequest request) throws Exception {
