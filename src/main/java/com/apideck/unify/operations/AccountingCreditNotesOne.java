...
public class AccountingCreditNotesOne {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingCreditNotesOneRequest, AccountingCreditNotesOneResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingCreditNotesOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingCreditNotesOneRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingCreditNotesOneRequest request) {
        ...
        @Override
        public AccountingCreditNotesOneResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingCreditNotesOneResponse.Builder resBuilder =
            ...
            AccountingCreditNotesOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetCreditNoteResponse(Utils.unmarshal(response, new TypeReference<GetCreditNoteResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingCreditNotesOneRequest, com.apideck.unify.models.operations.async.AccountingCreditNotesOneResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingCreditNotesOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingCreditNotesOneRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingCreditNotesOneRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingCreditNotesOneResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingCreditNotesOneResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingCreditNotesOneResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingCreditNotesOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetCreditNoteResponse>() {})
                            .thenApply(res::withGetCreditNoteResponse);
                } else {
