...
public class AccountingCreditNotesOneOperation implements RequestOperation<AccountingCreditNotesOneRequest, AccountingCreditNotesOneResponse> {
    ...
    public AccountingCreditNotesOneOperation(
    ...
    public HttpRequest buildRequest(AccountingCreditNotesOneRequest request) throws Exception {
