...
public class AccountingCreditNotesUpdate {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingCreditNotesUpdateRequest request) throws Exception {
        ...
        @Override
        public AccountingCreditNotesUpdateResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    UpdateCreditNoteResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withUpdateCreditNoteResponse(out);
                    return res;
                } else {
