...
public class AccountingCreditNotesUpdate {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingCreditNotesUpdateRequest, AccountingCreditNotesUpdateResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingCreditNotesUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingCreditNotesUpdateRequest.class, new TypeReference<AccountingCreditNotesUpdateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingCreditNotesUpdateRequest request) {
        ...
        @Override
        public AccountingCreditNotesUpdateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingCreditNotesUpdateResponse.Builder resBuilder =
            ...
            AccountingCreditNotesUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withUpdateCreditNoteResponse(Utils.unmarshal(response, new TypeReference<UpdateCreditNoteResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingCreditNotesUpdateRequest, com.apideck.unify.models.operations.async.AccountingCreditNotesUpdateResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingCreditNotesUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingCreditNotesUpdateRequest.class, new TypeReference<AccountingCreditNotesUpdateRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingCreditNotesUpdateRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingCreditNotesUpdateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingCreditNotesUpdateResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingCreditNotesUpdateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingCreditNotesUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<UpdateCreditNoteResponse>() {})
                            .thenApply(res::withUpdateCreditNoteResponse);
                } else {
