...
public class AccountingCreditNotesUpdateOperation implements RequestOperation<AccountingCreditNotesUpdateRequest, AccountingCreditNotesUpdateResponse> {
    ...
    public AccountingCreditNotesUpdateOperation(
    ...
    public HttpRequest buildRequest(AccountingCreditNotesUpdateRequest request) throws Exception {
