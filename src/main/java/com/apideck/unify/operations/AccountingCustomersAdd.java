...
public class AccountingCustomersAdd {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingCustomersAddRequest, AccountingCustomersAddResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingCustomersAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingCustomersAddRequest.class, new TypeReference<AccountingCustomersAddRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingCustomersAddRequest request) {
        ...
        @Override
        public AccountingCustomersAddResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingCustomersAddResponse.Builder resBuilder =
            ...
            AccountingCustomersAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCreateCustomerResponse(Utils.unmarshal(response, new TypeReference<CreateCustomerResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingCustomersAddRequest, com.apideck.unify.models.operations.async.AccountingCustomersAddResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingCustomersAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingCustomersAddRequest.class, new TypeReference<AccountingCustomersAddRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingCustomersAddRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingCustomersAddResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingCustomersAddResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingCustomersAddResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingCustomersAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CreateCustomerResponse>() {})
                            .thenApply(res::withCreateCustomerResponse);
                } else {
