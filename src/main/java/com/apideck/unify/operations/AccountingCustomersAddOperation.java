...
public class AccountingCustomersAddOperation implements RequestOperation<AccountingCustomersAddRequest, AccountingCustomersAddResponse> {
    ...
    public AccountingCustomersAddOperation(
    ...
    public HttpRequest buildRequest(AccountingCustomersAddRequest request) throws Exception {
