...
public class AccountingCustomersAll {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingCustomersAllRequest, AccountingCustomersAllResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingCustomersAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingCustomersAllRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingCustomersAllRequest request) {
        ...
        @Override
        public AccountingCustomersAllResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingCustomersAllResponse.Builder resBuilder =
            ...
            AccountingCustomersAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetCustomersResponse(Utils.unmarshal(response, new TypeReference<GetCustomersResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingCustomersAllRequest, com.apideck.unify.models.operations.async.AccountingCustomersAllResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingCustomersAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingCustomersAllRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingCustomersAllRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingCustomersAllResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingCustomersAllResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingCustomersAllResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingCustomersAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetCustomersResponse>() {})
                            .thenApply(res::withGetCustomersResponse);
                } else {
