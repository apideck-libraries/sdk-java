...
public class AccountingCustomersAllOperation implements RequestOperation<AccountingCustomersAllRequest, AccountingCustomersAllResponse> {
    ...
    public AccountingCustomersAllOperation(
    ...
    public HttpRequest buildRequest(AccountingCustomersAllRequest request) throws Exception {
