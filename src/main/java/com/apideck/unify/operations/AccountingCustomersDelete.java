...
public class AccountingCustomersDelete {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingCustomersDeleteRequest, AccountingCustomersDeleteResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingCustomersDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingCustomersDeleteRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingCustomersDeleteRequest request) {
        ...
        @Override
        public AccountingCustomersDeleteResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingCustomersDeleteResponse.Builder resBuilder =
            ...
            AccountingCustomersDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDeleteCustomerResponse(Utils.unmarshal(response, new TypeReference<DeleteCustomerResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingCustomersDeleteRequest, com.apideck.unify.models.operations.async.AccountingCustomersDeleteResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingCustomersDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingCustomersDeleteRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingCustomersDeleteRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingCustomersDeleteResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingCustomersDeleteResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingCustomersDeleteResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingCustomersDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DeleteCustomerResponse>() {})
                            .thenApply(res::withDeleteCustomerResponse);
                } else {
