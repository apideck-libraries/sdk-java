...
public class AccountingCustomersDeleteOperation implements RequestOperation<AccountingCustomersDeleteRequest, AccountingCustomersDeleteResponse> {
    ...
    public AccountingCustomersDeleteOperation(
    ...
    public HttpRequest buildRequest(AccountingCustomersDeleteRequest request) throws Exception {
