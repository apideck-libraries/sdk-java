...
public class AccountingCustomersOne {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingCustomersOneRequest, AccountingCustomersOneResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingCustomersOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingCustomersOneRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingCustomersOneRequest request) {
        ...
        @Override
        public AccountingCustomersOneResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingCustomersOneResponse.Builder resBuilder =
            ...
            AccountingCustomersOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetCustomerResponse(Utils.unmarshal(response, new TypeReference<GetCustomerResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingCustomersOneRequest, com.apideck.unify.models.operations.async.AccountingCustomersOneResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingCustomersOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingCustomersOneRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingCustomersOneRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingCustomersOneResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingCustomersOneResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingCustomersOneResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingCustomersOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetCustomerResponse>() {})
                            .thenApply(res::withGetCustomerResponse);
                } else {
