...
public class AccountingCustomersOneOperation implements RequestOperation<AccountingCustomersOneRequest, AccountingCustomersOneResponse> {
    ...
    public AccountingCustomersOneOperation(
    ...
    public HttpRequest buildRequest(AccountingCustomersOneRequest request) throws Exception {
