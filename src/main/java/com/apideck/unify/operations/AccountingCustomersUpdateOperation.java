...
public class AccountingCustomersUpdateOperation implements RequestOperation<AccountingCustomersUpdateRequest, AccountingCustomersUpdateResponse> {
    ...
    public AccountingCustomersUpdateOperation(
    ...
    public HttpRequest buildRequest(AccountingCustomersUpdateRequest request) throws Exception {
