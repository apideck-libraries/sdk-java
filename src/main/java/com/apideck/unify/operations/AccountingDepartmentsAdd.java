...
public class AccountingDepartmentsAdd {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingDepartmentsAddRequest request) throws Exception {
        ...
        @Override
        public AccountingDepartmentsAddResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    CreateAccountingDepartmentResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCreateAccountingDepartmentResponse(out);
                    return res;
                } else {
