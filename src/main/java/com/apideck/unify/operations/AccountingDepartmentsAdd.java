...
public class AccountingDepartmentsAdd {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingDepartmentsAddRequest, AccountingDepartmentsAddResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingDepartmentsAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingDepartmentsAddRequest.class, new TypeReference<AccountingDepartmentsAddRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingDepartmentsAddRequest request) {
        ...
        @Override
        public AccountingDepartmentsAddResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingDepartmentsAddResponse.Builder resBuilder =
            ...
            AccountingDepartmentsAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCreateAccountingDepartmentResponse(Utils.unmarshal(response, new TypeReference<CreateAccountingDepartmentResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingDepartmentsAddRequest, com.apideck.unify.models.operations.async.AccountingDepartmentsAddResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingDepartmentsAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingDepartmentsAddRequest.class, new TypeReference<AccountingDepartmentsAddRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingDepartmentsAddRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingDepartmentsAddResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingDepartmentsAddResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingDepartmentsAddResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingDepartmentsAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CreateAccountingDepartmentResponse>() {})
                            .thenApply(res::withCreateAccountingDepartmentResponse);
                } else {
