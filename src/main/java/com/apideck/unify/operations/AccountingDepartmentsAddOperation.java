...
public class AccountingDepartmentsAddOperation implements RequestOperation<AccountingDepartmentsAddRequest, AccountingDepartmentsAddResponse> {
    ...
    public AccountingDepartmentsAddOperation(
    ...
    public HttpRequest buildRequest(AccountingDepartmentsAddRequest request) throws Exception {
