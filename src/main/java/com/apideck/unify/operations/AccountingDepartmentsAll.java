...
public class AccountingDepartmentsAll {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingDepartmentsAllRequest request) throws Exception {
        ...
        @Override
        public AccountingDepartmentsAllResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GetAccountingDepartmentsResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGetAccountingDepartmentsResponse(out);
                    return res;
                } else {
