...
public class AccountingDepartmentsAll {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingDepartmentsAllRequest, AccountingDepartmentsAllResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingDepartmentsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingDepartmentsAllRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingDepartmentsAllRequest request) {
        ...
        @Override
        public AccountingDepartmentsAllResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingDepartmentsAllResponse.Builder resBuilder =
            ...
            AccountingDepartmentsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetAccountingDepartmentsResponse(Utils.unmarshal(response, new TypeReference<GetAccountingDepartmentsResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingDepartmentsAllRequest, com.apideck.unify.models.operations.async.AccountingDepartmentsAllResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingDepartmentsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingDepartmentsAllRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingDepartmentsAllRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingDepartmentsAllResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingDepartmentsAllResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingDepartmentsAllResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingDepartmentsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetAccountingDepartmentsResponse>() {})
                            .thenApply(res::withGetAccountingDepartmentsResponse);
                } else {
