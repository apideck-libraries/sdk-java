...
public class AccountingDepartmentsAllOperation implements RequestOperation<AccountingDepartmentsAllRequest, AccountingDepartmentsAllResponse> {
    ...
    public AccountingDepartmentsAllOperation(
    ...
    public HttpRequest buildRequest(AccountingDepartmentsAllRequest request) throws Exception {
