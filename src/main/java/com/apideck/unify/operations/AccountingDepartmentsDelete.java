...
public class AccountingDepartmentsDelete {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingDepartmentsDeleteRequest, AccountingDepartmentsDeleteResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingDepartmentsDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingDepartmentsDeleteRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingDepartmentsDeleteRequest request) {
        ...
        @Override
        public AccountingDepartmentsDeleteResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingDepartmentsDeleteResponse.Builder resBuilder =
            ...
            AccountingDepartmentsDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDeleteAccountingDepartmentResponse(Utils.unmarshal(response, new TypeReference<DeleteAccountingDepartmentResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingDepartmentsDeleteRequest, com.apideck.unify.models.operations.async.AccountingDepartmentsDeleteResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingDepartmentsDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingDepartmentsDeleteRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingDepartmentsDeleteRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingDepartmentsDeleteResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingDepartmentsDeleteResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingDepartmentsDeleteResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingDepartmentsDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DeleteAccountingDepartmentResponse>() {})
                            .thenApply(res::withDeleteAccountingDepartmentResponse);
                } else {
