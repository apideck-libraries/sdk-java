...
public class AccountingDepartmentsDeleteOperation implements RequestOperation<AccountingDepartmentsDeleteRequest, AccountingDepartmentsDeleteResponse> {
    ...
    public AccountingDepartmentsDeleteOperation(
    ...
    public HttpRequest buildRequest(AccountingDepartmentsDeleteRequest request) throws Exception {
