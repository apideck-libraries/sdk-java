...
public class AccountingDepartmentsOne {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingDepartmentsOneRequest, AccountingDepartmentsOneResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingDepartmentsOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingDepartmentsOneRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingDepartmentsOneRequest request) {
        ...
        @Override
        public AccountingDepartmentsOneResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingDepartmentsOneResponse.Builder resBuilder =
            ...
            AccountingDepartmentsOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetAccountingDepartmentResponse(Utils.unmarshal(response, new TypeReference<GetAccountingDepartmentResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingDepartmentsOneRequest, com.apideck.unify.models.operations.async.AccountingDepartmentsOneResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingDepartmentsOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingDepartmentsOneRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingDepartmentsOneRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingDepartmentsOneResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingDepartmentsOneResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingDepartmentsOneResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingDepartmentsOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetAccountingDepartmentResponse>() {})
                            .thenApply(res::withGetAccountingDepartmentResponse);
                } else {
