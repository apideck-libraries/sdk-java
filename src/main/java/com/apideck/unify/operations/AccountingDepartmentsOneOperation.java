...
public class AccountingDepartmentsOneOperation implements RequestOperation<AccountingDepartmentsOneRequest, AccountingDepartmentsOneResponse> {
    ...
    public AccountingDepartmentsOneOperation(
    ...
    public HttpRequest buildRequest(AccountingDepartmentsOneRequest request) throws Exception {
