...
public class AccountingDepartmentsUpdate {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingDepartmentsUpdateRequest request) throws Exception {
        ...
        @Override
        public AccountingDepartmentsUpdateResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    UpdateAccountingDepartmentResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withUpdateAccountingDepartmentResponse(out);
                    return res;
                } else {
