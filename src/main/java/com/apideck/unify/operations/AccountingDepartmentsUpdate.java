...
public class AccountingDepartmentsUpdate {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingDepartmentsUpdateRequest, AccountingDepartmentsUpdateResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingDepartmentsUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingDepartmentsUpdateRequest.class, new TypeReference<AccountingDepartmentsUpdateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingDepartmentsUpdateRequest request) {
        ...
        @Override
        public AccountingDepartmentsUpdateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingDepartmentsUpdateResponse.Builder resBuilder =
            ...
            AccountingDepartmentsUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withUpdateAccountingDepartmentResponse(Utils.unmarshal(response, new TypeReference<UpdateAccountingDepartmentResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingDepartmentsUpdateRequest, com.apideck.unify.models.operations.async.AccountingDepartmentsUpdateResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingDepartmentsUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingDepartmentsUpdateRequest.class, new TypeReference<AccountingDepartmentsUpdateRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingDepartmentsUpdateRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingDepartmentsUpdateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingDepartmentsUpdateResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingDepartmentsUpdateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingDepartmentsUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<UpdateAccountingDepartmentResponse>() {})
                            .thenApply(res::withUpdateAccountingDepartmentResponse);
                } else {
