...
public class AccountingDepartmentsUpdateOperation implements RequestOperation<AccountingDepartmentsUpdateRequest, AccountingDepartmentsUpdateResponse> {
    ...
    public AccountingDepartmentsUpdateOperation(
    ...
    public HttpRequest buildRequest(AccountingDepartmentsUpdateRequest request) throws Exception {
