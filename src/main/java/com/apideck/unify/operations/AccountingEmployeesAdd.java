...
public class AccountingEmployeesAdd {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingEmployeesAddRequest, AccountingEmployeesAddResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingEmployeesAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingEmployeesAddRequest.class, new TypeReference<AccountingEmployeesAddRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingEmployeesAddRequest request) {
        ...
        @Override
        public AccountingEmployeesAddResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingEmployeesAddResponse.Builder resBuilder =
            ...
            AccountingEmployeesAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCreateAccountingEmployeeResponse(Utils.unmarshal(response, new TypeReference<CreateAccountingEmployeeResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingEmployeesAddRequest, com.apideck.unify.models.operations.async.AccountingEmployeesAddResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingEmployeesAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingEmployeesAddRequest.class, new TypeReference<AccountingEmployeesAddRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingEmployeesAddRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingEmployeesAddResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingEmployeesAddResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingEmployeesAddResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingEmployeesAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CreateAccountingEmployeeResponse>() {})
                            .thenApply(res::withCreateAccountingEmployeeResponse);
                } else {
