...
public class AccountingEmployeesAll {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingEmployeesAllRequest, AccountingEmployeesAllResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingEmployeesAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingEmployeesAllRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingEmployeesAllRequest request) {
        ...
        @Override
        public AccountingEmployeesAllResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingEmployeesAllResponse.Builder resBuilder =
            ...
            AccountingEmployeesAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetAccountingEmployeesResponse(Utils.unmarshal(response, new TypeReference<GetAccountingEmployeesResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingEmployeesAllRequest, com.apideck.unify.models.operations.async.AccountingEmployeesAllResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingEmployeesAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingEmployeesAllRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingEmployeesAllRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingEmployeesAllResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingEmployeesAllResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingEmployeesAllResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingEmployeesAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetAccountingEmployeesResponse>() {})
                            .thenApply(res::withGetAccountingEmployeesResponse);
                } else {
