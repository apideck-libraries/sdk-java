...
public class AccountingEmployeesDelete {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingEmployeesDeleteRequest, AccountingEmployeesDeleteResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingEmployeesDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingEmployeesDeleteRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingEmployeesDeleteRequest request) {
        ...
        @Override
        public AccountingEmployeesDeleteResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingEmployeesDeleteResponse.Builder resBuilder =
            ...
            AccountingEmployeesDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDeleteAccountingEmployeeResponse(Utils.unmarshal(response, new TypeReference<DeleteAccountingEmployeeResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingEmployeesDeleteRequest, com.apideck.unify.models.operations.async.AccountingEmployeesDeleteResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingEmployeesDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingEmployeesDeleteRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingEmployeesDeleteRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingEmployeesDeleteResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingEmployeesDeleteResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingEmployeesDeleteResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingEmployeesDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DeleteAccountingEmployeeResponse>() {})
                            .thenApply(res::withDeleteAccountingEmployeeResponse);
                } else {
