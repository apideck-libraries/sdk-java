...
public class AccountingEmployeesOne {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingEmployeesOneRequest, AccountingEmployeesOneResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingEmployeesOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingEmployeesOneRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingEmployeesOneRequest request) {
        ...
        @Override
        public AccountingEmployeesOneResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingEmployeesOneResponse.Builder resBuilder =
            ...
            AccountingEmployeesOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetAccountingEmployeeResponse(Utils.unmarshal(response, new TypeReference<GetAccountingEmployeeResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingEmployeesOneRequest, com.apideck.unify.models.operations.async.AccountingEmployeesOneResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingEmployeesOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingEmployeesOneRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingEmployeesOneRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingEmployeesOneResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingEmployeesOneResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingEmployeesOneResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingEmployeesOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetAccountingEmployeeResponse>() {})
                            .thenApply(res::withGetAccountingEmployeeResponse);
                } else {
