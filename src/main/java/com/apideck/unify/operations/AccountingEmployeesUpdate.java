...
public class AccountingEmployeesUpdate {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingEmployeesUpdateRequest, AccountingEmployeesUpdateResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingEmployeesUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingEmployeesUpdateRequest.class, new TypeReference<AccountingEmployeesUpdateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingEmployeesUpdateRequest request) {
        ...
        @Override
        public AccountingEmployeesUpdateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingEmployeesUpdateResponse.Builder resBuilder =
            ...
            AccountingEmployeesUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withUpdateAccountingEmployeeResponse(Utils.unmarshal(response, new TypeReference<UpdateAccountingEmployeeResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingEmployeesUpdateRequest, com.apideck.unify.models.operations.async.AccountingEmployeesUpdateResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingEmployeesUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingEmployeesUpdateRequest.class, new TypeReference<AccountingEmployeesUpdateRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingEmployeesUpdateRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingEmployeesUpdateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingEmployeesUpdateResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingEmployeesUpdateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingEmployeesUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<UpdateAccountingEmployeeResponse>() {})
                            .thenApply(res::withUpdateAccountingEmployeeResponse);
                } else {
