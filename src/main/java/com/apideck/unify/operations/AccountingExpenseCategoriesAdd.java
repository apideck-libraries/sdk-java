...
public class AccountingExpenseCategoriesAdd {
    ...
    static abstract class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "accounting.expenseCategoriesAdd",
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingExpenseCategoriesAddRequest, AccountingExpenseCategoriesAddResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingExpenseCategoriesAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingExpenseCategoriesAddRequest.class, new TypeReference<AccountingExpenseCategoriesAddRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingExpenseCategoriesAddRequest request) {
        ...
        @Override
        public AccountingExpenseCategoriesAddResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingExpenseCategoriesAddResponse.Builder resBuilder =
            ...
            AccountingExpenseCategoriesAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCreateExpenseCategoryResponse(Utils.unmarshal(response, new TypeReference<CreateExpenseCategoryResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingExpenseCategoriesAddRequest, com.apideck.unify.models.operations.async.AccountingExpenseCategoriesAddResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingExpenseCategoriesAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingExpenseCategoriesAddRequest.class, new TypeReference<AccountingExpenseCategoriesAddRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingExpenseCategoriesAddRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingExpenseCategoriesAddResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingExpenseCategoriesAddResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingExpenseCategoriesAddResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingExpenseCategoriesAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CreateExpenseCategoryResponse>() {})
                            .thenApply(res::withCreateExpenseCategoryResponse);
                } else {
