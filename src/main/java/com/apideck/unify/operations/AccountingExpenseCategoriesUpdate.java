...
public class AccountingExpenseCategoriesUpdate {
    ...
    static abstract class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "accounting.expenseCategoriesUpdate",
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingExpenseCategoriesUpdateRequest, AccountingExpenseCategoriesUpdateResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingExpenseCategoriesUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingExpenseCategoriesUpdateRequest.class, new TypeReference<AccountingExpenseCategoriesUpdateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingExpenseCategoriesUpdateRequest request) {
        ...
        @Override
        public AccountingExpenseCategoriesUpdateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingExpenseCategoriesUpdateResponse.Builder resBuilder =
            ...
            AccountingExpenseCategoriesUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withUpdateExpenseCategoryResponse(Utils.unmarshal(response, new TypeReference<UpdateExpenseCategoryResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingExpenseCategoriesUpdateRequest, com.apideck.unify.models.operations.async.AccountingExpenseCategoriesUpdateResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingExpenseCategoriesUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingExpenseCategoriesUpdateRequest.class, new TypeReference<AccountingExpenseCategoriesUpdateRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingExpenseCategoriesUpdateRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingExpenseCategoriesUpdateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingExpenseCategoriesUpdateResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingExpenseCategoriesUpdateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingExpenseCategoriesUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<UpdateExpenseCategoryResponse>() {})
                            .thenApply(res::withUpdateExpenseCategoryResponse);
                } else {
