...
public class AccountingExpenseReportsAll {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingExpenseReportsAllRequest, AccountingExpenseReportsAllResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingExpenseReportsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingExpenseReportsAllRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingExpenseReportsAllRequest request) {
        ...
        @Override
        public AccountingExpenseReportsAllResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingExpenseReportsAllResponse.Builder resBuilder =
            ...
            AccountingExpenseReportsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetExpenseReportsResponse(Utils.unmarshal(response, new TypeReference<GetExpenseReportsResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingExpenseReportsAllRequest, com.apideck.unify.models.operations.async.AccountingExpenseReportsAllResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingExpenseReportsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingExpenseReportsAllRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingExpenseReportsAllRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingExpenseReportsAllResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingExpenseReportsAllResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingExpenseReportsAllResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingExpenseReportsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetExpenseReportsResponse>() {})
                            .thenApply(res::withGetExpenseReportsResponse);
                } else {
