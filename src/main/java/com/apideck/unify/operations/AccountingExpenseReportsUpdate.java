...
public class AccountingExpenseReportsUpdate {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingExpenseReportsUpdateRequest, AccountingExpenseReportsUpdateResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingExpenseReportsUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingExpenseReportsUpdateRequest.class, new TypeReference<AccountingExpenseReportsUpdateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingExpenseReportsUpdateRequest request) {
        ...
        @Override
        public AccountingExpenseReportsUpdateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingExpenseReportsUpdateResponse.Builder resBuilder =
            ...
            AccountingExpenseReportsUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withUpdateExpenseReportResponse(Utils.unmarshal(response, new TypeReference<UpdateExpenseReportResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingExpenseReportsUpdateRequest, com.apideck.unify.models.operations.async.AccountingExpenseReportsUpdateResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingExpenseReportsUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingExpenseReportsUpdateRequest.class, new TypeReference<AccountingExpenseReportsUpdateRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingExpenseReportsUpdateRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingExpenseReportsUpdateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingExpenseReportsUpdateResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingExpenseReportsUpdateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingExpenseReportsUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<UpdateExpenseReportResponse>() {})
                            .thenApply(res::withUpdateExpenseReportResponse);
                } else {
