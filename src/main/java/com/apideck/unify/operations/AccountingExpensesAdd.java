...
public class AccountingExpensesAdd {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(AccountingExpensesAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingExpensesAddRequest.class, new TypeReference<AccountingExpensesAddRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingExpensesAddRequest request) {
        ...
        @Override
        public AccountingExpensesAddResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCreateExpenseResponse(Utils.unmarshal(response, new TypeReference<CreateExpenseResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingExpensesAddRequest, com.apideck.unify.models.operations.async.AccountingExpensesAddResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingExpensesAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingExpensesAddRequest.class, new TypeReference<AccountingExpensesAddRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingExpensesAddRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingExpensesAddResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingExpensesAddResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingExpensesAddResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingExpensesAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CreateExpenseResponse>() {})
                            .thenApply(res::withCreateExpenseResponse);
                } else {
