...
public class AccountingExpensesAllOperation implements RequestOperation<AccountingExpensesAllRequest, AccountingExpensesAllResponse> {
    ...
    public AccountingExpensesAllOperation(
    ...
    public HttpRequest buildRequest(AccountingExpensesAllRequest request) throws Exception {
