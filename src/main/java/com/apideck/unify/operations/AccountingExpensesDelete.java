...
public class AccountingExpensesDelete {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingExpensesDeleteRequest, AccountingExpensesDeleteResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingExpensesDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingExpensesDeleteRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingExpensesDeleteRequest request) {
        ...
        @Override
        public AccountingExpensesDeleteResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingExpensesDeleteResponse.Builder resBuilder =
            ...
            AccountingExpensesDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDeleteExpenseResponse(Utils.unmarshal(response, new TypeReference<DeleteExpenseResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingExpensesDeleteRequest, com.apideck.unify.models.operations.async.AccountingExpensesDeleteResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingExpensesDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingExpensesDeleteRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingExpensesDeleteRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingExpensesDeleteResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingExpensesDeleteResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingExpensesDeleteResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingExpensesDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DeleteExpenseResponse>() {})
                            .thenApply(res::withDeleteExpenseResponse);
                } else {
