...
public class AccountingExpensesDeleteOperation implements RequestOperation<AccountingExpensesDeleteRequest, AccountingExpensesDeleteResponse> {
    ...
    public AccountingExpensesDeleteOperation(
    ...
    public HttpRequest buildRequest(AccountingExpensesDeleteRequest request) throws Exception {
