...
public class AccountingExpensesOne {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingExpensesOneRequest, AccountingExpensesOneResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingExpensesOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingExpensesOneRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingExpensesOneRequest request) {
        ...
        @Override
        public AccountingExpensesOneResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingExpensesOneResponse.Builder resBuilder =
            ...
            AccountingExpensesOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetExpenseResponse(Utils.unmarshal(response, new TypeReference<GetExpenseResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingExpensesOneRequest, com.apideck.unify.models.operations.async.AccountingExpensesOneResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingExpensesOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingExpensesOneRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingExpensesOneRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingExpensesOneResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingExpensesOneResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingExpensesOneResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingExpensesOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetExpenseResponse>() {})
                            .thenApply(res::withGetExpenseResponse);
                } else {
