...
public class AccountingExpensesOneOperation implements RequestOperation<AccountingExpensesOneRequest, AccountingExpensesOneResponse> {
    ...
    public AccountingExpensesOneOperation(
    ...
    public HttpRequest buildRequest(AccountingExpensesOneRequest request) throws Exception {
