...
public class AccountingExpensesUpdateOperation implements RequestOperation<AccountingExpensesUpdateRequest, AccountingExpensesUpdateResponse> {
    ...
    public AccountingExpensesUpdateOperation(
    ...
    public HttpRequest buildRequest(AccountingExpensesUpdateRequest request) throws Exception {
