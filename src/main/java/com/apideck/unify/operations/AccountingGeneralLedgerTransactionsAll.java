...
public class AccountingGeneralLedgerTransactionsAll {
    ...
    static abstract class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "accounting.generalLedgerTransactionsAll",
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingGeneralLedgerTransactionsAllRequest, AccountingGeneralLedgerTransactionsAllResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingGeneralLedgerTransactionsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingGeneralLedgerTransactionsAllRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingGeneralLedgerTransactionsAllRequest request) {
        ...
        @Override
        public AccountingGeneralLedgerTransactionsAllResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingGeneralLedgerTransactionsAllResponse.Builder resBuilder =
            ...
            AccountingGeneralLedgerTransactionsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetGeneralLedgerTransactionsResponse(Utils.unmarshal(response, new TypeReference<GetGeneralLedgerTransactionsResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingGeneralLedgerTransactionsAllRequest, com.apideck.unify.models.operations.async.AccountingGeneralLedgerTransactionsAllResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingGeneralLedgerTransactionsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingGeneralLedgerTransactionsAllRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingGeneralLedgerTransactionsAllRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingGeneralLedgerTransactionsAllResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingGeneralLedgerTransactionsAllResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingGeneralLedgerTransactionsAllResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingGeneralLedgerTransactionsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetGeneralLedgerTransactionsResponse>() {})
                            .thenApply(res::withGetGeneralLedgerTransactionsResponse);
                } else {
