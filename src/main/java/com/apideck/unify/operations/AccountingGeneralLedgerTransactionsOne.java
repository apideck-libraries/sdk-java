...
public class AccountingGeneralLedgerTransactionsOne {
    ...
    static abstract class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "accounting.generalLedgerTransactionsOne",
        ...
        <T>HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(
                    klass,
                    this.baseUrl,
                    "/accounting/general-ledger-transactions/{id}",
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingGeneralLedgerTransactionsOneRequest, AccountingGeneralLedgerTransactionsOneResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingGeneralLedgerTransactionsOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingGeneralLedgerTransactionsOneRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingGeneralLedgerTransactionsOneRequest request) {
        ...
        @Override
        public AccountingGeneralLedgerTransactionsOneResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingGeneralLedgerTransactionsOneResponse.Builder resBuilder =
            ...
            AccountingGeneralLedgerTransactionsOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetGeneralLedgerTransactionResponse(Utils.unmarshal(response, new TypeReference<GetGeneralLedgerTransactionResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingGeneralLedgerTransactionsOneRequest, com.apideck.unify.models.operations.async.AccountingGeneralLedgerTransactionsOneResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingGeneralLedgerTransactionsOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingGeneralLedgerTransactionsOneRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingGeneralLedgerTransactionsOneRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingGeneralLedgerTransactionsOneResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingGeneralLedgerTransactionsOneResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingGeneralLedgerTransactionsOneResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingGeneralLedgerTransactionsOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetGeneralLedgerTransactionResponse>() {})
                            .thenApply(res::withGetGeneralLedgerTransactionResponse);
                } else {
