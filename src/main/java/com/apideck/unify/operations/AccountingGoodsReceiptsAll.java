...
public class AccountingGoodsReceiptsAll {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingGoodsReceiptsAllRequest, AccountingGoodsReceiptsAllResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingGoodsReceiptsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingGoodsReceiptsAllRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingGoodsReceiptsAllRequest request) {
        ...
        @Override
        public AccountingGoodsReceiptsAllResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingGoodsReceiptsAllResponse.Builder resBuilder =
            ...
            AccountingGoodsReceiptsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetGoodsReceiptsResponse(Utils.unmarshal(response, new TypeReference<GetGoodsReceiptsResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingGoodsReceiptsAllRequest, com.apideck.unify.models.operations.async.AccountingGoodsReceiptsAllResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingGoodsReceiptsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingGoodsReceiptsAllRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingGoodsReceiptsAllRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingGoodsReceiptsAllResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingGoodsReceiptsAllResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingGoodsReceiptsAllResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingGoodsReceiptsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetGoodsReceiptsResponse>() {})
                            .thenApply(res::withGetGoodsReceiptsResponse);
                } else {
