...
public class AccountingGoodsReceiptsOne {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingGoodsReceiptsOneRequest, AccountingGoodsReceiptsOneResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingGoodsReceiptsOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingGoodsReceiptsOneRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingGoodsReceiptsOneRequest request) {
        ...
        @Override
        public AccountingGoodsReceiptsOneResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingGoodsReceiptsOneResponse.Builder resBuilder =
            ...
            AccountingGoodsReceiptsOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetGoodsReceiptResponse(Utils.unmarshal(response, new TypeReference<GetGoodsReceiptResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingGoodsReceiptsOneRequest, com.apideck.unify.models.operations.async.AccountingGoodsReceiptsOneResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingGoodsReceiptsOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingGoodsReceiptsOneRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingGoodsReceiptsOneRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingGoodsReceiptsOneResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingGoodsReceiptsOneResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingGoodsReceiptsOneResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingGoodsReceiptsOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetGoodsReceiptResponse>() {})
                            .thenApply(res::withGetGoodsReceiptResponse);
                } else {
