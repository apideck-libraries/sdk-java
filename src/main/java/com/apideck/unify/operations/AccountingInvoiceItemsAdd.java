...
public class AccountingInvoiceItemsAdd {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingInvoiceItemsAddRequest request) throws Exception {
        ...
        @Override
        public AccountingInvoiceItemsAddResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    CreateInvoiceItemResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCreateInvoiceItemResponse(out);
                    return res;
                } else {
