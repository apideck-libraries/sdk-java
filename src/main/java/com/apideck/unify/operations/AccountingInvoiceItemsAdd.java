...
public class AccountingInvoiceItemsAdd {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingInvoiceItemsAddRequest, AccountingInvoiceItemsAddResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingInvoiceItemsAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingInvoiceItemsAddRequest.class, new TypeReference<AccountingInvoiceItemsAddRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingInvoiceItemsAddRequest request) {
        ...
        @Override
        public AccountingInvoiceItemsAddResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingInvoiceItemsAddResponse.Builder resBuilder =
            ...
            AccountingInvoiceItemsAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCreateInvoiceItemResponse(Utils.unmarshal(response, new TypeReference<CreateInvoiceItemResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingInvoiceItemsAddRequest, com.apideck.unify.models.operations.async.AccountingInvoiceItemsAddResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingInvoiceItemsAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingInvoiceItemsAddRequest.class, new TypeReference<AccountingInvoiceItemsAddRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingInvoiceItemsAddRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingInvoiceItemsAddResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingInvoiceItemsAddResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingInvoiceItemsAddResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingInvoiceItemsAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CreateInvoiceItemResponse>() {})
                            .thenApply(res::withCreateInvoiceItemResponse);
                } else {
