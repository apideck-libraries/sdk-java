...
public class AccountingInvoiceItemsAddOperation implements RequestOperation<AccountingInvoiceItemsAddRequest, AccountingInvoiceItemsAddResponse> {
    ...
    public AccountingInvoiceItemsAddOperation(
    ...
    public HttpRequest buildRequest(AccountingInvoiceItemsAddRequest request) throws Exception {
