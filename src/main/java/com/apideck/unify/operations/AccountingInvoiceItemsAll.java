...
public class AccountingInvoiceItemsAll {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingInvoiceItemsAllRequest request) throws Exception {
        ...
        @Override
        public AccountingInvoiceItemsAllResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GetInvoiceItemsResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGetInvoiceItemsResponse(out);
                    return res;
                } else {
