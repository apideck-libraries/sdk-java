...
public class AccountingInvoiceItemsAll {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingInvoiceItemsAllRequest, AccountingInvoiceItemsAllResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingInvoiceItemsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingInvoiceItemsAllRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingInvoiceItemsAllRequest request) {
        ...
        @Override
        public AccountingInvoiceItemsAllResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingInvoiceItemsAllResponse.Builder resBuilder =
            ...
            AccountingInvoiceItemsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetInvoiceItemsResponse(Utils.unmarshal(response, new TypeReference<GetInvoiceItemsResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingInvoiceItemsAllRequest, com.apideck.unify.models.operations.async.AccountingInvoiceItemsAllResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingInvoiceItemsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingInvoiceItemsAllRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingInvoiceItemsAllRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingInvoiceItemsAllResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingInvoiceItemsAllResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingInvoiceItemsAllResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingInvoiceItemsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetInvoiceItemsResponse>() {})
                            .thenApply(res::withGetInvoiceItemsResponse);
                } else {
