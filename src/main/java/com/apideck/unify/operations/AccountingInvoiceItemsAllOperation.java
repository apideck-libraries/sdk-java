...
public class AccountingInvoiceItemsAllOperation implements RequestOperation<AccountingInvoiceItemsAllRequest, AccountingInvoiceItemsAllResponse> {
    ...
    public AccountingInvoiceItemsAllOperation(
    ...
    public HttpRequest buildRequest(AccountingInvoiceItemsAllRequest request) throws Exception {
