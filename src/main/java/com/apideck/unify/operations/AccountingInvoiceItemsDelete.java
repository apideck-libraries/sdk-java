...
public class AccountingInvoiceItemsDelete {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingInvoiceItemsDeleteRequest request) throws Exception {
        ...
        @Override
        public AccountingInvoiceItemsDeleteResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    DeleteTaxRateResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withDeleteTaxRateResponse(out);
                    return res;
                } else {
