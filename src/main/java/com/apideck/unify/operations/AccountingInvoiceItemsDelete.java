...
public class AccountingInvoiceItemsDelete {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingInvoiceItemsDeleteRequest, AccountingInvoiceItemsDeleteResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingInvoiceItemsDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingInvoiceItemsDeleteRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingInvoiceItemsDeleteRequest request) {
        ...
        @Override
        public AccountingInvoiceItemsDeleteResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingInvoiceItemsDeleteResponse.Builder resBuilder =
            ...
            AccountingInvoiceItemsDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDeleteTaxRateResponse(Utils.unmarshal(response, new TypeReference<DeleteTaxRateResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingInvoiceItemsDeleteRequest, com.apideck.unify.models.operations.async.AccountingInvoiceItemsDeleteResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingInvoiceItemsDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingInvoiceItemsDeleteRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingInvoiceItemsDeleteRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingInvoiceItemsDeleteResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingInvoiceItemsDeleteResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingInvoiceItemsDeleteResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingInvoiceItemsDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DeleteTaxRateResponse>() {})
                            .thenApply(res::withDeleteTaxRateResponse);
                } else {
