...
public class AccountingInvoiceItemsDeleteOperation implements RequestOperation<AccountingInvoiceItemsDeleteRequest, AccountingInvoiceItemsDeleteResponse> {
    ...
    public AccountingInvoiceItemsDeleteOperation(
    ...
    public HttpRequest buildRequest(AccountingInvoiceItemsDeleteRequest request) throws Exception {
