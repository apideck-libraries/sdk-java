...
public class AccountingInvoiceItemsOne {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingInvoiceItemsOneRequest, AccountingInvoiceItemsOneResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingInvoiceItemsOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingInvoiceItemsOneRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingInvoiceItemsOneRequest request) {
        ...
        @Override
        public AccountingInvoiceItemsOneResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingInvoiceItemsOneResponse.Builder resBuilder =
            ...
            AccountingInvoiceItemsOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetInvoiceItemResponse(Utils.unmarshal(response, new TypeReference<GetInvoiceItemResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingInvoiceItemsOneRequest, com.apideck.unify.models.operations.async.AccountingInvoiceItemsOneResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingInvoiceItemsOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingInvoiceItemsOneRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingInvoiceItemsOneRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingInvoiceItemsOneResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingInvoiceItemsOneResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingInvoiceItemsOneResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingInvoiceItemsOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetInvoiceItemResponse>() {})
                            .thenApply(res::withGetInvoiceItemResponse);
                } else {
