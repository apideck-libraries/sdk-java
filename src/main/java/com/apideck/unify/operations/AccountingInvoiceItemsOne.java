...
public class AccountingInvoiceItemsOne {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingInvoiceItemsOneRequest request) throws Exception {
        ...
        @Override
        public AccountingInvoiceItemsOneResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GetInvoiceItemResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGetInvoiceItemResponse(out);
                    return res;
                } else {
