...
public class AccountingInvoiceItemsOneOperation implements RequestOperation<AccountingInvoiceItemsOneRequest, AccountingInvoiceItemsOneResponse> {
    ...
    public AccountingInvoiceItemsOneOperation(
    ...
    public HttpRequest buildRequest(AccountingInvoiceItemsOneRequest request) throws Exception {
