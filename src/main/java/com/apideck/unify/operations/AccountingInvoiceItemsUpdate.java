...
public class AccountingInvoiceItemsUpdate {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingInvoiceItemsUpdateRequest, AccountingInvoiceItemsUpdateResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingInvoiceItemsUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingInvoiceItemsUpdateRequest.class, new TypeReference<AccountingInvoiceItemsUpdateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingInvoiceItemsUpdateRequest request) {
        ...
        @Override
        public AccountingInvoiceItemsUpdateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingInvoiceItemsUpdateResponse.Builder resBuilder =
            ...
            AccountingInvoiceItemsUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withUpdateInvoiceItemsResponse(Utils.unmarshal(response, new TypeReference<UpdateInvoiceItemsResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingInvoiceItemsUpdateRequest, com.apideck.unify.models.operations.async.AccountingInvoiceItemsUpdateResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingInvoiceItemsUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingInvoiceItemsUpdateRequest.class, new TypeReference<AccountingInvoiceItemsUpdateRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingInvoiceItemsUpdateRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingInvoiceItemsUpdateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingInvoiceItemsUpdateResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingInvoiceItemsUpdateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingInvoiceItemsUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<UpdateInvoiceItemsResponse>() {})
                            .thenApply(res::withUpdateInvoiceItemsResponse);
                } else {
