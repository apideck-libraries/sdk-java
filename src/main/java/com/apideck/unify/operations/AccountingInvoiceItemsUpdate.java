...
public class AccountingInvoiceItemsUpdate {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingInvoiceItemsUpdateRequest request) throws Exception {
        ...
        @Override
        public AccountingInvoiceItemsUpdateResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    UpdateInvoiceItemsResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withUpdateInvoiceItemsResponse(out);
                    return res;
                } else {
