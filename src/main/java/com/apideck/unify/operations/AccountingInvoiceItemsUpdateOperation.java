...
public class AccountingInvoiceItemsUpdateOperation implements RequestOperation<AccountingInvoiceItemsUpdateRequest, AccountingInvoiceItemsUpdateResponse> {
    ...
    public AccountingInvoiceItemsUpdateOperation(
    ...
    public HttpRequest buildRequest(AccountingInvoiceItemsUpdateRequest request) throws Exception {
