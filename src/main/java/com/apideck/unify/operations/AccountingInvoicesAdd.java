...
public class AccountingInvoicesAdd {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingInvoicesAddRequest, AccountingInvoicesAddResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingInvoicesAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingInvoicesAddRequest.class, new TypeReference<AccountingInvoicesAddRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingInvoicesAddRequest request) {
        ...
        @Override
        public AccountingInvoicesAddResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingInvoicesAddResponse.Builder resBuilder =
            ...
            AccountingInvoicesAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCreateInvoiceResponse(Utils.unmarshal(response, new TypeReference<CreateInvoiceResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingInvoicesAddRequest, com.apideck.unify.models.operations.async.AccountingInvoicesAddResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingInvoicesAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingInvoicesAddRequest.class, new TypeReference<AccountingInvoicesAddRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingInvoicesAddRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingInvoicesAddResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingInvoicesAddResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingInvoicesAddResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingInvoicesAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CreateInvoiceResponse>() {})
                            .thenApply(res::withCreateInvoiceResponse);
                } else {
