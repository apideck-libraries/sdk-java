...
public class AccountingInvoicesAddOperation implements RequestOperation<AccountingInvoicesAddRequest, AccountingInvoicesAddResponse> {
    ...
    public AccountingInvoicesAddOperation(
    ...
    public HttpRequest buildRequest(AccountingInvoicesAddRequest request) throws Exception {
