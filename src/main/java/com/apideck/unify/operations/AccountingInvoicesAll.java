...
public class AccountingInvoicesAll {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingInvoicesAllRequest request) throws Exception {
        ...
        @Override
        public AccountingInvoicesAllResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GetInvoicesResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGetInvoicesResponse(out);
                    return res;
                } else {
