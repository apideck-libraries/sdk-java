...
public class AccountingInvoicesAllOperation implements RequestOperation<AccountingInvoicesAllRequest, AccountingInvoicesAllResponse> {
    ...
    public AccountingInvoicesAllOperation(
    ...
    public HttpRequest buildRequest(AccountingInvoicesAllRequest request) throws Exception {
