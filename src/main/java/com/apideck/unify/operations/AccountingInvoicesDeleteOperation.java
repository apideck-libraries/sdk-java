...
public class AccountingInvoicesDeleteOperation implements RequestOperation<AccountingInvoicesDeleteRequest, AccountingInvoicesDeleteResponse> {
    ...
    public AccountingInvoicesDeleteOperation(
    ...
    public HttpRequest buildRequest(AccountingInvoicesDeleteRequest request) throws Exception {
