...
public class AccountingInvoicesOne {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingInvoicesOneRequest, AccountingInvoicesOneResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingInvoicesOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingInvoicesOneRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingInvoicesOneRequest request) {
        ...
        @Override
        public AccountingInvoicesOneResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingInvoicesOneResponse.Builder resBuilder =
            ...
            AccountingInvoicesOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetInvoiceResponse(Utils.unmarshal(response, new TypeReference<GetInvoiceResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingInvoicesOneRequest, com.apideck.unify.models.operations.async.AccountingInvoicesOneResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingInvoicesOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingInvoicesOneRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingInvoicesOneRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingInvoicesOneResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingInvoicesOneResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingInvoicesOneResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingInvoicesOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetInvoiceResponse>() {})
                            .thenApply(res::withGetInvoiceResponse);
                } else {
