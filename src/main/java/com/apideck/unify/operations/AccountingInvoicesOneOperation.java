...
public class AccountingInvoicesOneOperation implements RequestOperation<AccountingInvoicesOneRequest, AccountingInvoicesOneResponse> {
    ...
    public AccountingInvoicesOneOperation(
    ...
    public HttpRequest buildRequest(AccountingInvoicesOneRequest request) throws Exception {
