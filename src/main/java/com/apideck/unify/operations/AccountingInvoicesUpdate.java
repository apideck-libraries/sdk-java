...
public class AccountingInvoicesUpdate {
    ...
    public static class Sync extends Base
        ...
        @Override
        public AccountingInvoicesUpdateResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    UpdateInvoiceResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withUpdateInvoiceResponse(out);
                    return res;
                } else {
