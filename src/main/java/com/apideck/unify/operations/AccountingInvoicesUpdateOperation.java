...
public class AccountingInvoicesUpdateOperation implements RequestOperation<AccountingInvoicesUpdateRequest, AccountingInvoicesUpdateResponse> {
    ...
    public AccountingInvoicesUpdateOperation(
    ...
    public HttpRequest buildRequest(AccountingInvoicesUpdateRequest request) throws Exception {
