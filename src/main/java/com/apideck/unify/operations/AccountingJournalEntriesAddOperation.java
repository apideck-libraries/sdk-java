...
public class AccountingJournalEntriesAddOperation implements RequestOperation<AccountingJournalEntriesAddRequest, AccountingJournalEntriesAddResponse> {
    ...
    public AccountingJournalEntriesAddOperation(
    ...
    public HttpRequest buildRequest(AccountingJournalEntriesAddRequest request) throws Exception {
