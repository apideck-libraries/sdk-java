...
public class AccountingJournalEntriesAll {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingJournalEntriesAllRequest request) throws Exception {
        ...
        @Override
        public AccountingJournalEntriesAllResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GetJournalEntriesResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGetJournalEntriesResponse(out);
                    return res;
                } else {
