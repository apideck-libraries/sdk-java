...
public class AccountingJournalEntriesAllOperation implements RequestOperation<AccountingJournalEntriesAllRequest, AccountingJournalEntriesAllResponse> {
    ...
    public AccountingJournalEntriesAllOperation(
    ...
    public HttpRequest buildRequest(AccountingJournalEntriesAllRequest request) throws Exception {
