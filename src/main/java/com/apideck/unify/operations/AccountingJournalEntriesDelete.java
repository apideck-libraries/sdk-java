...
public class AccountingJournalEntriesDelete {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingJournalEntriesDeleteRequest, AccountingJournalEntriesDeleteResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingJournalEntriesDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingJournalEntriesDeleteRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingJournalEntriesDeleteRequest request) {
        ...
        @Override
        public AccountingJournalEntriesDeleteResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingJournalEntriesDeleteResponse.Builder resBuilder =
            ...
            AccountingJournalEntriesDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDeleteJournalEntryResponse(Utils.unmarshal(response, new TypeReference<DeleteJournalEntryResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingJournalEntriesDeleteRequest, com.apideck.unify.models.operations.async.AccountingJournalEntriesDeleteResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingJournalEntriesDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingJournalEntriesDeleteRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingJournalEntriesDeleteRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingJournalEntriesDeleteResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingJournalEntriesDeleteResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingJournalEntriesDeleteResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingJournalEntriesDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DeleteJournalEntryResponse>() {})
                            .thenApply(res::withDeleteJournalEntryResponse);
                } else {
