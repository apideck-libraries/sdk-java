...
public class AccountingJournalEntriesDeleteOperation implements RequestOperation<AccountingJournalEntriesDeleteRequest, AccountingJournalEntriesDeleteResponse> {
    ...
    public AccountingJournalEntriesDeleteOperation(
    ...
    public HttpRequest buildRequest(AccountingJournalEntriesDeleteRequest request) throws Exception {
