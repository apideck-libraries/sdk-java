...
public class AccountingJournalEntriesOne {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingJournalEntriesOneRequest, AccountingJournalEntriesOneResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingJournalEntriesOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingJournalEntriesOneRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingJournalEntriesOneRequest request) {
        ...
        @Override
        public AccountingJournalEntriesOneResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingJournalEntriesOneResponse.Builder resBuilder =
            ...
            AccountingJournalEntriesOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetJournalEntryResponse(Utils.unmarshal(response, new TypeReference<GetJournalEntryResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingJournalEntriesOneRequest, com.apideck.unify.models.operations.async.AccountingJournalEntriesOneResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingJournalEntriesOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingJournalEntriesOneRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingJournalEntriesOneRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingJournalEntriesOneResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingJournalEntriesOneResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingJournalEntriesOneResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingJournalEntriesOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetJournalEntryResponse>() {})
                            .thenApply(res::withGetJournalEntryResponse);
                } else {
