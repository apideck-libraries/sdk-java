...
public class AccountingJournalEntriesOneOperation implements RequestOperation<AccountingJournalEntriesOneRequest, AccountingJournalEntriesOneResponse> {
    ...
    public AccountingJournalEntriesOneOperation(
    ...
    public HttpRequest buildRequest(AccountingJournalEntriesOneRequest request) throws Exception {
