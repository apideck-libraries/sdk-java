...
public class AccountingJournalEntriesUpdateOperation implements RequestOperation<AccountingJournalEntriesUpdateRequest, AccountingJournalEntriesUpdateResponse> {
    ...
    public AccountingJournalEntriesUpdateOperation(
    ...
    public HttpRequest buildRequest(AccountingJournalEntriesUpdateRequest request) throws Exception {
