...
public class AccountingJournalsAdd {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingJournalsAddRequest, AccountingJournalsAddResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingJournalsAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingJournalsAddRequest.class, new TypeReference<AccountingJournalsAddRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingJournalsAddRequest request) {
        ...
        @Override
        public AccountingJournalsAddResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingJournalsAddResponse.Builder resBuilder =
            ...
            AccountingJournalsAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCreateJournalResponse(Utils.unmarshal(response, new TypeReference<CreateJournalResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingJournalsAddRequest, com.apideck.unify.models.operations.async.AccountingJournalsAddResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingJournalsAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingJournalsAddRequest.class, new TypeReference<AccountingJournalsAddRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingJournalsAddRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingJournalsAddResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingJournalsAddResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingJournalsAddResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingJournalsAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CreateJournalResponse>() {})
                            .thenApply(res::withCreateJournalResponse);
                } else {
