...
public class AccountingJournalsAll {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingJournalsAllRequest, AccountingJournalsAllResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingJournalsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingJournalsAllRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingJournalsAllRequest request) {
        ...
        @Override
        public AccountingJournalsAllResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingJournalsAllResponse.Builder resBuilder =
            ...
            AccountingJournalsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetJournalsResponse(Utils.unmarshal(response, new TypeReference<GetJournalsResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingJournalsAllRequest, com.apideck.unify.models.operations.async.AccountingJournalsAllResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingJournalsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingJournalsAllRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingJournalsAllRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingJournalsAllResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingJournalsAllResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingJournalsAllResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingJournalsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetJournalsResponse>() {})
                            .thenApply(res::withGetJournalsResponse);
                } else {
