...
public class AccountingJournalsOne {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingJournalsOneRequest, AccountingJournalsOneResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingJournalsOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingJournalsOneRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingJournalsOneRequest request) {
        ...
        @Override
        public AccountingJournalsOneResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingJournalsOneResponse.Builder resBuilder =
            ...
            AccountingJournalsOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetJournalResponse(Utils.unmarshal(response, new TypeReference<GetJournalResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingJournalsOneRequest, com.apideck.unify.models.operations.async.AccountingJournalsOneResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingJournalsOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingJournalsOneRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingJournalsOneRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingJournalsOneResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingJournalsOneResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingJournalsOneResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingJournalsOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetJournalResponse>() {})
                            .thenApply(res::withGetJournalResponse);
                } else {
