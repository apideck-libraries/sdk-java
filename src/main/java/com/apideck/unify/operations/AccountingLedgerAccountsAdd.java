...
public class AccountingLedgerAccountsAdd {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingLedgerAccountsAddRequest, AccountingLedgerAccountsAddResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingLedgerAccountsAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingLedgerAccountsAddRequest.class, new TypeReference<AccountingLedgerAccountsAddRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingLedgerAccountsAddRequest request) {
        ...
        @Override
        public AccountingLedgerAccountsAddResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingLedgerAccountsAddResponse.Builder resBuilder =
            ...
            AccountingLedgerAccountsAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCreateLedgerAccountResponse(Utils.unmarshal(response, new TypeReference<CreateLedgerAccountResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingLedgerAccountsAddRequest, com.apideck.unify.models.operations.async.AccountingLedgerAccountsAddResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingLedgerAccountsAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingLedgerAccountsAddRequest.class, new TypeReference<AccountingLedgerAccountsAddRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingLedgerAccountsAddRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingLedgerAccountsAddResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingLedgerAccountsAddResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingLedgerAccountsAddResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingLedgerAccountsAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CreateLedgerAccountResponse>() {})
                            .thenApply(res::withCreateLedgerAccountResponse);
                } else {
