...
public class AccountingLedgerAccountsAddOperation implements RequestOperation<AccountingLedgerAccountsAddRequest, AccountingLedgerAccountsAddResponse> {
    ...
    public AccountingLedgerAccountsAddOperation(
    ...
    public HttpRequest buildRequest(AccountingLedgerAccountsAddRequest request) throws Exception {
