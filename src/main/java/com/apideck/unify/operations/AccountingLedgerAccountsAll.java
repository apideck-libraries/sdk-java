...
public class AccountingLedgerAccountsAll {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingLedgerAccountsAllRequest request) throws Exception {
        ...
        @Override
        public AccountingLedgerAccountsAllResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GetLedgerAccountsResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGetLedgerAccountsResponse(out);
                    return res;
                } else {
