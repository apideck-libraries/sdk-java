...
public class AccountingLedgerAccountsAll {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingLedgerAccountsAllRequest, AccountingLedgerAccountsAllResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingLedgerAccountsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingLedgerAccountsAllRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingLedgerAccountsAllRequest request) {
        ...
        @Override
        public AccountingLedgerAccountsAllResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingLedgerAccountsAllResponse.Builder resBuilder =
            ...
            AccountingLedgerAccountsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetLedgerAccountsResponse(Utils.unmarshal(response, new TypeReference<GetLedgerAccountsResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingLedgerAccountsAllRequest, com.apideck.unify.models.operations.async.AccountingLedgerAccountsAllResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingLedgerAccountsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingLedgerAccountsAllRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingLedgerAccountsAllRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingLedgerAccountsAllResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingLedgerAccountsAllResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingLedgerAccountsAllResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingLedgerAccountsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetLedgerAccountsResponse>() {})
                            .thenApply(res::withGetLedgerAccountsResponse);
                } else {
