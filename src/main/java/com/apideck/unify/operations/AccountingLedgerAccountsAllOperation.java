...
public class AccountingLedgerAccountsAllOperation implements RequestOperation<AccountingLedgerAccountsAllRequest, AccountingLedgerAccountsAllResponse> {
    ...
    public AccountingLedgerAccountsAllOperation(
    ...
    public HttpRequest buildRequest(AccountingLedgerAccountsAllRequest request) throws Exception {
