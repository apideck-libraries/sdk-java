...
public class AccountingLedgerAccountsDelete {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingLedgerAccountsDeleteRequest, AccountingLedgerAccountsDeleteResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingLedgerAccountsDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingLedgerAccountsDeleteRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingLedgerAccountsDeleteRequest request) {
        ...
        @Override
        public AccountingLedgerAccountsDeleteResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingLedgerAccountsDeleteResponse.Builder resBuilder =
            ...
            AccountingLedgerAccountsDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDeleteLedgerAccountResponse(Utils.unmarshal(response, new TypeReference<DeleteLedgerAccountResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingLedgerAccountsDeleteRequest, com.apideck.unify.models.operations.async.AccountingLedgerAccountsDeleteResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingLedgerAccountsDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingLedgerAccountsDeleteRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingLedgerAccountsDeleteRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingLedgerAccountsDeleteResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingLedgerAccountsDeleteResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingLedgerAccountsDeleteResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingLedgerAccountsDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DeleteLedgerAccountResponse>() {})
                            .thenApply(res::withDeleteLedgerAccountResponse);
                } else {
