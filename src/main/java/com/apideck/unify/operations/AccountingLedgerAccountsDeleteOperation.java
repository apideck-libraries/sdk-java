...
public class AccountingLedgerAccountsDeleteOperation implements RequestOperation<AccountingLedgerAccountsDeleteRequest, AccountingLedgerAccountsDeleteResponse> {
    ...
    public AccountingLedgerAccountsDeleteOperation(
    ...
    public HttpRequest buildRequest(AccountingLedgerAccountsDeleteRequest request) throws Exception {
