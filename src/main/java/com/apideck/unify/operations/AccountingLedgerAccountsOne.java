...
public class AccountingLedgerAccountsOne {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingLedgerAccountsOneRequest request) throws Exception {
        ...
        @Override
        public AccountingLedgerAccountsOneResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GetLedgerAccountResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGetLedgerAccountResponse(out);
                    return res;
                } else {
