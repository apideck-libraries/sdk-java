...
public class AccountingLedgerAccountsOne {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingLedgerAccountsOneRequest, AccountingLedgerAccountsOneResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingLedgerAccountsOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingLedgerAccountsOneRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingLedgerAccountsOneRequest request) {
        ...
        @Override
        public AccountingLedgerAccountsOneResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingLedgerAccountsOneResponse.Builder resBuilder =
            ...
            AccountingLedgerAccountsOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetLedgerAccountResponse(Utils.unmarshal(response, new TypeReference<GetLedgerAccountResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingLedgerAccountsOneRequest, com.apideck.unify.models.operations.async.AccountingLedgerAccountsOneResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingLedgerAccountsOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingLedgerAccountsOneRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingLedgerAccountsOneRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingLedgerAccountsOneResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingLedgerAccountsOneResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingLedgerAccountsOneResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingLedgerAccountsOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetLedgerAccountResponse>() {})
                            .thenApply(res::withGetLedgerAccountResponse);
                } else {
