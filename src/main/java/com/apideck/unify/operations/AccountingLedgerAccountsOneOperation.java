...
public class AccountingLedgerAccountsOneOperation implements RequestOperation<AccountingLedgerAccountsOneRequest, AccountingLedgerAccountsOneResponse> {
    ...
    public AccountingLedgerAccountsOneOperation(
    ...
    public HttpRequest buildRequest(AccountingLedgerAccountsOneRequest request) throws Exception {
