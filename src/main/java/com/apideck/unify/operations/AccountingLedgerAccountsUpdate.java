...
public class AccountingLedgerAccountsUpdate {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingLedgerAccountsUpdateRequest request) throws Exception {
        ...
        @Override
        public AccountingLedgerAccountsUpdateResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    UpdateLedgerAccountResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withUpdateLedgerAccountResponse(out);
                    return res;
                } else {
