...
public class AccountingLedgerAccountsUpdate {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingLedgerAccountsUpdateRequest, AccountingLedgerAccountsUpdateResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingLedgerAccountsUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingLedgerAccountsUpdateRequest.class, new TypeReference<AccountingLedgerAccountsUpdateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingLedgerAccountsUpdateRequest request) {
        ...
        @Override
        public AccountingLedgerAccountsUpdateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingLedgerAccountsUpdateResponse.Builder resBuilder =
            ...
            AccountingLedgerAccountsUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withUpdateLedgerAccountResponse(Utils.unmarshal(response, new TypeReference<UpdateLedgerAccountResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingLedgerAccountsUpdateRequest, com.apideck.unify.models.operations.async.AccountingLedgerAccountsUpdateResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingLedgerAccountsUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingLedgerAccountsUpdateRequest.class, new TypeReference<AccountingLedgerAccountsUpdateRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingLedgerAccountsUpdateRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingLedgerAccountsUpdateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingLedgerAccountsUpdateResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingLedgerAccountsUpdateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingLedgerAccountsUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<UpdateLedgerAccountResponse>() {})
                            .thenApply(res::withUpdateLedgerAccountResponse);
                } else {
