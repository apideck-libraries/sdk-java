...
public class AccountingLedgerAccountsUpdateOperation implements RequestOperation<AccountingLedgerAccountsUpdateRequest, AccountingLedgerAccountsUpdateResponse> {
    ...
    public AccountingLedgerAccountsUpdateOperation(
    ...
    public HttpRequest buildRequest(AccountingLedgerAccountsUpdateRequest request) throws Exception {
