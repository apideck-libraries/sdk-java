...
public class AccountingLocationsAdd {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingLocationsAddRequest, AccountingLocationsAddResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingLocationsAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingLocationsAddRequest.class, new TypeReference<AccountingLocationsAddRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingLocationsAddRequest request) {
        ...
        @Override
        public AccountingLocationsAddResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingLocationsAddResponse.Builder resBuilder =
            ...
            AccountingLocationsAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCreateAccountingLocationResponse(Utils.unmarshal(response, new TypeReference<CreateAccountingLocationResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingLocationsAddRequest, com.apideck.unify.models.operations.async.AccountingLocationsAddResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingLocationsAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingLocationsAddRequest.class, new TypeReference<AccountingLocationsAddRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingLocationsAddRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingLocationsAddResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingLocationsAddResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingLocationsAddResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingLocationsAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CreateAccountingLocationResponse>() {})
                            .thenApply(res::withCreateAccountingLocationResponse);
                } else {
