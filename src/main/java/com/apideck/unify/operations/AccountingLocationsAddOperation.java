...
public class AccountingLocationsAddOperation implements RequestOperation<AccountingLocationsAddRequest, AccountingLocationsAddResponse> {
    ...
    public AccountingLocationsAddOperation(
    ...
    public HttpRequest buildRequest(AccountingLocationsAddRequest request) throws Exception {
