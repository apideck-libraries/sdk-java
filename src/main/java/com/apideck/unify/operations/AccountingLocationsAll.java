...
public class AccountingLocationsAll {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingLocationsAllRequest, AccountingLocationsAllResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingLocationsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingLocationsAllRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingLocationsAllRequest request) {
        ...
        @Override
        public AccountingLocationsAllResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingLocationsAllResponse.Builder resBuilder =
            ...
            AccountingLocationsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetAccountingLocationsResponse(Utils.unmarshal(response, new TypeReference<GetAccountingLocationsResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingLocationsAllRequest, com.apideck.unify.models.operations.async.AccountingLocationsAllResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingLocationsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingLocationsAllRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingLocationsAllRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingLocationsAllResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingLocationsAllResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingLocationsAllResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingLocationsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetAccountingLocationsResponse>() {})
                            .thenApply(res::withGetAccountingLocationsResponse);
                } else {
