...
public class AccountingLocationsAllOperation implements RequestOperation<AccountingLocationsAllRequest, AccountingLocationsAllResponse> {
    ...
    public AccountingLocationsAllOperation(
    ...
    public HttpRequest buildRequest(AccountingLocationsAllRequest request) throws Exception {
