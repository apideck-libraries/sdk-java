...
public class AccountingLocationsDelete {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingLocationsDeleteRequest, AccountingLocationsDeleteResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingLocationsDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingLocationsDeleteRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingLocationsDeleteRequest request) {
        ...
        @Override
        public AccountingLocationsDeleteResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingLocationsDeleteResponse.Builder resBuilder =
            ...
            AccountingLocationsDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDeleteAccountingLocationResponse(Utils.unmarshal(response, new TypeReference<DeleteAccountingLocationResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingLocationsDeleteRequest, com.apideck.unify.models.operations.async.AccountingLocationsDeleteResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingLocationsDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingLocationsDeleteRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingLocationsDeleteRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingLocationsDeleteResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingLocationsDeleteResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingLocationsDeleteResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingLocationsDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DeleteAccountingLocationResponse>() {})
                            .thenApply(res::withDeleteAccountingLocationResponse);
                } else {
