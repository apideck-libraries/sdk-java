...
public class AccountingLocationsDeleteOperation implements RequestOperation<AccountingLocationsDeleteRequest, AccountingLocationsDeleteResponse> {
    ...
    public AccountingLocationsDeleteOperation(
    ...
    public HttpRequest buildRequest(AccountingLocationsDeleteRequest request) throws Exception {
