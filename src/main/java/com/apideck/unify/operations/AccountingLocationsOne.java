...
public class AccountingLocationsOne {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingLocationsOneRequest, AccountingLocationsOneResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingLocationsOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingLocationsOneRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingLocationsOneRequest request) {
        ...
        @Override
        public AccountingLocationsOneResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingLocationsOneResponse.Builder resBuilder =
            ...
            AccountingLocationsOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetAccountingLocationResponse(Utils.unmarshal(response, new TypeReference<GetAccountingLocationResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingLocationsOneRequest, com.apideck.unify.models.operations.async.AccountingLocationsOneResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingLocationsOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingLocationsOneRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingLocationsOneRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingLocationsOneResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingLocationsOneResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingLocationsOneResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingLocationsOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetAccountingLocationResponse>() {})
                            .thenApply(res::withGetAccountingLocationResponse);
                } else {
