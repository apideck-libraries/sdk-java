...
public class AccountingLocationsOne {
    ...
    public static class Sync extends Base
        ...
        @Override
        public AccountingLocationsOneResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GetAccountingLocationResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGetAccountingLocationResponse(out);
                    return res;
                } else {
