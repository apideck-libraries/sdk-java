...
public class AccountingLocationsOneOperation implements RequestOperation<AccountingLocationsOneRequest, AccountingLocationsOneResponse> {
    ...
    public AccountingLocationsOneOperation(
    ...
    public HttpRequest buildRequest(AccountingLocationsOneRequest request) throws Exception {
