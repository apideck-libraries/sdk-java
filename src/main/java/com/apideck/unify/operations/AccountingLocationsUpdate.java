...
public class AccountingLocationsUpdate {
    ...
    public static class Sync extends Base
        ...
        @Override
        public AccountingLocationsUpdateResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    UpdateAccountingLocationResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withUpdateAccountingLocationResponse(out);
                    return res;
                } else {
