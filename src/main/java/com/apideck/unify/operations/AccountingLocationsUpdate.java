...
public class AccountingLocationsUpdate {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingLocationsUpdateRequest, AccountingLocationsUpdateResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingLocationsUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingLocationsUpdateRequest.class, new TypeReference<AccountingLocationsUpdateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingLocationsUpdateRequest request) {
        ...
        @Override
        public AccountingLocationsUpdateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingLocationsUpdateResponse.Builder resBuilder =
            ...
            AccountingLocationsUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withUpdateAccountingLocationResponse(Utils.unmarshal(response, new TypeReference<UpdateAccountingLocationResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingLocationsUpdateRequest, com.apideck.unify.models.operations.async.AccountingLocationsUpdateResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingLocationsUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingLocationsUpdateRequest.class, new TypeReference<AccountingLocationsUpdateRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingLocationsUpdateRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingLocationsUpdateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingLocationsUpdateResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingLocationsUpdateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingLocationsUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<UpdateAccountingLocationResponse>() {})
                            .thenApply(res::withUpdateAccountingLocationResponse);
                } else {
