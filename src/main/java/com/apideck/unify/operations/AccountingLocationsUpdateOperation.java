...
public class AccountingLocationsUpdateOperation implements RequestOperation<AccountingLocationsUpdateRequest, AccountingLocationsUpdateResponse> {
    ...
    public AccountingLocationsUpdateOperation(
    ...
    public HttpRequest buildRequest(AccountingLocationsUpdateRequest request) throws Exception {
