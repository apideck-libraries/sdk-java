...
public class AccountingPaymentMethodsAdd {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingPaymentMethodsAddRequest, AccountingPaymentMethodsAddResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingPaymentMethodsAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingPaymentMethodsAddRequest.class, new TypeReference<AccountingPaymentMethodsAddRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingPaymentMethodsAddRequest request) {
        ...
        @Override
        public AccountingPaymentMethodsAddResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingPaymentMethodsAddResponse.Builder resBuilder =
            ...
            AccountingPaymentMethodsAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCreatePaymentMethodResponse(Utils.unmarshal(response, new TypeReference<CreatePaymentMethodResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingPaymentMethodsAddRequest, com.apideck.unify.models.operations.async.AccountingPaymentMethodsAddResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingPaymentMethodsAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingPaymentMethodsAddRequest.class, new TypeReference<AccountingPaymentMethodsAddRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingPaymentMethodsAddRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingPaymentMethodsAddResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingPaymentMethodsAddResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingPaymentMethodsAddResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingPaymentMethodsAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CreatePaymentMethodResponse>() {})
                            .thenApply(res::withCreatePaymentMethodResponse);
                } else {
