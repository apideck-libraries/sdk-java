...
public class AccountingPaymentMethodsDelete {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingPaymentMethodsDeleteRequest, AccountingPaymentMethodsDeleteResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingPaymentMethodsDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingPaymentMethodsDeleteRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingPaymentMethodsDeleteRequest request) {
        ...
        @Override
        public AccountingPaymentMethodsDeleteResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingPaymentMethodsDeleteResponse.Builder resBuilder =
            ...
            AccountingPaymentMethodsDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDeletePaymentMethodResponse(Utils.unmarshal(response, new TypeReference<DeletePaymentMethodResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingPaymentMethodsDeleteRequest, com.apideck.unify.models.operations.async.AccountingPaymentMethodsDeleteResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingPaymentMethodsDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingPaymentMethodsDeleteRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingPaymentMethodsDeleteRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingPaymentMethodsDeleteResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingPaymentMethodsDeleteResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingPaymentMethodsDeleteResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingPaymentMethodsDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DeletePaymentMethodResponse>() {})
                            .thenApply(res::withDeletePaymentMethodResponse);
                } else {
