...
public class AccountingPaymentMethodsOne {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingPaymentMethodsOneRequest, AccountingPaymentMethodsOneResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingPaymentMethodsOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingPaymentMethodsOneRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingPaymentMethodsOneRequest request) {
        ...
        @Override
        public AccountingPaymentMethodsOneResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingPaymentMethodsOneResponse.Builder resBuilder =
            ...
            AccountingPaymentMethodsOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetPaymentMethodResponse(Utils.unmarshal(response, new TypeReference<GetPaymentMethodResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingPaymentMethodsOneRequest, com.apideck.unify.models.operations.async.AccountingPaymentMethodsOneResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingPaymentMethodsOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingPaymentMethodsOneRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingPaymentMethodsOneRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingPaymentMethodsOneResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingPaymentMethodsOneResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingPaymentMethodsOneResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingPaymentMethodsOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetPaymentMethodResponse>() {})
                            .thenApply(res::withGetPaymentMethodResponse);
                } else {
