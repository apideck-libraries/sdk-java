...
public class AccountingPaymentsAdd {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingPaymentsAddRequest, AccountingPaymentsAddResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingPaymentsAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingPaymentsAddRequest.class, new TypeReference<AccountingPaymentsAddRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingPaymentsAddRequest request) {
        ...
        @Override
        public AccountingPaymentsAddResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingPaymentsAddResponse.Builder resBuilder =
            ...
            AccountingPaymentsAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCreatePaymentResponse(Utils.unmarshal(response, new TypeReference<CreatePaymentResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingPaymentsAddRequest, com.apideck.unify.models.operations.async.AccountingPaymentsAddResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingPaymentsAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingPaymentsAddRequest.class, new TypeReference<AccountingPaymentsAddRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingPaymentsAddRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingPaymentsAddResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingPaymentsAddResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingPaymentsAddResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingPaymentsAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CreatePaymentResponse>() {})
                            .thenApply(res::withCreatePaymentResponse);
                } else {
