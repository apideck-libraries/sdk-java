...
public class AccountingPaymentsAddOperation implements RequestOperation<AccountingPaymentsAddRequest, AccountingPaymentsAddResponse> {
    ...
    public AccountingPaymentsAddOperation(
    ...
    public HttpRequest buildRequest(AccountingPaymentsAddRequest request) throws Exception {
