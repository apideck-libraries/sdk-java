...
public class AccountingPaymentsAll {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingPaymentsAllRequest, AccountingPaymentsAllResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingPaymentsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingPaymentsAllRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingPaymentsAllRequest request) {
        ...
        @Override
        public AccountingPaymentsAllResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingPaymentsAllResponse.Builder resBuilder =
            ...
            AccountingPaymentsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetPaymentsResponse(Utils.unmarshal(response, new TypeReference<GetPaymentsResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingPaymentsAllRequest, com.apideck.unify.models.operations.async.AccountingPaymentsAllResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingPaymentsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingPaymentsAllRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingPaymentsAllRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingPaymentsAllResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingPaymentsAllResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingPaymentsAllResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingPaymentsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetPaymentsResponse>() {})
                            .thenApply(res::withGetPaymentsResponse);
                } else {
