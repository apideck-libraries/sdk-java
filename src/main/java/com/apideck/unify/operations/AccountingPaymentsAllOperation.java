...
public class AccountingPaymentsAllOperation implements RequestOperation<AccountingPaymentsAllRequest, AccountingPaymentsAllResponse> {
    ...
    public AccountingPaymentsAllOperation(
    ...
    public HttpRequest buildRequest(AccountingPaymentsAllRequest request) throws Exception {
