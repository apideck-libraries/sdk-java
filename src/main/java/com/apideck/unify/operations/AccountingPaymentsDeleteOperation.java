...
public class AccountingPaymentsDeleteOperation implements RequestOperation<AccountingPaymentsDeleteRequest, AccountingPaymentsDeleteResponse> {
    ...
    public AccountingPaymentsDeleteOperation(
    ...
    public HttpRequest buildRequest(AccountingPaymentsDeleteRequest request) throws Exception {
