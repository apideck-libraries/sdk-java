...
public class AccountingPaymentsOneOperation implements RequestOperation<AccountingPaymentsOneRequest, AccountingPaymentsOneResponse> {
    ...
    public AccountingPaymentsOneOperation(
    ...
    public HttpRequest buildRequest(AccountingPaymentsOneRequest request) throws Exception {
