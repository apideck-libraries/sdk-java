...
public class AccountingPaymentsUpdate {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingPaymentsUpdateRequest, AccountingPaymentsUpdateResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingPaymentsUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingPaymentsUpdateRequest.class, new TypeReference<AccountingPaymentsUpdateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingPaymentsUpdateRequest request) {
        ...
        @Override
        public AccountingPaymentsUpdateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingPaymentsUpdateResponse.Builder resBuilder =
            ...
            AccountingPaymentsUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withUpdatePaymentResponse(Utils.unmarshal(response, new TypeReference<UpdatePaymentResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingPaymentsUpdateRequest, com.apideck.unify.models.operations.async.AccountingPaymentsUpdateResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingPaymentsUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingPaymentsUpdateRequest.class, new TypeReference<AccountingPaymentsUpdateRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingPaymentsUpdateRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingPaymentsUpdateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingPaymentsUpdateResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingPaymentsUpdateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingPaymentsUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<UpdatePaymentResponse>() {})
                            .thenApply(res::withUpdatePaymentResponse);
                } else {
