...
public class AccountingProfitAndLossOne {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingProfitAndLossOneRequest request) throws Exception {
        ...
        @Override
        public AccountingProfitAndLossOneResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GetProfitAndLossResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGetProfitAndLossResponse(out);
                    return res;
                } else {
