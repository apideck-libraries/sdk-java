...
public class AccountingProfitAndLossOne {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingProfitAndLossOneRequest, AccountingProfitAndLossOneResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingProfitAndLossOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingProfitAndLossOneRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingProfitAndLossOneRequest request) {
        ...
        @Override
        public AccountingProfitAndLossOneResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingProfitAndLossOneResponse.Builder resBuilder =
            ...
            AccountingProfitAndLossOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetProfitAndLossResponse(Utils.unmarshal(response, new TypeReference<GetProfitAndLossResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingProfitAndLossOneRequest, com.apideck.unify.models.operations.async.AccountingProfitAndLossOneResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingProfitAndLossOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingProfitAndLossOneRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingProfitAndLossOneRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingProfitAndLossOneResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingProfitAndLossOneResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingProfitAndLossOneResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingProfitAndLossOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetProfitAndLossResponse>() {})
                            .thenApply(res::withGetProfitAndLossResponse);
                } else {
