...
public class AccountingProfitAndLossOneOperation implements RequestOperation<AccountingProfitAndLossOneRequest, AccountingProfitAndLossOneResponse> {
    ...
    public AccountingProfitAndLossOneOperation(
    ...
    public HttpRequest buildRequest(AccountingProfitAndLossOneRequest request) throws Exception {
