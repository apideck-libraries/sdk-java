...
public class AccountingProjectsAdd {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingProjectsAddRequest, AccountingProjectsAddResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingProjectsAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingProjectsAddRequest.class, new TypeReference<AccountingProjectsAddRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingProjectsAddRequest request) {
        ...
        @Override
        public AccountingProjectsAddResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingProjectsAddResponse.Builder resBuilder =
            ...
            AccountingProjectsAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCreateProjectResponse(Utils.unmarshal(response, new TypeReference<CreateProjectResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingProjectsAddRequest, com.apideck.unify.models.operations.async.AccountingProjectsAddResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingProjectsAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingProjectsAddRequest.class, new TypeReference<AccountingProjectsAddRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingProjectsAddRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingProjectsAddResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingProjectsAddResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingProjectsAddResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingProjectsAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CreateProjectResponse>() {})
                            .thenApply(res::withCreateProjectResponse);
                } else {
