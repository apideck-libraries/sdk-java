...
public class AccountingProjectsAll {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingProjectsAllRequest, AccountingProjectsAllResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingProjectsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingProjectsAllRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingProjectsAllRequest request) {
        ...
        @Override
        public AccountingProjectsAllResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingProjectsAllResponse.Builder resBuilder =
            ...
            AccountingProjectsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetProjectsResponse(Utils.unmarshal(response, new TypeReference<GetProjectsResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingProjectsAllRequest, com.apideck.unify.models.operations.async.AccountingProjectsAllResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingProjectsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingProjectsAllRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingProjectsAllRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingProjectsAllResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingProjectsAllResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingProjectsAllResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingProjectsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetProjectsResponse>() {})
                            .thenApply(res::withGetProjectsResponse);
                } else {
