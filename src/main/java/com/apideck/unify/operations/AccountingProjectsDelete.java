...
public class AccountingProjectsDelete {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingProjectsDeleteRequest, AccountingProjectsDeleteResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingProjectsDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingProjectsDeleteRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingProjectsDeleteRequest request) {
        ...
        @Override
        public AccountingProjectsDeleteResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingProjectsDeleteResponse.Builder resBuilder =
            ...
            AccountingProjectsDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDeleteProjectResponse(Utils.unmarshal(response, new TypeReference<DeleteProjectResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingProjectsDeleteRequest, com.apideck.unify.models.operations.async.AccountingProjectsDeleteResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingProjectsDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingProjectsDeleteRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingProjectsDeleteRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingProjectsDeleteResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingProjectsDeleteResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingProjectsDeleteResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingProjectsDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DeleteProjectResponse>() {})
                            .thenApply(res::withDeleteProjectResponse);
                } else {
