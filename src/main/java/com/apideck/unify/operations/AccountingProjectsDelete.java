...
public class AccountingProjectsDelete {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingProjectsDeleteRequest request) throws Exception {
        ...
        @Override
        public AccountingProjectsDeleteResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    DeleteProjectResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withDeleteProjectResponse(out);
                    return res;
                } else {
