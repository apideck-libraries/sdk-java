...
public class AccountingProjectsOne {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingProjectsOneRequest, AccountingProjectsOneResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingProjectsOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingProjectsOneRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingProjectsOneRequest request) {
        ...
        @Override
        public AccountingProjectsOneResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingProjectsOneResponse.Builder resBuilder =
            ...
            AccountingProjectsOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetProjectResponse(Utils.unmarshal(response, new TypeReference<GetProjectResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingProjectsOneRequest, com.apideck.unify.models.operations.async.AccountingProjectsOneResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingProjectsOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingProjectsOneRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingProjectsOneRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingProjectsOneResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingProjectsOneResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingProjectsOneResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingProjectsOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetProjectResponse>() {})
                            .thenApply(res::withGetProjectResponse);
                } else {
