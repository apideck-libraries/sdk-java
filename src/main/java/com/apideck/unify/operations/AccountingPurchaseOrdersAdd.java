...
public class AccountingPurchaseOrdersAdd {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingPurchaseOrdersAddRequest, AccountingPurchaseOrdersAddResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingPurchaseOrdersAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingPurchaseOrdersAddRequest.class, new TypeReference<AccountingPurchaseOrdersAddRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingPurchaseOrdersAddRequest request) {
        ...
        @Override
        public AccountingPurchaseOrdersAddResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingPurchaseOrdersAddResponse.Builder resBuilder =
            ...
            AccountingPurchaseOrdersAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCreatePurchaseOrderResponse(Utils.unmarshal(response, new TypeReference<CreatePurchaseOrderResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingPurchaseOrdersAddRequest, com.apideck.unify.models.operations.async.AccountingPurchaseOrdersAddResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingPurchaseOrdersAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingPurchaseOrdersAddRequest.class, new TypeReference<AccountingPurchaseOrdersAddRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingPurchaseOrdersAddRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingPurchaseOrdersAddResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingPurchaseOrdersAddResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingPurchaseOrdersAddResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingPurchaseOrdersAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CreatePurchaseOrderResponse>() {})
                            .thenApply(res::withCreatePurchaseOrderResponse);
                } else {
