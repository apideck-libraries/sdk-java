...
public class AccountingPurchaseOrdersAdd {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingPurchaseOrdersAddRequest request) throws Exception {
        ...
        @Override
        public AccountingPurchaseOrdersAddResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    CreatePurchaseOrderResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCreatePurchaseOrderResponse(out);
                    return res;
                } else {
