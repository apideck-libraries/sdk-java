...
public class AccountingPurchaseOrdersAddOperation implements RequestOperation<AccountingPurchaseOrdersAddRequest, AccountingPurchaseOrdersAddResponse> {
    ...
    public AccountingPurchaseOrdersAddOperation(
    ...
    public HttpRequest buildRequest(AccountingPurchaseOrdersAddRequest request) throws Exception {
