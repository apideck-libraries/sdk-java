...
public class AccountingPurchaseOrdersAll {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingPurchaseOrdersAllRequest, AccountingPurchaseOrdersAllResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingPurchaseOrdersAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingPurchaseOrdersAllRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingPurchaseOrdersAllRequest request) {
        ...
        @Override
        public AccountingPurchaseOrdersAllResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingPurchaseOrdersAllResponse.Builder resBuilder =
            ...
            AccountingPurchaseOrdersAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetPurchaseOrdersResponse(Utils.unmarshal(response, new TypeReference<GetPurchaseOrdersResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingPurchaseOrdersAllRequest, com.apideck.unify.models.operations.async.AccountingPurchaseOrdersAllResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingPurchaseOrdersAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingPurchaseOrdersAllRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingPurchaseOrdersAllRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingPurchaseOrdersAllResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingPurchaseOrdersAllResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingPurchaseOrdersAllResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingPurchaseOrdersAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetPurchaseOrdersResponse>() {})
                            .thenApply(res::withGetPurchaseOrdersResponse);
                } else {
