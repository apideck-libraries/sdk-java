...
public class AccountingPurchaseOrdersAll {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingPurchaseOrdersAllRequest request) throws Exception {
        ...
        @Override
        public AccountingPurchaseOrdersAllResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GetPurchaseOrdersResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGetPurchaseOrdersResponse(out);
                    return res;
                } else {
