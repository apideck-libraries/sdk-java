...
public class AccountingPurchaseOrdersAllOperation implements RequestOperation<AccountingPurchaseOrdersAllRequest, AccountingPurchaseOrdersAllResponse> {
    ...
    public AccountingPurchaseOrdersAllOperation(
    ...
    public HttpRequest buildRequest(AccountingPurchaseOrdersAllRequest request) throws Exception {
