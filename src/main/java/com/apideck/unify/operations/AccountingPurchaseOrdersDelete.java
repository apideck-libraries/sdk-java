...
public class AccountingPurchaseOrdersDelete {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingPurchaseOrdersDeleteRequest, AccountingPurchaseOrdersDeleteResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingPurchaseOrdersDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingPurchaseOrdersDeleteRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingPurchaseOrdersDeleteRequest request) {
        ...
        @Override
        public AccountingPurchaseOrdersDeleteResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingPurchaseOrdersDeleteResponse.Builder resBuilder =
            ...
            AccountingPurchaseOrdersDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDeletePurchaseOrderResponse(Utils.unmarshal(response, new TypeReference<DeletePurchaseOrderResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingPurchaseOrdersDeleteRequest, com.apideck.unify.models.operations.async.AccountingPurchaseOrdersDeleteResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingPurchaseOrdersDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingPurchaseOrdersDeleteRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingPurchaseOrdersDeleteRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingPurchaseOrdersDeleteResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingPurchaseOrdersDeleteResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingPurchaseOrdersDeleteResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingPurchaseOrdersDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DeletePurchaseOrderResponse>() {})
                            .thenApply(res::withDeletePurchaseOrderResponse);
                } else {
