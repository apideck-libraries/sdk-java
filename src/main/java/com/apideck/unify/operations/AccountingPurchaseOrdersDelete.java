...
public class AccountingPurchaseOrdersDelete {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingPurchaseOrdersDeleteRequest request) throws Exception {
        ...
        @Override
        public AccountingPurchaseOrdersDeleteResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    DeletePurchaseOrderResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withDeletePurchaseOrderResponse(out);
                    return res;
                } else {
