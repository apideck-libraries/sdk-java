...
public class AccountingPurchaseOrdersDeleteOperation implements RequestOperation<AccountingPurchaseOrdersDeleteRequest, AccountingPurchaseOrdersDeleteResponse> {
    ...
    public AccountingPurchaseOrdersDeleteOperation(
    ...
    public HttpRequest buildRequest(AccountingPurchaseOrdersDeleteRequest request) throws Exception {
