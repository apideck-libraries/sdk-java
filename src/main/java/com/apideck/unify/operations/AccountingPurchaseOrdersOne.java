...
public class AccountingPurchaseOrdersOne {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingPurchaseOrdersOneRequest, AccountingPurchaseOrdersOneResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingPurchaseOrdersOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingPurchaseOrdersOneRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingPurchaseOrdersOneRequest request) {
        ...
        @Override
        public AccountingPurchaseOrdersOneResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingPurchaseOrdersOneResponse.Builder resBuilder =
            ...
            AccountingPurchaseOrdersOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetPurchaseOrderResponse(Utils.unmarshal(response, new TypeReference<GetPurchaseOrderResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingPurchaseOrdersOneRequest, com.apideck.unify.models.operations.async.AccountingPurchaseOrdersOneResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingPurchaseOrdersOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingPurchaseOrdersOneRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingPurchaseOrdersOneRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingPurchaseOrdersOneResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingPurchaseOrdersOneResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingPurchaseOrdersOneResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingPurchaseOrdersOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetPurchaseOrderResponse>() {})
                            .thenApply(res::withGetPurchaseOrderResponse);
                } else {
