...
public class AccountingPurchaseOrdersOne {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingPurchaseOrdersOneRequest request) throws Exception {
        ...
        @Override
        public AccountingPurchaseOrdersOneResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GetPurchaseOrderResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGetPurchaseOrderResponse(out);
                    return res;
                } else {
