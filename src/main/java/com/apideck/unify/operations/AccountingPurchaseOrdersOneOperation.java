...
public class AccountingPurchaseOrdersOneOperation implements RequestOperation<AccountingPurchaseOrdersOneRequest, AccountingPurchaseOrdersOneResponse> {
    ...
    public AccountingPurchaseOrdersOneOperation(
    ...
    public HttpRequest buildRequest(AccountingPurchaseOrdersOneRequest request) throws Exception {
