...
public class AccountingPurchaseOrdersUpdate {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingPurchaseOrdersUpdateRequest request) throws Exception {
        ...
        @Override
        public AccountingPurchaseOrdersUpdateResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    UpdatePurchaseOrderResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withUpdatePurchaseOrderResponse(out);
                    return res;
                } else {
