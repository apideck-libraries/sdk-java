...
public class AccountingPurchaseOrdersUpdate {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingPurchaseOrdersUpdateRequest, AccountingPurchaseOrdersUpdateResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingPurchaseOrdersUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingPurchaseOrdersUpdateRequest.class, new TypeReference<AccountingPurchaseOrdersUpdateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingPurchaseOrdersUpdateRequest request) {
        ...
        @Override
        public AccountingPurchaseOrdersUpdateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingPurchaseOrdersUpdateResponse.Builder resBuilder =
            ...
            AccountingPurchaseOrdersUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withUpdatePurchaseOrderResponse(Utils.unmarshal(response, new TypeReference<UpdatePurchaseOrderResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingPurchaseOrdersUpdateRequest, com.apideck.unify.models.operations.async.AccountingPurchaseOrdersUpdateResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingPurchaseOrdersUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingPurchaseOrdersUpdateRequest.class, new TypeReference<AccountingPurchaseOrdersUpdateRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingPurchaseOrdersUpdateRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingPurchaseOrdersUpdateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingPurchaseOrdersUpdateResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingPurchaseOrdersUpdateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingPurchaseOrdersUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<UpdatePurchaseOrderResponse>() {})
                            .thenApply(res::withUpdatePurchaseOrderResponse);
                } else {
