...
public class AccountingPurchaseOrdersUpdateOperation implements RequestOperation<AccountingPurchaseOrdersUpdateRequest, AccountingPurchaseOrdersUpdateResponse> {
    ...
    public AccountingPurchaseOrdersUpdateOperation(
    ...
    public HttpRequest buildRequest(AccountingPurchaseOrdersUpdateRequest request) throws Exception {
