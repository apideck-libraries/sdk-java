...
public class AccountingQuotesAdd {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(AccountingQuotesAddRequest request) throws Exception {
            ...
            Object convertedRequest = Utils.convertToShape(
                    request,
                    JsonShape.DEFAULT,
                    new TypeReference<AccountingQuotesAddRequest>() {
                    });
            ...
            req.addQueryParams(Utils.getQueryParams(
                    AccountingQuotesAddRequest.class,
                    request,
