...
public class AccountingQuotesAddOperation implements RequestOperation<AccountingQuotesAddRequest, AccountingQuotesAddResponse> {
    ...
    public AccountingQuotesAddOperation(
    ...
    public HttpRequest buildRequest(AccountingQuotesAddRequest request) throws Exception {
