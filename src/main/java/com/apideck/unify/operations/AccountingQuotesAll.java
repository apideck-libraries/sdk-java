...
public class AccountingQuotesAll {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingQuotesAllRequest, AccountingQuotesAllResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingQuotesAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingQuotesAllRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingQuotesAllRequest request) {
        ...
        @Override
        public AccountingQuotesAllResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingQuotesAllResponse.Builder resBuilder =
            ...
            AccountingQuotesAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetQuotesResponse(Utils.unmarshal(response, new TypeReference<GetQuotesResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingQuotesAllRequest, com.apideck.unify.models.operations.async.AccountingQuotesAllResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingQuotesAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingQuotesAllRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingQuotesAllRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingQuotesAllResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingQuotesAllResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingQuotesAllResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingQuotesAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetQuotesResponse>() {})
                            .thenApply(res::withGetQuotesResponse);
                } else {
