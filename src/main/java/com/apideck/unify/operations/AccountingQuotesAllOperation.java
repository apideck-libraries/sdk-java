...
public class AccountingQuotesAllOperation implements RequestOperation<AccountingQuotesAllRequest, AccountingQuotesAllResponse> {
    ...
    public AccountingQuotesAllOperation(
    ...
    public HttpRequest buildRequest(AccountingQuotesAllRequest request) throws Exception {
