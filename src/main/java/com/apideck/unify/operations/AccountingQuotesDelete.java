...
public class AccountingQuotesDelete {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingQuotesDeleteRequest, AccountingQuotesDeleteResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingQuotesDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingQuotesDeleteRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingQuotesDeleteRequest request) {
        ...
        @Override
        public AccountingQuotesDeleteResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingQuotesDeleteResponse.Builder resBuilder =
            ...
            AccountingQuotesDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDeleteQuoteResponse(Utils.unmarshal(response, new TypeReference<DeleteQuoteResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingQuotesDeleteRequest, com.apideck.unify.models.operations.async.AccountingQuotesDeleteResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingQuotesDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingQuotesDeleteRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingQuotesDeleteRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingQuotesDeleteResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingQuotesDeleteResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingQuotesDeleteResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingQuotesDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DeleteQuoteResponse>() {})
                            .thenApply(res::withDeleteQuoteResponse);
                } else {
