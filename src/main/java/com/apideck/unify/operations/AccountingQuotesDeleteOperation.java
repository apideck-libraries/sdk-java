...
public class AccountingQuotesDeleteOperation implements RequestOperation<AccountingQuotesDeleteRequest, AccountingQuotesDeleteResponse> {
    ...
    public AccountingQuotesDeleteOperation(
    ...
    public HttpRequest buildRequest(AccountingQuotesDeleteRequest request) throws Exception {
