...
public class AccountingQuotesOneOperation implements RequestOperation<AccountingQuotesOneRequest, AccountingQuotesOneResponse> {
    ...
    public AccountingQuotesOneOperation(
    ...
    public HttpRequest buildRequest(AccountingQuotesOneRequest request) throws Exception {
