...
public class AccountingQuotesUpdate {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(AccountingQuotesUpdateRequest request) throws Exception {
            String url = Utils.generateURL(
                    AccountingQuotesUpdateRequest.class,
                    this.baseUrl,
            ...
            Object convertedRequest = Utils.convertToShape(
                    request,
                    JsonShape.DEFAULT,
                    new TypeReference<AccountingQuotesUpdateRequest>() {
                    });
