...
public class AccountingQuotesUpdate {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingQuotesUpdateRequest, AccountingQuotesUpdateResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingQuotesUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingQuotesUpdateRequest.class, new TypeReference<AccountingQuotesUpdateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingQuotesUpdateRequest request) {
        ...
        @Override
        public AccountingQuotesUpdateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingQuotesUpdateResponse.Builder resBuilder =
            ...
            AccountingQuotesUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withUpdateQuoteResponse(Utils.unmarshal(response, new TypeReference<UpdateQuoteResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingQuotesUpdateRequest, com.apideck.unify.models.operations.async.AccountingQuotesUpdateResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingQuotesUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingQuotesUpdateRequest.class, new TypeReference<AccountingQuotesUpdateRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingQuotesUpdateRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingQuotesUpdateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingQuotesUpdateResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingQuotesUpdateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingQuotesUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<UpdateQuoteResponse>() {})
                            .thenApply(res::withUpdateQuoteResponse);
                } else {
