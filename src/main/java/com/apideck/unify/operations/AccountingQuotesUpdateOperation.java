...
public class AccountingQuotesUpdateOperation implements RequestOperation<AccountingQuotesUpdateRequest, AccountingQuotesUpdateResponse> {
    ...
    public AccountingQuotesUpdateOperation(
    ...
    public HttpRequest buildRequest(AccountingQuotesUpdateRequest request) throws Exception {
