...
public class AccountingRefundsAdd {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingRefundsAddRequest, AccountingRefundsAddResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingRefundsAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingRefundsAddRequest.class, new TypeReference<AccountingRefundsAddRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingRefundsAddRequest request) {
        ...
        @Override
        public AccountingRefundsAddResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingRefundsAddResponse.Builder resBuilder =
            ...
            AccountingRefundsAddResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingRefundsAddRequest, com.apideck.unify.models.operations.async.AccountingRefundsAddResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingRefundsAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingRefundsAddRequest.class, new TypeReference<AccountingRefundsAddRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingRefundsAddRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingRefundsAddResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingRefundsAddResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingRefundsAddResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingRefundsAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CreateRefundResponse>() {})
                            .thenApply(res::withCreateRefundResponse);
                } else {
