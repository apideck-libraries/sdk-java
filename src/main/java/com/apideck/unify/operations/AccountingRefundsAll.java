...
public class AccountingRefundsAll {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingRefundsAllRequest, AccountingRefundsAllResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingRefundsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingRefundsAllRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingRefundsAllRequest request) {
        ...
        @Override
        public AccountingRefundsAllResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingRefundsAllResponse.Builder resBuilder =
            ...
            AccountingRefundsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetRefundsResponse(Utils.unmarshal(response, new TypeReference<GetRefundsResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingRefundsAllRequest, com.apideck.unify.models.operations.async.AccountingRefundsAllResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingRefundsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingRefundsAllRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingRefundsAllRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingRefundsAllResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingRefundsAllResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingRefundsAllResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingRefundsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetRefundsResponse>() {})
                            .thenApply(res::withGetRefundsResponse);
                } else {
