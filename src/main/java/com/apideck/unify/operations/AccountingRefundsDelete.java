...
public class AccountingRefundsDelete {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingRefundsDeleteRequest, AccountingRefundsDeleteResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingRefundsDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingRefundsDeleteRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingRefundsDeleteRequest request) {
        ...
        @Override
        public AccountingRefundsDeleteResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingRefundsDeleteResponse.Builder resBuilder =
            ...
            AccountingRefundsDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDeleteRefundResponse(Utils.unmarshal(response, new TypeReference<DeleteRefundResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingRefundsDeleteRequest, com.apideck.unify.models.operations.async.AccountingRefundsDeleteResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingRefundsDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingRefundsDeleteRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingRefundsDeleteRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingRefundsDeleteResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingRefundsDeleteResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingRefundsDeleteResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingRefundsDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DeleteRefundResponse>() {})
                            .thenApply(res::withDeleteRefundResponse);
                } else {
