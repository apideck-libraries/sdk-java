...
public class AccountingRefundsOne {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingRefundsOneRequest, AccountingRefundsOneResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingRefundsOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingRefundsOneRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingRefundsOneRequest request) {
        ...
        @Override
        public AccountingRefundsOneResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingRefundsOneResponse.Builder resBuilder =
            ...
            AccountingRefundsOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetRefundResponse(Utils.unmarshal(response, new TypeReference<GetRefundResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingRefundsOneRequest, com.apideck.unify.models.operations.async.AccountingRefundsOneResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingRefundsOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingRefundsOneRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingRefundsOneRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingRefundsOneResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingRefundsOneResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingRefundsOneResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingRefundsOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetRefundResponse>() {})
                            .thenApply(res::withGetRefundResponse);
                } else {
