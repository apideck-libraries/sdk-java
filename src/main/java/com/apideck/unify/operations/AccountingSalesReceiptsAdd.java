...
public class AccountingSalesReceiptsAdd {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingSalesReceiptsAddRequest, AccountingSalesReceiptsAddResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingSalesReceiptsAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingSalesReceiptsAddRequest.class, new TypeReference<AccountingSalesReceiptsAddRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingSalesReceiptsAddRequest request) {
        ...
        @Override
        public AccountingSalesReceiptsAddResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingSalesReceiptsAddResponse.Builder resBuilder =
            ...
            AccountingSalesReceiptsAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCreateSalesReceiptResponse(Utils.unmarshal(response, new TypeReference<CreateSalesReceiptResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingSalesReceiptsAddRequest, com.apideck.unify.models.operations.async.AccountingSalesReceiptsAddResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingSalesReceiptsAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingSalesReceiptsAddRequest.class, new TypeReference<AccountingSalesReceiptsAddRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingSalesReceiptsAddRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingSalesReceiptsAddResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingSalesReceiptsAddResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingSalesReceiptsAddResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingSalesReceiptsAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CreateSalesReceiptResponse>() {})
                            .thenApply(res::withCreateSalesReceiptResponse);
                } else {
