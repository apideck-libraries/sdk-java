...
public class AccountingSalesReceiptsAll {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingSalesReceiptsAllRequest, AccountingSalesReceiptsAllResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingSalesReceiptsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingSalesReceiptsAllRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingSalesReceiptsAllRequest request) {
        ...
        @Override
        public AccountingSalesReceiptsAllResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingSalesReceiptsAllResponse.Builder resBuilder =
            ...
            AccountingSalesReceiptsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetSalesReceiptsResponse(Utils.unmarshal(response, new TypeReference<GetSalesReceiptsResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingSalesReceiptsAllRequest, com.apideck.unify.models.operations.async.AccountingSalesReceiptsAllResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingSalesReceiptsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingSalesReceiptsAllRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingSalesReceiptsAllRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingSalesReceiptsAllResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingSalesReceiptsAllResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingSalesReceiptsAllResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingSalesReceiptsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetSalesReceiptsResponse>() {})
                            .thenApply(res::withGetSalesReceiptsResponse);
                } else {
