...
public class AccountingSalesReceiptsDelete {
    ...
    static abstract class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "accounting.salesReceiptsDelete",
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingSalesReceiptsDeleteRequest, AccountingSalesReceiptsDeleteResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingSalesReceiptsDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingSalesReceiptsDeleteRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingSalesReceiptsDeleteRequest request) {
        ...
        @Override
        public AccountingSalesReceiptsDeleteResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingSalesReceiptsDeleteResponse.Builder resBuilder =
            ...
            AccountingSalesReceiptsDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDeleteSalesReceiptResponse(Utils.unmarshal(response, new TypeReference<DeleteSalesReceiptResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingSalesReceiptsDeleteRequest, com.apideck.unify.models.operations.async.AccountingSalesReceiptsDeleteResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingSalesReceiptsDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingSalesReceiptsDeleteRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingSalesReceiptsDeleteRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingSalesReceiptsDeleteResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingSalesReceiptsDeleteResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingSalesReceiptsDeleteResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingSalesReceiptsDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DeleteSalesReceiptResponse>() {})
                            .thenApply(res::withDeleteSalesReceiptResponse);
                } else {
