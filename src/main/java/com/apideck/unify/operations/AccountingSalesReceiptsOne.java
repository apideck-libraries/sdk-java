...
public class AccountingSalesReceiptsOne {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingSalesReceiptsOneRequest, AccountingSalesReceiptsOneResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingSalesReceiptsOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingSalesReceiptsOneRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingSalesReceiptsOneRequest request) {
        ...
        @Override
        public AccountingSalesReceiptsOneResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingSalesReceiptsOneResponse.Builder resBuilder =
            ...
            AccountingSalesReceiptsOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetSalesReceiptResponse(Utils.unmarshal(response, new TypeReference<GetSalesReceiptResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingSalesReceiptsOneRequest, com.apideck.unify.models.operations.async.AccountingSalesReceiptsOneResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingSalesReceiptsOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingSalesReceiptsOneRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingSalesReceiptsOneRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingSalesReceiptsOneResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingSalesReceiptsOneResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingSalesReceiptsOneResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingSalesReceiptsOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetSalesReceiptResponse>() {})
                            .thenApply(res::withGetSalesReceiptResponse);
                } else {
