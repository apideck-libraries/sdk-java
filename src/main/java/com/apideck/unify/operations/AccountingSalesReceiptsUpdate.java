...
public class AccountingSalesReceiptsUpdate {
    ...
    static abstract class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "accounting.salesReceiptsUpdate",
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingSalesReceiptsUpdateRequest, AccountingSalesReceiptsUpdateResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingSalesReceiptsUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingSalesReceiptsUpdateRequest.class, new TypeReference<AccountingSalesReceiptsUpdateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingSalesReceiptsUpdateRequest request) {
        ...
        @Override
        public AccountingSalesReceiptsUpdateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingSalesReceiptsUpdateResponse.Builder resBuilder =
            ...
            AccountingSalesReceiptsUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withUpdateSalesReceiptResponse(Utils.unmarshal(response, new TypeReference<UpdateSalesReceiptResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingSalesReceiptsUpdateRequest, com.apideck.unify.models.operations.async.AccountingSalesReceiptsUpdateResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingSalesReceiptsUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingSalesReceiptsUpdateRequest.class, new TypeReference<AccountingSalesReceiptsUpdateRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingSalesReceiptsUpdateRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingSalesReceiptsUpdateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingSalesReceiptsUpdateResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingSalesReceiptsUpdateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingSalesReceiptsUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<UpdateSalesReceiptResponse>() {})
                            .thenApply(res::withUpdateSalesReceiptResponse);
                } else {
