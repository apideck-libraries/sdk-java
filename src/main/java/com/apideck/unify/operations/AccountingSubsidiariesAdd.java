...
public class AccountingSubsidiariesAdd {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingSubsidiariesAddRequest, AccountingSubsidiariesAddResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingSubsidiariesAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingSubsidiariesAddRequest.class, new TypeReference<AccountingSubsidiariesAddRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingSubsidiariesAddRequest request) {
        ...
        @Override
        public AccountingSubsidiariesAddResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingSubsidiariesAddResponse.Builder resBuilder =
            ...
            AccountingSubsidiariesAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCreateSubsidiaryResponse(Utils.unmarshal(response, new TypeReference<CreateSubsidiaryResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingSubsidiariesAddRequest, com.apideck.unify.models.operations.async.AccountingSubsidiariesAddResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingSubsidiariesAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingSubsidiariesAddRequest.class, new TypeReference<AccountingSubsidiariesAddRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingSubsidiariesAddRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingSubsidiariesAddResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingSubsidiariesAddResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingSubsidiariesAddResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingSubsidiariesAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CreateSubsidiaryResponse>() {})
                            .thenApply(res::withCreateSubsidiaryResponse);
                } else {
