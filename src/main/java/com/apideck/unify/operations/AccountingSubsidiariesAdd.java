...
public class AccountingSubsidiariesAdd {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingSubsidiariesAddRequest request) throws Exception {
        ...
        @Override
        public AccountingSubsidiariesAddResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    CreateSubsidiaryResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCreateSubsidiaryResponse(out);
                    return res;
                } else {
