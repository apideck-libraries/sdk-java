...
public class AccountingSubsidiariesAddOperation implements RequestOperation<AccountingSubsidiariesAddRequest, AccountingSubsidiariesAddResponse> {
    ...
    public AccountingSubsidiariesAddOperation(
    ...
    public HttpRequest buildRequest(AccountingSubsidiariesAddRequest request) throws Exception {
