...
public class AccountingSubsidiariesAll {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingSubsidiariesAllRequest, AccountingSubsidiariesAllResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingSubsidiariesAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingSubsidiariesAllRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingSubsidiariesAllRequest request) {
        ...
        @Override
        public AccountingSubsidiariesAllResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingSubsidiariesAllResponse.Builder resBuilder =
            ...
            AccountingSubsidiariesAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetSubsidiariesResponse(Utils.unmarshal(response, new TypeReference<GetSubsidiariesResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingSubsidiariesAllRequest, com.apideck.unify.models.operations.async.AccountingSubsidiariesAllResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingSubsidiariesAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingSubsidiariesAllRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingSubsidiariesAllRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingSubsidiariesAllResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingSubsidiariesAllResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingSubsidiariesAllResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingSubsidiariesAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetSubsidiariesResponse>() {})
                            .thenApply(res::withGetSubsidiariesResponse);
                } else {
