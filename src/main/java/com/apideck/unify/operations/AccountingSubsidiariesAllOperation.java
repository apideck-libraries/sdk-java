...
public class AccountingSubsidiariesAllOperation implements RequestOperation<AccountingSubsidiariesAllRequest, AccountingSubsidiariesAllResponse> {
    ...
    public AccountingSubsidiariesAllOperation(
    ...
    public HttpRequest buildRequest(AccountingSubsidiariesAllRequest request) throws Exception {
