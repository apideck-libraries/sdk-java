...
public class AccountingSubsidiariesDelete {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingSubsidiariesDeleteRequest, AccountingSubsidiariesDeleteResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingSubsidiariesDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingSubsidiariesDeleteRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingSubsidiariesDeleteRequest request) {
        ...
        @Override
        public AccountingSubsidiariesDeleteResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingSubsidiariesDeleteResponse.Builder resBuilder =
            ...
            AccountingSubsidiariesDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDeleteSubsidiaryResponse(Utils.unmarshal(response, new TypeReference<DeleteSubsidiaryResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingSubsidiariesDeleteRequest, com.apideck.unify.models.operations.async.AccountingSubsidiariesDeleteResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingSubsidiariesDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingSubsidiariesDeleteRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingSubsidiariesDeleteRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingSubsidiariesDeleteResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingSubsidiariesDeleteResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingSubsidiariesDeleteResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingSubsidiariesDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DeleteSubsidiaryResponse>() {})
                            .thenApply(res::withDeleteSubsidiaryResponse);
                } else {
