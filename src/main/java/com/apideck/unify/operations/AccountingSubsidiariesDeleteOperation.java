...
public class AccountingSubsidiariesDeleteOperation implements RequestOperation<AccountingSubsidiariesDeleteRequest, AccountingSubsidiariesDeleteResponse> {
    ...
    public AccountingSubsidiariesDeleteOperation(
    ...
    public HttpRequest buildRequest(AccountingSubsidiariesDeleteRequest request) throws Exception {
