...
public class AccountingSubsidiariesOne {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingSubsidiariesOneRequest request) throws Exception {
        ...
        @Override
        public AccountingSubsidiariesOneResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GetSubsidiaryResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGetSubsidiaryResponse(out);
                    return res;
                } else {
