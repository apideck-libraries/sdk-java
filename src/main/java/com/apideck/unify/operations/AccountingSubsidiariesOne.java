...
public class AccountingSubsidiariesOne {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingSubsidiariesOneRequest, AccountingSubsidiariesOneResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingSubsidiariesOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingSubsidiariesOneRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingSubsidiariesOneRequest request) {
        ...
        @Override
        public AccountingSubsidiariesOneResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingSubsidiariesOneResponse.Builder resBuilder =
            ...
            AccountingSubsidiariesOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetSubsidiaryResponse(Utils.unmarshal(response, new TypeReference<GetSubsidiaryResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingSubsidiariesOneRequest, com.apideck.unify.models.operations.async.AccountingSubsidiariesOneResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingSubsidiariesOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingSubsidiariesOneRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingSubsidiariesOneRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingSubsidiariesOneResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingSubsidiariesOneResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingSubsidiariesOneResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingSubsidiariesOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetSubsidiaryResponse>() {})
                            .thenApply(res::withGetSubsidiaryResponse);
                } else {
