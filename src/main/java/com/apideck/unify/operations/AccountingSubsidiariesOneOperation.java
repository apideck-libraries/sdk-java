...
public class AccountingSubsidiariesOneOperation implements RequestOperation<AccountingSubsidiariesOneRequest, AccountingSubsidiariesOneResponse> {
    ...
    public AccountingSubsidiariesOneOperation(
    ...
    public HttpRequest buildRequest(AccountingSubsidiariesOneRequest request) throws Exception {
