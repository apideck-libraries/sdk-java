...
public class AccountingSubsidiariesUpdate {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingSubsidiariesUpdateRequest, AccountingSubsidiariesUpdateResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingSubsidiariesUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingSubsidiariesUpdateRequest.class, new TypeReference<AccountingSubsidiariesUpdateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingSubsidiariesUpdateRequest request) {
        ...
        @Override
        public AccountingSubsidiariesUpdateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingSubsidiariesUpdateResponse.Builder resBuilder =
            ...
            AccountingSubsidiariesUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withUpdateSubsidiaryResponse(Utils.unmarshal(response, new TypeReference<UpdateSubsidiaryResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingSubsidiariesUpdateRequest, com.apideck.unify.models.operations.async.AccountingSubsidiariesUpdateResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingSubsidiariesUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingSubsidiariesUpdateRequest.class, new TypeReference<AccountingSubsidiariesUpdateRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingSubsidiariesUpdateRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingSubsidiariesUpdateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingSubsidiariesUpdateResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingSubsidiariesUpdateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingSubsidiariesUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<UpdateSubsidiaryResponse>() {})
                            .thenApply(res::withUpdateSubsidiaryResponse);
                } else {
