...
public class AccountingSubsidiariesUpdateOperation implements RequestOperation<AccountingSubsidiariesUpdateRequest, AccountingSubsidiariesUpdateResponse> {
    ...
    public AccountingSubsidiariesUpdateOperation(
    ...
    public HttpRequest buildRequest(AccountingSubsidiariesUpdateRequest request) throws Exception {
