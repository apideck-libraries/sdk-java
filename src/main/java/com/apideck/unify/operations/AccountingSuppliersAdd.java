...
public class AccountingSuppliersAdd {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingSuppliersAddRequest, AccountingSuppliersAddResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingSuppliersAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingSuppliersAddRequest.class, new TypeReference<AccountingSuppliersAddRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingSuppliersAddRequest request) {
        ...
        @Override
        public AccountingSuppliersAddResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingSuppliersAddResponse.Builder resBuilder =
            ...
            AccountingSuppliersAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCreateSupplierResponse(Utils.unmarshal(response, new TypeReference<CreateSupplierResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingSuppliersAddRequest, com.apideck.unify.models.operations.async.AccountingSuppliersAddResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingSuppliersAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingSuppliersAddRequest.class, new TypeReference<AccountingSuppliersAddRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingSuppliersAddRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingSuppliersAddResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingSuppliersAddResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingSuppliersAddResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingSuppliersAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CreateSupplierResponse>() {})
                            .thenApply(res::withCreateSupplierResponse);
                } else {
