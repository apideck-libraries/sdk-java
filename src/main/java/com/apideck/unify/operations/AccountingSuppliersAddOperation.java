...
public class AccountingSuppliersAddOperation implements RequestOperation<AccountingSuppliersAddRequest, AccountingSuppliersAddResponse> {
    ...
    public AccountingSuppliersAddOperation(
    ...
    public HttpRequest buildRequest(AccountingSuppliersAddRequest request) throws Exception {
