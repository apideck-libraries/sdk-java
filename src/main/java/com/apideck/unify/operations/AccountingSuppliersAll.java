...
public class AccountingSuppliersAll {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingSuppliersAllRequest, AccountingSuppliersAllResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingSuppliersAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingSuppliersAllRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingSuppliersAllRequest request) {
        ...
        @Override
        public AccountingSuppliersAllResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingSuppliersAllResponse.Builder resBuilder =
            ...
            AccountingSuppliersAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetSuppliersResponse(Utils.unmarshal(response, new TypeReference<GetSuppliersResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingSuppliersAllRequest, com.apideck.unify.models.operations.async.AccountingSuppliersAllResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingSuppliersAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingSuppliersAllRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingSuppliersAllRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingSuppliersAllResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingSuppliersAllResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingSuppliersAllResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingSuppliersAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetSuppliersResponse>() {})
                            .thenApply(res::withGetSuppliersResponse);
                } else {
