...
public class AccountingSuppliersAllOperation implements RequestOperation<AccountingSuppliersAllRequest, AccountingSuppliersAllResponse> {
    ...
    public AccountingSuppliersAllOperation(
    ...
    public HttpRequest buildRequest(AccountingSuppliersAllRequest request) throws Exception {
