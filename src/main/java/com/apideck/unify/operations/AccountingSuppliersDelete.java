...
public class AccountingSuppliersDelete {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingSuppliersDeleteRequest, AccountingSuppliersDeleteResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingSuppliersDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingSuppliersDeleteRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingSuppliersDeleteRequest request) {
        ...
        @Override
        public AccountingSuppliersDeleteResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingSuppliersDeleteResponse.Builder resBuilder =
            ...
            AccountingSuppliersDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDeleteSupplierResponse(Utils.unmarshal(response, new TypeReference<DeleteSupplierResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingSuppliersDeleteRequest, com.apideck.unify.models.operations.async.AccountingSuppliersDeleteResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingSuppliersDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingSuppliersDeleteRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingSuppliersDeleteRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingSuppliersDeleteResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingSuppliersDeleteResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingSuppliersDeleteResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingSuppliersDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DeleteSupplierResponse>() {})
                            .thenApply(res::withDeleteSupplierResponse);
                } else {
