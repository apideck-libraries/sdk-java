...
public class AccountingSuppliersOne {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingSuppliersOneRequest, AccountingSuppliersOneResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingSuppliersOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingSuppliersOneRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingSuppliersOneRequest request) {
        ...
        @Override
        public AccountingSuppliersOneResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingSuppliersOneResponse.Builder resBuilder =
            ...
            AccountingSuppliersOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetSupplierResponse(Utils.unmarshal(response, new TypeReference<GetSupplierResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingSuppliersOneRequest, com.apideck.unify.models.operations.async.AccountingSuppliersOneResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingSuppliersOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingSuppliersOneRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingSuppliersOneRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingSuppliersOneResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingSuppliersOneResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingSuppliersOneResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingSuppliersOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetSupplierResponse>() {})
                            .thenApply(res::withGetSupplierResponse);
                } else {
