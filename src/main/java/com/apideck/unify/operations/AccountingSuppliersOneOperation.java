...
public class AccountingSuppliersOneOperation implements RequestOperation<AccountingSuppliersOneRequest, AccountingSuppliersOneResponse> {
    ...
    public AccountingSuppliersOneOperation(
    ...
    public HttpRequest buildRequest(AccountingSuppliersOneRequest request) throws Exception {
