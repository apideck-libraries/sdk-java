...
public class AccountingSuppliersUpdate {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingSuppliersUpdateRequest, AccountingSuppliersUpdateResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingSuppliersUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingSuppliersUpdateRequest.class, new TypeReference<AccountingSuppliersUpdateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingSuppliersUpdateRequest request) {
        ...
        @Override
        public AccountingSuppliersUpdateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingSuppliersUpdateResponse.Builder resBuilder =
            ...
            AccountingSuppliersUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withUpdateSupplierResponse(Utils.unmarshal(response, new TypeReference<UpdateSupplierResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingSuppliersUpdateRequest, com.apideck.unify.models.operations.async.AccountingSuppliersUpdateResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingSuppliersUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingSuppliersUpdateRequest.class, new TypeReference<AccountingSuppliersUpdateRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingSuppliersUpdateRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingSuppliersUpdateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingSuppliersUpdateResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingSuppliersUpdateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingSuppliersUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<UpdateSupplierResponse>() {})
                            .thenApply(res::withUpdateSupplierResponse);
                } else {
