...
public class AccountingSuppliersUpdateOperation implements RequestOperation<AccountingSuppliersUpdateRequest, AccountingSuppliersUpdateResponse> {
    ...
    public AccountingSuppliersUpdateOperation(
    ...
    public HttpRequest buildRequest(AccountingSuppliersUpdateRequest request) throws Exception {
