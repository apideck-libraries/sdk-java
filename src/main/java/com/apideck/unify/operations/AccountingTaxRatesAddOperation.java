...
public class AccountingTaxRatesAddOperation implements RequestOperation<AccountingTaxRatesAddRequest, AccountingTaxRatesAddResponse> {
    ...
    public AccountingTaxRatesAddOperation(
    ...
    public HttpRequest buildRequest(AccountingTaxRatesAddRequest request) throws Exception {
