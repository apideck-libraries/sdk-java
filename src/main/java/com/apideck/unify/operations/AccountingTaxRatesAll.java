...
public class AccountingTaxRatesAll {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingTaxRatesAllRequest, AccountingTaxRatesAllResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingTaxRatesAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingTaxRatesAllRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingTaxRatesAllRequest request) {
        ...
        @Override
        public AccountingTaxRatesAllResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingTaxRatesAllResponse.Builder resBuilder =
            ...
            AccountingTaxRatesAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetTaxRatesResponse(Utils.unmarshal(response, new TypeReference<GetTaxRatesResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingTaxRatesAllRequest, com.apideck.unify.models.operations.async.AccountingTaxRatesAllResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingTaxRatesAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingTaxRatesAllRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingTaxRatesAllRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingTaxRatesAllResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingTaxRatesAllResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingTaxRatesAllResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingTaxRatesAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetTaxRatesResponse>() {})
                            .thenApply(res::withGetTaxRatesResponse);
                } else {
