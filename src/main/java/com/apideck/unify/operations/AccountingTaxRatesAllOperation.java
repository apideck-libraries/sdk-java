...
public class AccountingTaxRatesAllOperation implements RequestOperation<AccountingTaxRatesAllRequest, AccountingTaxRatesAllResponse> {
    ...
    public AccountingTaxRatesAllOperation(
    ...
    public HttpRequest buildRequest(AccountingTaxRatesAllRequest request) throws Exception {
