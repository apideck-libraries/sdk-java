...
public class AccountingTaxRatesDeleteOperation implements RequestOperation<AccountingTaxRatesDeleteRequest, AccountingTaxRatesDeleteResponse> {
    ...
    public AccountingTaxRatesDeleteOperation(
    ...
    public HttpRequest buildRequest(AccountingTaxRatesDeleteRequest request) throws Exception {
