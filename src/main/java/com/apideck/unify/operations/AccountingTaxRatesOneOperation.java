...
public class AccountingTaxRatesOneOperation implements RequestOperation<AccountingTaxRatesOneRequest, AccountingTaxRatesOneResponse> {
    ...
    public AccountingTaxRatesOneOperation(
    ...
    public HttpRequest buildRequest(AccountingTaxRatesOneRequest request) throws Exception {
