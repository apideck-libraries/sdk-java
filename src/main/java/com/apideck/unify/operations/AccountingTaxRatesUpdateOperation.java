...
public class AccountingTaxRatesUpdateOperation implements RequestOperation<AccountingTaxRatesUpdateRequest, AccountingTaxRatesUpdateResponse> {
    ...
    public AccountingTaxRatesUpdateOperation(
    ...
    public HttpRequest buildRequest(AccountingTaxRatesUpdateRequest request) throws Exception {
