...
public class AccountingTrackingCategoriesAdd {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingTrackingCategoriesAddRequest request) throws Exception {
        ...
        @Override
        public AccountingTrackingCategoriesAddResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    CreateTrackingCategoryResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCreateTrackingCategoryResponse(out);
                    return res;
                } else {
