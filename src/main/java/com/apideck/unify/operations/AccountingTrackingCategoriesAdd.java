...
public class AccountingTrackingCategoriesAdd {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingTrackingCategoriesAddRequest, AccountingTrackingCategoriesAddResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingTrackingCategoriesAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingTrackingCategoriesAddRequest.class, new TypeReference<AccountingTrackingCategoriesAddRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingTrackingCategoriesAddRequest request) {
        ...
        @Override
        public AccountingTrackingCategoriesAddResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingTrackingCategoriesAddResponse.Builder resBuilder =
            ...
            AccountingTrackingCategoriesAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCreateTrackingCategoryResponse(Utils.unmarshal(response, new TypeReference<CreateTrackingCategoryResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingTrackingCategoriesAddRequest, com.apideck.unify.models.operations.async.AccountingTrackingCategoriesAddResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingTrackingCategoriesAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingTrackingCategoriesAddRequest.class, new TypeReference<AccountingTrackingCategoriesAddRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingTrackingCategoriesAddRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingTrackingCategoriesAddResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingTrackingCategoriesAddResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingTrackingCategoriesAddResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingTrackingCategoriesAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CreateTrackingCategoryResponse>() {})
                            .thenApply(res::withCreateTrackingCategoryResponse);
                } else {
