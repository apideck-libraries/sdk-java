...
public class AccountingTrackingCategoriesAddOperation implements RequestOperation<AccountingTrackingCategoriesAddRequest, AccountingTrackingCategoriesAddResponse> {
    ...
    public AccountingTrackingCategoriesAddOperation(
    ...
    public HttpRequest buildRequest(AccountingTrackingCategoriesAddRequest request) throws Exception {
