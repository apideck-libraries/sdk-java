...
public class AccountingTrackingCategoriesAll {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingTrackingCategoriesAllRequest, AccountingTrackingCategoriesAllResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingTrackingCategoriesAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingTrackingCategoriesAllRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingTrackingCategoriesAllRequest request) {
        ...
        @Override
        public AccountingTrackingCategoriesAllResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingTrackingCategoriesAllResponse.Builder resBuilder =
            ...
            AccountingTrackingCategoriesAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetTrackingCategoriesResponse(Utils.unmarshal(response, new TypeReference<GetTrackingCategoriesResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingTrackingCategoriesAllRequest, com.apideck.unify.models.operations.async.AccountingTrackingCategoriesAllResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingTrackingCategoriesAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingTrackingCategoriesAllRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingTrackingCategoriesAllRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingTrackingCategoriesAllResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingTrackingCategoriesAllResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingTrackingCategoriesAllResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingTrackingCategoriesAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetTrackingCategoriesResponse>() {})
                            .thenApply(res::withGetTrackingCategoriesResponse);
                } else {
