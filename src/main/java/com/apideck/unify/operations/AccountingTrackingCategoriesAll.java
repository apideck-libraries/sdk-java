...
public class AccountingTrackingCategoriesAll {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingTrackingCategoriesAllRequest request) throws Exception {
        ...
        @Override
        public AccountingTrackingCategoriesAllResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GetTrackingCategoriesResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGetTrackingCategoriesResponse(out);
                    return res;
                } else {
