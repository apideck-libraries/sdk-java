...
public class AccountingTrackingCategoriesAllOperation implements RequestOperation<AccountingTrackingCategoriesAllRequest, AccountingTrackingCategoriesAllResponse> {
    ...
    public AccountingTrackingCategoriesAllOperation(
    ...
    public HttpRequest buildRequest(AccountingTrackingCategoriesAllRequest request) throws Exception {
