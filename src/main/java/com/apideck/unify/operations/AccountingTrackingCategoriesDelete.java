...
public class AccountingTrackingCategoriesDelete {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingTrackingCategoriesDeleteRequest request) throws Exception {
        ...
        @Override
        public AccountingTrackingCategoriesDeleteResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    DeleteTrackingCategoryResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withDeleteTrackingCategoryResponse(out);
                    return res;
                } else {
