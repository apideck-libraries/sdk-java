...
public class AccountingTrackingCategoriesDelete {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingTrackingCategoriesDeleteRequest, AccountingTrackingCategoriesDeleteResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingTrackingCategoriesDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingTrackingCategoriesDeleteRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingTrackingCategoriesDeleteRequest request) {
        ...
        @Override
        public AccountingTrackingCategoriesDeleteResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingTrackingCategoriesDeleteResponse.Builder resBuilder =
            ...
            AccountingTrackingCategoriesDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDeleteTrackingCategoryResponse(Utils.unmarshal(response, new TypeReference<DeleteTrackingCategoryResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingTrackingCategoriesDeleteRequest, com.apideck.unify.models.operations.async.AccountingTrackingCategoriesDeleteResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingTrackingCategoriesDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingTrackingCategoriesDeleteRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingTrackingCategoriesDeleteRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingTrackingCategoriesDeleteResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingTrackingCategoriesDeleteResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingTrackingCategoriesDeleteResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingTrackingCategoriesDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DeleteTrackingCategoryResponse>() {})
                            .thenApply(res::withDeleteTrackingCategoryResponse);
                } else {
