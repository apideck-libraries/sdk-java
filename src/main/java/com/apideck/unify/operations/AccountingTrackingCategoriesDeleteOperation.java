...
public class AccountingTrackingCategoriesDeleteOperation implements RequestOperation<AccountingTrackingCategoriesDeleteRequest, AccountingTrackingCategoriesDeleteResponse> {
    ...
    public AccountingTrackingCategoriesDeleteOperation(
    ...
    public HttpRequest buildRequest(AccountingTrackingCategoriesDeleteRequest request) throws Exception {
