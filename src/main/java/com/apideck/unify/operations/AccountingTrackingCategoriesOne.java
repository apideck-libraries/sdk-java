...
public class AccountingTrackingCategoriesOne {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingTrackingCategoriesOneRequest, AccountingTrackingCategoriesOneResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingTrackingCategoriesOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingTrackingCategoriesOneRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingTrackingCategoriesOneRequest request) {
        ...
        @Override
        public AccountingTrackingCategoriesOneResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingTrackingCategoriesOneResponse.Builder resBuilder =
            ...
            AccountingTrackingCategoriesOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetTrackingCategoryResponse(Utils.unmarshal(response, new TypeReference<GetTrackingCategoryResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingTrackingCategoriesOneRequest, com.apideck.unify.models.operations.async.AccountingTrackingCategoriesOneResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingTrackingCategoriesOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingTrackingCategoriesOneRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingTrackingCategoriesOneRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingTrackingCategoriesOneResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingTrackingCategoriesOneResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingTrackingCategoriesOneResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingTrackingCategoriesOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetTrackingCategoryResponse>() {})
                            .thenApply(res::withGetTrackingCategoryResponse);
                } else {
