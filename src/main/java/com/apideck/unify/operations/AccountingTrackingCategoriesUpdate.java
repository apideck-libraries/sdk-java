...
public class AccountingTrackingCategoriesUpdate {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountingTrackingCategoriesUpdateRequest, AccountingTrackingCategoriesUpdateResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AccountingTrackingCategoriesUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingTrackingCategoriesUpdateRequest.class, new TypeReference<AccountingTrackingCategoriesUpdateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingTrackingCategoriesUpdateRequest request) {
        ...
        @Override
        public AccountingTrackingCategoriesUpdateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AccountingTrackingCategoriesUpdateResponse.Builder resBuilder =
            ...
            AccountingTrackingCategoriesUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withUpdateTrackingCategoryResponse(Utils.unmarshal(response, new TypeReference<UpdateTrackingCategoryResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AccountingTrackingCategoriesUpdateRequest, com.apideck.unify.models.operations.async.AccountingTrackingCategoriesUpdateResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AccountingTrackingCategoriesUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AccountingTrackingCategoriesUpdateRequest.class, new TypeReference<AccountingTrackingCategoriesUpdateRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AccountingTrackingCategoriesUpdateRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AccountingTrackingCategoriesUpdateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AccountingTrackingCategoriesUpdateResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AccountingTrackingCategoriesUpdateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AccountingTrackingCategoriesUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<UpdateTrackingCategoryResponse>() {})
                            .thenApply(res::withUpdateTrackingCategoryResponse);
                } else {
