...
public class AccountingTrackingCategoriesUpdate {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountingTrackingCategoriesUpdateRequest request) throws Exception {
        ...
        @Override
        public AccountingTrackingCategoriesUpdateResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    UpdateTrackingCategoryResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withUpdateTrackingCategoryResponse(out);
                    return res;
                } else {
