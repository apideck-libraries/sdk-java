...
public class AtsApplicantsAdd {
    ...
    public static class Sync extends Base
            implements RequestOperation<AtsApplicantsAddRequest, AtsApplicantsAddResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AtsApplicantsAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsApplicantsAddRequest.class, new TypeReference<AtsApplicantsAddRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsApplicantsAddRequest request) {
        ...
        @Override
        public AtsApplicantsAddResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCreateApplicantResponse(Utils.unmarshal(response, new TypeReference<CreateApplicantResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AtsApplicantsAddRequest, com.apideck.unify.models.operations.async.AtsApplicantsAddResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AtsApplicantsAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsApplicantsAddRequest.class, new TypeReference<AtsApplicantsAddRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AtsApplicantsAddRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AtsApplicantsAddResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AtsApplicantsAddResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AtsApplicantsAddResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AtsApplicantsAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CreateApplicantResponse>() {})
                            .thenApply(res::withCreateApplicantResponse);
                } else {
