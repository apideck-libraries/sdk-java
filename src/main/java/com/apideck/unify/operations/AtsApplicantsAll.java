...
public class AtsApplicantsAll {
    ...
    public static class Sync extends Base
            implements RequestOperation<AtsApplicantsAllRequest, AtsApplicantsAllResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AtsApplicantsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsApplicantsAllRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsApplicantsAllRequest request) {
        ...
        @Override
        public AtsApplicantsAllResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AtsApplicantsAllResponse.Builder resBuilder =
            ...
            AtsApplicantsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetApplicantsResponse(Utils.unmarshal(response, new TypeReference<GetApplicantsResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AtsApplicantsAllRequest, com.apideck.unify.models.operations.async.AtsApplicantsAllResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AtsApplicantsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsApplicantsAllRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AtsApplicantsAllRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AtsApplicantsAllResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AtsApplicantsAllResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AtsApplicantsAllResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AtsApplicantsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetApplicantsResponse>() {})
                            .thenApply(res::withGetApplicantsResponse);
                } else {
