...
public class AtsApplicantsAllOperation implements RequestOperation<AtsApplicantsAllRequest, AtsApplicantsAllResponse> {
    ...
    public AtsApplicantsAllOperation(
    ...
    public HttpRequest buildRequest(AtsApplicantsAllRequest request) throws Exception {
