...
public class AtsApplicantsDelete {
    ...
    public static class Sync extends Base
            implements RequestOperation<AtsApplicantsDeleteRequest, AtsApplicantsDeleteResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AtsApplicantsDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsApplicantsDeleteRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsApplicantsDeleteRequest request) {
        ...
        @Override
        public AtsApplicantsDeleteResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AtsApplicantsDeleteResponse.Builder resBuilder =
            ...
            AtsApplicantsDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDeleteApplicantResponse(Utils.unmarshal(response, new TypeReference<DeleteApplicantResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AtsApplicantsDeleteRequest, com.apideck.unify.models.operations.async.AtsApplicantsDeleteResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AtsApplicantsDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsApplicantsDeleteRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AtsApplicantsDeleteRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AtsApplicantsDeleteResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AtsApplicantsDeleteResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AtsApplicantsDeleteResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AtsApplicantsDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DeleteApplicantResponse>() {})
                            .thenApply(res::withDeleteApplicantResponse);
                } else {
