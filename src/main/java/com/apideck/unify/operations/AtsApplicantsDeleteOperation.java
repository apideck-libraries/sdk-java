...
public class AtsApplicantsDeleteOperation implements RequestOperation<AtsApplicantsDeleteRequest, AtsApplicantsDeleteResponse> {
    ...
    public AtsApplicantsDeleteOperation(
    ...
    public HttpRequest buildRequest(AtsApplicantsDeleteRequest request) throws Exception {
