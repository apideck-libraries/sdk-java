...
public class AtsApplicantsOne {
    ...
    public static class Sync extends Base
            implements RequestOperation<AtsApplicantsOneRequest, AtsApplicantsOneResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AtsApplicantsOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsApplicantsOneRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsApplicantsOneRequest request) {
        ...
        @Override
        public AtsApplicantsOneResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AtsApplicantsOneResponse.Builder resBuilder =
            ...
            AtsApplicantsOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetApplicantResponse(Utils.unmarshal(response, new TypeReference<GetApplicantResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AtsApplicantsOneRequest, com.apideck.unify.models.operations.async.AtsApplicantsOneResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AtsApplicantsOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsApplicantsOneRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AtsApplicantsOneRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AtsApplicantsOneResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AtsApplicantsOneResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AtsApplicantsOneResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AtsApplicantsOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetApplicantResponse>() {})
                            .thenApply(res::withGetApplicantResponse);
                } else {
