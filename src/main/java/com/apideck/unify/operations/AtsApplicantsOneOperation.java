...
public class AtsApplicantsOneOperation implements RequestOperation<AtsApplicantsOneRequest, AtsApplicantsOneResponse> {
    ...
    public AtsApplicantsOneOperation(
    ...
    public HttpRequest buildRequest(AtsApplicantsOneRequest request) throws Exception {
