...
public class AtsApplicantsUpdate {
    ...
    public static class Sync extends Base
            implements RequestOperation<AtsApplicantsUpdateRequest, AtsApplicantsUpdateResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AtsApplicantsUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsApplicantsUpdateRequest.class, new TypeReference<AtsApplicantsUpdateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsApplicantsUpdateRequest request) {
        ...
        @Override
        public AtsApplicantsUpdateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AtsApplicantsUpdateResponse.Builder resBuilder =
            ...
            AtsApplicantsUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withUpdateApplicantResponse(Utils.unmarshal(response, new TypeReference<UpdateApplicantResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AtsApplicantsUpdateRequest, com.apideck.unify.models.operations.async.AtsApplicantsUpdateResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AtsApplicantsUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsApplicantsUpdateRequest.class, new TypeReference<AtsApplicantsUpdateRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AtsApplicantsUpdateRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AtsApplicantsUpdateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AtsApplicantsUpdateResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AtsApplicantsUpdateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AtsApplicantsUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<UpdateApplicantResponse>() {})
                            .thenApply(res::withUpdateApplicantResponse);
                } else {
