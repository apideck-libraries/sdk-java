...
public class AtsApplicationsAdd {
    ...
    public static class Sync extends Base
            implements RequestOperation<AtsApplicationsAddRequest, AtsApplicationsAddResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AtsApplicationsAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsApplicationsAddRequest.class, new TypeReference<AtsApplicationsAddRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsApplicationsAddRequest request) {
        ...
        @Override
        public AtsApplicationsAddResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AtsApplicationsAddResponse.Builder resBuilder =
            ...
            AtsApplicationsAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCreateApplicationResponse(Utils.unmarshal(response, new TypeReference<CreateApplicationResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AtsApplicationsAddRequest, com.apideck.unify.models.operations.async.AtsApplicationsAddResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AtsApplicationsAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsApplicationsAddRequest.class, new TypeReference<AtsApplicationsAddRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AtsApplicationsAddRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AtsApplicationsAddResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AtsApplicationsAddResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AtsApplicationsAddResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AtsApplicationsAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CreateApplicationResponse>() {})
                            .thenApply(res::withCreateApplicationResponse);
                } else {
