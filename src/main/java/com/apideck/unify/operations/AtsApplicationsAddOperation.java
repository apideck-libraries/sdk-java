...
public class AtsApplicationsAddOperation implements RequestOperation<AtsApplicationsAddRequest, AtsApplicationsAddResponse> {
    ...
    public AtsApplicationsAddOperation(
    ...
    public HttpRequest buildRequest(AtsApplicationsAddRequest request) throws Exception {
