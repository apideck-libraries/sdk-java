...
public class AtsApplicationsAll {
    ...
    public static class Sync extends Base
            implements RequestOperation<AtsApplicationsAllRequest, AtsApplicationsAllResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AtsApplicationsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsApplicationsAllRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsApplicationsAllRequest request) {
        ...
        @Override
        public AtsApplicationsAllResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AtsApplicationsAllResponse.Builder resBuilder =
            ...
            AtsApplicationsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetApplicationsResponse(Utils.unmarshal(response, new TypeReference<GetApplicationsResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AtsApplicationsAllRequest, com.apideck.unify.models.operations.async.AtsApplicationsAllResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AtsApplicationsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsApplicationsAllRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AtsApplicationsAllRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AtsApplicationsAllResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AtsApplicationsAllResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AtsApplicationsAllResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AtsApplicationsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetApplicationsResponse>() {})
                            .thenApply(res::withGetApplicationsResponse);
                } else {
