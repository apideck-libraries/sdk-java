...
public class AtsApplicationsAllOperation implements RequestOperation<AtsApplicationsAllRequest, AtsApplicationsAllResponse> {
    ...
    public AtsApplicationsAllOperation(
    ...
    public HttpRequest buildRequest(AtsApplicationsAllRequest request) throws Exception {
