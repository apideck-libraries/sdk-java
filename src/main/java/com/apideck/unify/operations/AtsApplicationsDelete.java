...
public class AtsApplicationsDelete {
    ...
    public static class Sync extends Base
            implements RequestOperation<AtsApplicationsDeleteRequest, AtsApplicationsDeleteResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AtsApplicationsDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsApplicationsDeleteRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsApplicationsDeleteRequest request) {
        ...
        @Override
        public AtsApplicationsDeleteResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AtsApplicationsDeleteResponse.Builder resBuilder =
            ...
            AtsApplicationsDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDeleteApplicationResponse(Utils.unmarshal(response, new TypeReference<DeleteApplicationResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AtsApplicationsDeleteRequest, com.apideck.unify.models.operations.async.AtsApplicationsDeleteResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AtsApplicationsDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsApplicationsDeleteRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AtsApplicationsDeleteRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AtsApplicationsDeleteResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AtsApplicationsDeleteResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AtsApplicationsDeleteResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AtsApplicationsDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DeleteApplicationResponse>() {})
                            .thenApply(res::withDeleteApplicationResponse);
                } else {
