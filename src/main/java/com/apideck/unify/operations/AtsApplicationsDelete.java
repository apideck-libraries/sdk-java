...
public class AtsApplicationsDelete {
    ...
    public static class Sync extends Base
        ...
        @Override
        public AtsApplicationsDeleteResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    DeleteApplicationResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withDeleteApplicationResponse(out);
                    return res;
                } else {
