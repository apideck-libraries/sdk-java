...
public class AtsApplicationsDeleteOperation implements RequestOperation<AtsApplicationsDeleteRequest, AtsApplicationsDeleteResponse> {
    ...
    public AtsApplicationsDeleteOperation(
    ...
    public HttpRequest buildRequest(AtsApplicationsDeleteRequest request) throws Exception {
