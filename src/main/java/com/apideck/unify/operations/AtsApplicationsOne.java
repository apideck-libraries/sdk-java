...
public class AtsApplicationsOne {
    ...
    public static class Sync extends Base
            implements RequestOperation<AtsApplicationsOneRequest, AtsApplicationsOneResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AtsApplicationsOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsApplicationsOneRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsApplicationsOneRequest request) {
        ...
        @Override
        public AtsApplicationsOneResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AtsApplicationsOneResponse.Builder resBuilder =
            ...
            AtsApplicationsOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetApplicationResponse(Utils.unmarshal(response, new TypeReference<GetApplicationResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AtsApplicationsOneRequest, com.apideck.unify.models.operations.async.AtsApplicationsOneResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AtsApplicationsOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsApplicationsOneRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AtsApplicationsOneRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AtsApplicationsOneResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AtsApplicationsOneResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AtsApplicationsOneResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AtsApplicationsOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetApplicationResponse>() {})
                            .thenApply(res::withGetApplicationResponse);
                } else {
