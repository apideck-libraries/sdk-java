...
public class AtsApplicationsOneOperation implements RequestOperation<AtsApplicationsOneRequest, AtsApplicationsOneResponse> {
    ...
    public AtsApplicationsOneOperation(
    ...
    public HttpRequest buildRequest(AtsApplicationsOneRequest request) throws Exception {
