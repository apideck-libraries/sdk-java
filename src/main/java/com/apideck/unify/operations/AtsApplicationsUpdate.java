...
public class AtsApplicationsUpdate {
    ...
    public static class Sync extends Base
            implements RequestOperation<AtsApplicationsUpdateRequest, AtsApplicationsUpdateResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AtsApplicationsUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsApplicationsUpdateRequest.class, new TypeReference<AtsApplicationsUpdateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsApplicationsUpdateRequest request) {
        ...
        @Override
        public AtsApplicationsUpdateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AtsApplicationsUpdateResponse.Builder resBuilder =
            ...
            AtsApplicationsUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withUpdateApplicationResponse(Utils.unmarshal(response, new TypeReference<UpdateApplicationResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AtsApplicationsUpdateRequest, com.apideck.unify.models.operations.async.AtsApplicationsUpdateResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AtsApplicationsUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsApplicationsUpdateRequest.class, new TypeReference<AtsApplicationsUpdateRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AtsApplicationsUpdateRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AtsApplicationsUpdateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AtsApplicationsUpdateResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AtsApplicationsUpdateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AtsApplicationsUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<UpdateApplicationResponse>() {})
                            .thenApply(res::withUpdateApplicationResponse);
                } else {
