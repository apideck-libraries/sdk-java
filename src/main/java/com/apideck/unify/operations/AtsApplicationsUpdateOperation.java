...
public class AtsApplicationsUpdateOperation implements RequestOperation<AtsApplicationsUpdateRequest, AtsApplicationsUpdateResponse> {
    ...
    public AtsApplicationsUpdateOperation(
    ...
    public HttpRequest buildRequest(AtsApplicationsUpdateRequest request) throws Exception {
