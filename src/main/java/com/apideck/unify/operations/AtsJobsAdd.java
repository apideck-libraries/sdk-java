...
public class AtsJobsAdd {
    ...
    public static class Sync extends Base
            implements RequestOperation<AtsJobsAddRequest, AtsJobsAddResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AtsJobsAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsJobsAddRequest.class, new TypeReference<AtsJobsAddRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsJobsAddRequest request) {
        ...
        @Override
        public AtsJobsAddResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AtsJobsAddResponse.Builder resBuilder =
                    AtsJobsAddResponse
                            .builder()
            ...
            AtsJobsAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCreateJobResponse(Utils.unmarshal(response, new TypeReference<CreateJobResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AtsJobsAddRequest, com.apideck.unify.models.operations.async.AtsJobsAddResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AtsJobsAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsJobsAddRequest.class, new TypeReference<AtsJobsAddRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AtsJobsAddRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AtsJobsAddResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AtsJobsAddResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AtsJobsAddResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AtsJobsAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CreateJobResponse>() {})
                            .thenApply(res::withCreateJobResponse);
                } else {
