...
public class AtsJobsAll {
    ...
    public static class Sync extends Base
            implements RequestOperation<AtsJobsAllRequest, AtsJobsAllResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AtsJobsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsJobsAllRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsJobsAllRequest request) {
        ...
        @Override
        public AtsJobsAllResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AtsJobsAllResponse.Builder resBuilder =
                    AtsJobsAllResponse
                            .builder()
            ...
            AtsJobsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetJobsResponse(Utils.unmarshal(response, new TypeReference<GetJobsResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AtsJobsAllRequest, com.apideck.unify.models.operations.async.AtsJobsAllResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AtsJobsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsJobsAllRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AtsJobsAllRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AtsJobsAllResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AtsJobsAllResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AtsJobsAllResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AtsJobsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetJobsResponse>() {})
                            .thenApply(res::withGetJobsResponse);
                } else {
