...
public class AtsJobsAllOperation implements RequestOperation<AtsJobsAllRequest, AtsJobsAllResponse> {
    ...
    public HttpRequest buildRequest(AtsJobsAllRequest request) throws Exception {
