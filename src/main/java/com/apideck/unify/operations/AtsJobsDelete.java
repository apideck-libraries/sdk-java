...
public class AtsJobsDelete {
    ...
    public static class Sync extends Base
            implements RequestOperation<AtsJobsDeleteRequest, AtsJobsDeleteResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AtsJobsDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsJobsDeleteRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsJobsDeleteRequest request) {
        ...
        @Override
        public AtsJobsDeleteResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AtsJobsDeleteResponse.Builder resBuilder =
            ...
            AtsJobsDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDeleteJobResponse(Utils.unmarshal(response, new TypeReference<DeleteJobResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AtsJobsDeleteRequest, com.apideck.unify.models.operations.async.AtsJobsDeleteResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AtsJobsDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsJobsDeleteRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AtsJobsDeleteRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AtsJobsDeleteResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AtsJobsDeleteResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AtsJobsDeleteResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AtsJobsDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DeleteJobResponse>() {})
                            .thenApply(res::withDeleteJobResponse);
                } else {
