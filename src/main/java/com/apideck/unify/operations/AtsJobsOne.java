...
public class AtsJobsOne {
    ...
    public static class Sync extends Base
            implements RequestOperation<AtsJobsOneRequest, AtsJobsOneResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AtsJobsOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsJobsOneRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsJobsOneRequest request) {
        ...
        @Override
        public AtsJobsOneResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AtsJobsOneResponse.Builder resBuilder =
                    AtsJobsOneResponse
                            .builder()
            ...
            AtsJobsOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetJobResponse(Utils.unmarshal(response, new TypeReference<GetJobResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AtsJobsOneRequest, com.apideck.unify.models.operations.async.AtsJobsOneResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AtsJobsOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsJobsOneRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AtsJobsOneRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AtsJobsOneResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AtsJobsOneResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AtsJobsOneResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AtsJobsOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetJobResponse>() {})
                            .thenApply(res::withGetJobResponse);
                } else {
