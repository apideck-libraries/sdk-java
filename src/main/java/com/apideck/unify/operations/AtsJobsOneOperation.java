...
public class AtsJobsOneOperation implements RequestOperation<AtsJobsOneRequest, AtsJobsOneResponse> {
    ...
    public HttpRequest buildRequest(AtsJobsOneRequest request) throws Exception {
