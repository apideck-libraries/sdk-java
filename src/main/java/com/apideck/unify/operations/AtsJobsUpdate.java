...
public class AtsJobsUpdate {
    ...
    public static class Sync extends Base
            implements RequestOperation<AtsJobsUpdateRequest, AtsJobsUpdateResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AtsJobsUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsJobsUpdateRequest.class, new TypeReference<AtsJobsUpdateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AtsJobsUpdateRequest request) {
        ...
        @Override
        public AtsJobsUpdateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AtsJobsUpdateResponse.Builder resBuilder =
            ...
            AtsJobsUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withUpdateJobResponse(Utils.unmarshal(response, new TypeReference<UpdateJobResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AtsJobsUpdateRequest, com.apideck.unify.models.operations.async.AtsJobsUpdateResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AtsJobsUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AtsJobsUpdateRequest.class, new TypeReference<AtsJobsUpdateRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AtsJobsUpdateRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.AtsJobsUpdateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.AtsJobsUpdateResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.AtsJobsUpdateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.AtsJobsUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<UpdateJobResponse>() {})
                            .thenApply(res::withUpdateJobResponse);
                } else {
