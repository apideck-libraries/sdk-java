...
public class ConnectorApiResourceCoverageOne {
    ...
    public static class Sync extends Base
            implements RequestOperation<ConnectorApiResourceCoverageOneRequest, ConnectorApiResourceCoverageOneResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ConnectorApiResourceCoverageOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ConnectorApiResourceCoverageOneRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ConnectorApiResourceCoverageOneRequest request) {
        ...
        @Override
        public ConnectorApiResourceCoverageOneResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ConnectorApiResourceCoverageOneResponse.Builder resBuilder =
            ...
            ConnectorApiResourceCoverageOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetApiResourceCoverageResponse(Utils.unmarshal(response, new TypeReference<GetApiResourceCoverageResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ConnectorApiResourceCoverageOneRequest, com.apideck.unify.models.operations.async.ConnectorApiResourceCoverageOneResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ConnectorApiResourceCoverageOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ConnectorApiResourceCoverageOneRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ConnectorApiResourceCoverageOneRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.ConnectorApiResourceCoverageOneResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.ConnectorApiResourceCoverageOneResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.ConnectorApiResourceCoverageOneResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.ConnectorApiResourceCoverageOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetApiResourceCoverageResponse>() {})
                            .thenApply(res::withGetApiResourceCoverageResponse);
                } else {
