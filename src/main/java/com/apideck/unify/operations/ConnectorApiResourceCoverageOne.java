...
public class ConnectorApiResourceCoverageOne {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ConnectorApiResourceCoverageOneRequest request) throws Exception {
        ...
        @Override
        public ConnectorApiResourceCoverageOneResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GetApiResourceCoverageResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGetApiResourceCoverageResponse(out);
                    return res;
                } else {
