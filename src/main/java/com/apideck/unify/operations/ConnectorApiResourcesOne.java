...
public class ConnectorApiResourcesOne {
    ...
    public static class Sync extends Base
            implements RequestOperation<ConnectorApiResourcesOneRequest, ConnectorApiResourcesOneResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ConnectorApiResourcesOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ConnectorApiResourcesOneRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ConnectorApiResourcesOneRequest request) {
        ...
        @Override
        public ConnectorApiResourcesOneResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ConnectorApiResourcesOneResponse.Builder resBuilder =
            ...
            ConnectorApiResourcesOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetApiResourceResponse(Utils.unmarshal(response, new TypeReference<GetApiResourceResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ConnectorApiResourcesOneRequest, com.apideck.unify.models.operations.async.ConnectorApiResourcesOneResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ConnectorApiResourcesOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ConnectorApiResourcesOneRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ConnectorApiResourcesOneRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.ConnectorApiResourcesOneResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.ConnectorApiResourcesOneResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.ConnectorApiResourcesOneResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.ConnectorApiResourcesOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetApiResourceResponse>() {})
                            .thenApply(res::withGetApiResourceResponse);
                } else {
