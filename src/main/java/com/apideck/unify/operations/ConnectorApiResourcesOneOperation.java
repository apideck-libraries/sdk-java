...
public class ConnectorApiResourcesOneOperation implements RequestOperation<ConnectorApiResourcesOneRequest, ConnectorApiResourcesOneResponse> {
    ...
    public ConnectorApiResourcesOneOperation(
    ...
    public HttpRequest buildRequest(ConnectorApiResourcesOneRequest request) throws Exception {
