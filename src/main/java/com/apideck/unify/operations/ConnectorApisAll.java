...
public class ConnectorApisAll {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(ConnectorApisAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ConnectorApisAllRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ConnectorApisAllRequest request) {
        ...
        @Override
        public ConnectorApisAllResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ConnectorApisAllResponse.Builder resBuilder =
            ...
            ConnectorApisAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetApisResponse(Utils.unmarshal(response, new TypeReference<GetApisResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ConnectorApisAllRequest, com.apideck.unify.models.operations.async.ConnectorApisAllResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ConnectorApisAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ConnectorApisAllRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ConnectorApisAllRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.ConnectorApisAllResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.ConnectorApisAllResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.ConnectorApisAllResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.ConnectorApisAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetApisResponse>() {})
                            .thenApply(res::withGetApisResponse);
                } else {
