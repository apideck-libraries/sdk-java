...
public class ConnectorApisAllOperation implements RequestOperation<ConnectorApisAllRequest, ConnectorApisAllResponse> {
    ...
    public ConnectorApisAllOperation(
    ...
    public HttpRequest buildRequest(ConnectorApisAllRequest request) throws Exception {
