...
public class ConnectorApisOne {
    ...
    public static class Sync extends Base
        ...
        @Override
        public ConnectorApisOneResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GetApiResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGetApiResponse(out);
                    return res;
                } else {
