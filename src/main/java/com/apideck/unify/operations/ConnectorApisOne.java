...
public class ConnectorApisOne {
    ...
    public static class Sync extends Base
            implements RequestOperation<ConnectorApisOneRequest, ConnectorApisOneResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ConnectorApisOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ConnectorApisOneRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ConnectorApisOneRequest request) {
        ...
        @Override
        public ConnectorApisOneResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ConnectorApisOneResponse.Builder resBuilder =
            ...
            ConnectorApisOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetApiResponse(Utils.unmarshal(response, new TypeReference<GetApiResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ConnectorApisOneRequest, com.apideck.unify.models.operations.async.ConnectorApisOneResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ConnectorApisOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ConnectorApisOneRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ConnectorApisOneRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.ConnectorApisOneResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.ConnectorApisOneResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.ConnectorApisOneResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.ConnectorApisOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetApiResponse>() {})
                            .thenApply(res::withGetApiResponse);
                } else {
