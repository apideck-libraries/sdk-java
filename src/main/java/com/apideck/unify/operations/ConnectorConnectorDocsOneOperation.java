...
public class ConnectorConnectorDocsOneOperation implements RequestOperation<ConnectorConnectorDocsOneRequest, ConnectorConnectorDocsOneResponse> {
    ...
    public ConnectorConnectorDocsOneOperation(
    ...
    public HttpRequest buildRequest(ConnectorConnectorDocsOneRequest request) throws Exception {
