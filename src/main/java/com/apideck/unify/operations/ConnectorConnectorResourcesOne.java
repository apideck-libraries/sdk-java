...
public class ConnectorConnectorResourcesOne {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ConnectorConnectorResourcesOneRequest request) throws Exception {
        ...
        @Override
        public ConnectorConnectorResourcesOneResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GetConnectorResourceResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGetConnectorResourceResponse(out);
                    return res;
                } else {
