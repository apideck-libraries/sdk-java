...
public class ConnectorConnectorResourcesOne {
    ...
    public static class Sync extends Base
            implements RequestOperation<ConnectorConnectorResourcesOneRequest, ConnectorConnectorResourcesOneResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ConnectorConnectorResourcesOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ConnectorConnectorResourcesOneRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ConnectorConnectorResourcesOneRequest request) {
        ...
        @Override
        public ConnectorConnectorResourcesOneResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ConnectorConnectorResourcesOneResponse.Builder resBuilder =
            ...
            ConnectorConnectorResourcesOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetConnectorResourceResponse(Utils.unmarshal(response, new TypeReference<GetConnectorResourceResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ConnectorConnectorResourcesOneRequest, com.apideck.unify.models.operations.async.ConnectorConnectorResourcesOneResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ConnectorConnectorResourcesOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ConnectorConnectorResourcesOneRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ConnectorConnectorResourcesOneRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.ConnectorConnectorResourcesOneResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.ConnectorConnectorResourcesOneResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.ConnectorConnectorResourcesOneResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.ConnectorConnectorResourcesOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetConnectorResourceResponse>() {})
                            .thenApply(res::withGetConnectorResourceResponse);
                } else {
