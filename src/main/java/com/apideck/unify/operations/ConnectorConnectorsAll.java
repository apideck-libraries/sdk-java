...
public class ConnectorConnectorsAll {
    ...
    public static class Sync extends Base
            implements RequestOperation<ConnectorConnectorsAllRequest, ConnectorConnectorsAllResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ConnectorConnectorsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ConnectorConnectorsAllRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ConnectorConnectorsAllRequest request) {
            Retries retries = Retries.builder()
                    .action(() -> {
                        ...
                        try {
                            ...
                            if (Utils.statusCodeMatches(httpRes.statusCode(), "400", "401", "402", "4XX", "5XX")) {
        ...
        @Override
        public ConnectorConnectorsAllResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ConnectorConnectorsAllResponse.Builder resBuilder =
            ...
            ConnectorConnectorsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetConnectorsResponse(Utils.unmarshal(response, new TypeReference<GetConnectorsResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ConnectorConnectorsAllRequest, com.apideck.unify.models.operations.async.ConnectorConnectorsAllResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ConnectorConnectorsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ConnectorConnectorsAllRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ConnectorConnectorsAllRequest request) {
            ...
            return retries.retry(() -> unchecked(() -> onBuildRequest(request)).get().thenCompose(client::sendAsync)
                            .handle((resp, err) -> {
                                ...
                                if (Utils.statusCodeMatches(resp.statusCode(), "400", "401", "402", "4XX", "5XX")) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.ConnectorConnectorsAllResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.ConnectorConnectorsAllResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.ConnectorConnectorsAllResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.ConnectorConnectorsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetConnectorsResponse>() {})
                            .thenApply(res::withGetConnectorsResponse);
                } else {
