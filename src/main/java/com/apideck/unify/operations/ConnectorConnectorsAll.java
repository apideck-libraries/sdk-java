...
public class ConnectorConnectorsAll {
    ...
    public static class Sync extends Base
        ...
        @Override
        public ConnectorConnectorsAllResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GetConnectorsResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGetConnectorsResponse(out);
                    return res;
                } else {
