...
public class ConnectorConnectorsAllOperation implements RequestOperation<ConnectorConnectorsAllRequest, ConnectorConnectorsAllResponse> {
    ...
    public ConnectorConnectorsAllOperation(
    ...
    public HttpRequest buildRequest(ConnectorConnectorsAllRequest request) throws Exception {
