...
public class ConnectorConnectorsOne {
    ...
    public static class Sync extends Base
            implements RequestOperation<ConnectorConnectorsOneRequest, ConnectorConnectorsOneResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ConnectorConnectorsOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ConnectorConnectorsOneRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ConnectorConnectorsOneRequest request) {
        ...
        @Override
        public ConnectorConnectorsOneResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ConnectorConnectorsOneResponse.Builder resBuilder =
            ...
            ConnectorConnectorsOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetConnectorResponse(Utils.unmarshal(response, new TypeReference<GetConnectorResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ConnectorConnectorsOneRequest, com.apideck.unify.models.operations.async.ConnectorConnectorsOneResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ConnectorConnectorsOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ConnectorConnectorsOneRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ConnectorConnectorsOneRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.ConnectorConnectorsOneResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.ConnectorConnectorsOneResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.ConnectorConnectorsOneResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.ConnectorConnectorsOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetConnectorResponse>() {})
                            .thenApply(res::withGetConnectorResponse);
                } else {
