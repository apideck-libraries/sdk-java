...
public class ConnectorConnectorsOneOperation implements RequestOperation<ConnectorConnectorsOneRequest, ConnectorConnectorsOneResponse> {
    ...
    public ConnectorConnectorsOneOperation(
    ...
    public HttpRequest buildRequest(ConnectorConnectorsOneRequest request) throws Exception {
