...
public class CrmActivitiesAdd {
    ...
    public static class Sync extends Base
            implements RequestOperation<CrmActivitiesAddRequest, CrmActivitiesAddResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CrmActivitiesAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmActivitiesAddRequest.class, new TypeReference<CrmActivitiesAddRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CrmActivitiesAddRequest request) {
        ...
        @Override
        public CrmActivitiesAddResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CrmActivitiesAddResponse.Builder resBuilder =
            ...
            CrmActivitiesAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCreateActivityResponse(Utils.unmarshal(response, new TypeReference<CreateActivityResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CrmActivitiesAddRequest, com.apideck.unify.models.operations.async.CrmActivitiesAddResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CrmActivitiesAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmActivitiesAddRequest.class, new TypeReference<CrmActivitiesAddRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CrmActivitiesAddRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.CrmActivitiesAddResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.CrmActivitiesAddResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.CrmActivitiesAddResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.CrmActivitiesAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CreateActivityResponse>() {})
                            .thenApply(res::withCreateActivityResponse);
                } else {
