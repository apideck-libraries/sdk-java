...
public class CrmActivitiesAddOperation implements RequestOperation<CrmActivitiesAddRequest, CrmActivitiesAddResponse> {
    ...
    public CrmActivitiesAddOperation(
    ...
    public HttpRequest buildRequest(CrmActivitiesAddRequest request) throws Exception {
