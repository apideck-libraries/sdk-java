...
public class CrmActivitiesAll {
    ...
    public static class Sync extends Base
            implements RequestOperation<CrmActivitiesAllRequest, CrmActivitiesAllResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CrmActivitiesAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmActivitiesAllRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CrmActivitiesAllRequest request) {
        ...
        @Override
        public CrmActivitiesAllResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CrmActivitiesAllResponse.Builder resBuilder =
            ...
            CrmActivitiesAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetActivitiesResponse(Utils.unmarshal(response, new TypeReference<GetActivitiesResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CrmActivitiesAllRequest, com.apideck.unify.models.operations.async.CrmActivitiesAllResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CrmActivitiesAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmActivitiesAllRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CrmActivitiesAllRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.CrmActivitiesAllResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.CrmActivitiesAllResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.CrmActivitiesAllResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.CrmActivitiesAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetActivitiesResponse>() {})
                            .thenApply(res::withGetActivitiesResponse);
                } else {
