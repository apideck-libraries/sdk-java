...
public class CrmActivitiesAllOperation implements RequestOperation<CrmActivitiesAllRequest, CrmActivitiesAllResponse> {
    ...
    public CrmActivitiesAllOperation(
    ...
    public HttpRequest buildRequest(CrmActivitiesAllRequest request) throws Exception {
