...
public class CrmActivitiesDelete {
    ...
    public static class Sync extends Base
            implements RequestOperation<CrmActivitiesDeleteRequest, CrmActivitiesDeleteResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CrmActivitiesDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmActivitiesDeleteRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CrmActivitiesDeleteRequest request) {
        ...
        @Override
        public CrmActivitiesDeleteResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CrmActivitiesDeleteResponse.Builder resBuilder =
            ...
            CrmActivitiesDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDeleteActivityResponse(Utils.unmarshal(response, new TypeReference<DeleteActivityResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CrmActivitiesDeleteRequest, com.apideck.unify.models.operations.async.CrmActivitiesDeleteResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CrmActivitiesDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmActivitiesDeleteRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CrmActivitiesDeleteRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.CrmActivitiesDeleteResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.CrmActivitiesDeleteResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.CrmActivitiesDeleteResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.CrmActivitiesDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DeleteActivityResponse>() {})
                            .thenApply(res::withDeleteActivityResponse);
                } else {
