...
public class CrmActivitiesDeleteOperation implements RequestOperation<CrmActivitiesDeleteRequest, CrmActivitiesDeleteResponse> {
    ...
    public CrmActivitiesDeleteOperation(
    ...
    public HttpRequest buildRequest(CrmActivitiesDeleteRequest request) throws Exception {
