...
public class CrmActivitiesOne {
    ...
    public static class Sync extends Base
            implements RequestOperation<CrmActivitiesOneRequest, CrmActivitiesOneResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CrmActivitiesOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmActivitiesOneRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CrmActivitiesOneRequest request) {
        ...
        @Override
        public CrmActivitiesOneResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CrmActivitiesOneResponse.Builder resBuilder =
            ...
            CrmActivitiesOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetActivityResponse(Utils.unmarshal(response, new TypeReference<GetActivityResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CrmActivitiesOneRequest, com.apideck.unify.models.operations.async.CrmActivitiesOneResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CrmActivitiesOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmActivitiesOneRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CrmActivitiesOneRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.CrmActivitiesOneResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.CrmActivitiesOneResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.CrmActivitiesOneResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.CrmActivitiesOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetActivityResponse>() {})
                            .thenApply(res::withGetActivityResponse);
                } else {
