...
public class CrmActivitiesOneOperation implements RequestOperation<CrmActivitiesOneRequest, CrmActivitiesOneResponse> {
    ...
    public CrmActivitiesOneOperation(
    ...
    public HttpRequest buildRequest(CrmActivitiesOneRequest request) throws Exception {
