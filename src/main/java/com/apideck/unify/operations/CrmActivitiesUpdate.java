...
public class CrmActivitiesUpdate {
    ...
    public static class Sync extends Base
            implements RequestOperation<CrmActivitiesUpdateRequest, CrmActivitiesUpdateResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CrmActivitiesUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmActivitiesUpdateRequest.class, new TypeReference<CrmActivitiesUpdateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CrmActivitiesUpdateRequest request) {
        ...
        @Override
        public CrmActivitiesUpdateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CrmActivitiesUpdateResponse.Builder resBuilder =
            ...
            CrmActivitiesUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withUpdateActivityResponse(Utils.unmarshal(response, new TypeReference<UpdateActivityResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CrmActivitiesUpdateRequest, com.apideck.unify.models.operations.async.CrmActivitiesUpdateResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CrmActivitiesUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmActivitiesUpdateRequest.class, new TypeReference<CrmActivitiesUpdateRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CrmActivitiesUpdateRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.CrmActivitiesUpdateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.CrmActivitiesUpdateResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.CrmActivitiesUpdateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.CrmActivitiesUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<UpdateActivityResponse>() {})
                            .thenApply(res::withUpdateActivityResponse);
                } else {
