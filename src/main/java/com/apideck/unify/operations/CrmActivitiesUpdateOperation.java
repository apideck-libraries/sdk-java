...
public class CrmActivitiesUpdateOperation implements RequestOperation<CrmActivitiesUpdateRequest, CrmActivitiesUpdateResponse> {
    ...
    public CrmActivitiesUpdateOperation(
    ...
    public HttpRequest buildRequest(CrmActivitiesUpdateRequest request) throws Exception {
