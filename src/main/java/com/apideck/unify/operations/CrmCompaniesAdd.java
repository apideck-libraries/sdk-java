...
public class CrmCompaniesAdd {
    ...
    public static class Sync extends Base
            implements RequestOperation<CrmCompaniesAddRequest, CrmCompaniesAddResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CrmCompaniesAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmCompaniesAddRequest.class, new TypeReference<CrmCompaniesAddRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CrmCompaniesAddRequest request) {
        ...
        @Override
        public CrmCompaniesAddResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CrmCompaniesAddResponse.Builder resBuilder =
            ...
            CrmCompaniesAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCreateCompanyResponse(Utils.unmarshal(response, new TypeReference<CreateCompanyResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CrmCompaniesAddRequest, com.apideck.unify.models.operations.async.CrmCompaniesAddResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CrmCompaniesAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmCompaniesAddRequest.class, new TypeReference<CrmCompaniesAddRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CrmCompaniesAddRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.CrmCompaniesAddResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.CrmCompaniesAddResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.CrmCompaniesAddResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.CrmCompaniesAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CreateCompanyResponse>() {})
                            .thenApply(res::withCreateCompanyResponse);
                } else {
