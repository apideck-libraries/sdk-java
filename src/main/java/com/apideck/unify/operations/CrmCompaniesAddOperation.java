...
public class CrmCompaniesAddOperation implements RequestOperation<CrmCompaniesAddRequest, CrmCompaniesAddResponse> {
    ...
    public CrmCompaniesAddOperation(
    ...
    public HttpRequest buildRequest(CrmCompaniesAddRequest request) throws Exception {
