...
public class CrmCompaniesAll {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CrmCompaniesAllRequest request) {
        ...
        @Override
        public CrmCompaniesAllResponse handleResponse(HttpResponse<InputStream> response) {
