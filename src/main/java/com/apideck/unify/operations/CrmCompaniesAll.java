...
public class CrmCompaniesAll {
    ...
    public static class Sync extends Base
            implements RequestOperation<CrmCompaniesAllRequest, CrmCompaniesAllResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CrmCompaniesAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmCompaniesAllRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CrmCompaniesAllRequest request) throws Exception {
        ...
        @Override
        public CrmCompaniesAllResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CrmCompaniesAllResponse.Builder resBuilder =
            ...
            CrmCompaniesAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GetCompaniesResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGetCompaniesResponse(out);
                    return res;
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CrmCompaniesAllRequest, com.apideck.unify.models.operations.async.CrmCompaniesAllResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CrmCompaniesAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmCompaniesAllRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CrmCompaniesAllRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.CrmCompaniesAllResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.CrmCompaniesAllResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.CrmCompaniesAllResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.CrmCompaniesAllResponse res = resBuilder.build();
