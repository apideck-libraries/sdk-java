...
public class CrmCompaniesAllOperation implements RequestOperation<CrmCompaniesAllRequest, CrmCompaniesAllResponse> {
    ...
    public CrmCompaniesAllOperation(
    ...
    public HttpRequest buildRequest(CrmCompaniesAllRequest request) throws Exception {
