...
public class CrmCompaniesDelete {
    ...
    public static class Sync extends Base
            implements RequestOperation<CrmCompaniesDeleteRequest, CrmCompaniesDeleteResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CrmCompaniesDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmCompaniesDeleteRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CrmCompaniesDeleteRequest request) {
        ...
        @Override
        public CrmCompaniesDeleteResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CrmCompaniesDeleteResponse.Builder resBuilder =
            ...
            CrmCompaniesDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDeleteCompanyResponse(Utils.unmarshal(response, new TypeReference<DeleteCompanyResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CrmCompaniesDeleteRequest, com.apideck.unify.models.operations.async.CrmCompaniesDeleteResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CrmCompaniesDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmCompaniesDeleteRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CrmCompaniesDeleteRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.CrmCompaniesDeleteResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.CrmCompaniesDeleteResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.CrmCompaniesDeleteResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.CrmCompaniesDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DeleteCompanyResponse>() {})
                            .thenApply(res::withDeleteCompanyResponse);
                } else {
