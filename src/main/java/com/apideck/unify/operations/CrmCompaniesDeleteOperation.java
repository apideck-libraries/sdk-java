...
public class CrmCompaniesDeleteOperation implements RequestOperation<CrmCompaniesDeleteRequest, CrmCompaniesDeleteResponse> {
    ...
    public CrmCompaniesDeleteOperation(
    ...
    public HttpRequest buildRequest(CrmCompaniesDeleteRequest request) throws Exception {
