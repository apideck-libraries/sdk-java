...
public class CrmCompaniesOne {
    ...
    public static class Sync extends Base
            implements RequestOperation<CrmCompaniesOneRequest, CrmCompaniesOneResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CrmCompaniesOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmCompaniesOneRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CrmCompaniesOneRequest request) {
        ...
        @Override
        public CrmCompaniesOneResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CrmCompaniesOneResponse.Builder resBuilder =
            ...
            CrmCompaniesOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetCompanyResponse(Utils.unmarshal(response, new TypeReference<GetCompanyResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CrmCompaniesOneRequest, com.apideck.unify.models.operations.async.CrmCompaniesOneResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CrmCompaniesOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmCompaniesOneRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CrmCompaniesOneRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.CrmCompaniesOneResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.CrmCompaniesOneResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.CrmCompaniesOneResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.CrmCompaniesOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetCompanyResponse>() {})
                            .thenApply(res::withGetCompanyResponse);
                } else {
