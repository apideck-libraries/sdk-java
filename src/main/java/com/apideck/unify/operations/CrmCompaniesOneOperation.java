...
public class CrmCompaniesOneOperation implements RequestOperation<CrmCompaniesOneRequest, CrmCompaniesOneResponse> {
    ...
    public CrmCompaniesOneOperation(
    ...
    public HttpRequest buildRequest(CrmCompaniesOneRequest request) throws Exception {
