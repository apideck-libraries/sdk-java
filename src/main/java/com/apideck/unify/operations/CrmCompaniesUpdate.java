...
public class CrmCompaniesUpdate {
    ...
    public static class Sync extends Base
        ...
        @Override
        public CrmCompaniesUpdateResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    UpdateCompanyResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withUpdateCompanyResponse(out);
                    return res;
                } else {
