...
public class CrmCompaniesUpdate {
    ...
    public static class Sync extends Base
            implements RequestOperation<CrmCompaniesUpdateRequest, CrmCompaniesUpdateResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CrmCompaniesUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmCompaniesUpdateRequest.class, new TypeReference<CrmCompaniesUpdateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CrmCompaniesUpdateRequest request) {
        ...
        @Override
        public CrmCompaniesUpdateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CrmCompaniesUpdateResponse.Builder resBuilder =
            ...
            CrmCompaniesUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withUpdateCompanyResponse(Utils.unmarshal(response, new TypeReference<UpdateCompanyResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CrmCompaniesUpdateRequest, com.apideck.unify.models.operations.async.CrmCompaniesUpdateResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CrmCompaniesUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmCompaniesUpdateRequest.class, new TypeReference<CrmCompaniesUpdateRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CrmCompaniesUpdateRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.CrmCompaniesUpdateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.CrmCompaniesUpdateResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.CrmCompaniesUpdateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.CrmCompaniesUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<UpdateCompanyResponse>() {})
                            .thenApply(res::withUpdateCompanyResponse);
                } else {
