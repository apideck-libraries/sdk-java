...
public class CrmCompaniesUpdateOperation implements RequestOperation<CrmCompaniesUpdateRequest, CrmCompaniesUpdateResponse> {
    ...
    public CrmCompaniesUpdateOperation(
    ...
    public HttpRequest buildRequest(CrmCompaniesUpdateRequest request) throws Exception {
