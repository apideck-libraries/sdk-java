...
public class CrmContactsAdd {
    ...
    public static class Sync extends Base
            implements RequestOperation<CrmContactsAddRequest, CrmContactsAddResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CrmContactsAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmContactsAddRequest.class, new TypeReference<CrmContactsAddRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CrmContactsAddRequest request) {
        ...
        @Override
        public CrmContactsAddResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CrmContactsAddResponse.Builder resBuilder =
            ...
            CrmContactsAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCreateContactResponse(Utils.unmarshal(response, new TypeReference<CreateContactResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CrmContactsAddRequest, com.apideck.unify.models.operations.async.CrmContactsAddResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CrmContactsAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmContactsAddRequest.class, new TypeReference<CrmContactsAddRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CrmContactsAddRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.CrmContactsAddResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.CrmContactsAddResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.CrmContactsAddResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.CrmContactsAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CreateContactResponse>() {})
                            .thenApply(res::withCreateContactResponse);
                } else {
