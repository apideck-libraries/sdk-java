...
public class CrmContactsAddOperation implements RequestOperation<CrmContactsAddRequest, CrmContactsAddResponse> {
    ...
    public CrmContactsAddOperation(
    ...
    public HttpRequest buildRequest(CrmContactsAddRequest request) throws Exception {
