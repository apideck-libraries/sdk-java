...
public class CrmContactsAll {
    ...
    public static class Sync extends Base
            implements RequestOperation<CrmContactsAllRequest, CrmContactsAllResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CrmContactsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmContactsAllRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CrmContactsAllRequest request) {
        ...
        @Override
        public CrmContactsAllResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CrmContactsAllResponse.Builder resBuilder =
            ...
            CrmContactsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetContactsResponse(Utils.unmarshal(response, new TypeReference<GetContactsResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CrmContactsAllRequest, com.apideck.unify.models.operations.async.CrmContactsAllResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CrmContactsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmContactsAllRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CrmContactsAllRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.CrmContactsAllResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.CrmContactsAllResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.CrmContactsAllResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.CrmContactsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetContactsResponse>() {})
                            .thenApply(res::withGetContactsResponse);
                } else {
