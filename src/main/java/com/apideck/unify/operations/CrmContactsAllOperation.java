...
public class CrmContactsAllOperation implements RequestOperation<CrmContactsAllRequest, CrmContactsAllResponse> {
    ...
    public CrmContactsAllOperation(
    ...
    public HttpRequest buildRequest(CrmContactsAllRequest request) throws Exception {
