...
public class CrmContactsDelete {
    ...
    public static class Sync extends Base
            implements RequestOperation<CrmContactsDeleteRequest, CrmContactsDeleteResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CrmContactsDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmContactsDeleteRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CrmContactsDeleteRequest request) {
        ...
        @Override
        public CrmContactsDeleteResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CrmContactsDeleteResponse.Builder resBuilder =
            ...
            CrmContactsDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDeleteContactResponse(Utils.unmarshal(response, new TypeReference<DeleteContactResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CrmContactsDeleteRequest, com.apideck.unify.models.operations.async.CrmContactsDeleteResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CrmContactsDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmContactsDeleteRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CrmContactsDeleteRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.CrmContactsDeleteResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.CrmContactsDeleteResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.CrmContactsDeleteResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.CrmContactsDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DeleteContactResponse>() {})
                            .thenApply(res::withDeleteContactResponse);
                } else {
