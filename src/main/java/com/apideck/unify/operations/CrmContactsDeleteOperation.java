...
public class CrmContactsDeleteOperation implements RequestOperation<CrmContactsDeleteRequest, CrmContactsDeleteResponse> {
    ...
    public CrmContactsDeleteOperation(
    ...
    public HttpRequest buildRequest(CrmContactsDeleteRequest request) throws Exception {
