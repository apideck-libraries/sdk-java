...
public class CrmContactsOne {
    ...
    public static class Sync extends Base
            implements RequestOperation<CrmContactsOneRequest, CrmContactsOneResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CrmContactsOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmContactsOneRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CrmContactsOneRequest request) {
        ...
        @Override
        public CrmContactsOneResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CrmContactsOneResponse.Builder resBuilder =
            ...
            CrmContactsOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetContactResponse(Utils.unmarshal(response, new TypeReference<GetContactResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CrmContactsOneRequest, com.apideck.unify.models.operations.async.CrmContactsOneResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CrmContactsOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmContactsOneRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CrmContactsOneRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.CrmContactsOneResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.CrmContactsOneResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.CrmContactsOneResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.CrmContactsOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetContactResponse>() {})
                            .thenApply(res::withGetContactResponse);
                } else {
