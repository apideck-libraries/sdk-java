...
public class CrmContactsOneOperation implements RequestOperation<CrmContactsOneRequest, CrmContactsOneResponse> {
    ...
    public CrmContactsOneOperation(
    ...
    public HttpRequest buildRequest(CrmContactsOneRequest request) throws Exception {
