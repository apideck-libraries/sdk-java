...
public class CrmContactsUpdate {
    ...
    public static class Sync extends Base
            implements RequestOperation<CrmContactsUpdateRequest, CrmContactsUpdateResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CrmContactsUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmContactsUpdateRequest.class, new TypeReference<CrmContactsUpdateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CrmContactsUpdateRequest request) {
        ...
        @Override
        public CrmContactsUpdateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CrmContactsUpdateResponse.Builder resBuilder =
            ...
            CrmContactsUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withUpdateContactResponse(Utils.unmarshal(response, new TypeReference<UpdateContactResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CrmContactsUpdateRequest, com.apideck.unify.models.operations.async.CrmContactsUpdateResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CrmContactsUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmContactsUpdateRequest.class, new TypeReference<CrmContactsUpdateRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CrmContactsUpdateRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.CrmContactsUpdateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.CrmContactsUpdateResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.CrmContactsUpdateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.CrmContactsUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<UpdateContactResponse>() {})
                            .thenApply(res::withUpdateContactResponse);
                } else {
