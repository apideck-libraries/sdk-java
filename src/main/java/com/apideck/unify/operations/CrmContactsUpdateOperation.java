...
public class CrmContactsUpdateOperation implements RequestOperation<CrmContactsUpdateRequest, CrmContactsUpdateResponse> {
    ...
    public CrmContactsUpdateOperation(
    ...
    public HttpRequest buildRequest(CrmContactsUpdateRequest request) throws Exception {
