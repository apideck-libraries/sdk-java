...
public class CrmCustomObjectSchemasAdd {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CrmCustomObjectSchemasAddRequest request) throws Exception {
        ...
        @Override
        public CrmCustomObjectSchemasAddResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    CreateCustomObjectSchemaResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCreateCustomObjectSchemaResponse(out);
                    return res;
                } else {
