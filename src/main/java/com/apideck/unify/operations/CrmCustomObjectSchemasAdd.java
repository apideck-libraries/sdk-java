...
public class CrmCustomObjectSchemasAdd {
    ...
    public static class Sync extends Base
            implements RequestOperation<CrmCustomObjectSchemasAddRequest, CrmCustomObjectSchemasAddResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CrmCustomObjectSchemasAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmCustomObjectSchemasAddRequest.class, new TypeReference<CrmCustomObjectSchemasAddRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CrmCustomObjectSchemasAddRequest request) {
        ...
        @Override
        public CrmCustomObjectSchemasAddResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CrmCustomObjectSchemasAddResponse.Builder resBuilder =
            ...
            CrmCustomObjectSchemasAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCreateCustomObjectSchemaResponse(Utils.unmarshal(response, new TypeReference<CreateCustomObjectSchemaResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CrmCustomObjectSchemasAddRequest, com.apideck.unify.models.operations.async.CrmCustomObjectSchemasAddResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CrmCustomObjectSchemasAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmCustomObjectSchemasAddRequest.class, new TypeReference<CrmCustomObjectSchemasAddRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CrmCustomObjectSchemasAddRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.CrmCustomObjectSchemasAddResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.CrmCustomObjectSchemasAddResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.CrmCustomObjectSchemasAddResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.CrmCustomObjectSchemasAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CreateCustomObjectSchemaResponse>() {})
                            .thenApply(res::withCreateCustomObjectSchemaResponse);
                } else {
