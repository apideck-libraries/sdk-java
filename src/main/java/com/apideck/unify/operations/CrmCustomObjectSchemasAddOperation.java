...
public class CrmCustomObjectSchemasAddOperation implements RequestOperation<CrmCustomObjectSchemasAddRequest, CrmCustomObjectSchemasAddResponse> {
    ...
    public CrmCustomObjectSchemasAddOperation(
    ...
    public HttpRequest buildRequest(CrmCustomObjectSchemasAddRequest request) throws Exception {
