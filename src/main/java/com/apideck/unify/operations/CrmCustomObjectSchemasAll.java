...
public class CrmCustomObjectSchemasAll {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CrmCustomObjectSchemasAllRequest request) throws Exception {
        ...
        @Override
        public CrmCustomObjectSchemasAllResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GetCustomObjectSchemasResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGetCustomObjectSchemasResponse(out);
                    return res;
                } else {
