...
public class CrmCustomObjectSchemasAll {
    ...
    public static class Sync extends Base
            implements RequestOperation<CrmCustomObjectSchemasAllRequest, CrmCustomObjectSchemasAllResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CrmCustomObjectSchemasAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmCustomObjectSchemasAllRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CrmCustomObjectSchemasAllRequest request) {
        ...
        @Override
        public CrmCustomObjectSchemasAllResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CrmCustomObjectSchemasAllResponse.Builder resBuilder =
            ...
            CrmCustomObjectSchemasAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetCustomObjectSchemasResponse(Utils.unmarshal(response, new TypeReference<GetCustomObjectSchemasResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CrmCustomObjectSchemasAllRequest, com.apideck.unify.models.operations.async.CrmCustomObjectSchemasAllResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CrmCustomObjectSchemasAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmCustomObjectSchemasAllRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CrmCustomObjectSchemasAllRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.CrmCustomObjectSchemasAllResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.CrmCustomObjectSchemasAllResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.CrmCustomObjectSchemasAllResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.CrmCustomObjectSchemasAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetCustomObjectSchemasResponse>() {})
                            .thenApply(res::withGetCustomObjectSchemasResponse);
                } else {
