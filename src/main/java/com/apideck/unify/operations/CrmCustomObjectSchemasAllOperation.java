...
public class CrmCustomObjectSchemasAllOperation implements RequestOperation<CrmCustomObjectSchemasAllRequest, CrmCustomObjectSchemasAllResponse> {
    ...
    public CrmCustomObjectSchemasAllOperation(
    ...
    public HttpRequest buildRequest(CrmCustomObjectSchemasAllRequest request) throws Exception {
