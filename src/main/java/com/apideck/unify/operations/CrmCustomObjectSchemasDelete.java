...
public class CrmCustomObjectSchemasDelete {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CrmCustomObjectSchemasDeleteRequest request) throws Exception {
        ...
        @Override
        public CrmCustomObjectSchemasDeleteResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    DeleteCustomObjectSchemaResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withDeleteCustomObjectSchemaResponse(out);
                    return res;
                } else {
