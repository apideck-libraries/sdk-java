...
public class CrmCustomObjectSchemasDelete {
    ...
    public static class Sync extends Base
            implements RequestOperation<CrmCustomObjectSchemasDeleteRequest, CrmCustomObjectSchemasDeleteResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CrmCustomObjectSchemasDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmCustomObjectSchemasDeleteRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CrmCustomObjectSchemasDeleteRequest request) {
        ...
        @Override
        public CrmCustomObjectSchemasDeleteResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CrmCustomObjectSchemasDeleteResponse.Builder resBuilder =
            ...
            CrmCustomObjectSchemasDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDeleteCustomObjectSchemaResponse(Utils.unmarshal(response, new TypeReference<DeleteCustomObjectSchemaResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CrmCustomObjectSchemasDeleteRequest, com.apideck.unify.models.operations.async.CrmCustomObjectSchemasDeleteResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CrmCustomObjectSchemasDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmCustomObjectSchemasDeleteRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CrmCustomObjectSchemasDeleteRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.CrmCustomObjectSchemasDeleteResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.CrmCustomObjectSchemasDeleteResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.CrmCustomObjectSchemasDeleteResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.CrmCustomObjectSchemasDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DeleteCustomObjectSchemaResponse>() {})
                            .thenApply(res::withDeleteCustomObjectSchemaResponse);
                } else {
