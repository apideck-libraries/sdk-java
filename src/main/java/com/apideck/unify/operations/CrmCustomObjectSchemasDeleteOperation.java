...
public class CrmCustomObjectSchemasDeleteOperation implements RequestOperation<CrmCustomObjectSchemasDeleteRequest, CrmCustomObjectSchemasDeleteResponse> {
    ...
    public CrmCustomObjectSchemasDeleteOperation(
    ...
    public HttpRequest buildRequest(CrmCustomObjectSchemasDeleteRequest request) throws Exception {
