...
public class CrmCustomObjectSchemasOne {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CrmCustomObjectSchemasOneRequest request) throws Exception {
        ...
        @Override
        public CrmCustomObjectSchemasOneResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GetCustomObjectSchemaResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGetCustomObjectSchemaResponse(out);
                    return res;
                } else {
