...
public class CrmCustomObjectSchemasOne {
    ...
    public static class Sync extends Base
            implements RequestOperation<CrmCustomObjectSchemasOneRequest, CrmCustomObjectSchemasOneResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CrmCustomObjectSchemasOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmCustomObjectSchemasOneRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CrmCustomObjectSchemasOneRequest request) {
        ...
        @Override
        public CrmCustomObjectSchemasOneResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CrmCustomObjectSchemasOneResponse.Builder resBuilder =
            ...
            CrmCustomObjectSchemasOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetCustomObjectSchemaResponse(Utils.unmarshal(response, new TypeReference<GetCustomObjectSchemaResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CrmCustomObjectSchemasOneRequest, com.apideck.unify.models.operations.async.CrmCustomObjectSchemasOneResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CrmCustomObjectSchemasOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmCustomObjectSchemasOneRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CrmCustomObjectSchemasOneRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.CrmCustomObjectSchemasOneResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.CrmCustomObjectSchemasOneResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.CrmCustomObjectSchemasOneResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.CrmCustomObjectSchemasOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetCustomObjectSchemaResponse>() {})
                            .thenApply(res::withGetCustomObjectSchemaResponse);
                } else {
