...
public class CrmCustomObjectSchemasOneOperation implements RequestOperation<CrmCustomObjectSchemasOneRequest, CrmCustomObjectSchemasOneResponse> {
    ...
    public CrmCustomObjectSchemasOneOperation(
    ...
    public HttpRequest buildRequest(CrmCustomObjectSchemasOneRequest request) throws Exception {
