...
public class CrmCustomObjectSchemasUpdate {
    ...
    public static class Sync extends Base
            implements RequestOperation<CrmCustomObjectSchemasUpdateRequest, CrmCustomObjectSchemasUpdateResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CrmCustomObjectSchemasUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmCustomObjectSchemasUpdateRequest.class, new TypeReference<CrmCustomObjectSchemasUpdateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CrmCustomObjectSchemasUpdateRequest request) {
        ...
        @Override
        public CrmCustomObjectSchemasUpdateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CrmCustomObjectSchemasUpdateResponse.Builder resBuilder =
            ...
            CrmCustomObjectSchemasUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withUpdateCustomObjectSchemaResponse(Utils.unmarshal(response, new TypeReference<UpdateCustomObjectSchemaResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CrmCustomObjectSchemasUpdateRequest, com.apideck.unify.models.operations.async.CrmCustomObjectSchemasUpdateResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CrmCustomObjectSchemasUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmCustomObjectSchemasUpdateRequest.class, new TypeReference<CrmCustomObjectSchemasUpdateRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CrmCustomObjectSchemasUpdateRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.CrmCustomObjectSchemasUpdateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.CrmCustomObjectSchemasUpdateResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.CrmCustomObjectSchemasUpdateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.CrmCustomObjectSchemasUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<UpdateCustomObjectSchemaResponse>() {})
                            .thenApply(res::withUpdateCustomObjectSchemaResponse);
                } else {
