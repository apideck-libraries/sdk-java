...
public class CrmCustomObjectSchemasUpdate {
    ...
    public static class Sync extends Base
        ...
        @Override
        public CrmCustomObjectSchemasUpdateResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    UpdateCustomObjectSchemaResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withUpdateCustomObjectSchemaResponse(out);
                    return res;
                } else {
