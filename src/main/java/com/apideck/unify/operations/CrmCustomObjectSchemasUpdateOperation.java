...
public class CrmCustomObjectSchemasUpdateOperation implements RequestOperation<CrmCustomObjectSchemasUpdateRequest, CrmCustomObjectSchemasUpdateResponse> {
    ...
    public CrmCustomObjectSchemasUpdateOperation(
    ...
    public HttpRequest buildRequest(CrmCustomObjectSchemasUpdateRequest request) throws Exception {
