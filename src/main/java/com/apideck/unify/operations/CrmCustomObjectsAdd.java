...
public class CrmCustomObjectsAdd {
    ...
    public static class Sync extends Base
            implements RequestOperation<CrmCustomObjectsAddRequest, CrmCustomObjectsAddResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CrmCustomObjectsAddRequest request) {
        ...
        @Override
        public CrmCustomObjectsAddResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CrmCustomObjectsAddResponse.Builder resBuilder =
            ...
            CrmCustomObjectsAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCreateCustomObjectResponse(Utils.unmarshal(response, new TypeReference<CreateCustomObjectResponse>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        public CompletableFuture<com.apideck.unify.models.operations.async.CrmCustomObjectsAddResponse> handleResponse(
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CreateCustomObjectResponse>() {})
                            .thenApply(res::withCreateCustomObjectResponse);
                } else {
