...
public class CrmCustomObjectsAddOperation implements RequestOperation<CrmCustomObjectsAddRequest, CrmCustomObjectsAddResponse> {
    ...
    public CrmCustomObjectsAddOperation(
    ...
    public HttpRequest buildRequest(CrmCustomObjectsAddRequest request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(CrmCustomObjectsAddRequest request) throws Exception {
    ...
    @Override
    public CrmCustomObjectsAddResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
