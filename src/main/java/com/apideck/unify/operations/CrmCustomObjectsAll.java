...
public class CrmCustomObjectsAll {
    ...
    public static class Sync extends Base
            implements RequestOperation<CrmCustomObjectsAllRequest, CrmCustomObjectsAllResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CrmCustomObjectsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmCustomObjectsAllRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CrmCustomObjectsAllRequest request) {
        ...
        @Override
        public CrmCustomObjectsAllResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CrmCustomObjectsAllResponse.Builder resBuilder =
            ...
            CrmCustomObjectsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetCustomObjectsResponse(Utils.unmarshal(response, new TypeReference<GetCustomObjectsResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CrmCustomObjectsAllRequest, com.apideck.unify.models.operations.async.CrmCustomObjectsAllResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CrmCustomObjectsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmCustomObjectsAllRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CrmCustomObjectsAllRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.CrmCustomObjectsAllResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.CrmCustomObjectsAllResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.CrmCustomObjectsAllResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.CrmCustomObjectsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetCustomObjectsResponse>() {})
                            .thenApply(res::withGetCustomObjectsResponse);
                } else {
