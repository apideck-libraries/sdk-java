...
public class CrmCustomObjectsAllOperation implements RequestOperation<CrmCustomObjectsAllRequest, CrmCustomObjectsAllResponse> {
    ...
    public CrmCustomObjectsAllOperation(
    ...
    public HttpRequest buildRequest(CrmCustomObjectsAllRequest request) throws Exception {
