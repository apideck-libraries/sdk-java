...
public class CrmCustomObjectsDelete {
    ...
    public static class Sync extends Base
            implements RequestOperation<CrmCustomObjectsDeleteRequest, CrmCustomObjectsDeleteResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CrmCustomObjectsDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmCustomObjectsDeleteRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CrmCustomObjectsDeleteRequest request) {
        ...
        @Override
        public CrmCustomObjectsDeleteResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CrmCustomObjectsDeleteResponse.Builder resBuilder =
            ...
            CrmCustomObjectsDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDeleteCustomObjectResponse(Utils.unmarshal(response, new TypeReference<DeleteCustomObjectResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CrmCustomObjectsDeleteRequest, com.apideck.unify.models.operations.async.CrmCustomObjectsDeleteResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CrmCustomObjectsDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmCustomObjectsDeleteRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CrmCustomObjectsDeleteRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.CrmCustomObjectsDeleteResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.CrmCustomObjectsDeleteResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.CrmCustomObjectsDeleteResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.CrmCustomObjectsDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DeleteCustomObjectResponse>() {})
                            .thenApply(res::withDeleteCustomObjectResponse);
                } else {
