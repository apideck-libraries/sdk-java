...
public class CrmCustomObjectsDeleteOperation implements RequestOperation<CrmCustomObjectsDeleteRequest, CrmCustomObjectsDeleteResponse> {
    ...
    public CrmCustomObjectsDeleteOperation(
    ...
    public HttpRequest buildRequest(CrmCustomObjectsDeleteRequest request) throws Exception {
