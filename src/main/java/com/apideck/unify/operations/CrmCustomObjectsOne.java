...
public class CrmCustomObjectsOne {
    ...
    public static class Sync extends Base
            implements RequestOperation<CrmCustomObjectsOneRequest, CrmCustomObjectsOneResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CrmCustomObjectsOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmCustomObjectsOneRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CrmCustomObjectsOneRequest request) {
        ...
        @Override
        public CrmCustomObjectsOneResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CrmCustomObjectsOneResponse.Builder resBuilder =
            ...
            CrmCustomObjectsOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetCustomObjectResponse(Utils.unmarshal(response, new TypeReference<GetCustomObjectResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CrmCustomObjectsOneRequest, com.apideck.unify.models.operations.async.CrmCustomObjectsOneResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CrmCustomObjectsOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmCustomObjectsOneRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CrmCustomObjectsOneRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.CrmCustomObjectsOneResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.CrmCustomObjectsOneResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.CrmCustomObjectsOneResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.CrmCustomObjectsOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetCustomObjectResponse>() {})
                            .thenApply(res::withGetCustomObjectResponse);
                } else {
