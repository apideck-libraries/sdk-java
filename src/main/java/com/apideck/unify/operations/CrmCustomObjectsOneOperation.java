...
public class CrmCustomObjectsOneOperation implements RequestOperation<CrmCustomObjectsOneRequest, CrmCustomObjectsOneResponse> {
    ...
    public CrmCustomObjectsOneOperation(
    ...
    public HttpRequest buildRequest(CrmCustomObjectsOneRequest request) throws Exception {
