...
public class CrmCustomObjectsUpdate {
    ...
    public static class Sync extends Base
            implements RequestOperation<CrmCustomObjectsUpdateRequest, CrmCustomObjectsUpdateResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CrmCustomObjectsUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmCustomObjectsUpdateRequest.class, new TypeReference<CrmCustomObjectsUpdateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CrmCustomObjectsUpdateRequest request) {
        ...
        @Override
        public CrmCustomObjectsUpdateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CrmCustomObjectsUpdateResponse.Builder resBuilder =
            ...
            CrmCustomObjectsUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withUpdateCustomObjectResponse(Utils.unmarshal(response, new TypeReference<UpdateCustomObjectResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CrmCustomObjectsUpdateRequest, com.apideck.unify.models.operations.async.CrmCustomObjectsUpdateResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CrmCustomObjectsUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmCustomObjectsUpdateRequest.class, new TypeReference<CrmCustomObjectsUpdateRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CrmCustomObjectsUpdateRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.CrmCustomObjectsUpdateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.CrmCustomObjectsUpdateResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.CrmCustomObjectsUpdateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.CrmCustomObjectsUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<UpdateCustomObjectResponse>() {})
                            .thenApply(res::withUpdateCustomObjectResponse);
                } else {
