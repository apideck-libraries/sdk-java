...
public class CrmCustomObjectsUpdateOperation implements RequestOperation<CrmCustomObjectsUpdateRequest, CrmCustomObjectsUpdateResponse> {
    ...
    public CrmCustomObjectsUpdateOperation(
    ...
    public HttpRequest buildRequest(CrmCustomObjectsUpdateRequest request) throws Exception {
