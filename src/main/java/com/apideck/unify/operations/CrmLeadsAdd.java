...
public class CrmLeadsAdd {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(CrmLeadsAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmLeadsAddRequest.class, new TypeReference<CrmLeadsAddRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CrmLeadsAddRequest request) {
        ...
        @Override
        public CrmLeadsAddResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCreateLeadResponse(Utils.unmarshal(response, new TypeReference<CreateLeadResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CrmLeadsAddRequest, com.apideck.unify.models.operations.async.CrmLeadsAddResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CrmLeadsAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmLeadsAddRequest.class, new TypeReference<CrmLeadsAddRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CrmLeadsAddRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.CrmLeadsAddResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.CrmLeadsAddResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.CrmLeadsAddResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.CrmLeadsAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CreateLeadResponse>() {})
                            .thenApply(res::withCreateLeadResponse);
                } else {
