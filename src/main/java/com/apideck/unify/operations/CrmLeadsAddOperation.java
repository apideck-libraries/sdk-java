...
public class CrmLeadsAddOperation implements RequestOperation<CrmLeadsAddRequest, CrmLeadsAddResponse> {
    ...
    public HttpRequest buildRequest(CrmLeadsAddRequest request) throws Exception {
