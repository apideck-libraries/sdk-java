...
public class CrmLeadsAll {
    ...
    public static class Sync extends Base
            implements RequestOperation<CrmLeadsAllRequest, CrmLeadsAllResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CrmLeadsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmLeadsAllRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CrmLeadsAllRequest request) {
        ...
        @Override
        public CrmLeadsAllResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CrmLeadsAllResponse.Builder resBuilder =
                    CrmLeadsAllResponse
                            .builder()
            ...
            CrmLeadsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetLeadsResponse(Utils.unmarshal(response, new TypeReference<GetLeadsResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CrmLeadsAllRequest, com.apideck.unify.models.operations.async.CrmLeadsAllResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CrmLeadsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmLeadsAllRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CrmLeadsAllRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.CrmLeadsAllResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.CrmLeadsAllResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.CrmLeadsAllResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.CrmLeadsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetLeadsResponse>() {})
                            .thenApply(res::withGetLeadsResponse);
                } else {
