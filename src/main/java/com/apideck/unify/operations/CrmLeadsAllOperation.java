...
public class CrmLeadsAllOperation implements RequestOperation<CrmLeadsAllRequest, CrmLeadsAllResponse> {
    ...
    public HttpRequest buildRequest(CrmLeadsAllRequest request) throws Exception {
