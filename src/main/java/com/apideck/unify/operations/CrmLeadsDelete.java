...
public class CrmLeadsDelete {
    ...
    public static class Sync extends Base
            implements RequestOperation<CrmLeadsDeleteRequest, CrmLeadsDeleteResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CrmLeadsDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmLeadsDeleteRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CrmLeadsDeleteRequest request) {
        ...
        @Override
        public CrmLeadsDeleteResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CrmLeadsDeleteResponse.Builder resBuilder =
            ...
            CrmLeadsDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDeleteLeadResponse(Utils.unmarshal(response, new TypeReference<DeleteLeadResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CrmLeadsDeleteRequest, com.apideck.unify.models.operations.async.CrmLeadsDeleteResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CrmLeadsDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmLeadsDeleteRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CrmLeadsDeleteRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.CrmLeadsDeleteResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.CrmLeadsDeleteResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.CrmLeadsDeleteResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.CrmLeadsDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DeleteLeadResponse>() {})
                            .thenApply(res::withDeleteLeadResponse);
                } else {
