...
public class CrmLeadsDeleteOperation implements RequestOperation<CrmLeadsDeleteRequest, CrmLeadsDeleteResponse> {
    ...
    public CrmLeadsDeleteOperation(
    ...
    public HttpRequest buildRequest(CrmLeadsDeleteRequest request) throws Exception {
