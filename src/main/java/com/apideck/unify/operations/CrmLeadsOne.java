...
public class CrmLeadsOne {
    ...
    public static class Sync extends Base
            implements RequestOperation<CrmLeadsOneRequest, CrmLeadsOneResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CrmLeadsOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmLeadsOneRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CrmLeadsOneRequest request) {
        ...
        @Override
        public CrmLeadsOneResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CrmLeadsOneResponse.Builder resBuilder =
                    CrmLeadsOneResponse
                            .builder()
            ...
            CrmLeadsOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetLeadResponse(Utils.unmarshal(response, new TypeReference<GetLeadResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CrmLeadsOneRequest, com.apideck.unify.models.operations.async.CrmLeadsOneResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CrmLeadsOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmLeadsOneRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CrmLeadsOneRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.CrmLeadsOneResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.CrmLeadsOneResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.CrmLeadsOneResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.CrmLeadsOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetLeadResponse>() {})
                            .thenApply(res::withGetLeadResponse);
                } else {
