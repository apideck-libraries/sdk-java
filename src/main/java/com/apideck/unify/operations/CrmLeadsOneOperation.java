...
public class CrmLeadsOneOperation implements RequestOperation<CrmLeadsOneRequest, CrmLeadsOneResponse> {
    ...
    public HttpRequest buildRequest(CrmLeadsOneRequest request) throws Exception {
