...
public class CrmLeadsUpdate {
    ...
    public static class Sync extends Base
            implements RequestOperation<CrmLeadsUpdateRequest, CrmLeadsUpdateResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CrmLeadsUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmLeadsUpdateRequest.class, new TypeReference<CrmLeadsUpdateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CrmLeadsUpdateRequest request) {
        ...
        @Override
        public CrmLeadsUpdateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CrmLeadsUpdateResponse.Builder resBuilder =
            ...
            CrmLeadsUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withUpdateLeadResponse(Utils.unmarshal(response, new TypeReference<UpdateLeadResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CrmLeadsUpdateRequest, com.apideck.unify.models.operations.async.CrmLeadsUpdateResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CrmLeadsUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmLeadsUpdateRequest.class, new TypeReference<CrmLeadsUpdateRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CrmLeadsUpdateRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.CrmLeadsUpdateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.CrmLeadsUpdateResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.CrmLeadsUpdateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.CrmLeadsUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<UpdateLeadResponse>() {})
                            .thenApply(res::withUpdateLeadResponse);
                } else {
