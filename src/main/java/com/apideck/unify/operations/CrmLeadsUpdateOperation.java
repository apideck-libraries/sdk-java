...
public class CrmLeadsUpdateOperation implements RequestOperation<CrmLeadsUpdateRequest, CrmLeadsUpdateResponse> {
    ...
    public CrmLeadsUpdateOperation(
    ...
    public HttpRequest buildRequest(CrmLeadsUpdateRequest request) throws Exception {
