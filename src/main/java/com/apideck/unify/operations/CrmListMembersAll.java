...
public class CrmListMembersAll {
    ...
    public static class Sync extends Base
            implements RequestOperation<CrmListMembersAllRequest, CrmListMembersAllResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CrmListMembersAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmListMembersAllRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CrmListMembersAllRequest request) {
        ...
        @Override
        public CrmListMembersAllResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CrmListMembersAllResponse.Builder resBuilder =
            ...
            CrmListMembersAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetListMembersResponse(Utils.unmarshal(response, new TypeReference<GetListMembersResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CrmListMembersAllRequest, com.apideck.unify.models.operations.async.CrmListMembersAllResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CrmListMembersAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmListMembersAllRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CrmListMembersAllRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.CrmListMembersAllResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.CrmListMembersAllResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.CrmListMembersAllResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.CrmListMembersAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetListMembersResponse>() {})
                            .thenApply(res::withGetListMembersResponse);
                } else {
