...
public class CrmListsAll {
    ...
    public static class Sync extends Base
            implements RequestOperation<CrmListsAllRequest, CrmListsAllResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CrmListsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmListsAllRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CrmListsAllRequest request) {
        ...
        @Override
        public CrmListsAllResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CrmListsAllResponse.Builder resBuilder =
                    CrmListsAllResponse
                            .builder()
            ...
            CrmListsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetListsResponse(Utils.unmarshal(response, new TypeReference<GetListsResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CrmListsAllRequest, com.apideck.unify.models.operations.async.CrmListsAllResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CrmListsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmListsAllRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CrmListsAllRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.CrmListsAllResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.CrmListsAllResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.CrmListsAllResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.CrmListsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetListsResponse>() {})
                            .thenApply(res::withGetListsResponse);
                } else {
