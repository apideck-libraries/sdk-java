...
public class CrmListsOne {
    ...
    public static class Sync extends Base
            implements RequestOperation<CrmListsOneRequest, CrmListsOneResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CrmListsOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmListsOneRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CrmListsOneRequest request) {
        ...
        @Override
        public CrmListsOneResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CrmListsOneResponse.Builder resBuilder =
                    CrmListsOneResponse
                            .builder()
            ...
            CrmListsOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetListResponse(Utils.unmarshal(response, new TypeReference<GetListResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CrmListsOneRequest, com.apideck.unify.models.operations.async.CrmListsOneResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CrmListsOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmListsOneRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CrmListsOneRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.CrmListsOneResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.CrmListsOneResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.CrmListsOneResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.CrmListsOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetListResponse>() {})
                            .thenApply(res::withGetListResponse);
                } else {
