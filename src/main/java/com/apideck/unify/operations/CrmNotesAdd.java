...
public class CrmNotesAdd {
    ...
    public static class Sync extends Base
            implements RequestOperation<CrmNotesAddRequest, CrmNotesAddResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CrmNotesAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmNotesAddRequest.class, new TypeReference<CrmNotesAddRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CrmNotesAddRequest request) {
        ...
        @Override
        public CrmNotesAddResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CrmNotesAddResponse.Builder resBuilder =
                    CrmNotesAddResponse
                            .builder()
            ...
            CrmNotesAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCreateNoteResponse(Utils.unmarshal(response, new TypeReference<CreateNoteResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CrmNotesAddRequest, com.apideck.unify.models.operations.async.CrmNotesAddResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CrmNotesAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmNotesAddRequest.class, new TypeReference<CrmNotesAddRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CrmNotesAddRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.CrmNotesAddResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.CrmNotesAddResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.CrmNotesAddResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.CrmNotesAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CreateNoteResponse>() {})
                            .thenApply(res::withCreateNoteResponse);
                } else {
