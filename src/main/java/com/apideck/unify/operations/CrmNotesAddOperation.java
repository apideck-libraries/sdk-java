...
public class CrmNotesAddOperation implements RequestOperation<CrmNotesAddRequest, CrmNotesAddResponse> {
    ...
    public HttpRequest buildRequest(CrmNotesAddRequest request) throws Exception {
