...
public class CrmNotesAll {
    ...
    public static class Sync extends Base
            implements RequestOperation<CrmNotesAllRequest, CrmNotesAllResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CrmNotesAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmNotesAllRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CrmNotesAllRequest request) {
        ...
        @Override
        public CrmNotesAllResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CrmNotesAllResponse.Builder resBuilder =
                    CrmNotesAllResponse
                            .builder()
            ...
            CrmNotesAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetNotesResponse(Utils.unmarshal(response, new TypeReference<GetNotesResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CrmNotesAllRequest, com.apideck.unify.models.operations.async.CrmNotesAllResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CrmNotesAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmNotesAllRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CrmNotesAllRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.CrmNotesAllResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.CrmNotesAllResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.CrmNotesAllResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.CrmNotesAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetNotesResponse>() {})
                            .thenApply(res::withGetNotesResponse);
                } else {
