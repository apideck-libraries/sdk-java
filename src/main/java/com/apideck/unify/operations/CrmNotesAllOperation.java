...
public class CrmNotesAllOperation implements RequestOperation<CrmNotesAllRequest, CrmNotesAllResponse> {
    ...
    public HttpRequest buildRequest(CrmNotesAllRequest request) throws Exception {
