...
public class CrmNotesDelete {
    ...
    public static class Sync extends Base
            implements RequestOperation<CrmNotesDeleteRequest, CrmNotesDeleteResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CrmNotesDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmNotesDeleteRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CrmNotesDeleteRequest request) {
        ...
        @Override
        public CrmNotesDeleteResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CrmNotesDeleteResponse.Builder resBuilder =
            ...
            CrmNotesDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDeleteNoteResponse(Utils.unmarshal(response, new TypeReference<DeleteNoteResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CrmNotesDeleteRequest, com.apideck.unify.models.operations.async.CrmNotesDeleteResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CrmNotesDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmNotesDeleteRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CrmNotesDeleteRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.CrmNotesDeleteResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.CrmNotesDeleteResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.CrmNotesDeleteResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.CrmNotesDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DeleteNoteResponse>() {})
                            .thenApply(res::withDeleteNoteResponse);
                } else {
