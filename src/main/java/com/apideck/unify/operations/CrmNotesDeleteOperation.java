...
public class CrmNotesDeleteOperation implements RequestOperation<CrmNotesDeleteRequest, CrmNotesDeleteResponse> {
    ...
    public CrmNotesDeleteOperation(
    ...
    public HttpRequest buildRequest(CrmNotesDeleteRequest request) throws Exception {
