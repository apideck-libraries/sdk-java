...
public class CrmNotesOne {
    ...
    public static class Sync extends Base
            implements RequestOperation<CrmNotesOneRequest, CrmNotesOneResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CrmNotesOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmNotesOneRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CrmNotesOneRequest request) {
        ...
        @Override
        public CrmNotesOneResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CrmNotesOneResponse.Builder resBuilder =
                    CrmNotesOneResponse
                            .builder()
            ...
            CrmNotesOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetNoteResponse(Utils.unmarshal(response, new TypeReference<GetNoteResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CrmNotesOneRequest, com.apideck.unify.models.operations.async.CrmNotesOneResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CrmNotesOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmNotesOneRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CrmNotesOneRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.CrmNotesOneResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.CrmNotesOneResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.CrmNotesOneResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.CrmNotesOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetNoteResponse>() {})
                            .thenApply(res::withGetNoteResponse);
                } else {
