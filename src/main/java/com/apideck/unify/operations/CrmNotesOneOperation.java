...
public class CrmNotesOneOperation implements RequestOperation<CrmNotesOneRequest, CrmNotesOneResponse> {
    ...
    public HttpRequest buildRequest(CrmNotesOneRequest request) throws Exception {
