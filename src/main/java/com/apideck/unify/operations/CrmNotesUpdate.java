...
public class CrmNotesUpdate {
    ...
    public static class Sync extends Base
            implements RequestOperation<CrmNotesUpdateRequest, CrmNotesUpdateResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CrmNotesUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmNotesUpdateRequest.class, new TypeReference<CrmNotesUpdateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CrmNotesUpdateRequest request) {
        ...
        @Override
        public CrmNotesUpdateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CrmNotesUpdateResponse.Builder resBuilder =
            ...
            CrmNotesUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withUpdateNoteResponse(Utils.unmarshal(response, new TypeReference<UpdateNoteResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CrmNotesUpdateRequest, com.apideck.unify.models.operations.async.CrmNotesUpdateResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CrmNotesUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmNotesUpdateRequest.class, new TypeReference<CrmNotesUpdateRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CrmNotesUpdateRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.CrmNotesUpdateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.CrmNotesUpdateResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.CrmNotesUpdateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.CrmNotesUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<UpdateNoteResponse>() {})
                            .thenApply(res::withUpdateNoteResponse);
                } else {
