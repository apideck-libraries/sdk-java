...
public class CrmNotesUpdateOperation implements RequestOperation<CrmNotesUpdateRequest, CrmNotesUpdateResponse> {
    ...
    public CrmNotesUpdateOperation(
    ...
    public HttpRequest buildRequest(CrmNotesUpdateRequest request) throws Exception {
