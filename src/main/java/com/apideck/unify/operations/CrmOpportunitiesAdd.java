...
public class CrmOpportunitiesAdd {
    ...
    public static class Sync extends Base
            implements RequestOperation<CrmOpportunitiesAddRequest, CrmOpportunitiesAddResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CrmOpportunitiesAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmOpportunitiesAddRequest.class, new TypeReference<CrmOpportunitiesAddRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CrmOpportunitiesAddRequest request) {
        ...
        @Override
        public CrmOpportunitiesAddResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CrmOpportunitiesAddResponse.Builder resBuilder =
            ...
            CrmOpportunitiesAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCreateOpportunityResponse(Utils.unmarshal(response, new TypeReference<CreateOpportunityResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CrmOpportunitiesAddRequest, com.apideck.unify.models.operations.async.CrmOpportunitiesAddResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CrmOpportunitiesAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmOpportunitiesAddRequest.class, new TypeReference<CrmOpportunitiesAddRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CrmOpportunitiesAddRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.CrmOpportunitiesAddResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.CrmOpportunitiesAddResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.CrmOpportunitiesAddResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.CrmOpportunitiesAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CreateOpportunityResponse>() {})
                            .thenApply(res::withCreateOpportunityResponse);
                } else {
