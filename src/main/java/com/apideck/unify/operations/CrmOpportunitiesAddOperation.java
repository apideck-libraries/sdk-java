...
public class CrmOpportunitiesAddOperation implements RequestOperation<CrmOpportunitiesAddRequest, CrmOpportunitiesAddResponse> {
    ...
    public CrmOpportunitiesAddOperation(
    ...
    public HttpRequest buildRequest(CrmOpportunitiesAddRequest request) throws Exception {
