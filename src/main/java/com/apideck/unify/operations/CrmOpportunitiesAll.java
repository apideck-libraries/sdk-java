...
public class CrmOpportunitiesAll {
    ...
    public static class Sync extends Base
            implements RequestOperation<CrmOpportunitiesAllRequest, CrmOpportunitiesAllResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CrmOpportunitiesAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmOpportunitiesAllRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CrmOpportunitiesAllRequest request) {
        ...
        @Override
        public CrmOpportunitiesAllResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CrmOpportunitiesAllResponse.Builder resBuilder =
            ...
            CrmOpportunitiesAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetOpportunitiesResponse(Utils.unmarshal(response, new TypeReference<GetOpportunitiesResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CrmOpportunitiesAllRequest, com.apideck.unify.models.operations.async.CrmOpportunitiesAllResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CrmOpportunitiesAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmOpportunitiesAllRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CrmOpportunitiesAllRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.CrmOpportunitiesAllResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.CrmOpportunitiesAllResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.CrmOpportunitiesAllResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.CrmOpportunitiesAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetOpportunitiesResponse>() {})
                            .thenApply(res::withGetOpportunitiesResponse);
                } else {
