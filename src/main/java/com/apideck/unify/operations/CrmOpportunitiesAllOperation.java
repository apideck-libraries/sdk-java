...
public class CrmOpportunitiesAllOperation implements RequestOperation<CrmOpportunitiesAllRequest, CrmOpportunitiesAllResponse> {
    ...
    public CrmOpportunitiesAllOperation(
    ...
    public HttpRequest buildRequest(CrmOpportunitiesAllRequest request) throws Exception {
