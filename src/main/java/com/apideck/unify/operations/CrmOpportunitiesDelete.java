...
public class CrmOpportunitiesDelete {
    ...
    public static class Sync extends Base
            implements RequestOperation<CrmOpportunitiesDeleteRequest, CrmOpportunitiesDeleteResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CrmOpportunitiesDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmOpportunitiesDeleteRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CrmOpportunitiesDeleteRequest request) {
        ...
        @Override
        public CrmOpportunitiesDeleteResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CrmOpportunitiesDeleteResponse.Builder resBuilder =
            ...
            CrmOpportunitiesDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDeleteOpportunityResponse(Utils.unmarshal(response, new TypeReference<DeleteOpportunityResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CrmOpportunitiesDeleteRequest, com.apideck.unify.models.operations.async.CrmOpportunitiesDeleteResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CrmOpportunitiesDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmOpportunitiesDeleteRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CrmOpportunitiesDeleteRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.CrmOpportunitiesDeleteResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.CrmOpportunitiesDeleteResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.CrmOpportunitiesDeleteResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.CrmOpportunitiesDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DeleteOpportunityResponse>() {})
                            .thenApply(res::withDeleteOpportunityResponse);
                } else {
