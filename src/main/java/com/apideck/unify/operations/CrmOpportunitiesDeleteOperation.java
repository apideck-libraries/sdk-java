...
public class CrmOpportunitiesDeleteOperation implements RequestOperation<CrmOpportunitiesDeleteRequest, CrmOpportunitiesDeleteResponse> {
    ...
    public CrmOpportunitiesDeleteOperation(
    ...
    public HttpRequest buildRequest(CrmOpportunitiesDeleteRequest request) throws Exception {
