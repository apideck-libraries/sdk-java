...
public class CrmOpportunitiesOne {
    ...
    public static class Sync extends Base
            implements RequestOperation<CrmOpportunitiesOneRequest, CrmOpportunitiesOneResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CrmOpportunitiesOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmOpportunitiesOneRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CrmOpportunitiesOneRequest request) {
        ...
        @Override
        public CrmOpportunitiesOneResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CrmOpportunitiesOneResponse.Builder resBuilder =
            ...
            CrmOpportunitiesOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetOpportunityResponse(Utils.unmarshal(response, new TypeReference<GetOpportunityResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CrmOpportunitiesOneRequest, com.apideck.unify.models.operations.async.CrmOpportunitiesOneResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CrmOpportunitiesOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmOpportunitiesOneRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CrmOpportunitiesOneRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.CrmOpportunitiesOneResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.CrmOpportunitiesOneResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.CrmOpportunitiesOneResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.CrmOpportunitiesOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetOpportunityResponse>() {})
                            .thenApply(res::withGetOpportunityResponse);
                } else {
