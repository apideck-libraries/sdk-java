...
public class CrmOpportunitiesOneOperation implements RequestOperation<CrmOpportunitiesOneRequest, CrmOpportunitiesOneResponse> {
    ...
    public CrmOpportunitiesOneOperation(
    ...
    public HttpRequest buildRequest(CrmOpportunitiesOneRequest request) throws Exception {
