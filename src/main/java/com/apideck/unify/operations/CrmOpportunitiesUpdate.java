...
public class CrmOpportunitiesUpdate {
    ...
    public static class Sync extends Base
            implements RequestOperation<CrmOpportunitiesUpdateRequest, CrmOpportunitiesUpdateResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CrmOpportunitiesUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmOpportunitiesUpdateRequest.class, new TypeReference<CrmOpportunitiesUpdateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CrmOpportunitiesUpdateRequest request) {
        ...
        @Override
        public CrmOpportunitiesUpdateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CrmOpportunitiesUpdateResponse.Builder resBuilder =
            ...
            CrmOpportunitiesUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withUpdateOpportunityResponse(Utils.unmarshal(response, new TypeReference<UpdateOpportunityResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CrmOpportunitiesUpdateRequest, com.apideck.unify.models.operations.async.CrmOpportunitiesUpdateResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CrmOpportunitiesUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmOpportunitiesUpdateRequest.class, new TypeReference<CrmOpportunitiesUpdateRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CrmOpportunitiesUpdateRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.CrmOpportunitiesUpdateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.CrmOpportunitiesUpdateResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.CrmOpportunitiesUpdateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.CrmOpportunitiesUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<UpdateOpportunityResponse>() {})
                            .thenApply(res::withUpdateOpportunityResponse);
                } else {
