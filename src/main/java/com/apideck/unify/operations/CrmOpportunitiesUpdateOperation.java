...
public class CrmOpportunitiesUpdateOperation implements RequestOperation<CrmOpportunitiesUpdateRequest, CrmOpportunitiesUpdateResponse> {
    ...
    public CrmOpportunitiesUpdateOperation(
    ...
    public HttpRequest buildRequest(CrmOpportunitiesUpdateRequest request) throws Exception {
