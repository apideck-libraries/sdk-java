...
public class CrmPipelinesAdd {
    ...
    public static class Sync extends Base
            implements RequestOperation<CrmPipelinesAddRequest, CrmPipelinesAddResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CrmPipelinesAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmPipelinesAddRequest.class, new TypeReference<CrmPipelinesAddRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CrmPipelinesAddRequest request) {
        ...
        @Override
        public CrmPipelinesAddResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CrmPipelinesAddResponse.Builder resBuilder =
            ...
            CrmPipelinesAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCreatePipelineResponse(Utils.unmarshal(response, new TypeReference<CreatePipelineResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CrmPipelinesAddRequest, com.apideck.unify.models.operations.async.CrmPipelinesAddResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CrmPipelinesAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmPipelinesAddRequest.class, new TypeReference<CrmPipelinesAddRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CrmPipelinesAddRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.CrmPipelinesAddResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.CrmPipelinesAddResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.CrmPipelinesAddResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.CrmPipelinesAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CreatePipelineResponse>() {})
                            .thenApply(res::withCreatePipelineResponse);
                } else {
