...
public class CrmPipelinesAddOperation implements RequestOperation<CrmPipelinesAddRequest, CrmPipelinesAddResponse> {
    ...
    public CrmPipelinesAddOperation(
    ...
    public HttpRequest buildRequest(CrmPipelinesAddRequest request) throws Exception {
