...
public class CrmPipelinesAll {
    ...
    public static class Sync extends Base
            implements RequestOperation<CrmPipelinesAllRequest, CrmPipelinesAllResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CrmPipelinesAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmPipelinesAllRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CrmPipelinesAllRequest request) {
        ...
        @Override
        public CrmPipelinesAllResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CrmPipelinesAllResponse.Builder resBuilder =
            ...
            CrmPipelinesAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetPipelinesResponse(Utils.unmarshal(response, new TypeReference<GetPipelinesResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CrmPipelinesAllRequest, com.apideck.unify.models.operations.async.CrmPipelinesAllResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CrmPipelinesAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmPipelinesAllRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CrmPipelinesAllRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.CrmPipelinesAllResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.CrmPipelinesAllResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.CrmPipelinesAllResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.CrmPipelinesAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetPipelinesResponse>() {})
                            .thenApply(res::withGetPipelinesResponse);
                } else {
