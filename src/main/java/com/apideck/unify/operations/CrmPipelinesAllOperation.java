...
public class CrmPipelinesAllOperation implements RequestOperation<CrmPipelinesAllRequest, CrmPipelinesAllResponse> {
    ...
    public CrmPipelinesAllOperation(
    ...
    public HttpRequest buildRequest(CrmPipelinesAllRequest request) throws Exception {
