...
public class CrmPipelinesDelete {
    ...
    public static class Sync extends Base
            implements RequestOperation<CrmPipelinesDeleteRequest, CrmPipelinesDeleteResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CrmPipelinesDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmPipelinesDeleteRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CrmPipelinesDeleteRequest request) {
        ...
        @Override
        public CrmPipelinesDeleteResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CrmPipelinesDeleteResponse.Builder resBuilder =
            ...
            CrmPipelinesDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDeletePipelineResponse(Utils.unmarshal(response, new TypeReference<DeletePipelineResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CrmPipelinesDeleteRequest, com.apideck.unify.models.operations.async.CrmPipelinesDeleteResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CrmPipelinesDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmPipelinesDeleteRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CrmPipelinesDeleteRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.CrmPipelinesDeleteResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.CrmPipelinesDeleteResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.CrmPipelinesDeleteResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.CrmPipelinesDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DeletePipelineResponse>() {})
                            .thenApply(res::withDeletePipelineResponse);
                } else {
