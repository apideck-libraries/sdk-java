...
public class CrmPipelinesDeleteOperation implements RequestOperation<CrmPipelinesDeleteRequest, CrmPipelinesDeleteResponse> {
    ...
    public CrmPipelinesDeleteOperation(
    ...
    public HttpRequest buildRequest(CrmPipelinesDeleteRequest request) throws Exception {
