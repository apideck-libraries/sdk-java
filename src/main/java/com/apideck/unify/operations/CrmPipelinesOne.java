...
public class CrmPipelinesOne {
    ...
    public static class Sync extends Base
            implements RequestOperation<CrmPipelinesOneRequest, CrmPipelinesOneResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CrmPipelinesOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmPipelinesOneRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CrmPipelinesOneRequest request) {
        ...
        @Override
        public CrmPipelinesOneResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CrmPipelinesOneResponse.Builder resBuilder =
            ...
            CrmPipelinesOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetPipelineResponse(Utils.unmarshal(response, new TypeReference<GetPipelineResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CrmPipelinesOneRequest, com.apideck.unify.models.operations.async.CrmPipelinesOneResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CrmPipelinesOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmPipelinesOneRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CrmPipelinesOneRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.CrmPipelinesOneResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.CrmPipelinesOneResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.CrmPipelinesOneResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.CrmPipelinesOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetPipelineResponse>() {})
                            .thenApply(res::withGetPipelineResponse);
                } else {
