...
public class CrmPipelinesOneOperation implements RequestOperation<CrmPipelinesOneRequest, CrmPipelinesOneResponse> {
    ...
    public CrmPipelinesOneOperation(
    ...
    public HttpRequest buildRequest(CrmPipelinesOneRequest request) throws Exception {
