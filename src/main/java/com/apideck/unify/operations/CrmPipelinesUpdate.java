...
public class CrmPipelinesUpdate {
    ...
    public static class Sync extends Base
            implements RequestOperation<CrmPipelinesUpdateRequest, CrmPipelinesUpdateResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CrmPipelinesUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmPipelinesUpdateRequest.class, new TypeReference<CrmPipelinesUpdateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CrmPipelinesUpdateRequest request) {
        ...
        @Override
        public CrmPipelinesUpdateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CrmPipelinesUpdateResponse.Builder resBuilder =
            ...
            CrmPipelinesUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withUpdatePipelineResponse(Utils.unmarshal(response, new TypeReference<UpdatePipelineResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CrmPipelinesUpdateRequest, com.apideck.unify.models.operations.async.CrmPipelinesUpdateResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CrmPipelinesUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmPipelinesUpdateRequest.class, new TypeReference<CrmPipelinesUpdateRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CrmPipelinesUpdateRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.CrmPipelinesUpdateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.CrmPipelinesUpdateResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.CrmPipelinesUpdateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.CrmPipelinesUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<UpdatePipelineResponse>() {})
                            .thenApply(res::withUpdatePipelineResponse);
                } else {
