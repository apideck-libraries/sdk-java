...
public class CrmPipelinesUpdateOperation implements RequestOperation<CrmPipelinesUpdateRequest, CrmPipelinesUpdateResponse> {
    ...
    public CrmPipelinesUpdateOperation(
    ...
    public HttpRequest buildRequest(CrmPipelinesUpdateRequest request) throws Exception {
