...
public class CrmUsersAdd {
    ...
    public static class Sync extends Base
            implements RequestOperation<CrmUsersAddRequest, CrmUsersAddResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CrmUsersAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmUsersAddRequest.class, new TypeReference<CrmUsersAddRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CrmUsersAddRequest request) {
        ...
        @Override
        public CrmUsersAddResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CrmUsersAddResponse.Builder resBuilder =
                    CrmUsersAddResponse
                            .builder()
            ...
            CrmUsersAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCreateUserResponse(Utils.unmarshal(response, new TypeReference<CreateUserResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CrmUsersAddRequest, com.apideck.unify.models.operations.async.CrmUsersAddResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CrmUsersAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmUsersAddRequest.class, new TypeReference<CrmUsersAddRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CrmUsersAddRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.CrmUsersAddResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.CrmUsersAddResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.CrmUsersAddResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.CrmUsersAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CreateUserResponse>() {})
                            .thenApply(res::withCreateUserResponse);
                } else {
