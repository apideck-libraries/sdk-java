...
public class CrmUsersAddOperation implements RequestOperation<CrmUsersAddRequest, CrmUsersAddResponse> {
    ...
    public HttpRequest buildRequest(CrmUsersAddRequest request) throws Exception {
