...
public class CrmUsersAll {
    ...
    public static class Sync extends Base
            implements RequestOperation<CrmUsersAllRequest, CrmUsersAllResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CrmUsersAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmUsersAllRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CrmUsersAllRequest request) {
        ...
        @Override
        public CrmUsersAllResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CrmUsersAllResponse.Builder resBuilder =
                    CrmUsersAllResponse
                            .builder()
            ...
            CrmUsersAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetUsersResponse(Utils.unmarshal(response, new TypeReference<GetUsersResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CrmUsersAllRequest, com.apideck.unify.models.operations.async.CrmUsersAllResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CrmUsersAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmUsersAllRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CrmUsersAllRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.CrmUsersAllResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.CrmUsersAllResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.CrmUsersAllResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.CrmUsersAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetUsersResponse>() {})
                            .thenApply(res::withGetUsersResponse);
                } else {
