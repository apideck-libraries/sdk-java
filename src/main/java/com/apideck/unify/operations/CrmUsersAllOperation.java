...
public class CrmUsersAllOperation implements RequestOperation<CrmUsersAllRequest, CrmUsersAllResponse> {
    ...
    public HttpRequest buildRequest(CrmUsersAllRequest request) throws Exception {
