...
public class CrmUsersDelete {
    ...
    public static class Sync extends Base
            implements RequestOperation<CrmUsersDeleteRequest, CrmUsersDeleteResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CrmUsersDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmUsersDeleteRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CrmUsersDeleteRequest request) {
        ...
        @Override
        public CrmUsersDeleteResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CrmUsersDeleteResponse.Builder resBuilder =
            ...
            CrmUsersDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDeleteUserResponse(Utils.unmarshal(response, new TypeReference<DeleteUserResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CrmUsersDeleteRequest, com.apideck.unify.models.operations.async.CrmUsersDeleteResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CrmUsersDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmUsersDeleteRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CrmUsersDeleteRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.CrmUsersDeleteResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.CrmUsersDeleteResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.CrmUsersDeleteResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.CrmUsersDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DeleteUserResponse>() {})
                            .thenApply(res::withDeleteUserResponse);
                } else {
