...
public class CrmUsersDeleteOperation implements RequestOperation<CrmUsersDeleteRequest, CrmUsersDeleteResponse> {
    ...
    public CrmUsersDeleteOperation(
    ...
    public HttpRequest buildRequest(CrmUsersDeleteRequest request) throws Exception {
