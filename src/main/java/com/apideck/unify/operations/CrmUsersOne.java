...
public class CrmUsersOne {
    ...
    public static class Sync extends Base
            implements RequestOperation<CrmUsersOneRequest, CrmUsersOneResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CrmUsersOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmUsersOneRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CrmUsersOneRequest request) {
        ...
        @Override
        public CrmUsersOneResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CrmUsersOneResponse.Builder resBuilder =
                    CrmUsersOneResponse
                            .builder()
            ...
            CrmUsersOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetUserResponse(Utils.unmarshal(response, new TypeReference<GetUserResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CrmUsersOneRequest, com.apideck.unify.models.operations.async.CrmUsersOneResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CrmUsersOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmUsersOneRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CrmUsersOneRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.CrmUsersOneResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.CrmUsersOneResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.CrmUsersOneResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.CrmUsersOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetUserResponse>() {})
                            .thenApply(res::withGetUserResponse);
                } else {
