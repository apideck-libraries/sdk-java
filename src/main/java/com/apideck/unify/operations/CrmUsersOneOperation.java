...
public class CrmUsersOneOperation implements RequestOperation<CrmUsersOneRequest, CrmUsersOneResponse> {
    ...
    public HttpRequest buildRequest(CrmUsersOneRequest request) throws Exception {
