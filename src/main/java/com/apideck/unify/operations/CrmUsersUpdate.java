...
public class CrmUsersUpdate {
    ...
    public static class Sync extends Base
            implements RequestOperation<CrmUsersUpdateRequest, CrmUsersUpdateResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CrmUsersUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmUsersUpdateRequest.class, new TypeReference<CrmUsersUpdateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CrmUsersUpdateRequest request) {
        ...
        @Override
        public CrmUsersUpdateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CrmUsersUpdateResponse.Builder resBuilder =
            ...
            CrmUsersUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withUpdateUserResponse(Utils.unmarshal(response, new TypeReference<UpdateUserResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CrmUsersUpdateRequest, com.apideck.unify.models.operations.async.CrmUsersUpdateResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CrmUsersUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CrmUsersUpdateRequest.class, new TypeReference<CrmUsersUpdateRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CrmUsersUpdateRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.CrmUsersUpdateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.CrmUsersUpdateResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.CrmUsersUpdateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.CrmUsersUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<UpdateUserResponse>() {})
                            .thenApply(res::withUpdateUserResponse);
                } else {
