...
public class CrmUsersUpdateOperation implements RequestOperation<CrmUsersUpdateRequest, CrmUsersUpdateResponse> {
    ...
    public CrmUsersUpdateOperation(
    ...
    public HttpRequest buildRequest(CrmUsersUpdateRequest request) throws Exception {
