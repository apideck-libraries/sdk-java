...
public class EcommerceCustomersAll {
    ...
    public static class Sync extends Base
            implements RequestOperation<EcommerceCustomersAllRequest, EcommerceCustomersAllResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(EcommerceCustomersAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, EcommerceCustomersAllRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(EcommerceCustomersAllRequest request) {
        ...
        @Override
        public EcommerceCustomersAllResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            EcommerceCustomersAllResponse.Builder resBuilder =
            ...
            EcommerceCustomersAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetEcommerceCustomersResponse(Utils.unmarshal(response, new TypeReference<GetEcommerceCustomersResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<EcommerceCustomersAllRequest, com.apideck.unify.models.operations.async.EcommerceCustomersAllResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(EcommerceCustomersAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, EcommerceCustomersAllRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(EcommerceCustomersAllRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.EcommerceCustomersAllResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.EcommerceCustomersAllResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.EcommerceCustomersAllResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.EcommerceCustomersAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetEcommerceCustomersResponse>() {})
                            .thenApply(res::withGetEcommerceCustomersResponse);
                } else {
