...
public class EcommerceCustomersAll {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(EcommerceCustomersAllRequest request) throws Exception {
        ...
        @Override
        public EcommerceCustomersAllResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GetEcommerceCustomersResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGetEcommerceCustomersResponse(out);
                    return res;
                } else {
