...
public class EcommerceCustomersAllOperation implements RequestOperation<EcommerceCustomersAllRequest, EcommerceCustomersAllResponse> {
    ...
    public EcommerceCustomersAllOperation(
    ...
    public HttpRequest buildRequest(EcommerceCustomersAllRequest request) throws Exception {
