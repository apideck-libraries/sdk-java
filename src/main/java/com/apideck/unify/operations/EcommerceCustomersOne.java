...
public class EcommerceCustomersOne {
    ...
    public static class Sync extends Base
            implements RequestOperation<EcommerceCustomersOneRequest, EcommerceCustomersOneResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(EcommerceCustomersOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, EcommerceCustomersOneRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(EcommerceCustomersOneRequest request) {
        ...
        @Override
        public EcommerceCustomersOneResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            EcommerceCustomersOneResponse.Builder resBuilder =
            ...
            EcommerceCustomersOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetEcommerceCustomerResponse(Utils.unmarshal(response, new TypeReference<GetEcommerceCustomerResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<EcommerceCustomersOneRequest, com.apideck.unify.models.operations.async.EcommerceCustomersOneResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(EcommerceCustomersOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, EcommerceCustomersOneRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(EcommerceCustomersOneRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.EcommerceCustomersOneResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.EcommerceCustomersOneResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.EcommerceCustomersOneResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.EcommerceCustomersOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetEcommerceCustomerResponse>() {})
                            .thenApply(res::withGetEcommerceCustomerResponse);
                } else {
