...
public class EcommerceCustomersOne {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(EcommerceCustomersOneRequest request) throws Exception {
        ...
        @Override
        public EcommerceCustomersOneResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GetEcommerceCustomerResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGetEcommerceCustomerResponse(out);
                    return res;
                } else {
