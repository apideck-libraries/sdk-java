...
public class EcommerceCustomersOneOperation implements RequestOperation<EcommerceCustomersOneRequest, EcommerceCustomersOneResponse> {
    ...
    public EcommerceCustomersOneOperation(
    ...
    public HttpRequest buildRequest(EcommerceCustomersOneRequest request) throws Exception {
