...
public class EcommerceOrdersAll {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(EcommerceOrdersAllRequest request) throws Exception {
        ...
        @Override
        public EcommerceOrdersAllResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GetEcommerceOrdersResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGetEcommerceOrdersResponse(out);
                    return res;
                } else {
