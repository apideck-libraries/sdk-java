...
public class EcommerceOrdersAll {
    ...
    public static class Sync extends Base
            implements RequestOperation<EcommerceOrdersAllRequest, EcommerceOrdersAllResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(EcommerceOrdersAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, EcommerceOrdersAllRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(EcommerceOrdersAllRequest request) {
        ...
        @Override
        public EcommerceOrdersAllResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            EcommerceOrdersAllResponse.Builder resBuilder =
            ...
            EcommerceOrdersAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetEcommerceOrdersResponse(Utils.unmarshal(response, new TypeReference<GetEcommerceOrdersResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<EcommerceOrdersAllRequest, com.apideck.unify.models.operations.async.EcommerceOrdersAllResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(EcommerceOrdersAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, EcommerceOrdersAllRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(EcommerceOrdersAllRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.EcommerceOrdersAllResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.EcommerceOrdersAllResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.EcommerceOrdersAllResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.EcommerceOrdersAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetEcommerceOrdersResponse>() {})
                            .thenApply(res::withGetEcommerceOrdersResponse);
                } else {
