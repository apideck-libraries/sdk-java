...
public class EcommerceOrdersAllOperation implements RequestOperation<EcommerceOrdersAllRequest, EcommerceOrdersAllResponse> {
    ...
    public EcommerceOrdersAllOperation(
    ...
    public HttpRequest buildRequest(EcommerceOrdersAllRequest request) throws Exception {
