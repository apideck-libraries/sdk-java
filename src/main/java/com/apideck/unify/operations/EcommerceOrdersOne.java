...
public class EcommerceOrdersOne {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(EcommerceOrdersOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, EcommerceOrdersOneRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(EcommerceOrdersOneRequest request) {
        ...
        @Override
        public EcommerceOrdersOneResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetEcommerceOrderResponse(Utils.unmarshal(response, new TypeReference<GetEcommerceOrderResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<EcommerceOrdersOneRequest, com.apideck.unify.models.operations.async.EcommerceOrdersOneResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(EcommerceOrdersOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, EcommerceOrdersOneRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(EcommerceOrdersOneRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.EcommerceOrdersOneResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.EcommerceOrdersOneResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.EcommerceOrdersOneResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.EcommerceOrdersOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetEcommerceOrderResponse>() {})
                            .thenApply(res::withGetEcommerceOrderResponse);
                } else {
