...
public class EcommerceOrdersOneOperation implements RequestOperation<EcommerceOrdersOneRequest, EcommerceOrdersOneResponse> {
    ...
    public EcommerceOrdersOneOperation(
    ...
    public HttpRequest buildRequest(EcommerceOrdersOneRequest request) throws Exception {
