...
public class EcommerceProductsAll {
    ...
    public static class Sync extends Base
            implements RequestOperation<EcommerceProductsAllRequest, EcommerceProductsAllResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(EcommerceProductsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, EcommerceProductsAllRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(EcommerceProductsAllRequest request) {
        ...
        @Override
        public EcommerceProductsAllResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            EcommerceProductsAllResponse.Builder resBuilder =
            ...
            EcommerceProductsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetProductsResponse(Utils.unmarshal(response, new TypeReference<GetProductsResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<EcommerceProductsAllRequest, com.apideck.unify.models.operations.async.EcommerceProductsAllResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(EcommerceProductsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, EcommerceProductsAllRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(EcommerceProductsAllRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.EcommerceProductsAllResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.EcommerceProductsAllResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.EcommerceProductsAllResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.EcommerceProductsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetProductsResponse>() {})
                            .thenApply(res::withGetProductsResponse);
                } else {
