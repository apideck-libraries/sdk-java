...
public class EcommerceProductsAllOperation implements RequestOperation<EcommerceProductsAllRequest, EcommerceProductsAllResponse> {
    ...
    public EcommerceProductsAllOperation(
    ...
    public HttpRequest buildRequest(EcommerceProductsAllRequest request) throws Exception {
