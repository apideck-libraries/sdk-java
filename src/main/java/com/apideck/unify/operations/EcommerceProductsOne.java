...
public class EcommerceProductsOne {
    ...
    public static class Sync extends Base
            implements RequestOperation<EcommerceProductsOneRequest, EcommerceProductsOneResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(EcommerceProductsOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, EcommerceProductsOneRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(EcommerceProductsOneRequest request) {
        ...
        @Override
        public EcommerceProductsOneResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            EcommerceProductsOneResponse.Builder resBuilder =
            ...
            EcommerceProductsOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetProductResponse(Utils.unmarshal(response, new TypeReference<GetProductResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<EcommerceProductsOneRequest, com.apideck.unify.models.operations.async.EcommerceProductsOneResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(EcommerceProductsOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, EcommerceProductsOneRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(EcommerceProductsOneRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.EcommerceProductsOneResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.EcommerceProductsOneResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.EcommerceProductsOneResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.EcommerceProductsOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetProductResponse>() {})
                            .thenApply(res::withGetProductResponse);
                } else {
