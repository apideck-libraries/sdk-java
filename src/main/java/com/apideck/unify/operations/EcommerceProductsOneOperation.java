...
public class EcommerceProductsOneOperation implements RequestOperation<EcommerceProductsOneRequest, EcommerceProductsOneResponse> {
    ...
    public EcommerceProductsOneOperation(
    ...
    public HttpRequest buildRequest(EcommerceProductsOneRequest request) throws Exception {
