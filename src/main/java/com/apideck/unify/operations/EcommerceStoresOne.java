...
public class EcommerceStoresOne {
    ...
    public static class Sync extends Base
            implements RequestOperation<EcommerceStoresOneRequest, EcommerceStoresOneResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(EcommerceStoresOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, EcommerceStoresOneRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(EcommerceStoresOneRequest request) {
        ...
        @Override
        public EcommerceStoresOneResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            EcommerceStoresOneResponse.Builder resBuilder =
            ...
            EcommerceStoresOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetStoreResponse(Utils.unmarshal(response, new TypeReference<GetStoreResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<EcommerceStoresOneRequest, com.apideck.unify.models.operations.async.EcommerceStoresOneResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(EcommerceStoresOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, EcommerceStoresOneRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(EcommerceStoresOneRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.EcommerceStoresOneResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.EcommerceStoresOneResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.EcommerceStoresOneResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.EcommerceStoresOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetStoreResponse>() {})
                            .thenApply(res::withGetStoreResponse);
                } else {
