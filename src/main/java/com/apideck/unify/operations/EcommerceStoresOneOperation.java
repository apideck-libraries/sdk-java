...
public class EcommerceStoresOneOperation implements RequestOperation<EcommerceStoresOneRequest, EcommerceStoresOneResponse> {
    ...
    public EcommerceStoresOneOperation(
    ...
    public HttpRequest buildRequest(EcommerceStoresOneRequest request) throws Exception {
