...
public class FileStorageDriveGroupsAdd {
    ...
    public static class Sync extends Base
            implements RequestOperation<FileStorageDriveGroupsAddRequest, FileStorageDriveGroupsAddResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(FileStorageDriveGroupsAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, FileStorageDriveGroupsAddRequest.class, new TypeReference<FileStorageDriveGroupsAddRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(FileStorageDriveGroupsAddRequest request) {
        ...
        @Override
        public FileStorageDriveGroupsAddResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            FileStorageDriveGroupsAddResponse.Builder resBuilder =
            ...
            FileStorageDriveGroupsAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCreateDriveGroupResponse(Utils.unmarshal(response, new TypeReference<CreateDriveGroupResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<FileStorageDriveGroupsAddRequest, com.apideck.unify.models.operations.async.FileStorageDriveGroupsAddResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(FileStorageDriveGroupsAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, FileStorageDriveGroupsAddRequest.class, new TypeReference<FileStorageDriveGroupsAddRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(FileStorageDriveGroupsAddRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.FileStorageDriveGroupsAddResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.FileStorageDriveGroupsAddResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.FileStorageDriveGroupsAddResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.FileStorageDriveGroupsAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CreateDriveGroupResponse>() {})
                            .thenApply(res::withCreateDriveGroupResponse);
                } else {
