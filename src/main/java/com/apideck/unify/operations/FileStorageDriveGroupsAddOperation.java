...
public class FileStorageDriveGroupsAddOperation implements RequestOperation<FileStorageDriveGroupsAddRequest, FileStorageDriveGroupsAddResponse> {
    ...
    public FileStorageDriveGroupsAddOperation(
    ...
    public HttpRequest buildRequest(FileStorageDriveGroupsAddRequest request) throws Exception {
