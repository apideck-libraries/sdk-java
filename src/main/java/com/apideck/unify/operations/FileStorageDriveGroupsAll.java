...
public class FileStorageDriveGroupsAll {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(FileStorageDriveGroupsAllRequest request) throws Exception {
        ...
        @Override
        public FileStorageDriveGroupsAllResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GetDriveGroupsResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGetDriveGroupsResponse(out);
                    return res;
                } else {
