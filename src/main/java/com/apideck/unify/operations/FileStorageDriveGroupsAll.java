...
public class FileStorageDriveGroupsAll {
    ...
    public static class Sync extends Base
            implements RequestOperation<FileStorageDriveGroupsAllRequest, FileStorageDriveGroupsAllResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(FileStorageDriveGroupsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, FileStorageDriveGroupsAllRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(FileStorageDriveGroupsAllRequest request) {
        ...
        @Override
        public FileStorageDriveGroupsAllResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            FileStorageDriveGroupsAllResponse.Builder resBuilder =
            ...
            FileStorageDriveGroupsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetDriveGroupsResponse(Utils.unmarshal(response, new TypeReference<GetDriveGroupsResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<FileStorageDriveGroupsAllRequest, com.apideck.unify.models.operations.async.FileStorageDriveGroupsAllResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(FileStorageDriveGroupsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, FileStorageDriveGroupsAllRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(FileStorageDriveGroupsAllRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.FileStorageDriveGroupsAllResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.FileStorageDriveGroupsAllResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.FileStorageDriveGroupsAllResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.FileStorageDriveGroupsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetDriveGroupsResponse>() {})
                            .thenApply(res::withGetDriveGroupsResponse);
                } else {
