...
public class FileStorageDriveGroupsAllOperation implements RequestOperation<FileStorageDriveGroupsAllRequest, FileStorageDriveGroupsAllResponse> {
    ...
    public FileStorageDriveGroupsAllOperation(
    ...
    public HttpRequest buildRequest(FileStorageDriveGroupsAllRequest request) throws Exception {
