...
public class FileStorageDriveGroupsDelete {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(FileStorageDriveGroupsDeleteRequest request) throws Exception {
        ...
        @Override
        public FileStorageDriveGroupsDeleteResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    DeleteDriveGroupResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withDeleteDriveGroupResponse(out);
                    return res;
                } else {
