...
public class FileStorageDriveGroupsDelete {
    ...
    public static class Sync extends Base
            implements RequestOperation<FileStorageDriveGroupsDeleteRequest, FileStorageDriveGroupsDeleteResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(FileStorageDriveGroupsDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, FileStorageDriveGroupsDeleteRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(FileStorageDriveGroupsDeleteRequest request) {
        ...
        @Override
        public FileStorageDriveGroupsDeleteResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            FileStorageDriveGroupsDeleteResponse.Builder resBuilder =
            ...
            FileStorageDriveGroupsDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDeleteDriveGroupResponse(Utils.unmarshal(response, new TypeReference<DeleteDriveGroupResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<FileStorageDriveGroupsDeleteRequest, com.apideck.unify.models.operations.async.FileStorageDriveGroupsDeleteResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(FileStorageDriveGroupsDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, FileStorageDriveGroupsDeleteRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(FileStorageDriveGroupsDeleteRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.FileStorageDriveGroupsDeleteResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.FileStorageDriveGroupsDeleteResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.FileStorageDriveGroupsDeleteResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.FileStorageDriveGroupsDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DeleteDriveGroupResponse>() {})
                            .thenApply(res::withDeleteDriveGroupResponse);
                } else {
