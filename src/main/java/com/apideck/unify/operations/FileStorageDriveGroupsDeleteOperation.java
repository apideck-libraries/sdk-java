...
public class FileStorageDriveGroupsDeleteOperation implements RequestOperation<FileStorageDriveGroupsDeleteRequest, FileStorageDriveGroupsDeleteResponse> {
    ...
    public FileStorageDriveGroupsDeleteOperation(
    ...
    public HttpRequest buildRequest(FileStorageDriveGroupsDeleteRequest request) throws Exception {
