...
public class FileStorageDriveGroupsOne {
    ...
    public static class Sync extends Base
            implements RequestOperation<FileStorageDriveGroupsOneRequest, FileStorageDriveGroupsOneResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(FileStorageDriveGroupsOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, FileStorageDriveGroupsOneRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(FileStorageDriveGroupsOneRequest request) {
        ...
        @Override
        public FileStorageDriveGroupsOneResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            FileStorageDriveGroupsOneResponse.Builder resBuilder =
            ...
            FileStorageDriveGroupsOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetDriveGroupResponse(Utils.unmarshal(response, new TypeReference<GetDriveGroupResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<FileStorageDriveGroupsOneRequest, com.apideck.unify.models.operations.async.FileStorageDriveGroupsOneResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(FileStorageDriveGroupsOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, FileStorageDriveGroupsOneRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(FileStorageDriveGroupsOneRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.FileStorageDriveGroupsOneResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.FileStorageDriveGroupsOneResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.FileStorageDriveGroupsOneResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.FileStorageDriveGroupsOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetDriveGroupResponse>() {})
                            .thenApply(res::withGetDriveGroupResponse);
                } else {
