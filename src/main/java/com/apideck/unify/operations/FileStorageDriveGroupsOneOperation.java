...
public class FileStorageDriveGroupsOneOperation implements RequestOperation<FileStorageDriveGroupsOneRequest, FileStorageDriveGroupsOneResponse> {
    ...
    public FileStorageDriveGroupsOneOperation(
    ...
    public HttpRequest buildRequest(FileStorageDriveGroupsOneRequest request) throws Exception {
