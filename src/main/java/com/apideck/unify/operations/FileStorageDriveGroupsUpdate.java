...
public class FileStorageDriveGroupsUpdate {
    ...
    public static class Sync extends Base
            implements RequestOperation<FileStorageDriveGroupsUpdateRequest, FileStorageDriveGroupsUpdateResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(FileStorageDriveGroupsUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, FileStorageDriveGroupsUpdateRequest.class, new TypeReference<FileStorageDriveGroupsUpdateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(FileStorageDriveGroupsUpdateRequest request) {
        ...
        @Override
        public FileStorageDriveGroupsUpdateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            FileStorageDriveGroupsUpdateResponse.Builder resBuilder =
            ...
            FileStorageDriveGroupsUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withUpdateDriveGroupResponse(Utils.unmarshal(response, new TypeReference<UpdateDriveGroupResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<FileStorageDriveGroupsUpdateRequest, com.apideck.unify.models.operations.async.FileStorageDriveGroupsUpdateResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(FileStorageDriveGroupsUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, FileStorageDriveGroupsUpdateRequest.class, new TypeReference<FileStorageDriveGroupsUpdateRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(FileStorageDriveGroupsUpdateRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.FileStorageDriveGroupsUpdateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.FileStorageDriveGroupsUpdateResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.FileStorageDriveGroupsUpdateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.FileStorageDriveGroupsUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<UpdateDriveGroupResponse>() {})
                            .thenApply(res::withUpdateDriveGroupResponse);
                } else {
