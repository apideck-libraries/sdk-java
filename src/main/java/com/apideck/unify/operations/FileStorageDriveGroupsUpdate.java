...
public class FileStorageDriveGroupsUpdate {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(FileStorageDriveGroupsUpdateRequest request) throws Exception {
        ...
        @Override
        public FileStorageDriveGroupsUpdateResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    UpdateDriveGroupResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withUpdateDriveGroupResponse(out);
                    return res;
                } else {
