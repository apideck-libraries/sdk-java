...
public class FileStorageDrivesAdd {
    ...
    public static class Sync extends Base
            implements RequestOperation<FileStorageDrivesAddRequest, FileStorageDrivesAddResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(FileStorageDrivesAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, FileStorageDrivesAddRequest.class, new TypeReference<FileStorageDrivesAddRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(FileStorageDrivesAddRequest request) {
        ...
        @Override
        public FileStorageDrivesAddResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            FileStorageDrivesAddResponse.Builder resBuilder =
            ...
            FileStorageDrivesAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCreateDriveResponse(Utils.unmarshal(response, new TypeReference<CreateDriveResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<FileStorageDrivesAddRequest, com.apideck.unify.models.operations.async.FileStorageDrivesAddResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(FileStorageDrivesAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, FileStorageDrivesAddRequest.class, new TypeReference<FileStorageDrivesAddRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(FileStorageDrivesAddRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.FileStorageDrivesAddResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.FileStorageDrivesAddResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.FileStorageDrivesAddResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.FileStorageDrivesAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CreateDriveResponse>() {})
                            .thenApply(res::withCreateDriveResponse);
                } else {
