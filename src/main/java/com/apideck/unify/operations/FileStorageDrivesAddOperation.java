...
public class FileStorageDrivesAddOperation implements RequestOperation<FileStorageDrivesAddRequest, FileStorageDrivesAddResponse> {
    ...
    public FileStorageDrivesAddOperation(
    ...
    public HttpRequest buildRequest(FileStorageDrivesAddRequest request) throws Exception {
