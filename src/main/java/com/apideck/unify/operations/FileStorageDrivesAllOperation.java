...
public class FileStorageDrivesAllOperation implements RequestOperation<FileStorageDrivesAllRequest, FileStorageDrivesAllResponse> {
    ...
    public FileStorageDrivesAllOperation(
    ...
    public HttpRequest buildRequest(FileStorageDrivesAllRequest request) throws Exception {
