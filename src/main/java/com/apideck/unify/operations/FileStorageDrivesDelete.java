...
public class FileStorageDrivesDelete {
    ...
    public static class Sync extends Base
            implements RequestOperation<FileStorageDrivesDeleteRequest, FileStorageDrivesDeleteResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(FileStorageDrivesDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, FileStorageDrivesDeleteRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(FileStorageDrivesDeleteRequest request) {
        ...
        @Override
        public FileStorageDrivesDeleteResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            FileStorageDrivesDeleteResponse.Builder resBuilder =
            ...
            FileStorageDrivesDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDeleteDriveResponse(Utils.unmarshal(response, new TypeReference<DeleteDriveResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<FileStorageDrivesDeleteRequest, com.apideck.unify.models.operations.async.FileStorageDrivesDeleteResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(FileStorageDrivesDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, FileStorageDrivesDeleteRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(FileStorageDrivesDeleteRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.FileStorageDrivesDeleteResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.FileStorageDrivesDeleteResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.FileStorageDrivesDeleteResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.FileStorageDrivesDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DeleteDriveResponse>() {})
                            .thenApply(res::withDeleteDriveResponse);
                } else {
