...
public class FileStorageDrivesDeleteOperation implements RequestOperation<FileStorageDrivesDeleteRequest, FileStorageDrivesDeleteResponse> {
    ...
    public FileStorageDrivesDeleteOperation(
    ...
    public HttpRequest buildRequest(FileStorageDrivesDeleteRequest request) throws Exception {
