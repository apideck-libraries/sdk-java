...
public class FileStorageDrivesOneOperation implements RequestOperation<FileStorageDrivesOneRequest, FileStorageDrivesOneResponse> {
    ...
    public FileStorageDrivesOneOperation(
    ...
    public HttpRequest buildRequest(FileStorageDrivesOneRequest request) throws Exception {
