...
public class FileStorageDrivesUpdate {
    ...
    public static class Sync extends Base
            implements RequestOperation<FileStorageDrivesUpdateRequest, FileStorageDrivesUpdateResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(FileStorageDrivesUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, FileStorageDrivesUpdateRequest.class, new TypeReference<FileStorageDrivesUpdateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(FileStorageDrivesUpdateRequest request) {
        ...
        @Override
        public FileStorageDrivesUpdateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            FileStorageDrivesUpdateResponse.Builder resBuilder =
            ...
            FileStorageDrivesUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withUpdateDriveResponse(Utils.unmarshal(response, new TypeReference<UpdateDriveResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<FileStorageDrivesUpdateRequest, com.apideck.unify.models.operations.async.FileStorageDrivesUpdateResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(FileStorageDrivesUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, FileStorageDrivesUpdateRequest.class, new TypeReference<FileStorageDrivesUpdateRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(FileStorageDrivesUpdateRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.FileStorageDrivesUpdateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.FileStorageDrivesUpdateResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.FileStorageDrivesUpdateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.FileStorageDrivesUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<UpdateDriveResponse>() {})
                            .thenApply(res::withUpdateDriveResponse);
                } else {
