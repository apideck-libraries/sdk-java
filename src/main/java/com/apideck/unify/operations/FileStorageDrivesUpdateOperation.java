...
public class FileStorageDrivesUpdateOperation implements RequestOperation<FileStorageDrivesUpdateRequest, FileStorageDrivesUpdateResponse> {
    ...
    public FileStorageDrivesUpdateOperation(
    ...
    public HttpRequest buildRequest(FileStorageDrivesUpdateRequest request) throws Exception {
