...
public class FileStorageFilesAll {
    ...
    public static class Sync extends Base
            implements RequestOperation<FileStorageFilesAllRequest, FileStorageFilesAllResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(FileStorageFilesAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, FileStorageFilesAllRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(FileStorageFilesAllRequest request) {
        ...
        @Override
        public FileStorageFilesAllResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            FileStorageFilesAllResponse.Builder resBuilder =
            ...
            FileStorageFilesAllResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<FileStorageFilesAllRequest, com.apideck.unify.models.operations.async.FileStorageFilesAllResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(FileStorageFilesAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, FileStorageFilesAllRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(FileStorageFilesAllRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.FileStorageFilesAllResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.FileStorageFilesAllResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.FileStorageFilesAllResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.FileStorageFilesAllResponse res = resBuilder.build();
