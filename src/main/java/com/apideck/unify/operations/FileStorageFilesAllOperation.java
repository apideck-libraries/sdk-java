...
public class FileStorageFilesAllOperation implements RequestOperation<FileStorageFilesAllRequest, FileStorageFilesAllResponse> {
    ...
    public FileStorageFilesAllOperation(
    ...
    public HttpRequest buildRequest(FileStorageFilesAllRequest request) throws Exception {
