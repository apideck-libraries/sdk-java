...
public class FileStorageFilesDelete {
    ...
    public static class Sync extends Base
            implements RequestOperation<FileStorageFilesDeleteRequest, FileStorageFilesDeleteResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(FileStorageFilesDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, FileStorageFilesDeleteRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(FileStorageFilesDeleteRequest request) {
        ...
        @Override
        public FileStorageFilesDeleteResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            FileStorageFilesDeleteResponse.Builder resBuilder =
            ...
            FileStorageFilesDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDeleteFileResponse(Utils.unmarshal(response, new TypeReference<DeleteFileResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<FileStorageFilesDeleteRequest, com.apideck.unify.models.operations.async.FileStorageFilesDeleteResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(FileStorageFilesDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, FileStorageFilesDeleteRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(FileStorageFilesDeleteRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.FileStorageFilesDeleteResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.FileStorageFilesDeleteResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.FileStorageFilesDeleteResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.FileStorageFilesDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DeleteFileResponse>() {})
                            .thenApply(res::withDeleteFileResponse);
                } else {
