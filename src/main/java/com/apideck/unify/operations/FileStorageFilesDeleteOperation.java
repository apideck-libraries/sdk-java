...
public class FileStorageFilesDeleteOperation implements RequestOperation<FileStorageFilesDeleteRequest, FileStorageFilesDeleteResponse> {
    ...
    public FileStorageFilesDeleteOperation(
    ...
    public HttpRequest buildRequest(FileStorageFilesDeleteRequest request) throws Exception {
