...
public class FileStorageFilesDownloadOperation implements RequestOperation<FileStorageFilesDownloadRequest, FileStorageFilesDownloadResponse> {
    ...
    public FileStorageFilesDownloadOperation(
    ...
    public HttpRequest buildRequest(FileStorageFilesDownloadRequest request) throws Exception {
