...
public class FileStorageFilesExport {
    ...
    public static class Sync extends Base
            implements RequestOperation<FileStorageFilesExportRequest, FileStorageFilesExportResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(FileStorageFilesExportRequest request) throws Exception {
            HttpRequest req = buildRequest(request, FileStorageFilesExportRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(FileStorageFilesExportRequest request) throws Exception {
        ...
        @Override
        public FileStorageFilesExportResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            FileStorageFilesExportResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200") && Utils.contentTypeMatches(contentType, "*/*")) {
                resBuilder.getFileDownloadResponse(response.body());
            }

            FileStorageFilesExportResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<FileStorageFilesExportRequest, com.apideck.unify.models.operations.async.FileStorageFilesExportResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(FileStorageFilesExportRequest request) throws Exception {
            HttpRequest req = buildRequest(request, FileStorageFilesExportRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(FileStorageFilesExportRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.FileStorageFilesExportResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.FileStorageFilesExportResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.FileStorageFilesExportResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
            ...
            com.apideck.unify.models.operations.async.FileStorageFilesExportResponse res = resBuilder.build();
