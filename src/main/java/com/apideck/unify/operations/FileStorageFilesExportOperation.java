...
public class FileStorageFilesExportOperation implements RequestOperation<FileStorageFilesExportRequest, FileStorageFilesExportResponse> {
    ...
    public FileStorageFilesExportOperation(
    ...
    public HttpRequest buildRequest(FileStorageFilesExportRequest request) throws Exception {
