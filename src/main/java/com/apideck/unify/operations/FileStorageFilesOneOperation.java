...
public class FileStorageFilesOneOperation implements RequestOperation<FileStorageFilesOneRequest, FileStorageFilesOneResponse> {
    ...
    public FileStorageFilesOneOperation(
    ...
    public HttpRequest buildRequest(FileStorageFilesOneRequest request) throws Exception {
