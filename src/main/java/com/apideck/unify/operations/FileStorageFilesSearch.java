...
public class FileStorageFilesSearch {
    ...
    public static class Sync extends Base
            implements RequestOperation<FileStorageFilesSearchRequest, FileStorageFilesSearchResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(FileStorageFilesSearchRequest request) throws Exception {
            HttpRequest req = buildRequest(request, FileStorageFilesSearchRequest.class, new TypeReference<FileStorageFilesSearchRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(FileStorageFilesSearchRequest request) {
        ...
        @Override
        public FileStorageFilesSearchResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            FileStorageFilesSearchResponse.Builder resBuilder =
            ...
            FileStorageFilesSearchResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetFilesResponse(Utils.unmarshal(response, new TypeReference<GetFilesResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<FileStorageFilesSearchRequest, com.apideck.unify.models.operations.async.FileStorageFilesSearchResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(FileStorageFilesSearchRequest request) throws Exception {
            HttpRequest req = buildRequest(request, FileStorageFilesSearchRequest.class, new TypeReference<FileStorageFilesSearchRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(FileStorageFilesSearchRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.FileStorageFilesSearchResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.FileStorageFilesSearchResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.FileStorageFilesSearchResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.FileStorageFilesSearchResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetFilesResponse>() {})
                            .thenApply(res::withGetFilesResponse);
                } else {
