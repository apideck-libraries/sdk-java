...
public class FileStorageFilesSearch {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(FileStorageFilesSearchRequest request) throws Exception {
        ...
        @Override
        public FileStorageFilesSearchResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GetFilesResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGetFilesResponse(out);
                    return res;
                } else {
