...
public class FileStorageFilesSearchOperation implements RequestOperation<FileStorageFilesSearchRequest, FileStorageFilesSearchResponse> {
    ...
    public FileStorageFilesSearchOperation(
    ...
    public HttpRequest buildRequest(FileStorageFilesSearchRequest request) throws Exception {
