...
public class FileStorageFilesUpdate {
    ...
    public static class Sync extends Base
        ...
        @Override
        public FileStorageFilesUpdateResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    UpdateFileResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withUpdateFileResponse(out);
                    return res;
                } else {
