...
public class FileStorageFilesUpdate {
    ...
    public static class Sync extends Base
            implements RequestOperation<FileStorageFilesUpdateRequest, FileStorageFilesUpdateResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(FileStorageFilesUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, FileStorageFilesUpdateRequest.class, new TypeReference<FileStorageFilesUpdateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(FileStorageFilesUpdateRequest request) {
        ...
        @Override
        public FileStorageFilesUpdateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            FileStorageFilesUpdateResponse.Builder resBuilder =
            ...
            FileStorageFilesUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withUpdateFileResponse(Utils.unmarshal(response, new TypeReference<UpdateFileResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<FileStorageFilesUpdateRequest, com.apideck.unify.models.operations.async.FileStorageFilesUpdateResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(FileStorageFilesUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, FileStorageFilesUpdateRequest.class, new TypeReference<FileStorageFilesUpdateRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(FileStorageFilesUpdateRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.FileStorageFilesUpdateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.FileStorageFilesUpdateResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.FileStorageFilesUpdateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.FileStorageFilesUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<UpdateFileResponse>() {})
                            .thenApply(res::withUpdateFileResponse);
                } else {
