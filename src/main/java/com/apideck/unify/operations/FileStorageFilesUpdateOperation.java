...
public class FileStorageFilesUpdateOperation implements RequestOperation<FileStorageFilesUpdateRequest, FileStorageFilesUpdateResponse> {
    ...
    public FileStorageFilesUpdateOperation(
    ...
    public HttpRequest buildRequest(FileStorageFilesUpdateRequest request) throws Exception {
