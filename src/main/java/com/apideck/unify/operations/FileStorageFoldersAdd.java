...
public class FileStorageFoldersAdd {
    ...
    public static class Sync extends Base
            implements RequestOperation<FileStorageFoldersAddRequest, FileStorageFoldersAddResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(FileStorageFoldersAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, FileStorageFoldersAddRequest.class, new TypeReference<FileStorageFoldersAddRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(FileStorageFoldersAddRequest request) {
        ...
        @Override
        public FileStorageFoldersAddResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            FileStorageFoldersAddResponse.Builder resBuilder =
            ...
            FileStorageFoldersAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCreateFolderResponse(Utils.unmarshal(response, new TypeReference<CreateFolderResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<FileStorageFoldersAddRequest, com.apideck.unify.models.operations.async.FileStorageFoldersAddResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(FileStorageFoldersAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, FileStorageFoldersAddRequest.class, new TypeReference<FileStorageFoldersAddRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(FileStorageFoldersAddRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.FileStorageFoldersAddResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.FileStorageFoldersAddResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.FileStorageFoldersAddResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.FileStorageFoldersAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CreateFolderResponse>() {})
                            .thenApply(res::withCreateFolderResponse);
                } else {
