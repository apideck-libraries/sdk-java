...
public class FileStorageFoldersAddOperation implements RequestOperation<FileStorageFoldersAddRequest, FileStorageFoldersAddResponse> {
    ...
    public FileStorageFoldersAddOperation(
    ...
    public HttpRequest buildRequest(FileStorageFoldersAddRequest request) throws Exception {
