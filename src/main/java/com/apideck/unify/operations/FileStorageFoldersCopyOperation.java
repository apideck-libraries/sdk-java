...
public class FileStorageFoldersCopyOperation implements RequestOperation<FileStorageFoldersCopyRequest, FileStorageFoldersCopyResponse> {
    ...
    public FileStorageFoldersCopyOperation(
    ...
    public HttpRequest buildRequest(FileStorageFoldersCopyRequest request) throws Exception {
