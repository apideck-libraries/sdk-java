...
public class FileStorageFoldersDelete {
    ...
    public static class Sync extends Base
            implements RequestOperation<FileStorageFoldersDeleteRequest, FileStorageFoldersDeleteResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(FileStorageFoldersDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, FileStorageFoldersDeleteRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(FileStorageFoldersDeleteRequest request) {
        ...
        @Override
        public FileStorageFoldersDeleteResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            FileStorageFoldersDeleteResponse.Builder resBuilder =
            ...
            FileStorageFoldersDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDeleteFolderResponse(Utils.unmarshal(response, new TypeReference<DeleteFolderResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<FileStorageFoldersDeleteRequest, com.apideck.unify.models.operations.async.FileStorageFoldersDeleteResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(FileStorageFoldersDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, FileStorageFoldersDeleteRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(FileStorageFoldersDeleteRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.FileStorageFoldersDeleteResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.FileStorageFoldersDeleteResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.FileStorageFoldersDeleteResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.FileStorageFoldersDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DeleteFolderResponse>() {})
                            .thenApply(res::withDeleteFolderResponse);
                } else {
