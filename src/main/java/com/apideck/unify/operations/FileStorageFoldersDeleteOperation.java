...
public class FileStorageFoldersDeleteOperation implements RequestOperation<FileStorageFoldersDeleteRequest, FileStorageFoldersDeleteResponse> {
    ...
    public FileStorageFoldersDeleteOperation(
    ...
    public HttpRequest buildRequest(FileStorageFoldersDeleteRequest request) throws Exception {
