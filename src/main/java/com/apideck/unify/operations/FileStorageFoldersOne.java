...
public class FileStorageFoldersOne {
    ...
    public static class Sync extends Base
            implements RequestOperation<FileStorageFoldersOneRequest, FileStorageFoldersOneResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(FileStorageFoldersOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, FileStorageFoldersOneRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(FileStorageFoldersOneRequest request) {
        ...
        @Override
        public FileStorageFoldersOneResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            FileStorageFoldersOneResponse.Builder resBuilder =
            ...
            FileStorageFoldersOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetFolderResponse(Utils.unmarshal(response, new TypeReference<GetFolderResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<FileStorageFoldersOneRequest, com.apideck.unify.models.operations.async.FileStorageFoldersOneResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(FileStorageFoldersOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, FileStorageFoldersOneRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(FileStorageFoldersOneRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.FileStorageFoldersOneResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.FileStorageFoldersOneResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.FileStorageFoldersOneResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.FileStorageFoldersOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetFolderResponse>() {})
                            .thenApply(res::withGetFolderResponse);
                } else {
