...
public class FileStorageFoldersOneOperation implements RequestOperation<FileStorageFoldersOneRequest, FileStorageFoldersOneResponse> {
    ...
    public FileStorageFoldersOneOperation(
    ...
    public HttpRequest buildRequest(FileStorageFoldersOneRequest request) throws Exception {
