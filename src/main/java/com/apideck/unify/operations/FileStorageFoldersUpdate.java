...
public class FileStorageFoldersUpdate {
    ...
    public static class Sync extends Base
            implements RequestOperation<FileStorageFoldersUpdateRequest, FileStorageFoldersUpdateResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(FileStorageFoldersUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, FileStorageFoldersUpdateRequest.class, new TypeReference<FileStorageFoldersUpdateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(FileStorageFoldersUpdateRequest request) {
        ...
        @Override
        public FileStorageFoldersUpdateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            FileStorageFoldersUpdateResponse.Builder resBuilder =
            ...
            FileStorageFoldersUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withUpdateFolderResponse(Utils.unmarshal(response, new TypeReference<UpdateFolderResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<FileStorageFoldersUpdateRequest, com.apideck.unify.models.operations.async.FileStorageFoldersUpdateResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(FileStorageFoldersUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, FileStorageFoldersUpdateRequest.class, new TypeReference<FileStorageFoldersUpdateRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(FileStorageFoldersUpdateRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.FileStorageFoldersUpdateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.FileStorageFoldersUpdateResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.FileStorageFoldersUpdateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.FileStorageFoldersUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<UpdateFolderResponse>() {})
                            .thenApply(res::withUpdateFolderResponse);
                } else {
