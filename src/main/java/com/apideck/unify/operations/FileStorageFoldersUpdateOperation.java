...
public class FileStorageFoldersUpdateOperation implements RequestOperation<FileStorageFoldersUpdateRequest, FileStorageFoldersUpdateResponse> {
    ...
    public FileStorageFoldersUpdateOperation(
    ...
    public HttpRequest buildRequest(FileStorageFoldersUpdateRequest request) throws Exception {
