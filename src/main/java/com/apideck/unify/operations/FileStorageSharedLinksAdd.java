...
public class FileStorageSharedLinksAdd {
    ...
    public static class Sync extends Base
            implements RequestOperation<FileStorageSharedLinksAddRequest, FileStorageSharedLinksAddResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(FileStorageSharedLinksAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, FileStorageSharedLinksAddRequest.class, new TypeReference<FileStorageSharedLinksAddRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(FileStorageSharedLinksAddRequest request) {
        ...
        @Override
        public FileStorageSharedLinksAddResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            FileStorageSharedLinksAddResponse.Builder resBuilder =
            ...
            FileStorageSharedLinksAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCreateSharedLinkResponse(Utils.unmarshal(response, new TypeReference<CreateSharedLinkResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<FileStorageSharedLinksAddRequest, com.apideck.unify.models.operations.async.FileStorageSharedLinksAddResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(FileStorageSharedLinksAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, FileStorageSharedLinksAddRequest.class, new TypeReference<FileStorageSharedLinksAddRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(FileStorageSharedLinksAddRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.FileStorageSharedLinksAddResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.FileStorageSharedLinksAddResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.FileStorageSharedLinksAddResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.FileStorageSharedLinksAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CreateSharedLinkResponse>() {})
                            .thenApply(res::withCreateSharedLinkResponse);
                } else {
