...
public class FileStorageSharedLinksAdd {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(FileStorageSharedLinksAddRequest request) throws Exception {
        ...
        @Override
        public FileStorageSharedLinksAddResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    CreateSharedLinkResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCreateSharedLinkResponse(out);
                    return res;
                } else {
