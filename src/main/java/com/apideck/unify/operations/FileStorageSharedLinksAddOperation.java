...
public class FileStorageSharedLinksAddOperation implements RequestOperation<FileStorageSharedLinksAddRequest, FileStorageSharedLinksAddResponse> {
    ...
    public FileStorageSharedLinksAddOperation(
    ...
    public HttpRequest buildRequest(FileStorageSharedLinksAddRequest request) throws Exception {
