...
public class FileStorageSharedLinksAll {
    ...
    public static class Sync extends Base
            implements RequestOperation<FileStorageSharedLinksAllRequest, FileStorageSharedLinksAllResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(FileStorageSharedLinksAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, FileStorageSharedLinksAllRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(FileStorageSharedLinksAllRequest request) {
        ...
        @Override
        public FileStorageSharedLinksAllResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            FileStorageSharedLinksAllResponse.Builder resBuilder =
            ...
            FileStorageSharedLinksAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetSharedLinksResponse(Utils.unmarshal(response, new TypeReference<GetSharedLinksResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<FileStorageSharedLinksAllRequest, com.apideck.unify.models.operations.async.FileStorageSharedLinksAllResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(FileStorageSharedLinksAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, FileStorageSharedLinksAllRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(FileStorageSharedLinksAllRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.FileStorageSharedLinksAllResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.FileStorageSharedLinksAllResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.FileStorageSharedLinksAllResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.FileStorageSharedLinksAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetSharedLinksResponse>() {})
                            .thenApply(res::withGetSharedLinksResponse);
                } else {
