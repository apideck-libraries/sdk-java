...
public class FileStorageSharedLinksAll {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(FileStorageSharedLinksAllRequest request) throws Exception {
        ...
        @Override
        public FileStorageSharedLinksAllResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GetSharedLinksResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGetSharedLinksResponse(out);
                    return res;
                } else {
