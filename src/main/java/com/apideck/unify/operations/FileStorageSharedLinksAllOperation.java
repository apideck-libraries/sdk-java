...
public class FileStorageSharedLinksAllOperation implements RequestOperation<FileStorageSharedLinksAllRequest, FileStorageSharedLinksAllResponse> {
    ...
    public FileStorageSharedLinksAllOperation(
    ...
    public HttpRequest buildRequest(FileStorageSharedLinksAllRequest request) throws Exception {
