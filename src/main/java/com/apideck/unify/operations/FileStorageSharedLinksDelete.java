...
public class FileStorageSharedLinksDelete {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(FileStorageSharedLinksDeleteRequest request) throws Exception {
        ...
        @Override
        public FileStorageSharedLinksDeleteResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    DeleteSharedLinkResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withDeleteSharedLinkResponse(out);
                    return res;
                } else {
