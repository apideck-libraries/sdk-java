...
public class FileStorageSharedLinksDelete {
    ...
    public static class Sync extends Base
            implements RequestOperation<FileStorageSharedLinksDeleteRequest, FileStorageSharedLinksDeleteResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(FileStorageSharedLinksDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, FileStorageSharedLinksDeleteRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(FileStorageSharedLinksDeleteRequest request) {
        ...
        @Override
        public FileStorageSharedLinksDeleteResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            FileStorageSharedLinksDeleteResponse.Builder resBuilder =
            ...
            FileStorageSharedLinksDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDeleteSharedLinkResponse(Utils.unmarshal(response, new TypeReference<DeleteSharedLinkResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<FileStorageSharedLinksDeleteRequest, com.apideck.unify.models.operations.async.FileStorageSharedLinksDeleteResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(FileStorageSharedLinksDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, FileStorageSharedLinksDeleteRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(FileStorageSharedLinksDeleteRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.FileStorageSharedLinksDeleteResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.FileStorageSharedLinksDeleteResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.FileStorageSharedLinksDeleteResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.FileStorageSharedLinksDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DeleteSharedLinkResponse>() {})
                            .thenApply(res::withDeleteSharedLinkResponse);
                } else {
