...
public class FileStorageSharedLinksOne {
    ...
    public static class Sync extends Base
            implements RequestOperation<FileStorageSharedLinksOneRequest, FileStorageSharedLinksOneResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(FileStorageSharedLinksOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, FileStorageSharedLinksOneRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(FileStorageSharedLinksOneRequest request) {
        ...
        @Override
        public FileStorageSharedLinksOneResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            FileStorageSharedLinksOneResponse.Builder resBuilder =
            ...
            FileStorageSharedLinksOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetSharedLinkResponse(Utils.unmarshal(response, new TypeReference<GetSharedLinkResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<FileStorageSharedLinksOneRequest, com.apideck.unify.models.operations.async.FileStorageSharedLinksOneResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(FileStorageSharedLinksOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, FileStorageSharedLinksOneRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(FileStorageSharedLinksOneRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.FileStorageSharedLinksOneResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.FileStorageSharedLinksOneResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.FileStorageSharedLinksOneResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.FileStorageSharedLinksOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetSharedLinkResponse>() {})
                            .thenApply(res::withGetSharedLinkResponse);
                } else {
