...
public class FileStorageSharedLinksOne {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(FileStorageSharedLinksOneRequest request) throws Exception {
        ...
        @Override
        public FileStorageSharedLinksOneResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GetSharedLinkResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGetSharedLinkResponse(out);
                    return res;
                } else {
