...
public class FileStorageSharedLinksOneOperation implements RequestOperation<FileStorageSharedLinksOneRequest, FileStorageSharedLinksOneResponse> {
    ...
    public FileStorageSharedLinksOneOperation(
    ...
    public HttpRequest buildRequest(FileStorageSharedLinksOneRequest request) throws Exception {
