...
public class FileStorageSharedLinksUpdate {
    ...
    public static class Sync extends Base
        ...
        @Override
        public FileStorageSharedLinksUpdateResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    UpdateSharedLinkResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withUpdateSharedLinkResponse(out);
                    return res;
                } else {
