...
public class FileStorageSharedLinksUpdate {
    ...
    public static class Sync extends Base
            implements RequestOperation<FileStorageSharedLinksUpdateRequest, FileStorageSharedLinksUpdateResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(FileStorageSharedLinksUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, FileStorageSharedLinksUpdateRequest.class, new TypeReference<FileStorageSharedLinksUpdateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(FileStorageSharedLinksUpdateRequest request) {
        ...
        @Override
        public FileStorageSharedLinksUpdateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            FileStorageSharedLinksUpdateResponse.Builder resBuilder =
            ...
            FileStorageSharedLinksUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withUpdateSharedLinkResponse(Utils.unmarshal(response, new TypeReference<UpdateSharedLinkResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<FileStorageSharedLinksUpdateRequest, com.apideck.unify.models.operations.async.FileStorageSharedLinksUpdateResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(FileStorageSharedLinksUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, FileStorageSharedLinksUpdateRequest.class, new TypeReference<FileStorageSharedLinksUpdateRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(FileStorageSharedLinksUpdateRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.FileStorageSharedLinksUpdateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.FileStorageSharedLinksUpdateResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.FileStorageSharedLinksUpdateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.FileStorageSharedLinksUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<UpdateSharedLinkResponse>() {})
                            .thenApply(res::withUpdateSharedLinkResponse);
                } else {
