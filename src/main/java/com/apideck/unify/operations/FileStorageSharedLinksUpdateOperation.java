...
public class FileStorageSharedLinksUpdateOperation implements RequestOperation<FileStorageSharedLinksUpdateRequest, FileStorageSharedLinksUpdateResponse> {
    ...
    public FileStorageSharedLinksUpdateOperation(
    ...
    public HttpRequest buildRequest(FileStorageSharedLinksUpdateRequest request) throws Exception {
