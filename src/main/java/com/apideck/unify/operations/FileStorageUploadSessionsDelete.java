...
public class FileStorageUploadSessionsDelete {
    ...
    public static class Sync extends Base
            implements RequestOperation<FileStorageUploadSessionsDeleteRequest, FileStorageUploadSessionsDeleteResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(FileStorageUploadSessionsDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, FileStorageUploadSessionsDeleteRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(FileStorageUploadSessionsDeleteRequest request) {
        ...
        @Override
        public FileStorageUploadSessionsDeleteResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            FileStorageUploadSessionsDeleteResponse.Builder resBuilder =
            ...
            FileStorageUploadSessionsDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDeleteUploadSessionResponse(Utils.unmarshal(response, new TypeReference<DeleteUploadSessionResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<FileStorageUploadSessionsDeleteRequest, com.apideck.unify.models.operations.async.FileStorageUploadSessionsDeleteResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(FileStorageUploadSessionsDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, FileStorageUploadSessionsDeleteRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(FileStorageUploadSessionsDeleteRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.FileStorageUploadSessionsDeleteResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.FileStorageUploadSessionsDeleteResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.FileStorageUploadSessionsDeleteResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.FileStorageUploadSessionsDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DeleteUploadSessionResponse>() {})
                            .thenApply(res::withDeleteUploadSessionResponse);
                } else {
