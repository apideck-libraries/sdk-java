...
public class FileStorageUploadSessionsFinishOperation implements RequestOperation<FileStorageUploadSessionsFinishRequest, FileStorageUploadSessionsFinishResponse> {
    ...
    public FileStorageUploadSessionsFinishOperation(
    ...
    public HttpRequest buildRequest(FileStorageUploadSessionsFinishRequest request) throws Exception {
