...
public class FileStorageUploadSessionsOneOperation implements RequestOperation<FileStorageUploadSessionsOneRequest, FileStorageUploadSessionsOneResponse> {
    ...
    public HttpRequest buildRequest(FileStorageUploadSessionsOneRequest request) throws Exception {
