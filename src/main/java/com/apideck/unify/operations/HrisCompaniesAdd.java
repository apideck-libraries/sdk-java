...
public class HrisCompaniesAdd {
    ...
    public static class Sync extends Base
            implements RequestOperation<HrisCompaniesAddRequest, HrisCompaniesAddResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(HrisCompaniesAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisCompaniesAddRequest.class, new TypeReference<HrisCompaniesAddRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisCompaniesAddRequest request) {
        ...
        @Override
        public HrisCompaniesAddResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            HrisCompaniesAddResponse.Builder resBuilder =
            ...
            HrisCompaniesAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCreateHrisCompanyResponse(Utils.unmarshal(response, new TypeReference<CreateHrisCompanyResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HrisCompaniesAddRequest, com.apideck.unify.models.operations.async.HrisCompaniesAddResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HrisCompaniesAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisCompaniesAddRequest.class, new TypeReference<HrisCompaniesAddRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HrisCompaniesAddRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.HrisCompaniesAddResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.HrisCompaniesAddResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.HrisCompaniesAddResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.HrisCompaniesAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CreateHrisCompanyResponse>() {})
                            .thenApply(res::withCreateHrisCompanyResponse);
                } else {
