...
public class HrisCompaniesAdd {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisCompaniesAddRequest request) throws Exception {
        ...
        @Override
        public HrisCompaniesAddResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    CreateHrisCompanyResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCreateHrisCompanyResponse(out);
                    return res;
                } else {
