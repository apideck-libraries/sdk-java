...
public class HrisCompaniesAddOperation implements RequestOperation<HrisCompaniesAddRequest, HrisCompaniesAddResponse> {
    ...
    public HrisCompaniesAddOperation(
    ...
    public HttpRequest buildRequest(HrisCompaniesAddRequest request) throws Exception {
