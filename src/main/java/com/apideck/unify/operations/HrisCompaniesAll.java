...
public class HrisCompaniesAll {
        ...
        public HrisCompaniesAllResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetHrisCompaniesResponse(Utils.unmarshal(response, new TypeReference<GetHrisCompaniesResponse>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        public CompletableFuture<com.apideck.unify.models.operations.async.HrisCompaniesAllResponse> handleResponse(
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetHrisCompaniesResponse>() {})
                            .thenApply(res::withGetHrisCompaniesResponse);
                } else {
