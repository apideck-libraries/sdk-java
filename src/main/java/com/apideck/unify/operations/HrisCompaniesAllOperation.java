...
public class HrisCompaniesAllOperation implements RequestOperation<HrisCompaniesAllRequest, HrisCompaniesAllResponse> {
    ...
    public HrisCompaniesAllOperation(
    ...
    public HttpRequest buildRequest(HrisCompaniesAllRequest request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(HrisCompaniesAllRequest request) throws Exception {
    ...
    @Override
    public HrisCompaniesAllResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        ...
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                GetHrisCompaniesResponse out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withGetHrisCompaniesResponse(out);
                return res;
            } else {
