...
public class HrisCompaniesDelete {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HrisCompaniesDeleteResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    DeleteHrisCompanyResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withDeleteHrisCompanyResponse(out);
                    return res;
                } else {
