...
public class HrisCompaniesDelete {
    ...
    public static class Sync extends Base
            implements RequestOperation<HrisCompaniesDeleteRequest, HrisCompaniesDeleteResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(HrisCompaniesDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisCompaniesDeleteRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisCompaniesDeleteRequest request) {
        ...
        @Override
        public HrisCompaniesDeleteResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            HrisCompaniesDeleteResponse.Builder resBuilder =
            ...
            HrisCompaniesDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDeleteHrisCompanyResponse(Utils.unmarshal(response, new TypeReference<DeleteHrisCompanyResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HrisCompaniesDeleteRequest, com.apideck.unify.models.operations.async.HrisCompaniesDeleteResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HrisCompaniesDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisCompaniesDeleteRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HrisCompaniesDeleteRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.HrisCompaniesDeleteResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.HrisCompaniesDeleteResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.HrisCompaniesDeleteResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.HrisCompaniesDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DeleteHrisCompanyResponse>() {})
                            .thenApply(res::withDeleteHrisCompanyResponse);
                } else {
