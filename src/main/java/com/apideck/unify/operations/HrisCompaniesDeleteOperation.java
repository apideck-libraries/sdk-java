...
public class HrisCompaniesDeleteOperation implements RequestOperation<HrisCompaniesDeleteRequest, HrisCompaniesDeleteResponse> {
    ...
    public HrisCompaniesDeleteOperation(
    ...
    public HttpRequest buildRequest(HrisCompaniesDeleteRequest request) throws Exception {
