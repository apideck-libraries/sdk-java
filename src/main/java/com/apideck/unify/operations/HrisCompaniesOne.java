...
public class HrisCompaniesOne {
    ...
    public static class Sync extends Base
            implements RequestOperation<HrisCompaniesOneRequest, HrisCompaniesOneResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(HrisCompaniesOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisCompaniesOneRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisCompaniesOneRequest request) {
        ...
        @Override
        public HrisCompaniesOneResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            HrisCompaniesOneResponse.Builder resBuilder =
            ...
            HrisCompaniesOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetHrisCompanyResponse(Utils.unmarshal(response, new TypeReference<GetHrisCompanyResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HrisCompaniesOneRequest, com.apideck.unify.models.operations.async.HrisCompaniesOneResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HrisCompaniesOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisCompaniesOneRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HrisCompaniesOneRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.HrisCompaniesOneResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.HrisCompaniesOneResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.HrisCompaniesOneResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.HrisCompaniesOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetHrisCompanyResponse>() {})
                            .thenApply(res::withGetHrisCompanyResponse);
                } else {
