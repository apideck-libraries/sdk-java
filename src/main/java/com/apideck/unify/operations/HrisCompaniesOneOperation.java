...
public class HrisCompaniesOneOperation implements RequestOperation<HrisCompaniesOneRequest, HrisCompaniesOneResponse> {
    ...
    public HrisCompaniesOneOperation(
    ...
    public HttpRequest buildRequest(HrisCompaniesOneRequest request) throws Exception {
