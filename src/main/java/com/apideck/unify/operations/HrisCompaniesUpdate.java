...
public class HrisCompaniesUpdate {
    ...
    public static class Sync extends Base
            implements RequestOperation<HrisCompaniesUpdateRequest, HrisCompaniesUpdateResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(HrisCompaniesUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisCompaniesUpdateRequest.class, new TypeReference<HrisCompaniesUpdateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisCompaniesUpdateRequest request) {
        ...
        @Override
        public HrisCompaniesUpdateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            HrisCompaniesUpdateResponse.Builder resBuilder =
            ...
            HrisCompaniesUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withUpdateHrisCompanyResponse(Utils.unmarshal(response, new TypeReference<UpdateHrisCompanyResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HrisCompaniesUpdateRequest, com.apideck.unify.models.operations.async.HrisCompaniesUpdateResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HrisCompaniesUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisCompaniesUpdateRequest.class, new TypeReference<HrisCompaniesUpdateRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HrisCompaniesUpdateRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.HrisCompaniesUpdateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.HrisCompaniesUpdateResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.HrisCompaniesUpdateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.HrisCompaniesUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<UpdateHrisCompanyResponse>() {})
                            .thenApply(res::withUpdateHrisCompanyResponse);
                } else {
