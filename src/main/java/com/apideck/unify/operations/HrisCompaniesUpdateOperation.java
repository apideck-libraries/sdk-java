...
public class HrisCompaniesUpdateOperation implements RequestOperation<HrisCompaniesUpdateRequest, HrisCompaniesUpdateResponse> {
    ...
    public HrisCompaniesUpdateOperation(
    ...
    public HttpRequest buildRequest(HrisCompaniesUpdateRequest request) throws Exception {
