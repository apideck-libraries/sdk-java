...
public class HrisDepartmentsAdd {
    ...
    public static class Sync extends Base
            implements RequestOperation<HrisDepartmentsAddRequest, HrisDepartmentsAddResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(HrisDepartmentsAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisDepartmentsAddRequest.class, new TypeReference<HrisDepartmentsAddRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisDepartmentsAddRequest request) {
        ...
        @Override
        public HrisDepartmentsAddResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            HrisDepartmentsAddResponse.Builder resBuilder =
            ...
            HrisDepartmentsAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCreateDepartmentResponse(Utils.unmarshal(response, new TypeReference<CreateDepartmentResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HrisDepartmentsAddRequest, com.apideck.unify.models.operations.async.HrisDepartmentsAddResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HrisDepartmentsAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisDepartmentsAddRequest.class, new TypeReference<HrisDepartmentsAddRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HrisDepartmentsAddRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.HrisDepartmentsAddResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.HrisDepartmentsAddResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.HrisDepartmentsAddResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.HrisDepartmentsAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CreateDepartmentResponse>() {})
                            .thenApply(res::withCreateDepartmentResponse);
                } else {
