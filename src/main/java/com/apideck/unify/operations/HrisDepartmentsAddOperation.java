...
public class HrisDepartmentsAddOperation implements RequestOperation<HrisDepartmentsAddRequest, HrisDepartmentsAddResponse> {
    ...
    public HrisDepartmentsAddOperation(
    ...
    public HttpRequest buildRequest(HrisDepartmentsAddRequest request) throws Exception {
