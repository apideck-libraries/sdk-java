...
public class HrisDepartmentsAll {
    ...
    public static class Sync extends Base
            implements RequestOperation<HrisDepartmentsAllRequest, HrisDepartmentsAllResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(HrisDepartmentsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisDepartmentsAllRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisDepartmentsAllRequest request) {
        ...
        @Override
        public HrisDepartmentsAllResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            HrisDepartmentsAllResponse.Builder resBuilder =
            ...
            HrisDepartmentsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetDepartmentsResponse(Utils.unmarshal(response, new TypeReference<GetDepartmentsResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HrisDepartmentsAllRequest, com.apideck.unify.models.operations.async.HrisDepartmentsAllResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HrisDepartmentsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisDepartmentsAllRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HrisDepartmentsAllRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.HrisDepartmentsAllResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.HrisDepartmentsAllResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.HrisDepartmentsAllResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.HrisDepartmentsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetDepartmentsResponse>() {})
                            .thenApply(res::withGetDepartmentsResponse);
                } else {
