...
public class HrisDepartmentsAllOperation implements RequestOperation<HrisDepartmentsAllRequest, HrisDepartmentsAllResponse> {
    ...
    public HrisDepartmentsAllOperation(
    ...
    public HttpRequest buildRequest(HrisDepartmentsAllRequest request) throws Exception {
