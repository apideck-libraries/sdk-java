...
public class HrisDepartmentsDelete {
    ...
    public static class Sync extends Base
            implements RequestOperation<HrisDepartmentsDeleteRequest, HrisDepartmentsDeleteResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(HrisDepartmentsDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisDepartmentsDeleteRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisDepartmentsDeleteRequest request) {
        ...
        @Override
        public HrisDepartmentsDeleteResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            HrisDepartmentsDeleteResponse.Builder resBuilder =
            ...
            HrisDepartmentsDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDeleteDepartmentResponse(Utils.unmarshal(response, new TypeReference<DeleteDepartmentResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HrisDepartmentsDeleteRequest, com.apideck.unify.models.operations.async.HrisDepartmentsDeleteResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HrisDepartmentsDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisDepartmentsDeleteRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HrisDepartmentsDeleteRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.HrisDepartmentsDeleteResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.HrisDepartmentsDeleteResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.HrisDepartmentsDeleteResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.HrisDepartmentsDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DeleteDepartmentResponse>() {})
                            .thenApply(res::withDeleteDepartmentResponse);
                } else {
