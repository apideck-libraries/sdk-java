...
public class HrisDepartmentsDeleteOperation implements RequestOperation<HrisDepartmentsDeleteRequest, HrisDepartmentsDeleteResponse> {
    ...
    public HrisDepartmentsDeleteOperation(
    ...
    public HttpRequest buildRequest(HrisDepartmentsDeleteRequest request) throws Exception {
