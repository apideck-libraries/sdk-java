...
public class HrisDepartmentsOne {
    ...
    public static class Sync extends Base
            implements RequestOperation<HrisDepartmentsOneRequest, HrisDepartmentsOneResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(HrisDepartmentsOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisDepartmentsOneRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisDepartmentsOneRequest request) {
        ...
        @Override
        public HrisDepartmentsOneResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            HrisDepartmentsOneResponse.Builder resBuilder =
            ...
            HrisDepartmentsOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetDepartmentResponse(Utils.unmarshal(response, new TypeReference<GetDepartmentResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HrisDepartmentsOneRequest, com.apideck.unify.models.operations.async.HrisDepartmentsOneResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HrisDepartmentsOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisDepartmentsOneRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HrisDepartmentsOneRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.HrisDepartmentsOneResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.HrisDepartmentsOneResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.HrisDepartmentsOneResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.HrisDepartmentsOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetDepartmentResponse>() {})
                            .thenApply(res::withGetDepartmentResponse);
                } else {
