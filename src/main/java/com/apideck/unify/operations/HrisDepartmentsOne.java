...
public class HrisDepartmentsOne {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisDepartmentsOneRequest request) throws Exception {
        ...
        @Override
        public HrisDepartmentsOneResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GetDepartmentResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGetDepartmentResponse(out);
                    return res;
                } else {
