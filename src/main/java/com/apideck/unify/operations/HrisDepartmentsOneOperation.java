...
public class HrisDepartmentsOneOperation implements RequestOperation<HrisDepartmentsOneRequest, HrisDepartmentsOneResponse> {
    ...
    public HrisDepartmentsOneOperation(
    ...
    public HttpRequest buildRequest(HrisDepartmentsOneRequest request) throws Exception {
