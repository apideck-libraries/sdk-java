...
public class HrisDepartmentsUpdate {
    ...
    public static class Sync extends Base
            implements RequestOperation<HrisDepartmentsUpdateRequest, HrisDepartmentsUpdateResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(HrisDepartmentsUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisDepartmentsUpdateRequest.class, new TypeReference<HrisDepartmentsUpdateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisDepartmentsUpdateRequest request) {
        ...
        @Override
        public HrisDepartmentsUpdateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            HrisDepartmentsUpdateResponse.Builder resBuilder =
            ...
            HrisDepartmentsUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withUpdateDepartmentResponse(Utils.unmarshal(response, new TypeReference<UpdateDepartmentResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HrisDepartmentsUpdateRequest, com.apideck.unify.models.operations.async.HrisDepartmentsUpdateResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HrisDepartmentsUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisDepartmentsUpdateRequest.class, new TypeReference<HrisDepartmentsUpdateRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HrisDepartmentsUpdateRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.HrisDepartmentsUpdateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.HrisDepartmentsUpdateResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.HrisDepartmentsUpdateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.HrisDepartmentsUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<UpdateDepartmentResponse>() {})
                            .thenApply(res::withUpdateDepartmentResponse);
                } else {
