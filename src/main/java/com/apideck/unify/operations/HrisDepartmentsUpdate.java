...
public class HrisDepartmentsUpdate {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HrisDepartmentsUpdateResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    UpdateDepartmentResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withUpdateDepartmentResponse(out);
                    return res;
                } else {
