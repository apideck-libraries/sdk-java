...
public class HrisDepartmentsUpdateOperation implements RequestOperation<HrisDepartmentsUpdateRequest, HrisDepartmentsUpdateResponse> {
    ...
    public HrisDepartmentsUpdateOperation(
    ...
    public HttpRequest buildRequest(HrisDepartmentsUpdateRequest request) throws Exception {
