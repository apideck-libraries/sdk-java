...
public class HrisEmployeePayrollsAll {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisEmployeePayrollsAllRequest request) throws Exception {
        ...
        @Override
        public HrisEmployeePayrollsAllResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GetEmployeePayrollsResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGetEmployeePayrollsResponse(out);
                    return res;
                } else {
