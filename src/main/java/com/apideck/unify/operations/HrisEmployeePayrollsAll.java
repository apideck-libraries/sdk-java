...
public class HrisEmployeePayrollsAll {
    ...
    public static class Sync extends Base
            implements RequestOperation<HrisEmployeePayrollsAllRequest, HrisEmployeePayrollsAllResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(HrisEmployeePayrollsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisEmployeePayrollsAllRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisEmployeePayrollsAllRequest request) {
        ...
        @Override
        public HrisEmployeePayrollsAllResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            HrisEmployeePayrollsAllResponse.Builder resBuilder =
            ...
            HrisEmployeePayrollsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetEmployeePayrollsResponse(Utils.unmarshal(response, new TypeReference<GetEmployeePayrollsResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HrisEmployeePayrollsAllRequest, com.apideck.unify.models.operations.async.HrisEmployeePayrollsAllResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HrisEmployeePayrollsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisEmployeePayrollsAllRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HrisEmployeePayrollsAllRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.HrisEmployeePayrollsAllResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.HrisEmployeePayrollsAllResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.HrisEmployeePayrollsAllResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.HrisEmployeePayrollsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetEmployeePayrollsResponse>() {})
                            .thenApply(res::withGetEmployeePayrollsResponse);
                } else {
