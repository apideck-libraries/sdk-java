...
public class HrisEmployeePayrollsAllOperation implements RequestOperation<HrisEmployeePayrollsAllRequest, HrisEmployeePayrollsAllResponse> {
    ...
    public HrisEmployeePayrollsAllOperation(
    ...
    public HttpRequest buildRequest(HrisEmployeePayrollsAllRequest request) throws Exception {
