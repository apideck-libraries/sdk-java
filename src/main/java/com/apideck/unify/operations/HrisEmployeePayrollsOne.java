...
public class HrisEmployeePayrollsOne {
    ...
    public static class Sync extends Base
            implements RequestOperation<HrisEmployeePayrollsOneRequest, HrisEmployeePayrollsOneResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(HrisEmployeePayrollsOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisEmployeePayrollsOneRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisEmployeePayrollsOneRequest request) {
        ...
        @Override
        public HrisEmployeePayrollsOneResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            HrisEmployeePayrollsOneResponse.Builder resBuilder =
            ...
            HrisEmployeePayrollsOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetEmployeePayrollResponse(Utils.unmarshal(response, new TypeReference<GetEmployeePayrollResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HrisEmployeePayrollsOneRequest, com.apideck.unify.models.operations.async.HrisEmployeePayrollsOneResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HrisEmployeePayrollsOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisEmployeePayrollsOneRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HrisEmployeePayrollsOneRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.HrisEmployeePayrollsOneResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.HrisEmployeePayrollsOneResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.HrisEmployeePayrollsOneResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.HrisEmployeePayrollsOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetEmployeePayrollResponse>() {})
                            .thenApply(res::withGetEmployeePayrollResponse);
                } else {
