...
public class HrisEmployeePayrollsOne {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisEmployeePayrollsOneRequest request) throws Exception {
        ...
        @Override
        public HrisEmployeePayrollsOneResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GetEmployeePayrollResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGetEmployeePayrollResponse(out);
                    return res;
                } else {
