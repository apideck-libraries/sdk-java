...
public class HrisEmployeePayrollsOneOperation implements RequestOperation<HrisEmployeePayrollsOneRequest, HrisEmployeePayrollsOneResponse> {
    ...
    public HrisEmployeePayrollsOneOperation(
    ...
    public HttpRequest buildRequest(HrisEmployeePayrollsOneRequest request) throws Exception {
