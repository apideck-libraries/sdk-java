...
public class HrisEmployeeSchedulesAll {
    ...
    public static class Sync extends Base
            implements RequestOperation<HrisEmployeeSchedulesAllRequest, HrisEmployeeSchedulesAllResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(HrisEmployeeSchedulesAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisEmployeeSchedulesAllRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisEmployeeSchedulesAllRequest request) {
        ...
        @Override
        public HrisEmployeeSchedulesAllResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            HrisEmployeeSchedulesAllResponse.Builder resBuilder =
            ...
            HrisEmployeeSchedulesAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetEmployeeSchedulesResponse(Utils.unmarshal(response, new TypeReference<GetEmployeeSchedulesResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HrisEmployeeSchedulesAllRequest, com.apideck.unify.models.operations.async.HrisEmployeeSchedulesAllResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HrisEmployeeSchedulesAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisEmployeeSchedulesAllRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HrisEmployeeSchedulesAllRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.HrisEmployeeSchedulesAllResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.HrisEmployeeSchedulesAllResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.HrisEmployeeSchedulesAllResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.HrisEmployeeSchedulesAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetEmployeeSchedulesResponse>() {})
                            .thenApply(res::withGetEmployeeSchedulesResponse);
                } else {
