...
public class HrisEmployeeSchedulesAll {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisEmployeeSchedulesAllRequest request) throws Exception {
        ...
        @Override
        public HrisEmployeeSchedulesAllResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GetEmployeeSchedulesResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGetEmployeeSchedulesResponse(out);
                    return res;
                } else {
