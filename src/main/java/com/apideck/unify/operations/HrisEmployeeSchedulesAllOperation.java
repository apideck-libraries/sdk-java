...
public class HrisEmployeeSchedulesAllOperation implements RequestOperation<HrisEmployeeSchedulesAllRequest, HrisEmployeeSchedulesAllResponse> {
    ...
    public HrisEmployeeSchedulesAllOperation(
    ...
    public HttpRequest buildRequest(HrisEmployeeSchedulesAllRequest request) throws Exception {
