...
public class HrisEmployeesAdd {
    ...
    public static class Sync extends Base
            implements RequestOperation<HrisEmployeesAddRequest, HrisEmployeesAddResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(HrisEmployeesAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisEmployeesAddRequest.class, new TypeReference<HrisEmployeesAddRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisEmployeesAddRequest request) {
        ...
        @Override
        public HrisEmployeesAddResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            HrisEmployeesAddResponse.Builder resBuilder =
            ...
            HrisEmployeesAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCreateEmployeeResponse(Utils.unmarshal(response, new TypeReference<CreateEmployeeResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HrisEmployeesAddRequest, com.apideck.unify.models.operations.async.HrisEmployeesAddResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HrisEmployeesAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisEmployeesAddRequest.class, new TypeReference<HrisEmployeesAddRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HrisEmployeesAddRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.HrisEmployeesAddResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.HrisEmployeesAddResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.HrisEmployeesAddResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.HrisEmployeesAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CreateEmployeeResponse>() {})
                            .thenApply(res::withCreateEmployeeResponse);
                } else {
