...
public class HrisEmployeesAddOperation implements RequestOperation<HrisEmployeesAddRequest, HrisEmployeesAddResponse> {
    ...
    public HrisEmployeesAddOperation(
    ...
    public HttpRequest buildRequest(HrisEmployeesAddRequest request) throws Exception {
