...
public class HrisEmployeesAll {
    ...
    public static class Sync extends Base
            implements RequestOperation<HrisEmployeesAllRequest, HrisEmployeesAllResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(HrisEmployeesAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisEmployeesAllRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisEmployeesAllRequest request) {
        ...
        @Override
        public HrisEmployeesAllResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            HrisEmployeesAllResponse.Builder resBuilder =
            ...
            HrisEmployeesAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetEmployeesResponse(Utils.unmarshal(response, new TypeReference<GetEmployeesResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HrisEmployeesAllRequest, com.apideck.unify.models.operations.async.HrisEmployeesAllResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HrisEmployeesAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisEmployeesAllRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HrisEmployeesAllRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.HrisEmployeesAllResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.HrisEmployeesAllResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.HrisEmployeesAllResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.HrisEmployeesAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetEmployeesResponse>() {})
                            .thenApply(res::withGetEmployeesResponse);
                } else {
