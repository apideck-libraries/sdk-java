...
public class HrisEmployeesAllOperation implements RequestOperation<HrisEmployeesAllRequest, HrisEmployeesAllResponse> {
    ...
    public HrisEmployeesAllOperation(
    ...
    public HttpRequest buildRequest(HrisEmployeesAllRequest request) throws Exception {
