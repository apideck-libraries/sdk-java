...
public class HrisEmployeesDelete {
    ...
    public static class Sync extends Base
            implements RequestOperation<HrisEmployeesDeleteRequest, HrisEmployeesDeleteResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(HrisEmployeesDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisEmployeesDeleteRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisEmployeesDeleteRequest request) {
        ...
        @Override
        public HrisEmployeesDeleteResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            HrisEmployeesDeleteResponse.Builder resBuilder =
            ...
            HrisEmployeesDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDeleteEmployeeResponse(Utils.unmarshal(response, new TypeReference<DeleteEmployeeResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HrisEmployeesDeleteRequest, com.apideck.unify.models.operations.async.HrisEmployeesDeleteResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HrisEmployeesDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisEmployeesDeleteRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HrisEmployeesDeleteRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.HrisEmployeesDeleteResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.HrisEmployeesDeleteResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.HrisEmployeesDeleteResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.HrisEmployeesDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DeleteEmployeeResponse>() {})
                            .thenApply(res::withDeleteEmployeeResponse);
                } else {
