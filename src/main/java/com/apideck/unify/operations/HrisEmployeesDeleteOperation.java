...
public class HrisEmployeesDeleteOperation implements RequestOperation<HrisEmployeesDeleteRequest, HrisEmployeesDeleteResponse> {
    ...
    public HrisEmployeesDeleteOperation(
    ...
    public HttpRequest buildRequest(HrisEmployeesDeleteRequest request) throws Exception {
