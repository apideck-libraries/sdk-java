...
public class HrisEmployeesOne {
    ...
    public static class Sync extends Base
            implements RequestOperation<HrisEmployeesOneRequest, HrisEmployeesOneResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(HrisEmployeesOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisEmployeesOneRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisEmployeesOneRequest request) {
        ...
        @Override
        public HrisEmployeesOneResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            HrisEmployeesOneResponse.Builder resBuilder =
            ...
            HrisEmployeesOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetEmployeeResponse(Utils.unmarshal(response, new TypeReference<GetEmployeeResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HrisEmployeesOneRequest, com.apideck.unify.models.operations.async.HrisEmployeesOneResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HrisEmployeesOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisEmployeesOneRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HrisEmployeesOneRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.HrisEmployeesOneResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.HrisEmployeesOneResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.HrisEmployeesOneResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.HrisEmployeesOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetEmployeeResponse>() {})
                            .thenApply(res::withGetEmployeeResponse);
                } else {
