...
public class HrisEmployeesOneOperation implements RequestOperation<HrisEmployeesOneRequest, HrisEmployeesOneResponse> {
    ...
    public HrisEmployeesOneOperation(
    ...
    public HttpRequest buildRequest(HrisEmployeesOneRequest request) throws Exception {
