...
public class HrisEmployeesUpdate {
    ...
    public static class Sync extends Base
            implements RequestOperation<HrisEmployeesUpdateRequest, HrisEmployeesUpdateResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(HrisEmployeesUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisEmployeesUpdateRequest.class, new TypeReference<HrisEmployeesUpdateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisEmployeesUpdateRequest request) {
        ...
        @Override
        public HrisEmployeesUpdateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            HrisEmployeesUpdateResponse.Builder resBuilder =
            ...
            HrisEmployeesUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withUpdateEmployeeResponse(Utils.unmarshal(response, new TypeReference<UpdateEmployeeResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HrisEmployeesUpdateRequest, com.apideck.unify.models.operations.async.HrisEmployeesUpdateResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HrisEmployeesUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisEmployeesUpdateRequest.class, new TypeReference<HrisEmployeesUpdateRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HrisEmployeesUpdateRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.HrisEmployeesUpdateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.HrisEmployeesUpdateResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.HrisEmployeesUpdateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.HrisEmployeesUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<UpdateEmployeeResponse>() {})
                            .thenApply(res::withUpdateEmployeeResponse);
                } else {
