...
public class HrisEmployeesUpdateOperation implements RequestOperation<HrisEmployeesUpdateRequest, HrisEmployeesUpdateResponse> {
    ...
    public HrisEmployeesUpdateOperation(
    ...
    public HttpRequest buildRequest(HrisEmployeesUpdateRequest request) throws Exception {
