...
public class HrisPayrollsAll {
    ...
    public static class Sync extends Base
            implements RequestOperation<HrisPayrollsAllRequest, HrisPayrollsAllResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(HrisPayrollsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisPayrollsAllRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisPayrollsAllRequest request) {
        ...
        @Override
        public HrisPayrollsAllResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            HrisPayrollsAllResponse.Builder resBuilder =
            ...
            HrisPayrollsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetPayrollsResponse(Utils.unmarshal(response, new TypeReference<GetPayrollsResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HrisPayrollsAllRequest, com.apideck.unify.models.operations.async.HrisPayrollsAllResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HrisPayrollsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisPayrollsAllRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HrisPayrollsAllRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.HrisPayrollsAllResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.HrisPayrollsAllResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.HrisPayrollsAllResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.HrisPayrollsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetPayrollsResponse>() {})
                            .thenApply(res::withGetPayrollsResponse);
                } else {
