...
public class HrisPayrollsAllOperation implements RequestOperation<HrisPayrollsAllRequest, HrisPayrollsAllResponse> {
    ...
    public HrisPayrollsAllOperation(
    ...
    public HttpRequest buildRequest(HrisPayrollsAllRequest request) throws Exception {
