...
public class HrisPayrollsOne {
    ...
    public static class Sync extends Base
            implements RequestOperation<HrisPayrollsOneRequest, HrisPayrollsOneResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(HrisPayrollsOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisPayrollsOneRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisPayrollsOneRequest request) {
        ...
        @Override
        public HrisPayrollsOneResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            HrisPayrollsOneResponse.Builder resBuilder =
            ...
            HrisPayrollsOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetPayrollResponse(Utils.unmarshal(response, new TypeReference<GetPayrollResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HrisPayrollsOneRequest, com.apideck.unify.models.operations.async.HrisPayrollsOneResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HrisPayrollsOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisPayrollsOneRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HrisPayrollsOneRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.HrisPayrollsOneResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.HrisPayrollsOneResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.HrisPayrollsOneResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.HrisPayrollsOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetPayrollResponse>() {})
                            .thenApply(res::withGetPayrollResponse);
                } else {
