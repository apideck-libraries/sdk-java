...
public class HrisPayrollsOneOperation implements RequestOperation<HrisPayrollsOneRequest, HrisPayrollsOneResponse> {
    ...
    public HrisPayrollsOneOperation(
    ...
    public HttpRequest buildRequest(HrisPayrollsOneRequest request) throws Exception {
