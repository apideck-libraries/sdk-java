...
public class HrisTimeOffRequestsAdd {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisTimeOffRequestsAddRequest request) throws Exception {
        ...
        @Override
        public HrisTimeOffRequestsAddResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    CreateTimeOffRequestResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCreateTimeOffRequestResponse(out);
                    return res;
                } else {
