...
public class HrisTimeOffRequestsAdd {
    ...
    public static class Sync extends Base
            implements RequestOperation<HrisTimeOffRequestsAddRequest, HrisTimeOffRequestsAddResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(HrisTimeOffRequestsAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisTimeOffRequestsAddRequest.class, new TypeReference<HrisTimeOffRequestsAddRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisTimeOffRequestsAddRequest request) {
        ...
        @Override
        public HrisTimeOffRequestsAddResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            HrisTimeOffRequestsAddResponse.Builder resBuilder =
            ...
            HrisTimeOffRequestsAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCreateTimeOffRequestResponse(Utils.unmarshal(response, new TypeReference<CreateTimeOffRequestResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HrisTimeOffRequestsAddRequest, com.apideck.unify.models.operations.async.HrisTimeOffRequestsAddResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HrisTimeOffRequestsAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisTimeOffRequestsAddRequest.class, new TypeReference<HrisTimeOffRequestsAddRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HrisTimeOffRequestsAddRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.HrisTimeOffRequestsAddResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.HrisTimeOffRequestsAddResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.HrisTimeOffRequestsAddResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.HrisTimeOffRequestsAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CreateTimeOffRequestResponse>() {})
                            .thenApply(res::withCreateTimeOffRequestResponse);
                } else {
