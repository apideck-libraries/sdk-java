...
public class HrisTimeOffRequestsAddOperation implements RequestOperation<HrisTimeOffRequestsAddRequest, HrisTimeOffRequestsAddResponse> {
    ...
    public HrisTimeOffRequestsAddOperation(
    ...
    public HttpRequest buildRequest(HrisTimeOffRequestsAddRequest request) throws Exception {
