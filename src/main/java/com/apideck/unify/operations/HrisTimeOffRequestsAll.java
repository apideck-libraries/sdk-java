...
public class HrisTimeOffRequestsAll {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisTimeOffRequestsAllRequest request) throws Exception {
        ...
        @Override
        public HrisTimeOffRequestsAllResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GetTimeOffRequestsResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGetTimeOffRequestsResponse(out);
                    return res;
                } else {
