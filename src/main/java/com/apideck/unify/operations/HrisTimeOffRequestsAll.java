...
public class HrisTimeOffRequestsAll {
    ...
    public static class Sync extends Base
            implements RequestOperation<HrisTimeOffRequestsAllRequest, HrisTimeOffRequestsAllResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(HrisTimeOffRequestsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisTimeOffRequestsAllRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisTimeOffRequestsAllRequest request) {
        ...
        @Override
        public HrisTimeOffRequestsAllResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            HrisTimeOffRequestsAllResponse.Builder resBuilder =
            ...
            HrisTimeOffRequestsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetTimeOffRequestsResponse(Utils.unmarshal(response, new TypeReference<GetTimeOffRequestsResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HrisTimeOffRequestsAllRequest, com.apideck.unify.models.operations.async.HrisTimeOffRequestsAllResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HrisTimeOffRequestsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisTimeOffRequestsAllRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HrisTimeOffRequestsAllRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.HrisTimeOffRequestsAllResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.HrisTimeOffRequestsAllResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.HrisTimeOffRequestsAllResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.HrisTimeOffRequestsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetTimeOffRequestsResponse>() {})
                            .thenApply(res::withGetTimeOffRequestsResponse);
                } else {
