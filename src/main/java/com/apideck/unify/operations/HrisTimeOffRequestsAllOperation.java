...
public class HrisTimeOffRequestsAllOperation implements RequestOperation<HrisTimeOffRequestsAllRequest, HrisTimeOffRequestsAllResponse> {
    ...
    public HrisTimeOffRequestsAllOperation(
    ...
    public HttpRequest buildRequest(HrisTimeOffRequestsAllRequest request) throws Exception {
