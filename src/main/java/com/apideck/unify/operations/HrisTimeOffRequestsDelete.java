...
public class HrisTimeOffRequestsDelete {
    ...
    public static class Sync extends Base
            implements RequestOperation<HrisTimeOffRequestsDeleteRequest, HrisTimeOffRequestsDeleteResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(HrisTimeOffRequestsDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisTimeOffRequestsDeleteRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisTimeOffRequestsDeleteRequest request) {
        ...
        @Override
        public HrisTimeOffRequestsDeleteResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            HrisTimeOffRequestsDeleteResponse.Builder resBuilder =
            ...
            HrisTimeOffRequestsDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDeleteTimeOffRequestResponse(Utils.unmarshal(response, new TypeReference<DeleteTimeOffRequestResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HrisTimeOffRequestsDeleteRequest, com.apideck.unify.models.operations.async.HrisTimeOffRequestsDeleteResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HrisTimeOffRequestsDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisTimeOffRequestsDeleteRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HrisTimeOffRequestsDeleteRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.HrisTimeOffRequestsDeleteResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.HrisTimeOffRequestsDeleteResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.HrisTimeOffRequestsDeleteResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.HrisTimeOffRequestsDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DeleteTimeOffRequestResponse>() {})
                            .thenApply(res::withDeleteTimeOffRequestResponse);
                } else {
