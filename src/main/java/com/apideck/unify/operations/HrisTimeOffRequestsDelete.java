...
public class HrisTimeOffRequestsDelete {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisTimeOffRequestsDeleteRequest request) throws Exception {
        ...
        @Override
        public HrisTimeOffRequestsDeleteResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    DeleteTimeOffRequestResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withDeleteTimeOffRequestResponse(out);
                    return res;
                } else {
