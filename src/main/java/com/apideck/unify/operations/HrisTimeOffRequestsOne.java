...
public class HrisTimeOffRequestsOne {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HrisTimeOffRequestsOneResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GetTimeOffRequestResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGetTimeOffRequestResponse(out);
                    return res;
                } else {
