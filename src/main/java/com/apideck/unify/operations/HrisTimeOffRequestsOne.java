...
public class HrisTimeOffRequestsOne {
    ...
    public static class Sync extends Base
            implements RequestOperation<HrisTimeOffRequestsOneRequest, HrisTimeOffRequestsOneResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(HrisTimeOffRequestsOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisTimeOffRequestsOneRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisTimeOffRequestsOneRequest request) {
        ...
        @Override
        public HrisTimeOffRequestsOneResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            HrisTimeOffRequestsOneResponse.Builder resBuilder =
            ...
            HrisTimeOffRequestsOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetTimeOffRequestResponse(Utils.unmarshal(response, new TypeReference<GetTimeOffRequestResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HrisTimeOffRequestsOneRequest, com.apideck.unify.models.operations.async.HrisTimeOffRequestsOneResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HrisTimeOffRequestsOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisTimeOffRequestsOneRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HrisTimeOffRequestsOneRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.HrisTimeOffRequestsOneResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.HrisTimeOffRequestsOneResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.HrisTimeOffRequestsOneResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.HrisTimeOffRequestsOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetTimeOffRequestResponse>() {})
                            .thenApply(res::withGetTimeOffRequestResponse);
                } else {
