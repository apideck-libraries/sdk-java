...
public class HrisTimeOffRequestsOneOperation implements RequestOperation<HrisTimeOffRequestsOneRequest, HrisTimeOffRequestsOneResponse> {
    ...
    public HrisTimeOffRequestsOneOperation(
    ...
    public HttpRequest buildRequest(HrisTimeOffRequestsOneRequest request) throws Exception {
