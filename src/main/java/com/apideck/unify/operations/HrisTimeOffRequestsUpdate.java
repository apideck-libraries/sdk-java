...
public class HrisTimeOffRequestsUpdate {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisTimeOffRequestsUpdateRequest request) throws Exception {
        ...
        @Override
        public HrisTimeOffRequestsUpdateResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    UpdateTimeOffRequestResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withUpdateTimeOffRequestResponse(out);
                    return res;
                } else {
