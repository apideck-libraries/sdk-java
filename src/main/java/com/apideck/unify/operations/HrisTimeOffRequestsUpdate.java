...
public class HrisTimeOffRequestsUpdate {
    ...
    public static class Sync extends Base
            implements RequestOperation<HrisTimeOffRequestsUpdateRequest, HrisTimeOffRequestsUpdateResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(HrisTimeOffRequestsUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisTimeOffRequestsUpdateRequest.class, new TypeReference<HrisTimeOffRequestsUpdateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HrisTimeOffRequestsUpdateRequest request) {
        ...
        @Override
        public HrisTimeOffRequestsUpdateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            HrisTimeOffRequestsUpdateResponse.Builder resBuilder =
            ...
            HrisTimeOffRequestsUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withUpdateTimeOffRequestResponse(Utils.unmarshal(response, new TypeReference<UpdateTimeOffRequestResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HrisTimeOffRequestsUpdateRequest, com.apideck.unify.models.operations.async.HrisTimeOffRequestsUpdateResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HrisTimeOffRequestsUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, HrisTimeOffRequestsUpdateRequest.class, new TypeReference<HrisTimeOffRequestsUpdateRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HrisTimeOffRequestsUpdateRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.HrisTimeOffRequestsUpdateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.HrisTimeOffRequestsUpdateResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.HrisTimeOffRequestsUpdateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.HrisTimeOffRequestsUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<UpdateTimeOffRequestResponse>() {})
                            .thenApply(res::withUpdateTimeOffRequestResponse);
                } else {
