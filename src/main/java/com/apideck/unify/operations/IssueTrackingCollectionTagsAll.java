...
public class IssueTrackingCollectionTagsAll {
    ...
    public static class Sync extends Base
            implements RequestOperation<IssueTrackingCollectionTagsAllRequest, IssueTrackingCollectionTagsAllResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(IssueTrackingCollectionTagsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, IssueTrackingCollectionTagsAllRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(IssueTrackingCollectionTagsAllRequest request) {
        ...
        @Override
        public IssueTrackingCollectionTagsAllResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            IssueTrackingCollectionTagsAllResponse.Builder resBuilder =
            ...
            IssueTrackingCollectionTagsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetCollectionTagsResponse(Utils.unmarshal(response, new TypeReference<GetCollectionTagsResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<IssueTrackingCollectionTagsAllRequest, com.apideck.unify.models.operations.async.IssueTrackingCollectionTagsAllResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(IssueTrackingCollectionTagsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, IssueTrackingCollectionTagsAllRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(IssueTrackingCollectionTagsAllRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.IssueTrackingCollectionTagsAllResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.IssueTrackingCollectionTagsAllResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.IssueTrackingCollectionTagsAllResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.IssueTrackingCollectionTagsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetCollectionTagsResponse>() {})
                            .thenApply(res::withGetCollectionTagsResponse);
                } else {
