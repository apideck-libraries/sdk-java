...
public class IssueTrackingCollectionTagsAllOperation implements RequestOperation<IssueTrackingCollectionTagsAllRequest, IssueTrackingCollectionTagsAllResponse> {
    ...
    public IssueTrackingCollectionTagsAllOperation(
    ...
    public HttpRequest buildRequest(IssueTrackingCollectionTagsAllRequest request) throws Exception {
