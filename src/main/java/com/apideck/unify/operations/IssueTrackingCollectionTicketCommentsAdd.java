...
public class IssueTrackingCollectionTicketCommentsAdd {
    ...
    public static class Sync extends Base
            implements RequestOperation<IssueTrackingCollectionTicketCommentsAddRequest, IssueTrackingCollectionTicketCommentsAddResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(IssueTrackingCollectionTicketCommentsAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, IssueTrackingCollectionTicketCommentsAddRequest.class, new TypeReference<IssueTrackingCollectionTicketCommentsAddRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(IssueTrackingCollectionTicketCommentsAddRequest request) {
        ...
        @Override
        public IssueTrackingCollectionTicketCommentsAddResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            IssueTrackingCollectionTicketCommentsAddResponse.Builder resBuilder =
            ...
            IssueTrackingCollectionTicketCommentsAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCreateCommentResponse(Utils.unmarshal(response, new TypeReference<CreateCommentResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<IssueTrackingCollectionTicketCommentsAddRequest, com.apideck.unify.models.operations.async.IssueTrackingCollectionTicketCommentsAddResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(IssueTrackingCollectionTicketCommentsAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, IssueTrackingCollectionTicketCommentsAddRequest.class, new TypeReference<IssueTrackingCollectionTicketCommentsAddRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(IssueTrackingCollectionTicketCommentsAddRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.IssueTrackingCollectionTicketCommentsAddResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.IssueTrackingCollectionTicketCommentsAddResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.IssueTrackingCollectionTicketCommentsAddResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.IssueTrackingCollectionTicketCommentsAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CreateCommentResponse>() {})
                            .thenApply(res::withCreateCommentResponse);
                } else {
