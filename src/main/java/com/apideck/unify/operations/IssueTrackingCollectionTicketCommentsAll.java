...
public class IssueTrackingCollectionTicketCommentsAll {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(IssueTrackingCollectionTicketCommentsAllRequest request) throws Exception {
        ...
        @Override
        public IssueTrackingCollectionTicketCommentsAllResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GetCommentsResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGetCommentsResponse(out);
                    return res;
                } else {
