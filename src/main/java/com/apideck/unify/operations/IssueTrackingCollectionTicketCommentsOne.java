...
public class IssueTrackingCollectionTicketCommentsOne {
    ...
    public static class Sync extends Base
            implements RequestOperation<IssueTrackingCollectionTicketCommentsOneRequest, IssueTrackingCollectionTicketCommentsOneResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(IssueTrackingCollectionTicketCommentsOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, IssueTrackingCollectionTicketCommentsOneRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(IssueTrackingCollectionTicketCommentsOneRequest request) {
        ...
        @Override
        public IssueTrackingCollectionTicketCommentsOneResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            IssueTrackingCollectionTicketCommentsOneResponse.Builder resBuilder =
            ...
            IssueTrackingCollectionTicketCommentsOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetCommentResponse(Utils.unmarshal(response, new TypeReference<GetCommentResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<IssueTrackingCollectionTicketCommentsOneRequest, com.apideck.unify.models.operations.async.IssueTrackingCollectionTicketCommentsOneResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(IssueTrackingCollectionTicketCommentsOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, IssueTrackingCollectionTicketCommentsOneRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(IssueTrackingCollectionTicketCommentsOneRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.IssueTrackingCollectionTicketCommentsOneResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.IssueTrackingCollectionTicketCommentsOneResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.IssueTrackingCollectionTicketCommentsOneResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.IssueTrackingCollectionTicketCommentsOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetCommentResponse>() {})
                            .thenApply(res::withGetCommentResponse);
                } else {
