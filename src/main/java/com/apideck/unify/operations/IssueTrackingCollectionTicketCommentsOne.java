...
public class IssueTrackingCollectionTicketCommentsOne {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(IssueTrackingCollectionTicketCommentsOneRequest request) throws Exception {
        ...
        @Override
        public IssueTrackingCollectionTicketCommentsOneResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GetCommentResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGetCommentResponse(out);
                    return res;
                } else {
