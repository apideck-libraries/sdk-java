...
public class IssueTrackingCollectionTicketCommentsUpdate {
    ...
    public static class Sync extends Base
            implements RequestOperation<IssueTrackingCollectionTicketCommentsUpdateRequest, IssueTrackingCollectionTicketCommentsUpdateResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(IssueTrackingCollectionTicketCommentsUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, IssueTrackingCollectionTicketCommentsUpdateRequest.class, new TypeReference<IssueTrackingCollectionTicketCommentsUpdateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(IssueTrackingCollectionTicketCommentsUpdateRequest request) {
        ...
        @Override
        public IssueTrackingCollectionTicketCommentsUpdateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            IssueTrackingCollectionTicketCommentsUpdateResponse.Builder resBuilder =
            ...
            IssueTrackingCollectionTicketCommentsUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withUpdateCommentResponse(Utils.unmarshal(response, new TypeReference<UpdateCommentResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<IssueTrackingCollectionTicketCommentsUpdateRequest, com.apideck.unify.models.operations.async.IssueTrackingCollectionTicketCommentsUpdateResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(IssueTrackingCollectionTicketCommentsUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, IssueTrackingCollectionTicketCommentsUpdateRequest.class, new TypeReference<IssueTrackingCollectionTicketCommentsUpdateRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(IssueTrackingCollectionTicketCommentsUpdateRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.IssueTrackingCollectionTicketCommentsUpdateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.IssueTrackingCollectionTicketCommentsUpdateResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.IssueTrackingCollectionTicketCommentsUpdateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.IssueTrackingCollectionTicketCommentsUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<UpdateCommentResponse>() {})
                            .thenApply(res::withUpdateCommentResponse);
                } else {
