...
public class IssueTrackingCollectionTicketsAdd {
    ...
    public static class Sync extends Base
            implements RequestOperation<IssueTrackingCollectionTicketsAddRequest, IssueTrackingCollectionTicketsAddResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(IssueTrackingCollectionTicketsAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, IssueTrackingCollectionTicketsAddRequest.class, new TypeReference<IssueTrackingCollectionTicketsAddRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(IssueTrackingCollectionTicketsAddRequest request) {
        ...
        @Override
        public IssueTrackingCollectionTicketsAddResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            IssueTrackingCollectionTicketsAddResponse.Builder resBuilder =
            ...
            IssueTrackingCollectionTicketsAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCreateTicketResponse(Utils.unmarshal(response, new TypeReference<CreateTicketResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<IssueTrackingCollectionTicketsAddRequest, com.apideck.unify.models.operations.async.IssueTrackingCollectionTicketsAddResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(IssueTrackingCollectionTicketsAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, IssueTrackingCollectionTicketsAddRequest.class, new TypeReference<IssueTrackingCollectionTicketsAddRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(IssueTrackingCollectionTicketsAddRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.IssueTrackingCollectionTicketsAddResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.IssueTrackingCollectionTicketsAddResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.IssueTrackingCollectionTicketsAddResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.IssueTrackingCollectionTicketsAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CreateTicketResponse>() {})
                            .thenApply(res::withCreateTicketResponse);
                } else {
