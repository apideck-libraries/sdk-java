...
public class IssueTrackingCollectionTicketsAdd {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(IssueTrackingCollectionTicketsAddRequest request) throws Exception {
        ...
        @Override
        public IssueTrackingCollectionTicketsAddResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    CreateTicketResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCreateTicketResponse(out);
                    return res;
                } else {
