...
public class IssueTrackingCollectionTicketsAddOperation implements RequestOperation<IssueTrackingCollectionTicketsAddRequest, IssueTrackingCollectionTicketsAddResponse> {
    ...
    public IssueTrackingCollectionTicketsAddOperation(
    ...
    public HttpRequest buildRequest(IssueTrackingCollectionTicketsAddRequest request) throws Exception {
