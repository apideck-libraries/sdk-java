...
public class IssueTrackingCollectionTicketsAllOperation implements RequestOperation<IssueTrackingCollectionTicketsAllRequest, IssueTrackingCollectionTicketsAllResponse> {
    ...
    public IssueTrackingCollectionTicketsAllOperation(
    ...
    public HttpRequest buildRequest(IssueTrackingCollectionTicketsAllRequest request) throws Exception {
