...
public class IssueTrackingCollectionTicketsDelete {
    ...
    public static class Sync extends Base
            implements RequestOperation<IssueTrackingCollectionTicketsDeleteRequest, IssueTrackingCollectionTicketsDeleteResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(IssueTrackingCollectionTicketsDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, IssueTrackingCollectionTicketsDeleteRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(IssueTrackingCollectionTicketsDeleteRequest request) {
        ...
        @Override
        public IssueTrackingCollectionTicketsDeleteResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            IssueTrackingCollectionTicketsDeleteResponse.Builder resBuilder =
            ...
            IssueTrackingCollectionTicketsDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDeleteTicketResponse(Utils.unmarshal(response, new TypeReference<DeleteTicketResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<IssueTrackingCollectionTicketsDeleteRequest, com.apideck.unify.models.operations.async.IssueTrackingCollectionTicketsDeleteResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(IssueTrackingCollectionTicketsDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, IssueTrackingCollectionTicketsDeleteRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(IssueTrackingCollectionTicketsDeleteRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.IssueTrackingCollectionTicketsDeleteResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.IssueTrackingCollectionTicketsDeleteResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.IssueTrackingCollectionTicketsDeleteResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.IssueTrackingCollectionTicketsDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DeleteTicketResponse>() {})
                            .thenApply(res::withDeleteTicketResponse);
                } else {
