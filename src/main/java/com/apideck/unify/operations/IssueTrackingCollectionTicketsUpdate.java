...
public class IssueTrackingCollectionTicketsUpdate {
    ...
    public static class Sync extends Base
        ...
        @Override
        public IssueTrackingCollectionTicketsUpdateResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    UpdateTicketResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withUpdateTicketResponse(out);
                    return res;
                } else {
