...
public class IssueTrackingCollectionTicketsUpdate {
    ...
    public static class Sync extends Base
            implements RequestOperation<IssueTrackingCollectionTicketsUpdateRequest, IssueTrackingCollectionTicketsUpdateResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(IssueTrackingCollectionTicketsUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, IssueTrackingCollectionTicketsUpdateRequest.class, new TypeReference<IssueTrackingCollectionTicketsUpdateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(IssueTrackingCollectionTicketsUpdateRequest request) {
        ...
        @Override
        public IssueTrackingCollectionTicketsUpdateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            IssueTrackingCollectionTicketsUpdateResponse.Builder resBuilder =
            ...
            IssueTrackingCollectionTicketsUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withUpdateTicketResponse(Utils.unmarshal(response, new TypeReference<UpdateTicketResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<IssueTrackingCollectionTicketsUpdateRequest, com.apideck.unify.models.operations.async.IssueTrackingCollectionTicketsUpdateResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(IssueTrackingCollectionTicketsUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, IssueTrackingCollectionTicketsUpdateRequest.class, new TypeReference<IssueTrackingCollectionTicketsUpdateRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(IssueTrackingCollectionTicketsUpdateRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.IssueTrackingCollectionTicketsUpdateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.IssueTrackingCollectionTicketsUpdateResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.IssueTrackingCollectionTicketsUpdateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.IssueTrackingCollectionTicketsUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<UpdateTicketResponse>() {})
                            .thenApply(res::withUpdateTicketResponse);
                } else {
