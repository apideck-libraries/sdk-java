...
public class IssueTrackingCollectionUsersAll {
    ...
    public static class Sync extends Base
            implements RequestOperation<IssueTrackingCollectionUsersAllRequest, IssueTrackingCollectionUsersAllResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(IssueTrackingCollectionUsersAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, IssueTrackingCollectionUsersAllRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(IssueTrackingCollectionUsersAllRequest request) {
        ...
        @Override
        public IssueTrackingCollectionUsersAllResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            IssueTrackingCollectionUsersAllResponse.Builder resBuilder =
            ...
            IssueTrackingCollectionUsersAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetCollectionUsersResponse(Utils.unmarshal(response, new TypeReference<GetCollectionUsersResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<IssueTrackingCollectionUsersAllRequest, com.apideck.unify.models.operations.async.IssueTrackingCollectionUsersAllResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(IssueTrackingCollectionUsersAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, IssueTrackingCollectionUsersAllRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(IssueTrackingCollectionUsersAllRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.IssueTrackingCollectionUsersAllResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.IssueTrackingCollectionUsersAllResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.IssueTrackingCollectionUsersAllResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.IssueTrackingCollectionUsersAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetCollectionUsersResponse>() {})
                            .thenApply(res::withGetCollectionUsersResponse);
                } else {
