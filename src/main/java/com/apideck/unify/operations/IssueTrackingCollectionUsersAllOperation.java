...
public class IssueTrackingCollectionUsersAllOperation implements RequestOperation<IssueTrackingCollectionUsersAllRequest, IssueTrackingCollectionUsersAllResponse> {
    ...
    public IssueTrackingCollectionUsersAllOperation(
    ...
    public HttpRequest buildRequest(IssueTrackingCollectionUsersAllRequest request) throws Exception {
