...
public class IssueTrackingCollectionUsersOneOperation implements RequestOperation<IssueTrackingCollectionUsersOneRequest, IssueTrackingCollectionUsersOneResponse> {
    ...
    public IssueTrackingCollectionUsersOneOperation(
    ...
    public HttpRequest buildRequest(IssueTrackingCollectionUsersOneRequest request) throws Exception {
