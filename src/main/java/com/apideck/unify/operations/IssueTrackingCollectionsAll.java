...
public class IssueTrackingCollectionsAll {
    ...
    public static class Sync extends Base
            implements RequestOperation<IssueTrackingCollectionsAllRequest, IssueTrackingCollectionsAllResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(IssueTrackingCollectionsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, IssueTrackingCollectionsAllRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(IssueTrackingCollectionsAllRequest request) {
        ...
        @Override
        public IssueTrackingCollectionsAllResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            IssueTrackingCollectionsAllResponse.Builder resBuilder =
            ...
            IssueTrackingCollectionsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetCollectionsResponse(Utils.unmarshal(response, new TypeReference<GetCollectionsResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<IssueTrackingCollectionsAllRequest, com.apideck.unify.models.operations.async.IssueTrackingCollectionsAllResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(IssueTrackingCollectionsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, IssueTrackingCollectionsAllRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(IssueTrackingCollectionsAllRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.IssueTrackingCollectionsAllResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.IssueTrackingCollectionsAllResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.IssueTrackingCollectionsAllResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.IssueTrackingCollectionsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetCollectionsResponse>() {})
                            .thenApply(res::withGetCollectionsResponse);
                } else {
