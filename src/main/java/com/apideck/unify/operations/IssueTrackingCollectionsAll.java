...
public class IssueTrackingCollectionsAll {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(IssueTrackingCollectionsAllRequest request) throws Exception {
        ...
        @Override
        public IssueTrackingCollectionsAllResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GetCollectionsResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGetCollectionsResponse(out);
                    return res;
                } else {
