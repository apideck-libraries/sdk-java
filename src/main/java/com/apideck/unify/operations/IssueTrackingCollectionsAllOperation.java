...
public class IssueTrackingCollectionsAllOperation implements RequestOperation<IssueTrackingCollectionsAllRequest, IssueTrackingCollectionsAllResponse> {
    ...
    public IssueTrackingCollectionsAllOperation(
    ...
    public HttpRequest buildRequest(IssueTrackingCollectionsAllRequest request) throws Exception {
