...
public class IssueTrackingCollectionsOneOperation implements RequestOperation<IssueTrackingCollectionsOneRequest, IssueTrackingCollectionsOneResponse> {
    ...
    public IssueTrackingCollectionsOneOperation(
    ...
    public HttpRequest buildRequest(IssueTrackingCollectionsOneRequest request) throws Exception {
