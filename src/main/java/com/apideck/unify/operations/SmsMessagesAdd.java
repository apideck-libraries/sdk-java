...
public class SmsMessagesAdd {
    ...
    public static class Sync extends Base
            implements RequestOperation<SmsMessagesAddRequest, SmsMessagesAddResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(SmsMessagesAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, SmsMessagesAddRequest.class, new TypeReference<SmsMessagesAddRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(SmsMessagesAddRequest request) {
        ...
        @Override
        public SmsMessagesAddResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            SmsMessagesAddResponse.Builder resBuilder =
            ...
            SmsMessagesAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCreateMessageResponse(Utils.unmarshal(response, new TypeReference<CreateMessageResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<SmsMessagesAddRequest, com.apideck.unify.models.operations.async.SmsMessagesAddResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(SmsMessagesAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, SmsMessagesAddRequest.class, new TypeReference<SmsMessagesAddRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(SmsMessagesAddRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.SmsMessagesAddResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.SmsMessagesAddResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.SmsMessagesAddResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.SmsMessagesAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CreateMessageResponse>() {})
                            .thenApply(res::withCreateMessageResponse);
                } else {
