...
public class SmsMessagesAddOperation implements RequestOperation<SmsMessagesAddRequest, SmsMessagesAddResponse> {
    ...
    public SmsMessagesAddOperation(
    ...
    public HttpRequest buildRequest(SmsMessagesAddRequest request) throws Exception {
