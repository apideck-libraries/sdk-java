...
public class SmsMessagesAll {
    ...
    public static class Sync extends Base
            implements RequestOperation<SmsMessagesAllRequest, SmsMessagesAllResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(SmsMessagesAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, SmsMessagesAllRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(SmsMessagesAllRequest request) {
        ...
        @Override
        public SmsMessagesAllResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            SmsMessagesAllResponse.Builder resBuilder =
            ...
            SmsMessagesAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetMessagesResponse(Utils.unmarshal(response, new TypeReference<GetMessagesResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<SmsMessagesAllRequest, com.apideck.unify.models.operations.async.SmsMessagesAllResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(SmsMessagesAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, SmsMessagesAllRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(SmsMessagesAllRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.SmsMessagesAllResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.SmsMessagesAllResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.SmsMessagesAllResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.SmsMessagesAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetMessagesResponse>() {})
                            .thenApply(res::withGetMessagesResponse);
                } else {
