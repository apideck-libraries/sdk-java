...
public class SmsMessagesAllOperation implements RequestOperation<SmsMessagesAllRequest, SmsMessagesAllResponse> {
    ...
    public SmsMessagesAllOperation(
    ...
    public HttpRequest buildRequest(SmsMessagesAllRequest request) throws Exception {
