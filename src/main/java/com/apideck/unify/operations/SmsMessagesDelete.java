...
public class SmsMessagesDelete {
    ...
    public static class Sync extends Base
        ...
        @Override
        public SmsMessagesDeleteResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    DeleteMessageResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withDeleteMessageResponse(out);
                    return res;
                } else {
