...
public class SmsMessagesDelete {
    ...
    public static class Sync extends Base
            implements RequestOperation<SmsMessagesDeleteRequest, SmsMessagesDeleteResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(SmsMessagesDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, SmsMessagesDeleteRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(SmsMessagesDeleteRequest request) {
        ...
        @Override
        public SmsMessagesDeleteResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            SmsMessagesDeleteResponse.Builder resBuilder =
            ...
            SmsMessagesDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDeleteMessageResponse(Utils.unmarshal(response, new TypeReference<DeleteMessageResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<SmsMessagesDeleteRequest, com.apideck.unify.models.operations.async.SmsMessagesDeleteResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(SmsMessagesDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, SmsMessagesDeleteRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(SmsMessagesDeleteRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.SmsMessagesDeleteResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.SmsMessagesDeleteResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.SmsMessagesDeleteResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.SmsMessagesDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DeleteMessageResponse>() {})
                            .thenApply(res::withDeleteMessageResponse);
                } else {
