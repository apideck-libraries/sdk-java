...
public class SmsMessagesDeleteOperation implements RequestOperation<SmsMessagesDeleteRequest, SmsMessagesDeleteResponse> {
    ...
    public SmsMessagesDeleteOperation(
    ...
    public HttpRequest buildRequest(SmsMessagesDeleteRequest request) throws Exception {
