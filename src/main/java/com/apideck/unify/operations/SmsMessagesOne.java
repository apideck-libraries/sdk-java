...
public class SmsMessagesOne {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(SmsMessagesOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, SmsMessagesOneRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(SmsMessagesOneRequest request) {
        ...
        @Override
        public SmsMessagesOneResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            SmsMessagesOneResponse.Builder resBuilder =
            ...
            SmsMessagesOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetMessageResponse(Utils.unmarshal(response, new TypeReference<GetMessageResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<SmsMessagesOneRequest, com.apideck.unify.models.operations.async.SmsMessagesOneResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(SmsMessagesOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, SmsMessagesOneRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(SmsMessagesOneRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.SmsMessagesOneResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.SmsMessagesOneResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.SmsMessagesOneResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.SmsMessagesOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetMessageResponse>() {})
                            .thenApply(res::withGetMessageResponse);
                } else {
