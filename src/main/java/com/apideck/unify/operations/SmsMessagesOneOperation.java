...
public class SmsMessagesOneOperation implements RequestOperation<SmsMessagesOneRequest, SmsMessagesOneResponse> {
    ...
    public SmsMessagesOneOperation(
    ...
    public HttpRequest buildRequest(SmsMessagesOneRequest request) throws Exception {
