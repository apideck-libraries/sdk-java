...
public class SmsMessagesUpdate {
    ...
    public static class Sync extends Base
            implements RequestOperation<SmsMessagesUpdateRequest, SmsMessagesUpdateResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(SmsMessagesUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, SmsMessagesUpdateRequest.class, new TypeReference<SmsMessagesUpdateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(SmsMessagesUpdateRequest request) {
        ...
        @Override
        public SmsMessagesUpdateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            SmsMessagesUpdateResponse.Builder resBuilder =
            ...
            SmsMessagesUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withUpdateMessageResponse(Utils.unmarshal(response, new TypeReference<UpdateMessageResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<SmsMessagesUpdateRequest, com.apideck.unify.models.operations.async.SmsMessagesUpdateResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(SmsMessagesUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, SmsMessagesUpdateRequest.class, new TypeReference<SmsMessagesUpdateRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(SmsMessagesUpdateRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.SmsMessagesUpdateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.SmsMessagesUpdateResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.SmsMessagesUpdateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.SmsMessagesUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<UpdateMessageResponse>() {})
                            .thenApply(res::withUpdateMessageResponse);
                } else {
