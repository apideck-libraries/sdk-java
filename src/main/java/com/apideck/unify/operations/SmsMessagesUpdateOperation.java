...
public class SmsMessagesUpdateOperation implements RequestOperation<SmsMessagesUpdateRequest, SmsMessagesUpdateResponse> {
    ...
    public SmsMessagesUpdateOperation(
    ...
    public HttpRequest buildRequest(SmsMessagesUpdateRequest request) throws Exception {
