...
public class VaultConnectionConsentUpdate {
    ...
    public static class Sync extends Base
            implements RequestOperation<VaultConnectionConsentUpdateRequest, VaultConnectionConsentUpdateResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(VaultConnectionConsentUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, VaultConnectionConsentUpdateRequest.class, new TypeReference<VaultConnectionConsentUpdateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(VaultConnectionConsentUpdateRequest request) {
        ...
        @Override
        public VaultConnectionConsentUpdateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            VaultConnectionConsentUpdateResponse.Builder resBuilder =
            ...
            VaultConnectionConsentUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withUpdateConsentResponse(Utils.unmarshal(response, new TypeReference<UpdateConsentResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<VaultConnectionConsentUpdateRequest, com.apideck.unify.models.operations.async.VaultConnectionConsentUpdateResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(VaultConnectionConsentUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, VaultConnectionConsentUpdateRequest.class, new TypeReference<VaultConnectionConsentUpdateRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(VaultConnectionConsentUpdateRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.VaultConnectionConsentUpdateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.VaultConnectionConsentUpdateResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.VaultConnectionConsentUpdateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.VaultConnectionConsentUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<UpdateConsentResponse>() {})
                            .thenApply(res::withUpdateConsentResponse);
                } else {
