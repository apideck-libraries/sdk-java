...
public class VaultConnectionConsentsAll {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(VaultConnectionConsentsAllRequest request) throws Exception {
        ...
        @Override
        public VaultConnectionConsentsAllResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GetConsentRecordsResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGetConsentRecordsResponse(out);
                    return res;
                } else {
