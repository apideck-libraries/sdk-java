...
public class VaultConnectionConsentsAll {
    ...
    public static class Sync extends Base
            implements RequestOperation<VaultConnectionConsentsAllRequest, VaultConnectionConsentsAllResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(VaultConnectionConsentsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, VaultConnectionConsentsAllRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(VaultConnectionConsentsAllRequest request) {
        ...
        @Override
        public VaultConnectionConsentsAllResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            VaultConnectionConsentsAllResponse.Builder resBuilder =
            ...
            VaultConnectionConsentsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetConsentRecordsResponse(Utils.unmarshal(response, new TypeReference<GetConsentRecordsResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<VaultConnectionConsentsAllRequest, com.apideck.unify.models.operations.async.VaultConnectionConsentsAllResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(VaultConnectionConsentsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, VaultConnectionConsentsAllRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(VaultConnectionConsentsAllRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.VaultConnectionConsentsAllResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.VaultConnectionConsentsAllResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.VaultConnectionConsentsAllResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.VaultConnectionConsentsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetConsentRecordsResponse>() {})
                            .thenApply(res::withGetConsentRecordsResponse);
                } else {
