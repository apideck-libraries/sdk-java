...
public class VaultConnectionCustomMappingsAll {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(VaultConnectionCustomMappingsAllRequest request) throws Exception {
        ...
        @Override
        public VaultConnectionCustomMappingsAllResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GetCustomMappingsResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGetCustomMappingsResponse(out);
                    return res;
                } else {
