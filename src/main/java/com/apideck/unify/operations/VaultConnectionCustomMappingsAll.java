...
public class VaultConnectionCustomMappingsAll {
    ...
    public static class Sync extends Base
            implements RequestOperation<VaultConnectionCustomMappingsAllRequest, VaultConnectionCustomMappingsAllResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(VaultConnectionCustomMappingsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, VaultConnectionCustomMappingsAllRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(VaultConnectionCustomMappingsAllRequest request) {
        ...
        @Override
        public VaultConnectionCustomMappingsAllResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            VaultConnectionCustomMappingsAllResponse.Builder resBuilder =
            ...
            VaultConnectionCustomMappingsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetCustomMappingsResponse(Utils.unmarshal(response, new TypeReference<GetCustomMappingsResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<VaultConnectionCustomMappingsAllRequest, com.apideck.unify.models.operations.async.VaultConnectionCustomMappingsAllResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(VaultConnectionCustomMappingsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, VaultConnectionCustomMappingsAllRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(VaultConnectionCustomMappingsAllRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.VaultConnectionCustomMappingsAllResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.VaultConnectionCustomMappingsAllResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.VaultConnectionCustomMappingsAllResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.VaultConnectionCustomMappingsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetCustomMappingsResponse>() {})
                            .thenApply(res::withGetCustomMappingsResponse);
                } else {
