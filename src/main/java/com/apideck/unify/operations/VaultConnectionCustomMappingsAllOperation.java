...
public class VaultConnectionCustomMappingsAllOperation implements RequestOperation<VaultConnectionCustomMappingsAllRequest, VaultConnectionCustomMappingsAllResponse> {
    ...
    public VaultConnectionCustomMappingsAllOperation(
    ...
    public HttpRequest buildRequest(VaultConnectionCustomMappingsAllRequest request) throws Exception {
