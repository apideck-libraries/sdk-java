...
public class VaultConnectionSettingsAll {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(VaultConnectionSettingsAllRequest request) throws Exception {
        ...
        @Override
        public VaultConnectionSettingsAllResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GetConnectionResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGetConnectionResponse(out);
                    return res;
                } else {
