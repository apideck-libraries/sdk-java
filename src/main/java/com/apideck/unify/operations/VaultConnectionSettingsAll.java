...
public class VaultConnectionSettingsAll {
    ...
    public static class Sync extends Base
            implements RequestOperation<VaultConnectionSettingsAllRequest, VaultConnectionSettingsAllResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(VaultConnectionSettingsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, VaultConnectionSettingsAllRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(VaultConnectionSettingsAllRequest request) {
        ...
        @Override
        public VaultConnectionSettingsAllResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            VaultConnectionSettingsAllResponse.Builder resBuilder =
            ...
            VaultConnectionSettingsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetConnectionResponse(Utils.unmarshal(response, new TypeReference<GetConnectionResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<VaultConnectionSettingsAllRequest, com.apideck.unify.models.operations.async.VaultConnectionSettingsAllResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(VaultConnectionSettingsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, VaultConnectionSettingsAllRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(VaultConnectionSettingsAllRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.VaultConnectionSettingsAllResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.VaultConnectionSettingsAllResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.VaultConnectionSettingsAllResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.VaultConnectionSettingsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetConnectionResponse>() {})
                            .thenApply(res::withGetConnectionResponse);
                } else {
