...
public class VaultConnectionSettingsAllOperation implements RequestOperation<VaultConnectionSettingsAllRequest, VaultConnectionSettingsAllResponse> {
    ...
    public VaultConnectionSettingsAllOperation(
    ...
    public HttpRequest buildRequest(VaultConnectionSettingsAllRequest request) throws Exception {
