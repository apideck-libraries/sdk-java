...
public class VaultConnectionSettingsUpdate {
    ...
    public static class Sync extends Base
            implements RequestOperation<VaultConnectionSettingsUpdateRequest, VaultConnectionSettingsUpdateResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(VaultConnectionSettingsUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, VaultConnectionSettingsUpdateRequest.class, new TypeReference<VaultConnectionSettingsUpdateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(VaultConnectionSettingsUpdateRequest request) {
        ...
        @Override
        public VaultConnectionSettingsUpdateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            VaultConnectionSettingsUpdateResponse.Builder resBuilder =
            ...
            VaultConnectionSettingsUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withUpdateConnectionResponse(Utils.unmarshal(response, new TypeReference<UpdateConnectionResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<VaultConnectionSettingsUpdateRequest, com.apideck.unify.models.operations.async.VaultConnectionSettingsUpdateResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(VaultConnectionSettingsUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, VaultConnectionSettingsUpdateRequest.class, new TypeReference<VaultConnectionSettingsUpdateRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(VaultConnectionSettingsUpdateRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.VaultConnectionSettingsUpdateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.VaultConnectionSettingsUpdateResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.VaultConnectionSettingsUpdateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.VaultConnectionSettingsUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<UpdateConnectionResponse>() {})
                            .thenApply(res::withUpdateConnectionResponse);
                } else {
