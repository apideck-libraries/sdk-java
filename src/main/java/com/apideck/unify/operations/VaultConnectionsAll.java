...
public class VaultConnectionsAll {
    ...
    public static class Sync extends Base
            implements RequestOperation<VaultConnectionsAllRequest, VaultConnectionsAllResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(VaultConnectionsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, VaultConnectionsAllRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(VaultConnectionsAllRequest request) {
        ...
        @Override
        public VaultConnectionsAllResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            VaultConnectionsAllResponse.Builder resBuilder =
            ...
            VaultConnectionsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetConnectionsResponse(Utils.unmarshal(response, new TypeReference<GetConnectionsResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<VaultConnectionsAllRequest, com.apideck.unify.models.operations.async.VaultConnectionsAllResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(VaultConnectionsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, VaultConnectionsAllRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(VaultConnectionsAllRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.VaultConnectionsAllResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.VaultConnectionsAllResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.VaultConnectionsAllResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.VaultConnectionsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetConnectionsResponse>() {})
                            .thenApply(res::withGetConnectionsResponse);
                } else {
