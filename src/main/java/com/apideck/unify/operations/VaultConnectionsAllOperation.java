...
public class VaultConnectionsAllOperation implements RequestOperation<VaultConnectionsAllRequest, VaultConnectionsAllResponse> {
    ...
    public VaultConnectionsAllOperation(
    ...
    public HttpRequest buildRequest(VaultConnectionsAllRequest request) throws Exception {
