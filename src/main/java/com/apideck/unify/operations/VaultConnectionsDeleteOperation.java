...
public class VaultConnectionsDeleteOperation implements RequestOperation<VaultConnectionsDeleteRequest, VaultConnectionsDeleteResponse> {
    ...
    public VaultConnectionsDeleteOperation(
    ...
    public HttpRequest buildRequest(VaultConnectionsDeleteRequest request) throws Exception {
