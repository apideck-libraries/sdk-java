...
public class VaultConnectionsImport {
    ...
    public static class Sync extends Base
        ...
        @Override
        public VaultConnectionsImportResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    CreateConnectionResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCreateConnectionResponse(out);
                    return res;
                } else {
