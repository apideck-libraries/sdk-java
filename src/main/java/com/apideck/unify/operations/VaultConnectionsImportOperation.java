...
public class VaultConnectionsImportOperation implements RequestOperation<VaultConnectionsImportRequest, VaultConnectionsImportResponse> {
    ...
    public VaultConnectionsImportOperation(
    ...
    public HttpRequest buildRequest(VaultConnectionsImportRequest request) throws Exception {
