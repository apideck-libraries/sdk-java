...
import com.apideck.unify.models.errors.ConflictResponse;
...
public class VaultConnectionsMigrate {
    ...
    static abstract class Base {
        ...
        <T, U>HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(
                    klass,
                    this.baseUrl,
                    "/vault/connections/{unified_api}/{service_id}/migrate",
    ...
    public static class Sync extends Base
            implements RequestOperation<VaultConnectionsMigrateRequest, VaultConnectionsMigrateResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(VaultConnectionsMigrateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, VaultConnectionsMigrateRequest.class, new TypeReference<VaultConnectionsMigrateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(VaultConnectionsMigrateRequest request) {
        ...
        @Override
        public VaultConnectionsMigrateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            VaultConnectionsMigrateResponse.Builder resBuilder =
            ...
            VaultConnectionsMigrateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCreateConnectionResponse(Utils.unmarshal(response, new TypeReference<CreateConnectionResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<VaultConnectionsMigrateRequest, com.apideck.unify.models.operations.async.VaultConnectionsMigrateResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(VaultConnectionsMigrateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, VaultConnectionsMigrateRequest.class, new TypeReference<VaultConnectionsMigrateRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(VaultConnectionsMigrateRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.VaultConnectionsMigrateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.VaultConnectionsMigrateResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.VaultConnectionsMigrateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.VaultConnectionsMigrateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CreateConnectionResponse>() {})
                            .thenApply(res::withCreateConnectionResponse);
                } else {
