...
public class VaultConnectionsOneOperation implements RequestOperation<VaultConnectionsOneRequest, VaultConnectionsOneResponse> {
    ...
    public VaultConnectionsOneOperation(
    ...
    public HttpRequest buildRequest(VaultConnectionsOneRequest request) throws Exception {
