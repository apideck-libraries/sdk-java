...
public class VaultConnectionsUpdateOperation implements RequestOperation<VaultConnectionsUpdateRequest, VaultConnectionsUpdateResponse> {
    ...
    public VaultConnectionsUpdateOperation(
    ...
    public HttpRequest buildRequest(VaultConnectionsUpdateRequest request) throws Exception {
