...
public class VaultConsumerRequestCountsAll {
    ...
    public static class Sync extends Base
            implements RequestOperation<VaultConsumerRequestCountsAllRequest, VaultConsumerRequestCountsAllResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(VaultConsumerRequestCountsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, VaultConsumerRequestCountsAllRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(VaultConsumerRequestCountsAllRequest request) {
        ...
        @Override
        public VaultConsumerRequestCountsAllResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            VaultConsumerRequestCountsAllResponse.Builder resBuilder =
            ...
            VaultConsumerRequestCountsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withConsumerRequestCountsInDateRangeResponse(Utils.unmarshal(response, new TypeReference<ConsumerRequestCountsInDateRangeResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<VaultConsumerRequestCountsAllRequest, com.apideck.unify.models.operations.async.VaultConsumerRequestCountsAllResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(VaultConsumerRequestCountsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, VaultConsumerRequestCountsAllRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(VaultConsumerRequestCountsAllRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.VaultConsumerRequestCountsAllResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.VaultConsumerRequestCountsAllResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.VaultConsumerRequestCountsAllResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.VaultConsumerRequestCountsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ConsumerRequestCountsInDateRangeResponse>() {})
                            .thenApply(res::withConsumerRequestCountsInDateRangeResponse);
                } else {
