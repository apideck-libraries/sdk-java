...
public class VaultConsumerRequestCountsAll {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(VaultConsumerRequestCountsAllRequest request) throws Exception {
        ...
        @Override
        public VaultConsumerRequestCountsAllResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    ConsumerRequestCountsInDateRangeResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withConsumerRequestCountsInDateRangeResponse(out);
                    return res;
                } else {
