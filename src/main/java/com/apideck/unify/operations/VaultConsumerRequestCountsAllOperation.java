...
public class VaultConsumerRequestCountsAllOperation implements RequestOperation<VaultConsumerRequestCountsAllRequest, VaultConsumerRequestCountsAllResponse> {
    ...
    public VaultConsumerRequestCountsAllOperation(
    ...
    public HttpRequest buildRequest(VaultConsumerRequestCountsAllRequest request) throws Exception {
