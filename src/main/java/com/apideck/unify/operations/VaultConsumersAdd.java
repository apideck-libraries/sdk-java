...
public class VaultConsumersAdd {
    ...
    public static class Sync extends Base
            implements RequestOperation<VaultConsumersAddRequest, VaultConsumersAddResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(VaultConsumersAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<VaultConsumersAddRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(VaultConsumersAddRequest request) {
        ...
        @Override
        public VaultConsumersAddResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            VaultConsumersAddResponse.Builder resBuilder =
            ...
            VaultConsumersAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCreateConsumerResponse(Utils.unmarshal(response, new TypeReference<CreateConsumerResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<VaultConsumersAddRequest, com.apideck.unify.models.operations.async.VaultConsumersAddResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(VaultConsumersAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<VaultConsumersAddRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(VaultConsumersAddRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.VaultConsumersAddResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.VaultConsumersAddResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.VaultConsumersAddResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.VaultConsumersAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CreateConsumerResponse>() {})
                            .thenApply(res::withCreateConsumerResponse);
                } else {
