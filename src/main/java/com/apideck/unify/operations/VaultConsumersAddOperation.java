...
public class VaultConsumersAddOperation implements RequestOperation<VaultConsumersAddRequest, VaultConsumersAddResponse> {
    ...
    public VaultConsumersAddOperation(
    ...
    public HttpRequest buildRequest(VaultConsumersAddRequest request) throws Exception {
