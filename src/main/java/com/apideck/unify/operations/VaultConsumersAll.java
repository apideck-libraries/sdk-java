...
public class VaultConsumersAll {
    ...
    public static class Sync extends Base
            implements RequestOperation<VaultConsumersAllRequest, VaultConsumersAllResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(VaultConsumersAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, VaultConsumersAllRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(VaultConsumersAllRequest request) {
        ...
        @Override
        public VaultConsumersAllResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            VaultConsumersAllResponse.Builder resBuilder =
            ...
            VaultConsumersAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetConsumersResponse(Utils.unmarshal(response, new TypeReference<GetConsumersResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<VaultConsumersAllRequest, com.apideck.unify.models.operations.async.VaultConsumersAllResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(VaultConsumersAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, VaultConsumersAllRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(VaultConsumersAllRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.VaultConsumersAllResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.VaultConsumersAllResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.VaultConsumersAllResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.VaultConsumersAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetConsumersResponse>() {})
                            .thenApply(res::withGetConsumersResponse);
                } else {
