...
public class VaultConsumersAllOperation implements RequestOperation<VaultConsumersAllRequest, VaultConsumersAllResponse> {
    ...
    public VaultConsumersAllOperation(
    ...
    public HttpRequest buildRequest(VaultConsumersAllRequest request) throws Exception {
