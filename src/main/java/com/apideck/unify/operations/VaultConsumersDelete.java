...
public class VaultConsumersDelete {
    ...
    public static class Sync extends Base
            implements RequestOperation<VaultConsumersDeleteRequest, VaultConsumersDeleteResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(VaultConsumersDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, VaultConsumersDeleteRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(VaultConsumersDeleteRequest request) {
        ...
        @Override
        public VaultConsumersDeleteResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            VaultConsumersDeleteResponse.Builder resBuilder =
            ...
            VaultConsumersDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDeleteConsumerResponse(Utils.unmarshal(response, new TypeReference<DeleteConsumerResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<VaultConsumersDeleteRequest, com.apideck.unify.models.operations.async.VaultConsumersDeleteResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(VaultConsumersDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, VaultConsumersDeleteRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(VaultConsumersDeleteRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.VaultConsumersDeleteResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.VaultConsumersDeleteResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.VaultConsumersDeleteResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.VaultConsumersDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DeleteConsumerResponse>() {})
                            .thenApply(res::withDeleteConsumerResponse);
                } else {
