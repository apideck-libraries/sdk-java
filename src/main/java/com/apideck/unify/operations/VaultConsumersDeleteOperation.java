...
public class VaultConsumersDeleteOperation implements RequestOperation<VaultConsumersDeleteRequest, VaultConsumersDeleteResponse> {
    ...
    public VaultConsumersDeleteOperation(
    ...
    public HttpRequest buildRequest(VaultConsumersDeleteRequest request) throws Exception {
