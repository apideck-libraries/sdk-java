...
public class VaultConsumersOne {
    ...
    public static class Sync extends Base
            implements RequestOperation<VaultConsumersOneRequest, VaultConsumersOneResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(VaultConsumersOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, VaultConsumersOneRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(VaultConsumersOneRequest request) {
        ...
        @Override
        public VaultConsumersOneResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            VaultConsumersOneResponse.Builder resBuilder =
            ...
            VaultConsumersOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetConsumerResponse(Utils.unmarshal(response, new TypeReference<GetConsumerResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<VaultConsumersOneRequest, com.apideck.unify.models.operations.async.VaultConsumersOneResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(VaultConsumersOneRequest request) throws Exception {
            HttpRequest req = buildRequest(request, VaultConsumersOneRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(VaultConsumersOneRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.VaultConsumersOneResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.VaultConsumersOneResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.VaultConsumersOneResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.VaultConsumersOneResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetConsumerResponse>() {})
                            .thenApply(res::withGetConsumerResponse);
                } else {
