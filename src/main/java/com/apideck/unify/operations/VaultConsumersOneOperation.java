...
public class VaultConsumersOneOperation implements RequestOperation<VaultConsumersOneRequest, VaultConsumersOneResponse> {
    ...
    public VaultConsumersOneOperation(
    ...
    public HttpRequest buildRequest(VaultConsumersOneRequest request) throws Exception {
