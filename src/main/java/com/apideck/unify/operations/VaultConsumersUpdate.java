...
public class VaultConsumersUpdate {
    ...
    public static class Sync extends Base
        ...
        @Override
        public VaultConsumersUpdateResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    UpdateConsumerResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withUpdateConsumerResponse(out);
                    return res;
                } else {
