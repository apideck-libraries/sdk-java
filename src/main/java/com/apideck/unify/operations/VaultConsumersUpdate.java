...
public class VaultConsumersUpdate {
    ...
    public static class Sync extends Base
            implements RequestOperation<VaultConsumersUpdateRequest, VaultConsumersUpdateResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(VaultConsumersUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, VaultConsumersUpdateRequest.class, new TypeReference<VaultConsumersUpdateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(VaultConsumersUpdateRequest request) {
        ...
        @Override
        public VaultConsumersUpdateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            VaultConsumersUpdateResponse.Builder resBuilder =
            ...
            VaultConsumersUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withUpdateConsumerResponse(Utils.unmarshal(response, new TypeReference<UpdateConsumerResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<VaultConsumersUpdateRequest, com.apideck.unify.models.operations.async.VaultConsumersUpdateResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(VaultConsumersUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, VaultConsumersUpdateRequest.class, new TypeReference<VaultConsumersUpdateRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(VaultConsumersUpdateRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.VaultConsumersUpdateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.VaultConsumersUpdateResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.VaultConsumersUpdateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.VaultConsumersUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<UpdateConsumerResponse>() {})
                            .thenApply(res::withUpdateConsumerResponse);
                } else {
