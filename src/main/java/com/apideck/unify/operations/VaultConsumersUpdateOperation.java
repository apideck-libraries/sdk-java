...
public class VaultConsumersUpdateOperation implements RequestOperation<VaultConsumersUpdateRequest, VaultConsumersUpdateResponse> {
    ...
    public VaultConsumersUpdateOperation(
    ...
    public HttpRequest buildRequest(VaultConsumersUpdateRequest request) throws Exception {
