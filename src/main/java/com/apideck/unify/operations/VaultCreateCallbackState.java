...
public class VaultCreateCallbackState {
    ...
    public static class Sync extends Base
        ...
        @Override
        public VaultCreateCallbackStateResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    CreateCallbackStateResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCreateCallbackStateResponse(out);
                    return res;
                } else {
