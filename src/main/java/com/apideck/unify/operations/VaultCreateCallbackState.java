...
public class VaultCreateCallbackState {
    ...
    public static class Sync extends Base
            implements RequestOperation<VaultCreateCallbackStateRequest, VaultCreateCallbackStateResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(VaultCreateCallbackStateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, VaultCreateCallbackStateRequest.class, new TypeReference<VaultCreateCallbackStateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(VaultCreateCallbackStateRequest request) {
        ...
        @Override
        public VaultCreateCallbackStateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            VaultCreateCallbackStateResponse.Builder resBuilder =
            ...
            VaultCreateCallbackStateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCreateCallbackStateResponse(Utils.unmarshal(response, new TypeReference<CreateCallbackStateResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<VaultCreateCallbackStateRequest, com.apideck.unify.models.operations.async.VaultCreateCallbackStateResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(VaultCreateCallbackStateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, VaultCreateCallbackStateRequest.class, new TypeReference<VaultCreateCallbackStateRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(VaultCreateCallbackStateRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.VaultCreateCallbackStateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.VaultCreateCallbackStateResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.VaultCreateCallbackStateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.VaultCreateCallbackStateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CreateCallbackStateResponse>() {})
                            .thenApply(res::withCreateCallbackStateResponse);
                } else {
