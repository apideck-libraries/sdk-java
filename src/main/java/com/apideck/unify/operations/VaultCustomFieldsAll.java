...
public class VaultCustomFieldsAll {
    ...
    public static class Sync extends Base
            implements RequestOperation<VaultCustomFieldsAllRequest, VaultCustomFieldsAllResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(VaultCustomFieldsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, VaultCustomFieldsAllRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(VaultCustomFieldsAllRequest request) {
        ...
        @Override
        public VaultCustomFieldsAllResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            VaultCustomFieldsAllResponse.Builder resBuilder =
            ...
            VaultCustomFieldsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetCustomFieldsResponse(Utils.unmarshal(response, new TypeReference<GetCustomFieldsResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<VaultCustomFieldsAllRequest, com.apideck.unify.models.operations.async.VaultCustomFieldsAllResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(VaultCustomFieldsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, VaultCustomFieldsAllRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(VaultCustomFieldsAllRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.VaultCustomFieldsAllResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.VaultCustomFieldsAllResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.VaultCustomFieldsAllResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.VaultCustomFieldsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetCustomFieldsResponse>() {})
                            .thenApply(res::withGetCustomFieldsResponse);
                } else {
