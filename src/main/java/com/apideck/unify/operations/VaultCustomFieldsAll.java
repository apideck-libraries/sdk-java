...
public class VaultCustomFieldsAll {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(VaultCustomFieldsAllRequest request) throws Exception {
        ...
        @Override
        public VaultCustomFieldsAllResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GetCustomFieldsResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGetCustomFieldsResponse(out);
                    return res;
                } else {
