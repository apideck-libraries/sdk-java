...
public class VaultCustomFieldsAllOperation implements RequestOperation<VaultCustomFieldsAllRequest, VaultCustomFieldsAllResponse> {
    ...
    public VaultCustomFieldsAllOperation(
    ...
    public HttpRequest buildRequest(VaultCustomFieldsAllRequest request) throws Exception {
