...
public class VaultCustomMappingsAllOperation implements RequestOperation<VaultCustomMappingsAllRequest, VaultCustomMappingsAllResponse> {
    ...
    public VaultCustomMappingsAllOperation(
    ...
    public HttpRequest buildRequest(VaultCustomMappingsAllRequest request) throws Exception {
