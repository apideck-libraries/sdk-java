...
public class VaultLogsAll {
    ...
    public static class Sync extends Base
            implements RequestOperation<VaultLogsAllRequest, VaultLogsAllResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(VaultLogsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, VaultLogsAllRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(VaultLogsAllRequest request) {
        ...
        @Override
        public VaultLogsAllResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            VaultLogsAllResponse.Builder resBuilder =
            ...
            VaultLogsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetLogsResponse(Utils.unmarshal(response, new TypeReference<GetLogsResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<VaultLogsAllRequest, com.apideck.unify.models.operations.async.VaultLogsAllResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(VaultLogsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, VaultLogsAllRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(VaultLogsAllRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.VaultLogsAllResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.VaultLogsAllResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.VaultLogsAllResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.VaultLogsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetLogsResponse>() {})
                            .thenApply(res::withGetLogsResponse);
                } else {
