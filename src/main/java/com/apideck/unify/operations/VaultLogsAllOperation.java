...
public class VaultLogsAllOperation implements RequestOperation<VaultLogsAllRequest, VaultLogsAllResponse> {
    ...
    public HttpRequest buildRequest(VaultLogsAllRequest request) throws Exception {
