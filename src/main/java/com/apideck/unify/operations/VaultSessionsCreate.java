...
public class VaultSessionsCreate {
    ...
    public static class Sync extends Base
            implements RequestOperation<VaultSessionsCreateRequest, VaultSessionsCreateResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(VaultSessionsCreateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<VaultSessionsCreateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(VaultSessionsCreateRequest request) {
        ...
        @Override
        public VaultSessionsCreateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            VaultSessionsCreateResponse.Builder resBuilder =
            ...
            VaultSessionsCreateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCreateSessionResponse(Utils.unmarshal(response, new TypeReference<CreateSessionResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<VaultSessionsCreateRequest, com.apideck.unify.models.operations.async.VaultSessionsCreateResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(VaultSessionsCreateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<VaultSessionsCreateRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(VaultSessionsCreateRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.VaultSessionsCreateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.VaultSessionsCreateResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.VaultSessionsCreateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.VaultSessionsCreateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CreateSessionResponse>() {})
                            .thenApply(res::withCreateSessionResponse);
                } else {
