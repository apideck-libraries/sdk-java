...
public class VaultSessionsCreateOperation implements RequestOperation<VaultSessionsCreateRequest, VaultSessionsCreateResponse> {
    ...
    public VaultSessionsCreateOperation(
    ...
    public HttpRequest buildRequest(VaultSessionsCreateRequest request) throws Exception {
