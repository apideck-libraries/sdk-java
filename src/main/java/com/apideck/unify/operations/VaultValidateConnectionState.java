...
public class VaultValidateConnectionState {
    ...
    public static class Sync extends Base
            implements RequestOperation<VaultValidateConnectionStateRequest, VaultValidateConnectionStateResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(VaultValidateConnectionStateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, VaultValidateConnectionStateRequest.class, new TypeReference<VaultValidateConnectionStateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(VaultValidateConnectionStateRequest request) {
        ...
        @Override
        public VaultValidateConnectionStateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            VaultValidateConnectionStateResponse.Builder resBuilder =
            ...
            VaultValidateConnectionStateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withValidateConnectionStateResponse(Utils.unmarshal(response, new TypeReference<ValidateConnectionStateResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<VaultValidateConnectionStateRequest, com.apideck.unify.models.operations.async.VaultValidateConnectionStateResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(VaultValidateConnectionStateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, VaultValidateConnectionStateRequest.class, new TypeReference<VaultValidateConnectionStateRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(VaultValidateConnectionStateRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.VaultValidateConnectionStateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.VaultValidateConnectionStateResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.VaultValidateConnectionStateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.VaultValidateConnectionStateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ValidateConnectionStateResponse>() {})
                            .thenApply(res::withValidateConnectionStateResponse);
                } else {
