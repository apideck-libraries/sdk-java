...
public class VaultValidateConnectionState {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(VaultValidateConnectionStateRequest request) throws Exception {
        ...
        @Override
        public VaultValidateConnectionStateResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    ValidateConnectionStateResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withValidateConnectionStateResponse(out);
                    return res;
                } else {
