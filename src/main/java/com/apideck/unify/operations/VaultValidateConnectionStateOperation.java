...
public class VaultValidateConnectionStateOperation implements RequestOperation<VaultValidateConnectionStateRequest, VaultValidateConnectionStateResponse> {
    ...
    public VaultValidateConnectionStateOperation(
    ...
    public HttpRequest buildRequest(VaultValidateConnectionStateRequest request) throws Exception {
