...
public class WebhookWebhooksAdd {
    ...
    public static class Sync extends Base
            implements RequestOperation<WebhookWebhooksAddRequest, WebhookWebhooksAddResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(WebhookWebhooksAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<WebhookWebhooksAddRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(WebhookWebhooksAddRequest request) {
        ...
        @Override
        public WebhookWebhooksAddResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            WebhookWebhooksAddResponse.Builder resBuilder =
            ...
            WebhookWebhooksAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCreateWebhookResponse(Utils.unmarshal(response, new TypeReference<CreateWebhookResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<WebhookWebhooksAddRequest, com.apideck.unify.models.operations.async.WebhookWebhooksAddResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(WebhookWebhooksAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<WebhookWebhooksAddRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(WebhookWebhooksAddRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.WebhookWebhooksAddResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.WebhookWebhooksAddResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.WebhookWebhooksAddResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.WebhookWebhooksAddResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CreateWebhookResponse>() {})
                            .thenApply(res::withCreateWebhookResponse);
                } else {
