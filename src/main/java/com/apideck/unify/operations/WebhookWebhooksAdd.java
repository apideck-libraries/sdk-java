...
public class WebhookWebhooksAdd {
    ...
    public static class Sync extends Base
        ...
        @Override
        public WebhookWebhooksAddResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    CreateWebhookResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCreateWebhookResponse(out);
                    return res;
                } else {
