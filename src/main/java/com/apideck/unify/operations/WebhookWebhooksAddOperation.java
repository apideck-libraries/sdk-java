...
public class WebhookWebhooksAddOperation implements RequestOperation<WebhookWebhooksAddRequest, WebhookWebhooksAddResponse> {
    ...
    public WebhookWebhooksAddOperation(
    ...
    public HttpRequest buildRequest(WebhookWebhooksAddRequest request) throws Exception {
