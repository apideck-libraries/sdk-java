...
public class WebhookWebhooksAll {
    ...
    public static class Sync extends Base
            implements RequestOperation<WebhookWebhooksAllRequest, WebhookWebhooksAllResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(WebhookWebhooksAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, WebhookWebhooksAllRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(WebhookWebhooksAllRequest request) {
        ...
        @Override
        public WebhookWebhooksAllResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            WebhookWebhooksAllResponse.Builder resBuilder =
            ...
            WebhookWebhooksAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetWebhooksResponse(Utils.unmarshal(response, new TypeReference<GetWebhooksResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<WebhookWebhooksAllRequest, com.apideck.unify.models.operations.async.WebhookWebhooksAllResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(WebhookWebhooksAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, WebhookWebhooksAllRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(WebhookWebhooksAllRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.WebhookWebhooksAllResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.WebhookWebhooksAllResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.WebhookWebhooksAllResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.WebhookWebhooksAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetWebhooksResponse>() {})
                            .thenApply(res::withGetWebhooksResponse);
                } else {
