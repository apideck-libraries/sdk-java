...
public class WebhookWebhooksAllOperation implements RequestOperation<WebhookWebhooksAllRequest, WebhookWebhooksAllResponse> {
    ...
    public WebhookWebhooksAllOperation(
    ...
    public HttpRequest buildRequest(WebhookWebhooksAllRequest request) throws Exception {
