...
public class WebhookWebhooksDelete {
    ...
    public static class Sync extends Base
            implements RequestOperation<WebhookWebhooksDeleteRequest, WebhookWebhooksDeleteResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(WebhookWebhooksDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, WebhookWebhooksDeleteRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(WebhookWebhooksDeleteRequest request) {
        ...
        @Override
        public WebhookWebhooksDeleteResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            WebhookWebhooksDeleteResponse.Builder resBuilder =
            ...
            WebhookWebhooksDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDeleteWebhookResponse(Utils.unmarshal(response, new TypeReference<DeleteWebhookResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<WebhookWebhooksDeleteRequest, com.apideck.unify.models.operations.async.WebhookWebhooksDeleteResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(WebhookWebhooksDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, WebhookWebhooksDeleteRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(WebhookWebhooksDeleteRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.WebhookWebhooksDeleteResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.WebhookWebhooksDeleteResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.WebhookWebhooksDeleteResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.WebhookWebhooksDeleteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DeleteWebhookResponse>() {})
                            .thenApply(res::withDeleteWebhookResponse);
                } else {
