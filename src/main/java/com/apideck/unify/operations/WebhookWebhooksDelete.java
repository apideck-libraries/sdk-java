...
public class WebhookWebhooksDelete {
    ...
    public static class Sync extends Base
        ...
        @Override
        public WebhookWebhooksDeleteResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    DeleteWebhookResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withDeleteWebhookResponse(out);
                    return res;
                } else {
