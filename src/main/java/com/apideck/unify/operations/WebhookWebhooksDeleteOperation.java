...
public class WebhookWebhooksDeleteOperation implements RequestOperation<WebhookWebhooksDeleteRequest, WebhookWebhooksDeleteResponse> {
    ...
    public WebhookWebhooksDeleteOperation(
    ...
    public HttpRequest buildRequest(WebhookWebhooksDeleteRequest request) throws Exception {
