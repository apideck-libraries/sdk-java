...
public class WebhookWebhooksOne {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(WebhookWebhooksOneRequest request) {
        ...
        @Override
        public WebhookWebhooksOneResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetWebhookResponse(Utils.unmarshal(response, new TypeReference<GetWebhookResponse>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        public CompletableFuture<com.apideck.unify.models.operations.async.WebhookWebhooksOneResponse> handleResponse(
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetWebhookResponse>() {})
                            .thenApply(res::withGetWebhookResponse);
                } else {
