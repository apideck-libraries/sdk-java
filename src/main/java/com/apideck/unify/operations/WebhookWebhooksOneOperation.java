...
public class WebhookWebhooksOneOperation implements RequestOperation<WebhookWebhooksOneRequest, WebhookWebhooksOneResponse> {
    ...
    public WebhookWebhooksOneOperation(
    ...
    public HttpRequest buildRequest(WebhookWebhooksOneRequest request) throws Exception {
