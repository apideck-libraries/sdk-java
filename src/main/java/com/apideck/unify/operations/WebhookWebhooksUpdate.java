...
public class WebhookWebhooksUpdate {
    ...
    public static class Sync extends Base
            implements RequestOperation<WebhookWebhooksUpdateRequest, WebhookWebhooksUpdateResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(WebhookWebhooksUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, WebhookWebhooksUpdateRequest.class, new TypeReference<WebhookWebhooksUpdateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(WebhookWebhooksUpdateRequest request) {
        ...
        @Override
        public WebhookWebhooksUpdateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            WebhookWebhooksUpdateResponse.Builder resBuilder =
            ...
            WebhookWebhooksUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withUpdateWebhookResponse(Utils.unmarshal(response, new TypeReference<UpdateWebhookResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<WebhookWebhooksUpdateRequest, com.apideck.unify.models.operations.async.WebhookWebhooksUpdateResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(WebhookWebhooksUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, WebhookWebhooksUpdateRequest.class, new TypeReference<WebhookWebhooksUpdateRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(WebhookWebhooksUpdateRequest request) {
        ...
        @Override
        public CompletableFuture<com.apideck.unify.models.operations.async.WebhookWebhooksUpdateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.apideck.unify.models.operations.async.WebhookWebhooksUpdateResponse.Builder resBuilder =
                    com.apideck.unify.models.operations.async.WebhookWebhooksUpdateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.apideck.unify.models.operations.async.WebhookWebhooksUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<UpdateWebhookResponse>() {})
                            .thenApply(res::withUpdateWebhookResponse);
                } else {
