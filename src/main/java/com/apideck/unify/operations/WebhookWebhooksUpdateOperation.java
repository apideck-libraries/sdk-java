...
public class WebhookWebhooksUpdateOperation implements RequestOperation<WebhookWebhooksUpdateRequest, WebhookWebhooksUpdateResponse> {
    ...
    public WebhookWebhooksUpdateOperation(
    ...
    public HttpRequest buildRequest(WebhookWebhooksUpdateRequest request) throws Exception {
